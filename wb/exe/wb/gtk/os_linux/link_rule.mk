...
ifeq ($(export_type),exp)			 
  link = $(ldxx) $(explinkflags) $(domap) -o $(pwr_exe)/wb_gtk \
	...
	-lpwr_wb_gtk -lpwr_wb -lpwr_wb_gtk -lpwr_wb -lpwr_rt_gtk -lpwr_rt \
        -lpwr_ge_gtk -lpwr_ge \
	-lpwr_flow_gtk -lpwr_flow -lpwr_glow_gtk -lpwr_glow -lpwr_cnv -lpwr_co_gtk -lpwr_co -lpwr_rt -lpwr_statussrv \
  ...
  link = $(ldxx) $(elinkflags) $(domap) -o $(pwr_exe)/wb_gtk \
	...
	-lpwr_flow_gtk -lpwr_flow -lpwr_glow_gtk -lpwr_glow -lpwr_cnv -lpwr_co_gtk -lpwr_co -lpwr_statussrv -lpwr_rt\
	`pkg-config --libs gtk+-2.0` \
	-lpwr_msg_dummy -lantlr \
	-lrpcsvc -lpthread -lm -ldb_cxx -lz
endif
