...
static String fbr[] = { (char*)"*XmDialogShell.mwmDecorations: 94",
  ...
  (char*)"*XmLabelGadget.fontList: -*-helvetica-bold-r-*--12-*", NULL };

Wtt* WbMotif::wtt_new(const char* name, const char* iconname,
...
WVsel* WbMotif::vsel_new(pwr_tStatus* status, const char* name,
...
WbMotif::WbMotif(int argc, char* argv[])
{
  ...
  toplevel = XtVaAppInitialize(&app_ctx, WB_CLASS_NAME, NULL, 0, &argc, argv,
      fbr, XtNallowShellResize, True, XmNmappedWhenManaged, False, NULL);

  uilutil_fetch(&uid_filename_p, 1, 0, 0, toplevel, (char*)"mainwindow",
      (char*)"svn_svn", 0, 0, &mainwindow, NULL);

  XtManageChild(mainwindow);

  // Create message window
  MsgWindowMotif* msg_window
      = new MsgWindowMotif(0, mainwindow, "Workbench messages", &sts);
  ...
  // Create help window
  CoXHelpMotif* xhelp
      = new CoXHelpMotif(mainwindow, 0, xhelp_eUtility_Wtt, &sts);
