...
# Suppress all warnings, -x
  if [ $CurrentOpSys -eq $OpSys ]; then
      cc_cmd="gcc -c -x c -w $cc_debug -D_REENTRANT -DOS_OPENBSD -I$pwr_inc -I$pwrp_inc -I$pwrp_tmp $PWR_EXT_INC"
...
# Suppress all warnings, -x
  if [ $CurrentOpSys -eq $OpSys ]; then
      cc_cmd="gcc -c -x c -w $cc_debug -D_REENTRANT -DOS_CYGWIN -I$pwr_inc -I$pwrp_inc -I$pwrp_tmp -I/usr/include/tirpc $PWR_EXT_INC"
