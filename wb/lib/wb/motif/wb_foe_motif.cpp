...
//	Callback from the menu.
void WFoeMotif::activate_winddelete(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_savetrace(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  foe->activate_savetrace();
}

void WFoeMotif::activate_restoretrace(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_printoverv(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_printselect(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_changetext(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_attribute(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_subwindow(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_undelete(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_unselect(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Sets gridsize.
//
void WFoeMotif::activate_gridsize1(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  foe->gre->set_grid_size(0.01);
}

void WFoeMotif::activate_gridsize2(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  foe->gre->set_grid_size(0.02);
}

void WFoeMotif::activate_gridsize3(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  foe->gre->set_grid_size(0.05);
}

void WFoeMotif::activate_gridsize4(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  foe->gre->set_grid_size(0.10);
}

void WFoeMotif::activate_gridsize5(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//
void WFoeMotif::activate_showgrid(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
}
...
//
void WFoeMotif::activate_palette_con(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1)
    return;
...
//	Display or hide the connection palette.
//
void WFoeMotif::activate_palette_object(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1)
    return;
...
//	Display or hide the connection palette.
//
void WFoeMotif::activate_palette_plant(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1)
    return;
...
// 	Callback from the menu.
void WFoeMotif::activate_refcon(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1)
    return;
...
// 	Callback from the menu.
void WFoeMotif::activate_showexeord(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1)
    return;
...
//	Callback from the menu.
void WFoeMotif::activate_plcattribute(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_searchobject(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_searchstring(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the menu.
void WFoeMotif::activate_searchnext(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//	Callback from the edit entry of the foe_menu widget
void WFoeMotif::activate_compress(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
//
void WFoeMotif::activate_helpclass(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
// 	SG 01.05.91
//
void WFoeMotif::activate_trace_togg(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
...
//
void WFoeMotif::activate_simulate_togg(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1 || data->event == 0)
    return;
...
void WFoeMotif::activate_view_togg(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1 || data->event == 0)
    return;
...
void WFoeMotif::activate_edit_togg(
    Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data)
{
  if (data->set > 1 || data->event == 0)
    return;
...
void WFoeMotif::create_palette_object(
    Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
...
void WFoeMotif::popdown_pop(Widget w, WFoe* foe, XmAnyCallbackStruct* data)
{
  ...
  if (foe->popupmenu_node != 0) {
    ...
    TimerID = XtAppAddTimeOut(
        XtWidgetToApplicationContext(((WFoeMotif*)foe)->parent_wid), 300,
        (XtTimerCallbackProc)reset_current_node, foe);
  }
  foe->normal_cursor();
}
...
//	Callback from the menu.
//
void WFoeMotif::valchanged_textinput(
    Widget w, WFoeMotif* foe, XmAnyCallbackStruct* data)
{
  char* value;
  int len, sts;
...
int WFoeMotif::register_callbacks()
{
  static MrmRegisterArg reglist[] = { /* First the context variable */
    ...
    { (char*)"foe_activate_palette_object",
        (XtPointer)activate_palette_object },
    ...
    { (char*)"foe_activate_getobj",
        (XtPointer)activate_getobj }, /* sg 11.04.91 */
...
{
  static char buttontext[][40] = { "ObjectEditor", "SubWindow", "Connect",
    "Delete", "Paste", "Copy", "Cut", "PrintSelect", "HelpClass" };
  static XtCallbackProc callback[]
      = { (void (*)(Widget, void*, void*))activate_attribute,
  ...
  XtAddCallback(Menu, XmNunmapCallback, (XtCallbackProc)popup_unmap_cb, this);
  ...
  for (i = 0; i < 9; i++) {
    if (popupmenu_mask & (1 << i)) {
      w = XtVaCreateManagedWidget(
          buttontext[i], xmPushButtonGadgetClass, Menu, NULL);

      XtAddCallback(
          w, XmNactivateCallback, (XtCallbackProc)callback[i], (XtPointer)this);
    }
  }
...
void WFoeMotif::disable_set_focus(WFoeMotif* foe, int time)
{
  foe->set_focus_disabled++;
  foe->focus_timerid
      = XtAppAddTimeOut(XtWidgetToApplicationContext(foe->parent_wid), time,
...
//	comes.
//
WAtt* WFoeMotif::watt_new(void* a_parent_ctx, ldh_tSesContext a_ldhses,
    pwr_sAttrRef a_aref, int a_editmode, int a_advanced_user,
    int a_display_objectname)
{
  WAttMotif* watt = new WAttMotif(parent_wid, a_parent_ctx, a_ldhses, a_aref,
...
WFoe* WFoeMotif::subwindow_new(void* f_parent_ctx, char* f_name,
    ...
    void (*no_procedure)(WFoe*), void (*cancel_procedure)(WFoe*))
{
  ...
  cstr = XmStringCreateLtoR((char*)new_label, (char*)"ISO8859-1");
  i = 0;
  XtSetArg(args[0], XmNmessageString, cstr);
  i++;
...
// Constructor
//
WFoeMotif::WFoeMotif(void* f_parent_ctx, Widget f_parent_wid,
...
//
pwr_tStatus WFoeMotif::create_window(int x_top, int y_top, int width_adb,
...
<FocusIn>: foe_inputfocus()\n";
  ...
  if (icon_pixmap == 0)
    sts = MrmFetchBitmapLiteral(s_MrmH, (char*)"icon", XtScreen(parent_wid),
        XtDisplay(parent_wid), &icon_pixmap, &icon_w, &icon_h);

  i = 0;
  XtSetArg(args[i], XmNiconName, name);
  i++;
  XtSetArg(args[i], XtNiconPixmap, icon_pixmap);
  i++;

  /* SG 11.02.91 Save the id of the top in the context */
  parent_wid = XtCreatePopupShell(
      "plcEditor", topLevelShellWidgetClass, parent_wid, args, i);

  if (compiled_translations == NULL)
    XtAppAddActions(
        XtWidgetToApplicationContext(parent_wid), actions, XtNumber(actions));
  ...
  */
  ...
  i = 0;
  XtSetArg(args[i], XmNx, x_top);
  i++;
  XtSetArg(args[i], XmNy, y_top);
  i++;
  XtSetArg(args[i], XtNallowShellResize, TRUE), i++;

  if (!map_window) {
    XtSetArg(args[i], XmNmappedWhenManaged, FALSE);
    i++;
  }
  ...
  sts = MrmFetchWidgetOverride(s_MrmH, (char*)"foe_window", parent_wid, name,
      args, 1, &widgets.foe_window, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch foedit widget\n");

  /* SG 24.02.91 Set the width and hight desired for the main window to his
        child the adb widget */
  i = 0;
  XtSetArg(args[i], XmNwidth, width_adb);
  i++;
  XtSetArg(args[i], XmNheight, height_adb);
  i++;
  ...
  */
  ...
  if (MrmFetchWidget(s_MrmH, (char*)"foe_msgbox", widgets.foe_window,
          &widgets.msgbox, &dclass)
      != MrmSUCCESS)
  ...
  */
  ...
  if (MrmFetchWidget(s_MrmH, (char*)"foe_popupmsg", widgets.foe_window,
          &widgets.caution, &dclass)
      != MrmSUCCESS)
  ...
  node_palctx = new PalMotif(this, widgets.subpane, "Objects", ldhsession,
      "PlcEditorPalette", &widgets.node_palette, &sts);
  node_palette_managed = 1;

  navctx = new NavMotif(this, widgets.subpane, "Plant", ldhsession,
      "NavigatorW1", &widgets.nav_palette, &sts);
  XtUnmanageChild(widgets.nav_palette);

  con_palctx = new PalMotif(this, widgets.subpane, "Connections", ldhsession,
      "PlcEditorConPalette", &widgets.con_palette, &sts);
  XtUnmanageChild(widgets.con_palette);

  /* Turn off traversal for sash widgets */
  XtVaGetValues(widgets.subpane, XmNchildren, &children, XmNnumChildren,
      &num_children, NULL);
