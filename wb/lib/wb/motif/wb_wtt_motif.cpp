...
void WttMotif::set_window_char(int width, int height)
{
  ...
  if (width) {
    short w = width;
    XtSetArg(args[i], XmNwidth, w);
    i++;
  }
  if (height) {
    short h = height;
    XtSetArg(args[i], XmNheight, h);
    i++;
  }
...
{
  selection_timerid = XtAppAddTimeOut(XtWidgetToApplicationContext(toplevel),
      200, (XtTimerCallbackProc)WttMotif::set_selection_owner_proc, this);
}

void WttMotif::set_palette_selection_owner()
{
  selection_timerid = XtAppAddTimeOut(XtWidgetToApplicationContext(toplevel),
      200, (XtTimerCallbackProc)WttMotif::set_palette_selection_owner_proc,
      this);
}
...
void WttMotif::set_selection_owner_proc(WttMotif* wtt)
{
  ...
  // selection to value inputwith MB2
...
int WttMotif::create_popup_menu(pwr_tAttrRef aref, int x, int y)
{
  Widget popup;
  Arg args[5];
  int i;
  ...
  i = 0;
  XtSetArg(args[i], XmNx, menu_x);
  i++;
  XtSetArg(args[i], XmNy, menu_y);
  i++;
...
int WttMotif::create_pal_popup_menu(pwr_tCid cid, int x, int y)
{
  Widget popup;
  Arg args[5];
  int i;
...
void WttMotif::set_noedit_show()
{
  ...
  i = 0;
  XtSetArg(args[i], XmNwidth, width - WTT_PALETTE_WIDTH);
  i++;
  XtSetValues(toplevel, args, i);
}
...
void WttMotif::set_edit_show()
{
  ...
  i++;
  XtSetArg(args[i], XmNleftWidget, palette_form);
  i++;
  XtSetValues(wnav_form, args, i);
...
//
void WttMotif::activate_change_value(
...
void WttMotif::activate_openobject(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_openobject();
}

void WttMotif::activate_openvolobject(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_buildobject(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_buildobject();
}

void WttMotif::activate_openvolume(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_openvolume();
}

void WttMotif::activate_openbuffer(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_openbuffer();
}

void WttMotif::activate_confproject(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_confproject();
}

void WttMotif::activate_openfile_dbs(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_openfile_wbl(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->set_clock_cursor();
  wtt->wnav->wow->CreateFileSelDia("Loadfile Selection", (void*)wtt,
...
void WttMotif::activate_spreadsheet(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_openclasseditor(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_openclasseditor();
}

void WttMotif::activate_buildvolume(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_distribute(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_distribute();
}

void WttMotif::activate_showcrossref(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_showcrossref();
}

void WttMotif::activate_updateclasses(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_zoom_reset(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_zoom_reset();
}

void WttMotif::activate_twowindows(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_savesettings(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->save_settings();
}

void WttMotif::activate_restoresettings(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->restore_settings();
}

void WttMotif::activate_scriptproj(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_scriptproj();
}

void WttMotif::activate_scriptbase(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_help_project(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->activate_help_project();
}

void WttMotif::activate_help_proview(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::create_menubutton(Widget w, Wtt* wtt)
{
  ...
  switch (key) {
  case 1:
    ((WttMotif*)wtt)->menu_save_w = w;
    break;
  case 2:
    ((WttMotif*)wtt)->menu_revert_w = w;
    break;
  case 3:
    ((WttMotif*)wtt)->menu_cut_w = w;
    break;
  case 4:
    ((WttMotif*)wtt)->menu_rename_w = w;
    break;
  case 5:
    ((WttMotif*)wtt)->menu_utilities_w = w;
    break;
  case 6:
    ((WttMotif*)wtt)->menu_openplc_w = w;
    break;
  case 7:
    ((WttMotif*)wtt)->menu_buildvolume_w = w;
    break;
  case 8:
    ((WttMotif*)wtt)->menu_buildnode_w = w;
    break;
  case 9:
    ((WttMotif*)wtt)->menu_distribute_w = w;
    break;
  case 10:
    ((WttMotif*)wtt)->menu_change_value_w = w;
    break;
  case 11:
    ((WttMotif*)wtt)->menu_copy_w = w;
    break;
  case 12:
    ((WttMotif*)wtt)->menu_paste_w = w;
    break;
  case 13:
    ((WttMotif*)wtt)->menu_buildobject_w = w;
    break;
  case 14:
    ((WttMotif*)wtt)->menu_pasteinto_w = w;
    break;
  case 15:
    ((WttMotif*)wtt)->menu_edit_w = w;
    break;
  case 16:
    ((WttMotif*)wtt)->menu_classeditor_w = w;
    break;
  case 17:
    ((WttMotif*)wtt)->menu_copykeep_w = w;
    break;
  case 18:
    ((WttMotif*)wtt)->menu_updateclasses_w = w;
    break;
  default:;
  }
}
...
static void wtt_valchanged_cmd_input(Widget w, XEvent* event)
{
  ...
  if (wtt->input_open)
    sts = mrm_TextInput(w, event, (char*)wtt->value_recall,
        sizeof(wtt->value_recall[0]),
        sizeof(wtt->value_recall) / sizeof(wtt->value_recall[0]),
        &wtt->value_current_recall);
  else
    sts = mrm_TextInput(w, event, (char*)wtt->cmd_recall,
        sizeof(wtt->cmd_recall[0]),
...
void WttMotif::create_palette_form(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_india_cancel(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((WttMotif*)wtt)->india_widget);
}
void WttMotif::activate_confirm_ok(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
...
void WttMotif::activate_confirm_no(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((WttMotif*)wtt)->confirm_widget);
  wtt->confirm_open = 0;
...
void WttMotif::activate_confirm_cancel(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  wtt->confirm_open = 0;
  XtUnmanageChild(((WttMotif*)wtt)->confirm_widget);
...
void WttMotif::action_inputfocus(Widget w, XmAnyCallbackStruct* data)
{
  ...
  if (wtt->focused_wnav) {
    ...
    // wtt->focus_timerid = XtAppAddTimeOut( XtWidgetToApplicationContext(
    // wtt->toplevel), 200,
...
void WttMotif::activate_selmode(
...
void WttMotif::open_boot_window()
{
  ...
  if (boot_dia == NULL) {
    ...
    uilutil_fetch(&uid_filename_p, 1, reglist, reglist_num, toplevel,
        (char*)"bootFilesWindow", (char*)"bootFilesWindow", NULL, 0, &boot_dia,
        NULL);

    XtVaSetValues(XtParent(boot_dia), XmNdeleteResponse, XmDESTROY, NULL);
  }
      ...
      for (j = 0; j < wtt->boot_volumecount; j++) {
        if (strcmp(volumelist_ptr->p1, nodeconfigname)) {
          ...
          if (nodecount == pos_list[i]) {
            ...
            build.node(
                nodeconfigname, wtt->boot_volumelist, wtt->boot_volumecount);
            if (build.evenSts()) {
              XtDestroyWidget(((WttMotif*)wtt)->boot_dia);
              sprintf(msg, "Error creating bootfile for NodeConfig-object %s",
                  nodeconfigname);
              wtt->message('E', msg);
              return;
...
{
  // Hierarchies
  XmToggleButtonSetState(show_plant_w, (Boolean)wnav_mapped, False);
  XmToggleButtonSetState(show_node_w, (Boolean)wnavnode_mapped, False);
...
void WttMotif::set_options()
{
  ...
  wnav->set_options(enable_comment, show_class, show_alias, show_descrip,
      show_objref, show_objxref, show_attrref, show_attrxref, build_force,
      build_debug, build_crossref, build_manual);
  wnavnode->set_options(enable_comment, show_class, show_alias, show_descrip,
      show_objref, show_objxref, show_attrref, show_attrxref, build_force,
      build_debug, build_crossref, build_manual);
}
...
void WttMotif::options_entry_tog_cr(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  int key;
...
void WttMotif::options_hier_tog_cr(
    Widget w, Wtt* wtt, XmAnyCallbackStruct* data)
{
  int key;
...
WttMotif::WttMotif(void* wt_parent_ctx, Widget wt_parent_wid,
    ...
    : Wtt(wt_parent_ctx, wt_name, iconname, wt_wbctx, wt_volid, wt_volctx,
          root_menu, status),
      parent_wid(wt_parent_wid), boot_dia(0), set_focus_disabled(0),
      disfocus_timerid(0), selection_timerid(0), avoid_deadlock(0),
...
<FocusIn>: wtt_inputfocus()\n";
  ...
  static XtActionsRec actions[] = { { (char*)"wtt_inputfocus",
      (XtActionProc)WttMotif::action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"wtt_ctx", 0 },
    ...
    { (char*)"wtt_activate_openobject",
        (caddr_t)WttMotif::activate_openobject },
    { (char*)"wtt_activate_openvolobject",
        (caddr_t)WttMotif::activate_openvolobject },
    { (char*)"wtt_activate_confproject",
        (caddr_t)WttMotif::activate_confproject },
    { (char*)"wtt_activate_openvolume",
        (caddr_t)WttMotif::activate_openvolume },
    { (char*)"wtt_activate_openbuffer",
        (caddr_t)WttMotif::activate_openbuffer },
    { (char*)"wtt_activate_openfile_dbs",
        (caddr_t)WttMotif::activate_openfile_dbs },
    { (char*)"wtt_activate_openfile_wbl",
        (caddr_t)WttMotif::activate_openfile_wbl },
    ...
    { (char*)"wtt_activate_spreadsheet",
        (caddr_t)WttMotif::activate_spreadsheet },
    { (char*)"wtt_activate_openge", (caddr_t)WttMotif::activate_openge },
    { (char*)"wtt_activate_openclasseditor",
        (caddr_t)WttMotif::activate_openclasseditor },
    { (char*)"wtt_activate_buildobject",
        (caddr_t)WttMotif::activate_buildobject },
    { (char*)"wtt_activate_buildvolume",
        (caddr_t)WttMotif::activate_buildvolume },
    { (char*)"wtt_activate_buildnode", (caddr_t)WttMotif::activate_buildnode },
    { (char*)"wtt_activate_distribute",
        (caddr_t)WttMotif::activate_distribute },
    { (char*)"wtt_activate_updateclasses",
        (caddr_t)WttMotif::activate_updateclasses },
    { (char*)"wtt_activate_showcrossref",
        (caddr_t)WttMotif::activate_showcrossref },
    { (char*)"wtt_activate_change_value",
        (caddr_t)WttMotif::activate_change_value },
    ...
    { (char*)"wtt_activate_zoom_reset",
        (caddr_t)WttMotif::activate_zoom_reset },
    { (char*)"wtt_activate_twowindows",
        (caddr_t)WttMotif::activate_twowindows },
    { (char*)"wtt_activate_messages", (caddr_t)WttMotif::activate_messages },
    { (char*)"wtt_activate_view", (caddr_t)WttMotif::activate_view },
    { (char*)"wtt_activate_savesettings",
        (caddr_t)WttMotif::activate_savesettings },
    { (char*)"wtt_activate_restoresettings",
        (caddr_t)WttMotif::activate_restoresettings },
    { (char*)"wtt_activate_scriptproj",
        (caddr_t)WttMotif::activate_scriptproj },
    { (char*)"wtt_activate_scriptbase",
        (caddr_t)WttMotif::activate_scriptbase },
    { (char*)"wtt_activate_help", (caddr_t)WttMotif::activate_help },
    { (char*)"wtt_activate_help_project",
        (caddr_t)WttMotif::activate_help_project },
    { (char*)"wtt_activate_help_proview",
        (caddr_t)WttMotif::activate_help_proview },
    ...
    { (char*)"wtt_create_palette_form",
        (caddr_t)WttMotif::create_palette_form },
    ...
    { (char*)"wtt_activate_india_cancel",
        (caddr_t)WttMotif::activate_india_cancel },
    ...
    { (char*)"wtt_activate_confirm_ok",
        (caddr_t)WttMotif::activate_confirm_ok },
    { (char*)"wtt_activate_confirm_no",
        (caddr_t)WttMotif::activate_confirm_no },
    { (char*)"wtt_activate_confirm_cancel",
        (caddr_t)WttMotif::activate_confirm_cancel },
    { (char*)"wtt_options_form_cr", (caddr_t)WttMotif::options_form_cr },
    { (char*)"wtt_options_entry_tog_cr",
        (caddr_t)WttMotif::options_entry_tog_cr },
    { (char*)"wtt_options_hier_tog_cr",
        (caddr_t)WttMotif::options_hier_tog_cr },
    { (char*)"wtt_options_act_but_cb",
        (caddr_t)WttMotif::options_act_but_cb } };
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"wtt_window", toplevel, name,
      args, i, &wtt_widget, &dclass);
  if (sts != MrmSUCCESS)
  ...
  sts = MrmFetchWidget(
      s_DRMh, (char*)"optionsForm", toplevel, &options_form, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch options dialog\n");
  ...
  wnav = new WNavMotif(this, wnav_form, title_w2, layout_w1, &wnav_brow_widget,
  ...
  i = 0;
  XtSetArg(args[i], XmNtraversalOn, True);
  i++;
  XtSetArg(args[i], XmNnavigationType, XmTAB_GROUP);
  i++;
  ...
  i++;
  XtSetArg(args[i], XmNpaneMinimum, 100);
  i++;
  XtSetArg(args[i], XmNnavigationType, XmTAB_GROUP);
  i++;
  XtSetArg(args[i], XmNtraversalOn, True);
  ...
  palette = new PalMotif(this, palette_form, "Objects", ldhses, layout_palette,
      &palette_widget, &sts);
  ...
  i = 0;
  XtSetArg(args[i], XmNwidth, WTT_PALETTE_WIDTH);
  i++;
  ...
  flow_AddCloseVMProtocolCb(toplevel, (XtCallbackProc)activate_exit, this);

  wnav->get_options(&enable_comment, &show_class, &show_alias, &show_descrip,
      &show_objref, &show_objxref, &show_attrref, &show_attrxref, &build_force,
      &build_debug, &build_crossref, &build_manual);
...
Widget WttMotif::build_menu()
{
  ...
  popup = build_submenu(wnav_form, MENU_POPUP, (char*)"", mcp, popup_button_cb,
      (void*)this, (ldh_sMenuItem*)mcp->ItemList, &i);
  if (popup != NULL)
    XtAddCallback(
        popup, XmNunmapCallback, (XtCallbackProc)popup_unmap_cb, this);

  return popup;
}

Widget WttMotif::build_submenu(Widget Parent, int MenuType, char* MenuTitle,
    ...
    void* CallbackData, ldh_sMenuItem* Items, int* idx)
{
  ...
  i = 0;
  XtSetArg(ArgList[i], XmNuserData, MenuUserData);
  i++;
  XtSetArg(ArgList[i], XmNbuttonFontList, fontlist);
  i++;
  XtSetArg(ArgList[i], XmNlabelFontList, fontlist);
  i++;
  ...
  if (MenuType == MENU_PULLDOWN) {
    ...
    Cascade = XtVaCreateManagedWidget(MenuTitle, xmCascadeButtonGadgetClass,
        Parent, XmNsubMenuId, Menu, XmNlabelString, Str, NULL);
    XmStringFree(Str);
  ...
  for (; Items[*idx].Level != 0 && Items[*idx].Level >= Level; (*idx)++) {
    ...
    if (Items[*idx].Item == ldh_eMenuItem_Cascade) {
      ...
      W = XtVaCreateManagedWidget(Items[*idx].Name, Class, Menu, XmNuserData,
          *idx, XmNsensitive, (Boolean)(Items[*idx].Flags.f.Sensitive == 1),
          NULL);
