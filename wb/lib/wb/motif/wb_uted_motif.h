...
public:
  ...
  WUtedMotif(void* wu_parent_ctx, Widget wu_parent_wid, const char* wu_name,
  ...
  static void activate_command(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_command(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_helputils(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_helppwr_plc(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_batch(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_currsess(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  ...
  static void activate_cancel(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_show_cmd(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void activate_cmd_wind(
  ...
  static void create_file_entry(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_quit(Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_commandwind_button(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_batchoptmenu(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_commandlabel(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_batch(Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_currsess(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_cmd_wind(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_timelabel(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_timevalue(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier1(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value1(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present1(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier2(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value2(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present2(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier3(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value3(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present3(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier4(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value4(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present4(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier5(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value5(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present5(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier6(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value6(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present6(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier7(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value7(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present7(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier8(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value8(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present8(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier9(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value9(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present9(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_qualifier10(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_value10(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
  static void create_present10(
      Widget w, WUted* utedctx, XmAnyCallbackStruct* data);
