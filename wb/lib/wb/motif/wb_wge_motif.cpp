...
void WGeMotif::activate_value_input(
    Widget w, WGe* ge, XmAnyCallbackStruct* data)
{
  char* text;
...
void WGeMotif::activate_confirm_cancel(
    Widget w, WGe* ge, XmAnyCallbackStruct* data)
{
  ge->confirm_open = 0;
  XtUnmanageChild(((WGeMotif*)ge)->confirm_widget);
...
WGeMotif::WGeMotif(Widget wge_parent_wid, void* wge_parent_ctx, char* wge_name,
    ...
    : WGe(wge_parent_ctx, wge_name, wge_filename, wge_scrollbar, wge_menu,
      ...
      parent_wid(wge_parent_wid), value_dialog(0), set_focus_disabled(0),
      focus_timerid(0)
{
...
<FocusIn>: wge_inputfocus()";
  ...
  static MrmRegisterArg reglist[] = { { (char*)"wge_ctx", 0 },
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"wge_window", toplevel, wname,
      args, 1, &wge_widget, &dclass);
  if (sts != MrmSUCCESS)
