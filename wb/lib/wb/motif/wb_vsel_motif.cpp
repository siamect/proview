    ...
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
  ...
  if (XmListGetSelectedPos(vsel->widgets.volumelist, &pos_list, &pos_cnt)) {
    for (i = 0; i < pos_cnt; i++) {
...
void WVselMotif::activate_cancel(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
  if (vsel->vsel_bc_cancel != NULL)
    (vsel->vsel_bc_cancel)();
...
void WVselMotif::activate_close(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
...
void WVselMotif::activate_showall(
...
void WVselMotif::create_label(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
  vsel->widgets.label = w;
}

void WVselMotif::create_adb(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
  vsel->widgets.adb = w;
}

void WVselMotif::destroy_adb(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
}

void WVselMotif::action_volumelist(
...
void WVselMotif::create_volumelist(
    Widget w, WVselMotif* vsel, XmAnyCallbackStruct* data)
{
  pwr_tStatus sts;
...
WVselMotif::WVselMotif(pwr_tStatus* status, void* wv_parent_ctx,
    Widget wv_parent_wid, const char* wv_name, ldh_tWBContext wv_wbctx,
      ...
      parent_wid(wv_parent_wid)
{
  ...
  static MrmRegisterArg reglist[] = { /* First the context variable */
    { (char*)"vsel_ctx", 0 }, { (char*)"vsel_write_priv", 0 },
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"vsel_window", widgets.toplevel,
      name, args, 1, &widgets.vsel_window, &dclass);
