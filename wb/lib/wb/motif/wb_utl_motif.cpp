...
int wb_utl_motif::utl_foe_new_local(WFoe* foe, const char* name,
    pwr_tOid plcpgm, ldh_tWBContext ldhwbctx, ldh_tSesContext ldhsesctx,
    vldh_t_node nodeobject, unsigned long windowindex, unsigned long new_window,
    WFoe** return_foe, int map_window, ldh_eAccess access,
  ...
  *return_foe = WFoe::get(plcpgm);
  if (!*return_foe)
    *return_foe = new WFoeMotif(foe, ((WFoeMotif*)foe)->widgets.foe_window,
        name, plcpgm, ldhwbctx, ldhsesctx, nodeobject, windowindex, new_window,
