...
//
void WdaMotif::activate_change_value(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->change_value(1);
}

void WdaMotif::activate_close_changeval(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
...
void WdaMotif::activate_print(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  ((Wda*)wda)->activate_print();
}
void WdaMotif::activate_setclass(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  ((Wda*)wda)->open_class_dialog();
}

void WdaMotif::activate_setattr(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->open_attr_dialog();
}

void WdaMotif::activate_nextattr(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  int sts;
...
void WdaMotif::activate_prevattr(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  int sts;
...
void WdaMotif::create_msg_label(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->msg_label = w;
}
void WdaMotif::create_cmd_prompt(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->cmd_prompt = w;
}
void WdaMotif::create_cmd_input(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  Arg args[2];
...
void WdaMotif::create_cmd_scrolledinput(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->cmd_scrolledinput = w;
}
void WdaMotif::create_cmd_scrolled_ok(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->cmd_scrolled_ok = w;
}
void WdaMotif::create_cmd_scrolled_ca(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->cmd_scrolled_ca = w;
}

void WdaMotif::create_wdanav_form(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->wdanav_form = w;
}
void WdaMotif::class_create_hiervalue(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->wdaclass_hiervalue = w;
}

void WdaMotif::class_create_classvalue(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->wdaclass_classvalue = w;
}

void WdaMotif::class_create_attrobjects(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  wda->wdaclass_attrobjects = w;
}

void WdaMotif::class_activate_ok(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  char* hiername;
  char* classname;
  ...
  if (wda->classid != new_classid) {
    ...
    sts = ((WdaNav*)wda->wdanav)
              ->update(
                  wda->objid, wda->classid, wda->attribute, wda->attrobjects);
    if (EVEN(sts))
      wda->wow->DisplayError("Spreadsheet error", wnav_get_message(sts));
  }
}

void WdaMotif::class_activate_cancel(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(wda->wdaclass_dia);
}
...
void WdaMotif::disable_set_focus(WdaMotif* wda, int time)
{
  wda->set_focus_disabled++;
  wda->focus_timerid
      = XtAppAddTimeOut(XtWidgetToApplicationContext(wda->toplevel), time,
...
void WdaMotif::valchanged_cmd_input(Widget w, XEvent* event)
{
  ...
  if (sts) {
    ...
    if (wda->input_open) {
      sts = ((WdaNav*)wda->wdanav)
                ->set_attr_value(wda->input_node, wda->input_name, text);
      XtUnmanageChild(w);
      wda->set_prompt("");
      wda->input_open = 0;
      if (wda->redraw_cb)
...
void WdaMotif::change_value_close()
{
  ...
  if (input_open) {
    if (input_multiline) {
      sts = ((WdaNav*)wdanav)->set_attr_value(input_node, input_name, text);
...
void WdaMotif::activate_cmd_scrolled_ok(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  char* text;
  int sts;
...
void WdaMotif::activate_cmd_scrolled_ca(
    Widget w, WdaMotif* wda, XmAnyCallbackStruct* data)
{
  if (wda->input_open) {
    XtUnmanageChild(wda->cmd_scrolledinput);
...
void WdaMotif::open_class_dialog(char* hierstr, char* classstr)
{
  ...
  XmToggleButtonSetState(wdaclass_attrobjects, (Boolean)attrobjects, False);
...
WdaMotif::WdaMotif(Widget wa_parent_wid, void* wa_parent_ctx,
      ...
      parent_wid(wa_parent_wid), set_focus_disabled(0), value_current_recall(0)
{
  ...
  static char translations[] = "<FocusIn>: wda_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[]
      = { { (char*)"wda_inputfocus", (XtActionProc)action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"wda_ctx", 0 },
    ...
    { (char*)"wda_activate_close_changeval",
    ...
    { (char*)"wda_create_cmd_scrolledinput",
    ...
    { (char*)"wda_activate_cmd_scrolled_ok",
        (caddr_t)activate_cmd_scrolled_ok },
    { (char*)"wda_activate_cmd_scrolled_ca",
    ...
    { (char*)"wdaclass_create_attrobjects",
        (caddr_t)class_create_attrobjects } };
  ...
  parent_wid = XtCreatePopupShell(
      "spreadSheetEditor", topLevelShellWidgetClass, parent_wid, args, 0);

  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"wda_window", parent_wid, name,
      args, 1, &toplevel, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch %s\n", name);

  sts = MrmFetchWidget(
      s_DRMh, (char*)"wdaclass_dia", parent_wid, &wdaclass_dia, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch class input dialog\n");
  ...
  wdanav = new WdaNavMotif((void*)this, wdanav_form, "Plant", ldhses, objid,
      classid, attribute, wa_editmode, wa_advanced_user, wa_display_objectname,
