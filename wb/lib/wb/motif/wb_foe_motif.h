...
public:
  ...
  WFoeMotif(void* f_parent_ctx, Widget f_parent_wid, const char* f_name,
  ...
  static void activate_changetext(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  ...
  static void activate_attribute(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_subwindow(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  ...
  static void activate_gridsize1(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_gridsize2(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_gridsize3(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_gridsize4(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_gridsize5(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_showgrid(
  ...
  static void activate_palette_con(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_palette_object(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_palette_plant(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_refcon(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_showexeord(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_plcattribute(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_search(Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_searchobject(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_searchstring(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_searchnext(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  ...
  static void activate_helpclass(
      Widget w, WFoe* foe, XmAnyCallbackStruct* data);
  static void activate_trace_togg(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_simulate_togg(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_view_togg(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
  static void activate_edit_togg(
      Widget w, WFoe* foe, XmToggleButtonCallbackStruct* data);
