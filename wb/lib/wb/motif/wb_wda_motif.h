...
public:
  WdaMotif(Widget wa_parent_wid, void* wa_parent_ctx, ldh_tSesContext wa_ldhses,
  ...
  static void activate_close_changeval(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_exit(Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_print(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_setclass(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_setattr(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_nextattr(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_prevattr(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_help(Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_cmd_input(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  ...
  static void create_cmd_input(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void create_cmd_scrolledinput(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void create_cmd_scrolled_ok(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void create_cmd_scrolled_ca(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void create_wdanav_form(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void class_create_hiervalue(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void class_create_classvalue(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void class_create_attrobjects(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void class_activate_ok(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void class_activate_cancel(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void action_inputfocus(Widget w, XmAnyCallbackStruct* data);
  static void valchanged_cmd_input(Widget w, XEvent* event);
  static void activate_cmd_scrolled_ok(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
  static void activate_cmd_scrolled_ca(
      Widget w, WdaMotif* wda, XmAnyCallbackStruct* data);
};
