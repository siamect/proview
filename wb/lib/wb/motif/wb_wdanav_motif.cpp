...
//
WdaNavMotif::WdaNavMotif(void* wa_parent_ctx, Widget wa_parent_wid,
...
static void wdanav_trace_scan(WdaNavMotif* wdanav)
{
  ...
  if (wdanav->trace_started) {
    ...
    wdanav->trace_timerid
        = XtAppAddTimeOut(XtWidgetToApplicationContext(wdanav->brow_widget),
            time, (XtTimerCallbackProc)wdanav_trace_scan, wdanav);
  }
}
