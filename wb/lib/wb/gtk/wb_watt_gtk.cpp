...
void WAttGtk::action_text_inserted(
...
gboolean WAttGtk::action_inputfocus(
    GtkWidget* w, GdkEvent* event, gpointer data)
{
  ...
  g_object_get(
      watt->cmd_scrolledinput, "visible", &scrolledinput_visible, NULL);
...
void WAttGtk::print(const char* title)
{
  ...
  CoWowGtk::CreateBrowPrintDialogGtk(title, wattnav->brow->ctx,
  ...
  if (input_open) {
    if (input_multiline) {
      ...
      if (text) {
        ...
        sts = wattnav->set_attr_value(input_node, input_name, text);
        g_free(text);
      }
      g_object_set(cmd_scrolledinput, "visible", FALSE, NULL);
      set_prompt("");
