...
public:
  WNavGtk(void* xn_parent_ctx, GtkWidget* xn_parent_wid, const char* xn_name,
      const char* xn_layout, GtkWidget** w, ldh_tSesContext xn_ldhses,
