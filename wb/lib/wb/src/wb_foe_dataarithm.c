...
) 
{
	...
	{
	  sprintf( out, 
		"Da1 */ memcpy( &%s->OutData1, %s->DataIn1P, sizeof(pwr_tDataRef))", var, var);
	...
	{
	  sprintf( out, 
		"Da1 */ memcpy( &%s->OutData2, %s->DataIn1P, sizeof(pwr_tDataRef))", var, var);
	...
	{
	  sprintf( out, 
		"Da1 */ memcpy( &%s->OutData3, %s->DataIn1P, sizeof(pwr_tDataRef))", var, var);
	...
	{
	  sprintf( out, 
		"Da1 */ memcpy( &%s->OutData4, %s->DataIn1P, sizeof(pwr_tDataRef))", var, var);
...
) 
{
	...
	{
	  sprintf( out,
		"Da2 */ memcpy( &%s->OutData1, %s->DataIn2P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata1_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da2 */ memcpy( &%s->OutData2, %s->DataIn2P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata2_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da2 */ memcpy( &%s->OutData3, %s->DataIn2P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata3_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da2 */ memcpy( &%s->OutData4, %s->DataIn2P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata4_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS;
	}
...
) 
{
	...
	{
	  sprintf( out, 
		"Da3 */ memcpy( &%s->OutData1, %s->DataIn3P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata1_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da3 */ memcpy( &%s->OutData2, %s->DataIn3P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata2_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da3 */ memcpy( &%s->OutData3, %s->DataIn3P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata3_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da3 */ memcpy( &%s->OutData4, %s->DataIn3P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata4_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS;
	}
...
) 
{
	...
	{
	  sprintf( out, 
		"Da4 */ memcpy( &%s->OutData1, %s->DataIn4P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata1_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da4 */ memcpy( &%s->OutData2, %s->DataIn4P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata2_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da4 */ memcpy( &%s->OutData3, %s->DataIn4P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata3_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS; 
	}
	...
	{
	  sprintf( out, 
		"Da4 */ memcpy( &%s->OutData4, %s->DataIn4P, sizeof(pwr_tDataRef))", var, var);
	  dataactx->outdata4_eq_indata = 0;
	  *incr = strlen(out);
	  return GSX__SUCCESS;
	}
...
) 
{
	...
	if ( !dataactx->outdata1_eq_indata )
	  sprintf( out, "(%s->OutData1.Ptr)", var);
	*incr = strlen(out);
	return GSX__SUCCESS; 
}
...
) 
{
	...
	if ( !dataactx->outdata2_eq_indata )
	  sprintf( out, "(%s->OutData2.Ptr)", var);
	*incr = strlen(out);
	return GSX__SUCCESS; 
}
...
) 
{
	...
	if ( !dataactx->outdata3_eq_indata )
	  sprintf( out, "(%s->OutData3.Ptr)", var);
	*incr = strlen(out);
	return GSX__SUCCESS; 
}
