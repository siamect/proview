...
int goec_con_delete_ref(WGre* gre, vldh_t_con con_object);

int goec_con_delete_ref_noredraw(WGre* gre, vldh_t_con con_object);

int goec_con_redraw_ref(WGre* gre, vldh_t_node node);
