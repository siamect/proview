/* 
 * Proview   $Id: wb_goenm10.h,v 1.1 2007-01-04 07:29:03 claes Exp $
...
int goen_create_nodetype_m10( pwr_sGraphPlcNode	*graphbody,
			     pwr_tClassId	cid,
...
int goen_get_point_info_m10( WGre *grectx, pwr_sGraphPlcNode *graphbody, 
			    unsigned long point, unsigned long *mask, 
			    unsigned long node_width, goen_conpoint_type *info_pointer, 
			    vldh_t_node node);

int	goen_get_parameter_m10( pwr_sGraphPlcNode *graphbody, pwr_tClassId cid, 
...
int goen_get_location_point_m10( WGre *grectx, pwr_sGraphPlcNode *graphbody, 
