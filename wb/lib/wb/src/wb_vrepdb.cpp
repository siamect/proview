...
wb_vrepdb::wb_vrepdb(wb_erep* erep, pwr_tVid vid, pwr_tCid cid,
...
wb_orep* wb_vrepdb::copyObject(pwr_tStatus* sts, const wb_orep* orep,
...
wb_orep* wb_vrepdb::createObject(pwr_tStatus* sts, wb_cdef cdef,
    wb_destination& d, wb_name& name, pwr_tOix oix)
{
  *sts = LDH__SUCCESS;
  wb_db_txn* txn = m_db->begin(m_db->m_txn);
...
bool wb_vrepdb::writeAttribute(pwr_tStatus* sts, wb_orep* orp, pwr_eBix bix,
...
void* wb_vrepdb::readAttribute(pwr_tStatus* sts, const wb_orep* orp,
...
int wb_vrepdb::checkClass(pwr_tCid cid)
{
  wb_cdrep* o_crep = 0;
  wb_cdrep* n_crep = 0;
...
int wb_vrepdb::updateObject(pwr_tOid oid, pwr_tCid cid)
{
  pwr_tStatus sts;
...
void wb_vrepdb::checkSubClass(pwr_tCid cid, pwr_tCid subcid,
