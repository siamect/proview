...
pwr_dImport pwr_BindMethods(OpPlaceWeb);
...
pwr_dExport pwr_BindClasses(Base) = { pwr_BindClass(ASup),
  ...
  pwr_BindClass(DSup), pwr_BindClass(PlcPgm), pwr_BindClass(PlcEmbed),
  pwr_BindClass(ProjectReg), pwr_BindClass(RootVolumeConfig),
  pwr_BindClass(SubVolumeConfig), pwr_BindClass(SharedVolumeConfig),
  pwr_BindClass(ClassVolumeConfig), pwr_BindClass(ChanDi),
  pwr_BindClass(ChanDo), pwr_BindClass(ChanAi), pwr_BindClass(ChanAit),
  pwr_BindClass(ChanAo), pwr_BindClass(ChanCo), pwr_BindClass(ChanIi),
  pwr_BindClass(ChanIo), pwr_BindClass(Di), pwr_BindClass(Do),
  pwr_BindClass(Ai), pwr_BindClass(Ao), pwr_BindClass(Co), pwr_BindClass(Po),
  pwr_BindClass(Ii), pwr_BindClass(Io), pwr_BindClass(XttGraph),
  pwr_BindClass(WebGraph), pwr_BindClass(OpPlace), pwr_BindClass(OpPlaceWeb),
