...
bool wb_dbs::importVolume(wb_export& e)
{
  e.exportHead(*this);
  buildSectName();
  checkObject(m_oep);
...
void wb_dbs::checkObject(sOentry* oep)
{
  int nChild = 0;
  pwr_tStatus sts;
  dbs_sQlink* sib_lh;
...
pwr_tStatus wb_dbs::closeFile(pwr_tBoolean doDelete)
{
  if (m_fp != NULL)
    fclose(m_fp);
...
pwr_tBoolean wb_dbs::createFile()
{
  pwr_tStatus sts;
  int size;
...
pwr_tStatus wb_dbs::writeSectFile(size_t size)
{
  ...
  if (fwrite(f, sizeof(f), 1, m_fp) < 1)
    return LDH__FILEWRITE;

  return LDH__SUCCESS;
}

pwr_tStatus wb_dbs::writeSectDirectory()
{
...
pwr_tStatus wb_dbs::writeSectVolume()
{
...
pwr_tStatus wb_dbs::prepareSectVolref()
{
...
pwr_tStatus wb_dbs::writeSectVolref(size_t size)
{
  pwr_tStatus sts;
...
static pwr_tStatus copyFile(FILE* sfp, FILE* tfp, size_t size)
{
  char buf[512];
  size_t bytes;
...
pwr_tStatus wb_dbs::writeReferencedVolumes()
{
  pwr_tStatus sts;
...
pwr_tStatus wb_dbs::writeSectOid()
{
  sOentry* oep;
...
static pwr_tStatus writeTree(wb_dbs::sOentry* oep, FILE* fp)
{
  pwr_tStatus sts;
...
pwr_tStatus wb_dbs::writeSectObject()
{
...
bool wb_dbs::importDbody(pwr_tOid oid, size_t size, void* body)
{
  pwr_tStatus sts;
  sOentry* oep;
...
pwr_tStatus wb_dbs::writeSectDbody()
{
...
bool wb_dbs::importRbody(pwr_tOid oid, size_t size, void* body)
{
  pwr_tStatus sts;
  sOentry* oep;
  char b[dbs_dAlign(sizeof(dbs_sBody))];
...
pwr_tStatus wb_dbs::writeSectRbody()
{
...
pwr_tStatus wb_dbs::writeSectName()
{
  sNentry* nep;
...
pwr_tStatus wb_dbs::writeSectClass()
{
  sCentry* cep;
...
void wb_dbs::classInsert(sOentry* oep)
{
  pwr_tStatus sts;
  sCentry* cep;
