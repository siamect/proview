  ...
  */
  ...
  case pwr_cClass_ChanAo:
    sts = ldh_ReadObjectBody(
        Session, Channel, "RtBody", &ChanAo, sizeof(ChanAo));
    if (EVEN(sts))
      return sts;
    ...
    ChanAo.Number = i;
    sts = ldh_SetObjectBody(
        Session, Channel, "RtBody", (char*)&ChanAo, sizeof(ChanAo));
...
pwr_dExport pwr_BindMethods(Ao_HVAO4) = { pwr_BindMethod(AnteAdopt),
