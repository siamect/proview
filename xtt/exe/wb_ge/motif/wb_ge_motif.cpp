...
int main(int argc, char* argv[])
{
  ...
  toplevel = XtVaAppInitialize(&app_ctx, "mainwindow", NULL, 0, &argc, argv,
      fbr, XtNallowShellResize, True, XtNtitle, title, XmNmappedWhenManaged,
      False, NULL);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"mainwindow", toplevel, name,
      NULL, 0, &mainwindow, &dclass);
  if (sts != MrmSUCCESS)
  ...
  // Create help window
  CoXHelpMotif* xhelp
      = new CoXHelpMotif(mainwindow, 0, xhelp_eUtility_Wtt, (int*)&sts);
