...
void XttMotif::hotkey_ToggleDig(
    Widget w, XKeyEvent* ev, String* av, Cardinal* ac)
{
  if (ev->type != KeyPress)
    return;
...
void XttMotif::close(void* ctx, int terminate)
{
  ...
  if (terminate) {
    xtt->wow->DisplayQuestion(
        xtt, "Confirm", "Do you want to close", close_ok, 0, 0);
    // delete xtt->xnav;
    // exit(0);
  } else {
...
//
void XttMotif::activate_change_value(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
...
void XttMotif::activate_openobject(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
...
void XttMotif::activate_showcrossref(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
...
void XttMotif::activate_collect_insert(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->activate_collect_insert();
}

void XttMotif::activate_collect_show(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->xnav->collect_show();
}

void XttMotif::activate_collect_remove(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->xnav->collect_remove();
}

void XttMotif::activate_collect_clear(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->xnav->collect_clear();
}

void XttMotif::activate_advanceduser(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
...
void XttMotif::activate_zoom_reset(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->xnav->unzoom();
}
...
void XttMotif::activate_help_project(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  xtt->activate_help_project();
}

void XttMotif::activate_help_proview(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
...
void XttMotif::activate_india_cancel(
    Widget w, Xtt* xtt, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((XttMotif*)xtt)->india_widget);
}
...
void XttMotif::valchanged_cmd_input(
    Widget w, XEvent* event, XmAnyCallbackStruct* data)
{
  Xtt* xtt;
  int sts;
  char* text;
  ...
  if (xtt->input_open)
    sts = mrm_TextInput(w, event, (char*)((XttMotif*)xtt)->value_recall,
        sizeof(((XttMotif*)xtt)->value_recall[0]),
        sizeof(((XttMotif*)xtt)->value_recall)
            / sizeof(((XttMotif*)xtt)->value_recall[0]),
        &((XttMotif*)xtt)->value_current_recall);
  else
    sts = mrm_TextInput(w, event, (char*)((XttMotif*)xtt)->cmd_recall,
        sizeof(((XttMotif*)xtt)->cmd_recall[0]),
        sizeof(((XttMotif*)xtt)->cmd_recall)
            / sizeof(((XttMotif*)xtt)->cmd_recall[0]),
...
XttMotif::XttMotif(int argc, char* argv[], int* return_sts)
    : Xtt(&argc, &argv, return_sts), cmd_current_recall(0),
      value_current_recall(0)
{
  ...
  static char translations[] = "<FocusIn>: xtt_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[]
      = { { (char*)"xtt_inputfocus", (XtActionProc)action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"xtt_ctx", 0 },
  ...
  toplevel = XtVaAppInitialize(&app_ctx, "Rt_xtt", NULL, 0, &argc, argv, fbr,
      XtNallowShellResize, True, XtNtitle, title, XmNmappedWhenManaged, True,
      NULL);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"xtt_window", toplevel, title,
      args, i, &xtt_widget, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch xtt_window\n");
  ...
  xnav = new XNavMotif(this, xnav_form, "Plant", &brow_widget,
