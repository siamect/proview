...
public:
  ...
  static void activate_collect_insert(
      Widget w, Xtt* xtt, XmAnyCallbackStruct* data);
  static void activate_collect_show(
      Widget w, Xtt* xtt, XmAnyCallbackStruct* data);
  static void activate_collect_remove(
      Widget w, Xtt* xtt, XmAnyCallbackStruct* data);
  static void activate_collect_clear(
      Widget w, Xtt* xtt, XmAnyCallbackStruct* data);
  static void activate_advanceduser(
      Widget w, Xtt* xtt, XmAnyCallbackStruct* data);
