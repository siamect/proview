...
ifeq ($(export_type),exp)			 
  link = $(ldxx) $(explinkflags) $(domap) -o $(pwr_exe)/rt_xtt_cmd_gtk \
	$(bld_dir)/rt_xtt_cmd_gtk.o $(bld_dir)/xtt_cmd_main.o $(rt_msg_eobjs) \
  ...
  link = $(ldxx) $(elinkflags) $(domap) -o $(pwr_exe)/rt_xtt_cmd_gtk \
	$(bld_dir)/rt_xtt_cmd_gtk.o $(bld_dir)/xtt_cmd_main.o $(rt_msg_eobjs) \
	$(pwr_eobj)/rt_io_user.o \
	$(pwre_conf_libdir) $(pwre_conf_libpwrxttgtk) $(pwre_conf_libpwrxtt) \
	$(pwre_conf_libpwrxttgtk) $(pwre_conf_libpwrxtt) \
