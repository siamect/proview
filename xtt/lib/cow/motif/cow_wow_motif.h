...
public:
  ...
  static void question_ok_cb(
      Widget dialog, XtPointer data, XmAnyCallbackStruct* cbs);
  static void question_cancel_cb(
      Widget dialog, XtPointer data, XmAnyCallbackStruct* cbs);
  static void question_help_cb(
      Widget dialog, XtPointer data, XmAnyCallbackStruct* cbs);
  static void list_ok_cb(Widget w, XtPointer data, XmAnyCallbackStruct* cbs);
  static void list_cancel_cb(
      Widget w, XtPointer data, XmAnyCallbackStruct* cbs);
  static void list_action_cb(
