...
public:
  CoXHelpMotif(Widget xa_parent_wid, void* xa_parent_ctx,
  ...
  static void open_input_dialog(CoXHelpMotif* xhelp, const char* text,
  ...
  static void activate_zoom_reset(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_search(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_searchnext(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_searchprevious(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void create_india_label(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void create_india_text(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_india_ok(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_india_cancel(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void activate_help(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
  static void create_xhelpnav_form(
      Widget w, CoXHelpMotif* xhelp, XmAnyCallbackStruct* data);
