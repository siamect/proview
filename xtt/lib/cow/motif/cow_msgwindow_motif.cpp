...
MsgWindowMotif::MsgWindowMotif(void* msg_parent_ctx, Widget msg_parent_wid,
    ...
    : MsgWindow(msg_parent_ctx, msg_name, status), parent_wid(msg_parent_wid)
{
  ...
  static char msg_translations[] = "<FocusIn>: msg_inputfocus()\n";
  ...
  static MrmRegisterArg reglist[] = { { (char*)"msg_ctx", 0 },
  ...
  *status = 1;
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"msg_window", parent_wid, name,
  ...
  if (msg_compiled_translations == NULL) {
    XtAppAddActions(XtWidgetToApplicationContext(toplevel), msg_actions,
        XtNumber(msg_actions));
...
void MsgWindowMotif::activate_exit(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  flow_UnmapWidget(((MsgWindowMotif*)msgw)->parent_wid);
  msgw->displayed = 0;
}

void MsgWindowMotif::activate_clear(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  msgw->msgnav->clear();
  msgw->size = 0;
...
void MsgWindowMotif::activate_zoom_in(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  msgw->msgnav->zoom(1.2);
}

void MsgWindowMotif::activate_zoom_out(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  msgw->msgnav->zoom(5.0 / 6);
}

void MsgWindowMotif::activate_zoom_reset(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  msgw->msgnav->unzoom();
}

void MsgWindowMotif::activate_help(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
...
void MsgWindowMotif::activate_help_message(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
  CoXHelp::dhelp("message window", 0, navh_eHelpFile_Base, 0, true);
}

void MsgWindowMotif::create_form(
    Widget w, MsgWindow* msgw, XmAnyCallbackStruct* data)
{
