...
//
void CoLoginMotif::activate_ok(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
...
//	Callback from the pushbutton.
//
void CoLoginMotif::activate_cancel(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  loginctx->activate_cancel();
}

void CoLoginMotif::create_label(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  ((CoLoginMotif*)loginctx)->widgets.label = w;
}

void CoLoginMotif::create_adb(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  ((CoLoginMotif*)loginctx)->widgets.adb = w;
}

void CoLoginMotif::create_usernamevalue(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  ((CoLoginMotif*)loginctx)->widgets.usernamevalue = w;
}

void CoLoginMotif::create_passwordvalue(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
...
//
void CoLoginMotif::valchanged_passwordvalue(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  char* value;
  int sts;
  ...
  if (s == 0) {
    ...
    XtFree(value);
    XmTextSetString(
        ((CoLoginMotif*)loginctx)->widgets.passwordvalue, (char*)"");
    return;
  }
...
//	Callback when value changed.
//
void CoLoginMotif::valchanged_usernamevalue(
    Widget w, CoLogin* loginctx, XmAnyCallbackStruct* data)
{
  char* value;
  char* s;
...
// Constructor
//
CoLoginMotif::CoLoginMotif(void* wl_parent_ctx, Widget wl_parent_wid,
      ...
      parent_wid(wl_parent_wid)
{
  ...
  static MrmRegisterArg reglist[] = {
    ...
    { (char*)"login_valchanged_usernamevalue",
        (caddr_t)valchanged_usernamevalue },
    { (char*)"login_valchanged_passwordvalue",
        (caddr_t)valchanged_passwordvalue },
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"login_window", widgets.toplevel,
      name, args, 1, &widgets.login_window, &dclass);
