				...
				void		*client_flag)
{
  ...
  else if ( cdh_NoCaseStrncmp( arg1_str, "TEXT", strlen( arg1_str)) == 0)
  {
    ...
    grow_CreateGrowText( graph->grow->ctx, "", text_str,
			 x1, y1,
			 drawtype, text_color, textsize, 
			 graph->textfont, glow_mDisplayLevel_1,
  ...
  else if ( cdh_NoCaseStrncmp( arg1_str, "IMAGE", strlen( arg1_str)) == 0)
  {
    ...
    grow_CreateGrowImage( graph->grow->ctx, name, image_str, 
			  x1, y1, NULL, &i1);
...
int Graph::readcmdfile( 	char		*incommand)
{
  ...
  if ( !ccm_func_registred)
  {
    ...
    sts = ccm_create_external_var( "mDynType1_SliderBackground", CCM_DECL_INT, 0, ge_mDynType1_SliderBackground, 0);
    ...
    sts = ccm_create_external_var( "mDynType2_ColorThemeLightness", CCM_DECL_INT, 0, ge_mDynType2_ColorThemeLightness, 0);
    sts = ccm_create_external_var( "mDynType2_DigBackgroundColor", CCM_DECL_INT, 0, ge_mDynType2_DigBackgroundColor, 0);
    ...
    sts = ccm_create_external_var( "mActionType1_CommandDoubleClick", CCM_DECL_INT, 0, ge_mActionType1_CommandDoubleClick, 0);
    ...
    sts = ccm_create_external_var( "mActionType1_PulldownMenu", CCM_DECL_INT, 0, ge_mActionType1_PulldownMenu, 0);
    ...
    sts = ccm_create_external_var( "mActionType1_MethodToolbar", CCM_DECL_INT, 0, ge_mActionType1_MethodToolbar, 0);
    sts = ccm_create_external_var( "mActionType1_MethodPulldownMenu", CCM_DECL_INT, 0, ge_mActionType1_MethodPulldownMenu, 0);
