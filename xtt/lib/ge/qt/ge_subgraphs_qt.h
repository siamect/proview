...
public slots:
  void trace_scan();
  void subgraphs_activate_attr();
  void subgraphs_activate_set_extern();
  void subgraphs_activate_set_intern();
  void subgraphs_activate_set_all_intern();
  void subgraphs_activate_set_all_extern();
