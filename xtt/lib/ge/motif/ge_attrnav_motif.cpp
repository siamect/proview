...
//
AttrNavMotif::AttrNavMotif(void* xn_parent_ctx, Widget xn_parent_wid,
    const char* xn_name, attr_sItem* xn_itemlist, int xn_item_cnt, Widget* w,
    pwr_tStatus* status)
...
void AttrNavMotif::trace_scan(AttrNav* attrnav)
{
  ...
  if (attrnav->trace_started) {
    ...
    ((AttrNavMotif*)attrnav)->trace_timerid = XtAppAddTimeOut(
        XtWidgetToApplicationContext(((AttrNavMotif*)attrnav)->brow_widget),
        time, (XtTimerCallbackProc)AttrNavMotif::trace_scan, attrnav);
  }
}
