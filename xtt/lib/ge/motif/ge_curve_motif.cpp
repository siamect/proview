...
void GeCurveMotif::activate_exit(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve->activate_exit();
}

void GeCurveMotif::activate_configure(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve->activate_configure();
}

void GeCurveMotif::activate_print(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve->activate_print();
}

void GeCurveMotif::activate_zoomin(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve_Zoom(curve->growcurve_ctx, 2.0);
}

void GeCurveMotif::activate_zoomout(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve_Zoom(curve->growcurve_ctx, 0.5);
}

void GeCurveMotif::activate_zoomreset(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
}

void GeCurveMotif::activate_background(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve->activate_background();
}

void GeCurveMotif::activate_showname(
    Widget w, GeCurve* curve, XmToggleButtonCallbackStruct* data)
{
}

void GeCurveMotif::activate_filledcurves(
    Widget w, GeCurve* curve, XmToggleButtonCallbackStruct* data)
{
  curve->activate_filledcurves(data->set);
}

void GeCurveMotif::activate_xlimits(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  char value_str[80];
...
void GeCurveMotif::activate_help(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  curve->activate_help();
}

void GeCurveMotif::create_pane(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->pane_widget = w;
}

void GeCurveMotif::create_growform(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->axisform_widget = w;
}

void GeCurveMotif::create_nameform(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->nameform_widget = w;
}

void GeCurveMotif::create_curveform(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->curveform_widget = w;
}

void GeCurveMotif::create_minmax_textmin(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->minmax_textmin_widget = w;
}

void GeCurveMotif::create_minmax_textmax(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  ((GeCurveMotif*)curve)->minmax_textmax_widget = w;
}

void GeCurveMotif::activate_minmax_ok(
    Widget w, GeCurve* curve, XmAnyCallbackStruct* data)
{
  char* value;
...
GeCurveMotif::GeCurveMotif(void* gc_parent_ctx, Widget parent_widget,
          ...
          gc_width, gc_height, gc_options)
{
  ...
  static MrmRegisterArg reglist[] = { { (char*)"gec_ctx", 0 },
  ...
  toplevel = XtCreatePopupShell(
      title, topLevelShellWidgetClass, parent_widget, args, 0);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"ge_curve_window", toplevel, name,
      NULL, 0, &ge_curve_widget, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch %s\n", name);

  sts = MrmFetchWidget(
      s_DRMh, (char*)"minmax_dialog", toplevel, &minmax_widget, &dclass);
  if (sts != MrmSUCCESS)
  ...
  i = 0;
  XtSetArg(args[i], XmNwidth, gc_width);
  i++;
  XtSetArg(args[i], XmNheight, gc_height);
  i++;
  ...
  grownames_main_widget = ScrolledGrowCreate(nameform_widget,
      (char*)"GeCurveNames", NULL, 0, init_grownames_cb, this, &w);
  i = 0;
  ...
  growaxis_main_widget = GrowCreate(
      axisform_widget, (char*)"GeCurveAxis", NULL, 0, init_growaxis_cb, this);
  i = 0;
  XtSetArg(args[i], XmNwidth, 200);
  i++;
  ...
  growcurve_main_widget = CurveCreate(
      curveform_widget, (char*)"GeCurve", NULL, 0, init_growcurve_cb, this);
  ...
  i++;
  XtSetArg(args[i], XmNpaneMaximum, 100);
  i++;
  nav_widget = CurveCreateNav(
      pane_widget, (char*)"navigator", args, i, growcurve_main_widget);
