    ...
    void (*yes_cb)(Ge*), void (*no_cb)(Ge*))
{
  ...
  XtSetArg(args[0], XmNmessageString,
      XmStringCreateLtoR((char*)text, (char*)"ISO8859-1"));
...
void GeMotif::confirm_cb(void* ge_ctx, void* confirm_object, char* text)
{
  ...
  XtSetArg(
      args[0], XmNmessageString, XmStringCreateLtoR(text, (char*)"ISO8859-1"));
...
//
void GeMotif::activate_change_text(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_change_text();
}

void GeMotif::activate_change_name(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_change_name();
}

void GeMotif::activate_preview_start(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_preview_start();
}

void GeMotif::activate_preview_stop(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_flip_horiz(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_edit_polyline(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_edit_polyline();
}

void GeMotif::activate_scale_equal(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_scale_equal();
}

void GeMotif::activate_move_horizontal(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_move_horizontal();
}

void GeMotif::activate_move_vertical(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_move_vertical();
}

void GeMotif::activate_move_reset(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_move_reset();
}

void GeMotif::activate_align_horiz_up(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_horiz_up();
}

void GeMotif::activate_align_horiz_down(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_horiz_down();
}

void GeMotif::activate_align_horiz_center(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_horiz_center();
}

void GeMotif::activate_align_vert_left(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_vert_left();
}

void GeMotif::activate_align_vert_right(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_vert_right();
}

void GeMotif::activate_align_vert_center(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_align_vert_center();
}

void GeMotif::activate_equid_vert_up(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_vert_up();
}

void GeMotif::activate_equid_vert_down(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_vert_down();
}

void GeMotif::activate_equid_vert_center(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_vert_center();
}

void GeMotif::activate_equid_horiz_left(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_horiz_left();
}

void GeMotif::activate_equid_horiz_right(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_horiz_right();
}

void GeMotif::activate_equid_horiz_center(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_equid_horiz_center();
}

void GeMotif::activate_select_cons(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_select_cons();
}

void GeMotif::activate_select_objects(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_connectsecond(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_connectsecond();
}

void GeMotif::activate_objectattributes(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_objectattributes();
}

void GeMotif::activate_show_grid(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
...
void GeMotif::activate_export_javabean(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_javabean();
}

void GeMotif::activate_export_javabean_as(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_javabean_as();
}

void GeMotif::activate_export_gejava(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_gejava();
}

void GeMotif::activate_export_gejava_as(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_gejava_as();
}

void GeMotif::activate_export_java(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_java();
}

void GeMotif::activate_export_java_as(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_export_java_as();
}

void GeMotif::activate_creanextpage(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_graph_attr(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_rectrounded(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  bool keep = false;
...
void GeMotif::activate_fill(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
  gectx->activate_fill(data->set);
}

void GeMotif::activate_border(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
  gectx->activate_border(data->set);
}

void GeMotif::activate_shadow(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
  gectx->activate_shadow(data->set);
}

void GeMotif::activate_incr_lightness(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_incr_lightness();
}

void GeMotif::activate_decr_lightness(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_decr_lightness();
}

void GeMotif::activate_incr_intensity(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_incr_intensity();
}

void GeMotif::activate_decr_intensity(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_decr_intensity();
}

void GeMotif::activate_incr_shift(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_incr_shift();
}

void GeMotif::activate_decr_shift(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_grid(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
  gectx->activate_grid(data->set);
}

void GeMotif::activate_linewidth_1(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(1);
}
void GeMotif::activate_linewidth_2(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(2);
}
void GeMotif::activate_linewidth_3(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(3);
}
void GeMotif::activate_linewidth_4(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(4);
}
void GeMotif::activate_linewidth_5(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(5);
}
void GeMotif::activate_linewidth_6(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(6);
}
void GeMotif::activate_linewidth_7(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_linewidth(7);
}
void GeMotif::activate_linewidth_8(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_gridsize_4(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_gridsize(1);
}

void GeMotif::activate_gridsize_3(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_gridsize(0.5);
}

void GeMotif::activate_gridsize_2(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_gridsize(0.2);
}

void GeMotif::activate_gridsize_1(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_gridsize(0.1);
}

void GeMotif::activate_textsize_0(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(0);
}
void GeMotif::activate_textsize_1(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(1);
}

void GeMotif::activate_textsize_2(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(2);
}

void GeMotif::activate_textsize_3(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(3);
}

void GeMotif::activate_textsize_4(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(4);
}

void GeMotif::activate_textsize_5(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textsize(5);
}

void GeMotif::activate_textfont_1(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textfont(glow_eFont_Helvetica);
}
void GeMotif::activate_textfont_2(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textfont(glow_eFont_Times);
}
void GeMotif::activate_textfont_3(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textfont(glow_eFont_NewCenturySchoolbook);
}
void GeMotif::activate_textfont_4(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_textfont(glow_eFont_Courier);
}

void GeMotif::activate_textbold(
    Widget w, Ge* gectx, XmToggleButtonCallbackStruct* data)
{
...
void GeMotif::activate_zoom_reset(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_zoom_reset();
}

void GeMotif::activate_concorner_right(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_concorner_right();
}

void GeMotif::activate_concorner_rounded(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_concorner_rounded();
}

void GeMotif::activate_round_amount_1(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_round_amount(0.2);
}

void GeMotif::activate_round_amount_2(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_round_amount(0.5);
}

void GeMotif::activate_round_amount_3(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_round_amount(1.0);
}

void GeMotif::activate_round_amount_4(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_round_amount(2.0);
}

void GeMotif::activate_round_amount_5(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_round_amount(4.0);
}

void GeMotif::activate_contype_straight(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_straight();
}

void GeMotif::activate_contype_routed(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_routed();
}

void GeMotif::activate_contype_stronearr(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_stronearr();
}

void GeMotif::activate_contype_stepdiv(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_stepdiv();
}

void GeMotif::activate_contype_stepconv(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_stepconv();
}

void GeMotif::activate_contype_transdiv(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_transdiv();
}

void GeMotif::activate_contype_transconv(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_contype_transconv();
}

void GeMotif::activate_condir_center(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_condir_center();
}

void GeMotif::activate_condir_left(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_condir_left();
}

void GeMotif::activate_condir_right(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_condir_down(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  gectx->activate_condir_down();
}

void GeMotif::activate_background_color(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::create_cursor_position(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::create_palette_pane(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::activate_india_cancel(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((GeMotif*)gectx)->india_widget);
}
void GeMotif::activate_yesnodia_yes(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((GeMotif*)gectx)->yesnodia_widget);
  gectx->activate_yesnodia_yes();
}
void GeMotif::activate_yesnodia_no(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((GeMotif*)gectx)->yesnodia_widget);
  gectx->activate_yesnodia_no();
}
void GeMotif::activate_yesnodia_cancel(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((GeMotif*)gectx)->yesnodia_widget);
  gectx->activate_yesnodia_cancel();
}
void GeMotif::activate_confirm_ok(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
  XtUnmanageChild(((GeMotif*)gectx)->confirm_widget);
  gectx->activate_confirm_ok();
}
void GeMotif::activate_confirm_cancel(
    Widget w, Ge* gectx, XmAnyCallbackStruct* data)
{
...
void GeMotif::valchanged_cmd_input(Widget w, XEvent* event)
{
  ...
  if (gectx->value_input_open)
    sts = mrm_TextInput(w, event, (char*)((GeMotif*)gectx)->value_recall,
        ...
        sizeof(((GeMotif*)gectx)->value_recall)
            / sizeof(((GeMotif*)gectx)->value_recall[0]),
    ...
    sts = mrm_TextInput(w, event, (char*)((GeMotif*)gectx)->name_recall,
        ...
        sizeof(((GeMotif*)gectx)->name_recall)
            / sizeof(((GeMotif*)gectx)->name_recall[0]),
        &((GeMotif*)gectx)->name_current_recall);
  else if (gectx->text_input_open)
    sts = mrm_TextInput(w, event, (char*)((GeMotif*)gectx)->text_recall,
        sizeof(((GeMotif*)gectx)->text_recall[0]),
        sizeof(((GeMotif*)gectx)->text_recall)
            / sizeof(((GeMotif*)gectx)->text_recall[0]),
        &((GeMotif*)gectx)->text_current_recall);
  else
    sts = mrm_TextInput(w, event, (char*)((GeMotif*)gectx)->cmd_recall,
        sizeof(((GeMotif*)gectx)->cmd_recall[0]),
        sizeof(((GeMotif*)gectx)->cmd_recall)
            / sizeof(((GeMotif*)gectx)->cmd_recall[0]),
...
GeMotif::GeMotif(void* x_parent_ctx, Widget x_parent_widget,
      ...
      name_current_recall(0), value_current_recall(0), cmd_current_recall(0)
{
  ...
  static char translations[] = "<FocusIn>: ge_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[] = { { (char*)"ge_inputfocus",
      (XtActionProc)GeMotif::action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"ge_ctx", 0 },
    ...
    { (char*)"ge_activate_export_java",
        (caddr_t)GeMotif::activate_export_java },
    { (char*)"ge_activate_export_java_as",
        (caddr_t)GeMotif::activate_export_java_as },
    { (char*)"ge_activate_creanextpage",
        (caddr_t)GeMotif::activate_creanextpage },
    { (char*)"ge_activate_nextpage", (caddr_t)GeMotif::activate_nextpage },
    { (char*)"ge_activate_prevpage", (caddr_t)GeMotif::activate_prevpage },
    { (char*)"ge_activate_preview_start",
        (caddr_t)GeMotif::activate_preview_start },
    { (char*)"ge_activate_preview_stop",
        (caddr_t)GeMotif::activate_preview_stop },
    { (char*)"ge_activate_subgraphs", (caddr_t)GeMotif::activate_subgraphs },
    { (char*)"ge_activate_change_text",
        (caddr_t)GeMotif::activate_change_text },
    { (char*)"ge_activate_change_name",
        (caddr_t)GeMotif::activate_change_name },
    { (char*)"ge_activate_pop", (caddr_t)GeMotif::activate_pop },
    { (char*)"ge_activate_push", (caddr_t)GeMotif::activate_push },
    { (char*)"ge_activate_edit_polyline",
        (caddr_t)GeMotif::activate_edit_polyline },
    { (char*)"ge_activate_scale_equal",
        (caddr_t)GeMotif::activate_scale_equal },
    { (char*)"ge_activate_move_horizontal",
        (caddr_t)GeMotif::activate_move_horizontal },
    { (char*)"ge_activate_move_vertical",
        (caddr_t)GeMotif::activate_move_vertical },
    { (char*)"ge_activate_move_reset", (caddr_t)GeMotif::activate_move_reset },
    { (char*)"ge_activate_align_vert_left",
        (caddr_t)GeMotif::activate_align_vert_left },
    { (char*)"ge_activate_align_vert_right",
        (caddr_t)GeMotif::activate_align_vert_right },
    { (char*)"ge_activate_align_vert_center",
        (caddr_t)GeMotif::activate_align_vert_center },
    { (char*)"ge_activate_align_horiz_up",
        (caddr_t)GeMotif::activate_align_horiz_up },
    { (char*)"ge_activate_align_horiz_down",
        (caddr_t)GeMotif::activate_align_horiz_down },
    { (char*)"ge_activate_align_horiz_center",
        (caddr_t)GeMotif::activate_align_horiz_center },
    { (char*)"ge_activate_equid_horiz_left",
        (caddr_t)GeMotif::activate_equid_horiz_left },
    { (char*)"ge_activate_equid_horiz_right",
        (caddr_t)GeMotif::activate_equid_horiz_right },
    { (char*)"ge_activate_equid_horiz_center",
        (caddr_t)GeMotif::activate_equid_horiz_center },
    { (char*)"ge_activate_equid_vert_up",
        (caddr_t)GeMotif::activate_equid_vert_up },
    { (char*)"ge_activate_equid_vert_down",
        (caddr_t)GeMotif::activate_equid_vert_down },
    { (char*)"ge_activate_equid_vert_center",
        (caddr_t)GeMotif::activate_equid_vert_center },
    { (char*)"ge_activate_select_cons",
        (caddr_t)GeMotif::activate_select_cons },
    { (char*)"ge_activate_select_objects",
        (caddr_t)GeMotif::activate_select_objects },
    ...
    { (char*)"ge_activate_connectsecond",
        (caddr_t)GeMotif::activate_connectsecond },
    { (char*)"ge_activate_objectattributes",
        (caddr_t)GeMotif::activate_objectattributes },
    ...
    { (char*)"ge_activate_rectrounded",
        (caddr_t)GeMotif::activate_rectrounded },
    ...
    { (char*)"ge_activate_incr_lightness",
        (caddr_t)GeMotif::activate_incr_lightness },
    { (char*)"ge_activate_decr_lightness",
        (caddr_t)GeMotif::activate_decr_lightness },
    { (char*)"ge_activate_incr_intensity",
        (caddr_t)GeMotif::activate_incr_intensity },
    { (char*)"ge_activate_decr_intensity",
        (caddr_t)GeMotif::activate_decr_intensity },
    ...
    { (char*)"ge_activate_linewidth_1",
        (caddr_t)GeMotif::activate_linewidth_1 },
    { (char*)"ge_activate_linewidth_2",
        (caddr_t)GeMotif::activate_linewidth_2 },
    { (char*)"ge_activate_linewidth_3",
        (caddr_t)GeMotif::activate_linewidth_3 },
    { (char*)"ge_activate_linewidth_4",
        (caddr_t)GeMotif::activate_linewidth_4 },
    { (char*)"ge_activate_linewidth_5",
        (caddr_t)GeMotif::activate_linewidth_5 },
    { (char*)"ge_activate_linewidth_6",
        (caddr_t)GeMotif::activate_linewidth_6 },
    { (char*)"ge_activate_linewidth_7",
        (caddr_t)GeMotif::activate_linewidth_7 },
    { (char*)"ge_activate_linewidth_8",
        (caddr_t)GeMotif::activate_linewidth_8 },
    ...
    { (char*)"ge_create_cursor_position",
        (caddr_t)GeMotif::create_cursor_position },
    ...
    { (char*)"ge_activate_concorner_right",
        (caddr_t)GeMotif::activate_concorner_right },
    { (char*)"ge_activate_concorner_rounded",
        (caddr_t)GeMotif::activate_concorner_rounded },
    { (char*)"ge_activate_round_amount_1",
        (caddr_t)GeMotif::activate_round_amount_1 },
    { (char*)"ge_activate_round_amount_2",
        (caddr_t)GeMotif::activate_round_amount_2 },
    { (char*)"ge_activate_round_amount_3",
        (caddr_t)GeMotif::activate_round_amount_3 },
    { (char*)"ge_activate_round_amount_4",
        (caddr_t)GeMotif::activate_round_amount_4 },
    { (char*)"ge_activate_round_amount_5",
        (caddr_t)GeMotif::activate_round_amount_5 },
    { (char*)"ge_activate_contype_straight",
        (caddr_t)GeMotif::activate_contype_straight },
    { (char*)"ge_activate_contype_routed",
        (caddr_t)GeMotif::activate_contype_routed },
    { (char*)"ge_activate_contype_stronearr",
        (caddr_t)GeMotif::activate_contype_stronearr },
    { (char*)"ge_activate_contype_stepdiv",
        (caddr_t)GeMotif::activate_contype_stepdiv },
    { (char*)"ge_activate_contype_stepconv",
        (caddr_t)GeMotif::activate_contype_stepconv },
    { (char*)"ge_activate_contype_transdiv",
        (caddr_t)GeMotif::activate_contype_transdiv },
    { (char*)"ge_activate_contype_transconv",
        (caddr_t)GeMotif::activate_contype_transconv },
    { (char*)"ge_activate_condir_center",
        (caddr_t)GeMotif::activate_condir_center },
    { (char*)"ge_activate_condir_left",
        (caddr_t)GeMotif::activate_condir_left },
    { (char*)"ge_activate_condir_right",
        (caddr_t)GeMotif::activate_condir_right },
    { (char*)"ge_activate_condir_up", (caddr_t)GeMotif::activate_condir_up },
    { (char*)"ge_activate_condir_down",
        (caddr_t)GeMotif::activate_condir_down },
    { (char*)"ge_activate_background_color",
        (caddr_t)GeMotif::activate_background_color },
    { (char*)"ge_activate_india_ok", (caddr_t)GeMotif::activate_india_ok },
    { (char*)"ge_activate_india_cancel",
        (caddr_t)GeMotif::activate_india_cancel },
    { (char*)"ge_create_india_label", (caddr_t)GeMotif::create_india_label },
    { (char*)"ge_create_india_text", (caddr_t)GeMotif::create_india_text },
    { (char*)"ge_activate_yesnodia_yes",
        (caddr_t)GeMotif::activate_yesnodia_yes },
    { (char*)"ge_activate_yesnodia_no",
        (caddr_t)GeMotif::activate_yesnodia_no },
    { (char*)"ge_activate_yesnodia_cancel",
        (caddr_t)GeMotif::activate_yesnodia_cancel },
    { (char*)"ge_activate_confirm_ok", (caddr_t)GeMotif::activate_confirm_ok },
    { (char*)"ge_activate_confirm_cancel",
        (caddr_t)GeMotif::activate_confirm_cancel } };
  ...
  toplevel = XtCreatePopupShell(
      title, topLevelShellWidgetClass, parent_wid, args, 0);
  ...
  sts = MrmFetchWidgetOverride(
      s_DRMh, (char*)"ge_window", toplevel, name, NULL, 0, &ge_widget, &dclass);
  if (sts != MrmSUCCESS)
  ...
  sts = MrmFetchWidget(
      s_DRMh, (char*)"confirm_dialog", toplevel, &confirm_widget, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch confirm dialog\n");

  sts = MrmFetchWidget(
      s_DRMh, (char*)"yesno_dialog", toplevel, &yesnodia_widget, &dclass);
  if (sts != MrmSUCCESS)
    printf("can't fetch yesno dialog\n");
  ...
  graph = new GraphMotif(this, graph_form, "", &grow_widget, &sts, "pwrp_pop:",
  ...
  subpalette = new SubPaletteMotif(
      this, palette_pane, "SubGraphs", &subpalette_widget, &sts);
  subpalette->message_cb = &Ge::message_cb;
  subpalette->set_focus_cb = &Ge::set_focus_cb;
  subpalette->traverse_focus_cb = &Ge::traverse_focus;
  subpalette_mapped = 1;

  colpal_main_widget = ScrolledColPalCreate(palette_pane, (char*)"Colors", NULL,
      0, Ge::init_colorpalette_cb, this, &colorpalette_widget);
  XtManageChild(colpal_main_widget);

#ifdef LDH
  if (ldhses) {
    plantctx = new NavMotif(this, palette_pane, "Plant", ldhses, "NavigatorW1",
        &plant_widget, &sts);
  ...
  // Set traversal off on sash widget
  {
    ...
    int num_children;
    XtVaGetValues(
        main_pane, XmNchildren, &children, XmNnumChildren, &num_children, NULL);
  ...
  flow_AddCloseVMProtocolCb(
      toplevel, (XtCallbackProc)GeMotif::activate_exit, this);
