...
#ifndef xtt_trend_qt_h
#define xtt_trend_qt_h
...
public:
  XttTrendQt(void *xn_parent_ctx, QWidget *xn_parent_wid, char *xn_name,
             QWidget **w, pwr_sAttrRef *objid, pwr_sAttrRef *plotgroup,
             int width, int height, unsigned int options, int x_color_theme,
