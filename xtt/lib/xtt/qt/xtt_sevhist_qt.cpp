...
XttSevHistQt::XttSevHistQt(void *parent_ctx, QWidget *x_parent_wid,
                           const char *name, QWidget **w, pwr_tOid *xn_oidv,
                           pwr_tOName *xn_anamev, pwr_tOName *xn_onamev,
                           bool *sevhistobjectv, sevcli_tCtx xn_scctx,
                           int xn_width, int xn_height, unsigned int xn_options,
                           int xn_color_theme, time_ePeriod xn_time_range,
...
XttSevHistQt::XttSevHistQt(void *parent_ctx, QWidget *x_parent_wid,
                           const char *name, QWidget **w, char *filename,
      ...
      parent_wid(x_parent_wid)
{
  ...
  *sts = XNAV__SUCCESS;
  ...
  curve = new GeCurveQt(this, parent_wid, title, NULL, gcd, 1, 0, 0, 0,
