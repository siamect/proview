...
XttTCurveQt::XttTCurveQt(void *parent_ctx, QWidget *parent_wid,
                         const char *name, QWidget **w, pwr_tAttrRef *xn_arefv,
    ...
    : XttTCurve(parent_ctx, name, xn_arefv, xn_color_theme, sts)
{
  ...
  *sts = XNAV__SUCCESS;
  ...
  curve->enable(curve_mEnable_Timebox | curve_mEnable_Export |
                curve_mEnable_New | curve_mEnable_Open | curve_mEnable_Save | 
                curve_mEnable_CurveType | curve_mEnable_CurveTypeSquare | 
