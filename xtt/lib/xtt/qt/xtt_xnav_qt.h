...
public:
  ...
  Ev *ev_new(char *eve_name, char *ala_name, char *blk_name, pwr_tObjid ev_user,
             int display_ala, int display_eve, int display_blk,
             int display_return, int display_ack, int ev_beep,
  ...
  XttTrend *xtttrend_new(char *name, pwr_tAttrRef *objar,
                         pwr_tAttrRef *plotgroup, int width, int height,
  ...
  XttSevHist *xttsevhist_new(char *name, pwr_tOid *oidv, pwr_tOName *anamev,
                             ...
                             sevcli_tCtx scctx, char *filename, int width,
                             int height, unsigned int options, int color_theme,
                             time_ePeriod time_range, void *basewidget,
                             pwr_tStatus *sts);
  ...
  XttFast *xttfast_new(char *name, pwr_tAttrRef *objar, int width, int height,
                       unsigned int options, char *filename, int color_theme,
                       void *basewidget, pwr_tStatus *sts);
  ...
  XttGe *xnav_ge_new(const char *name, const char *filename, int scrollbar,
                     int menu, int navigator, int width, int height, int x,
                     int y, double scan_time, const char *object_name,
                     ...
                     int (*xg_get_current_objects_cb)(void *, pwr_sAttrRef **,
                                                      int **),
                     int (*xg_is_authorized_cb)(void *, unsigned int),
                     void (*xg_keyboard_cb)(void *, void *, int, int));
  XttMultiView *multiview_new(const char *name, pwr_tAttrRef *aref, int width,
                              int height, int x, int y, unsigned int options,
                              void *basewidget, int color_theme,
                              pwr_tStatus *sts,
                              int (*command_cb)(void *, char *, char *, void *),
                              int (*get_current_objects_cb)(void *,
                                                            pwr_sAttrRef **,
                                                            int **),
  ...
  XttStream *stream_new(const char *name, const char *uri, int width,
                        ...
                        unsigned int options, int embedded, pwr_tAttrRef *arp,
                        pwr_tStatus *sts);
  ...
  CoLogin *login_new(const char *wl_name, const char *wl_groupname,
                     ...
                     void    (*wl_bc_cancel)(void *), void *basewidget,
                     pwr_tStatus *status);
  XttKeyboard *keyboard_new(const char *name, keyboard_eKeymap keymap,
                            keyboard_eType type, int color_theme,
                            pwr_tStatus *status);
