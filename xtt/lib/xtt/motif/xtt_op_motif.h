...
public:
  OpMotif(void* op_parent_ctx, Widget op_parent_wid, char* opplace,
      pwr_tStatus* status);
  ~OpMotif();
  ...
  static void create_alarmcnt_label(
      Widget w, Op* op, XmAnyCallbackStruct* data);
  ...
  static void create_aalarm_active1(
      Widget w, Op* op, XmAnyCallbackStruct* data);
  static void create_aalarm_active2(
      Widget w, Op* op, XmAnyCallbackStruct* data);
  static void create_aalarm_active3(
      Widget w, Op* op, XmAnyCallbackStruct* data);
  static void create_aalarm_active4(
      Widget w, Op* op, XmAnyCallbackStruct* data);
  static void create_aalarm_active5(
      Widget w, Op* op, XmAnyCallbackStruct* data);
