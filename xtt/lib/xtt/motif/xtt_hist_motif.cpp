...
HistMotif::HistMotif(void* hist_parent_ctx, Widget hist_parent_wid,
      ...
      parent_wid(hist_parent_wid), parent_wid_hist(NULL)
{
  ...
  static char hist_translations[] = "<FocusIn>: hist_inputfocus()\n";
  ...
  static MrmRegisterArg reglist[] = { { (char*)"hist_ctx", 0 },
    ...
    { (char*)"hist_activate_display_in_xnav",
        (caddr_t)activate_display_in_xnav },
    ...
    { (char*)"hist_nrofevents_string_label_cr",
        (caddr_t)nrofevents_string_label_cr },
    ...
    { (char*)"hist_start_time_help_label_cr",
        (caddr_t)start_time_help_label_cr }
  ...
  *status = 1;
  ...
  parent_wid_hist = XtCreatePopupShell(
      hist_name, topLevelShellWidgetClass, parent_wid, args, i);
  ...
  if (hist_compiled_translations == NULL) {
    XtAppAddActions(XtWidgetToApplicationContext(toplevel_hist), hist_actions,
        XtNumber(hist_actions));
  ...
  // Create hist...
  hist = new EvListMotif(
      this, form_hist, ev_eType_HistList, hist_size, 0, &hist_widget);
  ...
  flow_AddCloseVMProtocolCb(
      parent_wid_hist, (XtCallbackProc)activate_exit, this);

  pwr_tAName name_str;

  if (arp && cdh_ObjidIsNotNull(arp->Objid)) {
    sts = gdh_AttrrefToName(
        arp, name_str, sizeof(name_str), cdh_mName_pathStrict);
    if (ODD(sts)) {
...
void HistMotif::ok_btn(Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  ...
  histOP->eventType_Alarm
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->alarm_toggle_w);

  histOP->eventType_Ack
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->ack_toggle_w);

  histOP->eventType_Info
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->info_toggle_w);

  histOP->eventType_Return
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->ret_toggle_w);

  histOP->eventPrio_A
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->prioA_toggle_w);

  histOP->eventPrio_B
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->prioB_toggle_w);

  histOP->eventPrio_C
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->prioC_toggle_w);

  histOP->eventPrio_D
      = (bool)XmToggleButtonGetState(((HistMotif*)histOP)->prioD_toggle_w);

  histOP->minTime_str
      = XmTextGetString(((HistMotif*)histOP)->start_time_entry_w);

  histOP->maxTime_str
      = XmTextGetString(((HistMotif*)histOP)->stop_time_entry_w);

  histOP->eventText_str
      = XmTextGetString(((HistMotif*)histOP)->event_text_entry_w);

  histOP->eventName_str
      = XmTextGetString(((HistMotif*)histOP)->event_name_entry_w);
...
void HistMotif::activate_print(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->activate_print();
}

void HistMotif::activate_zoom_in(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->hist->zoom(1.2);
}

void HistMotif::activate_zoom_out(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->hist->zoom(5.0 / 6);
}

void HistMotif::activate_zoom_reset(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->hist->unzoom();
}

void HistMotif::activate_open_plc(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->hist->start_trace();
}

void HistMotif::activate_display_in_xnav(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  histOP->hist->display_in_xnav();
}

void HistMotif::activate_disp_hundredth(
    Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data)
{
  histOP->hist->set_display_hundredth(data->set);
}

void HistMotif::activate_hide_object(
    Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data)
{
  histOP->hist->set_hide_object(data->set);
}

void HistMotif::activate_hide_text(
    Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data)
{
...
void HistMotif::activate_helpevent(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::start_time_entry_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  ((HistMotif*)histOP)->start_time_entry_w = w;
  XmTextSetString(
      ((HistMotif*)histOP)->start_time_entry_w, (char*)"1970-05-05 00:00:00");
  XtSetSensitive(((HistMotif*)histOP)->start_time_entry_w, INSENS);
}

void HistMotif::start_time_entry_lf(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_start_time_entry_lf\n");
}

void HistMotif::stop_time_entry_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::stop_time_entry_lf(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_stop_time_entry_lf\n");
}

void HistMotif::alarm_toggle_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::prioA_toggle_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::prioB_toggle_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::prioC_toggle_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::prioD_toggle_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::event_text_entry_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::event_text_entry_lf(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_event_text_entry_lf\n");
}

void HistMotif::event_name_entry_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::event_name_entry_lf(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_event_name_entry_lf\n");
}

void HistMotif::nrofevents_string_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
...
void HistMotif::search_string_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_search_string_label_cr\n");
  ((HistMotif*)histOP)->search_string_lbl_w = w;
}
void HistMotif::search_string2_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_search_string_label_cr\n");
  ((HistMotif*)histOP)->search_string2_lbl_w = w;
}
void HistMotif::search_string3_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_search_string_label_cr\n");
  ((HistMotif*)histOP)->search_string3_lbl_w = w;
}
void HistMotif::search_string4_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  //  printf("hist_search_string_label_cr\n");
...
void HistMotif::start_time_help_label_cr(
    Widget w, Hist* histOP, XmAnyCallbackStruct* data)
{
  ...
  XtVaSetValues(
      ((HistMotif*)histOP)->start_time_help_lbl_w, XmNlabelString, str, NULL);
  XmStringFree(str);
}
...
void HistMotif::set_search_string(
