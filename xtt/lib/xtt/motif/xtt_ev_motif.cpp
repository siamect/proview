...
EvMotif::EvMotif(void* ev_parent_ctx, Widget ev_parent_wid, char* eve_name,
      ...
      parent_wid(ev_parent_wid), parent_wid_eve(NULL), parent_wid_ala(NULL)
{
  ...
  static char eve_translations[] = "<FocusIn>: eve_inputfocus()\n";
  ...
  static MrmRegisterArg reglist[] = { { (char*)"ev_ctx", 0 },
    ...
    { (char*)"ev_eve_activate_display_in_xnav",
        (caddr_t)eve_activate_display_in_xnav },
    { (char*)"ev_eve_activate_disp_hundredth",
        (caddr_t)eve_activate_disp_hundredth },
    ...
    { (char*)"ev_ala_activate_display_in_xnav",
        (caddr_t)ala_activate_display_in_xnav },
    { (char*)"ev_ala_activate_disp_hundredth",
        (caddr_t)ala_activate_disp_hundredth },
    ...
    { (char*)"ev_blk_activate_block_remove",
        (caddr_t)blk_activate_block_remove },
    { (char*)"ev_blk_activate_open_plc", (caddr_t)blk_activate_open_plc },
    { (char*)"ev_blk_activate_display_in_xnav",
        (caddr_t)blk_activate_display_in_xnav },
  ...
  *status = 1;
  ...
  parent_wid_eve = XtCreatePopupShell(
      eve_name, topLevelShellWidgetClass, parent_wid, args, i);
  ...
  parent_wid_ala = XtCreatePopupShell(
      ala_name, topLevelShellWidgetClass, parent_wid, args, i);
  ...
  parent_wid_blk = XtCreatePopupShell(
      blk_name, topLevelShellWidgetClass, parent_wid, args, i);
  ...
  if (eve_compiled_translations == NULL) {
    XtAppAddActions(XtWidgetToApplicationContext(toplevel_eve), eve_actions,
        XtNumber(eve_actions));
  ...
  if (ala_compiled_translations == NULL) {
    XtAppAddActions(XtWidgetToApplicationContext(toplevel_ala), ala_actions,
        XtNumber(ala_actions));
  ...
  if (blk_compiled_translations == NULL) {
    XtAppAddActions(XtWidgetToApplicationContext(toplevel_blk), blk_actions,
        XtNumber(blk_actions));
  ...
  // Create ala and eve...
  eve = new EvListMotif(
      this, form_eve, ev_eType_EventList, eve_size, eventname_seg, &eve_widget);
  ...
  ala = new EvListMotif(
      this, form_ala, ev_eType_AlarmList, ala_size, eventname_seg, &ala_widget);
  ...
  blk = new EvListMotif(
      this, form_blk, ev_eType_BlockList, blk_size, eventname_seg, &blk_widget);
  ...
  flow_AddCloseVMProtocolCb(
      parent_wid_eve, (XtCallbackProc)eve_activate_exit, this);
  flow_AddCloseVMProtocolCb(
      parent_wid_ala, (XtCallbackProc)ala_activate_exit, this);
  flow_AddCloseVMProtocolCb(
      parent_wid_blk, (XtCallbackProc)blk_activate_exit, this);
...
void EvMotif::eve_activate_zoom_reset(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->eve->unzoom();
}

void EvMotif::ala_activate_zoom_reset(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->ala->unzoom();
}

void EvMotif::blk_activate_zoom_reset(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->blk->unzoom();
}

void EvMotif::blk_activate_block_remove(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->blk->block_remove();
}
...
void EvMotif::eve_activate_display_in_xnav(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->eve->display_in_xnav();
}

void EvMotif::ala_activate_display_in_xnav(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->ala->display_in_xnav();
}

void EvMotif::blk_activate_display_in_xnav(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
  ev->blk->display_in_xnav();
}

void EvMotif::eve_activate_disp_hundredth(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
  ev->eve->set_display_hundredth(data->set);
}

void EvMotif::ala_activate_disp_hundredth(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
  ev->ala->set_display_hundredth(data->set);
}

void EvMotif::eve_activate_hide_object(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
  ev->eve->set_hide_object(data->set);
}

void EvMotif::ala_activate_hide_object(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
  ev->ala->set_hide_object(data->set);
}

void EvMotif::eve_activate_hide_text(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
  ev->eve->set_hide_text(data->set);
}

void EvMotif::ala_activate_hide_text(
    Widget w, Ev* ev, XmToggleButtonCallbackStruct* data)
{
...
void EvMotif::eve_activate_helpevent(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
...
void EvMotif::ala_activate_helpevent(
    Widget w, Ev* ev, XmAnyCallbackStruct* data)
{
