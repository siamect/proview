...
XttFastMotif::XttFastMotif(void* parent_ctx, Widget parent_wid, char* name,
    Widget* w, pwr_sAttrRef* fast_arp, int width, int height,
    unsigned int options, int* sts)
    : XttFast(parent_ctx, name, fast_arp, sts), parent_widget(parent_wid)
{
  ...
  *sts = XNAV__SUCCESS;
  ...
  curve = new GeCurveMotif(
      this, parent_widget, title, NULL, gcd, 0, width, height, options);
