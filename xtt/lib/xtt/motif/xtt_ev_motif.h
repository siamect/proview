...
public:
  EvMotif(void* ev_parent_ctx, Widget ev_parent_wid, char* eve_name,
  ...
  static void eve_activate_ack_last(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_ack_last(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  ...
  static void eve_activate_zoom_out(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_zoom_out(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void blk_activate_zoom_out(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void eve_activate_zoom_reset(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_zoom_reset(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void blk_activate_zoom_reset(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void blk_activate_block_remove(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void eve_activate_open_plc(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_open_plc(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void blk_activate_open_plc(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void eve_activate_display_in_xnav(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_display_in_xnav(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void blk_activate_display_in_xnav(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void eve_activate_disp_hundredth(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  static void ala_activate_disp_hundredth(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  static void eve_activate_hide_object(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  static void ala_activate_hide_object(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  static void eve_activate_hide_text(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  static void ala_activate_hide_text(
      Widget w, Ev* ev, XmToggleButtonCallbackStruct* data);
  ...
  static void eve_activate_helpevent(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
  static void ala_activate_helpevent(
      Widget w, Ev* ev, XmAnyCallbackStruct* data);
