...
private:
  ...
  static void activate_restoretrace(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_cleartrace(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_display_object(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_collect_insert(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_open_object(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_show_cross(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_open_classgraph(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_trace(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_simulate(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  ...
  static void activate_zoomreset(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_scantime1(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_scantime2(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_scantime3(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_scantime4(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_scantime5(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_help(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
  static void activate_helpplc(
      Widget w, RtTrace* tractx, XmAnyCallbackStruct* data);
};
