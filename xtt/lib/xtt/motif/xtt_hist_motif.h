...
public:
  HistMotif(void* hist_parent_ctx, Widget hist_parent_wid, char* hist_name,
  ...
  static void activate_zoom_reset(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void activate_open_plc(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void activate_display_in_xnav(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void activate_disp_hundredth(
      Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data);
  static void activate_hide_object(
      Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data);
  static void activate_hide_text(
      Widget w, Hist* histOP, XmToggleButtonCallbackStruct* data);
  static void activate_help(Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void activate_helpevent(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  ...
  static void start_time_help_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void start_time_entry_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void start_time_entry_lf(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void stop_time_entry_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void stop_time_entry_lf(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  ...
  static void prioA_toggle_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void prioB_toggle_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void prioC_toggle_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void prioD_toggle_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);

  static void event_text_entry_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void event_text_entry_lf(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);

  static void event_name_entry_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void event_name_entry_lf(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void nrofevents_string_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void search_string_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void search_string2_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void search_string3_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
  static void search_string4_label_cr(
      Widget w, Hist* histOP, XmAnyCallbackStruct* data);
};
...
class Hist {
public:
  Hist(void* hist_parent_ctx, Widget hist_parent_wid, char* hist_name,
      pwr_tObjid objid, pwr_tStatus* status)
  ...
  void (*popup_menu_cb)(
      void*, pwr_sAttrRef, unsigned long, unsigned long, char*, Widget*);
};
