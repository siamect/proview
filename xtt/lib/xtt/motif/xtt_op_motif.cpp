...
OpMotif::OpMotif(void* op_parent_ctx, Widget op_parent_wid, char* opplace,
    pwr_tStatus* status)
    : Op(op_parent_ctx, opplace, status), parent_wid(op_parent_wid)
{
  ...
  static MrmRegisterArg reglist[] = { { (char*)"op_ctx", 0 },
  ...
  *status = 1;
  ...
  decor = MWM_DECOR_ALL | MWM_DECOR_MINIMIZE | MWM_DECOR_MAXIMIZE
  ...
  i++;
  XtSetArg(args[i], XmNmwmDecorations, decor);
  i++;
  XtSetArg(args[i], XmNmwmFunctions, func);
  i++;

  XtSetArg(args[i], XmNwidth, width - 20);
  i++;
  XtSetArg(args[i], XmNheight, OP_HEIGHT_MIN);
  i++;
  XtSetArg(args[i], XmNminHeight, OP_HEIGHT_MIN);
  i++;
  XtSetArg(args[i], XmNmaxHeight, OP_HEIGHT_MAX);
  i++;
  XtSetArg(args[i], XmNheightInc, OP_HEIGHT_INC);
  i++;
  XtSetArg(args[i], XmNx, 1);
  i++;
  XtSetArg(args[i], XmNy, 1);
  i++;
  ...
  parent_wid_op
      = XtCreatePopupShell(name, topLevelShellWidgetClass, parent_wid, args, i);

  i = 0;
  XtSetArg(args[i], XmNuserData, (XtPointer)this);
  i++;

  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"op_window", parent_wid_op, name,
      args, i, &toplevel, &dclass);
  if (sts != MrmSUCCESS)
  ...
  */
  ...
  flow_AddCloseVMProtocolCb(parent_wid_op, (XtCallbackProc)activate_exit, this);
...
void OpMotif::update_alarm_info()
{
  ...
  if (get_alarm_info_cb) {
    ...
    /*
        printf("Info A: %s  %d %d\n", info.a_alarm_text[0],
       info.a_alarm_active[0],
            info.a_alarm_exist[0]);
        printf("Info A: %s  %d %d\n", info.a_alarm_text[1],
       info.a_alarm_active[1],
            info.a_alarm_exist[1]);
        printf("Info A: %s  %d %d\n", info.a_alarm_text[2],
       info.a_alarm_active[2],
            info.a_alarm_exist[2]);
        printf("Info A: %s  %d %d\n", info.a_alarm_text[3],
       info.a_alarm_active[3],
            info.a_alarm_exist[3]);
        printf("Info A: %s  %d %d\n", info.a_alarm_text[4],
       info.a_alarm_active[4],
            info.a_alarm_exist[4]);
        printf("Info B: %s  %d\n", info.b_alarm_text[0],
       info.b_alarm_active[0]);
        printf("Info B: %s  %d\n", info.b_alarm_text[1],
       info.b_alarm_active[1]);
    */
    XtSetArg(args[j = 0], XmNbackground, &background);
    j++;
    ...
    XtSetArg(args[j = 0], XmNlabelString, cstr);
    j++;
    ...
    for (i = 0; i < 5; i++) {
      if (info.a_alarm_exist[i]) {
        ...
        XtVaSetValues(aalarm_label[i], XtVaTypedArg, XmNbackground, XmRString,
            "red", 4, NULL);
        ...
        XtSetArg(args[j = 0], XmNlabelString, cstr);
        j++;
        XtSetArg(args[j], XmNbackground, background);
        j++;
        XtSetValues(aalarm_label[i], args, j);
        XmStringFree(cstr);
    ...
    if (info.b_alarm_exist[0]) {
      ...
      XtVaSetValues(balarm_label, XtVaTypedArg, XmNbackground, XmRString,
          "yellow", 7, NULL);
    ...
    for (i = 0; i < 5; i++) {
      XtSetArg(args[j = 0], XmNheight, height);
      j++;
      XtSetValues(aalarm_label[i], args, j);

      XtSetArg(args[j = 0], XmNheight, active_height);
      j++;
...
int OpMotif::configure(char* opplace_str)
{
  ...
  for (i = 0; i < 25; i++) {
    ...
    if (cdh_ObjidIsNotNull(opplace_p->FastAvail[i].Objid)) {
      ...
      sts = gdh_GetObjectInfoAttrref(
          &attrref, (void*)button_title[idx], sizeof(button_title[0]));
      if (ODD(sts))
  ...
  for (i = 0; i < button_cnt; i++) {
    ...
    switch (i) {
    case 0:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_FORM, XmNtopAttachment,
          XmATTACH_FORM, XmNheight, 25, XmNfontList, fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl1,
          (void*)this);
      break;
    case 1:
    case 2:
    case 3:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          ...
          b[i - 1], XmNheight, 25, XmNfontList, fontlist, NULL);
      if (i == 1)
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl2,
            (void*)this);
      else if (i == 2)
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl3,
            (void*)this);
      else
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl4,
            (void*)this);
      break;
    case 4:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_FORM, XmNtopAttachment,
          XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
          b[i - 1], XmNrightAttachment, XmATTACH_FORM, XmNheight, 25,
          XmNfontList, fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl5,
          (void*)this);
      break;
    case 5:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_FORM, XmNtopAttachment,
          XmATTACH_WIDGET, XmNtopWidget, b[0], XmNheight, 25, XmNfontList,
          fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl6,
          (void*)this);
      break;
    case 6:
    case 7:
    case 8:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
          b[i - 1], XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, b[0],
          XmNheight, 25, XmNfontList, fontlist, NULL);
      if (i == 6)
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl7,
            (void*)this);
      else if (i == 7)
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl8,
            (void*)this);
      else
        XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl9,
            (void*)this);
      break;
    case 9:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
          b[i - 1], XmNrightAttachment, XmATTACH_FORM, XmNtopAttachment,
          XmATTACH_WIDGET, XmNtopWidget, b[0], XmNheight, 25, XmNfontList,
          fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl10,
          (void*)this);
      break;
    case 10:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_FORM, XmNtopAttachment,
          XmATTACH_WIDGET, XmNtopWidget, b[5], XmNbottomAttachment,
          XmATTACH_FORM, XmNheight, 25, XmNfontList, fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl11,
          (void*)this);
      break;
    case 11:
    case 12:
    case 13:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          appl_form, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
          b[i - 1], XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, b[5],
          XmNbottomAttachment, XmATTACH_FORM, XmNheight, 25, XmNfontList,
          fontlist, NULL);
      if (i == 11)
    ...
    case 14:
      b[i] = XtVaCreateManagedWidget(button_title[i], xmPushButtonWidgetClass,
          ...
          XmATTACH_WIDGET, XmNtopWidget, b[5], XmNbottomAttachment,
          XmATTACH_FORM, XmNheight, 25, XmNfontList, fontlist, NULL);
      XtAddCallback(b[i], XmNactivateCallback, (XtCallbackProc)activate_appl15,
          (void*)this);
      break;
    }
  }
