...
XttTrendMotif::XttTrendMotif(void* parent_ctx, Widget parent_wid, char* name,
    Widget* w, pwr_sAttrRef* trend_list, pwr_sAttrRef* plotgroup, int width,
    int height, unsigned int options, int* sts)
      ...
      parent_widget(parent_wid)
{
  ...
  *sts = XNAV__SUCCESS;
  ...
  curve = new GeCurveMotif(
      this, parent_widget, name, NULL, gcd, 1, width, height, options);
