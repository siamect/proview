...
void RtTraceMotif::create_form(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  ((RtTraceMotif*)tractx)->form = w;
}

void RtTraceMotif::create_menu(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  ((RtTraceMotif*)tractx)->menu = w;
}

void RtTraceMotif::activate_close(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_close();
}

void RtTraceMotif::activate_print(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_print();
}

void RtTraceMotif::activate_printselect(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_printselect();
}

void RtTraceMotif::activate_savetrace(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_savetrace();
}

void RtTraceMotif::activate_restoretrace(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_restoretrace();
}

void RtTraceMotif::activate_cleartrace(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_cleartrace();
}

void RtTraceMotif::activate_display_object(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_display_object();
}

void RtTraceMotif::activate_collect_insert(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_collect_insert();
}

void RtTraceMotif::activate_open_object(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_open_object();
}

void RtTraceMotif::activate_show_cross(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_show_cross();
}

void RtTraceMotif::activate_open_classgraph(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_open_classgraph();
}

void RtTraceMotif::activate_trace(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_trace();
}

void RtTraceMotif::activate_simulate(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_simulate();
}

void RtTraceMotif::activate_view(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_view();
}

void RtTraceMotif::activate_zoomin(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  flow_Zoom(tractx->flow_ctx, 1.0 / 0.7);
}

void RtTraceMotif::activate_zoomout(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  flow_Zoom(tractx->flow_ctx, 0.7);
}

void RtTraceMotif::activate_zoomreset(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  flow_UnZoom(tractx->flow_ctx);
}

void RtTraceMotif::activate_scantime1(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->scan_time = 0.5;
}

void RtTraceMotif::activate_scantime2(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->scan_time = 0.2;
}

void RtTraceMotif::activate_scantime3(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->scan_time = 0.1;
}

void RtTraceMotif::activate_scantime4(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->scan_time = 0.05;
}

void RtTraceMotif::activate_scantime5(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->scan_time = 0.02;
}

void RtTraceMotif::activate_help(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
  tractx->activate_help();
}

void RtTraceMotif::activate_helpplc(
    Widget w, RtTrace* tractx, XmAnyCallbackStruct* data)
{
...
RtTrace* RtTraceMotif::subwindow_new(
    void* ctx, pwr_tObjid oid, pwr_tStatus* sts)
{
  return new RtTraceMotif(ctx, flow_widget, oid, sts);
}

RtTraceMotif::RtTraceMotif(void* tr_parent_ctx, Widget tr_parent_wid,
    ...
    : RtTrace(tr_parent_ctx, tr_objid, status), parent_wid(tr_parent_wid)
{
  ...
  MrmType dclass;
  Widget trace_widget;
  static MrmRegisterArg reglist[] = { { (char*)"tra_ctx", 0 },
    ...
    { (char*)"tra_activate_open_classgraph",
        (caddr_t)activate_open_classgraph },
  ...
  toplevel
      = XtCreatePopupShell(name, topLevelShellWidgetClass, parent_wid, args, 0);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"trace_window", toplevel, title,
      args, 1, &trace_widget, &dclass);
  if (sts != MrmSUCCESS)
  ...
  */
  ...
  i++;
  XtSetArg(args[i], XmNtopWidget, menu);
  i++;
  ...
  i++;
  flow_widget
      = FlowCreate(form, (char*)"Flow window", args, i, init_flow, (void*)this);
  ...
  */
  ...
  flow_AddCloseVMProtocolCb(toplevel, (XtCallbackProc)activate_close, this);
