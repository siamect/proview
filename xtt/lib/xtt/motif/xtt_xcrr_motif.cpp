...
void XCrrMotif::activate_openplc(
    Widget w, XCrr* xcrr, XmAnyCallbackStruct* data)
{
...
void XCrrMotif::create_xcrrnav_form(
    Widget w, XCrr* xcrr, XmAnyCallbackStruct* data)
{
...
void XCrrMotif::disable_set_focus(XCrrMotif* xcrr, int time)
{
  xcrr->set_focus_disabled++;
  xcrr->focus_timerid
      = XtAppAddTimeOut(XtWidgetToApplicationContext(xcrr->toplevel), time,
...
XCrrMotif::XCrrMotif(Widget xa_parent_wid, void* xa_parent_ctx,
      ...
      parent_wid(xa_parent_wid), set_focus_disabled(0)
{
  ...
  static char translations[] = "<FocusIn>: xcrr_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[]
      = { { (char*)"xcrr_inputfocus", (XtActionProc)action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"xcrr_ctx", 0 },
  ...
  *xa_sts = gdh_AttrrefToName(&objar, title, sizeof(title), cdh_mNName);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"xcrr_window", parent_wid, name,
