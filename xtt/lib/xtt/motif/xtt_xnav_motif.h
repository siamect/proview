...
public:
  XNavMotif(void* xn_parent_ctx, Widget xn_parent_wid, const char* xn_name,
      Widget* w, xnav_sStartMenu* root_menu, char* xn_opplace_name,
      int op_close_button, pwr_tStatus* status);
  ~XNavMotif();
  ...
  static Widget build_menu(Widget Parent, int MenuType, const char* MenuTitle,
