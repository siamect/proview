...
//
void XAttMotif::activate_change_value(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  xatt->change_value(1);
}

void XAttMotif::activate_close_changeval(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
...
void XAttMotif::activate_display_object(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  xatt->activate_display_object();
}

void XAttMotif::activate_show_cross(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  xatt->activate_show_cross();
}

void XAttMotif::activate_open_classgraph(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  xatt->activate_open_classgraph();
}

void XAttMotif::activate_open_plc(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
...
void XAttMotif::create_msg_label(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  ((XAttMotif*)xatt)->msg_label = w;
}
void XAttMotif::create_cmd_prompt(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  ((XAttMotif*)xatt)->cmd_prompt = w;
}
void XAttMotif::create_cmd_input(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  Arg args[2];
...
void XAttMotif::create_cmd_scrolledinput(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  ((XAttMotif*)xatt)->cmd_scrolledinput = w;
}
void XAttMotif::create_cmd_scrolled_ok(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  ((XAttMotif*)xatt)->cmd_scrolled_ok = w;
}
void XAttMotif::create_cmd_scrolled_ca(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  ((XAttMotif*)xatt)->cmd_scrolled_ca = w;
}
void XAttMotif::create_xattnav_form(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
...
void XAttMotif::disable_set_focus(XAttMotif* xatt, int time)
{
  xatt->set_focus_disabled++;
  xatt->focus_timerid
      = XtAppAddTimeOut(XtWidgetToApplicationContext(xatt->toplevel), time,
...
void XAttMotif::activate_cmd_input(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  char* text;
  int sts;
...
void XAttMotif::activate_cmd_scrolled_ok(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  char* text;
  int sts;
...
void XAttMotif::activate_cmd_scrolled_ca(
    Widget w, XAtt* xatt, XmAnyCallbackStruct* data)
{
  if (xatt->input_open) {
    XtUnmanageChild(((XAttMotif*)xatt)->cmd_scrolledinput);
...
XAttMotif::XAttMotif(Widget xa_parent_wid, void* xa_parent_ctx,
      ...
      parent_wid(xa_parent_wid), set_focus_disabled(0), value_current_recall(0)
{
  ...
  static char translations[] = "<FocusIn>: xatt_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[]
      = { { (char*)"xatt_inputfocus", (XtActionProc)action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"xatt_ctx", 0 },
    ...
    { (char*)"xatt_activate_open_classgraph",
    ...
    { (char*)"xatt_activate_close_changeval",
    ...
    { (char*)"xatt_create_cmd_scrolledinput",
    ...
    { (char*)"xatt_activate_cmd_scrolled_ok",
        (caddr_t)activate_cmd_scrolled_ok },
    { (char*)"xatt_activate_cmd_scrolled_ca",
  ...
  *xa_sts = gdh_AttrrefToName(&objar, title, sizeof(title), cdh_mNName);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"xatt_window", parent_wid, name,
