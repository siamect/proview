...
public:
  CLogMotif(void* clog_parent_ctx, Widget clog_parent_wid,
  ...
  static void activate_select_file(
      Widget w, CLog* clog, XmAnyCallbackStruct* data);
  static void activate_next_file(
      Widget w, CLog* clog, XmAnyCallbackStruct* data);
  static void activate_prev_file(
      Widget w, CLog* clog, XmAnyCallbackStruct* data);
