...
void XAttOneMotif::activate_exit(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  if (xattone->close_cb)
...
void XAttOneMotif::activate_help(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  // Not yet implemented
}

void XAttOneMotif::create_msg_label(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->msg_label = w;
}
void XAttOneMotif::create_cmd_prompt(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->cmd_prompt = w;
}
void XAttOneMotif::create_cmd_label(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->cmd_label = w;
}
void XAttOneMotif::create_cmd_input(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  Arg args[2];
...
void XAttOneMotif::create_cmd_scrolledinput(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->cmd_scrolledinput = w;
}
void XAttOneMotif::create_cmd_scrolled_ok(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->cmd_scrolled_ok = w;
}
void XAttOneMotif::create_cmd_scrolled_ap(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  ((XAttOneMotif*)xattone)->cmd_scrolled_ap = w;
}
void XAttOneMotif::create_cmd_scrolled_ca(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
...
{
  xattone->set_focus_disabled++;
  xattone->focus_timerid
      = XtAppAddTimeOut(XtWidgetToApplicationContext(xattone->toplevel), time,
...
void XAttOneMotif::activate_cmd_input(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
}

void XAttOneMotif::activate_cmd_scrolled_ok(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  int sts;
...
void XAttOneMotif::activate_cmd_scrolled_ap(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  xattone->set_value();
}

void XAttOneMotif::activate_cmd_scrolled_ca(
    Widget w, XAttOne* xattone, XmAnyCallbackStruct* data)
{
  if (xattone->close_cb)
    (xattone->close_cb)(xattone->parent_ctx, xattone);
...
XAttOneMotif::XAttOneMotif(Widget xa_parent_wid, void* xa_parent_ctx,
      ...
      parent_wid(xa_parent_wid), set_focus_disabled(0), value_current_recall(0)
{
  ...
  static char translations[] = "<FocusIn>: xao_inputfocus()\n";
  static XtTranslations compiled_translations = NULL;

  static XtActionsRec actions[]
      = { { (char*)"xao_inputfocus", (XtActionProc)action_inputfocus } };

  static MrmRegisterArg reglist[] = { { (char*)"xao_ctx", 0 },
    ...
    { (char*)"xao_create_cmd_scrolledinput",
    ...
    { (char*)"xao_activate_cmd_scrolled_ok",
        (caddr_t)activate_cmd_scrolled_ok },
    { (char*)"xao_activate_cmd_scrolled_ap",
        (caddr_t)activate_cmd_scrolled_ap },
    { (char*)"xao_activate_cmd_scrolled_ca",
  ...
  *xa_sts = gdh_AttrrefToName(&aref, title, sizeof(title), cdh_mNName);
  ...
  sts = MrmFetchWidgetOverride(s_DRMh, (char*)"xao_window", parent_wid, name,
