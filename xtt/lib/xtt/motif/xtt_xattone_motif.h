...
public:
  XAttOneMotif(Widget xa_parent_wid, void* xa_parent_ctx,
  ...
  static void create_cmd_scrolled_ok(
      Widget w, XAttOne* xattone, XmAnyCallbackStruct* data);
  static void create_cmd_scrolled_ap(
      Widget w, XAttOne* xattone, XmAnyCallbackStruct* data);
  ...
  static void activate_cmd_scrolled_ok(
      Widget w, XAttOne* xattone, XmAnyCallbackStruct* data);
  static void activate_cmd_scrolled_ap(
      Widget w, XAttOne* xattone, XmAnyCallbackStruct* data);
