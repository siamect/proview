...
XttSevHistGtk::XttSevHistGtk(void* parent_ctx, GtkWidget* parent_wid,
    const char* name, GtkWidget** w, pwr_tOid* xn_oidv, pwr_tOName* xn_anamev,
...
XttOTree* XttSevHistGtk::tree_new(const char* title, pwr_tAttrRef* itemlist,
