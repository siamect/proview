...
public:
  FlowImage(FlowCtx* flow_ctx, const char* imagefile, double x = 0,
      double y = 0, flow_mDisplayLevel display_lev = flow_mDisplayLevel_1);
  friend std::ostream& operator<<(std::ostream& o, const FlowImage r);
  void zoom();
  void nav_zoom();
  void print_zoom();
