...
class FlowPscript {
  public:
    ...
    ~FlowPscript();
     ...
     int rect( double x, double y, double width, double height, flow_eDrawType type, int idx);
     int filled_rect( double x, double y, double width, double height, flow_eDrawType type, int idx);
     int arc( double x, double y, double width, double height, int angel1, int angel2,
		flow_eDrawType type, int idx);
     int line( double x1, double y1, double x2, double y2, flow_eDrawType type, int idx);
