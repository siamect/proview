...
public:
  FlowRadiobutton(FlowCtx* flow_ctx, double x = 0, double y = 0, double w = 0,
      double h = 0, int annot_num = 0,
  ...
  friend std::ostream& operator<<(std::ostream& o, const FlowRadiobutton r);
  void zoom();
  void nav_zoom();
  void print_zoom();
  ...
  {
    return flow_eObjectType_Radiobutton;
  };
  FlowCtx* ctx;
  double width()
  {
