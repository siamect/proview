...
public:
  ...
  int arrow(FlowCtx *ctx, int x1, int y1, int x2, int y2, int x3, int y3,
            flow_eDrawType gc_type, int idx, int highlight);
  int arrow_erase(FlowCtx *ctx, int x1, int y1, int x2, int y2, int x3, int y3,
                  int idx);
  int nav_arrow(FlowCtx *ctx, int x1, int y1, int x2, int y2, int x3, int y3,
                flow_eDrawType gc_type, int idx, int highlight);
  int nav_arrow_erase(FlowCtx *ctx, int x1, int y1, int x2, int y2, int x3,
                      int y3, int idx);
  ...
  int pixmap(FlowCtx *ctx, int x, int y, flow_sPixmapData *pixmap_data,
             void *pixmaps, flow_eDrawType gc_type, int idx, int highlight,
             int line);
  ...
  int get_text_extent(FlowCtx *ctx, const char *text, int len,
                      flow_eDrawType gc_type, int idx, int *width, int *height,
                      double size);
  ...
  void set_image_clip_mask(QPainter *painter, flow_tPixmap pixmap, int x,
                           int y);
...
private:
  ...
  int triangle_helper(FlowCtx *ctx, int painter_type, int size, int x, int y,
                      int width, int height, bool nav = false,
                      bool fill = false);
  ...
  int text_pango_helper(FlowCtx *ctx, int x, int y, char *text, int len,
                        flow_eDrawType painter_type, int idx, double size,
                        int dimmed = 0, int erase_rect = 0);
