/* 
 * Proview   $Id: glow_growrectrounded.h,v 1.3 2005-12-06 09:18:34 claes Exp $
...
#ifndef glow_growrectrounded_h
#define glow_growrectrounded_h

#include "glow_rect.h"

/*! \file glow_growrectrounded.h
    \brief Contains the GrowRectRounded class. */
/*! \addtogroup Glow */
/*@{*/


//! Class for drawing a rectangle with rounded corners.
/*! A rectangle object for drawing a rounded rectangle with specified bordercolor, linewidth, fill and fillcolor.
  Detection of event when the object is clicked on, moved etc.
*/
class GrowRectRounded : public GlowRect {
  public:
  //! Constuctor
  /*!
  ...
  */
  GrowRectRounded( GlowCtx *glow_ctx, char *name, double x = 0, double y = 0, 
  ...
  */
  glow_eObjectType type() { return glow_eObjectType_GrowRectRounded;};
  ...
  */
  ...
  double	round_amount;	//!< The size of the roudness of the corners. In perctage of the minimum of width an height.
  ...
  */
  virtual void draw( GlowTransform *t, int highlight, int hot, void *node, void *colornode);
  ...
  */
  ...
  /*!
    ...
    \param colornode	The node that controls the color of the object. Can be zero.
  */
  virtual void nav_draw( GlowTransform *t, int highlight, void *node, void *colornode);
