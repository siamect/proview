/* 
 * Proview   $Id: glow_growrectrounded.h,v 1.4 2007-01-04 07:57:39 claes Exp $
...
class GrowRectRounded : public GlowRect {
  ...
  */
  virtual void draw( GlowWind *w, GlowTransform *t, int highlight, int hot, void *node, void *colornode);
