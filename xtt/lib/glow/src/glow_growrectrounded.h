...
/*! A rectangle object for drawing a rounded rectangle with specified
  bordercolor, linewidth, fill and fillcolor.
...
public:
  ...
  */
  GrowRectRounded(GrowCtx* glow_ctx, const char* name, double x = 0,
      double y = 0, double w = 0, double h = 0,
  ...
  */
  ...
  {
    return glow_eObjectType_GrowRectRounded;
  }
  ...
  */
  ...
  double round_amount; //!< The size of the roudness of the corners. In perctage
  //! of the minimum of width an height.
  ...
  */
  ...
  /*!
    ...
    annotation background and
    redrawn by this function. This is a fast way to redraw an annotation without
    having to redraw
  ...
  */
  ...
  /*!
    \param t		Transform of parent node.
    \param node		Parent node.
    \param background	The fill color of this object, if this is the
    background object.
