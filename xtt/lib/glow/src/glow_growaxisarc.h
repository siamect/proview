...
/*! A GrowAxisArc object is an object that displays an axis or scale.
  ...
  The GrowAxisArc class contains function for drawing the object, and handle
  events when the
...
public:
  ...
  */
  ...
  {
    return glow_eObjectType_GrowAxisArc;
  }
  ...
  */
  ...
  /*!
    ...
    \param fmt		Format specification, c syntax or %1t(h:m:s), %2t (d
    h:m)
    for time formats.
