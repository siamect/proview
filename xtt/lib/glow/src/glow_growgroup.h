/* 
 * Proview   $Id: glow_growgroup.h,v 1.4 2007-01-04 07:57:38 claes Exp $
...
class GrowGroup : public GrowNode {
  ...
  */
  GrowGroup( GrowCtx *glow_ctx, char *name, GlowArray& array, 
	       int nodraw = 0);

  //! Noargs constructor.
  GrowGroup() {};

  GrowGroup( GrowCtx *glow_ctx, char *name);
  ~GrowGroup();
