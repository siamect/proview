...
static int colpal_init_proc(QWidget *w, GlowCtx *fctx, void *client_data)
{
  ...
  if (((QtScrollWidgetGlow *) w)->scroll_h) {
    ...
    scroll_data->scroll_v = colpal->scroll_v;
...
QWidget *colpalwidgetqt_new(int (*init_proc)(GlowCtx *ctx, void *client_data),
                            void *client_data)
{
