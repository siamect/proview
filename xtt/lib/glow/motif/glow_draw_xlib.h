...
public:
  DrawWindXLib()
      : toplevel(0), shell(0), window(0), buffer(0), buffer_width(0),
...
public:
  GlowDrawXLib(Widget toplevel, void** glow_ctx,
  ...
  virtual int arc(GlowWind* w, int x, int y, int width, int height, int angel1,
      int angel2, glow_eDrawType gc_type, int idx, int highlight);
  ...
  virtual int draw_points(
      GlowWind* w, glow_sPointX* points, int point_num, glow_eDrawType gc_type);
