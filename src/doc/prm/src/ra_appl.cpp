 ...
 *
 * The open function fetches pointer to the digita value object Dv1 and Dv2, and
 * to
 * the alalog value object Av1. It also connects to the message handler.
 *
 * The scan function is called cyclically and sets one value to Av1 if Dv1 is
 * high and
