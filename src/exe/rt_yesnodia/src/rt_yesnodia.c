...
void WarningMsg(Widget parent, char* msg, char* title)
{
  ...
  XtVaSetValues(dialog, XmNmessageString, text, XmNokLabelString, ok_str,
      XmNcancelLabelString, cancel_str, XmNdefaultButtonType,
...
int main(int argc, char* argv[])
{
  ...
  toplevel = XtVaAppInitialize(&app_ctx, "yesnodia", NULL, 0, &argc, argv, NULL,
