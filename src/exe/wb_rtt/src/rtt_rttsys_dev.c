...
int RTTSYS_ERROR(menu_ctx ctx, int event, char* parameter_ptr, char* objectname,
    char** picture)
{
  return RTT__SUCCESS;
}
...
int RTTSYS_WATCHDOG(menu_ctx ctx, int event, char* parameter_ptr,
    char* objectname, char** picture)
{
  return RTT__SUCCESS;
}
...
int RTTSYS_OBJECT_NMPSCELL(menu_ctx ctx, int event, char* parameter_ptr,
    char* objectname, char** picture)
{
  return RTT__SUCCESS;
}
