...
static pwr_sClass_Backup_Conf* backup_confp; /* Backup_Conf object pointer */
...
int dapopen(char* filespec, pwr_tBoolean create)
{
  int sts;
...
int dapwrite(int filepos, char* buf, int buflen)
{
  int sts = 1;
  DAP$R_RFA rfa;
...
int dapread(int filepos, char* buf, int buflen)
{
  int sts;
  DAP$R_RFA rfa;
  int thislen;
