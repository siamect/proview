...
#define pwrv_cBuildTimeStr       "15 Dec 2000"

#define pwrv_cPwrVersionStr      "V3.9.0"
#define pwrv_cPwrVersion         SET_VERSION('V', 3, 9, 0)

#define pwrv_cSmdVersion         SET_VERSION('V', 3, 9, 0)
#define pwrv_cSmdVersionStr      "V3.9.0"

#define pwrv_cBmdVersion         SET_VERSION('V', 3, 9, 0)
#define pwrv_cBmdVersionStr      "V3.9.0"

#define pwrv_cWbdbVersion        SET_VERSION('V', 3, 9, 0)
#define pwrv_cWbdbVersionStr     "V3.9.0"
#define pwrv_cWbdbVersionShortStr "V39"

#define pwrv_cLffVersion         SET_VERSION('V', 3, 9, 0)
#define pwrv_cLffVersionStr      "V3.9.0"
