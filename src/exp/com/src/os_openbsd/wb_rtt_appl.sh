...
#link option file exists and is not empty
  if [ -s $pwrp_exe/ra_rtt.opt ]; then
    ...
    cflags="-DOS_OPENBSD=1 -DOS=openbsd -DHW_X86_64=1 -DHW=x86_64 -O3 -DGNU_SOURCE -DPWR_NDEBUG -D_REENTRANT"
...
#   echo "Compile"
    ...
    cflags="-DOS_OPENBSD=1 -DOS=freebsd -DHW_X86_64=1 -DHW=x86_64 -O3 -DGNU_SOURCE -DPWR_NDEBUG -D_REENTRANT"
