...
# echo "Opsys is OpenBSD"
  ...
  then
    ...
    cflags="-DOS_OPENBSD -DOS_POSIX -DOS=openbsd -DHW_X86_64=1 -DPOSIX_SOURCE -DWall" 
...
#   echo $ar_name $ar_name_pict
    ...
    cflags="-DOS_OPENBSD -DOS_POSIX -DOS=freebsd -DHW_X86_64=1 -DPOSIX_SOURCE -DWall" 
