...
op_mode: model
    ...
    height 1.5
    text "External Set:" 8.52776 4.66493
    group
    ...
    . dynprop  \
        ...
        prec 2
        align 1 3
        ftrect -31 2.5 31 -2.5  "Forced Control"
        . dynprop   \
              (Force   \
                (!= 1  \
                  (stext "" "%s") ))
        ...
        ecolor 12
        poly \
            66.6241 69.3738 89.8031 69.3738 89.4297 69.7782 \
            66.9975 69.7782 
        . filled 1
        fcolor 15
        ecolor 15
        poly \
            66.6241 74.2269 66.9975 73.8225 89.4297 73.8225 \
            89.8031 74.2269 
        . filled 1
        fcolor 14
        ecolor 14
        ...
        ecolor 10
        estyle 1
        fcir2 85.9978 72.0327 87.7405 70.6385 
        . move 59.1363 49.3009
        . scale 59.1363 49.3009 0.31235 0.31235
    endg
endm
