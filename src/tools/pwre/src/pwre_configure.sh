...
#    fi
    ...
    pwre_config_check_lib mysql     MYSQL    lib lib 1 "/usr/lib/libmysqlclient.so:/usr/lib/mysql/libmysqlclient.so:/usr/lib/$hwpl-linux-$gnu/libmysqlclient.so:/usr/lib/$hwpl-linux-$gnu/libmariadbclient.so"
