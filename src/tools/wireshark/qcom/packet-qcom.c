...
static char* qcom_aref_to_string(
    guint32 oix, guint32 vid, guint32 offset, guint32 size)
{
  static char ls[200];
...
void proto_register_qcom(void)
{
  ...
  static hf_register_info hf[] = {
    { &hf_qcom, { "Data", "qcom.data", FT_NONE, BASE_NONE, NULL, 0x0,
                    "QCOM Data", HFILL } },

    /* Qcom Header */
    { &hf_qcom_header, { "Header", "qcom.header", FT_NONE, BASE_NONE, NULL, 0x0,
                           "QCOM Header", HFILL } },
    { &hf_qcom_header_nodeid, { "NodeId", "qcom.header.nodeid", FT_UINT32,
                                  BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_header_birth, { "Birth", "qcom.header.birth", FT_INT32, BASE_DEC,
                                 NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_header_flags, { "Flags", "qcom.header.flags", FT_UINT32,
                                 BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_header_lacksequence,
        { "LackSequence", "qcom.header.lacksequence", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_qcom_header_lacktimestamp,
        { "LackTimestamp", "qcom.header.lacktimestamp", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_header_racksequence,
        { "RackSequence", "qcom.header.racksequence", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_qcom_header_racktimestamp,
        { "RackTimestamp", "qcom.header.racktimestamp", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },

    /* Qcom Info */
    { &hf_qcom_info, { "Info", "qcom.info", FT_NONE, BASE_NONE, NULL, 0x0,
                         "QCOM Info", HFILL } },
    { &hf_qcom_info_senderaix, { "SenderAix", "qcom.info.senderaix", FT_INT32,
                                   BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_sendernid, { "SenderNid", "qcom.info.sendernid", FT_UINT32,
                                   BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_pid, { "Pid", "qcom.info.pid", FT_UINT32, BASE_DEC, NULL,
                             0x0, NULL, HFILL } },
    { &hf_qcom_info_receiverqix,
        { "ReceiverQix", "qcom.info.receiverqix", FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL } },
    { &hf_qcom_info_receivernid,
        { "ReceiverNid", "qcom.info.receivernid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_qcom_info_replyqix, { "ReplyQix", "qcom.info.replyqix", FT_INT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_replynid, { "ReplyNid", "qcom.info.replynid", FT_UINT32,
                                  BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_btype, { "BType", "qcom.info.btype", FT_INT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_stype, { "SType", "qcom.info.stype", FT_INT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_rid, { "Rid", "qcom.info.rid", FT_INT32, BASE_DEC, NULL,
                             0x0, NULL, HFILL } },
    { &hf_qcom_info_size, { "Size", "qcom.info.size", FT_UINT32, BASE_DEC, NULL,
                              0x0, NULL, HFILL } },
    { &hf_qcom_info_tmo, { "Tmo", "qcom.info.tmo", FT_INT32, BASE_DEC, NULL,
                             0x0, NULL, HFILL } },
    { &hf_qcom_info_status, { "Status", "qcom.info.status", FT_INT32, BASE_DEC,
                                NULL, 0x0, NULL, HFILL } },
    { &hf_qcom_info_flags, { "Flags", "qcom.info.flags", FT_UINT32, BASE_HEX,
                               NULL, 0x0, NULL, HFILL } },

    /* Mh header */
    { &hf_mh_header, { "MhHeader", "qcom.mh.header", FT_NONE, BASE_NONE, NULL,
                         0x0, "QCOM MhHeader", HFILL } },
    { &hf_mh_header_xdr, { "Xdr", "qcom.mh.header.xdr", FT_INT32, BASE_DEC,
                             NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_platform, { "Platform", "qcom.mh.header.platform", FT_INT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_version, { "Version", "qcom.mh.header.version", FT_INT32,
                                 BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_source, { "Source", "qcom.mh.header.source", FT_INT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_birthtime,
        { "BirthTime", "qcom.mh.header.birthtime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_type, { "Type", "qcom.mh.header.type", FT_INT32, BASE_DEC,
                              NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_qidqix, { "QidQix", "qcom.mh.header.qidqix", FT_INT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_qidnid, { "QidNid", "qcom.mh.header.qidnid", FT_UINT32,
                                BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_nix, { "Nix", "qcom.mh.header.nix", FT_UINT32, BASE_HEX,
                             NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_outunitoix,
        { "OutunitOix", "qcom.mh.header.outunitoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_header_outunitvid,
        { "OutunitVid", "qcom.mh.header.outunitvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_header_aidoix, { "AidOix", "qcom.mh.header.aidoix", FT_UINT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_header_aidvid, { "AidVid", "qcom.mh.header.aidvid", FT_UINT32,
                                BASE_HEX, NULL, 0x0, NULL, HFILL } },

    /* Mh msginfo */
    { &hf_mh_msginfo, { "MhMsgInfo", "qcom.mh.msginfo", FT_NONE, BASE_NONE,
                          NULL, 0x0, "QCOM MhMsgInfo", HFILL } },
    { &hf_mh_msginfo_idnix, { "IdNix", "qcom.mh.msginfo.idnix", FT_UINT32,
                                BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_msginfo_idbirthtime,
        { "IdBirthTime", "qcom.mh.msginfo.idbirthtime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_msginfo_ididx, { "IdIdx", "qcom.mh.msginfo.ididx", FT_INT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_msginfo_outunitoix,
        { "OutunitOix", "qcom.mh.msginfo.outunitoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_msginfo_outunitvid,
        { "OutunitVid", "qcom.mh.msginfo.outunitvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_msginfo_eventflags,
        { "EventFlags", "qcom.mh.msginfo.eventflags", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_msginfo_eventtime,
        { "EventTime", "qcom.mh.msginfo.eventtime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_msginfo_eventnamev3,
        { "EventNameV3", "qcom.mh.msginfo.eventnamev3", FT_STRING, BASE_NONE,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_msginfo_eventtype,
        { "EventType", "qcom.mh.msginfo.eventtype", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_msginfo_eventprio,
        { "EventPrio", "qcom.mh.msginfo.eventprio", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },

    /* Mh Message */
    { &hf_mh_message, { "MhMessage", "qcom.mh.message", FT_NONE, BASE_NONE,
                          NULL, 0x0, "QCOM MhMessage", HFILL } },
    { &hf_mh_message_eventtext,
        { "EventText", "qcom.mh.message.eventtext", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_status, { "Status", "qcom.mh.message.status", FT_UINT32,
                                 BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundoix,
        { "EventSoundOix", "qcom.mh.message.eventsoundoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundvid,
        { "EventSoundVid", "qcom.mh.message.eventsoundvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundbody,
        { "EventSoundBody", "qcom.mh.message.eventsoundbody", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundoffset,
        { "EventSoundOffset", "qcom.mh.message.eventsoundoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundsize,
        { "EventSoundSize", "qcom.mh.message.eventsoundsize", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventsoundflags,
        { "EventSoundFlags", "qcom.mh.message.eventsoundflags", FT_UINT32,
            BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventmoretext,
        { "EventMoreText", "qcom.mh.message.eventmoretext", FT_STRING,
            BASE_NONE, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_objectoix,
        { "ObjectOix", "qcom.mh.message.objectoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_objectvid,
        { "ObjectVid", "qcom.mh.message.objectvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_objectbody,
        { "ObjectBody", "qcom.mh.message.objectbody", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_objectoffset,
        { "ObjectOffset", "qcom.mh.message.objectoffset", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_objectsize,
        { "ObjectSize", "qcom.mh.message.objectsize", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_objectflags,
        { "ObjectFlags", "qcom.mh.message.objectflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectoix,
        { "SupObjectOix", "qcom.mh.message.supobjectoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectvid,
        { "SupObjectVid", "qcom.mh.message.supobjectvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectbody,
        { "SupObjectBody", "qcom.mh.message.supobjectbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectoffset,
        { "SupObjectOffset", "qcom.mh.message.supobjectoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectsize,
        { "SupObjectSize", "qcom.mh.message.supobjectsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_supobjectflags,
        { "SupObjectFlags", "qcom.mh.message.supobjectflags", FT_UINT32,
            BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_message_eventname,
        { "EventName", "qcom.mh.message.eventname", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_message_receiver,
        { "Receiver", "qcom.mh.message.receiver", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },

    /* Mh Block */
    { &hf_mh_block, { "MhBlock", "qcom.mh.block", FT_NONE, BASE_NONE, NULL, 0x0,
                        "QCOM MhBlock", HFILL } },
    { &hf_mh_block_targetidnix,
        { "TargetIdNix", "qcom.mh.block.targetidnix", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_targetidbirthtime,
        { "TargetIdBirthTime", "qcom.mh.block.targetidbirthtime",
            FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_targetididx,
        { "TargetIdIdx", "qcom.mh.block.targetididx", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_detecttime,
        { "DetectTime", "qcom.mh.block.detecttime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_outunitoix,
        { "OutunitOix", "qcom.mh.block.outunitoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_outunitvid,
        { "OutunitVid", "qcom.mh.block.outunitvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_status, { "Status", "qcom.mh.block.status", FT_UINT32,
                               BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_objectoix,
        { "ObjectOix", "qcom.mh.block.objectoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_objectvid,
        { "ObjectVid", "qcom.mh.block.objectvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_objectbody,
        { "ObjectBody", "qcom.mh.block.objectbody", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_objectoffset,
        { "ObjectOffset", "qcom.mh.block.objectoffset", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_objectsize,
        { "ObjectSize", "qcom.mh.block.objectsize", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_objectflags,
        { "ObjectFlags", "qcom.mh.block.objectflags", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectoix,
        { "SupObjectOix", "qcom.mh.block.supobjectoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectvid,
        { "SupObjectVid", "qcom.mh.block.supobjectvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectbody,
        { "SupObjectBody", "qcom.mh.block.supobjectbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectoffset,
        { "SupObjectOffset", "qcom.mh.block.supobjectoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectsize,
        { "SupObjectSize", "qcom.mh.block.supobjectsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_supobjectflags,
        { "SupObjectFlags", "qcom.mh.block.supobjectflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_block_eventname,
        { "EventName", "qcom.mh.block.eventname", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },

    /* Mh Ack */
    { &hf_mh_ack, { "MhAck", "qcom.mh.ack", FT_NONE, BASE_NONE, NULL, 0x0,
                      "QCOM MhAck", HFILL } },
    { &hf_mh_ack_targetidnix,
        { "TargetIdNix", "qcom.mh.ack.targetidnix", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_targetidbirthtime,
        { "TargetIdBirthTime", "qcom.mh.ack.targetidbirthtime",
            FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_targetididx,
        { "TargetIdIdx", "qcom.mh.ack.targetididx", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_detecttime,
        { "DetectTime", "qcom.mh.ack.detecttime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_outunitoix,
        { "OutunitOix", "qcom.mh.ack.outunitoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_outunitvid,
        { "OutunitVid", "qcom.mh.ack.outunitvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_objectoix, { "ObjectOix", "qcom.mh.ack.objectoix", FT_UINT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_objectvid, { "ObjectVid", "qcom.mh.ack.objectvid", FT_UINT32,
                                BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_objectbody,
        { "ObjectBody", "qcom.mh.ack.objectbody", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_objectoffset,
        { "ObjectOffset", "qcom.mh.ack.objectoffset", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_objectsize,
        { "ObjectSize", "qcom.mh.ack.objectsize", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_objectflags,
        { "ObjectFlags", "qcom.mh.ack.objectflags", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectoix,
        { "SupObjectOix", "qcom.mh.ack.supobjectoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectvid,
        { "SupObjectVid", "qcom.mh.ack.supobjectvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectbody,
        { "SupObjectBody", "qcom.mh.ack.supobjectbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectoffset,
        { "SupObjectOffset", "qcom.mh.ack.supobjectoffset", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectsize,
        { "SupObjectSize", "qcom.mh.ack.supobjectsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_supobjectflags,
        { "SupObjectFlags", "qcom.mh.ack.supobjectflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_ack_eventname, { "EventName", "qcom.mh.ack.eventname", FT_STRING,
                                BASE_NONE, NULL, 0x0, NULL, HFILL } },

    /* Mh Return */
    { &hf_mh_return, { "MhReturn", "qcom.mh.return", FT_NONE, BASE_NONE, NULL,
                         0x0, "QCOM MhReturn", HFILL } },
    { &hf_mh_return_eventtext,
        { "EventText", "qcom.mh.return.eventtext", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_targetidnix,
        { "TargetIdNix", "qcom.mh.return.targetidnix", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_targetidbirthtime,
        { "TargetIdBirthTime", "qcom.mh.return.targetidbirthtime",
            FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_targetididx,
        { "TargetIdIdx", "qcom.mh.return.targetididx", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_detecttime,
        { "DetectTime", "qcom.mh.return.detecttime", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_objectoix,
        { "ObjectOix", "qcom.mh.return.objectoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_objectvid,
        { "ObjectVid", "qcom.mh.return.objectvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_objectbody,
        { "ObjectBody", "qcom.mh.return.objectbody", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_objectoffset,
        { "ObjectOffset", "qcom.mh.return.objectoffset", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_objectsize,
        { "ObjectSize", "qcom.mh.return.objectsize", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_mh_return_objectflags,
        { "ObjectFlags", "qcom.mh.return.objectflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectoix,
        { "SupObjectOix", "qcom.mh.return.supobjectoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectvid,
        { "SupObjectVid", "qcom.mh.return.supobjectvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectbody,
        { "SupObjectBody", "qcom.mh.return.supobjectbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectoffset,
        { "SupObjectOffset", "qcom.mh.return.supobjectoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectsize,
        { "SupObjectSize", "qcom.mh.return.supobjectsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_supobjectflags,
        { "SupObjectFlags", "qcom.mh.return.supobjectflags", FT_UINT32,
            BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_mh_return_eventname,
        { "EventName", "qcom.mh.return.eventname", FT_STRING, BASE_NONE, NULL,
            0x0, NULL, HFILL } },

    /* Net Message */
    { &hf_net_message, { "NetMessage", "qcom.net.message", FT_NONE, BASE_NONE,
                           NULL, 0x0, "QCOM NetMessage", HFILL } },
    { &hf_net_message_xdr, { "Xdr", "qcom.net.message.xdr", FT_INT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_net_message_msn, { "Msn", "qcom.net.message.msn", FT_UINT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_net_message_nid, { "Nid", "qcom.net.message.nid", FT_UINT32, BASE_HEX,
                               NULL, 0x0, NULL, HFILL } },

    /* Net OidToObject */
    { &hf_net_oidtoobject,
        { "NetOidToObject", "qcom.net.oidtoobject", FT_NONE, BASE_NONE, NULL,
            0x0, "QCOM NetOidToObject", HFILL } },
    { &hf_net_oidtoobject_oidoix,
        { "OidOix", "qcom.net.oidtoobject.oidoix", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_oidtoobject_oidvid,
        { "OidVid", "qcom.net.oidtoobject.oidvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_oidtoobject_trans,
        { "Trans", "qcom.net.oidtoobject.oidvid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_oidtoobject_lcount,
        { "LCount", "qcom.net.oidtoobject.lcount", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_oidtoobject_rcount,
        { "RCount", "qcom.net.oidtoobject.rcount", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },

    /* Net ObjectR */
    { &hf_net_objectr, { "NetObjectR", "qcom.net.objectr", FT_NONE, BASE_NONE,
                           NULL, 0x0, "QCOM NetObjectR", HFILL } },
    { &hf_net_objectr_status, { "Status", "qcom.net.objectr.status", FT_UINT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_objectr_oidoix, { "OidOix", "qcom.net.objectr.oidoix", FT_UINT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_objectr_oidvid, { "OidVid", "qcom.net.objectr.oidvid", FT_UINT32,
                                  BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_net_objectr_count, { "Count", "qcom.net.objectr.count", FT_UINT32,
                                 BASE_DEC, NULL, 0x0, NULL, HFILL } },

    /* Net Gobject */
    { &hf_net_gobject_oidoix, { "OidOix", "qcom.net.gobject.oidoix", FT_UINT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_oidvid, { "OidVid", "qcom.net.gobject.oidvid", FT_UINT32,
                                  BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_cid, { "Cid", "qcom.net.gobject.cid", FT_UINT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_familynameorig,
        { "FamilyNameOrig", "qcom.net.gobject.familynameorig", FT_STRING,
            BASE_NONE, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_familynamenorm,
        { "FamilyNameNorm", "qcom.net.gobject.familynamenorm", FT_STRING,
            BASE_NONE, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_familynamekey,
        { "FamilyNameKey", "qcom.net.gobject.familynamekey", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_familypoidoix,
        { "PoidOix", "qcom.net.gobject.familypoidoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_familypoidvid,
        { "PoidVid", "qcom.net.gobject.familypoidvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_sibflink,
        { "SibFlink", "qcom.net.gobject.sibflink", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_gobject_sibblink,
        { "SibBlink", "qcom.net.gobject.sibblink", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_net_gobject_soidoix,
        { "SoidOix", "qcom.net.gobject.soidoix", FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL } },
    { &hf_net_gobject_soidvid,
        { "SoidVid", "qcom.net.gobject.soidvid", FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL } },
    { &hf_net_gobject_size, { "Size", "qcom.net.gobject.size", FT_UINT32,
                                BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_gobject_flags, { "Flags", "qcom.net.gobject.flags", FT_UINT32,
                                 BASE_DEC, NULL, 0x0, NULL, HFILL } },

    /* Net GetObjectInfo */
    { &hf_net_getobjectinfo,
        { "NetGetObjectInfo", "qcom.net.getobjectinfo", FT_NONE, BASE_NONE,
            NULL, 0x0, "QCOM NetGetObjectInfo", HFILL } },
    { &hf_net_getobjectinfo_arefoix,
        { "ArefOix", "qcom.net.getobjectinfo.arefoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfo_arefvid,
        { "ArefVid", "qcom.net.getobjectinfo.arefvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfo_arefbody,
        { "ArefBody", "qcom.net.getobjectinfo.arefbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfo_arefoffset,
        { "ArefOffset", "qcom.net.getobjectinfo.arefoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfo_arefsize,
        { "ArefSize", "qcom.net.getobjectinfo.arefsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfo_arefflags,
        { "ArefFlags", "qcom.net.getobjectinfo.arefflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },

    /* Net GetObjectInfoR */
    { &hf_net_getobjectinfor,
        { "NetGetObjectInfoR", "qcom.net.getobjectinfor", FT_NONE, BASE_NONE,
            NULL, 0x0, "QCOM NetGetObjectInfoR", HFILL } },
    { &hf_net_getobjectinfor_sts,
        { "Sts", "qcom.net.getobjectinfo.sts", FT_UINT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL } },
    { &hf_net_getobjectinfor_arefoix,
        { "ArefOix", "qcom.net.getobjectinfor.arefoix", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_arefvid,
        { "ArefVid", "qcom.net.getobjectinfor.arefvid", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_arefbody,
        { "ArefBody", "qcom.net.getobjectinfor.arefbody", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_arefoffset,
        { "ArefOffset", "qcom.net.getobjectinfor.arefoffset", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_arefsize,
        { "ArefSize", "qcom.net.getobjectinfor.arefsize", FT_UINT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_arefflags,
        { "ArefFlags", "qcom.net.getobjectinfor.arefflags", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },
    { &hf_net_getobjectinfor_size,
        { "Size", "qcom.net.getobjectinfor.size", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },

  };

  static gint* ett[] = {
    &ett_qcom, &ett_qcom_header, &ett_qcom_header_nodeid,
    &ett_qcom_header_birth, &ett_qcom_header_flags,
    &ett_qcom_header_lacksequence, &ett_qcom_header_lacktimestamp,
    &ett_qcom_header_racksequence, &ett_qcom_header_racktimestamp,
    &ett_qcom_info, &ett_qcom_info_senderaix, &ett_qcom_info_sendernid,
    &ett_qcom_info_pid, &ett_qcom_info_receiverqix, &ett_qcom_info_receivernid,
    &ett_qcom_info_replyqix, &ett_qcom_info_replynid, &ett_qcom_info_btype,
    &ett_qcom_info_stype, &ett_qcom_info_rid, &ett_qcom_info_size,
    &ett_qcom_info_tmo, &ett_qcom_info_status, &ett_qcom_info_flags,
    &ett_mh_header, &ett_mh_header_xdr, &ett_mh_header_platform,
    &ett_mh_header_version, &ett_mh_header_source, &ett_mh_header_birthtime,
    &ett_mh_header_type, &ett_mh_header_qidqix, &ett_mh_header_qidnid,
    &ett_mh_header_nix, &ett_mh_header_outunitoix, &ett_mh_header_outunitvid,
    &ett_mh_header_aidoix, &ett_mh_header_aidvid, &ett_mh_msginfo,
    &ett_mh_msginfo_idnix, &ett_mh_msginfo_idbirthtime, &ett_mh_msginfo_ididx,
    &ett_mh_msginfo_outunitoix, &ett_mh_msginfo_outunitvid,
    &ett_mh_msginfo_eventflags, &ett_mh_msginfo_eventtime,
    &ett_mh_msginfo_eventnamev3, &ett_mh_msginfo_eventtype,
    &ett_mh_msginfo_eventprio, &ett_mh_message, &ett_mh_message_eventtext,
    &ett_mh_message_status, &ett_mh_message_eventsoundoix,
    &ett_mh_message_eventsoundvid, &ett_mh_message_eventsoundbody,
    &ett_mh_message_eventsoundoffset, &ett_mh_message_eventsoundsize,
    &ett_mh_message_eventsoundflags, &ett_mh_message_eventmoretext,
    &ett_mh_message_objectoix, &ett_mh_message_objectvid,
    &ett_mh_message_objectbody, &ett_mh_message_objectoffset,
    &ett_mh_message_objectsize, &ett_mh_message_objectflags,
    &ett_mh_message_supobjectoix, &ett_mh_message_supobjectvid,
    &ett_mh_message_supobjectbody, &ett_mh_message_supobjectoffset,
    &ett_mh_message_supobjectsize, &ett_mh_message_supobjectflags,
    &ett_mh_message_eventname, &ett_mh_message_receiver, &ett_mh_block,
    &ett_mh_block_targetidnix, &ett_mh_block_targetidbirthtime,
    &ett_mh_block_targetididx, &ett_mh_block_detecttime,
    &ett_mh_block_outunitoix, &ett_mh_block_outunitvid, &ett_mh_block_status,
    &ett_mh_block_objectoix, &ett_mh_block_objectvid, &ett_mh_block_objectbody,
    &ett_mh_block_objectoffset, &ett_mh_block_objectsize,
    &ett_mh_block_objectflags, &ett_mh_block_supobjectoix,
    &ett_mh_block_supobjectvid, &ett_mh_block_supobjectbody,
    &ett_mh_block_supobjectoffset, &ett_mh_block_supobjectsize,
    &ett_mh_block_supobjectflags, &ett_mh_block_eventname, &ett_mh_ack,
    &ett_mh_ack_targetidnix, &ett_mh_ack_targetidbirthtime,
    &ett_mh_ack_targetididx, &ett_mh_ack_detecttime, &ett_mh_ack_outunitoix,
    &ett_mh_ack_outunitvid, &ett_mh_ack_objectoix, &ett_mh_ack_objectvid,
    &ett_mh_ack_objectbody, &ett_mh_ack_objectoffset, &ett_mh_ack_objectsize,
    &ett_mh_ack_objectflags, &ett_mh_ack_supobjectoix, &ett_mh_ack_supobjectvid,
    &ett_mh_ack_supobjectbody, &ett_mh_ack_supobjectoffset,
    &ett_mh_ack_supobjectsize, &ett_mh_ack_supobjectflags,
    &ett_mh_ack_eventname, &ett_mh_return, &ett_mh_return_eventtext,
    &ett_mh_return_targetidnix, &ett_mh_return_targetidbirthtime,
    &ett_mh_return_targetididx, &ett_mh_return_detecttime,
    &ett_mh_return_objectoix, &ett_mh_return_objectvid,
    &ett_mh_return_objectbody, &ett_mh_return_objectoffset,
    &ett_mh_return_objectsize, &ett_mh_return_objectflags,
    &ett_mh_return_supobjectoix, &ett_mh_return_supobjectvid,
    &ett_mh_return_supobjectbody, &ett_mh_return_supobjectoffset,
    &ett_mh_return_supobjectsize, &ett_mh_return_supobjectflags,
    &ett_mh_return_eventname, &ett_net_message, &ett_net_message_xdr,
    &ett_net_message_msn, &ett_net_message_nid, &ett_net_oidtoobject,
    &ett_net_oidtoobject_oidoix, &ett_net_oidtoobject_oidvid,
    &ett_net_oidtoobject_trans, &ett_net_oidtoobject_lcount,
    &ett_net_oidtoobject_rcount, &ett_net_objectr, &ett_net_objectr_status,
    &ett_net_objectr_oidoix, &ett_net_objectr_oidvid, &ett_net_objectr_count,
    &ett_net_gobject, &ett_net_gobject_oidoix, &ett_net_gobject_oidvid,
    &ett_net_gobject_cid, &ett_net_gobject_familynameorig,
    &ett_net_gobject_familynamenorm, &ett_net_gobject_familynamekey,
    &ett_net_gobject_familypoidoix, &ett_net_gobject_familypoidvid,
    &ett_net_gobject_sibflink, &ett_net_gobject_sibblink,
    &ett_net_gobject_soidoix, &ett_net_gobject_soidvid, &ett_net_gobject_size,
    &ett_net_gobject_flags, &ett_net_getobjectinfo,
    &ett_net_getobjectinfo_arefoix, &ett_net_getobjectinfo_arefvid,
    &ett_net_getobjectinfo_arefbody, &ett_net_getobjectinfo_arefoffset,
    &ett_net_getobjectinfo_arefsize, &ett_net_getobjectinfo_arefflags,
    &ett_net_getobjectinfor, &ett_net_getobjectinfor_sts,
    &ett_net_getobjectinfor_arefoix, &ett_net_getobjectinfor_arefvid,
    &ett_net_getobjectinfor_arefbody, &ett_net_getobjectinfor_arefoffset,
    &ett_net_getobjectinfor_arefsize, &ett_net_getobjectinfor_arefflags,
...
void dissect_qcom(tvbuff_t* tvb, packet_info* pinfo, proto_tree* tree)
{
  ...
  static gchar protostr[][20]
      = { "QCOM", "QCOM-SYS", "QCOM-EV", "QCOM-Net", "QCOM-Mh", "QCOM-Sev" };
    ...
    if (msg_flags & mSeg_middle && !(msg_flags & mSeg_first))
      ...
      case net_cMsgClass: {
        ...
        case net_eMsg_oidToObject:
          ...
          sprintf(info, "OidToObject     oid  %s",
              qcom_oid_to_string(oid_oix, oid_vid));
          break;
        ...
        case net_eMsg_getObjectInfo:
          ...
          sprintf(info, "GetObjectInfo   aref %s",
              qcom_aref_to_string(aref_oix, aref_vid, aref_offset, aref_size));
          break;
        case net_eMsg_getObjectInfoR:
          ...
          sprintf(info, "GetObjectInfoR  aref %s",
              qcom_aref_to_string(aref_oix, aref_vid, aref_offset, aref_size));
          break;
        ...
        if (msg_size >= 28) {
          ...
          case mh_eMsg_Event: {
            ...
            if (mh_endian == ENC_BIG_ENDIAN)
              mh_eventtype
                  = tvb_get_ntohl(tvb, qcommsg_size + mh_header_size + 132);
            else
              mh_eventtype
                  = tvb_get_letohl(tvb, qcommsg_size + mh_header_size + 132);
            ...
            case mh_eEvent_Ack:
              ...
              if (mh_endian == ENC_BIG_ENDIAN)
                mh_id = tvb_get_ntohl(
                    tvb, qcommsg_size + mh_header_size + mh_msginfo_size + 12);
              else
                mh_id = tvb_get_letohl(
                    tvb, qcommsg_size + mh_header_size + mh_msginfo_size + 12);
            ...
            case mh_eEvent_Unblock:
              ...
              snprintf(&info[16], sizeof(info) - 16, "oid  %s",
                  qcom_oid_to_string(oid_oix, oid_vid));
              break;
            ...
            case mh_eEvent_Return:
              ...
              if (mh_endian == ENC_BIG_ENDIAN)
                mh_id = tvb_get_ntohl(
                    tvb, qcommsg_size + mh_header_size + mh_msginfo_size + 92);
              else
                mh_id = tvb_get_letohl(
                    tvb, qcommsg_size + mh_header_size + mh_msginfo_size + 92);
  ...
  if (tree) { /* we are being asked for details */
    ...
    /* Header map */
    qcom_sub_item = proto_tree_add_item(
        qcom_tree, hf_qcom_header, tvb, offset, header_size, FALSE);
    ...
    offset += 4;
    qcom_sub_item = proto_tree_add_item(
        qcom_header_tree, hf_qcom_header_birth, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    qcom_sub_item = proto_tree_add_item(
        qcom_header_tree, hf_qcom_header_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    qcom_sub_item = proto_tree_add_item(qcom_header_tree,
        hf_qcom_header_lacksequence, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    qcom_sub_item = proto_tree_add_item(qcom_header_tree,
        hf_qcom_header_lacktimestamp, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    qcom_sub_item = proto_tree_add_item(qcom_header_tree,
        hf_qcom_header_racksequence, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    qcom_sub_item = proto_tree_add_item(qcom_header_tree,
        hf_qcom_header_racktimestamp, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;

    if (is_user) {
      /* Info map */
      qcom_sub_item = proto_tree_add_item(
          qcom_tree, hf_qcom_info, tvb, offset, info_size, FALSE);

      qcom_info_tree = proto_item_add_subtree(qcom_sub_item, ett_qcom);

      qcom_sub_item = proto_tree_add_item(qcom_info_tree,
          hf_qcom_info_senderaix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(qcom_info_tree,
          hf_qcom_info_sendernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_pid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(qcom_info_tree,
          hf_qcom_info_receiverqix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(qcom_info_tree,
          hf_qcom_info_receivernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      ...
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_btype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_stype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_rid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_size, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_tmo, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_status, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      qcom_sub_item = proto_tree_add_item(
          qcom_info_tree, hf_qcom_info_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;

      if (is_net) {
        /* Net message map */
        qcom_sub_item = proto_tree_add_item(
            qcom_tree, hf_net_message, tvb, offset, net_message_size, FALSE);

        qcom_net_message_tree = proto_item_add_subtree(qcom_sub_item, ett_qcom);

        qcom_sub_item = proto_tree_add_item(qcom_net_message_tree,
            hf_net_message_xdr, tvb, offset, 4, net_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_net_message_tree,
            hf_net_message_msn, tvb, offset, 4, net_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_net_message_tree,
            hf_net_message_nid, tvb, offset, 4, net_endian);
        offset += 4;
        ...
        if (is_netoidtoobject) {
          ...
          qcom_net_oidtoobject_tree
              = proto_item_add_subtree(qcom_sub_item, ett_qcom);

          qcom_sub_item = proto_tree_add_item(qcom_net_oidtoobject_tree,
              hf_net_oidtoobject_oidoix, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_oidtoobject_tree,
              hf_net_oidtoobject_oidvid, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_oidtoobject_tree,
              hf_net_oidtoobject_trans, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_oidtoobject_tree,
              hf_net_oidtoobject_lcount, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_oidtoobject_tree,
              hf_net_oidtoobject_rcount, tvb, offset, 4, net_endian);
          offset += 4;
        } else if (is_netobjectr) {
          /* Net objectr map */
          qcom_sub_item = proto_tree_add_item(
              qcom_tree, hf_net_objectr, tvb, offset, net_objectr_size, FALSE);

          qcom_net_objectr_tree
              = proto_item_add_subtree(qcom_sub_item, ett_qcom);

          qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
              hf_net_objectr_status, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
              hf_net_objectr_oidoix, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
              hf_net_objectr_oidvid, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
              hf_net_objectr_count, tvb, offset, 4, net_endian);
          offset += 4;

          /* Gobject */
          for (i = 0; i < (int)net_gobject_count; i++) {
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_oidoix, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_oidvid, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_cid, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_familynameorig, tvb, offset, 32, net_endian);
            offset += 32;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_familynamenorm, tvb, offset, 32, net_endian);
            offset += 32;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_familynamekey, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_familypoidoix, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_familypoidvid, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_sibflink, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_sibblink, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_soidoix, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_soidvid, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_size, tvb, offset, 4, net_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_net_objectr_tree,
                hf_net_gobject_flags, tvb, offset, 4, net_endian);
            offset += 4;
          }
          ...
          qcom_net_getobjectinfo_tree
              = proto_item_add_subtree(qcom_sub_item, ett_qcom);

          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefoix, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefvid, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefbody, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefoffset, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefsize, tvb, offset, 4, net_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_net_getobjectinfo_tree,
              hf_net_getobjectinfo_arefflags, tvb, offset, 4, net_endian);
          offset += 4;
        ...
        qcom_sub_item = proto_tree_add_item(
            qcom_tree, hf_mh_header, tvb, offset, mh_header_size, FALSE);

        qcom_mh_header_tree = proto_item_add_subtree(qcom_sub_item, ett_qcom);

        qcom_sub_item = proto_tree_add_item(
            qcom_mh_header_tree, hf_mh_header_xdr, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_platform, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_version, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_source, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_birthtime, tvb, offset, 8, mh_endian);
        offset += 8;
        qcom_sub_item = proto_tree_add_item(
            qcom_mh_header_tree, hf_mh_header_type, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_qidqix, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_qidnid, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(
            qcom_mh_header_tree, hf_mh_header_nix, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_outunitoix, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_outunitvid, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_aidoix, tvb, offset, 4, mh_endian);
        offset += 4;
        qcom_sub_item = proto_tree_add_item(qcom_mh_header_tree,
            hf_mh_header_aidvid, tvb, offset, 4, mh_endian);
        offset += 4;
        offset += 20;
        ...
        if (is_mhmsg) {
          /* Mh msginfo map */
          qcom_sub_item = proto_tree_add_item(
              qcom_tree, hf_mh_msginfo, tvb, offset, mh_msginfo_size, FALSE);

          qcom_mh_msginfo_tree
              = proto_item_add_subtree(qcom_sub_item, ett_qcom);

          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_idnix, tvb, offset, 4, mh_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_idbirthtime, tvb, offset, 8, mh_endian);
          offset += 8;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_ididx, tvb, offset, 4, mh_endian);
          offset += 4;
          offset += 8;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_outunitoix, tvb, offset, 4, mh_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_outunitvid, tvb, offset, 4, mh_endian);
          offset += 4;
          offset += 8;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_eventflags, tvb, offset, 4, mh_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_eventtime, tvb, offset, 8, mh_endian);
          offset += 8;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_eventnamev3, tvb, offset, 80, mh_endian);
          offset += 80;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_eventtype, tvb, offset, 4, mh_endian);
          offset += 4;
          qcom_sub_item = proto_tree_add_item(qcom_mh_msginfo_tree,
              hf_mh_msginfo_eventprio, tvb, offset, 4, mh_endian);
          offset += 4;

          if (is_mhmessage) {
            /* Mh message map */
            qcom_sub_item = proto_tree_add_item(
                qcom_tree, hf_mh_message, tvb, offset, mh_message_size, FALSE);

            qcom_mh_message_tree
                = proto_item_add_subtree(qcom_sub_item, ett_qcom);

            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventtext, tvb, offset, 80, mh_endian);
            offset += 80;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_status, tvb, offset, 4, mh_endian);
            offset += 4;
            offset += 36; /* SupInfo TODO... */
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventsoundflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventmoretext, tvb, offset, 256, mh_endian);
            offset += 256;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_objectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_supobjectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_eventname, tvb, offset, 400, mh_endian);
            offset += 400;
            qcom_sub_item = proto_tree_add_item(qcom_mh_message_tree,
                hf_mh_message_receiver, tvb, offset, 40, mh_endian);
            offset += 40;
          } else if (is_mhblock) {
            /* Mh block map */
            qcom_sub_item = proto_tree_add_item(
                qcom_tree, hf_mh_block, tvb, offset, mh_block_size, FALSE);

            qcom_mh_block_tree
                = proto_item_add_subtree(qcom_sub_item, ett_qcom);

            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_targetidnix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_targetidbirthtime, tvb, offset, 8, mh_endian);
            offset += 8;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_targetididx, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_detecttime, tvb, offset, 8, mh_endian);
            offset += 8;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_outunitoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_outunitvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_status, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_objectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_supobjectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_block_tree,
                hf_mh_block_eventname, tvb, offset, 400, mh_endian);
            offset += 400;
          } else if (is_mhack) {
            /* Mh ack map */
            qcom_sub_item = proto_tree_add_item(
                qcom_tree, hf_mh_ack, tvb, offset, mh_ack_size, FALSE);

            qcom_mh_ack_tree = proto_item_add_subtree(qcom_sub_item, ett_qcom);

            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_targetidnix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_targetidbirthtime, tvb, offset, 8, mh_endian);
            offset += 8;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_targetididx, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_detecttime, tvb, offset, 8, mh_endian);
            offset += 8;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_outunitoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_outunitvid, tvb, offset, 4, mh_endian);
            offset += 4;
            offset += 36; /* SupInfo TODO */
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_objectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_supobjectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_ack_tree,
                hf_mh_ack_eventname, tvb, offset, 400, mh_endian);
            offset += 400;
          } else if (is_mhreturn) {
            /* Mh return map */
            qcom_sub_item = proto_tree_add_item(
                qcom_tree, hf_mh_return, tvb, offset, mh_return_size, FALSE);

            qcom_mh_return_tree
                = proto_item_add_subtree(qcom_sub_item, ett_qcom);

            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_eventtext, tvb, offset, 80, mh_endian);
            offset += 80;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_targetidnix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_targetidbirthtime, tvb, offset, 8, mh_endian);
            offset += 8;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_targetididx, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_detecttime, tvb, offset, 8, mh_endian);
            offset += 8;
            offset += 36; /* SupInfo TODO */
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_objectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectoix, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectvid, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectbody, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectoffset, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectsize, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_supobjectflags, tvb, offset, 4, mh_endian);
            offset += 4;
            qcom_sub_item = proto_tree_add_item(qcom_mh_return_tree,
                hf_mh_return_eventname, tvb, offset, 400, mh_endian);
            offset += 400;
          }
        }
      }
