...
void proto_register_redcom(void)
{
  ...
  static hf_register_info hf[] = {
    { &hf_redcom, { "Data", "redcom.data", FT_NONE, BASE_NONE, NULL, 0x0,
                      "REDCOM Data", HFILL } },

    /* Redcom Header */
    { &hf_redcom_header, { "Header", "redcom.header", FT_NONE, BASE_NONE, NULL,
                             0x0, "REDCOM Header", HFILL } },
    { &hf_redcom_header_nodeid, { "NodeId", "redcom.header.nodeid", FT_UINT32,
                                    BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_birth, { "Birth", "redcom.header.birth", FT_INT32,
                                   BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_flags, { "Flags", "redcom.header.flags", FT_UINT32,
                                   BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_lacksequence,
        { "LackSequence", "redcom.header.lacksequence", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_lacktimestamp,
        { "LackTimestamp", "redcom.header.lacktimestamp", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_racksequence,
        { "RackSequence", "redcom.header.racksequence", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_racktimestamp,
        { "RackTimestamp", "redcom.header.racktimestamp", FT_INT32, BASE_DEC,
            NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_prio, { "Prio", "redcom.header.prio", FT_INT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_header_state, { "State", "redcom.header.state", FT_INT32,
                                   BASE_DEC, NULL, 0x0, NULL, HFILL } },

    /* Redcom Info */
    { &hf_redcom_info, { "Info", "redcom.info", FT_NONE, BASE_NONE, NULL, 0x0,
                           "REDCOM Info", HFILL } },
    { &hf_redcom_info_senderaix,
        { "SenderAix", "redcom.info.senderaix", FT_INT32, BASE_DEC, NULL, 0x0,
            NULL, HFILL } },
    { &hf_redcom_info_sendernid,
        { "SenderNid", "redcom.info.sendernid", FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL } },
    { &hf_redcom_info_pid, { "Pid", "redcom.info.pid", FT_UINT32, BASE_DEC,
                               NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_receiverqix,
        { "ReceiverQix", "redcom.info.receiverqix", FT_INT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_redcom_info_receivernid,
        { "ReceiverNid", "redcom.info.receivernid", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },
    { &hf_redcom_info_replyqix, { "ReplyQix", "redcom.info.replyqix", FT_INT32,
                                    BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_replynid, { "ReplyNid", "redcom.info.replynid", FT_UINT32,
                                    BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_btype, { "BType", "redcom.info.btype", FT_INT32, BASE_DEC,
                                 NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_stype, { "SType", "redcom.info.stype", FT_INT32, BASE_DEC,
                                 NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_rid, { "Rid", "redcom.info.rid", FT_INT32, BASE_DEC, NULL,
                               0x0, NULL, HFILL } },
    { &hf_redcom_info_size, { "Size", "redcom.info.size", FT_UINT32, BASE_DEC,
                                NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_tmo, { "Tmo", "redcom.info.tmo", FT_INT32, BASE_DEC, NULL,
                               0x0, NULL, HFILL } },
    { &hf_redcom_info_status, { "Status", "redcom.info.status", FT_INT32,
                                  BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redcom_info_flags, { "Flags", "redcom.info.flags", FT_UINT32,
                                 BASE_HEX, NULL, 0x0, NULL, HFILL } },

    /* Redu MsgHeader */
    { &hf_redu_msgheader, { "MsgHeader", "redcom.msgheader", FT_NONE, BASE_NONE,
                              NULL, 0x0, "Redcom Msg Header", HFILL } },
    { &hf_redu_msgheader_type, { "Type", "redcom.msgheader.type", FT_UINT32,
                                   BASE_HEX, NULL, 0x0, NULL, HFILL } },
    { &hf_redu_msgheader_size, { "Size", "redcom.msgheader.size", FT_UINT32,
                                   BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redu_msgheader_version,
        { "Version", "redcom.msgheader.version", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },

    /* Redu TableMsgHeader */
    { &hf_redu_tablemsgheader,
        { "MsgTableHeader", "redcom.tablemsgheader", FT_NONE, BASE_NONE, NULL,
            0x0, "Redcom TableMsg Header", HFILL } },
    { &hf_redu_tablemsgheader_type,
        { "Type", "redcom.tablemsgheader.type", FT_UINT32, BASE_HEX, NULL, 0x0,
            NULL, HFILL } },
    { &hf_redu_tablemsgheader_size,
        { "Size", "redcom.redu.tablemsgheader.size", FT_UINT32, BASE_DEC, NULL,
            0x0, NULL, HFILL } },
    { &hf_redu_tablemsgheader_attributes,
        { "Attributes", "redcom.redu.tablemsgheader.attributes", FT_UINT32,
            BASE_DEC, NULL, 0x0, NULL, HFILL } },
    { &hf_redu_tablemsgheader_version,
        { "Version", "redcom.redu.tablemsgheader.version", FT_ABSOLUTE_TIME,
            ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL, HFILL } },

    /* Redu TableReqMsgHeader */
    { &hf_redu_tablereqmsgheader,
        { "MsgTableReqHeader", "redcom.tablereqmsgheader", FT_NONE, BASE_NONE,
            NULL, 0x0, "Redcom TableReqeustMsg Header", HFILL } },
    { &hf_redu_tablereqmsgheader_type,
        { "Type", "redcom.tablereqmsgheader.type", FT_UINT32, BASE_HEX, NULL,
            0x0, NULL, HFILL } },

    /* Redu TableVersionReqMsgHeader */
    { &hf_redu_tableversionreqmsgheader,
        { "MsgTableVersionReqHeader", "redcom.tableversionreqmsgheader",
            FT_NONE, BASE_NONE, NULL, 0x0,
            "Redcom TableVersionReqeustMsg Header", HFILL } },
    { &hf_redu_tableversionreqmsgheader_type,
        { "Type", "redcom.tableversionreqmsgheader.type", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },

    /* Redu TableVersionMsgHeader */
    { &hf_redu_tableversionmsgheader,
        { "MsgTableVersionHeader", "redcom.tableversionmsgheader", FT_NONE,
            BASE_NONE, NULL, 0x0, "Redcom TableVersionMsg Header", HFILL } },
    { &hf_redu_tableversionmsgheader_type,
        { "Type", "redcom.tableversionmsgheader.type", FT_UINT32, BASE_HEX,
            NULL, 0x0, NULL, HFILL } },

  };

  static gint* ett[] = {
    &ett_redcom, &ett_redcom_header, &ett_redcom_header_nodeid,
    &ett_redcom_header_birth, &ett_redcom_header_flags,
    &ett_redcom_header_lacksequence, &ett_redcom_header_lacktimestamp,
    &ett_redcom_header_racksequence, &ett_redcom_header_racktimestamp,
    &ett_redcom_header_prio, &ett_redcom_header_state, &ett_redcom_info,
    &ett_redcom_info_senderaix, &ett_redcom_info_sendernid,
    &ett_redcom_info_pid, &ett_redcom_info_receiverqix,
    &ett_redcom_info_receivernid, &ett_redcom_info_replyqix,
    &ett_redcom_info_replynid, &ett_redcom_info_btype, &ett_redcom_info_stype,
    &ett_redcom_info_rid, &ett_redcom_info_size, &ett_redcom_info_tmo,
    &ett_redcom_info_status, &ett_redcom_info_flags, &ett_redu_msgheader,
    &ett_redu_msgheader_type, &ett_redu_msgheader_size,
    &ett_redu_msgheader_version, &ett_redu_tablemsgheader,
    &ett_redu_tablemsgheader_type, &ett_redu_tablemsgheader_size,
    &ett_redu_tablemsgheader_attributes, &ett_redu_tablemsgheader_version,
    &ett_redu_tablereqmsgheader, &ett_redu_tablereqmsgheader_type,
    &ett_redu_tableversionreqmsgheader, &ett_redu_tableversionreqmsgheader_type,
    &ett_redu_tableversionmsgheader, &ett_redu_tableversionmsgheader_type,
...
void dissect_redcom(tvbuff_t* tvb, packet_info* pinfo, proto_tree* tree)
{
  ...
  if (tree) { /* we are being asked for details */
    ...
    /* Header map */
    redcom_sub_item = proto_tree_add_item(
        redcom_tree, hf_redcom_header, tvb, offset, header_size, FALSE);

    redcom_header_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_nodeid, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_birth, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_lacksequence, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_lacktimestamp, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_racksequence, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_racktimestamp, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_prio, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree,
        hf_redcom_header_state, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;

    if (is_user) {
      /* Info map */
      redcom_sub_item = proto_tree_add_item(
          redcom_tree, hf_redcom_info, tvb, offset, info_size, FALSE);

      redcom_info_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_senderaix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_sendernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(
          redcom_info_tree, hf_redcom_info_pid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_receiverqix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_receivernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_replyqix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_replynid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_btype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_stype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(
          redcom_info_tree, hf_redcom_info_rid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_size, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(
          redcom_info_tree, hf_redcom_info_tmo, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_status, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item = proto_tree_add_item(redcom_info_tree,
          hf_redcom_info_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      ...
      if (is_reducyclic) {
        ...
        redcom_redu_cyclic_tree
            = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree,
            hf_redu_msgheader_type, tvb, offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree,
            hf_redu_msgheader_size, tvb, offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree,
            hf_redu_msgheader_version, tvb, offset, 8, local_endian);
        offset += 8;
      } else if (is_redutable) {
        /* Redu table */
        redcom_sub_item = proto_tree_add_item(redcom_tree,
            hf_redu_tablemsgheader, tvb, offset, redutable_size, FALSE);

        redcom_redu_table_tree
            = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree,
            hf_redu_tablemsgheader_type, tvb, offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree,
            hf_redu_tablemsgheader_size, tvb, offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree,
            hf_redu_tablemsgheader_attributes, tvb, offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree,
            hf_redu_tablemsgheader_version, tvb, offset, 8, local_endian);
        offset += 8;
      } else if (is_redutablerequest) {
        /* redu table request message map */
        redcom_sub_item = proto_tree_add_item(redcom_tree,
            hf_redu_tablereqmsgheader, tvb, offset, redutable_size, FALSE);

        redcom_redu_tablerequest_tree
            = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_tablerequest_tree,
            hf_redu_tablereqmsgheader_type, tvb, offset, 4, local_endian);
        offset += 4;
      } else if (is_redutableversionrequest) {
        /* redu table request message map */
        redcom_sub_item
            = proto_tree_add_item(redcom_tree, hf_redu_tableversionreqmsgheader,
                tvb, offset, redutable_size, FALSE);

        redcom_redu_tableversionrequest_tree
            = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item
            = proto_tree_add_item(redcom_redu_tableversionrequest_tree,
                hf_redu_tableversionreqmsgheader_type, tvb, offset, 4,
                local_endian);
        offset += 4;
      } else if (is_redutableversion) {
        /* redu table request message map */
        redcom_sub_item = proto_tree_add_item(redcom_tree,
            hf_redu_tableversionmsgheader, tvb, offset, redutable_size, FALSE);

        redcom_redu_tableversion_tree
            = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_tableversion_tree,
            hf_redu_tableversionmsgheader_type, tvb, offset, 4, local_endian);
        offset += 4;
      }
    }
  }
