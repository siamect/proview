...
copy : $(export_includes) $(l_copy)


lib :


exe : $(objects) $(export_obj) $(export_exe) $(l_exe)

dirs : $(bld_dir)$(dir_ext) $(l_dirs)

$(bld_dir)$(dir_ext) :
	@ $(mkdir) $(mkdirflags) $(to-vms $(basename $@)/)

clean : clean_exe $(l_clean_exe)

realclean : clean $(clean_h_includes) $(clean_hpp_includes) clean_dirs $(l_realclean)
