...
static void findstrconst(char **str,
                         char **val);

static void findconst(char **str,
                      char **val);

static void findkind(char **mark,
                     token *tokp);
...
static void docppline(char *line,
                      int *lineno,
                      char **fname);
