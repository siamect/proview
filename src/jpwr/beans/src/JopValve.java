/* 
 * Proview   $Id: JopValve.java,v 1.3 2005-09-01 14:57:50 claes Exp $
...
public class JopValve extends JComponent implements JopDynamic, ActionListener{
  Dimension size;
  Object root;
  JopEngine en;
  ...
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 2, 2, 42, 42, 2}, new int[] {2, 22, 2, 22, 2}, 5),
  };
