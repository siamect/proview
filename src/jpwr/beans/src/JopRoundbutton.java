/* 
 * Proview   $Id: JopRoundbutton.java,v 1.4 2005-09-01 14:57:49 claes Exp $
...
public class JopRoundbutton extends JComponent implements JopDynamic, JopConfirm, ActionListener{
  Dimension size;
  Object root;
  JopEngine en;
  JopSession session;
  ...
  public JopRoundbutton component = this;
  public JopRoundbutton()
  {
    try {
      jbInit();
    }
  ...
  Shape[] shapes = new Shape[] { 
    new Arc2D.Float(2F, 2F, 60F, 60F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(2F, 2F, 60F, 60F, 180F, 100F, Arc2D.PIE),
    new Arc2D.Float(2F, 2F, 60F, 60F, 0F, 120F, Arc2D.PIE),
    new Arc2D.Float(2F, 2F, 60F, 60F, 190F, 30F, Arc2D.PIE),
    new Arc2D.Float(2F, 2F, 60F, 60F, 30F, 30F, Arc2D.PIE),
    new Arc2D.Float(2F, 2F, 60F, 60F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(11.8812F, 13.158F, 40.2377F, 37.6841F, 0F, 180F, Arc2D.PIE),
    new Arc2D.Float(11.8812F, 13.158F, 40.2377F, 37.6841F, 180F, 180F, Arc2D.PIE),
    new Arc2D.Float(17.4218F, 17.9374F, 29.1565F, 28.1253F, 0F, 360F, Arc2D.PIE),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(92, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, false));
    g.fill( shapes[7]);
    ...
    g.setColor(GeColor.getColor(14, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, false));
    g.draw( shapes[7]);
    g.setColor(GeColor.getColor(91, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, false));
    g.fill( shapes[8]);
    ...
    g.drawString( annot1, 20 * original_height / height * width / original_width, 36F);
