/* 
 * Proview   $Id: JopReliefmedium.java,v 1.3 2005-09-01 14:57:49 claes Exp $
...
import javax.swing.*;
public class JopReliefmedium extends JComponent {
  Dimension size;
  public JopReliefmedium()
  {
    try {
      jbInit();
    }
  ...
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 2, 7, 236, 242, 2}, new int[] {2, 7, 7, 2, 2}, 5),
    ...
    new Rectangle2D.Float(8F, 8F, 228F, 128F),
  };
