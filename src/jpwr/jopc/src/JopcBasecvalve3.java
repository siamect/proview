...
public class JopcBasecvalve3 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_actuator	pwr_actuator50;
  pwr_basevalve	pwr_basevalve51;
  pwr_pulldownmenu	pwr_pulldownmenu54;
  ...
  public void geInit() {
    ...
    pwr_actuator50 = new pwr_actuator(session);
    pwr_actuator50.setBounds(new Rectangle(260,453,132,84));
    pwr_actuator50.setShadow(1);
    localPanel.add(pwr_actuator50, new Proportion(pwr_actuator50.getBounds(), dsize));
    pwr_basevalve51 = new pwr_basevalve(session);
    pwr_basevalve51.setBounds(new Rectangle(285,533,80,122));
    pwr_basevalve51.setShadow(1);
    localPanel.add(pwr_basevalve51, new Proportion(pwr_basevalve51.getBounds(), dsize));
    pwr_pulldownmenu54 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu54.setBounds(new Rectangle(160,0,69,24));
    pwr_pulldownmenu54.setShadow(1);
    localPanel.add(pwr_pulldownmenu54, new Proportion(pwr_pulldownmenu54.getBounds(), dsize));
    jopSmallbutton55 = new JopSmallbutton(session);
    jopSmallbutton55.setBounds(new Rectangle(36,342,48,21));
    ...
    pwr_indround56.setBounds(new Rectangle(96,397,18,18));
    ...
    grp175_57 = new Grp175_(session);
    grp175_57.setBounds(new Rectangle(39,396,35,17));
    localPanel.add(grp175_57, new Proportion(grp175_57.getBounds(), dsize));
    pwr_indsquare58 = new pwr_indsquare(session);
    pwr_indsquare58.setBounds(new Rectangle(182,487,16,16));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton41.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton41.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
...
null)
    ...
    pwr_actuator50.dd.setDynType(1);
    pwr_actuator50.dd.setActionType(66);
    pwr_actuator50.dd.setAccess(65532);
    pwr_actuator50.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator50.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator50.dd, "open graph/class/inst=$object.Actuator")
      });
    pwr_basevalve51.dd.setDynType(16385);
    pwr_basevalve51.dd.setActionType(66);
    pwr_basevalve51.dd.setAccess(65532);
    pwr_basevalve51.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve51.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve51.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve51.dd, "open graph/class/inst=$object.Valve")
      });
    pwr_pulldownmenu54.dd.setDynType(1);
    pwr_pulldownmenu54.dd.setActionType(524288);
    pwr_pulldownmenu54.dd.setAccess(65535);
    pwr_pulldownmenu54.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu54.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu54,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu54.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu54,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu54.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu54.setAnnot1("Components");
    jopSmallbutton55.dd.setDynType(128);
    jopSmallbutton55.dd.setActionType(4);
    jopSmallbutton55.dd.setAccess(65532);
    jopSmallbutton55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton55.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton55.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    jopSmallbutton55.setAnnot1("Man");
    pwr_indround56.dd.setDynType(133);
    pwr_indround56.dd.setActionType(0);
    pwr_indround56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround56.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround56.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_57.dd.setDynType(129);
    grp175_57.dd.setActionType(0);
    grp175_57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_57.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare58.dd.setDynType(13);
    pwr_indsquare58.dd.setActionType(0);
    pwr_indsquare58.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare58.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare58.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
