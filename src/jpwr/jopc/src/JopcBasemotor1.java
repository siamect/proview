...
public class JopcBasemotor1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuesmall22.setBounds(new Rectangle(134,128,50,17));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(20F, 98F, 179.619F, 71.3333F),
    new Polygon( new int[] { 20, 200, 199, 21, 21, 20}, new int[] { 98, 98, 99, 99, 169, 169}, 6), 
    new Polygon( new int[] { 200, 200, 199, 199, 21, 20}, new int[] { 169, 98, 99, 169, 169, 169}, 6), 
  };
