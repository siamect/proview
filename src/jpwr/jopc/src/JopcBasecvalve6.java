...
public class JopcBasecvalve6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecvalve6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare36.setBounds(new Rectangle(166,186,16,17));
    ...
    jopSmallbutton46.setBounds(new Rectangle(36,365,48,21));
    ...
    pwr_valueinputsmallrd52.setColorBrightness(-2);
    ...
    pwr_indsquare55.setBounds(new Rectangle(165,237,15,17));
    ...
    pwr_indsquare56.setBounds(new Rectangle(166,256,16,17));
    ...
    grp167_57.setBounds(new Rectangle(472,106,46,18));
    ...
    pwr_pulldownmenu63.setBounds(new Rectangle(160,0,69,24));
    ...
    jopSmallbutton64.setBounds(new Rectangle(36,342,48,21));
    ...
    grp175_66.setBounds(new Rectangle(39,396,35,17));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu31.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu31.dd, new String[] {
        "Position Ai","Order Ao","SwitchClosed Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton46.dd.setActionType(4);
    jopSmallbutton46.dd.setAccess(65532);
    jopSmallbutton46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton46.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton46.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    jopSmallbutton46.setAnnot1(" Auto");
    ...
    pwr_sliderbackground1_250.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_250.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
...
null)
    ...
    grp167_57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_57.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_pulldownmenu63.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu63.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu63,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu63.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu63.setAnnot1("Components");
    jopSmallbutton64.dd.setDynType(128);
    jopSmallbutton64.dd.setActionType(4);
    jopSmallbutton64.dd.setAccess(65532);
    jopSmallbutton64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton64.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton64.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    jopSmallbutton64.setAnnot1(" Man");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SwitchClosed",38, 202);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
