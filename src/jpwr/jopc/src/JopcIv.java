/* 
 * Proview   $Id: JopcIv.java,v 1.2 2005-09-01 14:57:51 claes Exp $
...
public class JopcIv extends JopcIvGen implements JopDynamic {
  ...
  LocalDb ldb;
  public JopcIv( JopSession session, String instance, boolean scrollbar) {
