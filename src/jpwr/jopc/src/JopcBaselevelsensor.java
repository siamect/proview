...
public class JopcBaselevelsensor extends JopFrame implements JopUtilityIfc {
  ...
  pwr_pulldownmenu	pwr_pulldownmenu61;
  pwr_pulldownmenu	pwr_pulldownmenu62;
  Grp132_	grp132_67;
  ...
  public void geInit() {
    ...
    pwr_valuelong2.setBounds(new Rectangle(17,46,429,22));
    ...
    pwr_menubar3.setBounds(new Rectangle(0,0,455,24));
    ...
    pwr_pulldownmenu5.setBounds(new Rectangle(367,0,69,24));
    ...
    pwr_valuelong20.setBounds(new Rectangle(17,70,429,22));
    ...
    pwr_sliderbackground324.setBounds(new Rectangle(334,116,115,244));
    ...
    pwr_slider325.setBounds(new Rectangle(334,336,115,14));
    ...
    pwr_slider326.setBounds(new Rectangle(334,316,115,14));
    ...
    pwr_slider327.setBounds(new Rectangle(334,136,115,14));
    ...
    pwr_slider328.setBounds(new Rectangle(334,156,115,14));
    ...
    pwr_switch55.setBounds(new Rectangle(117,160,34,34));
    ...
    pwr_indsquare57.setBounds(new Rectangle(95,306,15,17));
    ...
    pwr_indsquare58.setBounds(new Rectangle(95,324,15,16));
    ...
    pwr_indsquare59.setBounds(new Rectangle(95,342,15,17));
    ...
    pwr_indsquare60.setBounds(new Rectangle(95,360,15,16));
    ...
    pwr_pulldownmenu61 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu61.setBounds(new Rectangle(150,0,69,24));
    pwr_pulldownmenu61.setShadow(1);
    localPanel.add(pwr_pulldownmenu61, new Proportion(pwr_pulldownmenu61.getBounds(), dsize));
    pwr_pulldownmenu62 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu62.setBounds(new Rectangle(69,0,69,24));
    pwr_pulldownmenu62.setShadow(1);
    localPanel.add(pwr_pulldownmenu62, new Proportion(pwr_pulldownmenu62.getBounds(), dsize));
    grp132_67 = new Grp132_(session);
    grp132_67.setBounds(new Rectangle(342,116,77,243));
    localPanel.add(grp132_67, new Proportion(grp132_67.getBounds(), dsize));
...
null)
    ...
    pwr_pulldownmenu61.dd.setDynType(1);
    pwr_pulldownmenu61.dd.setActionType(524288);
    pwr_pulldownmenu61.dd.setAccess(65535);
    pwr_pulldownmenu61.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu61.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu61,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu61.dd, "open graph /class /inst=$object.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu61.setAnnot1("Signals");
    pwr_pulldownmenu62.dd.setDynType(1);
    pwr_pulldownmenu62.dd.setActionType(524288);
    pwr_pulldownmenu62.dd.setAccess(65535);
    pwr_pulldownmenu62.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu62.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu62,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu62,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu62.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu62.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu62.setAnnot1("Methods");
    grp132_67.dd.setDynType(2097153);
    grp132_67.dd.setActionType(0);
    grp132_67.dd.setElements(new GeDynElemIfc[] {
      new GeDynFillLevel(grp132_67.dd, "$object.Value.ActualValue##Float32",39,4,0,100,0,0,"$object.Value.PresMinLimit##Float32","$object.Value.PresMaxLimit##Float32")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( "Supervision disabled",128, 273);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_slider3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 50, 52, 61, 58}, new int[] { 3, 4, 4,3}, 4),
    new Polygon( new int[] { 58, 61, 61, 58}, new int[] { 3, 4, 14,11}, 4),
    new Polygon( new int[] { 58, 61, 51, 50}, new int[] { 11, 14, 14,11}, 4),
    new Polygon( new int[] { 50, 51, 51, 50}, new int[] { 11, 14, 6,3}, 4),
    new Polygon( new int[] { 50, 51, 52, 49}, new int[] { 3, 6, 6,3}, 4),
    new Polygon( new int[] { 49, 52, 52, 49}, new int[] { 3, 6, 13,12}, 4),
    new Polygon( new int[] { 49, 52, 60, 59}, new int[] { 12, 13, 13,12}, 4),
    new Polygon( new int[] { 59, 60, 60, 59}, new int[] { 12, 13, 5,2}, 4),
    new Polygon( new int[] { 59, 60, 52, 49}, new int[] { 2, 5, 5,2}, 4),
    new Polygon( new int[] { 49, 52, 52, 49}, new int[] { 2, 5, 4,3}, 4),
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 14, 7, 2}, new int[] { 22, 20, 6,2}, 4),
    new Polygon( new int[] { 2, 7, 21, 22}, new int[] { 2, 6, 6,2}, 4),
    new Polygon( new int[] { 22, 21, 14, 12}, new int[] { 2, 6, 20,22}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class Grp132_ extends GeComponent {
  Dimension size;
  public Grp132_( JopSession session)
  {
    super( session);
    size = new Dimension( 77, 243);
  }
  public int original_width = 77;
  public int original_height = 243;
  Shape[] shapes = new Shape[] { 
    new RoundRectangle2D.Float(2F, 2F, 73F, 239F, 58.4F, 58.4F),
    new Rectangle2D.Float(31.2F, 2F, 14.6F, 5.11F),
    new Rectangle2D.Float(2F, 31.2F, 5.11F, 180.6F),
    new Arc2D.Float(2F, 2F, 58.4F, 58.4F, 90F, 90F, Arc2D.PIE),
    new Arc2D.Float(16.6F, 2F, 58.4F, 58.4F, 45F, 45F, Arc2D.PIE),
    new Arc2D.Float(2F, 182.6F, 58.4F, 58.4F, 180F, 45F, Arc2D.PIE),
    new Rectangle2D.Float(31.2F, 235.89F, 14.6F, 5.11F),
    new Rectangle2D.Float(69.89F, 31.2F, 5.11F, 180.6F),
    new Arc2D.Float(16.6F, 182.6F, 58.4F, 58.4F, 270F, 90F, Arc2D.PIE),
    new Arc2D.Float(16.6F, 2F, 58.4F, 58.4F, 0F, 45F, Arc2D.PIE),
    new Arc2D.Float(2F, 182.6F, 58.4F, 58.4F, 225F, 45F, Arc2D.PIE),
    new RoundRectangle2D.Float(7.11F, 7.11F, 62.78F, 228.78F, 48.18F, 48.18F),
    new RoundRectangle2D.Float(2F, 2F, 73F, 239F, 58.4F, 58.4F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
