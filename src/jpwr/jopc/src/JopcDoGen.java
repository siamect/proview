...
public class JopcDoGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopTrend2.setBounds(new Rectangle(186,36,607,32));
    ...
    pwr_valuelong7.setBounds(new Rectangle(123,0,685,23));
    ...
    pwr_valuemedium8.setBounds(new Rectangle(124,60,29,22));
    ...
    pwr_buttoncommand10.setBounds(new Rectangle(5,86,90,30));
    ...
    pwr_valueinputmedium11.setBounds(new Rectangle(124,36,30,23));
    ...
    pwr_valueinputreliefup12.setBounds(new Rectangle(185,71,43,19));
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 809;
  public int original_height = 124;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "0",787, 81);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "InitialValue",9, 78);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 6, 8}, new int[] { 35, 29, 28,29}, 4),
    ...
    new Polygon( new int[] { 2, 6, 6, 2}, new int[] { 2, 6, 29,35}, 4),
    ...
    new Polygon( new int[] { 96, 98, 98, 96}, new int[] { 29, 31, 11,8}, 4),
    new Polygon( new int[] { 96, 98, 100, 102}, new int[] { 8, 11, 9,2}, 4),
    new Polygon( new int[] { 102, 100, 100, 102}, new int[] { 2, 9, 33,35}, 4),
