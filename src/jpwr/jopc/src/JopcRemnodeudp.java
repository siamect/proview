/* 
 * Proview   $Id: JopcRemnodeudp.java,v 1.3 2005-09-01 14:57:51 claes Exp $
...
public class JopcRemnodeudp extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp60_3.setBounds(new Rectangle(15,185,21,19));
    localPanel.add(grp60_3, new Proportion(grp60_3.getBounds(), dsize));
    grp65_4 = new Grp65_(session);
    grp65_4.setBounds(new Rectangle(15,203,21,19));
    ...
    pwr_valuesmall26.setBounds(new Rectangle(123,37,47,18));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(123,72,129,18));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(123,90,129,18));
    ...
    pwr_valuesmall39.setBounds(new Rectangle(123,108,47,18));
    ...
    pwr_valuesmall41.setBounds(new Rectangle(123,125,47,18));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(436,55,74,18));
    ...
    pwr_valuesmall45.setBounds(new Rectangle(436,72,74,18));
    ...
    pwr_valuesmall47.setBounds(new Rectangle(436,90,74,18));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Prio",17, 47);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Description",17, 29);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "DevName",17, 64);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "RemoteHost",17, 82);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "RemoteAddress",17, 100);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "LocalPort",17, 117);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "RemotePort",17, 135);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "LinkUp",331, 64);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Disable",331, 82);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "ErrCount",331, 100);
    g.setTransform(save);
  }
