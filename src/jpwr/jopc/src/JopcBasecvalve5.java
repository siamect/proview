...
public class JopcBasecvalve5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecvalve5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare36.setBounds(new Rectangle(165,185,15,17));
    ...
    pwr_pulldownmenu63.setBounds(new Rectangle(160,0,86,24));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare36.dd, "$object.Actuator.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare36.dd, "$object.Actuator.SwitchOpen")
      });
