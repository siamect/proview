/* 
 * Proview   $Id: JopcAiGen.java,v 1.3 2005-09-01 14:57:51 claes Exp $
...
public class JopcAiGen extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputmedium	pwr_valueinputmedium21;
  ...
  public JopcAiGen( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAiGen( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAiGen");
    pwr_valuemedium2 = new pwr_valuemedium(session);
    pwr_valuemedium2.setBounds(new Rectangle(122,128,97,24));
    ...
    pwr_valuemedium4.setBounds(new Rectangle(122,155,97,24));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(200,55,42,19));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(200,202,42,19));
    ...
    pwr_valueinputreliefup20.setBounds(new Rectangle(289,214,42,19));
    ...
    pwr_valueinputmedium21 = new pwr_valueinputmedium(session);
    pwr_valueinputmedium21.setBounds(new Rectangle(122,101,97,24));
    pwr_valueinputmedium21.setBorderColor(47);
    localPanel.add(pwr_valueinputmedium21, new Proportion(pwr_valueinputmedium21.getBounds(), dsize));
    pwr_mbopenobject22 = new pwr_mbopenobject(session);
    pwr_mbopenobject22.setBounds(new Rectangle(178,0,20,20));
    ...
    pwr_mbtrend23.setBounds(new Rectangle(39,0,20,20));
    ...
    pwr_mbfast24.setBounds(new Rectangle(59,0,20,20));
    ...
    pwr_mbphoto25.setBounds(new Rectangle(79,0,20,20));
    ...
    pwr_mbdatasheet26.setBounds(new Rectangle(99,0,20,20));
    ...
    pwr_mbcircuitdiagram27.setBounds(new Rectangle(218,0,20,20));
    ...
    pwr_mbrtnavigator28.setBounds(new Rectangle(158,0,20,20));
    ...
    pwr_mbblockevents30.setBounds(new Rectangle(138,0,20,20));
    ...
    pwr_mbnote32.setBounds(new Rectangle(19,0,20,20));
    ...
    pwr_mbcrossreferences34.setBounds(new Rectangle(198,0,20,20));
    ...
    jopButtontoggle35.setBounds(new Rectangle(278,0,48,21));
    ...
    pwr_valuelong36.setBounds(new Rectangle(333,0,488,23));
    ...
    pwr_valueinputreliefup18.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup18.dd, "$object.PresMaxLimit##Float32","%5.1f")
    ...
    pwr_valueinputreliefup19.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup19.dd, "$object.PresMinLimit##Float32","%5.1f")
    ...
    pwr_valueinputreliefup20.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup20.dd, "$local.ScanTime##Float32","%5.0f")
      ,new GeDynValueInput(pwr_valueinputreliefup20.dd, 4,100000)
      });
    pwr_valueinputmedium21.dd.setDynType(1024);
    pwr_valueinputmedium21.dd.setActionType(4096);
    pwr_valueinputmedium21.dd.setAccess(6);
    pwr_valueinputmedium21.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputmedium21.dd, "$object.ActualValue##Float32","%10.3f")
      ,new GeDynValueInput(pwr_valueinputmedium21.dd, 0,0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Description",11, 41);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "ActualValue",11, 118);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "InitialValue",11, 144);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "Unit",11, 171);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( "0",776, 224);
    g.setTransform(save);
  }
