...
public class JopcIiGen extends JopFrame implements JopUtilityIfc {
  ...
  pwr_buttoncommand	pwr_buttoncommand15;
  pwr_valueinputmedium	pwr_valueinputmedium16;
  ...
  pwr_mbcrossreferences	pwr_mbcrossreferences32;
  JopButtontoggle	jopButtontoggle33;
  ...
  public void geInit() {
    ...
    jopButtontoggle10.setBounds(new Rectangle(506,209,59,20));
    ...
    jopButtontoggle14.setBounds(new Rectangle(675,209,63,20));
    jopButtontoggle14.setColorTone(1);
    localPanel.add(jopButtontoggle14, new Proportion(jopButtontoggle14.getBounds(), dsize));
    pwr_buttoncommand15 = new pwr_buttoncommand(session);
    pwr_buttoncommand15.setBounds(new Rectangle(10,200,86,28));
    pwr_buttoncommand15.setColorTone(1);
    localPanel.add(pwr_buttoncommand15, new Proportion(pwr_buttoncommand15.getBounds(), dsize));
    pwr_valueinputmedium16 = new pwr_valueinputmedium(session);
    pwr_valueinputmedium16.setBounds(new Rectangle(127,102,94,23));
    pwr_valueinputmedium16.setBorderColor(47);
    localPanel.add(pwr_valueinputmedium16, new Proportion(pwr_valueinputmedium16.getBounds(), dsize));
    pwr_valueinputreliefup17 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup17.setBounds(new Rectangle(203,58,41,18));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(203,200,41,18));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(289,212,41,18));
    ...
    pwr_mbopenobject20.setBounds(new Rectangle(182,5,19,19));
    pwr_mbopenobject20.setColorTone(19);
    ...
    pwr_mbtrend21.setBounds(new Rectangle(48,5,19,19));
    pwr_mbtrend21.setColorTone(19);
    ...
    pwr_mbfast22.setBounds(new Rectangle(67,5,19,19));
    pwr_mbfast22.setColorTone(19);
    ...
    pwr_mbphoto23.setBounds(new Rectangle(86,5,19,19));
    pwr_mbphoto23.setColorTone(19);
    ...
    pwr_mbdatasheet24.setBounds(new Rectangle(105,5,19,19));
    pwr_mbdatasheet24.setColorTone(19);
    ...
    pwr_mbcircuitdiagram25.setBounds(new Rectangle(220,5,19,19));
    pwr_mbcircuitdiagram25.setColorTone(19);
    ...
    pwr_mbrtnavigator26.setBounds(new Rectangle(163,5,19,19));
    pwr_mbrtnavigator26.setColorTone(19);
    ...
    pwr_mbhelpclass27.setBounds(new Rectangle(240,5,19,19));
    pwr_mbhelpclass27.setColorTone(19);
    ...
    pwr_mbblockevents28.setBounds(new Rectangle(144,5,19,19));
    pwr_mbblockevents28.setColorTone(19);
    ...
    pwr_mbhistevent29.setBounds(new Rectangle(124,5,19,19));
    pwr_mbhistevent29.setColorTone(19);
    localPanel.add(pwr_mbhistevent29, new Proportion(pwr_mbhistevent29.getBounds(), dsize));
    pwr_mbnote30 = new pwr_mbnote(session);
    pwr_mbnote30.setBounds(new Rectangle(28,5,19,19));
    pwr_mbnote30.setColorTone(19);
    localPanel.add(pwr_mbnote30, new Proportion(pwr_mbnote30.getBounds(), dsize));
    pwr_mbhelp31 = new pwr_mbhelp(session);
    pwr_mbhelp31.setBounds(new Rectangle(9,5,19,19));
    pwr_mbhelp31.setColorTone(19);
    localPanel.add(pwr_mbhelp31, new Proportion(pwr_mbhelp31.getBounds(), dsize));
    pwr_mbcrossreferences32 = new pwr_mbcrossreferences(session);
    pwr_mbcrossreferences32.setBounds(new Rectangle(201,5,19,19));
    pwr_mbcrossreferences32.setColorTone(19);
    localPanel.add(pwr_mbcrossreferences32, new Proportion(pwr_mbcrossreferences32.getBounds(), dsize));
    jopButtontoggle33 = new JopButtontoggle(session);
    jopButtontoggle33.setBounds(new Rectangle(279,5,46,20));
    jopButtontoggle33.setBorderColor(37);
    localPanel.add(jopButtontoggle33, new Proportion(jopButtontoggle33.getBounds(), dsize));
    pwr_valuelong34 = new pwr_valuelong(session);
    pwr_valuelong34.setBounds(new Rectangle(333,5,472,22));
    pwr_valuelong34.setFillColor(41);
    ...
    pwr_buttoncommand15.dd.setDynType(1);
    pwr_buttoncommand15.dd.setActionType(64);
    pwr_buttoncommand15.dd.setAccess(65535);
    pwr_buttoncommand15.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_buttoncommand15.dd, "open graph/classgraph/inst=&$object.SigChanCon")
      });
    pwr_buttoncommand15.setAnnot1("Channel");
    pwr_valueinputmedium16.dd.setDynType(1024);
    pwr_valueinputmedium16.dd.setActionType(4096);
    ...
    pwr_mbhistevent29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent29.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",1)
    ...
    pwr_mbnote30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote30.dd, "$cmd(check method/method=\"Note\"/object=$object)",1)
    ...
    pwr_mbcrossreferences32.dd.setDynType(128);
    pwr_mbcrossreferences32.dd.setActionType(8256);
    pwr_mbcrossreferences32.dd.setAccess(65532);
    pwr_mbcrossreferences32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcrossreferences32.dd, "$cmd(check method/method=\"Crossreferences\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcrossreferences32.dd, "call method/method=\"Crossreferences\"/object=$object")
      ,new GeDynTipText(pwr_mbcrossreferences32.dd, "Crossreferences")
      });
    jopButtontoggle33.dd.setDynType(128);
    jopButtontoggle33.dd.setActionType(64);
    jopButtontoggle33.dd.setAccess(65532);
    jopButtontoggle33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopButtontoggle33.dd, "$object.Note##String80",0)
      ,new GeDynCommand(jopButtontoggle33.dd, "call method/method=\"Note\"/object=$object")
      });
    jopButtontoggle33.setAnnot1("Note !");
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 97, 95, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 33}, 6), 
    new Polygon( new int[] { 97, 97, 95, 95, 4, 2}, new int[] { 33, 2, 4, 31, 31, 33}, 6), 
    new Polygon( new int[] { 2, 8, 8, 91, 97, 2, 2}, new int[] {33, 27, 8, 8, 2, 2, 33}, 7),
    new Polygon( new int[] { 2, 4, 6, 8}, new int[] { 33, 28, 26,27}, 4),
    new Polygon( new int[] { 8, 6, 6, 8}, new int[] { 27, 26, 6,8}, 4),
    new Polygon( new int[] { 8, 6, 90, 91}, new int[] { 8, 6, 6,8}, 4),
    new Polygon( new int[] { 91, 90, 92, 97}, new int[] { 8, 6, 4,2}, 4),
    new Polygon( new int[] { 97, 92, 4, 2}, new int[] { 2, 4, 4,2}, 4),
    new Polygon( new int[] { 2, 4, 4, 2}, new int[] { 2, 4, 28,33}, 4),
    new Polygon( new int[] { 2, 8, 91, 91, 97, 97, 2}, new int[] {33, 27, 27, 8, 2, 33, 33}, 7),
    new Polygon( new int[] { 2, 7, 9, 8}, new int[] { 33, 31, 29,27}, 4),
    new Polygon( new int[] { 8, 9, 93, 91}, new int[] { 27, 29, 29,27}, 4),
    new Polygon( new int[] { 91, 93, 93, 91}, new int[] { 27, 29, 9,8}, 4),
    new Polygon( new int[] { 91, 93, 95, 97}, new int[] { 8, 9, 7,2}, 4),
    new Polygon( new int[] { 97, 95, 95, 97}, new int[] { 2, 7, 31,33}, 4),
    new Polygon( new int[] { 97, 95, 7, 2}, new int[] { 33, 31, 31,33}, 4),
    new Rectangle2D.Float(2F, 2F, 94.9153F, 30.9927F),
    new Polygon( new int[] { 2, 97, 95, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 33}, 6), 
    new Polygon( new int[] { 97, 97, 95, 95, 4, 2}, new int[] { 33, 2, 4, 31, 31, 33}, 6), 
  };
...
protected class pwr_sliderbackground1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 5, 38, 41}, new int[] { 2, 3, 3,2}, 4),
    new Polygon( new int[] { 41, 38, 21, 21}, new int[] { 2, 3, 20,21}, 4),
    new Polygon( new int[] { 21, 21, 5, 2}, new int[] { 21, 20, 3,2}, 4),
    ...
    new Polygon( new int[] { 2, 5, 5, 2}, new int[] { 2, 5, 212,215}, 4),
    new Polygon( new int[] { 2, 5, 20, 21}, new int[] { 215, 212, 196,196}, 4),
    new Polygon( new int[] { 21, 20, 20, 21}, new int[] { 196, 196, 21,21}, 4),
    new Polygon( new int[] { 21, 20, 5, 2}, new int[] { 21, 21, 5,2}, 4),
    new Polygon( new int[] { 2, 21, 41, 2}, new int[] {215, 196, 215, 215}, 4),
    new Polygon( new int[] { 2, 5, 21, 21}, new int[] { 215, 214, 197,196}, 4),
    new Polygon( new int[] { 21, 21, 38, 41}, new int[] { 196, 197, 214,215}, 4),
    new Polygon( new int[] { 41, 38, 5, 2}, new int[] { 215, 214, 214,215}, 4),
...
protected class pwr_slider1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, 6, 2}, new int[] { 29, 28, 22,21}, 4),
    new Polygon( new int[] { 2, 6, 24, 23}, new int[] { 21, 22, 22,21}, 4),
