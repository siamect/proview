...
public class JopcPlcprocess extends JopFrame implements JopUtilityIfc {
  ...
  public JopcPlcprocess( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcPlcprocess( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_valuelong32.setBounds(new Rectangle(134,13,546,24));
    ...
    pwr_valuesmall34.setBounds(new Rectangle(133,37,55,19));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(133,57,55,19));
    ...
    pwr_valuesmall36.setBounds(new Rectangle(368,57,55,19));
    pwr_valuesmall36.setFillColor(31);
    pwr_valuesmall36.setBorderColor(33);
    ...
    geTable6.dd.setElements(new GeDynElemIfc[] {
      new GeDynTable(geTable6.dd, new String[] {"$object.PlcThreadObjects##Objid#20","$header.Prio##Int32","$header.Count##Int32","$header.ScanTime##Float32","$header.ScanTimeMean##Float32","$header.Coverage##Float32","$header.Count_1_8##Int32","$header.Count_1_4##Int32","$header.Count_1_2##Int32","$header.Count_1_1##Int32"}, new String[] {"%o","%d","%d","%7.3f","%7.4f","%5.4f","%d","%d","%d","%d"}, new String[] {"","","","","","","","","",""},20,10)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 616;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(12.1124F, 143.573F, 675.281F, 458.344F),
    new Polygon( new int[] { 12, 687, 686, 13, 13, 12}, new int[] { 144, 144, 145, 145, 601, 602}, 6), 
    new Polygon( new int[] { 687, 687, 686, 686, 13, 12}, new int[] { 602, 144, 145, 601, 601, 602}, 6), 
    new Rectangle2D.Float(12.1124F, 8.74157F, 675.281F, 125.843F),
    new Polygon( new int[] { 12, 687, 686, 13, 13, 12}, new int[] { 9, 9, 10, 10, 133, 135}, 6), 
    new Polygon( new int[] { 687, 687, 686, 686, 13, 12}, new int[] { 135, 9, 10, 133, 133, 135}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "LogMessage",17, 116);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "BootVersion",17, 71);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "CurrentVersion",264, 71);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Description",18, 27);
    g.setTransform(save);
  }
