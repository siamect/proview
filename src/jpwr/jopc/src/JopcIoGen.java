...
public class JopcIoGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_framethin6.setBounds(new Rectangle(9,67,223,78));
    ...
    pwr_buttoncommand15.setBounds(new Rectangle(10,179,86,28));
    ...
    pwr_valueinputmedium16.setBounds(new Rectangle(127,82,94,23));
    ...
    pwr_valueinputreliefup17.setBounds(new Rectangle(203,37,41,18));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(203,180,41,18));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(289,191,41,18));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Description",19, 23);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "ActualValue",19, 98);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "InitialValue",19, 123);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "0",760, 200);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 8, 8}, new int[] { 33, 28, 26,27}, 4),
    new Polygon( new int[] { 8, 8, 8, 8}, new int[] { 27, 26, 6,8}, 4),
    new Polygon( new int[] { 8, 8, 90, 91}, new int[] { 8, 6, 6,8}, 4),
    new Polygon( new int[] { 91, 90, 92, 97}, new int[] { 8, 6, 4,2}, 4),
    new Polygon( new int[] { 97, 92, 6, 2}, new int[] { 2, 4, 4,2}, 4),
    new Polygon( new int[] { 2, 6, 6, 2}, new int[] { 2, 4, 28,33}, 4),
    new Polygon( new int[] { 2, 8, 91, 91, 97, 97, 2}, new int[] {33, 27, 27, 8, 2, 33, 33}, 7),
    new Polygon( new int[] { 2, 9, 11, 8}, new int[] { 33, 31, 29,27}, 4),
    new Polygon( new int[] { 8, 11, 93, 91}, new int[] { 27, 29, 29,27}, 4),
    ...
    new Polygon( new int[] { 97, 95, 9, 2}, new int[] { 33, 31, 31,33}, 4),
    new Rectangle2D.Float(2F, 2F, 94.9153F, 30.9927F),
    new Polygon( new int[] { 2, 97, 95, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 33}, 6), 
    new Polygon( new int[] { 97, 97, 95, 95, 4, 2}, new int[] { 33, 2, 4, 31, 31, 33}, 6), 
  };
  public void paintComponent(Graphics g1) {
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 12 * original_height / height * width / original_width, 22F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
...
protected class pwr_sliderbackground1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 40, 41}, new int[] { 2, 3, 3,2}, 4),
    new Polygon( new int[] { 41, 40, 23, 21}, new int[] { 2, 3, 20,21}, 4),
    new Polygon( new int[] { 21, 23, 6, 2}, new int[] { 21, 20, 3,2}, 4),
    new Polygon( new int[] { 41, 21, 21, 41, 41}, new int[] {2, 21, 196, 215, 2}, 5),
    new Polygon( new int[] { 41, 42, 24, 21}, new int[] { 2, 4, 21,21}, 4),
    new Polygon( new int[] { 21, 24, 24, 21}, new int[] { 21, 21, 196,196}, 4),
    new Polygon( new int[] { 21, 24, 42, 41}, new int[] { 196, 196, 213,215}, 4),
    new Polygon( new int[] { 41, 42, 42, 41}, new int[] { 215, 213, 4,2}, 4),
    new Polygon( new int[] { 2, 2, 21, 21, 2}, new int[] {2, 215, 196, 21, 2}, 5),
    new Polygon( new int[] { 2, 5, 5, 2}, new int[] { 2, 4, 213,215}, 4),
    new Polygon( new int[] { 2, 5, 22, 21}, new int[] { 215, 213, 196,196}, 4),
    new Polygon( new int[] { 21, 22, 22, 21}, new int[] { 196, 196, 21,21}, 4),
    new Polygon( new int[] { 21, 22, 5, 2}, new int[] { 21, 21, 4,2}, 4),
    new Polygon( new int[] { 2, 21, 41, 2}, new int[] {215, 196, 215, 215}, 4),
    new Polygon( new int[] { 2, 6, 23, 21}, new int[] { 215, 214, 197,196}, 4),
    new Polygon( new int[] { 21, 23, 40, 41}, new int[] { 196, 197, 214,215}, 4),
    new Polygon( new int[] { 41, 40, 6, 2}, new int[] { 215, 214, 214,215}, 4),
...
protected class pwr_slider1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 23, 26, 32, 31}, new int[] { 2, 7, 23,23}, 4),
    new Polygon( new int[] { 31, 32, 32, 31}, new int[] { 23, 23, 28,29}, 4),
    new Polygon( new int[] { 31, 32, 14, 12}, new int[] { 29, 28, 28,29}, 4),
    new Polygon( new int[] { 12, 14, 7, 2}, new int[] { 29, 28, 22,21}, 4),
    new Polygon( new int[] { 2, 7, 26, 23}, new int[] { 21, 22, 22,21}, 4),
    new Polygon( new int[] { 23, 26, 26, 23}, new int[] { 21, 22, 7,2}, 4),
