...
{
  if (!xdr_int(xdrs, (int*)&objp->os))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->hw))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->bo))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->ft))
    return FALSE;
...
{
  if (!xdr_int(xdrs, (int*)&objp->Editor))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Method))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Flags.m))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->NumOfObjBodies))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->PopEditor))
    return FALSE;
...
{
  if (!xdr_pwr_tStructName(xdrs, &objp->StructName))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->NumOfParams))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Size))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->NextAix))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Flags))
    return FALSE;
...
{
  if (!xdr_pwr_tPgmName(xdrs, &objp->PgmName))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Type))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Offset))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Size))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Flags))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Elements))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->ParamIndex))
    return FALSE;
...
{
  if (!xdr_pwr_sParInfo(xdrs, &objp->Info))
    return FALSE;
...
{
  if (!xdr_int(xdrs, (int*)&((__pwr_tInt64*)objp)->low))
    return FALSE;
  if (!xdr_int(xdrs, &((__pwr_tInt64*)objp)->high))
    return FALSE;
...
{
  if (!xdr_int(xdrs, (int*)&((__pwr_tUInt64*)objp)->low))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&((__pwr_tUInt64*)objp)->high))
    return FALSE;
...
{
  if (!xdr_int(xdrs, (int*)&objp->oix))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->vid))
    return FALSE;
...
{
  if (!xdr_pwr_tInt64(xdrs, &objp->tv_sec))
    return FALSE;
  if (!xdr_pwr_tInt64(xdrs, &objp->tv_nsec))
    return FALSE;
...
{
  if (!xdr_int(xdrs, (int*)&objp->Objid.oix))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Objid.vid))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Body))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Offset))
    return FALSE;
  if (!xdr_int(xdrs, (int*)&objp->Size))
