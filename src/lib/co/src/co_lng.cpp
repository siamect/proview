...
char Lng::items[][2][40] = {
      ...
      {"Block Events...",  "Blockera Händelser..."},
      ...
      {"Out value",    "Ut signal"},
      {"Blocked Alarms", "Blockerade larm"},
      {"Alarm Blocking", "Larmblockering"},
      {"Contents", 	"Innehåll"},
      {"page", 		"sidan"},
      {"See", 		"Se"},
      {"Class", 	"Klass"},
      ...
      {"Body", 		"Kropp"},
      {"Type", 		"Typ"},
      {"English text not available", "Svensk text finns ej tillgänglig"},
      ...
      {"Hysteresis", 	"Hysteres"},
      {"Delay", 	"Fördröjning"},
      {"Switch open", 	"Gränsläge öppen"},
      {"Switch closed", "Gränsläge stängd"},
      {"Error detected", "Fel detekterat"},
      {"Overload", 	"Överlast"},
      {"Safety switch", "Säkerhetsbrytare"},
      {"Ready", 	"Klar"},
      {"Extern interlock","Extern förregling"},
      {"Contactor", "Kontaktor"},
      {"Circuit breaker","Effektbrytare"},
      {"Startlock",	"Startspärr"},
