...
char* cdh_OpSysToDirStr(pwr_mOpSys opsys)
{
  ...
  case pwr_mOpSys_PPC_LINUX:
    ...
    break;
  case pwr_mOpSys_X86_LINUX:
    strcpy(str, "os_linux/hw_x86");
    break;
  case pwr_mOpSys_X86_64_LINUX:
    strcpy(str, "os_linux/hw_x86_64");
    break;
  case pwr_mOpSys_X86_64_MACOS:
    strcpy(str, "os_macos/hw_x86_64");
    break;
  case pwr_mOpSys_ARM_LINUX:
    strcpy(str, "os_linux/hw_arm");
    break;
  case pwr_mOpSys_ARM64_LINUX:
    strcpy(str, "os_linux/hw_arm64");
    break;
  case pwr_mOpSys_X86_64_FREEBSD:
    strcpy(str, "os_freebsd/hw_x86_64");
    break;
  case pwr_mOpSys_X86_64_OPENBSD:
    strcpy(str, "os_openbsd/hw_x86_64");
    break;
  case pwr_mOpSys_X86_CYGWIN:
    strcpy(str, "os_cygwin/hw_x86");
    break;
  default:
    strcpy(str, "");
  }
...
/*!
  Invalid characters in the string are replaced by '_'. If the first char is
  invalid
  it is replaced by 'O'.
