...
static rtt_t_helptext helptext[] = { { 1, "MENU", "", "\
...
" },
  { 0, "FILE LIST", "       RETURN execute a file                              "
                    "      Ctrl/R back",
      "\
List of files.\n\n\
...
/collect		The picture will be restored in the collection picture.\n\
			...
			picture.\n\
" },
  { 0, "STORED PICTURES AND COMMANDFILES", "       RETURN show a picture or "
...
" },
  { 0, "LIST OF SIGNALS", "Ctrl/A Open object  Ctrl/T Crossreference  Ctrl/E "
                          "Change value  Ctrl/R Back",
      "\
Display the signals referenced in a plcpgm or a window.\n\
...
" },
  { 0, "HELP SUBJECTS", " Select a subject and press RETURN                    "
                        "           Ctrl/R Back",
      "\
...
static rtt_t_helptext script_helptext[] = { { 1, "DATATYPES", "", "\
