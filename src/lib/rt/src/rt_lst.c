...
pwr_tBoolean lst_HasOne(thread_sMutex* mp, lst_sEntry* link)
{
...
lst_sEntry* lst_Init(thread_sMutex* mp, lst_sEntry* link, void* item)
{
  if (mp != NULL)
    sync_MutexLock(mp);
...
pwr_tBoolean lst_IsEmpty(thread_sMutex* mp, lst_sEntry* link)
{
...
pwr_tBoolean lst_IsNull(thread_sMutex* mp, lst_sEntry* link)
{
...
pwr_tBoolean lst_IsSucc(thread_sMutex* mp, lst_sEntry* pred, lst_sEntry* link)
{
  lst_sEntry* succ;
...
void* lst_Pred(thread_sMutex* mp, lst_sEntry* link, lst_sEntry** lp)
{
  lst_sEntry* pred;
  void* item = NULL;
...
void* lst_Remove(thread_sMutex* mp, lst_sEntry* link)
{
  lst_sEntry* succ;
  lst_sEntry* pred;
  void* item = NULL;
...
void* lst_RemovePred(thread_sMutex* mp, lst_sEntry* link, lst_sEntry** lp)
{
  lst_sEntry* pred;
...
void* lst_RemoveSucc(thread_sMutex* mp, lst_sEntry* link, lst_sEntry** lp)
{
  lst_sEntry* succ;
...
void* lst_Succ(thread_sMutex* mp, lst_sEntry* link, lst_sEntry** lp)
{
  lst_sEntry* succ;
  void* item = NULL;
