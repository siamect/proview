...
/* rt_sancm.c -- Subscribed alarm (and block) notification, client monitor
 * calls. */
...
void sancm_Add(pwr_tStatus* status, gdb_sNode* np)
{
  net_sSanAdd* ap;
  pool_sQlink* ol;
  gdb_sObject* op;
...
void sancm_FlushNode(pwr_tStatus* status, gdb_sNode* np)
{
  pool_sQlink* ol;
  gdb_sObject* op;
...
void sancm_MoveExpired(pwr_tStatus* status, gdb_sNode* np)
{
  pool_sQlink* ol;
  gdb_sObject* op;
...
void sancm_Remove(pwr_tStatus* status, gdb_sNode* np)
{
  net_sSanRemove* rp;
  pool_sQlink* ol;
  gdb_sObject* op;
...
void sancm_Update(qcom_sGet* get)
{
  gdb_sObject* op;
  int i;
  int error;
