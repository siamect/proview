...
void subsm_ActivateBuffer(sub_sBuffer* bp, pwr_tUInt32 dt)
{
  gdb_AssumeLocked;
...
void subsm_FlushNode(pwr_tStatus* sts, gdb_sNode* np)
{
  pool_sQlink* ssl;
...
void subsm_Remove(qcom_sGet* get)
{
  pwr_tStatus sts;
  pwr_tInt32 i;
  sub_sServer* sp;
