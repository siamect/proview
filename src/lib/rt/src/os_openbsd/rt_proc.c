...
#if !defined(OS_LYNX) && !defined(OS_LINUX) && !defined(OS_MACOS) && !defined OS_FREEBSD && !defined OS_OPENBSD
# error "This file is valid only for OS_LYNX and OS_LINUX and OS_MACOS and OS_FREEBSD and OS_OPENBSD"
#endif
