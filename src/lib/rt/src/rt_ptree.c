...
static pool_tRef findNearNode(ptree_sTable* tp, void* key);

static pool_tRef findNode(ptree_sTable* tp, void* key);

static pool_tRef minimumNode(ptree_sTable* tp, pool_tRef nr);
...
static pool_tRef deleteNode(ptree_sTable* tp, pool_tRef zr);
