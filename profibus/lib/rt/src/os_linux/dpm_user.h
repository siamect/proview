/* <St> *******************************************************************
  ...
  V1.401  AB        19.10.00  New Message command MPI_Read_Write_DB and
                              disconnect
  V1.400  AB        22.11.99  Extention of struct
  DPM_PLC_PARAMETER.(Identnumber)
...
#define DPM_FORMAT_SWAP 1
  unsigned short
      usWatchDogTime;        /* watchdog time in msec. for HOST-supervision */
...
typedef struct DPM_SL_PRM_PRM_DATAtag
{
  ...
  unsigned short
      usIdent_Number;         /* ident number of the station, motorola format */
