...
typedef struct _T_PN_IOCR {
  ...
  /*
    ...
    PROFINET_IO_CR_TYPE_MULTICAST_CONSUMER
...
typedef struct _T_PN_SERVICE_PHASE_DATA_ADJUST {
  ...
  PN_U8 Phase[2];
  T_PN_SERVICE_PHASE_ASSIGNMENTS Assignments[2]
                                            [MAX_NUMBER_PDIR_BEGIN_END_PHASES];
...
typedef struct _T_PN_SERVICE_DOWNLOAD_LOCAL_IRT_DOMAIN {
  ...
  T_PN_SERVICE_PROVIDER_SEND_OFFSETS
  Provider[2u * MAX_NUMBER_SUPPORTED_DEVICES];
...
#define PROFINET_SUBMODULE_STATE_QUALIFIED_INFO                                \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0008u)
#define PROFINET_SUBMODULE_STATE_MAINTANANCE_REQUIRED                          \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0010u)
#define PROFINET_SUBMODULE_STATE_MAINTANANCE_DEMANDED                          \
