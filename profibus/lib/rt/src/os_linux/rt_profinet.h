...
#define _PN_GET_SERVICE(ServiceClass)                 ((PN_U8) ((ServiceClass) & PN_SERVICE_CLASS_MASK))
...
#define PROFINET_IO_CR_FRAME_ID_RT_CLASS3_HIGHEST_FRAME_ID        (PN_U16) (PROFINET_IO_CR_FRAME_ID_RT_CLASS3_BASE + \
...
#define PROFINET_IO_CR_FRAME_ID_RT_CLASS3_MRPD_HIGHEST_FRAME_ID   (PN_U16) (PROFINET_IO_CR_FRAME_ID_RT_CLASS3_MRPD_BASE + \
...
typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_REQ    T_PN_SERVICE_DOWNLOAD_TOPOLOGY_DOMAIN_REQ;
typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_CON    T_PN_SERVICE_DOWNLOAD_TOPOLOGY_DOMAIN_CON;

/*===========================================================================*/

#define PN_SERVICE_ERROR_DOWNLOAD_MRP_DOMAIN_INVALID_LENGTH         0x01u

typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_REQ    T_PN_SERVICE_DOWNLOAD_MRP_DOMAIN_REQ;
typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_CON    T_PN_SERVICE_DOWNLOAD_MRP_DOMAIN_CON;
...
#define CONFIG_ID_SELECTOR_MASK                                   (PN_U16) (CONFIG_ID_SELECTOR_AR_SET_1 | \
                                                                           CONFIG_ID_SELECTOR_AR_SET_2  | \
                                                                           CONFIG_ID_SELECTOR_AR_SET_3  | \
                                                                           CONFIG_ID_SELECTOR_AR_SET_4  | \
...
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_ADVISE_MASK     (PN_U32) 0x00000078u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_3               (PN_U32) 0x00000008u /* Start of Advice */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_REQUIRED_MASK   (PN_U32) 0x0001FF00u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_7               (PN_U32) 0x00000080u /* Start of Maintanace Required */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_DEMANDED_MASK   (PN_U32) 0x07FE0000u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_17              (PN_U32) 0x00020000u /* Start of Maintanace Demanded */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_DIAGNOSIS_MASK  (PN_U32) 0xF8000000u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_27              (PN_U32) 0x08000000u /* Start of Fault */
...
#define PROFINET_SUBMODULE_STATE_ADVICE                               (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0008u)
#define PROFINET_SUBMODULE_STATE_MAINTENANCE_REQUIRED                 (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0010u)
#define PROFINET_SUBMODULE_STATE_MAINTENANCE_DEMANDED                 (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0020u)
...
#define PROFINET_TX_PORT_GROUP_ALL          (PROFINET_TX_PORT_GROUP_LOCAL | \
                                            PROFINET_TX_PORT_GROUP_1      | \
                                            PROFINET_TX_PORT_GROUP_2      | \
                                            PROFINET_TX_PORT_GROUP_3      | \
                                            PROFINET_TX_PORT_GROUP_4      | \
                                            PROFINET_TX_PORT_GROUP_5      | \
                                            PROFINET_TX_PORT_GROUP_6      | \
                                            PROFINET_TX_PORT_GROUP_7)
...
/*
  ...
  in this case the DataLength of the Service-Description-Block has to be adapted
  T_PN_CONTROL_RES_ERROR    Error;
