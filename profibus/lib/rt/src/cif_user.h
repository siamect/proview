...
#define DRV_PCI_READ_DPM_LENGTH                                                \
...
#define DRV_USR_SENDBUF_PTR_NULL                                               \
...
typedef struct tagMSG_STRUC
{
  ...
  unsigned char
      dummy[25] PACKED; // for compatibility with older definitions (288 Bytes)
} MSG_STRUC;
...
typedef struct tagDEVINFO
{
  ...
  unsigned char
      abDevIdentifier[3] PACKED; /* Device identification characters */
} DEVINFO;
