...
#define _PN_ALIGN2(Type, Value)                                                \
  ((Type)((((Type)(Value)) + (Type)1) & ((Type)(-2))))
#define _PN_ALIGN4(Type, Value)                                                \
  ((Type)((((Type)(Value)) + (Type)3) & ((Type)(-4))))
...
#define PROFINET_AR_PROPERTY_STATE_MASK                                        \
  (PROFINET_AR_PROPERTY_STATE_BACKUP | PROFINET_AR_PROPERTY_STATE_PRIMARY)
...
#define PROFINET_FIELDBUS_INTEGRATION_API 0x00004600uL
#define PROFINET_RFID_READER_API 0x00005B00uL
#define PROFINET_BARCODE_READER_API 0x00005B10uL
...
#define CYCLIC_DATA_STATUS_PRIMARY_PRESENT 0x00u
#define CYCLIC_DATA_STATUS_PRIMARY_MISSING 0x02u
#define CYCLIC_DATA_STATUS_PRIMARY_FAULT 0x02u
...
#define PROFINET_ALARM_CR_PRIORITY_MASK                                        \
  (PROFINET_ALARM_CR_PRIORITY_DEFAULT | PROFINET_ALARM_CR_PRIORITY_LOW)

#define PROFINET_ALARM_CR_USE_DATA_RTA 0x00000000uL
#define PROFINET_ALARM_CR_USE_UDP_RTA 0x00000002uL
#define PROFINET_ALARM_CR_TRANSPORT_MASK                                       \
  (PROFINET_ALARM_CR_USE_DATA_RTA | PROFINET_ALARM_CR_USE_UDP_RTA)

#define PROFINET_ALARM_CR_MASK                                                 \
  (PROFINET_ALARM_CR_PRIORITY_MASK | PROFINET_ALARM_CR_TRANSPORT_MASK)

#define PROFINET_ALARM_CR_TAG_VLAN_MASK 0x0FFFuL
#define PROFINET_ALARM_CR_TAG_HIGH_PRIORITY_HIGH 0xC000uL
#define PROFINET_ALARM_CR_TAG_HIGH_MASK                                        \
  (PROFINET_ALARM_CR_TAG_VLAN_MASK | PROFINET_ALARM_CR_TAG_HIGH_PRIORITY_HIGH)
#define PROFINET_ALARM_CR_TAG_LOW_PRIORITY_LOW 0xA000uL
#define PROFINET_ALARM_CR_TAG_LOW_MASK                                         \
  (PROFINET_ALARM_CR_TAG_VLAN_MASK | PROFINET_ALARM_CR_TAG_LOW_PRIORITY_LOW)
...
#define PROFINET_MC_CR_ADDR_RESOLUTION_MASK                                    \
  (PROFINET_MC_CR_ADDR_RESOLUTION_DNS | PROFINET_MC_CR_ADDR_RESOLUTION_DCP)
...
#define PNIO_ERROR_CODE1_ACCESS_INVALID_INDEX                                  \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x00u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_LENGTH                                 \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x01u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_SLOT_SUBSLOT                           \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x02u)
#define PNIO_ERROR_CODE1_ACCESS_TYPE_CONFLICT                                  \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x03u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_API                                    \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x04u)
#define PNIO_ERROR_CODE1_ACCESS_STATE_CONFLICT                                 \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x05u)
#define PNIO_ERROR_CODE1_ACCESS_DENIED (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x06u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_RANGE                                  \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x07u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_PARAMETER                              \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x08u)
#define PNIO_ERROR_CODE1_ACCESS_INVALID_TYPE                                   \
  (PN_U8)(PNIO_ERROR_CODE1_ACCESS | 0x09u)
...
#define _PN_GET_SERVICE(ServiceClass)                                          \
  ((PN_U8)((ServiceClass)&PN_SERVICE_CLASS_MASK))
...
#define PN_SERVICE_CLASS_CMCTL_CMDEV                                           \
  (PN_U8) _PN_GET_SERVICE_CLASS(PN_SERVICE_CLASS1)
...
#define PN_SERVICE_DOWNLOAD_TOPOLOGY_DOMAIN (PN_U8)(PN_SERVICE_CLASS4 | 0x06u)
#define PN_SERVICE_DOWNLOAD_MRP_DOMAIN (PN_U8)(PN_SERVICE_CLASS4 | 0x07u)
#define PN_SERVICE_DOWNLOAD_EXTENDED (PN_U8)(PN_SERVICE_CLASS4 | 0x08u)
#define PN_SERVICE_CLASS_CONFIG_MAX_SERVICE PN_SERVICE_DOWNLOAD_EXTENDED

#define PN_SERVICE_CLASS_TOPOLOGY                                              \
  (PN_U8) _PN_GET_SERVICE_CLASS(PN_SERVICE_CLASS5)
...
#define PN_SERVICE_CLASS_SUPERVISOR                                            \
  (PN_U8) _PN_GET_SERVICE_CLASS(PN_SERVICE_CLASS1)
...
typedef struct _T_PN_IOCR
{
  ...
  /*
    ...
    the following is only available for IOCR type ==
    PROFINET_IO_CR_TYPE_MULTICAST_CONSUMER or for IOCR type ==
    PROFINET_IO_CR_TYPE_MULTICAST_PROVIDER

    union
    {
    T_PN_MCR_CONSUMER   MCRConsumer;
    T_PN_MCR_PROVIDER   MCRProvider;
    T_PN_RTC3_CONSUMER  RTC3Consumer;
    T_PN_RTC3_PROVIDER  RTC3Provider;
    }
  */
...
#define PN_SERVICE_DOWNLOAD_INVALID_RTC_CLASS 0x27u
#define PN_SERVICE_DOWNLOAD_INVALID_RTC3_FRAME_ID 0x28u
#define PN_SERVICE_DOWNLOAD_LEGACY_IRT_NOT_SUPPORTED 0x29u
...
#define PN_SERVICE_DOWNLOAD_ADD_FLAG_ENABLE_IRT 0x02u
#define PN_SERVICE_DOWNLOAD_ADD_FLAG_ENABLE_SYSTEM_REDUNDANCY 0x04u
#define PN_SERVICE_DOWNLOAD_ADD_FLAG_ENABLE_MULTIPLE_WRITE 0x08u
#define PN_SERVICE_DOWNLOAD_FLAG_ACHILLES_TEST_ACTIVE 0x10u

#define PN_SERVICE_DOWNLOAD_VERSION 3u
...
#define _PN_IOCR_CMDEV_AR_TO_INDEX(IOCRIdentifier)                             \
  (IOCRIdentifier & PN_IOCR_CMDEV_AR_MASK)
#define _PN_IOCR_NUMBER_TO_INDEX(IOCRIdentifier)                               \
...
#define PN_SYNC_DOMAIN_CLOCK_CLASS_DEFAULT 0x0Du
...
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_NOT_SUPPORTED 0x01u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_MISSING_DATA 0x02u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PRIORITY1 0x03u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PRIORITY2 0x04u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PLL_WINDOW 0x05u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_SYNC_SEND_FACTOR 0x06u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PTCP_TIMEOUT 0x07u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PTCP_TAKEOVER 0x08u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_PTCP_STARTUP_TIME 0x09u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_NUMBER_PORTS 0x0Au
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_FRAME_ID 0x0Bu
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_NUMBER_ASSIGNMENTS 0x0Cu
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_RED_TX 0x0Du
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_ORANGE_TX 0x0Eu
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_GREEN_TX 0x0Fu
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_RED_RX 0x10u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_ORANGE_RX 0x11u
#define PN_SERVICE_DOWNLOAD_IRT_DOMAIN_INVALID_GREEN_RX 0x12u
...
typedef struct _T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_REQ
{
  ...
  /*
    T_PN_DEFAULT_API_DATA_RECORD    DataRecords [NumberOfDataRecords];
  */
...
#define PN_SERVICE_ERROR_DOWNLOAD_TOPOLOGY_DOMAIN_INVALID_LENGTH 0x01u

typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_REQ
    T_PN_SERVICE_DOWNLOAD_TOPOLOGY_DOMAIN_REQ;
typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_CON
    T_PN_SERVICE_DOWNLOAD_TOPOLOGY_DOMAIN_CON;

/*===========================================================================*/

#define PN_SERVICE_ERROR_DOWNLOAD_MRP_DOMAIN_INVALID_LENGTH 0x01u

typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_REQ
    T_PN_SERVICE_DOWNLOAD_MRP_DOMAIN_REQ;
typedef T_PN_SERVICE_DOWNLOAD_IRT_DOMAIN_CON
    T_PN_SERVICE_DOWNLOAD_MRP_DOMAIN_CON;
...
} PACK_BYTE_ALIGNMENT(T_PN_EXTENDED_BLOCK);

/*---------------------------------------------------------------------------*/

#define CONFIG_ID_SELECTOR_AR_SET_1 (PN_U16)0x0001u
#define CONFIG_ID_SELECTOR_AR_SET_2 (PN_U16)0x0002u
#define CONFIG_ID_SELECTOR_AR_SET_3 (PN_U16)0x0003u
...
typedef struct _T_PN_EXTENDED_BLOCK_CONFIG_ID
{
  ...
  PN_U8 KeyHighWordHighByte;
  PN_U8 KeyHighWordLowByte;
  PN_U8 KeyLowWordHighByte;
  PN_U8 KeyLowWordLowByte;

  PN_U8 CounterHighWordHighByte;
  PN_U8 CounterHighWordLowByte;
  PN_U8 CounterLowWordHighByte;
  PN_U8 CounterLowWordLowByte;

  PN_U8 SelectorHighByte;
  PN_U8 SelectorLowByte;

  PN_U8 Alignment[2];

} PACK_BYTE_ALIGNMENT(T_PN_EXTENDED_BLOCK_CONFIG_ID);

/*---------------------------------------------------------------------------*/

#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_INVALID_LENGTH 0x01u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_TYPE_NOT_SUPPORTED 0x02u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_VERSION_NOT_SUPPORTED 0x03u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_WRONG_BLOCK_LENGTH 0x04u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_WRONG_PROPERTIES 0x05u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_DFP_NOT_SUPPORTED 0x06u
#define PN_SERVICE_ERROR_DOWNLOAD_EXTENDED_WRONG_DATA_HOLD_FACTOR 0x07u
...
typedef struct _T_PN_SERVICE_DOWNLOAD_EXTENDED_REQ
{
  ...
  /*
    T_PN_EXTENDED_BLOCK   Block [NumberOfBlocks];
  */

} PACK_BYTE_ALIGNMENT(T_PN_SERVICE_DOWNLOAD_EXTENDED_REQ);
...
#define PN_SERVICE_ALARM_PRIO_MASK                                             \
  (PN_SERVICE_ALARM_PRIO_LOW | PN_SERVICE_ALARM_PRIO_HIGH)
...
#define PROFINET_ALARM_USER_STRUCTURE_IDENT_MANUFACTURER_LOWER_LIMIT           \
  (PN_U16)0x0000u
#define PROFINET_ALARM_USER_STRUCTURE_IDENT_MANUFACTURER_UPPER_LIMIT           \
  (PN_U16)0x7FFFu
...
#define PROFINET_ALARM_CHANNEL_PROPERTIES_TYPE_MASK (PN_U16)0x00FFu
...
/* used with channel error type 0x000F and 0x0010 */
#define PROFINET_EXT_CH_ERR_TYPE_PARAMETER_FAULT_DETAIL (PN_U16)0x8001u
#define PROFINET_EXT_CH_ERR_TYPE_CONSISTENCY_FAULT_DETAIL (PN_U16)0x8002u
...
#define PROFINET_EXT_CH_ERR_TYPE_MRPD_FRAME_DUPLICATE_LOWER_LIMIT              \
  (PN_U16)0x8700u
#define PROFINET_EXT_CH_ERR_TYPE_MRPD_FRAME_DUPLICATE_UPPER_LIMIT              \
  (PN_U16)0x8FFFu
...
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_3_31_MASK (PN_U32)0xFFFFFFF8u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_ADVISE_MASK                  \
  (PN_U32)0x00000078u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_3                            \
  (PN_U32)0x00000008u /* Start of Advice */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_REQUIRED_MASK                \
  (PN_U32)0x0001FF00u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_7                            \
  (PN_U32)0x00000080u /* Start of Maintanace Required */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_DEMANDED_MASK                \
  (PN_U32)0x07FE0000u
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_17                           \
  (PN_U32)0x00020000u /* Start of Maintanace Demanded */
#define PROFINET_QUALIFIED_CHANNEL_DIAG_QUALIFIER_DIAGNOSIS_MASK               \
  (PN_U32)0xF8000000u
...
#define PROFINET_SUBMODULE_STATE_ADD_INFO_NO                                   \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0000u)
#define PROFINET_SUBMODULE_STATE_ADD_INFO_TAKEOVER_NOT_ALLOWED                 \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0001u)
#define PROFINET_SUBMODULE_STATE_ADD_INFO_RESERVED                             \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0006u)
#define PROFINET_SUBMODULE_STATE_ADVICE                                        \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0008u)
#define PROFINET_SUBMODULE_STATE_MAINTENANCE_REQUIRED                          \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0010u)
#define PROFINET_SUBMODULE_STATE_MAINTENANCE_DEMANDED                          \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0020u)
#define PROFINET_SUBMODULE_STATE_DIAG_INFO_NO                                  \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0000u)
#define PROFINET_SUBMODULE_STATE_DIAG_INFO_DIAG_AVAILABLE                      \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0040u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_NO                                    \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0000u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_APPL_READY_PENDING                    \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0080u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_SUPERORDINATED_LOCK                   \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0100u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_LOCKED_BY_CONTROLLER                  \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0180u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_LOCKED_BY_SUPERVISOR                  \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0200u)
#define PROFINET_SUBMODULE_STATE_AR_INFO_MASK                                  \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0680u)
#define PROFINET_SUBMODULE_STATE_IDENT_INFO_OK                                 \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0000u)
#define PROFINET_SUBMODULE_STATE_IDENT_INFO_SUBSTITUTE                         \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x0800u)
#define PROFINET_SUBMODULE_STATE_IDENT_INFO_WRONG                              \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x1000u)
#define PROFINET_SUBMODULE_STATE_IDENT_INFO_NO_SUBMODULE                       \
  (PROFINET_SUBMODULE_STATE_FORMAT_INDICATOR | 0x1800u)
...
#define PN_SERVICE_SET_NAME_INVALID_RESPONSE_LENGTH                            \
  PN_SERVICE_SET_INVALID_RESPONSE_LENGTH
...
#define PN_SERVICE_SET_IP_SETTINGS_INVALID_RESPONSE_LENGTH                     \
  PN_SERVICE_SET_INVALID_RESPONSE_LENGTH
#define PN_SERVICE_SET_IP_SETTINGS_INVALID_RESPONSE                            \
  PN_SERVICE_SET_INVALID_RESPONSE
...
#define DCP_OPTION_IP_SUB_FULL_IP (PN_U8)3u
...
typedef struct _T_PN_CONNECT_AR_VENDOR_BLOCK
{
  ...
  PN_U8 APStructureIdentifierLowByte;
...
/* shall be only used in conjunction with service = DOWNLOAD_IRT_DOMAIN and
 * DeviceRef = PN_DEVICE_REFERENCE_THIS_STATION
 */
#define PN_LOCAL_INDEX_PDIR_FRAME_DATA (PN_U16)0x0001u
...
#define PROFINET_INDEX_SUBSLOT_PD_PORT_DATA_REAL_EXT (PN_U16)0x8027u
...
#define PROFINET_INDEX_SUBSLOT_ENERGY_RECORD_0 (PN_U16)0x80A0u
#define PROFINET_INDEX_SUBSLOT_ENERGY_STATUS_DATA (PN_U16)0x80AFu
#define PROFINET_INDEX_SUBSLOT_COMBINED_OBJECT_CONTAINER (PN_U16)0x80B0u
#define PROFINET_INDEX_SUBSLOT_SOE_START (PN_U16)0x80C0u
#define PROFINET_INDEX_SUBSLOT_SOE_END (PN_U16)0x80CFu
#define PROFINET_INDEX_SUBSLOT_SOE_RECORD_0 (PN_U16)0x80C0u
...
#define PROFINET_INDEX_AR_ENERGY_FILTER_DATA (PN_U16)0xE030u
#define PROFINET_INDEX_AR_ENERGY_STATUS_DATA (PN_U16)0xE031u
...
#define PROFINET_INDEX_C2C_PROFILE_START (PN_U16)0xF860u
#define PROFINET_INDEX_C2C_PROFILE_END (PN_U16)0xF86Fu
#define PROFINET_INDEX_C2C_GSD_UPLOAD (PN_U16)0xF860u
#define PROFINET_INDEX_C2C_NESTED_DIAGNOSIS (PN_U16)0xF861u
#define PROFINET_INDEX_ENERGY_FILTER_DATA (PN_U16)0xF870u
#define PROFINET_INDEX_ENERGY_STATUS_DATA (PN_U16)0xF871u
...
#define PN_SERVICE_READ_INVALID_SEQUENCE_NUMBER                                \
...
#define READ_RES_ERROR_CODE1_INVALID_SLOT_SUBSLOT                              \
  WRITE_RES_ERROR_CODE1_INVALID_SLOT_SUBSLOT
...
#define PROFINET_BLOCK_TYPE_SUBMODULE_LIST (PN_U16)0x0119u
...
#define PROFINET_BLOCK_TYPE_MRP_INSTANCE_DATA_ADJUST (PN_U16)0x0231u
#define PROFINET_BLOCK_TYPE_MRP_INSTANCE_DATA_REAL (PN_U16)0x0232u
#define PROFINET_BLOCK_TYPE_MRP_INSTANCE_DATA_CHECK (PN_U16)0x0233u
...
/* shall be only used in conjunction with service = DOWNLOAD_EXTENDED and
 * DeviceRef != PN_DEVICE_REFERENCE_THIS_STATION
 */
#define PN_LOCAL_BLOCK_TYPE_REDUNDANCY_CONFIG_ID (PN_U16)0xFFFEu
...
#define PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT                              \
  PN_SERVICE_SET_RESPONSE_TIMEOUT
#define PN_SERVICE_IMPLICIT_READ_INVALID_IP_ADDRESS                            \
  (PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT + 0x01u)
#define PN_SERVICE_IMPLICIT_READ_INVALID_BLOCK_TYPE                            \
  (PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT + 0x02u)
#define PN_SERVICE_IMPLICIT_READ_INVALID_API                                   \
  (PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT + 0x03u)
#define PN_SERVICE_IMPLICIT_READ_INVALID_SLOT                                  \
  (PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT + 0x04u)
#define PN_SERVICE_IMPLICIT_READ_INVALID_SUBSLOT                               \
  (PN_SERVICE_IMPLICIT_READ_RESPONSE_TIMEOUT + 0x05u)
...
#define PN_SERVICE_LOOKUP_INVALID_IP_ADDRESS                                   \
  (PN_SERVICE_LOOKUP_RESPONSE_TIMEOUT + 0x01u)
...
typedef T_PN_DIFF_MODULE_API T_PROFINET_MODULE_API_RES;

/*---------------------------------------------------------------------------*/

#define PROFINET_MODULE_STATE_GOOD 0xFFFFu /* this is for internal use only */

typedef T_PN_DIFF_MODULE_SLOT T_PROFINET_MODULE_SLOT_RES;

/*---------------------------------------------------------------------------*/

typedef T_PN_DIFF_MODULE_SUBSLOT T_PROFINET_MODULE_SUBSLOT_RES;
...
typedef struct _T_PROFINET_MODULE_RES
{
  ...
  /*
    T_PROFINET_MODULE_API_RES   Api [NumberOfAPIs];
  */

} PACK_WORD_ALIGNMENT(T_PROFINET_MODULE_RES);
...
} PACK_BYTE_ALIGNMENT(T_PROFINET_AR_VENDOR);
...
#define PROFINET_RED_MIN_DATA_HOLD_FACTOR 0x0003u
#define PROFINET_RED_MAX_DATA_HOLD_FACTOR 0xFFFFu

#define PROFINET_SR_PROPERTIES_IGNORE_INPUT_STATUS 0x00000000u
#define PROFINET_SR_PROPERTIES_DELIVER_VALID_INPUTS 0x00000001u
#define PROFINET_SR_PROPERTIES_RESERVED1 0x00000002u
#define PROFINET_SR_PROPERTIES_SET_INVALID_INPUT_VALID 0x00000000u
...
#define PROFINET_FSU_HELLO_INTERVAL_100MS 0x00000064uL
#define PROFINET_FSU_HELLO_INTERVAL_300MS 0x0000012CuL

#define PROFINET_FSU_HELLO_RETRY_DEFAULT 0x00000003uL

#define PROFINET_FSU_HELLO_DELAY_OFF 0x00000000uL
#define PROFINET_FSU_HELLO_DELAY_50MS 0x00000032uL
#define PROFINET_FSU_HELLO_DELAY_100MS 0x00000064uL
...
typedef T_PROFINET_MULTICAST_BOUNDARY_ADJUST
    T_PROFINET_PEER2PEER_BOUNDARY_ADJUST;
...
} PACK_BYTE_ALIGNMENT(T_PROFINET_MRP_INSTANCE_DATA_ADJUST);
...
typedef struct _T_PROFINET_PD_INTERFACE_MRP_DATA_ADJUST_V1_1
{
  ...
  PN_U8 Padding;
  PN_U8 NumberMRPInstances;
  /*
    T_PROFINET_MRP_INSTANCE_DATA_ADJUST   MRPInstances [NumberMRPInstances];
  */

} PACK_BYTE_ALIGNMENT(T_PROFINET_PD_INTERFACE_MRP_DATA_ADJUST_V1_1);
...
} PACK_BYTE_ALIGNMENT(T_PROFINET_MRP_INSTANCE_DATA_REAL);
...
typedef struct _T_PROFINET_PD_INTERFACE_MRP_DATA_REAL_V1_1
{
  ...
  PN_U8 NumberMRPInstances;
  /*
    T_PROFINET_MRP_INSTANCE_DATA_REAL   MRPInstances [NumberMRPInstances];
  */

} PACK_BYTE_ALIGNMENT(T_PROFINET_PD_INTERFACE_MRP_DATA_REAL_V1_1);
...
typedef struct _T_PROFINET_PD_INTERFACE_MRP_DATA_CHECK_V1_1
{
  ...
  PN_U8 NumberMRPInstances;
  /*
    T_PROFINET_MRP_INSTANCE_DATA_CHECK    MRPInstances [NumberMRPInstances];
  */
} PACK_BYTE_ALIGNMENT(T_PROFINET_PD_INTERFACE_MRP_DATA_CHECK_V1_1);
...
#define PROFINET_TX_PORT_GROUP_LOCAL 0x01u
#define PROFINET_TX_PORT_GROUP_1 0x02u
#define PROFINET_TX_PORT_GROUP_2 0x04u
#define PROFINET_TX_PORT_GROUP_3 0x08u
#define PROFINET_TX_PORT_GROUP_4 0x10u
#define PROFINET_TX_PORT_GROUP_5 0x20u
...
#define PROFINET_FORWARDING_MODE_MASK                                          \
  (PROFINET_ABSOLUTE_FORWARDING_MODE | PROFINET_RELATIVE_FORWARDING_MODE)
...
#define PROFINET_SYNC_SEND_FACTOR_30_MS 960uL

#define PROFINET_DEFAULT_SYNC_SEND_FACTOR PROFINET_SYNC_SEND_FACTOR_30_MS

#define PROFINET_PTCP_MIN_TIMEOUT_FACTOR 0x00000001uL
#define PROFINET_PTCP_MAX_TIMEOUT_FACTOR 0x000001FFuL

#define PROFINET_PTCP_DEFAULT_TIMEOUT_FACTOR 0x00000006uL
#define PROFINET_PTCP_DEFAULT_TAKEOVER_FACTOR 0x00000002uL

#define PROFINET_PTCP_MASTER_STARTUP_TIME_DISABLE 0x0000u
...
} PACK_BYTE_ALIGNMENT(T_PROFINET_SUBMODULE_LIST_ENTRY);
...
typedef struct _T_PROFINET_SUBMODULE_LIST
{
  ...
  /*
    T_PROFINET_SUBMODULE_LIST_ENTRY   Entry [NumberEntries];
  */
} PACK_BYTE_ALIGNMENT(T_PROFINET_SUBMODULE_LIST);
...
#define C_CONTROL_COMMAND_DONE 0x0008u
...
typedef struct _T_PN_SERVICE_CONTROL_IND
{
  ...
  /*
    ATTENTION:
    in case of C_CONTROL_COMMAND_PRM_BEGIN the following blocks

    T_PROFINET_UUID             ConfigUUID;
    T_PROFINET_SUBMODULE_LIST   SubmoduleList;
...
} PACK_BYTE_ALIGNMENT(T_PN_CONTROL_RES_ERROR);

/*---------------------------------------------------------------------------*/

#define CONTROL_RES_ERROR_CODE1_OK ERROR_CODE1_OK
#define CONTROL_RES_ERROR_CODE2_OK ERROR_CODE2_OK
...
typedef struct _T_PN_SERVICE_CONTROL_RES
{
  ...
  /*
    ...
    ATTENTION:
    in case of C_CONTROL_COMMAND_DONE as answer of a C_CONTROL_COMMAND_PRM_BEGIN
    with NumberOfDiffModules == 0 the ErrorCode is appended

    in this case the DataLength of the Service-Description-Block has to be
    adapted T_PN_CONTROL_RES_ERROR    Error;
