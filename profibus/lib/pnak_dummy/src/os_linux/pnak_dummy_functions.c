...
T_PNAK_RESULT    pnak_snmp_get_data                        (unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32* a4, PN_U32* a5, unsigned char a6, PN_BOOL a7) {return PNAK_OK;}
T_PNAK_RESULT    pnak_snmp_check_data                      (unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32 a4, PN_U32 a5, unsigned char a6) {return PNAK_OK;}
T_PNAK_RESULT    pnak_snmp_set_data                        (unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32 a4, PN_U32 a5) {return PNAK_OK;}
