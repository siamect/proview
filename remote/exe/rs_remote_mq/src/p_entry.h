...
PAMSIMPORT int32 PAMSAPI pams_attach_q(int32*, /* ptr to attach mode */
...
PAMSIMPORT int32 PAMSAPI pams_detach_q(q_address*, /* ptr to queue to detach */
    int32*, /* ptr detach option list              */
    int32*, /* ptr to option list length           */
    int32* /* ptr to count of msgs flushed        */
    );

PAMSIMPORT int32 PAMSAPI pams_locate_q(char*, /* ptr to queue name to locate */
    int32*, /* ptr to queue name length            */
...
PAMSIMPORT int32 PAMSAPI pams_put_msg(char*, /* ptr to char buffer */
...
PAMSIMPORT int32 PAMSAPI pams_get_msg(char*, /* ptr to char buffer */
    char*, /* ptr to priority                     */
...
PAMSIMPORT int32 PAMSAPI pams_get_msgw(char*, /* ptr to char buffer */
    char*, /* ptr to priority                     */
    q_address*, /* ptr to source                       */
    short*, /* ptr to class                        */
    short*, /* ptr to type                         */
...
PAMSIMPORT int32 PAMSAPI pams_get_msga(char*, /* ptr to char buffer */
    char*, /* ptr to priority                     */
    q_address*, /* ptr to source                       */
    short*, /* ptr to class                        */
    short*, /* ptr to type                         */
...
PAMSIMPORT int32 PAMSAPI pams_cancel_get(int32* /* ptr to sel_filter */
    );

PAMSIMPORT int32 PAMSAPI pams_confirm_msg(uint32*, /* msg seq num */
    int32*, /* confirm status                      */
    char* /* post-conf journal param             */
    );

PAMSIMPORT int32 PAMSAPI pams_show_msg(char**, /* ptr to ptr to char buffer */
    struct show_buffer* /* ptr to SHOWMSG structure            */
    );

PAMSIMPORT int32 PAMSAPI pams_exit(void);

PAMSIMPORT int32 PAMSAPI pams_open_jrn(char*, int16*, int32*);

PAMSIMPORT int32 PAMSAPI pams_read_jrn(int32*, char*, char*, int32*, int16*,
    int16*, int16*, int16*, int32*, uint32*, int32*, uint32*, int32*, int32*,
    int32*, char*);

PAMSIMPORT int32 PAMSAPI pams_close_jrn(int32*);

PAMSIMPORT int32 PAMSAPI pams_print_sts(char*, /* ptr to string process name */
    char*, /* ptr to string message               */
    int /* status return                       */
    );

PAMSIMPORT int32 PAMSAPI putil_print_sts(char*, /* ptr to string process name */
    char*, /* ptr to string message               */
    int /* status return                       */
    );
...
PAMSIMPORT int32 PAMSAPI pams_set_timer(int32*, /* ptr to timer id */
    char*, /* ptr to timer format                 */
    int32*, /* ptr to timer tick count             */
    int32* /* ptr to int32 array                  */
    );

PAMSIMPORT int32 PAMSAPI pams_cancel_timer(int32* /* ptr to timer id */
    );
...
PAMSIMPORT int32 PAMSAPI pams_status_text(int32*, /* error code */
...
PAMSIMPORT int32 PAMSAPI pams_create_handle(pams_handle, /* a pams_handle */
    int32* /* the type of handle                  */
    );

PAMSIMPORT int32 PAMSAPI pams_delete_handle(pams_handle /* a pams_handle */
    );

PAMSIMPORT int32 PAMSAPI pams_msg_length(pams_handle, /* a pams_handle */
    uint32* /* length of message returned          */
    );

PAMSIMPORT int32 PAMSAPI pams_insert_buffer(pams_handle, /* message handle */
    char*, /* pointer to buffer                   */
    uint32* /* length of buffer                    */
    );

PAMSIMPORT int32 PAMSAPI pams_extract_buffer(pams_handle, /* message handle */
    char*, /* pointer to a buffer                 */
    uint32*, /* length of the buffer                */
    uint32* /* length of xtracted message          */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_int8(pams_handle, /* message handle */
    int32*, /* tag                                 */
    int8* /* value                               */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_uint8(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint8* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_int16(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int16* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_uint16(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint16* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_int32(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int32* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_uint32(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint32* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_qid(pams_handle, /* message handle */
    int32*, /* field tag                           */
    q_address* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_int64(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int64* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_uint64(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint64* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_float(pams_handle, /* message handle */
    int32*, /* field tag                           */
    float* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_double(pams_handle, /* message handle */
    int32*, /* field tag                           */
    double* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_string(pams_handle, /* message handle */
    int32*, /* field tag                          */
    char*, /* field value                        */
    int32* /* length of string                   */
    );

PAMSIMPORT int32 PAMSAPI pams_encode_array(pams_handle, /* message handle */
    int32*, /* field tag                           */
    void*, /* pointer to array                    */
    int32* /* number of elments in array          */
    );

PAMSIMPORT int32 PAMSAPI pams_remove_encoding(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int32* /* flags                               */
    );

PAMSIMPORT int32 PAMSAPI pams_next_msg_field(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int32* /* length of field                     */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_int8(pams_handle, /* message handle */
    int32*, /* field tag                          */
    int8* /* field value                        */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_uint8(pams_handle, /* message handle */
    int32*, /* field tag                          */
    uint8* /* field value                        */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_int16(pams_handle, /* message handle */
    int32*, /* field tag                          */
    int16* /* field value                        */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_uint16(pams_handle, /* message handle */
    int32*, /* field tag                          */
    uint16* /* field value                        */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_int32(pams_handle, /* message handle */
    int32*, /* field tag                          */
    int32* /* field value                        */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_uint32(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint32* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_qid(pams_handle, /* message handle */
    int32*, /* field tag                           */
    q_address* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_int64(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int64* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_uint64(pams_handle, /* message handle */
    int32*, /* field tag                           */
    uint64* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_float(pams_handle, /* message handle */
    int32*, /* field tag                           */
    float* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_double(pams_handle, /* message handle */
    int32*, /* field tag                           */
    double* /* field value                         */
    );

PAMSIMPORT int32 PAMSAPI pams_decode_string(pams_handle, /* message handle */
    int32*, /* field tag                           */
    char*, /* buffer                              */
...
PAMSIMPORT int32 PAMSAPI pams_decode_array(pams_handle, /* message handle */
    int32*, /* field tag                           */
    void*, /* pointer to array                    */
...
PAMSIMPORT int32 PAMSAPI pams_set_msg_position(pams_handle, /* message handle */
    int32*, /* field tag                           */
    int32* /* flags                               */
    );
