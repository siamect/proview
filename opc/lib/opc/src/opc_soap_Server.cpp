...
SOAP_SOURCE_STAMP("@(#) opc_soap_Server.cpp ver 2.7.9d 2007-03-30 08:43:57 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__Read(struct soap* soap)
{
  ...
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
    ...
    return soap->error;
  soap->error
      = __s0__Read(soap, soap_tmp___s0__Read.s0__Read, &s0__ReadResponse);
  if (soap->error)
    return soap->error;
  soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__Write(struct soap* soap)
{
  ...
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
    ...
    return soap->error;
  soap->error
      = __s0__Write(soap, soap_tmp___s0__Write.s0__Write, &s0__WriteResponse);
  if (soap->error)
    return soap->error;
  soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__Subscribe(struct soap* soap)
{
  ...
  soap->encodingStyle = NULL;
  if (!soap_get___s0__Subscribe(
          soap, &soap_tmp___s0__Subscribe, "-s0:Subscribe", NULL))
    return soap->error;
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
      || soap_end_recv(soap))
    return soap->error;
  soap->error = __s0__Subscribe(
      soap, soap_tmp___s0__Subscribe.s0__Subscribe, &s0__SubscribeResponse);
  if (soap->error)
    return soap->error;
  soap_serializeheader(soap);
    ...
    struct soap* soap)
{
  struct __s0__SubscriptionPolledRefresh
      soap_tmp___s0__SubscriptionPolledRefresh;
  ...
  soap_default___s0__SubscriptionPolledRefresh(
      soap, &soap_tmp___s0__SubscriptionPolledRefresh);
  soap->encodingStyle = NULL;
  if (!soap_get___s0__SubscriptionPolledRefresh(soap,
          &soap_tmp___s0__SubscriptionPolledRefresh,
          "-s0:SubscriptionPolledRefresh", NULL))
    return soap->error;
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
      || soap_end_recv(soap))
    return soap->error;
  soap->error = __s0__SubscriptionPolledRefresh(soap,
      soap_tmp___s0__SubscriptionPolledRefresh.s0__SubscriptionPolledRefresh,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap)
        || soap_body_begin_out(soap)
        || s0__SubscriptionPolledRefreshResponse.soap_put(
               soap, "s0:SubscriptionPolledRefreshResponse", "")
        || soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  };
  if (soap_end_count(soap) || soap_response(soap, SOAP_OK)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__SubscriptionCancel(struct soap* soap)
{
  ...
  soap_default___s0__SubscriptionCancel(
      soap, &soap_tmp___s0__SubscriptionCancel);
  soap->encodingStyle = NULL;
  if (!soap_get___s0__SubscriptionCancel(soap,
          &soap_tmp___s0__SubscriptionCancel, "-s0:SubscriptionCancel", NULL))
    return soap->error;
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
      || soap_end_recv(soap))
    return soap->error;
  soap->error = __s0__SubscriptionCancel(soap,
      soap_tmp___s0__SubscriptionCancel.s0__SubscriptionCancel,
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap)
        || soap_body_begin_out(soap)
        || s0__SubscriptionCancelResponse.soap_put(
               soap, "s0:SubscriptionCancelResponse", "")
        || soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  };
  if (soap_end_count(soap) || soap_response(soap, SOAP_OK)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__Browse(struct soap* soap)
{
  ...
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
      || soap_end_recv(soap))
    return soap->error;
  soap->error = __s0__Browse(
      soap, soap_tmp___s0__Browse.s0__Browse, &s0__BrowseResponse);
  if (soap->error)
    return soap->error;
  soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___s0__GetProperties(struct soap* soap)
{
  ...
  soap->encodingStyle = NULL;
  if (!soap_get___s0__GetProperties(
          soap, &soap_tmp___s0__GetProperties, "-s0:GetProperties", NULL))
    return soap->error;
  if (soap_body_end_in(soap) || soap_envelope_end_in(soap)
      || soap_end_recv(soap))
    return soap->error;
  soap->error = __s0__GetProperties(soap,
      soap_tmp___s0__GetProperties.s0__GetProperties,
      &s0__GetPropertiesResponse);
  if (soap->error)
    return soap->error;
  soap_serializeheader(soap);
  ...
  if (soap->mode & SOAP_IO_LENGTH) {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap)
        || soap_body_begin_out(soap)
        || s0__GetPropertiesResponse.soap_put(
               soap, "s0:GetPropertiesResponse", "")
        || soap_body_end_out(soap) || soap_envelope_end_out(soap))
      return soap->error;
  };
  if (soap_end_count(soap) || soap_response(soap, SOAP_OK)
