...
public class JopcBasefcppo5motoraggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc85;
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo5motoraggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr16");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(162,354,14,15));
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,491,14,14));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(197,480,36,37));
    ...
    pwr_motor244.setBounds(new Rectangle(159,553,96,72));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,563,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,581,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(357,566,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(307,599,49,15));
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(153,580,10,20));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,528,14,14));
    ...
    pwr_manswitch384.setBounds(new Rectangle(268,342,36,36));
    ...
    bcomp_fc85.setBounds(new Rectangle(256,393,62,82));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),361, 594);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 594);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 612);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 612);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915363, 12}, new int[] { 12, 15, -1219915332,43}, 4),
