...
public class JopcBasefcppo3pumpaggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbsimulate	pwr_mbsimulate67;
  pwr_indsquare	pwr_indsquare68;
  Grp221_	grp221_69;
  pwr_pumpanim2	pwr_pumpanim271;
  pwr_pump3	pwr_pump372;
  pwr_rodcouplinganim	pwr_rodcouplinganim73;
  Grp226_	grp226_74;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter75;
  pwr_fuse3	pwr_fuse379;
  pwr_contactor2	pwr_contactor280;
  bcomp_fc	bcomp_fc81;
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3pumpaggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr20");
    ...
    pwr_valuemedium59.setBounds(new Rectangle(357,519,18,12));
    pwr_valuemedium59.setFillColor(31);
    pwr_valuemedium59.setBorderColor(31);
    ...
    pwr_indsquare66.setBounds(new Rectangle(358,200,14,15));
    pwr_indsquare66.setFillColor(175);
    pwr_indsquare66.setShadow(1);
    localPanel.add(pwr_indsquare66, new Proportion(pwr_indsquare66.getBounds(), dsize));
    pwr_mbsimulate67 = new pwr_mbsimulate(session);
    pwr_mbsimulate67.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate67, new Proportion(pwr_mbsimulate67.getBounds(), dsize));
    pwr_indsquare68 = new pwr_indsquare(session);
    pwr_indsquare68.setBounds(new Rectangle(162,481,14,14));
    ...
    grp221_69 = new Grp221_(session);
    grp221_69.setBounds(new Rectangle(35,480,38,16));
    localPanel.add(grp221_69, new Proportion(grp221_69.getBounds(), dsize));
    pwr_pumpanim271 = new pwr_pumpanim2(session);
    pwr_pumpanim271.setBounds(new Rectangle(119,96,62,42));
    pwr_pumpanim271.setShadow(1);
    pwr_pumpanim271.setGradient(12);
    localPanel.add(pwr_pumpanim271, new Proportion(pwr_pumpanim271.getBounds(), dsize));
    pwr_pump372 = new pwr_pump3(session);
    pwr_pump372.setBounds(new Rectangle(76,507,82,72));
    pwr_pump372.setColorTone(7);
    localPanel.add(pwr_pump372, new Proportion(pwr_pump372.getBounds(), dsize));
    pwr_rodcouplinganim73 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim73.setBounds(new Rectangle(153,533,10,20));
    localPanel.add(pwr_rodcouplinganim73, new Proportion(pwr_rodcouplinganim73.getBounds(), dsize));
    grp226_74 = new Grp226_(session);
    grp226_74.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_74, new Proportion(grp226_74.getBounds(), dsize));
    pwr_smallbuttoncenter75 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter75.setBounds(new Rectangle(34,197,46,19));
    ...
    pwr_fuse379.setBounds(new Rectangle(281,301,13,35));
    pwr_fuse379.setRotate(-90);
    pwr_fuse379.setShadow(1);
    localPanel.add(pwr_fuse379, new Proportion(pwr_fuse379.getBounds(), dsize));
    pwr_contactor280 = new pwr_contactor2(session);
    pwr_contactor280.setBounds(new Rectangle(268,343,36,36));
    pwr_contactor280.setFillColor(32);
    pwr_contactor280.setShadow(1);
    localPanel.add(pwr_contactor280, new Proportion(pwr_contactor280.getBounds(), dsize));
    bcomp_fc81 = new bcomp_fc(session);
    bcomp_fc81.setBounds(new Rectangle(256,392,62,82));
    bcomp_fc81.setShadow(1);
    localPanel.add(bcomp_fc81, new Proportion(bcomp_fc81.getBounds(), dsize));
    pwr_mbup82 = new pwr_mbup(session);
    pwr_mbup82.setBounds(new Rectangle(347,25,18,18));
    localPanel.add(pwr_mbup82, new Proportion(pwr_mbup82.getBounds(), dsize));
...
null,null,    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuemedium59.dd.setActionType(0);
    pwr_valuemedium59.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium59.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_indsquare66.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare66.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate67.dd.setDynType(129);
    pwr_mbsimulate67.dd.setActionType(8256);
    pwr_mbsimulate67.dd.setAccess(65532);
    pwr_mbsimulate67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate67.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate67.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate67.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare68.dd.setDynType(176);
    pwr_indsquare68.dd.setActionType(2);
    pwr_indsquare68.dd.setAccess(65532);
    pwr_indsquare68.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare68.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare68.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare68.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare68.dd, "$object.Motor")
      });
    grp221_69.dd.setDynType(129);
    grp221_69.dd.setActionType(0);
    grp221_69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp221_69.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim271.dd.setDynType(66612);
    pwr_pumpanim271.dd.setActionType(0);
    pwr_pumpanim271.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim271.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim271.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim271.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim271.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim271.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump372.dd.setDynType(1);
    pwr_pump372.dd.setActionType(66);
    pwr_pump372.dd.setAccess(65532);
    pwr_pump372.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump372.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump372.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim73.dd.setDynType(65537);
    pwr_rodcouplinganim73.dd.setActionType(0);
    pwr_rodcouplinganim73.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim73.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    grp226_74.dd.setDynType(129);
    grp226_74.dd.setActionType(0);
    grp226_74.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_74.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter75.dd.setDynType(129);
    pwr_smallbuttoncenter75.dd.setActionType(6);
    pwr_smallbuttoncenter75.dd.setAccess(65532);
    pwr_smallbuttoncenter75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter75.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter75.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter75.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter75.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter75.setAnnot1("Auto");
    pwr_fuse379.dd.setDynType(1);
    pwr_fuse379.dd.setActionType(0);
    pwr_contactor280.dd.setDynType(32769);
    pwr_contactor280.dd.setActionType(66);
    pwr_contactor280.dd.setAccess(65535);
    pwr_contactor280.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor280.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor280.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor280.dd, "open graph /class/instance=$object.Contactor")
      });
    bcomp_fc81.dd.setDynType(1);
    bcomp_fc81.dd.setActionType(66);
    bcomp_fc81.dd.setAccess(65535);
    bcomp_fc81.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc81.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc81.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    pwr_mbup82.dd.setDynType(129);
    pwr_mbup82.dd.setActionType(8256);
    pwr_mbup82.dd.setAccess(33619967);
    pwr_mbup82.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup82.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup82.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup82.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 288F, 290F, 288F, 346F),
    new Line2D.Float( 288F, 396F, 288F, 380F),
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {510, 510, 506, 474, 506, 510}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 367);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Speed"),262, 530);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 41, 44}, new int[] { 14, 13, 13,14}, 4),
    ...
    new Polygon( new int[] { 6, 3, 9, -16}, new int[] { 8, 10, 13,25}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 7, 7, 6}, new int[] { 40, 36, 25,24}, 4),
    new Polygon( new int[] { 6, 7, 11, 10}, new int[] { 24, 25, 21,18}, 4),
    new Polygon( new int[] { 10, 11, 14, 14}, new int[] { 18, 21, 17,14}, 4),
    new Polygon( new int[] { 14, 14, 43, 44}, new int[] { 14, 17, 17,14}, 4),
    new Polygon( new int[] { 44, 43, 45, 46}, new int[] { 14, 17, 25,24}, 4),
    new Polygon( new int[] { 46, 45, 18, 18}, new int[] { 24, 25, 25,24}, 4),
    new Polygon( new int[] { 18, 18, 11, 12}, new int[] { 24, 25, 27,28}, 4),
    new Polygon( new int[] { 12, 11, 5, 10}, new int[] { 28, 27, 39,32}, 4),
    new Polygon( new int[] { 10, 5, 7, 6}, new int[] { 32, 39, 36,40}, 4),
    new Polygon( new int[] { 6, 7, -16, -16}, new int[] { 40, 36, 25,25}, 4),
    ...
    new Polygon( new int[] { 58, 61, 61, 58}, new int[] { 38, 38, 15,10}, 4),
    new Polygon( new int[] { 58, 61, 61, 64}, new int[] { 10, 15, 15,10}, 4),
    new Polygon( new int[] { 64, 61, 61, 64}, new int[] { 10, 15, 52,52}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -16}, new int[] { 46, 46, 54,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915392, -16}, new int[] { 10, 14, -1219915350,25}, 4),
    new Polygon( new int[] { 6, 44, 44, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {14, 14, 10, 10, 52, 58, 62, 62, 58, 52, 14}, 11),
    new Polygon( new int[] { 6, 9, 47, 44}, new int[] { 14, 19, 19,14}, 4),
    ...
    new Polygon( new int[] { 14, 15, 11, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 11, 9, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 52, 52, 19,14}, 4),
    new Polygon( new int[] { 6, 9, 140893303, -16}, new int[] { 14, 19, 144126449,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915374, 1}, new int[] { 12, 15, -1219915320,55}, 4),
