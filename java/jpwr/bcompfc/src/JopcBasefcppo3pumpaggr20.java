...
public class JopcBasefcppo3pumpaggr20 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium59.setBounds(new Rectangle(356,518,20,14));
    ...
    pwr_indsquare66.setBounds(new Rectangle(357,199,16,17));
    ...
    pwr_pump372.setBounds(new Rectangle(75,506,84,74));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_fuse379.setBounds(new Rectangle(280,300,15,37));
    ...
    pwr_contactor280.setBounds(new Rectangle(267,342,38,38));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu238.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu238.dd, new String[] {
        "Contactor.Order Do",null,"Contactor.Feedback Di",null,"FrequencyConverter.ActSpeed",null,null,"FrequencyConverter.RefSpeed","Motor.TempSwitch.Switch Di","Motor.TempSensor.Value Ai",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate67.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate67.dd, "Open simulate graph")
      });
    ...
    pwr_mbup82.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbup82.dd, "Open parent object graph")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Frequencyconverter",36, 414);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 184, -16}, new int[] { 40, 36, -1220222550,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222592, -16}, new int[] { 10, 14, -1220222550,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, -16, -16}, new int[] { 14, 19, 666,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222574, 1}, new int[] { 12, 15, -1220222520,55}, 4),
