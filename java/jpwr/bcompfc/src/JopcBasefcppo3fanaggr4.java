...
public class JopcBasefcppo3fanaggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,433,16,17));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(196,422,38,39));
    ...
    pwr_motor247.setBounds(new Rectangle(158,495,98,74));
    ...
    pwr_indsquare57.setBounds(new Rectangle(161,345,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(306,505,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(356,508,20,14));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,470,16,16));
    ...
    pwr_rod76.setBounds(new Rectangle(129,527,39,10));
    ...
    pwr_fananim77.setBounds(new Rectangle(117,487,19,91));
    ...
    grp227_78.setBounds(new Rectangle(35,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 11, 11}, new int[] { 12, 15, 472,31}, 4),
