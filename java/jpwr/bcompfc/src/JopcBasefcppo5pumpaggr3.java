...
public class JopcBasefcppo5pumpaggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup87;
  public JopcBasefcppo5pumpaggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr3");
    ...
    bcomp_fc85.setBounds(new Rectangle(255,336,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 4, 9, 5}, new int[] { 8, 8, 11,5}, 4),
    ...
    new Polygon( new int[] { 6, 7, 30, 5}, new int[] { 40, 36, 5,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 5}, new int[] { 46, 46, 54,5}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980906, 5}, new int[] { 10, 12, -1219980906,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980906, 5}, new int[] { 14, 17, -1219980906,5}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980888, 23}, new int[] { 12, 15, -1219980876,35}, 4),
