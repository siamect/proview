...
public class JopcBasefcppo5pumpaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc85.setBounds(new Rectangle(256,337,62,82));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 5, 5}, new int[] { 40, 36, 5,5}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915370, 5}, new int[] { 10, 12, -1219915370,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 17, 144126429,5}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915352, 23}, new int[] { 12, 15, -1219915340,35}, 4),
