...
public class JopcBasefcppo3motoraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare9.setBounds(new Rectangle(161,399,16,17));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(4,554,47,21));
    ...
    pwr_valuelong27.setBounds(new Rectangle(60,553,336,23));
    ...
    pwr_safetyswitch30.setBounds(new Rectangle(198,387,38,39));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(301,229,72,17));
    ...
    pwr_indsquare53.setBounds(new Rectangle(161,303,16,17));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(36,322,57,23));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,463,51,17));
    ...
    pwr_rodcouplinganim68.setBounds(new Rectangle(154,480,12,21));
    ...
    pwr_indsquare70.setBounds(new Rectangle(161,428,16,17));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_mbup74.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980882, 29}, new int[] { 12, 15, -1219980868,43}, 4),
