...
public class JopcBasefcppo3motoraggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_safetyswitch	pwr_safetyswitch30;
  ...
  pwr_mbup	pwr_mbup74;
  public JopcBasefcppo3motoraggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr10");
    ...
    pwr_indsquare9.setBounds(new Rectangle(162,400,14,15));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(5,555,45,19));
    ...
    pwr_valuelong27.setBounds(new Rectangle(61,554,334,21));
    ...
    pwr_safetyswitch30 = new pwr_safetyswitch(session);
    pwr_safetyswitch30.setBounds(new Rectangle(199,388,36,37));
    pwr_safetyswitch30.setFillColor(32);
    pwr_safetyswitch30.setShadow(1);
    localPanel.add(pwr_safetyswitch30, new Proportion(pwr_safetyswitch30.getBounds(), dsize));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_motor243.setBounds(new Rectangle(161,454,96,72));
    localPanel.add(pwr_motor243, new Proportion(pwr_motor243.getBounds(), dsize));
    bcomp_fc44 = new bcomp_fc(session);
    bcomp_fc44.setBounds(new Rectangle(256,294,62,82));
    bcomp_fc44.setShadow(1);
    localPanel.add(bcomp_fc44, new Proportion(bcomp_fc44.getBounds(), dsize));
    ...
    pwr_indsquare53.setBounds(new Rectangle(162,304,14,15));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,323,55,21));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,464,49,15));
    ...
    pwr_indsquare66.setBounds(new Rectangle(308,176,14,15));
    ...
    pwr_rodcouplinganim68.setBounds(new Rectangle(155,481,10,19));
    ...
    pwr_motorman69.setBounds(new Rectangle(115,96,62,42));
    ...
    pwr_indsquare70.setBounds(new Rectangle(162,429,14,15));
    ...
    grp223_71.setBounds(new Rectangle(35,428,38,16));
    localPanel.add(grp223_71, new Proportion(grp223_71.getBounds(), dsize));
    grp226_72 = new Grp226_(session);
    grp226_72.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_72, new Proportion(grp226_72.getBounds(), dsize));
    pwr_smallbuttoncenter73 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter73.setBounds(new Rectangle(34,197,45,19));
    ...
    pwr_mbup74.setBounds(new Rectangle(347,25,18,18));
    ...
    pwr_safetyswitch30.dd.setDynType(32769);
    pwr_safetyswitch30.dd.setActionType(66);
    pwr_safetyswitch30.dd.setAccess(65535);
    pwr_safetyswitch30.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch30.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch30.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch30.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
null,null,null,    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu242,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc44.dd.setDynType(1);
    bcomp_fc44.dd.setActionType(66);
    bcomp_fc44.dd.setAccess(65535);
    bcomp_fc44.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc44.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc44.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    grp226_72.dd.setDynType(129);
    grp226_72.dd.setActionType(0);
    grp226_72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_72.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915346, 29}, new int[] { 12, 15, -1219915332,43}, 4),
