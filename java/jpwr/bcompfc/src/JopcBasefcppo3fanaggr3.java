...
public class JopcBasefcppo3fanaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare16.setBounds(new Rectangle(161,442,16,17));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,597,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,596,336,23));
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(268,432,38,39));
    ...
    pwr_indsquare61.setBounds(new Rectangle(161,346,16,16));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(36,365,57,23));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,506,51,17));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(358,509,20,14));
    ...
    pwr_indsquare74.setBounds(new Rectangle(310,175,16,17));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,471,16,16));
    ...
    grp223_77.setBounds(new Rectangle(34,470,40,17));
    ...
    pwr_rod80.setBounds(new Rectangle(131,528,39,10));
    ...
    pwr_fananim81.setBounds(new Rectangle(119,488,19,91));
    ...
    pwr_mbup84.setBounds(new Rectangle(347,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980905, 6}, new int[] { 12, 15, -1219980883,28}, 4),
