...
public class JopcBasefcppo3motoraggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_rodcouplinganim	pwr_rodcouplinganim65;
  pwr_motorman	pwr_motorman66;
  pwr_indsquare	pwr_indsquare67;
  Grp223_	grp223_68;
  pwr_fuse3	pwr_fuse370;
  Grp227_	grp227_71;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter72;
  pwr_mbup	pwr_mbup73;
  public JopcBasefcppo3motoraggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr23");
    ...
    pwr_valuelong23.setBounds(new Rectangle(17,69,367,20));
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(5,553,46,19));
    ...
    pwr_valuelong25.setBounds(new Rectangle(61,552,334,21));
    ...
    pwr_indsquare26.setBounds(new Rectangle(349,97,14,15));
    ...
    pwr_valuesmall32.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_valuesmall33.setBounds(new Rectangle(302,249,70,16));
    ...
    pwr_motor240.setBounds(new Rectangle(161,452,96,72));
    localPanel.add(pwr_motor240, new Proportion(pwr_motor240.getBounds(), dsize));
    bcomp_fc41 = new bcomp_fc(session);
    bcomp_fc41.setBounds(new Rectangle(256,342,62,82));
    bcomp_fc41.setShadow(1);
    localPanel.add(bcomp_fc41, new Proportion(bcomp_fc41.getBounds(), dsize));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(309,462,49,15));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(359,465,18,12));
    ...
    grp210_60.setBounds(new Rectangle(127,228,39,16));
    ...
    pwr_rodcouplinganim65 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim65.setBounds(new Rectangle(155,479,10,20));
    localPanel.add(pwr_rodcouplinganim65, new Proportion(pwr_rodcouplinganim65.getBounds(), dsize));
    pwr_motorman66 = new pwr_motorman(session);
    pwr_motorman66.setBounds(new Rectangle(115,96,62,42));
    pwr_motorman66.setShadow(1);
    pwr_motorman66.setGradient(12);
    localPanel.add(pwr_motorman66, new Proportion(pwr_motorman66.getBounds(), dsize));
    pwr_indsquare67 = new pwr_indsquare(session);
    pwr_indsquare67.setBounds(new Rectangle(162,427,14,14));
    ...
    grp223_68.setBounds(new Rectangle(35,426,38,16));
    localPanel.add(grp223_68, new Proportion(grp223_68.getBounds(), dsize));
    pwr_fuse370 = new pwr_fuse3(session);
    pwr_fuse370.setBounds(new Rectangle(281,297,13,35));
    pwr_fuse370.setRotate(-90);
    pwr_fuse370.setShadow(1);
    localPanel.add(pwr_fuse370, new Proportion(pwr_fuse370.getBounds(), dsize));
...
null,null,null,null,null,null,    new GeDyn(pwr_pulldownmenu237,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc41.dd.setDynType(1);
    bcomp_fc41.dd.setActionType(66);
    bcomp_fc41.dd.setAccess(65535);
    bcomp_fc41.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc41.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc41.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_rodcouplinganim65.dd.setDynType(65537);
    pwr_rodcouplinganim65.dd.setActionType(0);
    pwr_rodcouplinganim65.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim65.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    pwr_motorman66.dd.setDynType(1077);
    pwr_motorman66.dd.setActionType(0);
    pwr_motorman66.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman66.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman66.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman66.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_motorman66.dd, "$object.Mode.IndMode##String8","%s")
      });
    ...
    pwr_fuse370.dd.setDynType(1);
    pwr_fuse370.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {454, 454, 450, 422, 450, 454}, 6),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915394, -18}, new int[] { 12, 15, -1219915345,30}, 4),
