...
public class JopcBasefcppo3motoraggr23 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(4,552,48,21));
    ...
    pwr_valuelong25.setBounds(new Rectangle(60,551,336,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(308,461,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(358,464,20,14));
    ...
    grp210_60.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_rodcouplinganim65.setBounds(new Rectangle(154,478,12,22));
    ...
    pwr_motorman66.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare67.setBounds(new Rectangle(161,426,16,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980930, -18}, new int[] { 12, 15, -1219980881,30}, 4),
