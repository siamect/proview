...
public class JopcBasefcppo3pumpaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp210_62.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_pump371.setBounds(new Rectangle(77,454,84,74));
    ...
    pwr_mbup76.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 158, -42}, new int[] { 40, 36, -1219980907,4}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980954, -42}, new int[] { 10, 12, -1219980907,4}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980954, -42}, new int[] { 14, 17, -1219980907,4}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980936, -24}, new int[] { 12, 15, -1219980877,34}, 4),
