...
public class JopcBasefcppo5pumpaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc89.setBounds(new Rectangle(255,336,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 163, 2}, new int[] { 40, 36, -1219980911,0}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980909, 2}, new int[] { 10, 12, -1219980911,0}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980909, 2}, new int[] { 14, 17, -1219980911,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 164098956, 20}, new int[] { 12, 15, 144032830,30}, 4),
