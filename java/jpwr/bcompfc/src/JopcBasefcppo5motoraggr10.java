...
public class JopcBasefcppo5motoraggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup80;
  public JopcBasefcppo5motoraggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr10");
    ...
    pwr_smallbuttoncenter26.setBorderColor(57);
    ...
    pwr_valuemedium59.setBounds(new Rectangle(309,482,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(355,451,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(309,500,49,15));
    ...
    pwr_indsquare72.setBounds(new Rectangle(308,176,14,15));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,429,14,15));
    ...
    grp223_77.setBounds(new Rectangle(35,428,38,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915343, 32}, new int[] { 12, 15, -1219915321,54}, 4),
