...
public class JopcBasefcppo5motoraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium59.setBounds(new Rectangle(308,481,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(354,450,20,14));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(308,499,51,17));
    ...
    pwr_indsquare72.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,428,16,17));
    ...
    grp223_77.setBounds(new Rectangle(34,427,40,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980879, 32}, new int[] { 12, 15, -1219980857,54}, 4),
