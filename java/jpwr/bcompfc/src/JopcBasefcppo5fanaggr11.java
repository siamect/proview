...
public class JopcBasefcppo5fanaggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_71;
  pwr_fananim2	pwr_fananim273;
  pwr_rod	pwr_rod74;
  pwr_fananim	pwr_fananim75;
  Grp229_	grp229_76;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter77;
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo5fanaggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr11");
    ...
    pwr_fananim273 = new pwr_fananim2(session);
    pwr_fananim273.setBounds(new Rectangle(115,95,64,44));
    pwr_fananim273.setBorderColor(29);
    pwr_fananim273.setTextColor(0);
    pwr_fananim273.setShadow(1);
    pwr_fananim273.setGradient(12);
    localPanel.add(pwr_fananim273, new Proportion(pwr_fananim273.getBounds(), dsize));
    pwr_rod74 = new pwr_rod(session);
    pwr_rod74.setBounds(new Rectangle(132,435,39,10));
    pwr_rod74.setShadow(1);
    localPanel.add(pwr_rod74, new Proportion(pwr_rod74.getBounds(), dsize));
    pwr_fananim75 = new pwr_fananim(session);
    pwr_fananim75.setBounds(new Rectangle(120,395,19,91));
    pwr_fananim75.setShadow(1);
    localPanel.add(pwr_fananim75, new Proportion(pwr_fananim75.getBounds(), dsize));
    grp229_76 = new Grp229_(session);
    grp229_76.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp229_76, new Proportion(grp229_76.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim273.dd.setDynType(66612);
    pwr_fananim273.dd.setActionType(0);
    pwr_fananim273.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim273.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim273.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim273.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim273.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim273.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim273.setAnnot1("L");
    pwr_rod74.dd.setDynType(1);
    pwr_rod74.dd.setActionType(0);
    pwr_fananim75.dd.setDynType(65537);
    pwr_fananim75.dd.setActionType(66);
    pwr_fananim75.dd.setAccess(65532);
    pwr_fananim75.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim75.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim75.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim75.dd, "open graph/class/inst=$object.Fan")
      });
    grp229_76.dd.setDynType(129);
    grp229_76.dd.setActionType(0);
    grp229_76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_76.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980909, 2}, new int[] { 12, 15, -1219980860,51}, 4),
