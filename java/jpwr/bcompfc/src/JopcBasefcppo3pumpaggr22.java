...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 248, 0}, new int[] { 40, 36, -1220222549,26}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222576, 0}, new int[] { 10, 14, -1220222549,26}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222576, 0}, new int[] { 14, 19, -1220222549,26}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222558, 17}, new int[] { 12, 15, -1220222519,56}, 4),
