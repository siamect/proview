...
public class JopcBasefcppo3pumpaggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium57.setBounds(new Rectangle(358,514,20,14));
    ...
    pwr_indsquare64.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_pump370.setBounds(new Rectangle(77,502,84,74));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_mbup78.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 144, 0}, new int[] { 40, 36, -1219980885,26}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980912, 0}, new int[] { 10, 14, -1219980885,26}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980912, 0}, new int[] { 14, 19, -1219980885,26}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980894, 17}, new int[] { 12, 15, -1219980855,56}, 4),
