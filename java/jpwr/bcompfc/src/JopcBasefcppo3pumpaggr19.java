...
public class JopcBasefcppo3pumpaggr19 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc85;
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo3pumpaggr19( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr19( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr19");
    ...
    pwr_valuemedium62.setBounds(new Rectangle(357,564,18,12));
    ...
    pwr_indsquare69.setBounds(new Rectangle(358,200,14,15));
    ...
    pwr_indsquare71.setBounds(new Rectangle(162,526,14,15));
    ...
    pwr_pump375.setBounds(new Rectangle(76,552,82,72));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(153,578,10,20));
    ...
    pwr_fuse383.setBounds(new Rectangle(281,297,13,35));
    ...
    pwr_contactor284.setBounds(new Rectangle(268,342,36,36));
    ...
    bcomp_fc85.setBounds(new Rectangle(256,391,62,82));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 288.694F, 287.999F, 288.694F, 343.999F),
    new Line2D.Float( 288.694F, 394F, 288.694F, 378F),
    new Polygon( new int[] { 213, 285, 289, 289, 289, 285}, new int[] {554, 554, 550, 472, 550, 554}, 6),
    new Polygon( new int[] { 217, 217, 221, 271, 221, 217}, new int[] {480, 364, 360, 360, 360, 364}, 6),
  };
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, 1}, new int[] { 8, 8, 11,-2}, 4),
    ...
    new Polygon( new int[] { 6, 7, 66, 1}, new int[] { 40, 36, -1219915378,-2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 1}, new int[] { 46, 46, 54,-2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915374, 1}, new int[] { 10, 12, -1219915378,-2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915374, 1}, new int[] { 14, 17, -1219915378,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915356, 19}, new int[] { 12, 15, -1219915348,27}, 4),
