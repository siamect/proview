...
public class JopcBasefcppo3pumpaggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium62.setBounds(new Rectangle(356,563,20,14));
    ...
    pwr_indsquare69.setBounds(new Rectangle(357,199,16,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,525,16,17));
    ...
    pwr_pump375.setBounds(new Rectangle(75,551,84,74));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(152,577,12,22));
    ...
    pwr_fuse383.setBounds(new Rectangle(280,296,15,37));
    ...
    pwr_contactor284.setBounds(new Rectangle(267,341,38,38));
    ...
    bcomp_fc85.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 34, 1}, new int[] { 40, 36, -1219980914,-2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980910, 1}, new int[] { 10, 12, -1219980914,-2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 1, 1}, new int[] { 14, 17, 70,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980892, 19}, new int[] { 12, 15, -1219980884,27}, 4),
