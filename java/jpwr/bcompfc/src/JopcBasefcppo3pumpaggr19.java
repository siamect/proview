...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 26, 1}, new int[] { 40, 36, -1220222578,-2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222574, 1}, new int[] { 10, 12, -1220222578,-2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222574, 1}, new int[] { 14, 17, -1220222578,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222556, 19}, new int[] { 12, 15, -1220222548,27}, 4),
