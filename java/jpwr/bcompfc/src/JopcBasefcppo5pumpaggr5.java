...
public class JopcBasefcppo5pumpaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_manswitch329.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,345,16,16));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(306,457,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,475,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(356,460,20,14));
    ...
    pwr_valueinputmediumrd64.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_65.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_65, new Proportion(grp210_65.getBounds(), dsize));
    grp212_66 = new Grp212_(session);
    grp212_66.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(306,493,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_mbsimulate72.setBounds(new Rectangle(365,24,19,20));
    ...
    pwr_pumpanim276.setBounds(new Rectangle(116,95,64,44));
    ...
    pwr_pump377.setBounds(new Rectangle(75,448,84,74));
    ...
    pwr_smallbuttoncenter80.setBounds(new Rectangle(33,196,48,21));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 8, 24, 7}, new int[] { 40, 34, -1219980886,25}, 4),
    ...
    new Polygon( new int[] { 6, 10, 10, 25}, new int[] { 46, 46, 57,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980904, 7}, new int[] { 10, 14, -1219980886,25}, 4),
    ...
    new Polygon( new int[] { 6, 10, 7, 7}, new int[] { 14, 19, 466,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980886, 25}, new int[] { 12, 15, -1219980856,55}, 4),
