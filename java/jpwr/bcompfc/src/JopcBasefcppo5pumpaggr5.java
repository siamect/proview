...
public class JopcBasefcppo5pumpaggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch329;
  ...
  pwr_valueinputmediumrd	pwr_valueinputmediumrd64;
  Grp210_	grp210_65;
  Grp212_	grp212_66;
  pwr_valuemedium	pwr_valuemedium67;
  pwr_indsquare	pwr_indsquare71;
  pwr_mbsimulate	pwr_mbsimulate72;
  pwr_indsquare	pwr_indsquare73;
  Grp221_	grp221_74;
  pwr_pumpanim2	pwr_pumpanim276;
  pwr_pump3	pwr_pump377;
  pwr_rodcouplinganim	pwr_rodcouplinganim78;
  Grp226_	grp226_79;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter80;
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5pumpaggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr5");
    ...
    pwr_manswitch329 = new pwr_manswitch3(session);
    pwr_manswitch329.setBounds(new Rectangle(268,285,36,36));
    pwr_manswitch329.setFillColor(32);
    pwr_manswitch329.setShadow(1);
    localPanel.add(pwr_manswitch329, new Proportion(pwr_manswitch329.getBounds(), dsize));
    ...
    pwr_motor242.setBounds(new Rectangle(159,448,96,72));
    localPanel.add(pwr_motor242, new Proportion(pwr_motor242.getBounds(), dsize));
    bcomp_fc43 = new bcomp_fc(session);
    bcomp_fc43.setBounds(new Rectangle(256,336,62,82));
    bcomp_fc43.setShadow(1);
    localPanel.add(bcomp_fc43, new Proportion(bcomp_fc43.getBounds(), dsize));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,346,14,14));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(37,365,55,21));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(307,458,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,476,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(357,461,18,12));
    pwr_valuemedium60.setFillColor(31);
    pwr_valuemedium60.setBorderColor(31);
    localPanel.add(pwr_valuemedium60, new Proportion(pwr_valuemedium60.getBounds(), dsize));
    pwr_valueinputmediumrd64 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd64.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd64.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd64, new Proportion(pwr_valueinputmediumrd64.getBounds(), dsize));
    grp210_65 = new Grp210_(session);
    grp210_65.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_65, new Proportion(grp210_65.getBounds(), dsize));
    grp212_66 = new Grp212_(session);
    grp212_66.setBounds(new Rectangle(199,247,26,18));
    grp212_66.setFillColor(31);
    grp212_66.setBorderColor(31);
    localPanel.add(grp212_66, new Proportion(grp212_66.getBounds(), dsize));
    pwr_valuemedium67 = new pwr_valuemedium(session);
    pwr_valuemedium67.setBounds(new Rectangle(307,494,49,15));
    pwr_valuemedium67.setShadow(1);
    ...
    pwr_indsquare71.setBounds(new Rectangle(312,174,14,15));
    pwr_indsquare71.setFillColor(175);
    pwr_indsquare71.setShadow(1);
    localPanel.add(pwr_indsquare71, new Proportion(pwr_indsquare71.getBounds(), dsize));
    pwr_mbsimulate72 = new pwr_mbsimulate(session);
    pwr_mbsimulate72.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate72, new Proportion(pwr_mbsimulate72.getBounds(), dsize));
    ...
    pwr_pumpanim276 = new pwr_pumpanim2(session);
    pwr_pumpanim276.setBounds(new Rectangle(117,96,62,42));
    pwr_pumpanim276.setShadow(1);
    pwr_pumpanim276.setGradient(12);
    localPanel.add(pwr_pumpanim276, new Proportion(pwr_pumpanim276.getBounds(), dsize));
    pwr_pump377 = new pwr_pump3(session);
    pwr_pump377.setBounds(new Rectangle(76,449,82,72));
    pwr_pump377.setColorTone(7);
    localPanel.add(pwr_pump377, new Proportion(pwr_pump377.getBounds(), dsize));
    pwr_rodcouplinganim78 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim78.setBounds(new Rectangle(153,475,10,19));
    localPanel.add(pwr_rodcouplinganim78, new Proportion(pwr_rodcouplinganim78.getBounds(), dsize));
    grp226_79 = new Grp226_(session);
    grp226_79.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_79, new Proportion(grp226_79.getBounds(), dsize));
    pwr_smallbuttoncenter80 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter80.setBounds(new Rectangle(34,197,46,19));
    pwr_smallbuttoncenter80.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter80, new Proportion(pwr_smallbuttoncenter80.getBounds(), dsize));
    ...
    pwr_manswitch329.dd.setDynType(32769);
    pwr_manswitch329.dd.setActionType(66);
    pwr_manswitch329.dd.setAccess(65535);
    pwr_manswitch329.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch329.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch329.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch329.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu239.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.CircuitBreaker.NotTripped")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu241.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.CircuitBreaker")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc43.dd.setDynType(1);
    bcomp_fc43.dd.setActionType(66);
    bcomp_fc43.dd.setAccess(65535);
    bcomp_fc43.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc43.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc43.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter56.dd.setDynType(1);
    ...
    pwr_smallbuttoncenter56.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter56.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter56.setAnnot1("Reset");
    pwr_valuemedium57.dd.setDynType(1024);
    ...
    pwr_valuemedium57.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium57.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium57.dd, "$object.FrequencyConverter.ActSpeed")
      });
    ...
    pwr_valuemedium58.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium58.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium58.dd, "$object.FrequencyConverter.ActTorque")
      });
    pwr_valuemedium60.dd.setDynType(1025);
    pwr_valuemedium60.dd.setActionType(0);
    pwr_valuemedium60.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium60.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd64.dd.setDynType(1153);
    pwr_valueinputmediumrd64.dd.setActionType(4096);
    pwr_valueinputmediumrd64.dd.setAccess(65532);
    pwr_valueinputmediumrd64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd64.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd64.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd64.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd64.setAnnot1Font(pwr_valueinputmediumrd64.annotFont.deriveFont((float)14));
    grp210_65.dd.setDynType(129);
    grp210_65.dd.setActionType(0);
    grp210_65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_65.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_66.dd.setDynType(129);
    grp212_66.dd.setActionType(0);
    grp212_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_66.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_valuemedium67.dd.setDynType(1025);
    pwr_valuemedium67.dd.setActionType(2);
    pwr_valuemedium67.dd.setAccess(65532);
    pwr_valuemedium67.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium67.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium67.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    pwr_indsquare71.dd.setDynType(5);
    pwr_indsquare71.dd.setActionType(0);
    pwr_indsquare71.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare71.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate72.dd.setDynType(129);
    pwr_mbsimulate72.dd.setActionType(8256);
    pwr_mbsimulate72.dd.setAccess(65532);
    pwr_mbsimulate72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate72.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate72.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate72.dd, JopLang.transl("Open simulate graph"))
      });
    ...
    pwr_pumpanim276.dd.setDynType(66612);
    pwr_pumpanim276.dd.setActionType(0);
    pwr_pumpanim276.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim276.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim276.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim276.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim276.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim276.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump377.dd.setDynType(1);
    pwr_pump377.dd.setActionType(66);
    pwr_pump377.dd.setAccess(65532);
    pwr_pump377.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump377.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump377.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim78.dd.setDynType(65537);
    pwr_rodcouplinganim78.dd.setActionType(0);
    pwr_rodcouplinganim78.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim78.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    grp226_79.dd.setDynType(129);
    grp226_79.dd.setActionType(0);
    grp226_79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_79.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter80.dd.setDynType(129);
    pwr_smallbuttoncenter80.dd.setActionType(6);
    pwr_smallbuttoncenter80.dd.setAccess(65532);
    pwr_smallbuttoncenter80.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter80.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter80.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter80.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter80.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter80.setAnnot1("Auto");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),361, 490);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 490);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 472);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 508);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 508);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 10, 7}, new int[] { 8, 10, 13,25}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 8, 8, 6}, new int[] { 40, 34, 25,24}, 4),
    new Polygon( new int[] { 6, 8, 11, 10}, new int[] { 24, 25, 21,18}, 4),
    ...
    new Polygon( new int[] { 6, 8, 168, 7}, new int[] { 40, 34, -1219915350,25}, 4),
    ...
    new Polygon( new int[] { 6, 10, 10, 7}, new int[] { 46, 46, 57,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915368, 7}, new int[] { 10, 14, -1219915350,25}, 4),
    new Polygon( new int[] { 6, 44, 44, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {14, 14, 10, 10, 52, 58, 62, 62, 58, 52, 14}, 11),
    new Polygon( new int[] { 6, 10, 47, 44}, new int[] { 14, 19, 19,14}, 4),
    ...
    new Polygon( new int[] { 14, 15, 11, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 11, 10, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 52, 52, 19,14}, 4),
    new Polygon( new int[] { 6, 10, -1219915368, 7}, new int[] { 14, 19, -1219915350,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915350, 25}, new int[] { 12, 15, -1219915320,55}, 4),
