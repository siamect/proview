...
public class JopcBasefcppo3motoraggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(162,398,14,15));
    ...
    pwr_indsquare14.setBounds(new Rectangle(162,352,14,15));
    ...
    pwr_indsquare17.setBounds(new Rectangle(162,543,14,14));
    ...
    pwr_smallbuttoncenter34.setBounds(new Rectangle(5,698,45,18));
    ...
    pwr_valuelong35.setBounds(new Rectangle(61,697,334,21));
    ...
    pwr_manswitch338.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_contactor239.setBounds(new Rectangle(268,388,36,36));
    ...
    pwr_safetyswitch40.setBounds(new Rectangle(269,533,36,37));
    ...
    pwr_indsquare65.setBounds(new Rectangle(162,447,14,14));
    ...
    pwr_smallbuttoncenter70.setBounds(new Rectangle(37,466,55,21));
    ...
    pwr_valuemedium71.setBounds(new Rectangle(309,607,49,15));
    ...
    pwr_valuemedium72.setBounds(new Rectangle(359,610,18,12));
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(155,624,10,20));
    ...
    pwr_motorman82.setBounds(new Rectangle(115,96,62,42));
    ...
    pwr_indsquare83.setBounds(new Rectangle(162,572,14,15));
    ...
    grp226_86.setBounds(new Rectangle(37,197,39,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 158170853, 5}, new int[] { 12, 15, 144033831,55}, 4),
