...
public class JopcBasefcppo5fanaggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc83;
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo5fanaggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr22");
    ...
    bcomp_fc83.setBounds(new Rectangle(256,343,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim275.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim275.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim275.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim275.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim77.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim77.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {508, 508, 504, 426, 504, 508}, 6),
  };
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915332, 43}, new int[] { 12, 15, -1219915338,37}, 4),
