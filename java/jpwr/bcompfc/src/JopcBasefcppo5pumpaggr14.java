...
public class JopcBasefcppo5pumpaggr14 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc91;
  pwr_mbup	pwr_mbup92;
  public JopcBasefcppo5pumpaggr14( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr14( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr14");
    ...
    bcomp_fc91.setBounds(new Rectangle(256,436,62,82));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -25}, new int[] { 8, 10, 11,10}, 4),
    ...
    new Polygon( new int[] { 6, 7, 159, -25}, new int[] { 40, 36, -1219915365,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -25}, new int[] { 46, 46, 54,10}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915401, -25}, new int[] { 10, 12, -1219915365,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915401, -25}, new int[] { 14, 17, -1219915365,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915383, -7}, new int[] { 12, 15, -1219915335,40}, 4),
