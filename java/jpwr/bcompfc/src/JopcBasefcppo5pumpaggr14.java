...
public class JopcBasefcppo5pumpaggr14 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc91.setBounds(new Rectangle(255,435,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -25, -25}, new int[] { 40, 36, 10,10}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980937, -25}, new int[] { 10, 12, -1219980901,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893294, -25}, new int[] { 14, 17, 144132690,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980919, -7}, new int[] { 12, 15, -1219980871,40}, 4),
