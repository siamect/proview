...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 39, -25}, new int[] { 40, 36, 152147858,10}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222601, -25}, new int[] { 10, 12, -1220222565,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893294, -25}, new int[] { 14, 17, 144130530,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -7, -7}, new int[] { 12, 15, 40,40}, 4),
