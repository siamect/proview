...
public class JopcBasefcppo3fanaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim270.setBounds(new Rectangle(118,96,62,42));
    ...
    pwr_rod71.setBounds(new Rectangle(132,486,37,8));
    ...
    pwr_fananim72.setBounds(new Rectangle(120,446,17,89));
    ...
    pwr_mbup76.setBounds(new Rectangle(348,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915336, 39}, new int[] { 12, 15, -1219915343,32}, 4),
