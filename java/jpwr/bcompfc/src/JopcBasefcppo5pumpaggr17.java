...
public class JopcBasefcppo5pumpaggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc84.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -1, -1}, new int[] { 40, 36, 7,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980913, -1}, new int[] { 10, 12, -1219980904,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893318, -1}, new int[] { 14, 17, 144132687,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 16, 16}, new int[] { 12, 15, 37,37}, 4),
