...
public class JopcBasefcppo5pumpaggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc84;
  pwr_mbup	pwr_mbup85;
  public JopcBasefcppo5pumpaggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr17");
    ...
    bcomp_fc84.setBounds(new Rectangle(256,391,62,82));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -1}, new int[] { 8, 8, 11,7}, 4),
    ...
    new Polygon( new int[] { 6, 7, 23, -1}, new int[] { 40, 36, 7,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -1}, new int[] { 46, 46, 54,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915377, -1}, new int[] { 10, 12, -1219915368,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893318, -1}, new int[] { 14, 17, 144126431,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915359, 16}, new int[] { 12, 15, -1219915338,37}, 4),
