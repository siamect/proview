...
public class JopcBasefcppo3fanaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbnote36.setBounds(new Rectangle(35,24,19,20));
    ...
    pwr_smallbuttoncenter39.setBounds(new Rectangle(4,697,47,20));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_valueinputmediumrd80.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_81.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_81, new Proportion(grp210_81.getBounds(), dsize));
    grp212_82 = new Grp212_(session);
    grp212_82.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_indsquare86.setBounds(new Rectangle(161,571,16,17));
    ...
    pwr_rod90.setBounds(new Rectangle(132,628,39,10));
    ...
    pwr_fananim91.setBounds(new Rectangle(120,588,19,91));
    ...
    pwr_fuse392.setBounds(new Rectangle(280,296,15,37));
    ...
    grp229_93.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_smallbuttoncenter94.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_mbup95.setBounds(new Rectangle(347,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980884, 27}, new int[] { 12, 15, -1219980877,34}, 4),
