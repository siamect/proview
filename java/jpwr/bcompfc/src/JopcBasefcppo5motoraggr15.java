...
public class JopcBasefcppo5motoraggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup87;
  public JopcBasefcppo5motoraggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr15");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(163,351,14,14));
    ...
    pwr_indsquare10.setBounds(new Rectangle(163,497,14,15));
    ...
    pwr_indsquare32.setBounds(new Rectangle(350,118,14,15));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(303,230,70,16));
    ...
    pwr_valuesmall36.setBounds(new Rectangle(303,249,70,16));
    ...
    pwr_smallbuttoncenter44.setBounds(new Rectangle(35,172,46,19));
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(125,173,59,19));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(125,197,59,19));
    ...
    pwr_indround49.setBounds(new Rectangle(87,248,16,15));
    ...
    pwr_indround50.setBounds(new Rectangle(194,174,16,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,579,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(359,564,18,12));
    ...
    grp210_65.setBounds(new Rectangle(128,228,39,16));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(309,597,49,15));
    ...
    pwr_indsquare71.setBounds(new Rectangle(312,176,14,15));
    ...
    pwr_mbsimulate72.setBounds(new Rectangle(367,25,17,18));
    ...
    pwr_rodcouplinganim73.setBounds(new Rectangle(155,578,10,20));
    ...
    pwr_indsquare75.setBounds(new Rectangle(163,526,14,15));
    ...
    pwr_smallbuttoncenter78.setBounds(new Rectangle(35,197,46,19));
    ...
    pwr_manswitch383.setBounds(new Rectangle(269,339,36,36));
    ...
    bcomp_fc85.setBounds(new Rectangle(257,391,62,82));
    ...
    pwr_safetyswitch86.setBounds(new Rectangle(269,487,36,37));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(20.382F, 278.787F, 361.009F, 369.051F),
    ...
    new Line2D.Float( 288.625F, 394F, 288.625F, 376F),
    new Line2D.Float( 288.625F, 490F, 288.625F, 472F),
    new Polygon( new int[] { 215, 285, 289, 289, 289, 285}, new int[] {554, 554, 550, 524, 550, 554}, 6),
    new Line2D.Float( 288.625F, 286F, 288.625F, 342F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Circuit breaker"),37, 362);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),37, 508);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),364, 592);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),265, 592);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),265, 574);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),364, 610);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),265, 610);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),243, 188);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[16]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 92, 92, 95, 96}, new int[] { 12, 15, 16,14}, 4),
    new Polygon( new int[] { 96, 95, 95, 96}, new int[] { 14, 16, 59,60}, 4),
    ...
    new Polygon( new int[] { 80, 81, -1219915392, -16}, new int[] { 12, 15, -1219915360,15}, 4),
