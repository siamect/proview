...
public class JopcBasefcppo3motoraggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,298,14,15));
    ...
    pwr_indsquare13.setBounds(new Rectangle(162,435,14,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,598,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,597,334,21));
    ...
    pwr_contactor234.setBounds(new Rectangle(268,288,36,36));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(197,424,36,37));
    ...
    pwr_indsquare60.setBounds(new Rectangle(162,347,14,14));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(307,507,49,15));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(357,510,18,12));
    ...
    pwr_indsquare78.setBounds(new Rectangle(162,472,14,14));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915370, 5}, new int[] { 12, 15, -1219915320,55}, 4),
