...
public class JopcBasefcppo5motoraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(154,480,12,22));
    ...
    pwr_indsquare77.setBounds(new Rectangle(161,428,16,17));
    ...
    grp223_78.setBounds(new Rectangle(34,427,40,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980891, 20}, new int[] { 12, 15, -1219980894,17}, 4),
