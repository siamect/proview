...
public class JopcBasefcppo5motoraggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup81;
  public JopcBasefcppo5motoraggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr9");
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(155,481,10,20));
    ...
    pwr_indsquare77.setBounds(new Rectangle(162,429,14,15));
    ...
    grp223_78.setBounds(new Rectangle(35,428,38,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915355, 20}, new int[] { 12, 15, -1219915358,17}, 4),
