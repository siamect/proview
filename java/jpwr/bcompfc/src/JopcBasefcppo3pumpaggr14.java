...
public class JopcBasefcppo3pumpaggr14 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc91;
  pwr_mbup	pwr_mbup92;
  public JopcBasefcppo3pumpaggr14( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr14( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr14");
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -25}, new int[] { 8, 8, 11,0}, 4),
    ...
    new Polygon( new int[] { 6, 7, -25, -25}, new int[] { 40, 36, 0,0}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -25}, new int[] { 46, 46, 54,0}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915401, -25}, new int[] { 10, 12, -1219915375,0}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893294, -25}, new int[] { 14, 17, 144126424,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -7, -7}, new int[] { 12, 15, 34,30}, 4),
