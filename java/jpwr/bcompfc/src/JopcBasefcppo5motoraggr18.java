...
public class JopcBasefcppo5motoraggr18 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcBasefcppo5motoraggr18( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr18( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr18");
    ...
    pwr_motor243.setBounds(new Rectangle(161,549,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,399,14,15));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,418,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,559,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,577,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,562,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,595,49,15));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(155,576,10,20));
    ...
    pwr_motorman77.setBounds(new Rectangle(116,96,61,42));
    ...
    pwr_indsquare78.setBounds(new Rectangle(162,524,14,15));
    ...
    grp223_79.setBounds(new Rectangle(35,523,37,16));
    ...
    pwr_contactor287.setBounds(new Rectangle(268,340,36,36));
    ...
    bcomp_fc88.setBounds(new Rectangle(256,389,62,82));
    ...
    pwr_safetyswitch89.setBounds(new Rectangle(269,485,36,37));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915305, 70}, new int[] { 12, 15, -1219915354,21}, 4),
