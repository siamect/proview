...
public class JopcBasefcppo5motoraggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_motor243.setBounds(new Rectangle(160,548,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(161,398,16,17));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(36,417,57,23));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(308,558,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,576,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,561,20,14));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(308,594,51,17));
    ...
    pwr_motorman77.setBounds(new Rectangle(115,95,63,44));
    ...
    grp223_79.setBounds(new Rectangle(34,522,39,18));
    ...
    pwr_contactor287.setBounds(new Rectangle(267,339,38,38));
    ...
    bcomp_fc88.setBounds(new Rectangle(255,388,64,84));
    ...
    pwr_safetyswitch89.setBounds(new Rectangle(268,484,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222505, 70}, new int[] { 12, 15, -1220222554,21}, 4),
