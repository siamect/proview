...
public class JopcBasefcppo5pumpaggr13 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_smallbuttoncenter86.setBounds(new Rectangle(33,196,48,21));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219980921, -9}, new int[] { 10, 14, -1219980890,21}, 4),
    ...
    new Polygon( new int[] { 6, 9, -9, -9}, new int[] { 14, 19, 24,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 8, 8}, new int[] { 12, 15, 156,51}, 4),
