...
public class JopcBasefcppo5pumpaggr13 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc95;
  pwr_mbup	pwr_mbup96;
  public JopcBasefcppo5pumpaggr13( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr13( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr13");
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_smallbuttoncenter86.setBounds(new Rectangle(34,197,46,19));
    ...
    bcomp_fc95 = new bcomp_fc(session);
    bcomp_fc95.setBounds(new Rectangle(256,436,62,82));
    bcomp_fc95.setShadow(1);
    localPanel.add(bcomp_fc95, new Proportion(bcomp_fc95.getBounds(), dsize));
    pwr_mbup96 = new pwr_mbup(session);
    pwr_mbup96.setBounds(new Rectangle(347,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc95.dd.setDynType(1);
    bcomp_fc95.dd.setActionType(66);
    bcomp_fc95.dd.setAccess(65535);
    bcomp_fc95.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc95.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc95.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -9}, new int[] { 8, 10, 13,21}, 4),
    ...
    new Polygon( new int[] { 6, 7, -9, -9}, new int[] { 40, 36, 21,21}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -9}, new int[] { 46, 46, 54,21}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915385, -9}, new int[] { 10, 14, -1219915354,21}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893310, -9}, new int[] { 14, 19, 144126445,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 8, 8}, new int[] { 12, 15, 116,51}, 4),
