...
public class JopcBasefcppo3fanaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim275.setBounds(new Rectangle(115,95,64,44));
    ...
    pwr_rod76.setBounds(new Rectangle(130,482,39,10));
    ...
    pwr_fananim77.setBounds(new Rectangle(118,442,19,91));
    ...
    pwr_mbup80.setBounds(new Rectangle(347,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222585, -9}, new int[] { 12, 15, -1220222534,41}, 4),
