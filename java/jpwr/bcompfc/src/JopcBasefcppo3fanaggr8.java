...
public class JopcBasefcppo3fanaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup80;
  public JopcBasefcppo3fanaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr8");
    ...
    pwr_fananim275.setBounds(new Rectangle(116,96,62,42));
    ...
    pwr_rod76.setBounds(new Rectangle(131,483,37,8));
    ...
    pwr_fananim77.setBounds(new Rectangle(119,443,17,89));
    ...
    pwr_mbup80.setBounds(new Rectangle(348,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915385, -9}, new int[] { 12, 15, -1219915334,41}, 4),
