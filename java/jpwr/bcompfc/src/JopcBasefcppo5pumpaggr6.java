...
public class JopcBasefcppo5pumpaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcBasefcppo5pumpaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr6");
    ...
    bcomp_fc88.setBounds(new Rectangle(255,335,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -16}, new int[] { 8, 8, 11,5}, 4),
    ...
    new Polygon( new int[] { 6, 7, 72, -16}, new int[] { 40, 36, -1220222570,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -16}, new int[] { 46, 46, 54,5}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222592, -16}, new int[] { 10, 12, -1220222570,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222592, -16}, new int[] { 14, 17, -1220222570,5}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 1, 1}, new int[] { 12, 15, 516,35}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 1, 1}, new int[] { 12, 15, 476,35}, 4),
