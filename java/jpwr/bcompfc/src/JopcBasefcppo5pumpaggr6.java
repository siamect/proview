...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 144, -16}, new int[] { 40, 36, -1219980906,5}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980928, -16}, new int[] { 10, 12, -1219980906,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980928, -16}, new int[] { 14, 17, -1219980906,5}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 1, 1}, new int[] { 12, 15, 35,35}, 4),
