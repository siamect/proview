...
public class JopcBasefcppo5pumpaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc88.setBounds(new Rectangle(256,336,62,82));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 136, -16}, new int[] { 40, 36, -1219915370,5}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915392, -16}, new int[] { 10, 12, -1219915370,5}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915392, -16}, new int[] { 14, 17, -1219915370,5}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915374, 1}, new int[] { 12, 15, -1219915340,35}, 4),
