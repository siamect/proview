...
public class JopcBasefcppo3motoraggr1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,342,16,17));
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,296,16,17));
    ...
    pwr_valuelong14.setBounds(new Rectangle(16,46,369,22));
    ...
    pwr_indsquare15.setBounds(new Rectangle(161,479,16,17));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,642,48,20));
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,641,336,23));
    ...
    pwr_manswitch336.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_contactor237.setBounds(new Rectangle(267,332,38,38));
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(196,468,38,39));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(301,229,72,18));
    ...
    pwr_valuesmall44.setBounds(new Rectangle(301,248,72,18));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(123,172,61,21));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(123,196,61,21));
    ...
    grp169_60.setBounds(new Rectangle(34,248,37,18));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(239,173,36,21));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(239,197,36,21));
    ...
    pwr_smallbuttoncenter68.setBounds(new Rectangle(36,410,57,23));
    ...
    pwr_valuemedium69.setBounds(new Rectangle(306,551,51,17));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(356,554,20,14));
    ...
    pwr_valueinputmediumrd73.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_74.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_74, new Proportion(grp210_74.getBounds(), dsize));
    grp212_75 = new Grp212_(session);
    grp212_75.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_indsquare77.setBounds(new Rectangle(357,199,16,17));
    ...
    pwr_mbsimulate78.setBounds(new Rectangle(365,24,19,20));
    ...
    pwr_rodcouplinganim79.setBounds(new Rectangle(152,568,12,22));
    ...
    pwr_motorman80.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare81.setBounds(new Rectangle(161,516,16,17));
    ...
    pwr_smallbuttoncenter84.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_mbup86.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980916, -4}, new int[] { 12, 15, -1219980882,29}, 4),
