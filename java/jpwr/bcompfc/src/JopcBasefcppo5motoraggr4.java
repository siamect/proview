...
public class JopcBasefcppo5motoraggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5motoraggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr4");
    ...
    pwr_indsquare9.setBounds(new Rectangle(162,434,14,15));
    ...
    pwr_safetyswitch30.setBounds(new Rectangle(197,423,36,37));
    ...
    pwr_motor243.setBounds(new Rectangle(159,496,96,72));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(307,506,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,524,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(357,509,18,12));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(307,542,49,15));
    ...
    pwr_indsquare75.setBounds(new Rectangle(162,471,14,14));
    ...
    bcomp_fc81.setBounds(new Rectangle(256,336,62,82));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915335, 40}, new int[] { 12, 15, -1219915319,56}, 4),
