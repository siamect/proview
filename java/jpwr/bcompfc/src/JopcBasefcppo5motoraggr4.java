...
public class JopcBasefcppo5motoraggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare9.setBounds(new Rectangle(161,433,16,17));
    ...
    pwr_safetyswitch30.setBounds(new Rectangle(196,422,38,39));
    ...
    pwr_motor243.setBounds(new Rectangle(158,495,98,74));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(306,505,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,523,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(356,508,20,14));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(306,541,51,17));
    ...
    pwr_indsquare75.setBounds(new Rectangle(161,470,16,16));
    ...
    bcomp_fc81.setBounds(new Rectangle(255,335,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980871, 40}, new int[] { 12, 15, -1219980855,56}, 4),
