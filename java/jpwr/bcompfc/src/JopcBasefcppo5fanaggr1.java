...
public class JopcBasefcppo5fanaggr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc93;
  pwr_mbup	pwr_mbup94;
  public JopcBasefcppo5fanaggr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr1");
    ...
    pwr_valuesmall38.setBounds(new Rectangle(302,230,70,16));
    ...
    pwr_valuemedium66.setBorderColor(32);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim282.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim282.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim282.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim282.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim84.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim84.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915397, -21}, new int[] { 12, 15, -1219915352,23}, 4),
