...
public class JopcBasefcppo5fanaggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc87;
  pwr_safetyswitch	pwr_safetyswitch88;
  pwr_mbup	pwr_mbup89;
  public JopcBasefcppo5fanaggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr15");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,653,48,20));
    ...
    pwr_motor243.setBounds(new Rectangle(160,552,98,74));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,402,16,17));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(36,421,57,23));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,562,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,580,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(358,565,20,14));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(308,598,51,17));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,527,16,16));
    ...
    pwr_rod77.setBounds(new Rectangle(131,584,39,10));
    ...
    pwr_fananim78.setBounds(new Rectangle(119,544,19,91));
    pwr_fananim78.setShadow(1);
    localPanel.add(pwr_fananim78, new Proportion(pwr_fananim78.getBounds(), dsize));
    grp230_79 = new Grp230_(session);
    grp230_79.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp230_79, new Proportion(grp230_79.getBounds(), dsize));
    ...
    bcomp_fc87.setBounds(new Rectangle(255,392,64,84));
    bcomp_fc87.setShadow(1);
    localPanel.add(bcomp_fc87, new Proportion(bcomp_fc87.getBounds(), dsize));
    pwr_safetyswitch88 = new pwr_safetyswitch(session);
    pwr_safetyswitch88.setBounds(new Rectangle(268,488,38,39));
    pwr_safetyswitch88.setFillColor(32);
    pwr_safetyswitch88.setShadow(1);
    localPanel.add(pwr_safetyswitch88, new Proportion(pwr_safetyswitch88.getBounds(), dsize));
    pwr_mbup89 = new pwr_mbup(session);
    pwr_mbup89.setBounds(new Rectangle(346,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp230_79.dd.setDynType(129);
    grp230_79.dd.setActionType(0);
    grp230_79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_79.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_safetyswitch88.dd.setDynType(32769);
    pwr_safetyswitch88.dd.setActionType(66);
    pwr_safetyswitch88.dd.setAccess(65535);
    pwr_safetyswitch88.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch88.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch88.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch88.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 511);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 415);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),363, 595);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 595);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 577);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 613);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 613);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980921, -9}, new int[] { 12, 15, -1219980858,53}, 4),
