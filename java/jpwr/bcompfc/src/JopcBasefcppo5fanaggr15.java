...
public class JopcBasefcppo5fanaggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,654,46,18));
    ...
    pwr_motor243.setBounds(new Rectangle(161,553,96,72));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,403,14,15));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(37,422,55,21));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(309,563,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,581,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(359,566,18,12));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(309,599,49,15));
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,528,14,14));
    ...
    pwr_rod77.setBounds(new Rectangle(132,585,37,8));
    ...
    pwr_fananim78.setBounds(new Rectangle(120,545,17,89));
    ...
    grp230_79.setBounds(new Rectangle(37,197,39,16));
    ...
    bcomp_fc87.setBounds(new Rectangle(256,393,62,82));
    ...
    pwr_safetyswitch88.setBounds(new Rectangle(269,489,36,37));
    ...
    pwr_mbup89.setBounds(new Rectangle(347,25,18,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915385, -9}, new int[] { 12, 15, -1219915322,53}, 4),
