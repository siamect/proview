...
public class JopcBasefcppo5fanaggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5fanaggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr9");
    ...
    pwr_fananim80.setBounds(new Rectangle(121,446,17,89));
    pwr_fananim80.setShadow(1);
    localPanel.add(pwr_fananim80, new Proportion(pwr_fananim80.getBounds(), dsize));
    grp228_81 = new Grp228_(session);
    grp228_81.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp228_81, new Proportion(grp228_81.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim278.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim278.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim278.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim278.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim80.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim80.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim80.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim80.dd, "open graph/class/inst=$object.Fan")
      });
    grp228_81.dd.setDynType(129);
    grp228_81.dd.setActionType(0);
    grp228_81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_81.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(3.00019F, 22F, 404.413F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 3.00019F,44.4305F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        3.00019F,22F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915359, 16}, new int[] { 12, 15, -1219915331,44}, 4),
