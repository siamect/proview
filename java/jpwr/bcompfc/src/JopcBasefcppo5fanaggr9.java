...
public class JopcBasefcppo5fanaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim278.setBounds(new Rectangle(119,95,64,44));
    ...
    pwr_rod79.setBounds(new Rectangle(132,485,39,10));
    ...
    pwr_fananim80.setBounds(new Rectangle(120,445,19,91));
    ...
    grp228_81.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980895, 16}, new int[] { 12, 15, -1219980867,44}, 4),
