...
public class JopcBasefcppo3fanaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare65.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_indsquare67.setBounds(new Rectangle(161,422,16,17));
    ...
    pwr_rod71.setBounds(new Rectangle(129,479,39,10));
    ...
    pwr_fananim72.setBounds(new Rectangle(117,439,19,91));
    ...
    grp227_73.setBounds(new Rectangle(35,196,41,18));
    ...
    pwr_smallbuttoncenter74.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_mbup77.setBounds(new Rectangle(347,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980855, 56}, new int[] { 12, 15, -1219980881,30}, 4),
