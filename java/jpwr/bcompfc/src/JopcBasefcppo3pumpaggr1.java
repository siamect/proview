...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 11, 16}, new int[] { 8, 10, 13,21}, 4),
    ...
    new Polygon( new int[] { 6, 11, 11, 16}, new int[] { 46, 46, 54,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222559, 16}, new int[] { 10, 14, -1220222554,21}, 4),
    ...
    new Polygon( new int[] { 6, 11, 140885176, 16}, new int[] { 14, 19, -1092639658,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222541, 34}, new int[] { 12, 15, -1220222524,51}, 4),
