...
public class JopcBasefcppo3pumpaggr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch335;
  pwr_contactor2	pwr_contactor236;
  pwr_safetyswitch	pwr_safetyswitch37;
  ...
  pwr_valueinputmediumrd	pwr_valueinputmediumrd72;
  Grp210_	grp210_73;
  Grp212_	grp212_74;
  ...
  Grp221_	grp221_79;
  pwr_pumpanim2	pwr_pumpanim281;
  pwr_pump3	pwr_pump382;
  pwr_rodcouplinganim	pwr_rodcouplinganim83;
  Grp225_	grp225_84;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter85;
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo3pumpaggr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr1");
    pwr_indsquare9 = new pwr_indsquare(session);
    pwr_indsquare9.setBounds(new Rectangle(162,343,14,15));
    ...
    pwr_indsquare11.setBounds(new Rectangle(162,297,14,15));
    ...
    pwr_valuelong13.setBounds(new Rectangle(17,47,367,20));
    pwr_valuelong13.setFillColor(31);
    pwr_valuelong13.setBorderColor(32);
    localPanel.add(pwr_valuelong13, new Proportion(pwr_valuelong13.getBounds(), dsize));
    pwr_indsquare14 = new pwr_indsquare(session);
    pwr_indsquare14.setBounds(new Rectangle(162,480,14,15));
    ...
    pwr_mbnote28.setBounds(new Rectangle(36,25,17,18));
    ...
    pwr_valuelong30.setBounds(new Rectangle(17,69,367,20));
    pwr_valuelong30.setFillColor(31);
    pwr_valuelong30.setBorderColor(32);
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,643,45,18));
    pwr_smallbuttoncenter31.setFillColor(102);
    pwr_smallbuttoncenter31.setBorderColor(37);
    ...
    pwr_manswitch335 = new pwr_manswitch3(session);
    pwr_manswitch335.setBounds(new Rectangle(268,285,36,36));
    pwr_manswitch335.setFillColor(32);
    pwr_manswitch335.setShadow(1);
    localPanel.add(pwr_manswitch335, new Proportion(pwr_manswitch335.getBounds(), dsize));
    pwr_contactor236 = new pwr_contactor2(session);
    pwr_contactor236.setBounds(new Rectangle(268,333,36,36));
    pwr_contactor236.setFillColor(32);
    pwr_contactor236.setShadow(1);
    localPanel.add(pwr_contactor236, new Proportion(pwr_contactor236.getBounds(), dsize));
    pwr_safetyswitch37 = new pwr_safetyswitch(session);
    pwr_safetyswitch37.setBounds(new Rectangle(197,469,36,37));
    pwr_safetyswitch37.setFillColor(32);
    pwr_safetyswitch37.setShadow(1);
    localPanel.add(pwr_safetyswitch37, new Proportion(pwr_safetyswitch37.getBounds(), dsize));
    pwr_indsquare39 = new pwr_indsquare(session);
    pwr_indsquare39.setBounds(new Rectangle(349,118,14,15));
    ...
    pwr_valuesmall42.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(302,249,70,16));
    ...
    pwr_motor250.setBounds(new Rectangle(159,542,96,72));
    localPanel.add(pwr_motor250, new Proportion(pwr_motor250.getBounds(), dsize));
    bcomp_fc51 = new bcomp_fc(session);
    bcomp_fc51.setBounds(new Rectangle(256,382,62,82));
    bcomp_fc51.setShadow(1);
    localPanel.add(bcomp_fc51, new Proportion(bcomp_fc51.getBounds(), dsize));
    pwr_smallbuttoncenter52 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter52.setBounds(new Rectangle(34,172,45,19));
    ...
    pwr_indround53.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround54.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround57.setBounds(new Rectangle(86,248,16,15));
    ...
    pwr_indround58.setBounds(new Rectangle(193,174,16,15));
    ...
    grp169_59 = new Grp169_(session);
    grp169_59.setBounds(new Rectangle(35,249,35,16));
    localPanel.add(grp169_59, new Proportion(grp169_59.getBounds(), dsize));
    pwr_smallbuttoncenter60 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter60.setBounds(new Rectangle(240,174,34,19));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(240,198,34,19));
    ...
    pwr_indsquare62.setBounds(new Rectangle(162,392,14,14));
    ...
    pwr_indround64.setBounds(new Rectangle(286,174,15,16));
    ...
    pwr_smallbuttoncenter67.setBounds(new Rectangle(37,411,55,21));
    pwr_smallbuttoncenter67.setFillColor(32);
    pwr_smallbuttoncenter67.setShadow(1);
    ...
    pwr_valuemedium69.setBounds(new Rectangle(357,555,18,12));
    pwr_valuemedium69.setFillColor(31);
    pwr_valuemedium69.setBorderColor(31);
    localPanel.add(pwr_valuemedium69, new Proportion(pwr_valuemedium69.getBounds(), dsize));
    pwr_valueinputmediumrd72 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd72.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd72.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd72, new Proportion(pwr_valueinputmediumrd72.getBounds(), dsize));
    grp210_73 = new Grp210_(session);
    grp210_73.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_73, new Proportion(grp210_73.getBounds(), dsize));
    grp212_74 = new Grp212_(session);
    grp212_74.setBounds(new Rectangle(199,247,26,18));
    grp212_74.setFillColor(31);
    grp212_74.setBorderColor(31);
    localPanel.add(grp212_74, new Proportion(grp212_74.getBounds(), dsize));
    pwr_indsquare76 = new pwr_indsquare(session);
    pwr_indsquare76.setBounds(new Rectangle(358,200,14,15));
    ...
    grp221_79 = new Grp221_(session);
    grp221_79.setBounds(new Rectangle(35,516,38,15));
    localPanel.add(grp221_79, new Proportion(grp221_79.getBounds(), dsize));
    pwr_pumpanim281 = new pwr_pumpanim2(session);
    pwr_pumpanim281.setBounds(new Rectangle(120,96,62,42));
    pwr_pumpanim281.setShadow(1);
    pwr_pumpanim281.setGradient(12);
    localPanel.add(pwr_pumpanim281, new Proportion(pwr_pumpanim281.getBounds(), dsize));
    pwr_pump382 = new pwr_pump3(session);
    pwr_pump382.setBounds(new Rectangle(76,543,82,72));
    pwr_pump382.setColorTone(7);
    localPanel.add(pwr_pump382, new Proportion(pwr_pump382.getBounds(), dsize));
    pwr_rodcouplinganim83 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim83.setBounds(new Rectangle(153,569,10,20));
    localPanel.add(pwr_rodcouplinganim83, new Proportion(pwr_rodcouplinganim83.getBounds(), dsize));
    grp225_84 = new Grp225_(session);
    grp225_84.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp225_84, new Proportion(grp225_84.getBounds(), dsize));
    pwr_smallbuttoncenter85 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter85.setBounds(new Rectangle(34,197,45,19));
    pwr_smallbuttoncenter85.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter85, new Proportion(pwr_smallbuttoncenter85.getBounds(), dsize));
    ...
    pwr_indsquare9.dd.setDynType(13);
    pwr_indsquare9.dd.setActionType(2);
    pwr_indsquare9.dd.setAccess(65532);
    pwr_indsquare9.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare9.dd, "$object.Contactor.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare9.dd, "$object.Contactor.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare9.dd, "$object.Contactor.Feedback")
      });
    ...
    pwr_indsquare11.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare11.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean",176)
      ,new GeDynPopupMenu(pwr_indsquare11.dd, "$object.CircuitBreaker.NotTripped")
      });
    ...
    pwr_indsquare14.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare14.dd, "$object.SafetySwitch.On.ActualValue##Boolean",114)
      ,new GeDynPopupMenu(pwr_indsquare14.dd, "$object.SafetySwitch.On")
      });
    ...
    pwr_valuelong30.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong30.dd, "$object.Specification##String80","%s")
      });
    pwr_smallbuttoncenter31.dd.setDynType(128);
    pwr_smallbuttoncenter31.dd.setActionType(64);
    pwr_smallbuttoncenter31.dd.setAccess(65532);
    pwr_smallbuttoncenter31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter31.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter31.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter31.setAnnot1("Note !");
    ...
    pwr_manswitch335.dd.setDynType(32769);
    pwr_manswitch335.dd.setActionType(66);
    pwr_manswitch335.dd.setAccess(65535);
    pwr_manswitch335.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch335.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch335.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch335.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    ...
    pwr_contactor236.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor236.dd, "$object.Contactor.IndFeedback##Boolean")
    ...
    pwr_safetyswitch37.dd.setDynType(32769);
    pwr_safetyswitch37.dd.setActionType(66);
    pwr_safetyswitch37.dd.setAccess(65535);
    pwr_safetyswitch37.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch37.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch37.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch37.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.Contactor.Order")
      }),
    new GeDyn(pwr_pulldownmenu247,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu247.dd, "$object.Contactor.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.Contactor.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
null,null,    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu249,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu249.dd, "open graph /class /inst=$object.Contactor")
      }),
    new GeDyn(pwr_pulldownmenu249,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu249.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
    new GeDyn(pwr_pulldownmenu249,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu249.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu249,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc51.dd.setDynType(1);
    bcomp_fc51.dd.setActionType(66);
    bcomp_fc51.dd.setAccess(65535);
    bcomp_fc51.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc51.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc51.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter52.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter52.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter52.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter52.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter52.setAnnot1("Man");
    pwr_indround53.dd.setDynType(133);
    pwr_indround53.dd.setActionType(0);
    pwr_indround53.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround53.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround53.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround54.dd.setDynType(133);
    pwr_indround54.dd.setActionType(0);
    pwr_indround54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround54.dd, "$object.Mode.ExternOrdHide##Boolean",0)
    ...
    pwr_smallbuttoncenter55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter55.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter55.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter55.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter55.dd, "$object.MOde.OpManStart##Boolean")
      });
    pwr_smallbuttoncenter55.setAnnot1("Start");
    ...
    pwr_smallbuttoncenter56.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter56.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter56.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter56.setAnnot1("Stop");
    pwr_indround57.dd.setDynType(133);
    pwr_indround57.dd.setActionType(0);
    pwr_indround57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround57.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround57.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    pwr_indround58.dd.setDynType(5);
    pwr_indround58.dd.setActionType(0);
    pwr_indround58.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround58.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    grp169_59.dd.setDynType(129);
    grp169_59.dd.setActionType(0);
    grp169_59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp169_59.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter60.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter60.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(pwr_smallbuttoncenter60.dd, "$object.OpPowerOn##Boolean")
      });
    pwr_smallbuttoncenter60.setAnnot1("On");
    ...
    pwr_smallbuttoncenter61.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter61.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(pwr_smallbuttoncenter61.dd, "$object.OpPowerOff##Boolean")
      });
    pwr_smallbuttoncenter61.setAnnot1("Off");
    pwr_indsquare62.dd.setDynType(117);
    pwr_indsquare62.dd.setActionType(2);
    pwr_indsquare62.dd.setAccess(65532);
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare62.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare62.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare62.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare62.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare62.dd, "$object.FrequencyConverter")
      });
    pwr_indround64.dd.setDynType(5);
    pwr_indround64.dd.setActionType(0);
    pwr_indround64.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround64.dd, "$object.Contactor.IndFeedback##Boolean",29)
      });
    pwr_smallbuttoncenter67.dd.setDynType(1);
    pwr_smallbuttoncenter67.dd.setActionType(4);
    pwr_smallbuttoncenter67.dd.setAccess(65532);
    pwr_smallbuttoncenter67.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter67.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter67.setAnnot1("Reset");
    pwr_valuemedium68.dd.setDynType(1024);
    ...
    pwr_valuemedium68.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium68.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium68.dd, "$object.FrequencyConverter.ActSpeed")
      });
    pwr_valuemedium69.dd.setDynType(1025);
    pwr_valuemedium69.dd.setActionType(0);
    pwr_valuemedium69.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium69.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd72.dd.setDynType(1153);
    pwr_valueinputmediumrd72.dd.setActionType(4096);
    pwr_valueinputmediumrd72.dd.setAccess(65532);
    pwr_valueinputmediumrd72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd72.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd72.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd72.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd72.setAnnot1Font(pwr_valueinputmediumrd72.annotFont.deriveFont((float)14));
    grp210_73.dd.setDynType(129);
    grp210_73.dd.setActionType(0);
    grp210_73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_73.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_74.dd.setDynType(129);
    grp212_74.dd.setActionType(0);
    grp212_74.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_74.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    ...
    pwr_mbsimulate77.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate77.dd, JopLang.transl("Open simulate graph"))
      });
    ...
    grp221_79.dd.setDynType(129);
    grp221_79.dd.setActionType(0);
    grp221_79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp221_79.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim281.dd.setDynType(66612);
    pwr_pumpanim281.dd.setActionType(0);
    pwr_pumpanim281.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim281.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim281.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim281.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim281.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim281.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump382.dd.setDynType(1);
    pwr_pump382.dd.setActionType(66);
    pwr_pump382.dd.setAccess(65532);
    pwr_pump382.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump382.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump382.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim83.dd.setDynType(65537);
    pwr_rodcouplinganim83.dd.setActionType(0);
    pwr_rodcouplinganim83.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim83.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    grp225_84.dd.setDynType(129);
    grp225_84.dd.setActionType(0);
    grp225_84.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp225_84.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter85.dd.setDynType(129);
    pwr_smallbuttoncenter85.dd.setActionType(6);
    pwr_smallbuttoncenter85.dd.setAccess(65532);
    pwr_smallbuttoncenter85.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter85.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter85.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter85.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter85.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter85.setAnnot1("Auto");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.00019F, 24F, 404.413F, 22.4305F),
    new Polygon( new int[] { 216, 216, 220, 270, 220, 216}, new int[] {472, 356, 352, 352, 352, 356}, 6),
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {546, 546, 542, 322, 542, 546}, 6),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.00019F,46.4305F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.00019F,24F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),36, 492);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Speed"),262, 566);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[17]);
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 15, 7, 8}, new int[] { 62, 65, 60,58}, 4),
    new Polygon( new int[] { 8, 7, 5, 6}, new int[] { 58, 60, 52,52}, 4),
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 52, 52, 10,8}, 4),
    new Polygon( new int[] { 6, 5, 11, 16}, new int[] { 8, 10, 13,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 9, 13, 10}, new int[] { 24, 24, 21,18}, 4),
    ...
    new Polygon( new int[] { 6, 9, 16, 16}, new int[] { 40, 36, 21,21}, 4),
    ...
    new Polygon( new int[] { 56, 55, 16, 14}, new int[] { 62, 59, 59,62}, 4),
    new Polygon( new int[] { 14, 16, 13, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 13, 11, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 11, 11, 6}, new int[] { 52, 52, 46,46}, 4),
    new Polygon( new int[] { 6, 11, 11, 16}, new int[] { 46, 46, 54,21}, 4),
    ...
    new Polygon( new int[] { 54, 56, 140857048, 16}, new int[] { 10, 14, 159629405,21}, 4),
    ...
    new Polygon( new int[] { 14, 16, 13, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 13, 11, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 11, 11, 6}, new int[] { 52, 52, 19,14}, 4),
    new Polygon( new int[] { 6, 11, 140885176, 16}, new int[] { 14, 19, 858993481,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915341, 34}, new int[] { 12, 15, -1219915324,51}, 4),
