...
public class JopcBasefcppo5fanaggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc84;
  pwr_mbup	pwr_mbup85;
  public JopcBasefcppo5fanaggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr17");
    ...
    bcomp_fc84 = new bcomp_fc(session);
    bcomp_fc84.setBounds(new Rectangle(256,392,62,82));
    bcomp_fc84.setShadow(1);
    localPanel.add(bcomp_fc84, new Proportion(bcomp_fc84.getBounds(), dsize));
    pwr_mbup85 = new pwr_mbup(session);
    pwr_mbup85.setBounds(new Rectangle(347,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare50.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare50.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare50.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare50.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare50.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare50.dd, "$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter54.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter54.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    ...
    pwr_valuemedium55.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium55.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium55.dd, "$object.FrequencyConverter.ActSpeed")
      });
    ...
    pwr_valuemedium56.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium56.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium56.dd, "$object.FrequencyConverter.ActTorque")
      });
    ...
    pwr_valuemedium58.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium58.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium65.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium65.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium65.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    ...
    pwr_fananim274.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim274.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim274.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim274.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim76.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim76.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
    ...
    bcomp_fc84.dd.setDynType(1);
    bcomp_fc84.dd.setActionType(66);
    bcomp_fc84.dd.setAccess(65535);
    bcomp_fc84.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc84.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc84.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915318, 57}, new int[] { 12, 15, -1219915355,20}, 4),
