...
public class JopcBasefcppo3fanaggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo3fanaggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr21");
    ...
    pwr_valuemedium56.setBounds(new Rectangle(359,514,18,12));
    ...
    pwr_indsquare65.setBounds(new Rectangle(162,476,14,14));
    ...
    pwr_rod69.setBounds(new Rectangle(133,533,37,8));
    ...
    pwr_fananim70.setBounds(new Rectangle(121,493,17,89));
    pwr_fananim70.setShadow(1);
    localPanel.add(pwr_fananim70, new Proportion(pwr_fananim70.getBounds(), dsize));
    grp229_71 = new Grp229_(session);
    grp229_71.setBounds(new Rectangle(36,197,39,16));
    localPanel.add(grp229_71, new Proportion(grp229_71.getBounds(), dsize));
    ...
    bcomp_fc77.setBounds(new Rectangle(256,341,62,82));
    ...
    pwr_safetyswitch78.setBounds(new Rectangle(269,437,36,37));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp229_71.dd.setDynType(129);
    grp229_71.dd.setActionType(0);
    grp229_71.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_71.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
