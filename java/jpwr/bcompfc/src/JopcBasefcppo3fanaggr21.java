...
public class JopcBasefcppo3fanaggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium56.setBounds(new Rectangle(358,513,20,14));
    ...
    pwr_indsquare65.setBounds(new Rectangle(161,475,16,16));
    ...
    pwr_rod69.setBounds(new Rectangle(132,532,39,10));
    ...
    pwr_fananim70.setBounds(new Rectangle(120,492,19,91));
    ...
    grp229_71.setBounds(new Rectangle(35,196,41,18));
    ...
    bcomp_fc77.setBounds(new Rectangle(255,340,64,84));
    ...
    pwr_safetyswitch78.setBounds(new Rectangle(268,436,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 17, 17}, new int[] { 12, 15, 57,54}, 4),
