...
public class JopcBasefcppo3motoraggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup75;
  public JopcBasefcppo3motoraggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr9");
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(155,481,10,20));
    ...
    grp225_73 = new Grp225_(session);
    grp225_73.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp225_73, new Proportion(grp225_73.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp225_73.dd.setDynType(129);
    grp225_73.dd.setActionType(0);
    grp225_73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp225_73.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915372, 3}, new int[] { 12, 15, -1219915334,41}, 4),
