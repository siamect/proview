...
public class JopcBasefcppo3motoraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(154,480,12,22));
    ...
    grp225_73.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980908, 3}, new int[] { 12, 15, -1219980870,41}, 4),
