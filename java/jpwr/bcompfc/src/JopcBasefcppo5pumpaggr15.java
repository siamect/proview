...
public class JopcBasefcppo5pumpaggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,526,14,15));
    ...
    grp223_74.setBounds(new Rectangle(35,525,38,16));
    ...
    pwr_pump377.setBounds(new Rectangle(78,552,82,72));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(155,578,10,20));
    ...
    bcomp_fc87.setBounds(new Rectangle(256,391,62,82));
    ...
    pwr_safetyswitch88.setBounds(new Rectangle(269,487,36,37));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219915399, -23}, new int[] { 10, 12, -1219915371,4}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140856048, -23}, new int[] { 14, 17, 161949652,4}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915381, -5}, new int[] { 12, 15, -1219915341,34}, 4),
