...
public class JopcBasefcppo5pumpaggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup89;
  public JopcBasefcppo5pumpaggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr15");
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,525,16,17));
    ...
    grp223_74.setBounds(new Rectangle(34,524,40,18));
    ...
    pwr_pump377.setBounds(new Rectangle(77,551,84,74));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(154,577,12,22));
    ...
    bcomp_fc87.setBounds(new Rectangle(255,390,64,84));
    ...
    pwr_safetyswitch88.setBounds(new Rectangle(268,486,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -23}, new int[] { 8, 8, 11,4}, 4),
    ...
    new Polygon( new int[] { 6, 7, -23, -23}, new int[] { 40, 36, 4,4}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -23}, new int[] { 46, 46, 54,4}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980935, -23}, new int[] { 10, 12, -1219980907,4}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893296, -23}, new int[] { 14, 17, 144132684,4}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980917, -5}, new int[] { 12, 15, -1219980877,34}, 4),
