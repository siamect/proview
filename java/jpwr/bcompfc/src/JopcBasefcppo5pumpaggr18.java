...
public class JopcBasefcppo5pumpaggr18 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup92;
  public JopcBasefcppo5pumpaggr18( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr18( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr18");
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,495,16,17));
    ...
    bcomp_fc90.setBounds(new Rectangle(255,389,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 4, 9, 5}, new int[] { 8, 8, 11,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222570, 5}, new int[] { 10, 12, -1220222568,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 152180077, 5}, new int[] { 14, 17, 144057495,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 23, 23}, new int[] { 12, 15, 40,37}, 4),
