...
public class JopcBasefcppo5pumpaggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,496,14,15));
    ...
    bcomp_fc90.setBounds(new Rectangle(256,390,62,82));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219915370, 5}, new int[] { 10, 12, -1219915368,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 17, 144126431,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915352, 23}, new int[] { 12, 15, -1219915338,37}, 4),
