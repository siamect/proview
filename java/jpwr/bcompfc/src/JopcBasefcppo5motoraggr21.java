...
public class JopcBasefcppo5motoraggr21 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5motoraggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr21");
    ...
    pwr_indsquare8.setBounds(new Rectangle(162,449,14,15));
    ...
    pwr_motor241.setBounds(new Rectangle(161,503,96,72));
    ...
    pwr_indsquare50.setBounds(new Rectangle(162,353,14,15));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(37,372,55,21));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(309,513,49,15));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(309,531,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(359,516,18,12));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(309,549,49,15));
    ...
    pwr_rodcouplinganim71.setBounds(new Rectangle(155,530,10,20));
    ...
    pwr_fuse380.setBounds(new Rectangle(281,299,13,35));
    ...
    bcomp_fc81.setBounds(new Rectangle(256,343,62,82));
    ...
    pwr_safetyswitch82.setBounds(new Rectangle(269,439,36,37));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 279.568F, 361.006F, 322.47F),
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {508, 508, 504, 476, 504, 508}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 461);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 365);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),363, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 527);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 563);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 563);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 2, 2}, new int[] { 12, 15, 96,55}, 4),
