...
public class JopcBasefcppo5motoraggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,448,16,17));
    ...
    pwr_motor241.setBounds(new Rectangle(160,502,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,352,16,17));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,371,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(308,512,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,530,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(358,515,20,14));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(308,548,51,17));
    ...
    pwr_rodcouplinganim71.setBounds(new Rectangle(154,529,12,22));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,477,16,17));
    ...
    pwr_fuse380.setBounds(new Rectangle(280,298,15,37));
    ...
    bcomp_fc81.setBounds(new Rectangle(255,342,64,84));
    ...
    pwr_safetyswitch82.setBounds(new Rectangle(268,438,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980909, 2}, new int[] { 12, 15, -1219980856,55}, 4),
