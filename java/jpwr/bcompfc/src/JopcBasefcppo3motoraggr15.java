...
public class JopcBasefcppo3motoraggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare11.setBounds(new Rectangle(162,351,14,14));
    ...
    pwr_indsquare14.setBounds(new Rectangle(162,497,14,15));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,652,46,19));
    ...
    pwr_valuelong32.setBounds(new Rectangle(61,651,334,21));
    ...
    pwr_manswitch335.setBounds(new Rectangle(268,339,36,36));
    ...
    pwr_safetyswitch36.setBounds(new Rectangle(269,487,36,37));
    ...
    pwr_indsquare59.setBounds(new Rectangle(162,401,14,14));
    ...
    pwr_smallbuttoncenter63.setBounds(new Rectangle(37,420,55,21));
    ...
    pwr_valuemedium64.setBounds(new Rectangle(309,561,49,15));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(359,564,18,12));
    ...
    pwr_indsquare72.setBounds(new Rectangle(311,176,14,15));
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(155,578,10,20));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,526,14,15));
    ...
    pwr_mbup81.setBounds(new Rectangle(347,25,18,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915384, -8}, new int[] { 12, 15, -1219915335,40}, 4),
