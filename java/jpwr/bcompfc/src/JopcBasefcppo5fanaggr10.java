...
public class JopcBasefcppo5fanaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim276.setBounds(new Rectangle(117,95,64,44));
    ...
    pwr_rod77.setBounds(new Rectangle(131,485,39,10));
    ...
    pwr_fananim78.setBounds(new Rectangle(119,445,19,91));
    ...
    grp229_79.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980945, -33}, new int[] { 12, 15, -1219980860,51}, 4),
