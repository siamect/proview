...
public class JopcBasefcppo5fanaggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_74;
  pwr_fananim2	pwr_fananim276;
  pwr_rod	pwr_rod77;
  pwr_fananim	pwr_fananim78;
  Grp229_	grp229_79;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter80;
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo5fanaggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr10");
    ...
    pwr_fananim276 = new pwr_fananim2(session);
    pwr_fananim276.setBounds(new Rectangle(118,96,62,42));
    pwr_fananim276.setBorderColor(29);
    pwr_fananim276.setTextColor(0);
    pwr_fananim276.setShadow(1);
    pwr_fananim276.setGradient(12);
    localPanel.add(pwr_fananim276, new Proportion(pwr_fananim276.getBounds(), dsize));
    pwr_rod77 = new pwr_rod(session);
    pwr_rod77.setBounds(new Rectangle(132,486,37,8));
    pwr_rod77.setShadow(1);
    localPanel.add(pwr_rod77, new Proportion(pwr_rod77.getBounds(), dsize));
    pwr_fananim78 = new pwr_fananim(session);
    pwr_fananim78.setBounds(new Rectangle(120,446,17,89));
    pwr_fananim78.setShadow(1);
    localPanel.add(pwr_fananim78, new Proportion(pwr_fananim78.getBounds(), dsize));
    grp229_79 = new Grp229_(session);
    grp229_79.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp229_79, new Proportion(grp229_79.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim276.dd.setDynType(66612);
    pwr_fananim276.dd.setActionType(0);
    pwr_fananim276.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim276.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim276.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim276.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim276.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim276.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim276.setAnnot1("L");
    pwr_rod77.dd.setDynType(1);
    pwr_rod77.dd.setActionType(0);
    pwr_fananim78.dd.setDynType(65537);
    pwr_fananim78.dd.setActionType(66);
    pwr_fananim78.dd.setAccess(65532);
    pwr_fananim78.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim78.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim78.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim78.dd, "open graph/class/inst=$object.Fan")
      });
    grp229_79.dd.setDynType(129);
    grp229_79.dd.setActionType(0);
    grp229_79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_79.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(3.37535F, 23.1001F, 404.413F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 3.37535F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        3.37535F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915409, -33}, new int[] { 12, 15, -1219915324,51}, 4),
