...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 142, 5}, new int[] { 40, 37, -1220222537,38}, 4),
    ...
    new Polygon( new int[] { 54, 56, 140859245, 5}, new int[] { 10, 14, 148762918,38}, 4),
    ...
    new Polygon( new int[] { 6, 9, 458791, 5}, new int[] { 14, 19, 393288,38}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222552, 23}, new int[] { 12, 15, -1220222507,68}, 4),
