...
public class JopcBasefcppo3pumpaggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup81;
  public JopcBasefcppo3pumpaggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr3");
    ...
    pwr_valuemedium58.setBounds(new Rectangle(358,509,20,14));
    ...
    pwr_indsquare67.setBounds(new Rectangle(161,471,16,16));
    ...
    grp223_68.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_pump371.setBounds(new Rectangle(77,497,84,74));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(154,523,12,22));
    ...
    pwr_manswitch378.setBounds(new Rectangle(267,284,38,38));
    ...
    bcomp_fc79.setBounds(new Rectangle(255,336,64,84));
    ...
    pwr_safetyswitch80.setBounds(new Rectangle(268,432,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 4, 9, 5}, new int[] { 8, 10, 13,38}, 4),
    ...
    new Polygon( new int[] { 6, 7, 5, 5}, new int[] { 40, 37, 38,38}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 5}, new int[] { 46, 46, 54,38}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980906, 5}, new int[] { 10, 14, -1219980873,38}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 19, 144132718,38}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980888, 23}, new int[] { 12, 15, -1219980843,68}, 4),
