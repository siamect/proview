...
public class JopcBasefcppo3pumpaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium58.setBounds(new Rectangle(359,510,18,12));
    ...
    pwr_indsquare67.setBounds(new Rectangle(162,472,14,14));
    ...
    grp223_68.setBounds(new Rectangle(35,471,38,16));
    ...
    pwr_pump371.setBounds(new Rectangle(78,498,82,72));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(155,524,10,20));
    ...
    pwr_manswitch378.setBounds(new Rectangle(268,285,36,36));
    ...
    bcomp_fc79.setBounds(new Rectangle(256,337,62,82));
    ...
    pwr_safetyswitch80.setBounds(new Rectangle(269,433,36,37));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 86, 5}, new int[] { 40, 37, -1219915337,38}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915370, 5}, new int[] { 10, 14, -1219915337,38}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915370, 5}, new int[] { 14, 19, -1219915337,38}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 23, 23}, new int[] { 12, 15, 549,68}, 4),
