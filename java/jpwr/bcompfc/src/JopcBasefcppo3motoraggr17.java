...
public class JopcBasefcppo3motoraggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch331;
  ...
  pwr_mbup	pwr_mbup77;
  public JopcBasefcppo3motoraggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr17");
    pwr_indsquare9 = new pwr_indsquare(session);
    pwr_indsquare9.setBounds(new Rectangle(162,352,14,15));
    ...
    pwr_manswitch331 = new pwr_manswitch3(session);
    pwr_manswitch331.setBounds(new Rectangle(268,340,36,36));
    pwr_manswitch331.setFillColor(32);
    pwr_manswitch331.setShadow(1);
    localPanel.add(pwr_manswitch331, new Proportion(pwr_manswitch331.getBounds(), dsize));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,401,14,14));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(37,420,55,21));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,513,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(357,516,18,12));
    ...
    pwr_indsquare67.setBounds(new Rectangle(312,174,14,15));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(153,530,10,20));
    ...
    pwr_manswitch331.dd.setDynType(32769);
    pwr_manswitch331.dd.setActionType(66);
    pwr_manswitch331.dd.setAccess(65535);
    pwr_manswitch331.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch331.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch331.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch331.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 158488157, -2}, new int[] { 12, 15, 144033846,70}, 4),
