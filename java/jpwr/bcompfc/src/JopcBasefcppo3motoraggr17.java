...
public class JopcBasefcppo3motoraggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare9.setBounds(new Rectangle(161,351,16,17));
    ...
    pwr_manswitch331.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(36,419,57,23));
    ...
    pwr_indsquare67.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(152,529,12,22));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857029, -2}, new int[] { 12, 15, 146327086,70}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 63, 63,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 63, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140857029, -2}, new int[] { 12, 15, 146045222,70}, 4),
