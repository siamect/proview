...
public class JopcBasefcppo5pumpaggr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc93;
  pwr_mbup	pwr_mbup94;
  public JopcBasefcppo5pumpaggr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr1");
    ...
    bcomp_fc93 = new bcomp_fc(session);
    bcomp_fc93.setBounds(new Rectangle(256,382,62,82));
    bcomp_fc93.setShadow(1);
    localPanel.add(bcomp_fc93, new Proportion(bcomp_fc93.getBounds(), dsize));
    pwr_mbup94 = new pwr_mbup(session);
    pwr_mbup94.setBounds(new Rectangle(347,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu245,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu245,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indround53.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround53.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter62.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter62.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    ...
    pwr_valuemedium63.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium63.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium63.dd, "$object.FrequencyConverter.ActSpeed")
      });
    ...
    pwr_valuemedium64.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium64.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium64.dd, "$object.FrequencyConverter.ActTorque")
      });
    ...
    pwr_valuemedium66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium66.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium73.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium73.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium73.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    ...
    pwr_pumpanim282.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim282.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim282.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim282.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_rodcouplinganim84.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim84.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    ...
    bcomp_fc93.dd.setDynType(1);
    bcomp_fc93.dd.setActionType(66);
    bcomp_fc93.dd.setAccess(65535);
    bcomp_fc93.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc93.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc93.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),361, 584);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 584);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 602);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 602);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 11, 14}, new int[] { 8, 10, 13,21}, 4),
    ...
    new Polygon( new int[] { 10, 13, 15, 14}, new int[] { 18, 21, 17,14}, 4),
    new Polygon( new int[] { 14, 15, 43, 44}, new int[] { 14, 17, 17,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, 71, 14}, new int[] { 40, 36, 159661005,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 11, 11, 14}, new int[] { 46, 46, 54,21}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915361, 14}, new int[] { 10, 14, -1219915354,21}, 4),
    ...
    new Polygon( new int[] { 6, 11, -1219915361, 14}, new int[] { 14, 19, -1219915354,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915343, 32}, new int[] { 12, 15, -1219915324,51}, 4),
