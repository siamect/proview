...
public class JopcBasefcppo3fanaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim267.setBounds(new Rectangle(116,96,62,42));
    ...
    pwr_rod68.setBounds(new Rectangle(133,436,37,8));
    ...
    pwr_fananim69.setBounds(new Rectangle(121,396,17,89));
    ...
    grp229_70.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_mbup73.setBounds(new Rectangle(348,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915373, 2}, new int[] { 12, 15, -1219915334,41}, 4),
