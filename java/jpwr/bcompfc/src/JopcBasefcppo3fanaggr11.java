...
public class JopcBasefcppo3fanaggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_65;
  pwr_fananim2	pwr_fananim267;
  pwr_rod	pwr_rod68;
  pwr_fananim	pwr_fananim69;
  Grp229_	grp229_70;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter71;
  pwr_mbup	pwr_mbup73;
  public JopcBasefcppo3fanaggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr11");
    ...
    pwr_fananim267 = new pwr_fananim2(session);
    pwr_fananim267.setBounds(new Rectangle(115,95,64,44));
    pwr_fananim267.setBorderColor(29);
    pwr_fananim267.setTextColor(0);
    pwr_fananim267.setShadow(1);
    pwr_fananim267.setGradient(12);
    localPanel.add(pwr_fananim267, new Proportion(pwr_fananim267.getBounds(), dsize));
    pwr_rod68 = new pwr_rod(session);
    pwr_rod68.setBounds(new Rectangle(132,435,39,10));
    pwr_rod68.setShadow(1);
    localPanel.add(pwr_rod68, new Proportion(pwr_rod68.getBounds(), dsize));
    pwr_fananim69 = new pwr_fananim(session);
    pwr_fananim69.setBounds(new Rectangle(120,395,19,91));
    pwr_fananim69.setShadow(1);
    localPanel.add(pwr_fananim69, new Proportion(pwr_fananim69.getBounds(), dsize));
    grp229_70 = new Grp229_(session);
    grp229_70.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp229_70, new Proportion(grp229_70.getBounds(), dsize));
    ...
    pwr_mbup73.setBounds(new Rectangle(347,24,19,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim267.dd.setDynType(66612);
    pwr_fananim267.dd.setActionType(0);
    pwr_fananim267.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim267.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim267.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim267.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim267.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim267.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim267.setAnnot1("L");
    pwr_rod68.dd.setDynType(1);
    pwr_rod68.dd.setActionType(0);
    pwr_fananim69.dd.setDynType(65537);
    pwr_fananim69.dd.setActionType(66);
    pwr_fananim69.dd.setAccess(65532);
    pwr_fananim69.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim69.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim69.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim69.dd, "open graph/class/inst=$object.Fan")
      });
    grp229_70.dd.setDynType(129);
    grp229_70.dd.setActionType(0);
    grp229_70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_70.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980909, 2}, new int[] { 12, 15, -1219980870,41}, 4),
