...
public class JopcBasefcppo5motoraggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup80;
  public JopcBasefcppo5motoraggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr5");
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(4,548,47,21));
    ...
    pwr_manswitch328.setFillColor(32);
    ...
    bcomp_fc42 = new bcomp_fc(session);
    bcomp_fc42.setBounds(new Rectangle(255,335,64,84));
    bcomp_fc42.setShadow(1);
    localPanel.add(bcomp_fc42, new Proportion(bcomp_fc42.getBounds(), dsize));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(152,474,12,22));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,422,16,17));
    ...
    grp221_75.setBounds(new Rectangle(34,421,40,17));
    localPanel.add(grp221_75, new Proportion(grp221_75.getBounds(), dsize));
    grp224_76 = new Grp224_(session);
    grp224_76.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp224_76, new Proportion(grp224_76.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc42.dd.setDynType(1);
    bcomp_fc42.dd.setActionType(66);
    bcomp_fc42.dd.setAccess(65535);
    bcomp_fc42.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc42.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc42.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    grp224_76.dd.setDynType(129);
    grp224_76.dd.setActionType(0);
    grp224_76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp224_76.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 35, 35}, new int[] { 12, 15, 459,18}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 35, 35}, new int[] { 12, 15, 75,18}, 4),
