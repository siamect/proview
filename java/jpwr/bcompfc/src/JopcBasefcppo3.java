...
public class JopcBasefcppo3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  JopBar	jopBar46;
  JopTrend	jopTrend47;
  pwr_framethin	pwr_framethin48;
  pwr_framethin	pwr_framethin49;
  JopBar	jopBar51;
  pwr_valuesmall	pwr_valuesmall52;
  pwr_valueinputreliefup	pwr_valueinputreliefup53;
  pwr_valueinputreliefup	pwr_valueinputreliefup54;
  pwr_indsquare	pwr_indsquare62;
  pwr_valuelong	pwr_valuelong63;
  pwr_mbsimulate	pwr_mbsimulate64;
  pwr_valuemedium	pwr_valuemedium65;
  pwr_valuemedium	pwr_valuemedium66;
  pwr_mbup	pwr_mbup67;
  public JopcBasefcppo3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_mbopenobject5.setBounds(new Rectangle(196,26,18,18));
    ...
    pwr_mbtrend6.setBounds(new Rectangle(57,26,18,18));
    ...
    pwr_mbfast7.setBounds(new Rectangle(77,26,17,18));
    ...
    pwr_mbphoto8.setBounds(new Rectangle(97,26,18,18));
    ...
    pwr_mbdatasheet9.setBounds(new Rectangle(116,26,18,18));
    ...
    pwr_mbopenplc10.setBounds(new Rectangle(216,26,18,18));
    ...
    pwr_mbcircuitdiagram11.setBounds(new Rectangle(236,26,18,18));
    ...
    pwr_mbrtnavigator12.setBounds(new Rectangle(176,26,18,18));
    ...
    pwr_mbhelpclass13.setBounds(new Rectangle(255,26,18,18));
    ...
    pwr_mbblockevents14.setBounds(new Rectangle(156,26,18,18));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(32,443,46,19));
    pwr_smallbuttoncenter18.setFillColor(102);
    ...
    pwr_valuelong20.setBounds(new Rectangle(89,443,334,21));
    ...
    pwr_indsquare28.setBounds(new Rectangle(487,66,14,15));
    ...
    pwr_indsquare36.setBounds(new Rectangle(487,124,14,14));
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(414,171,55,21));
    pwr_smallbuttoncenter45.setFillColor(32);
    pwr_smallbuttoncenter45.setShadow(1);
    localPanel.add(pwr_smallbuttoncenter45, new Proportion(pwr_smallbuttoncenter45.getBounds(), dsize));
    jopBar46 = new JopBar(session);
    jopBar46.setBounds(new Rectangle(252,252,13,145));
    jopBar46.setFillColor(29);
    jopBar46.setBorderColor(56);
    jopBar46.setFillColorBar(296);
    jopBar46.setBorderColorBar(291);
    jopBar46.setDrawFill(1);
    jopBar46.setDrawBorder(1);
    jopBar46.setBarBorderWidth(3);
    jopBar46.setLineWidth(1);
    jopBar46.setMinValue(0F);
    jopBar46.setMaxValue(100F);
    jopBar46.setRotate(0);
    localPanel.add(jopBar46, new Proportion(jopBar46.getBounds(), dsize));
    jopTrend47 = new JopTrend( session);
    jopTrend47.setBounds(new Rectangle(290,251,491,146));
    jopTrend47.setFillColor(59);
    jopTrend47.setBorderColor(57);
    jopTrend47.setBorderColorTrend1(291);
    jopTrend47.setBorderColorTrend2(172);
    jopTrend47.setFillColorTrend1(28);
    jopTrend47.setFillColorTrend2(9999);
    jopTrend47.setDrawFill(1);
    jopTrend47.setDrawBorder(1);
    jopTrend47.setTrendBorderWidth(1);
    jopTrend47.setLineWidth(1);
    jopTrend47.setMinValue1(0F);
    jopTrend47.setMaxValue1(100F);
    jopTrend47.setMinValue2(0F);
    jopTrend47.setMaxValue2(100F);
    jopTrend47.setNoOfPoints(200);
    jopTrend47.setHorizontalLines(4);
    jopTrend47.setVerticalLines(9);
    jopTrend47.setRotate(0);
    localPanel.add(jopTrend47, new Proportion(jopTrend47.getBounds(), dsize));
    pwr_framethin48 = new pwr_framethin(session);
    pwr_framethin48.setBounds(new Rectangle(281,244,508,176));
    pwr_framethin48.setFillColor(31);
    localPanel.add(pwr_framethin48, new Proportion(pwr_framethin48.getBounds(), dsize));
    pwr_framethin49 = new pwr_framethin(session);
    pwr_framethin49.setBounds(new Rectangle(227,245,43,160));
    pwr_framethin49.setFillColor(31);
    localPanel.add(pwr_framethin49, new Proportion(pwr_framethin49.getBounds(), dsize));
    jopBar51 = new JopBar(session);
    jopBar51.setBounds(new Rectangle(234,252,13,145));
    jopBar51.setFillColor(29);
    jopBar51.setBorderColor(56);
    jopBar51.setFillColorBar(177);
    jopBar51.setBorderColorBar(172);
    ...
    pwr_valuesmall52.setBounds(new Rectangle(180,266,38,16));
    pwr_valuesmall52.setFillColor(31);
    pwr_valuesmall52.setBorderColor(31);
    localPanel.add(pwr_valuesmall52, new Proportion(pwr_valuesmall52.getBounds(), dsize));
    pwr_valueinputreliefup53 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup53.setBounds(new Rectangle(179,245,40,17));
    pwr_valueinputreliefup53.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup53, new Proportion(pwr_valueinputreliefup53.getBounds(), dsize));
    pwr_valueinputreliefup54 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup54.setBounds(new Rectangle(179,389,40,17));
    pwr_valueinputreliefup54.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup54, new Proportion(pwr_valueinputreliefup54.getBounds(), dsize));
    pwr_indsquare62 = new pwr_indsquare(session);
    pwr_indsquare62.setBounds(new Rectangle(487,201,14,15));
    pwr_indsquare62.setFillColor(295);
    pwr_indsquare62.setShadow(1);
    localPanel.add(pwr_indsquare62, new Proportion(pwr_indsquare62.getBounds(), dsize));
    pwr_valuelong63 = new pwr_valuelong(session);
    pwr_valuelong63.setBounds(new Rectangle(513,199,273,20));
    pwr_valuelong63.setFillColor(31);
    pwr_valuelong63.setBorderColor(32);
    localPanel.add(pwr_valuelong63, new Proportion(pwr_valuelong63.getBounds(), dsize));
    pwr_mbsimulate64 = new pwr_mbsimulate(session);
    pwr_mbsimulate64.setBounds(new Rectangle(773,26,18,18));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(189,314,26,16));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(189,340,26,16));
    ...
    pwr_mbup67.setBounds(new Rectangle(754,26,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter45.dd.setDynType(1);
    pwr_smallbuttoncenter45.dd.setActionType(16);
    pwr_smallbuttoncenter45.dd.setAccess(65532);
    pwr_smallbuttoncenter45.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter45.dd, "$object.OpReset##Boolean")
      });
    pwr_smallbuttoncenter45.setAnnot1("Reset");
    jopBar46.setPwrAttribute("$object.RefSpeed.ActualValue##Float32");
    jopBar46.setMinValueAttr("$object.RefSpeed.PresMinLimit##Float32");
    jopBar46.setMaxValueAttr("$object.RefSpeed.PresMaxLimit##Float32");
    jopTrend47.setPwrAttribute1("$object.RefSpeed.ActualValue##Float32");
    jopTrend47.setPwrAttribute2("$object.ActSpeed.ActualValue##Float32");
    jopTrend47.setMinValueAttr1("$object.RefSpeed.PresMinLimit##Float32");
    jopTrend47.setMaxValueAttr1("$object.RefSpeed.PresMaxLimit##Float32");
    jopTrend47.setMinValueAttr2("$object.RefSpeed.PresMinLimit##Float32");
    jopTrend47.setMaxValueAttr2("$object.RefSpeed.PresMaxLimit##Float32");
    pwr_framethin48.dd.setDynType(1);
    pwr_framethin48.dd.setActionType(0);
    pwr_framethin49.dd.setDynType(1);
    pwr_framethin49.dd.setActionType(0);
    jopBar51.setPwrAttribute("$object.ActSpeed.ActualValue##Float32");
    ...
    pwr_valuesmall52.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall52.dd, "$object.RefSpeed.Unit##String8","%s")
      });
    pwr_valueinputreliefup53.dd.setDynType(1024);
    pwr_valueinputreliefup53.dd.setActionType(4096);
    pwr_valueinputreliefup53.dd.setAccess(22);
    pwr_valueinputreliefup53.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup53.dd, "$object.RefSpeed.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup53.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup53.setAnnot1Font(pwr_valueinputreliefup53.annotFont.deriveFont((float)11));
    pwr_valueinputreliefup54.dd.setDynType(1024);
    pwr_valueinputreliefup54.dd.setActionType(4096);
    pwr_valueinputreliefup54.dd.setAccess(22);
    pwr_valueinputreliefup54.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup54.dd, "$object.RefSpeed.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup54.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup54.setAnnot1Font(pwr_valueinputreliefup54.annotFont.deriveFont((float)11));
    pwr_indsquare62.dd.setDynType(33554432);
    pwr_indsquare62.dd.setActionType(0);
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynStatusColor(pwr_indsquare62.dd, "$object.IoStatus##Status",58)
      });
    pwr_valuelong63.dd.setDynType(1025);
    pwr_valuelong63.dd.setActionType(0);
    pwr_valuelong63.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong63.dd, "$object.IoStatus##Status","%1m")
      });
    ...
    pwr_valuemedium65.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium65.dd, "$object.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium66.dd, "$object.ActSpeed.Unit##String16","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 465;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.1001F, 794.567F, 22.4305F),
    new Rectangle2D.Float(18.9049F, 234F, 776.365F, 199.658F),
    new Polygon( new int[] { 19, 795, 794, 20, 20, 19}, new int[] { 234, 234, 235, 235, 433, 434}, 6), 
    new Polygon( new int[] { 795, 795, 794, 794, 20, 19}, new int[] { 434, 234, 235, 433, 433, 434}, 6), 
    new Rectangle2D.Float(398.113F, 50.2178F, 394.531F, 173.174F),
    new Polygon( new int[] { 398, 793, 792, 399, 399, 398}, new int[] { 50, 50, 51, 51, 223, 223}, 6), 
    new Polygon( new int[] { 793, 793, 792, 792, 399, 398}, new int[] { 223, 50, 51, 223, 223, 223}, 6), 
    new Rectangle2D.Float(152.905F, 154F, 10F, 1F),
    new Line2D.Float( 152.905F, 154F, 162.905F, 154F),
    new Line2D.Float( 152.905F, 154F, 162.905F, 154F),
    new Line2D.Float( 162.905F, 154F, 162.905F, 154F),
    new Rectangle2D.Float(23.9049F, 154F, 10F, 1F),
    new Line2D.Float( 23.9049F, 154F, 33.9049F, 154F),
    new Line2D.Float( 23.9049F, 154F, 33.9049F, 154F),
    new Line2D.Float( 23.9049F, 154F, 23.9049F, 154F),
    new Rectangle2D.Float(175.478F, 339.146F, 8F, 20F),
    new Rectangle2D.Float(175.478F, 311.918F, 8F, 20F),
    new Line2D.Float( 152.905F, 154F, 116.905F, 154F),
    new Line2D.Float( 152.905F, 154F, 116.905F, 154F),
    new Line2D.Float( 152.905F, 154F, 116.905F, 154F),
    new Line2D.Float( 32.9049F, 154F, 76.9049F, 154F),
    new Line2D.Float( 32.9049F, 154F, 76.9049F, 154F),
    new Line2D.Float( 32.9049F, 154F, 76.9049F, 154F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("0"),774, 412);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("100"),290, 412);
    {
