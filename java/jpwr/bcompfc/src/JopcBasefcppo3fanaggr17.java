...
public class JopcBasefcppo3fanaggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium56.setBounds(new Rectangle(356,516,20,14));
    ...
    pwr_indsquare65.setBounds(new Rectangle(161,478,16,17));
    ...
    pwr_rod69.setBounds(new Rectangle(129,535,39,10));
    ...
    pwr_fananim70.setBounds(new Rectangle(117,495,19,91));
    ...
    pwr_smallbuttoncenter72.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_manswitch377.setBounds(new Rectangle(267,340,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 57, 57}, new int[] { 12, 15, 136,63}, 4),
