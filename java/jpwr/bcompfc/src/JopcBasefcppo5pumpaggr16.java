...
public class JopcBasefcppo5pumpaggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc87;
  pwr_mbup	pwr_mbup88;
  public JopcBasefcppo5pumpaggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr16");
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -21}, new int[] { 8, 8, 11,2}, 4),
    ...
    new Polygon( new int[] { 6, 7, 147, -21}, new int[] { 40, 36, -1219915373,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -21}, new int[] { 46, 46, 54,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915397, -21}, new int[] { 10, 12, -1219915373,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915397, -21}, new int[] { 14, 17, -1219915373,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915379, -3}, new int[] { 12, 15, -1219915343,32}, 4),
