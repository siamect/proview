...
public class JopcBasefcppo5pumpaggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp223_72.setBounds(new Rectangle(34,475,40,17));
    ...
    bcomp_fc83.setBounds(new Rectangle(255,341,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 22, -2}, new int[] { 40, 36, 3,3}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980914, -2}, new int[] { 10, 12, -1219980908,3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893317, -2}, new int[] { 14, 17, 144132683,3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980896, 15}, new int[] { 12, 15, -1219980878,33}, 4),
