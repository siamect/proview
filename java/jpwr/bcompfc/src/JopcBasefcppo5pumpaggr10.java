...
public class JopcBasefcppo5pumpaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    bcomp_fc43.setBounds(new Rectangle(255,293,64,84));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,303,16,17));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(36,322,57,23));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,463,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,481,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(358,466,20,14));
    ...
    grp210_65.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(308,499,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_pumpanim276.setBounds(new Rectangle(119,95,64,44));
    ...
    pwr_pump377.setBounds(new Rectangle(77,454,84,74));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -1, -42}, new int[] { 40, 36, 140856074,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980954, -42}, new int[] { 10, 12, -1219980909,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980954, -42}, new int[] { 14, 17, -1219980909,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 161959079, -24}, new int[] { 12, 15, 144032832,32}, 4),
