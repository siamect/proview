...
public class JopcBasefcppo3motoraggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup77;
  public JopcBasefcppo3motoraggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr21");
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,449,14,15));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,604,45,19));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,603,334,21));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(269,439,36,37));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,353,14,15));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(37,372,55,21));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(309,513,49,15));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(155,530,10,20));
    localPanel.add(pwr_rodcouplinganim69, new Proportion(pwr_rodcouplinganim69.getBounds(), dsize));
    pwr_motorman70 = new pwr_motorman(session);
    pwr_motorman70.setBounds(new Rectangle(115,96,62,42));
    pwr_motorman70.setShadow(1);
    pwr_motorman70.setGradient(12);
    localPanel.add(pwr_motorman70, new Proportion(pwr_motorman70.getBounds(), dsize));
    pwr_indsquare71 = new pwr_indsquare(session);
    pwr_indsquare71.setBounds(new Rectangle(162,478,14,14));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman70.dd.setDynType(1077);
    pwr_motorman70.dd.setActionType(0);
    pwr_motorman70.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman70.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman70.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman70.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_motorman70.dd, "$object.Mode.IndMode##String8","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 460);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
