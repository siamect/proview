...
public class JopcBasefcppo3motoraggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,448,16,17));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,603,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,602,336,23));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(268,438,38,39));
    ...
    pwr_indsquare54.setBounds(new Rectangle(161,352,16,17));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(36,371,57,23));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(308,512,51,17));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(154,529,12,22));
    ...
    pwr_motorman70.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,477,16,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 20, 20}, new int[] { 12, 15, 89,32}, 4),
