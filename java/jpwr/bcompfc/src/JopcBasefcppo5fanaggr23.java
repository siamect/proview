...
public class JopcBasefcppo5fanaggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc80;
  pwr_mbup	pwr_mbup81;
  public JopcBasefcppo5fanaggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr23");
    ...
    pwr_indsquare69.setBounds(new Rectangle(162,427,14,14));
    ...
    pwr_rod73.setBounds(new Rectangle(133,484,37,8));
    ...
    pwr_fananim74.setBounds(new Rectangle(121,444,17,89));
    pwr_fananim74.setShadow(1);
    localPanel.add(pwr_fananim74, new Proportion(pwr_fananim74.getBounds(), dsize));
    grp230_75 = new Grp230_(session);
    grp230_75.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp230_75, new Proportion(grp230_75.getBounds(), dsize));
    ...
    bcomp_fc80.setBounds(new Rectangle(256,342,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp230_75.dd.setDynType(129);
    grp230_75.dd.setActionType(0);
    grp230_75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_75.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 92, 92}, new int[] { 12, 14, 14,12}, 4),
    new Polygon( new int[] { 92, 92, 95, 96}, new int[] { 12, 14, 15,14}, 4),
    ...
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 14,12}, 4),
    new Polygon( new int[] { 80, 81, -1219915373, 2}, new int[] { 12, 14, -1219915361,14}, 4),
