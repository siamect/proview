...
public class JopcBasefcppo5fanaggr23 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare69.setBounds(new Rectangle(161,426,16,16));
    ...
    grp223_70.setBounds(new Rectangle(34,425,40,18));
    ...
    pwr_rod73.setBounds(new Rectangle(132,483,39,10));
    ...
    pwr_fananim74.setBounds(new Rectangle(120,443,19,91));
    ...
    grp230_75.setBounds(new Rectangle(36,196,41,18));
    ...
    bcomp_fc80.setBounds(new Rectangle(255,341,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980909, 2}, new int[] { 12, 14, -1219980897,14}, 4),
