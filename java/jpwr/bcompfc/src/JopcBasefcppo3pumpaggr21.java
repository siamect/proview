...
public class JopcBasefcppo3pumpaggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputmediumrd	pwr_valueinputmediumrd59;
  Grp210_	grp210_60;
  Grp212_	grp212_61;
  pwr_indsquare	pwr_indsquare63;
  pwr_mbsimulate	pwr_mbsimulate64;
  pwr_indsquare	pwr_indsquare65;
  Grp223_	grp223_66;
  pwr_pumpanim2	pwr_pumpanim268;
  pwr_pump3	pwr_pump369;
  pwr_rodcouplinganim	pwr_rodcouplinganim70;
  Grp228_	grp228_71;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter72;
  pwr_fuse3	pwr_fuse376;
  bcomp_fc	bcomp_fc77;
  pwr_safetyswitch	pwr_safetyswitch78;
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo3pumpaggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr21");
    ...
    pwr_smallbuttoncenter25.setBorderColor(0);
    ...
    pwr_valuemedium56.setBounds(new Rectangle(359,515,18,12));
    pwr_valuemedium56.setFillColor(31);
    pwr_valuemedium56.setBorderColor(31);
    localPanel.add(pwr_valuemedium56, new Proportion(pwr_valuemedium56.getBounds(), dsize));
    pwr_valueinputmediumrd59 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd59.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd59.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd59, new Proportion(pwr_valueinputmediumrd59.getBounds(), dsize));
    grp210_60 = new Grp210_(session);
    grp210_60.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_60, new Proportion(grp210_60.getBounds(), dsize));
    grp212_61 = new Grp212_(session);
    grp212_61.setBounds(new Rectangle(199,247,26,18));
    grp212_61.setFillColor(31);
    grp212_61.setBorderColor(31);
    localPanel.add(grp212_61, new Proportion(grp212_61.getBounds(), dsize));
    pwr_indsquare63 = new pwr_indsquare(session);
    pwr_indsquare63.setBounds(new Rectangle(308,176,14,15));
    pwr_indsquare63.setFillColor(175);
    pwr_indsquare63.setShadow(1);
    localPanel.add(pwr_indsquare63, new Proportion(pwr_indsquare63.getBounds(), dsize));
    pwr_mbsimulate64 = new pwr_mbsimulate(session);
    pwr_mbsimulate64.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate64, new Proportion(pwr_mbsimulate64.getBounds(), dsize));
    pwr_indsquare65 = new pwr_indsquare(session);
    pwr_indsquare65.setBounds(new Rectangle(162,477,14,14));
    ...
    grp223_66 = new Grp223_(session);
    grp223_66.setBounds(new Rectangle(35,476,38,16));
    localPanel.add(grp223_66, new Proportion(grp223_66.getBounds(), dsize));
    pwr_pumpanim268 = new pwr_pumpanim2(session);
    pwr_pumpanim268.setBounds(new Rectangle(119,96,62,42));
    pwr_pumpanim268.setShadow(1);
    pwr_pumpanim268.setGradient(12);
    localPanel.add(pwr_pumpanim268, new Proportion(pwr_pumpanim268.getBounds(), dsize));
    pwr_pump369 = new pwr_pump3(session);
    pwr_pump369.setBounds(new Rectangle(78,503,82,72));
    pwr_pump369.setColorTone(7);
    localPanel.add(pwr_pump369, new Proportion(pwr_pump369.getBounds(), dsize));
    pwr_rodcouplinganim70 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim70.setBounds(new Rectangle(155,529,10,20));
    localPanel.add(pwr_rodcouplinganim70, new Proportion(pwr_rodcouplinganim70.getBounds(), dsize));
    grp228_71 = new Grp228_(session);
    grp228_71.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp228_71, new Proportion(grp228_71.getBounds(), dsize));
    pwr_smallbuttoncenter72 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter72.setBounds(new Rectangle(34,197,46,19));
    ...
    pwr_fuse376 = new pwr_fuse3(session);
    pwr_fuse376.setBounds(new Rectangle(281,297,13,35));
    pwr_fuse376.setRotate(-90);
    pwr_fuse376.setShadow(1);
    localPanel.add(pwr_fuse376, new Proportion(pwr_fuse376.getBounds(), dsize));
    bcomp_fc77 = new bcomp_fc(session);
    bcomp_fc77.setBounds(new Rectangle(256,342,62,82));
    bcomp_fc77.setShadow(1);
    localPanel.add(bcomp_fc77, new Proportion(bcomp_fc77.getBounds(), dsize));
    pwr_safetyswitch78 = new pwr_safetyswitch(session);
    pwr_safetyswitch78.setBounds(new Rectangle(269,438,36,37));
    pwr_safetyswitch78.setFillColor(32);
    pwr_safetyswitch78.setShadow(1);
    localPanel.add(pwr_safetyswitch78, new Proportion(pwr_safetyswitch78.getBounds(), dsize));
    pwr_mbup79 = new pwr_mbup(session);
    pwr_mbup79.setBounds(new Rectangle(347,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuemedium56.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium56.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd59.dd.setDynType(1153);
    pwr_valueinputmediumrd59.dd.setActionType(4096);
    pwr_valueinputmediumrd59.dd.setAccess(65532);
    pwr_valueinputmediumrd59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd59.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd59.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd59.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd59.setAnnot1Font(pwr_valueinputmediumrd59.annotFont.deriveFont((float)14));
    grp210_60.dd.setDynType(129);
    grp210_60.dd.setActionType(0);
    grp210_60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_60.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_61.dd.setDynType(129);
    grp212_61.dd.setActionType(0);
    grp212_61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_61.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_indsquare63.dd.setDynType(5);
    pwr_indsquare63.dd.setActionType(0);
    pwr_indsquare63.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare63.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate64.dd.setDynType(129);
    pwr_mbsimulate64.dd.setActionType(8256);
    pwr_mbsimulate64.dd.setAccess(65532);
    pwr_mbsimulate64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate64.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate64.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate64.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare65.dd.setDynType(176);
    pwr_indsquare65.dd.setActionType(2);
    pwr_indsquare65.dd.setAccess(65532);
    pwr_indsquare65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare65.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare65.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare65.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare65.dd, "$object.Motor")
      });
    grp223_66.dd.setDynType(129);
    grp223_66.dd.setActionType(0);
    grp223_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_66.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim268.dd.setDynType(66612);
    pwr_pumpanim268.dd.setActionType(0);
    pwr_pumpanim268.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim268.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim268.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim268.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim268.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim268.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump369.dd.setDynType(1);
    pwr_pump369.dd.setActionType(66);
    pwr_pump369.dd.setAccess(65532);
    pwr_pump369.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump369.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump369.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim70.dd.setDynType(65537);
    pwr_rodcouplinganim70.dd.setActionType(0);
    pwr_rodcouplinganim70.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim70.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    grp228_71.dd.setDynType(129);
    grp228_71.dd.setActionType(0);
    grp228_71.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_71.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter72.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter72.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter72.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter72.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter72.setAnnot1("Auto");
    pwr_fuse376.dd.setDynType(1);
    pwr_fuse376.dd.setActionType(0);
    bcomp_fc77.dd.setDynType(1);
    bcomp_fc77.dd.setActionType(66);
    bcomp_fc77.dd.setAccess(65535);
    bcomp_fc77.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc77.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc77.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    pwr_safetyswitch78.dd.setDynType(32769);
    pwr_safetyswitch78.dd.setActionType(66);
    pwr_safetyswitch78.dd.setAccess(65535);
    pwr_safetyswitch78.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch78.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch78.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch78.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -2}, new int[] { 8, 10, 13,39}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 7, 7, 6}, new int[] { 40, 37, 26,24}, 4),
    new Polygon( new int[] { 6, 7, 11, 10}, new int[] { 24, 26, 21,18}, 4),
    ...
    new Polygon( new int[] { 18, 18, 11, 12}, new int[] { 24, 25, 29,28}, 4),
    new Polygon( new int[] { 12, 11, 9, 10}, new int[] { 28, 29, 34,32}, 4),
    new Polygon( new int[] { 10, 9, 7, 6}, new int[] { 32, 34, 37,40}, 4),
    new Polygon( new int[] { 6, 7, 30, -2}, new int[] { 40, 37, -1219915336,39}, 4),
    ...
    new Polygon( new int[] { 52, 53, 59, 56}, new int[] { 52, 55, 50,48}, 4),
    new Polygon( new int[] { 56, 59, 61, 58}, new int[] { 48, 50, 39,38}, 4),
    new Polygon( new int[] { 58, 61, 61, 58}, new int[] { 38, 39, 15,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -2}, new int[] { 46, 46, 54,39}, 4),
    new Polygon( new int[] { 54, 54, 52, 50, 18, 10, 6, 6, 10, 18, 52, 56, 58, 58, 54}, new int[] {10, 38, 44, 46, 46, 44, 42, 44, 50, 52, 52, 48, 38, 10, 10}, 15),
    new Polygon( new int[] { 54, 56, 56, 54}, new int[] { 10, 14, 39,38}, 4),
    new Polygon( new int[] { 54, 56, 54, 52}, new int[] { 38, 39, 45,44}, 4),
    ...
    new Polygon( new int[] { 56, 54, 56, 58}, new int[] { 48, 47, 39,38}, 4),
    new Polygon( new int[] { 58, 56, 56, 58}, new int[] { 38, 39, 14,10}, 4),
    new Polygon( new int[] { 58, 56, 56, 54}, new int[] { 10, 14, 14,10}, 4),
    new Polygon( new int[] { 54, 56, -1219915378, -2}, new int[] { 10, 14, -1219915336,39}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915378, -2}, new int[] { 14, 19, -1219915336,39}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915360, 15}, new int[] { 12, 15, -1219915306,69}, 4),
