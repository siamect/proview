...
public class JopcBasefcppo3pumpaggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium56.setBounds(new Rectangle(358,514,20,14));
    ...
    pwr_valueinputmediumrd59.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_60.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_60, new Proportion(grp210_60.getBounds(), dsize));
    grp212_61 = new Grp212_(session);
    grp212_61.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_indsquare63.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_pump369.setBounds(new Rectangle(77,502,84,74));
    ...
    pwr_smallbuttoncenter72.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_fuse376.setBounds(new Rectangle(280,296,15,37));
    ...
    bcomp_fc77.setBounds(new Rectangle(255,341,64,84));
    ...
    pwr_safetyswitch78.setBounds(new Rectangle(268,437,38,39));
    ...
    pwr_mbup79.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -2, -2147483648}, new int[] { 40, 37, 39,39}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980914, -2}, new int[] { 10, 14, -1219980872,39}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140892229, -2}, new int[] { 14, 19, 144132719,39}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 159368143, 15}, new int[] { 12, 15, 144032869,69}, 4),
