...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 10, 10}, new int[] { 40, 34, 24,24}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980901, 10}, new int[] { 10, 14, -1219980887,24}, 4),
    ...
    new Polygon( new int[] { 6, 10, 140898770, 10}, new int[] { 14, 19, 144132704,24}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857060, 28}, new int[] { 12, 15, 152295174,54}, 4),
