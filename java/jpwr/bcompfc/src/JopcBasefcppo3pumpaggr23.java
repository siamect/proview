...
public class JopcBasefcppo3pumpaggr23 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(4,553,47,21));
    ...
    pwr_valuelong24.setBounds(new Rectangle(60,552,336,23));
    ...
    pwr_motor239.setBounds(new Rectangle(160,452,98,74));
    ...
    pwr_smallbuttoncenter40.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(123,172,61,21));
    ...
    pwr_smallbuttoncenter44.setBounds(new Rectangle(123,196,61,21));
    ...
    pwr_indround45.setBounds(new Rectangle(85,247,18,17));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(36,371,57,23));
    ...
    pwr_valuemedium53.setBounds(new Rectangle(308,462,51,17));
    ...
    pwr_valuemedium54.setBounds(new Rectangle(358,465,20,14));
    ...
    grp210_58.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_58, new Proportion(grp210_58.getBounds(), dsize));
    grp212_59 = new Grp212_(session);
    grp212_59.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_indsquare61.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_pump367.setBounds(new Rectangle(77,453,84,74));
    ...
    pwr_smallbuttoncenter70.setBounds(new Rectangle(33,196,47,21));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 83, 10}, new int[] { 40, 34, -1220222551,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222565, 10}, new int[] { 10, 14, -1220222551,24}, 4),
    ...
    new Polygon( new int[] { 6, 10, 140893330, 10}, new int[] { 14, 19, 144130544,24}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 28, 28}, new int[] { 12, 15, 535,54}, 4),
