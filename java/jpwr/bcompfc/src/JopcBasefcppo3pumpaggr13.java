...
public class JopcBasefcppo3pumpaggr13 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor287;
  bcomp_fc	bcomp_fc88;
  pwr_safetyswitch	pwr_safetyswitch89;
  pwr_mbup	pwr_mbup90;
  public JopcBasefcppo3pumpaggr13( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr13( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr13");
    ...
    pwr_motor245.setBounds(new Rectangle(159,596,96,72));
    ...
    pwr_indsquare56.setBounds(new Rectangle(162,446,14,14));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(37,465,55,21));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(307,606,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(357,609,18,12));
    ...
    pwr_indsquare70.setBounds(new Rectangle(358,200,14,15));
    ...
    pwr_indsquare72.setBounds(new Rectangle(162,571,14,15));
    ...
    grp221_73.setBounds(new Rectangle(35,570,38,16));
    ...
    pwr_pump376.setBounds(new Rectangle(76,597,82,72));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(153,623,10,19));
    ...
    pwr_contactor287 = new pwr_contactor2(session);
    pwr_contactor287.setBounds(new Rectangle(268,387,36,36));
    pwr_contactor287.setFillColor(32);
    pwr_contactor287.setShadow(1);
    localPanel.add(pwr_contactor287, new Proportion(pwr_contactor287.getBounds(), dsize));
    bcomp_fc88 = new bcomp_fc(session);
    bcomp_fc88.setBounds(new Rectangle(256,436,62,82));
    bcomp_fc88.setShadow(1);
    localPanel.add(bcomp_fc88, new Proportion(bcomp_fc88.getBounds(), dsize));
    pwr_safetyswitch89 = new pwr_safetyswitch(session);
    pwr_safetyswitch89.setBounds(new Rectangle(197,523,36,37));
    pwr_safetyswitch89.setFillColor(32);
    pwr_safetyswitch89.setShadow(1);
    localPanel.add(pwr_safetyswitch89, new Proportion(pwr_safetyswitch89.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_contactor287.dd.setDynType(32769);
    pwr_contactor287.dd.setActionType(66);
    pwr_contactor287.dd.setAccess(65535);
    pwr_contactor287.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor287.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor287.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor287.dd, "open graph /class/instance=$object.Contactor")
      });
    bcomp_fc88.dd.setDynType(1);
    bcomp_fc88.dd.setActionType(66);
    bcomp_fc88.dd.setAccess(65535);
    bcomp_fc88.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc88.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc88.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    pwr_safetyswitch89.dd.setDynType(32769);
    pwr_safetyswitch89.dd.setActionType(66);
    pwr_safetyswitch89.dd.setAccess(65535);
    pwr_safetyswitch89.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch89.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch89.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch89.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -9}, new int[] { 8, 10, 13,27}, 4),
    ...
    new Polygon( new int[] { 6, 7, 1335, -9}, new int[] { 40, 36, -1219915348,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -9}, new int[] { 46, 46, 54,27}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915385, -9}, new int[] { 10, 14, -1219915348,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 26, -9}, new int[] { 14, 19, 28,27}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915367, 8}, new int[] { 12, 15, -1219915318,57}, 4),
