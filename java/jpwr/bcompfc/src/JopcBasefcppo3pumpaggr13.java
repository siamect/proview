...
public class JopcBasefcppo3pumpaggr13 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_motor245.setBounds(new Rectangle(158,595,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(161,445,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(36,464,57,23));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(306,605,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(356,608,20,14));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,570,16,17));
    ...
    grp221_73.setBounds(new Rectangle(34,569,40,18));
    ...
    pwr_pump376.setBounds(new Rectangle(75,596,84,74));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(152,622,12,21));
    ...
    pwr_contactor287.setBounds(new Rectangle(267,386,38,38));
    ...
    bcomp_fc88.setBounds(new Rectangle(255,435,64,84));
    ...
    pwr_safetyswitch89.setBounds(new Rectangle(196,522,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -9, -9}, new int[] { 40, 36, 27,27}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980921, -9}, new int[] { 10, 14, -1219980884,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 1114118, -9}, new int[] { 14, 19, 1507375,27}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980903, 8}, new int[] { 12, 15, -1219980854,57}, 4),
