...
public class JopcBasefcppo5fanaggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim281.setBounds(new Rectangle(112,95,64,44));
    ...
    pwr_rod82.setBounds(new Rectangle(132,573,39,10));
    ...
    pwr_fananim83.setBounds(new Rectangle(120,533,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980934, -22}, new int[] { 12, 15, -1219980870,41}, 4),
