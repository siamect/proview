...
public class JopcBasefcppo5fanaggr extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup94;
  public JopcBasefcppo5fanaggr( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr");
    ...
    pwr_fananim281.setBounds(new Rectangle(113,96,62,42));
    ...
    pwr_rod82.setBounds(new Rectangle(133,574,37,8));
    ...
    pwr_fananim83.setBounds(new Rectangle(121,534,17,89));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -22, -22}, new int[] { 12, 15, 41,41}, 4),
