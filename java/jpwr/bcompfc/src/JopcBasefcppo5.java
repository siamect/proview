...
public class JopcBasefcppo5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_frequencyconverter	pwr_frequencyconverter26;
  ...
  pwr_valuemedium	pwr_valuemedium41;
  pwr_valuemedium	pwr_valuemedium43;
  pwr_valuemedium	pwr_valuemedium45;
  pwr_valuemedium	pwr_valuemedium47;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter51;
  JopBar	jopBar52;
  JopTrend	jopTrend53;
  pwr_framethin	pwr_framethin54;
  pwr_framethin	pwr_framethin55;
  JopTrend	jopTrend57;
  JopBar	jopBar58;
  pwr_valuesmall	pwr_valuesmall59;
  ...
  pwr_valueinputreliefup	pwr_valueinputreliefup63;
  pwr_valueinputreliefup	pwr_valueinputreliefup65;
  pwr_valueinputreliefup	pwr_valueinputreliefup66;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5");
    pwr_indsquare2 = new pwr_indsquare(session);
    pwr_indsquare2.setBounds(new Rectangle(255,141,14,15));
    ...
    pwr_valuelong4.setBounds(new Rectangle(17,47,367,20));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(32,617,46,18));
    ...
    pwr_valuelong19.setBounds(new Rectangle(17,71,367,20));
    ...
    pwr_valuelong20.setBounds(new Rectangle(89,617,334,21));
    ...
    pwr_menubar221.setBounds(new Rectangle(1,1,796,22));
    ...
    pwr_pulldownmenu222.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(717,1,67,22));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(151,1,67,22));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(71,1,67,22));
    pwr_pulldownmenu225.setShadow(1);
    localPanel.add(pwr_pulldownmenu225, new Proportion(pwr_pulldownmenu225.getBounds(), dsize));
    pwr_frequencyconverter26 = new pwr_frequencyconverter(session);
    pwr_frequencyconverter26.setBounds(new Rectangle(75,133,42,42));
    pwr_frequencyconverter26.setShadow(1);
    localPanel.add(pwr_frequencyconverter26, new Proportion(pwr_frequencyconverter26.getBounds(), dsize));
    pwr_indsquare28 = new pwr_indsquare(session);
    pwr_indsquare28.setBounds(new Rectangle(487,65,14,15));
    ...
    pwr_indsquare30.setBounds(new Rectangle(487,85,14,15));
    ...
    pwr_indsquare32.setBounds(new Rectangle(487,174,14,15));
    pwr_indsquare32.setFillColor(176);
    ...
    pwr_indsquare34.setBounds(new Rectangle(487,105,14,15));
    pwr_indsquare34.setFillColor(176);
    ...
    pwr_indsquare36.setBounds(new Rectangle(487,124,14,15));
    pwr_indsquare36.setFillColor(114);
    ...
    pwr_indsquare38.setBounds(new Rectangle(487,144,14,15));
    pwr_indsquare38.setFillColor(114);
    pwr_indsquare38.setShadow(1);
    localPanel.add(pwr_indsquare38, new Proportion(pwr_indsquare38.getBounds(), dsize));
    pwr_valuemedium41 = new pwr_valuemedium(session);
    pwr_valuemedium41.setBounds(new Rectangle(110,338,62,22));
    pwr_valuemedium41.setShadow(1);
    localPanel.add(pwr_valuemedium41, new Proportion(pwr_valuemedium41.getBounds(), dsize));
    pwr_valuemedium43 = new pwr_valuemedium(session);
    pwr_valuemedium43.setBounds(new Rectangle(110,311,62,22));
    pwr_valuemedium43.setShadow(1);
    localPanel.add(pwr_valuemedium43, new Proportion(pwr_valuemedium43.getBounds(), dsize));
    pwr_valuemedium45 = new pwr_valuemedium(session);
    pwr_valuemedium45.setBounds(new Rectangle(110,477,62,22));
    pwr_valuemedium45.setShadow(1);
    localPanel.add(pwr_valuemedium45, new Proportion(pwr_valuemedium45.getBounds(), dsize));
    pwr_valuemedium47 = new pwr_valuemedium(session);
    pwr_valuemedium47.setBounds(new Rectangle(110,501,62,22));
    pwr_valuemedium47.setShadow(1);
    localPanel.add(pwr_valuemedium47, new Proportion(pwr_valuemedium47.getBounds(), dsize));
    pwr_smallbuttoncenter51 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter51.setBounds(new Rectangle(413,171,55,21));
    ...
    jopBar52 = new JopBar(session);
    jopBar52.setBounds(new Rectangle(251,252,13,145));
    jopBar52.setFillColor(29);
    jopBar52.setBorderColor(56);
    jopBar52.setFillColorBar(296);
    jopBar52.setBorderColorBar(291);
    jopBar52.setDrawFill(1);
    jopBar52.setDrawBorder(1);
    jopBar52.setBarBorderWidth(3);
    jopBar52.setLineWidth(1);
    jopBar52.setMinValue(0F);
    jopBar52.setMaxValue(100F);
    jopBar52.setRotate(0);
    localPanel.add(jopBar52, new Proportion(jopBar52.getBounds(), dsize));
    jopTrend53 = new JopTrend( session);
    jopTrend53.setBounds(new Rectangle(289,251,491,146));
    jopTrend53.setFillColor(59);
    jopTrend53.setBorderColor(57);
    jopTrend53.setBorderColorTrend1(291);
    jopTrend53.setBorderColorTrend2(172);
    jopTrend53.setFillColorTrend1(28);
    jopTrend53.setFillColorTrend2(9999);
    jopTrend53.setDrawFill(1);
    jopTrend53.setDrawBorder(1);
    jopTrend53.setTrendBorderWidth(1);
    jopTrend53.setLineWidth(1);
    jopTrend53.setMinValue1(0F);
    jopTrend53.setMaxValue1(100F);
    jopTrend53.setMinValue2(0F);
    jopTrend53.setMaxValue2(100F);
    jopTrend53.setNoOfPoints(200);
    jopTrend53.setHorizontalLines(4);
    jopTrend53.setVerticalLines(9);
    jopTrend53.setRotate(0);
    localPanel.add(jopTrend53, new Proportion(jopTrend53.getBounds(), dsize));
    pwr_framethin54 = new pwr_framethin(session);
    pwr_framethin54.setBounds(new Rectangle(280,244,508,344));
    pwr_framethin54.setFillColor(31);
    localPanel.add(pwr_framethin54, new Proportion(pwr_framethin54.getBounds(), dsize));
    pwr_framethin55 = new pwr_framethin(session);
    pwr_framethin55.setBounds(new Rectangle(226,245,43,160));
    pwr_framethin55.setFillColor(31);
    localPanel.add(pwr_framethin55, new Proportion(pwr_framethin55.getBounds(), dsize));
    jopTrend57 = new JopTrend( session);
    jopTrend57.setBounds(new Rectangle(289,416,491,146));
    jopTrend57.setFillColor(59);
    jopTrend57.setBorderColor(57);
    jopTrend57.setBorderColorTrend1(110);
    jopTrend57.setBorderColorTrend2(232);
    jopTrend57.setFillColorTrend1(28);
    jopTrend57.setFillColorTrend2(9999);
    jopTrend57.setDrawFill(1);
    jopTrend57.setDrawBorder(1);
    jopTrend57.setTrendBorderWidth(1);
    jopTrend57.setLineWidth(1);
    jopTrend57.setMinValue1(0F);
    jopTrend57.setMaxValue1(100F);
    jopTrend57.setMinValue2(0F);
    jopTrend57.setMaxValue2(100F);
    jopTrend57.setNoOfPoints(200);
    jopTrend57.setHorizontalLines(4);
    jopTrend57.setVerticalLines(9);
    jopTrend57.setRotate(0);
    localPanel.add(jopTrend57, new Proportion(jopTrend57.getBounds(), dsize));
    jopBar58 = new JopBar(session);
    jopBar58.setBounds(new Rectangle(233,252,13,145));
    jopBar58.setFillColor(29);
    jopBar58.setBorderColor(56);
    jopBar58.setFillColorBar(177);
    jopBar58.setBorderColorBar(172);
    jopBar58.setDrawFill(1);
    jopBar58.setDrawBorder(1);
    jopBar58.setBarBorderWidth(3);
    jopBar58.setLineWidth(1);
    jopBar58.setMinValue(0F);
    jopBar58.setMaxValue(100F);
    jopBar58.setRotate(0);
    localPanel.add(jopBar58, new Proportion(jopBar58.getBounds(), dsize));
    pwr_valuesmall59 = new pwr_valuesmall(session);
    pwr_valuesmall59.setBounds(new Rectangle(180,266,38,16));
    pwr_valuesmall59.setFillColor(31);
    pwr_valuesmall59.setBorderColor(31);
    localPanel.add(pwr_valuesmall59, new Proportion(pwr_valuesmall59.getBounds(), dsize));
    pwr_valueinputreliefup60 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup60.setBounds(new Rectangle(178,415,40,17));
    ...
    pwr_valueinputreliefup61.setBounds(new Rectangle(178,546,40,17));
    ...
    pwr_valueinputreliefup62.setBounds(new Rectangle(178,245,40,17));
    ...
    pwr_valueinputreliefup63 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup63.setBounds(new Rectangle(178,389,40,17));
    pwr_valueinputreliefup63.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup63, new Proportion(pwr_valueinputreliefup63.getBounds(), dsize));
    pwr_valueinputreliefup65 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup65.setBounds(new Rectangle(230,415,40,17));
    ...
    pwr_valueinputreliefup66 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup66.setBounds(new Rectangle(230,546,40,17));
    pwr_valueinputreliefup66.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup66, new Proportion(pwr_valueinputreliefup66.getBounds(), dsize));
    pwr_indsquare77 = new pwr_indsquare(session);
    pwr_indsquare77.setBounds(new Rectangle(487,201,14,15));
    ...
    pwr_valuelong78.setBounds(new Rectangle(513,199,273,20));
    pwr_valuelong78.setFillColor(31);
    pwr_valuelong78.setBorderColor(32);
    ...
    pwr_smallbuttoncenter79.setBounds(new Rectangle(679,25,56,19));
    pwr_smallbuttoncenter79.setFillColor(33);
    ...
    pwr_mbsimulate80.setBounds(new Rectangle(772,25,18,18));
    ...
    pwr_valuemedium81.setBounds(new Rectangle(188,314,26,16));
    pwr_valuemedium81.setFillColor(31);
    pwr_valuemedium81.setBorderColor(31);
    ...
    pwr_valuemedium82.setBounds(new Rectangle(188,340,26,16));
    pwr_valuemedium82.setFillColor(31);
    pwr_valuemedium82.setBorderColor(31);
    localPanel.add(pwr_valuemedium82, new Proportion(pwr_valuemedium82.getBounds(), dsize));
    pwr_mbup83 = new pwr_mbup(session);
    pwr_mbup83.setBounds(new Rectangle(752,25,18,18));
    localPanel.add(pwr_mbup83, new Proportion(pwr_mbup83.getBounds(), dsize));
    pwr_indsquare2.dd.setDynType(116);
    pwr_indsquare2.dd.setActionType(0);
    pwr_indsquare2.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare2.dd, "$object.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare2.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare2.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare2.dd, "$object.ReadyRemote##Boolean",29)
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu224.dd, new String[] {
        JopLang.transl("ActSpeed Ai"),JopLang.transl("ActTorque Ai"),JopLang.transl("ActCurrent Ai"),JopLang.transl("RefSpeed Ao"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.RefSpeed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare36.dd, "$object.ConvertWarning##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare36.dd, "$object.Switch")
      });
    pwr_indsquare38.dd.setDynType(5);
    pwr_indsquare38.dd.setActionType(0);
    pwr_indsquare38.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare38.dd, "!$object.ConvertRemote##Boolean",29)
      });
    pwr_valuemedium41.dd.setDynType(1025);
    pwr_valuemedium41.dd.setActionType(2);
    pwr_valuemedium41.dd.setAccess(65532);
    pwr_valuemedium41.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium41.dd, "$object.RefSpeed.ActualValue##Float32","%7.2f")
      ,new GeDynPopupMenu(pwr_valuemedium41.dd, "$object.RefSpeed")
      });
    pwr_valuemedium43.dd.setDynType(1025);
    pwr_valuemedium43.dd.setActionType(2);
    pwr_valuemedium43.dd.setAccess(65532);
    pwr_valuemedium43.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium43.dd, "$object.ActSpeed.ActualValue##Float32","%7.2f")
      ,new GeDynPopupMenu(pwr_valuemedium43.dd, "$object.ActSpeed")
      });
    pwr_valuemedium45.dd.setDynType(1025);
    pwr_valuemedium45.dd.setActionType(2);
    pwr_valuemedium45.dd.setAccess(65532);
    pwr_valuemedium45.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium45.dd, "$object.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium45.dd, "$object.ActTorque")
      });
    pwr_valuemedium47.dd.setDynType(1025);
    pwr_valuemedium47.dd.setActionType(2);
    pwr_valuemedium47.dd.setAccess(65532);
    pwr_valuemedium47.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium47.dd, "$object.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium47.dd, "$object.ActCurrent")
      });
    pwr_smallbuttoncenter51.dd.setDynType(1);
    pwr_smallbuttoncenter51.dd.setActionType(16);
    pwr_smallbuttoncenter51.dd.setAccess(65532);
    pwr_smallbuttoncenter51.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter51.dd, "$object.OpReset##Boolean")
      });
    pwr_smallbuttoncenter51.setAnnot1("Reset");
    jopBar52.setPwrAttribute("$object.RefSpeed.ActualValue##Float32");
    jopBar52.setMinValueAttr("$object.RefSpeed.PresMinLimit##Float32");
    jopBar52.setMaxValueAttr("$object.RefSpeed.PresMaxLimit##Float32");
    jopTrend53.setPwrAttribute1("$object.RefSpeed.ActualValue##Float32");
    jopTrend53.setPwrAttribute2("$object.ActSpeed.ActualValue##Float32");
    jopTrend53.setMinValueAttr1("$object.RefSpeed.PresMinLimit##Float32");
    jopTrend53.setMaxValueAttr1("$object.RefSpeed.PresMaxLimit##Float32");
    jopTrend53.setMinValueAttr2("$object.RefSpeed.PresMinLimit##Float32");
    jopTrend53.setMaxValueAttr2("$object.RefSpeed.PresMaxLimit##Float32");
    pwr_framethin54.dd.setDynType(1);
    pwr_framethin54.dd.setActionType(0);
    pwr_framethin55.dd.setDynType(1);
    pwr_framethin55.dd.setActionType(0);
    jopTrend57.setPwrAttribute1("$object.ActTorque.ActualValue##Float32");
    jopTrend57.setPwrAttribute2("$object.ActCurrent.ActualValue##Float32");
    jopTrend57.setMinValueAttr1("$object.ActTorque.PresMinLimit##Float32");
    jopTrend57.setMaxValueAttr1("$object.ActTorque.PresMaxLimit##Float32");
    jopTrend57.setMinValueAttr2("$object.ActCurrent.PresMinLimit##Float32");
    jopTrend57.setMaxValueAttr2("$object.ActCurrent.PresMaxLimit##Float32");
    jopBar58.setPwrAttribute("$object.ActSpeed.ActualValue##Float32");
    jopBar58.setMinValueAttr("$object.RefSpeed.PresMinLimit##Float32");
    jopBar58.setMaxValueAttr("$object.RefSpeed.PresMaxLimit##Float32");
    pwr_valuesmall59.dd.setDynType(1025);
    pwr_valuesmall59.dd.setActionType(0);
    pwr_valuesmall59.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall59.dd, "$object.RefSpeed.Unit##String8","%s")
      });
    ...
    pwr_valueinputreliefup60.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup60.dd, "$object.ActTorque.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup60.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup60.setAnnot1Font(pwr_valueinputreliefup60.annotFont.deriveFont((float)11));
    ...
    pwr_valueinputreliefup61.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup61.dd, "$object.ActTorque.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup61.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup61.setAnnot1Font(pwr_valueinputreliefup61.annotFont.deriveFont((float)11));
    ...
    pwr_valueinputreliefup62.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup62.dd, "$object.RefSpeed.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup62.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup62.setAnnot1Font(pwr_valueinputreliefup62.annotFont.deriveFont((float)11));
    pwr_valueinputreliefup63.dd.setDynType(1024);
    pwr_valueinputreliefup63.dd.setActionType(4096);
    pwr_valueinputreliefup63.dd.setAccess(22);
    pwr_valueinputreliefup63.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup63.dd, "$object.RefSpeed.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup63.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup63.setAnnot1Font(pwr_valueinputreliefup63.annotFont.deriveFont((float)11));
    ...
    pwr_valueinputreliefup65.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup65.dd, "$object.ActCurrent.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup65.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup65.setAnnot1Font(pwr_valueinputreliefup65.annotFont.deriveFont((float)11));
    pwr_valueinputreliefup66.dd.setDynType(1024);
    pwr_valueinputreliefup66.dd.setActionType(4096);
    pwr_valueinputreliefup66.dd.setAccess(22);
    pwr_valueinputreliefup66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup66.dd, "$object.ActCurrent.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup66.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup66.setAnnot1Font(pwr_valueinputreliefup66.annotFont.deriveFont((float)11));
    ...
    pwr_smallbuttoncenter79.dd.setDynType(1);
    pwr_smallbuttoncenter79.dd.setActionType(64);
    pwr_smallbuttoncenter79.dd.setAccess(33619964);
    pwr_smallbuttoncenter79.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_smallbuttoncenter79.dd, "open graph pwr_c_basefcppo5param/inst=$object")
      });
    pwr_smallbuttoncenter79.setAnnot1("More...");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.37507F, 23.1001F, 794.773F, 22.4305F),
    ...
    new Rectangle2D.Float(152F, 154F, 10F, 1F),
    new Line2D.Float( 152F, 154F, 162F, 154F),
    new Line2D.Float( 152F, 154F, 162F, 154F),
    new Line2D.Float( 162F, 154F, 162F, 154F),
    new Rectangle2D.Float(22F, 154F, 10F, 1F),
    new Line2D.Float( 22F, 154F, 32F, 154F),
    new Line2D.Float( 22F, 154F, 32F, 154F),
    new Line2D.Float( 22F, 154F, 22F, 154F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.37507F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.37507F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.drawString( JopLang.transl("Status"),189, 152);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, 2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Ready"),512, 77);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Run"),512, 97);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Tripped"),512, 186);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch-On inhibit"),512, 117);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Warning"),512, 136);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Local control"),512, 155);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Status"),416, 111);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SetValue"),29, 356);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("ActualValue"),29, 329);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Moment"),29, 495);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Current"),29, 519);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("A"),196, 519);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),194, 495);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("0"),774, 578);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("100"),290, 578);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Speed"),28, 257);
    {
    int fcolor = GeColor.getDrawtype(102, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.getColor( fcolor));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Bus com"),416, 214);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_frequencyconverter extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,40F,40F, false,52, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
