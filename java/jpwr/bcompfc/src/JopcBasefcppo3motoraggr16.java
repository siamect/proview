...
public class JopcBasefcppo3motoraggr16 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(162,491,14,14));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(5,654,45,18));
    ...
    pwr_valuelong30.setBounds(new Rectangle(61,653,334,21));
    ...
    pwr_manswitch333.setBounds(new Rectangle(268,342,36,36));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(197,480,36,37));
    ...
    pwr_indround54.setBounds(new Rectangle(86,248,16,16));
    ...
    pwr_indsquare57.setBounds(new Rectangle(162,403,14,15));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(37,422,55,21));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(307,563,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(357,566,18,12));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(153,580,10,20));
    ...
    grp221_75.setBounds(new Rectangle(35,527,38,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857043, 11}, new int[] { 12, 15, 157305940,76}, 4),
