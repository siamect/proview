...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1220222579, -3}, new int[] { 10, 14, -1220222561,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, 146335716, -3}, new int[] { 14, 17, 147599854,14}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222561, 14}, new int[] { 12, 15, -1220222531,44}, 4),
