...
public class JopcBasefcppo3pumpaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare69.setBounds(new Rectangle(161,428,16,17));
    ...
    pwr_pump373.setBounds(new Rectangle(77,454,84,74));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 29, -2147483648}, new int[] { 40, 36, -1219980897,14}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980915, -3}, new int[] { 10, 14, -1219980897,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980915, -3}, new int[] { 14, 17, -1219980897,14}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857046, 14}, new int[] { 12, 15, 159373444,44}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140857046, 14}, new int[] { 12, 15, 160352964,44}, 4),
