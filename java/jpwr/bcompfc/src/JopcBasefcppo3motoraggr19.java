...
public class JopcBasefcppo3motoraggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,352,14,15));
    ...
    pwr_indsquare13.setBounds(new Rectangle(162,489,14,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,652,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,651,334,21));
    ...
    pwr_contactor234.setBounds(new Rectangle(268,342,36,36));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(197,478,36,37));
    ...
    pwr_indsquare60.setBounds(new Rectangle(162,401,14,14));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(37,420,55,21));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(307,561,49,15));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(357,564,18,12));
    ...
    pwr_indsquare78.setBounds(new Rectangle(162,526,14,15));
    ...
    grp221_79.setBounds(new Rectangle(35,525,38,16));
    ...
    grp224_82.setBounds(new Rectangle(37,197,39,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915354, 21}, new int[] { 12, 15, -1219915338,37}, 4),
