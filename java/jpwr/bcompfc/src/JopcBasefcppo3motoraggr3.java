...
public class JopcBasefcppo3motoraggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,442,16,17));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(4,597,47,21));
    ...
    pwr_valuelong30.setBounds(new Rectangle(60,596,336,23));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(268,432,38,39));
    ...
    pwr_indsquare57.setBounds(new Rectangle(161,346,16,16));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(308,506,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,509,20,14));
    ...
    pwr_indsquare70.setBounds(new Rectangle(310,175,16,17));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,471,16,16));
    ...
    grp223_75.setBounds(new Rectangle(34,470,40,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222568, 7}, new int[] { 12, 15, -1220222524,51}, 4),
