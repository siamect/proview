...
public class JopcBasefcppo3motoraggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo3motoraggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr3");
    ...
    pwr_indsquare12.setBounds(new Rectangle(162,443,14,15));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(5,598,45,19));
    ...
    pwr_valuelong30.setBounds(new Rectangle(61,597,334,21));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(269,433,36,37));
    ...
    pwr_indsquare57.setBounds(new Rectangle(162,347,14,14));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(309,507,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,510,18,12));
    ...
    pwr_indsquare70.setBounds(new Rectangle(311,176,14,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,472,14,14));
    ...
    grp223_75.setBounds(new Rectangle(35,471,38,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915368, 7}, new int[] { 12, 15, -1219915324,51}, 4),
