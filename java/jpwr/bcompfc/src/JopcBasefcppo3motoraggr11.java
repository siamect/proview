...
public class JopcBasefcppo3motoraggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(4,504,47,21));
    ...
    pwr_valuelong25.setBounds(new Rectangle(60,503,336,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(308,413,51,17));
    ...
    pwr_rodcouplinganim65.setBounds(new Rectangle(154,430,12,21));
    ...
    pwr_indsquare67.setBounds(new Rectangle(161,378,16,17));
    ...
    pwr_smallbuttoncenter70.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_mbup71.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980904, 7}, new int[] { 12, 15, -1219980871,40}, 4),
