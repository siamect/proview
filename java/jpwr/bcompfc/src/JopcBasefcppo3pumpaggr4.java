...
public class JopcBasefcppo3pumpaggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch378;
  bcomp_fc	bcomp_fc79;
  pwr_mbup	pwr_mbup80;
  public JopcBasefcppo3pumpaggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr4");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(162,296,16,17));
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,433,16,17));
    ...
    pwr_mbopenobject13.setBounds(new Rectangle(195,24,20,20));
    ...
    pwr_mbtrend14.setBounds(new Rectangle(56,24,20,20));
    ...
    pwr_mbfast15.setBounds(new Rectangle(76,24,20,20));
    ...
    pwr_mbrtnavigator20.setBounds(new Rectangle(175,24,20,20));
    ...
    pwr_mbblockevents22.setBounds(new Rectangle(155,24,20,20));
    ...
    pwr_mbnote24.setBounds(new Rectangle(36,24,20,20));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,596,48,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,595,336,23));
    ...
    pwr_indsquare29.setBounds(new Rectangle(349,96,16,17));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(196,422,38,39));
    ...
    pwr_indsquare33.setBounds(new Rectangle(349,117,16,17));
    ...
    pwr_valuesmall36.setBounds(new Rectangle(302,229,72,17));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(302,248,72,18));
    ...
    pwr_motor244.setBounds(new Rectangle(158,495,98,74));
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(34,171,48,21));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(124,172,61,21));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(124,196,61,21));
    ...
    pwr_indround50.setBounds(new Rectangle(86,247,18,17));
    ...
    pwr_indround51.setBounds(new Rectangle(193,173,18,17));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,505,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(356,508,20,14));
    ...
    grp210_63.setBounds(new Rectangle(127,227,41,18));
    ...
    pwr_indsquare66.setBounds(new Rectangle(312,173,16,17));
    ...
    grp221_69.setBounds(new Rectangle(35,469,40,18));
    ...
    pwr_pump372.setBounds(new Rectangle(75,496,84,74));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(34,196,48,21));
    ...
    pwr_manswitch378 = new pwr_manswitch3(session);
    pwr_manswitch378.setBounds(new Rectangle(268,284,38,38));
    pwr_manswitch378.setFillColor(32);
    pwr_manswitch378.setShadow(1);
    localPanel.add(pwr_manswitch378, new Proportion(pwr_manswitch378.getBounds(), dsize));
    bcomp_fc79 = new bcomp_fc(session);
    bcomp_fc79.setBounds(new Rectangle(256,335,64,84));
    bcomp_fc79.setShadow(1);
    localPanel.add(bcomp_fc79, new Proportion(bcomp_fc79.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu243.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu243.dd, new String[] {
        "CircuitBreaker",null,"StartLock","FrequencyConverter","Motor",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_manswitch378.dd.setDynType(32769);
    pwr_manswitch378.dd.setActionType(66);
    pwr_manswitch378.dd.setAccess(65535);
    pwr_manswitch378.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch378.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch378.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch378.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    bcomp_fc79.dd.setDynType(1);
    bcomp_fc79.dd.setActionType(66);
    bcomp_fc79.dd.setAccess(65535);
    bcomp_fc79.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc79.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc79.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.3679F, 277.215F, 362.023F, 317.628F),
    new Polygon( new int[] { 19, 381, 380, 20, 20, 19}, new int[] { 277, 277, 278, 278, 594, 595}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 20, 19}, new int[] { 595, 277, 278, 594, 594, 595}, 6), 
    ...
    new Rectangle2D.Float(40.6247F, 113F, 196F, 7F),
    new Polygon( new int[] { 41, 237, 235, 42, 42, 41}, new int[] { 113, 113, 115, 115, 118, 120}, 6), 
    new Polygon( new int[] { 237, 237, 235, 235, 42, 41}, new int[] { 120, 113, 115, 118, 118, 120}, 6), 
    new Line2D.Float( 288.625F, 340F, 288.625F, 322F),
    new Polygon( new int[] { 213, 285, 289, 289, 289, 285}, new int[] {498, 498, 494, 416, 494, 498}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Interlock",244, 187);
    {
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -34}, new int[] { 8, 10, 13,25}, 4),
    ...
    new Polygon( new int[] { 6, 7, 78, -34}, new int[] { 40, 36, -1220222550,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -34}, new int[] { 46, 46, 54,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222610, -34}, new int[] { 10, 14, -1220222550,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140898181, -34}, new int[] { 14, 19, 144130545,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222592, -16}, new int[] { 12, 15, -1220222520,55}, 4),
