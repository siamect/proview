...
public class JopcBasefcppo5fanaggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup85;
  public JopcBasefcppo5fanaggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr21");
    ...
    bcomp_fc83 = new bcomp_fc(session);
    bcomp_fc83.setBounds(new Rectangle(256,341,62,82));
    bcomp_fc83.setShadow(1);
    localPanel.add(bcomp_fc83, new Proportion(bcomp_fc83.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc83.dd.setDynType(1);
    bcomp_fc83.dd.setActionType(66);
    bcomp_fc83.dd.setAccess(65535);
    bcomp_fc83.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc83.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc83.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Power"),244, 161);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[14]);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),239, 189);
    {
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915358, 17}, new int[] { 12, 15, -1219915321,54}, 4),
