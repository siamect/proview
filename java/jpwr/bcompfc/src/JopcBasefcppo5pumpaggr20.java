...
public class JopcBasefcppo5pumpaggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbopenobject	pwr_mbopenobject11;
  pwr_mbtrend	pwr_mbtrend12;
  pwr_mbfast	pwr_mbfast13;
  pwr_mbphoto	pwr_mbphoto14;
  pwr_mbdatasheet	pwr_mbdatasheet15;
  pwr_mbopenplc	pwr_mbopenplc16;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram17;
  pwr_mbrtnavigator	pwr_mbrtnavigator18;
  pwr_mbhelpclass	pwr_mbhelpclass19;
  pwr_mbblockevents	pwr_mbblockevents20;
  pwr_mbhistevent	pwr_mbhistevent21;
  pwr_mbnote	pwr_mbnote22;
  pwr_mbhelp	pwr_mbhelp23;
  ...
  pwr_menubar2	pwr_menubar235;
  pwr_pulldownmenu2	pwr_pulldownmenu236;
  pwr_pulldownmenu2	pwr_pulldownmenu237;
  pwr_pulldownmenu2	pwr_pulldownmenu238;
  pwr_pulldownmenu2	pwr_pulldownmenu239;
  pwr_pulldownmenu2	pwr_pulldownmenu240;
  pwr_motor2	pwr_motor241;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter42;
  ...
  pwr_valuemedium	pwr_valuemedium58;
  pwr_valuemedium	pwr_valuemedium59;
  pwr_valuemedium	pwr_valuemedium61;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd65;
  Grp210_	grp210_66;
  Grp212_	grp212_67;
  pwr_valuemedium	pwr_valuemedium68;
  pwr_indsquare	pwr_indsquare72;
  pwr_mbsimulate	pwr_mbsimulate73;
  pwr_indsquare	pwr_indsquare74;
  Grp221_	grp221_75;
  pwr_pumpanim2	pwr_pumpanim277;
  pwr_pump3	pwr_pump378;
  pwr_rodcouplinganim	pwr_rodcouplinganim79;
  Grp226_	grp226_80;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter81;
  pwr_fuse3	pwr_fuse385;
  pwr_contactor2	pwr_contactor286;
  bcomp_fc	bcomp_fc87;
  pwr_mbup	pwr_mbup88;
  public JopcBasefcppo5pumpaggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr20");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(162,353,14,15));
    ...
    pwr_mbopenobject11 = new pwr_mbopenobject(session);
    pwr_mbopenobject11.setBounds(new Rectangle(195,26,18,18));
    pwr_mbopenobject11.setShadow(1);
    localPanel.add(pwr_mbopenobject11, new Proportion(pwr_mbopenobject11.getBounds(), dsize));
    pwr_mbtrend12 = new pwr_mbtrend(session);
    pwr_mbtrend12.setBounds(new Rectangle(56,26,18,18));
    pwr_mbtrend12.setShadow(1);
    localPanel.add(pwr_mbtrend12, new Proportion(pwr_mbtrend12.getBounds(), dsize));
    pwr_mbfast13 = new pwr_mbfast(session);
    pwr_mbfast13.setBounds(new Rectangle(76,26,18,18));
    pwr_mbfast13.setShadow(1);
    localPanel.add(pwr_mbfast13, new Proportion(pwr_mbfast13.getBounds(), dsize));
    pwr_mbphoto14 = new pwr_mbphoto(session);
    pwr_mbphoto14.setBounds(new Rectangle(96,26,18,18));
    pwr_mbphoto14.setShadow(1);
    localPanel.add(pwr_mbphoto14, new Proportion(pwr_mbphoto14.getBounds(), dsize));
    pwr_mbdatasheet15 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet15.setBounds(new Rectangle(116,26,18,18));
    pwr_mbdatasheet15.setShadow(1);
    localPanel.add(pwr_mbdatasheet15, new Proportion(pwr_mbdatasheet15.getBounds(), dsize));
    pwr_mbopenplc16 = new pwr_mbopenplc(session);
    pwr_mbopenplc16.setBounds(new Rectangle(215,26,18,18));
    pwr_mbopenplc16.setShadow(1);
    localPanel.add(pwr_mbopenplc16, new Proportion(pwr_mbopenplc16.getBounds(), dsize));
    pwr_mbcircuitdiagram17 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram17.setBounds(new Rectangle(235,26,18,18));
    pwr_mbcircuitdiagram17.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram17, new Proportion(pwr_mbcircuitdiagram17.getBounds(), dsize));
    pwr_mbrtnavigator18 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator18.setBounds(new Rectangle(175,26,18,18));
    pwr_mbrtnavigator18.setShadow(1);
    localPanel.add(pwr_mbrtnavigator18, new Proportion(pwr_mbrtnavigator18.getBounds(), dsize));
    pwr_mbhelpclass19 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass19.setBounds(new Rectangle(255,26,18,18));
    pwr_mbhelpclass19.setShadow(1);
    localPanel.add(pwr_mbhelpclass19, new Proportion(pwr_mbhelpclass19.getBounds(), dsize));
    pwr_mbblockevents20 = new pwr_mbblockevents(session);
    pwr_mbblockevents20.setBounds(new Rectangle(155,26,18,18));
    pwr_mbblockevents20.setShadow(1);
    localPanel.add(pwr_mbblockevents20, new Proportion(pwr_mbblockevents20.getBounds(), dsize));
    pwr_mbhistevent21 = new pwr_mbhistevent(session);
    pwr_mbhistevent21.setBounds(new Rectangle(136,26,18,18));
    localPanel.add(pwr_mbhistevent21, new Proportion(pwr_mbhistevent21.getBounds(), dsize));
    pwr_mbnote22 = new pwr_mbnote(session);
    pwr_mbnote22.setBounds(new Rectangle(36,26,17,18));
    localPanel.add(pwr_mbnote22, new Proportion(pwr_mbnote22.getBounds(), dsize));
    pwr_mbhelp23 = new pwr_mbhelp(session);
    pwr_mbhelp23.setBounds(new Rectangle(17,26,18,18));
    localPanel.add(pwr_mbhelp23, new Proportion(pwr_mbhelp23.getBounds(), dsize));
    pwr_valuelong24 = new pwr_valuelong(session);
    pwr_valuelong24.setBounds(new Rectangle(17,69,367,20));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,609,45,19));
    pwr_smallbuttoncenter25.setFillColor(102);
    pwr_smallbuttoncenter25.setBorderColor(37);
    ...
    pwr_valuelong26.setBounds(new Rectangle(61,608,334,21));
    ...
    pwr_indsquare27.setBounds(new Rectangle(349,97,14,15));
    ...
    pwr_indsquare30.setBounds(new Rectangle(349,118,14,15));
    pwr_indsquare30.setFillColor(175);
    ...
    pwr_valuesmall33.setBounds(new Rectangle(302,230,70,16));
    ...
    pwr_valuesmall34.setBounds(new Rectangle(302,249,70,16));
    localPanel.add(pwr_valuesmall34, new Proportion(pwr_valuesmall34.getBounds(), dsize));
    pwr_menubar235 = new pwr_menubar2(session);
    pwr_menubar235.setBounds(new Rectangle(1,1,407,22));
    pwr_menubar235.setShadow(1);
    localPanel.add(pwr_menubar235, new Proportion(pwr_menubar235.getBounds(), dsize));
    pwr_pulldownmenu236 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu236.setBounds(new Rectangle(9,1,42,22));
    pwr_pulldownmenu236.setShadow(1);
    localPanel.add(pwr_pulldownmenu236, new Proportion(pwr_pulldownmenu236.getBounds(), dsize));
    pwr_pulldownmenu237 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu237.setBounds(new Rectangle(329,1,67,22));
    pwr_pulldownmenu237.setShadow(1);
    localPanel.add(pwr_pulldownmenu237, new Proportion(pwr_pulldownmenu237.getBounds(), dsize));
    pwr_pulldownmenu238 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu238.setBounds(new Rectangle(221,1,67,22));
    ...
    pwr_pulldownmenu239.setBounds(new Rectangle(53,1,67,22));
    ...
    pwr_pulldownmenu240.setBounds(new Rectangle(125,1,86,22));
    pwr_pulldownmenu240.setShadow(1);
    localPanel.add(pwr_pulldownmenu240, new Proportion(pwr_pulldownmenu240.getBounds(), dsize));
    pwr_motor241 = new pwr_motor2(session);
    pwr_motor241.setBounds(new Rectangle(159,506,96,72));
    localPanel.add(pwr_motor241, new Proportion(pwr_motor241.getBounds(), dsize));
    pwr_smallbuttoncenter42 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter42.setBounds(new Rectangle(34,173,45,19));
    pwr_smallbuttoncenter42.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter42, new Proportion(pwr_smallbuttoncenter42.getBounds(), dsize));
    pwr_indround43 = new pwr_indround(session);
    pwr_indround43.setBounds(new Rectangle(88,174,16,16));
    ...
    pwr_indround44.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter46.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround47.setBounds(new Rectangle(86,248,16,15));
    ...
    pwr_indround48.setBounds(new Rectangle(193,174,16,16));
    pwr_indround48.setFillColor(294);
    pwr_indround48.setShadow(1);
    localPanel.add(pwr_indround48, new Proportion(pwr_indround48.getBounds(), dsize));
    grp169_49 = new Grp169_(session);
    grp169_49.setBounds(new Rectangle(35,249,35,16));
    localPanel.add(grp169_49, new Proportion(grp169_49.getBounds(), dsize));
    pwr_smallbuttoncenter50 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter50.setBounds(new Rectangle(240,174,34,19));
    ...
    pwr_smallbuttoncenter51.setBounds(new Rectangle(240,198,34,19));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,402,14,14));
    ...
    pwr_indround54.setBounds(new Rectangle(286,174,15,16));
    pwr_indround54.setFillColor(294);
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,421,55,21));
    pwr_smallbuttoncenter57.setFillColor(32);
    pwr_smallbuttoncenter57.setShadow(1);
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,516,49,15));
    pwr_valuemedium58.setShadow(1);
    localPanel.add(pwr_valuemedium58, new Proportion(pwr_valuemedium58.getBounds(), dsize));
    pwr_valuemedium59 = new pwr_valuemedium(session);
    pwr_valuemedium59.setBounds(new Rectangle(307,534,49,15));
    pwr_valuemedium59.setShadow(1);
    localPanel.add(pwr_valuemedium59, new Proportion(pwr_valuemedium59.getBounds(), dsize));
    pwr_valuemedium61 = new pwr_valuemedium(session);
    pwr_valuemedium61.setBounds(new Rectangle(357,519,18,12));
    pwr_valuemedium61.setFillColor(31);
    pwr_valuemedium61.setBorderColor(31);
    localPanel.add(pwr_valuemedium61, new Proportion(pwr_valuemedium61.getBounds(), dsize));
    pwr_valueinputmediumrd65 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd65.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd65.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd65, new Proportion(pwr_valueinputmediumrd65.getBounds(), dsize));
    grp210_66 = new Grp210_(session);
    grp210_66.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_66, new Proportion(grp210_66.getBounds(), dsize));
    grp212_67 = new Grp212_(session);
    grp212_67.setBounds(new Rectangle(199,247,26,18));
    grp212_67.setFillColor(31);
    grp212_67.setBorderColor(31);
    localPanel.add(grp212_67, new Proportion(grp212_67.getBounds(), dsize));
    pwr_valuemedium68 = new pwr_valuemedium(session);
    pwr_valuemedium68.setBounds(new Rectangle(307,552,49,15));
    pwr_valuemedium68.setShadow(1);
    localPanel.add(pwr_valuemedium68, new Proportion(pwr_valuemedium68.getBounds(), dsize));
    pwr_indsquare72 = new pwr_indsquare(session);
    pwr_indsquare72.setBounds(new Rectangle(358,200,14,15));
    pwr_indsquare72.setFillColor(175);
    pwr_indsquare72.setShadow(1);
    localPanel.add(pwr_indsquare72, new Proportion(pwr_indsquare72.getBounds(), dsize));
    pwr_mbsimulate73 = new pwr_mbsimulate(session);
    pwr_mbsimulate73.setBounds(new Rectangle(366,26,17,18));
    localPanel.add(pwr_mbsimulate73, new Proportion(pwr_mbsimulate73.getBounds(), dsize));
    pwr_indsquare74 = new pwr_indsquare(session);
    pwr_indsquare74.setBounds(new Rectangle(162,481,14,15));
    ...
    grp221_75.setBounds(new Rectangle(35,480,38,16));
    localPanel.add(grp221_75, new Proportion(grp221_75.getBounds(), dsize));
    pwr_pumpanim277 = new pwr_pumpanim2(session);
    pwr_pumpanim277.setBounds(new Rectangle(119,96,62,42));
    pwr_pumpanim277.setShadow(1);
    pwr_pumpanim277.setGradient(12);
    localPanel.add(pwr_pumpanim277, new Proportion(pwr_pumpanim277.getBounds(), dsize));
    pwr_pump378 = new pwr_pump3(session);
    pwr_pump378.setBounds(new Rectangle(76,507,82,72));
    pwr_pump378.setColorTone(7);
    localPanel.add(pwr_pump378, new Proportion(pwr_pump378.getBounds(), dsize));
    pwr_rodcouplinganim79 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim79.setBounds(new Rectangle(153,533,10,20));
    localPanel.add(pwr_rodcouplinganim79, new Proportion(pwr_rodcouplinganim79.getBounds(), dsize));
    grp226_80 = new Grp226_(session);
    grp226_80.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_80, new Proportion(grp226_80.getBounds(), dsize));
    pwr_smallbuttoncenter81 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter81.setBounds(new Rectangle(34,197,45,19));
    pwr_smallbuttoncenter81.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter81, new Proportion(pwr_smallbuttoncenter81.getBounds(), dsize));
    ...
    pwr_contactor286 = new pwr_contactor2(session);
    pwr_contactor286.setBounds(new Rectangle(268,343,36,36));
    pwr_contactor286.setFillColor(32);
    pwr_contactor286.setShadow(1);
    localPanel.add(pwr_contactor286, new Proportion(pwr_contactor286.getBounds(), dsize));
    bcomp_fc87 = new bcomp_fc(session);
    bcomp_fc87.setBounds(new Rectangle(256,392,62,82));
    bcomp_fc87.setShadow(1);
    localPanel.add(bcomp_fc87, new Proportion(bcomp_fc87.getBounds(), dsize));
    pwr_mbup88 = new pwr_mbup(session);
    pwr_mbup88.setBounds(new Rectangle(347,26,18,18));
    ...
    pwr_mbopenobject11.dd.setDynType(129);
    pwr_mbopenobject11.dd.setActionType(8256);
    pwr_mbopenobject11.dd.setAccess(65532);
    pwr_mbopenobject11.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject11.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject11.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject11.dd, JopLang.transl("Open Object"))
      });
    pwr_mbtrend12.dd.setDynType(129);
    pwr_mbtrend12.dd.setActionType(8256);
    pwr_mbtrend12.dd.setAccess(65532);
    pwr_mbtrend12.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend12.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend12.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend12.dd, JopLang.transl("Trend"))
      });
    pwr_mbfast13.dd.setDynType(129);
    pwr_mbfast13.dd.setActionType(8256);
    pwr_mbfast13.dd.setAccess(65532);
    pwr_mbfast13.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast13.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast13.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast13.dd, JopLang.transl("Fast"))
      });
    pwr_mbphoto14.dd.setDynType(129);
    pwr_mbphoto14.dd.setActionType(8256);
    pwr_mbphoto14.dd.setAccess(65532);
    pwr_mbphoto14.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto14.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto14.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto14.dd, JopLang.transl("Photo"))
      });
    pwr_mbdatasheet15.dd.setDynType(129);
    pwr_mbdatasheet15.dd.setActionType(8256);
    pwr_mbdatasheet15.dd.setAccess(65532);
    pwr_mbdatasheet15.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet15.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet15.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet15.dd, JopLang.transl("DataSheet"))
      });
    pwr_mbopenplc16.dd.setDynType(129);
    pwr_mbopenplc16.dd.setActionType(8256);
    pwr_mbopenplc16.dd.setAccess(65532);
    pwr_mbopenplc16.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc16.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc16.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc16.dd, JopLang.transl("Open Plc"))
      });
    pwr_mbcircuitdiagram17.dd.setDynType(129);
    pwr_mbcircuitdiagram17.dd.setActionType(8256);
    pwr_mbcircuitdiagram17.dd.setAccess(65535);
    pwr_mbcircuitdiagram17.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram17.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram17.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram17.dd, JopLang.transl("CircuitDiagram"))
      });
    pwr_mbrtnavigator18.dd.setDynType(129);
    pwr_mbrtnavigator18.dd.setActionType(8256);
    pwr_mbrtnavigator18.dd.setAccess(65532);
    pwr_mbrtnavigator18.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator18.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator18.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator18.dd, JopLang.transl("RtNavigator"))
      });
    pwr_mbhelpclass19.dd.setDynType(129);
    pwr_mbhelpclass19.dd.setActionType(8256);
    pwr_mbhelpclass19.dd.setAccess(65532);
    pwr_mbhelpclass19.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass19.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass19.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass19.dd, JopLang.transl("Help Class"))
      });
    pwr_mbblockevents20.dd.setDynType(129);
    pwr_mbblockevents20.dd.setActionType(8256);
    pwr_mbblockevents20.dd.setAccess(65532);
    pwr_mbblockevents20.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents20.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents20.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents20.dd, JopLang.transl("Block Events"))
      });
    pwr_mbhistevent21.dd.setDynType(129);
    pwr_mbhistevent21.dd.setActionType(8256);
    pwr_mbhistevent21.dd.setAccess(65532);
    pwr_mbhistevent21.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent21.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent21.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent21.dd, JopLang.transl("Hist Event"))
      });
    pwr_mbnote22.dd.setDynType(129);
    pwr_mbnote22.dd.setActionType(8256);
    pwr_mbnote22.dd.setAccess(65532);
    pwr_mbnote22.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote22.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote22.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote22.dd, JopLang.transl("Note"))
      });
    pwr_mbhelp23.dd.setDynType(128);
    pwr_mbhelp23.dd.setActionType(8256);
    pwr_mbhelp23.dd.setAccess(65532);
    pwr_mbhelp23.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp23.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp23.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp23.dd, JopLang.transl("Help"))
      });
    ...
    pwr_smallbuttoncenter25.dd.setActionType(64);
    pwr_smallbuttoncenter25.dd.setAccess(65532);
    pwr_smallbuttoncenter25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter25.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter25.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter25.setAnnot1("Note !");
    ...
    pwr_indsquare30.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare30.dd, "$object.ExtInterlock##Boolean",29)
      });
    pwr_valuesmall33.dd.setDynType(1025);
    pwr_valuesmall33.dd.setActionType(0);
    pwr_valuesmall33.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall33.dd, "$object.RunTimeCounter.TotalNOfStarts##UInt32","%d")
      });
    pwr_valuesmall34.dd.setDynType(1025);
    pwr_valuesmall34.dd.setActionType(0);
    pwr_valuesmall34.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall34.dd, "$object.RunTimeCounter.TotalRunTime##DeltaTime","%1t")
      });
    pwr_menubar235.dd.setDynType(1);
    pwr_menubar235.dd.setActionType(0);
    pwr_pulldownmenu236.dd.setDynType(0);
    pwr_pulldownmenu236.dd.setActionType(524288);
    ...
    pwr_pulldownmenu236.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu236.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu236,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu236.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu236.setAnnot1("File");
    pwr_pulldownmenu237.dd.setDynType(1);
    pwr_pulldownmenu237.dd.setActionType(524288);
    pwr_pulldownmenu237.dd.setAccess(65532);
    pwr_pulldownmenu237.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu237.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu237,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu237.setAnnot1("Help");
    pwr_pulldownmenu238.dd.setDynType(1);
    ...
    pwr_pulldownmenu238.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu238.dd, new String[] {
        JopLang.transl("Contactor.Order Do"),null,JopLang.transl("Contactor.Feedback Di"),null,JopLang.transl("FrequencyConverter.ActSpeed"),JopLang.transl("FrequencyConverter.ActTorque"),JopLang.transl("FrequencyConverter.ActCurrent"),JopLang.transl("FrequencyConverter.RefSpeed"),JopLang.transl("Motor.TempSwitch.Switch Di"),JopLang.transl("Motor.TempSensor.Value Ai"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.Contactor.Order")
      }),
null,    new GeDyn(pwr_pulldownmenu238,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu238.dd, "$object.Contactor.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.Contactor.Feedback")
      }),
null,    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu238,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu238.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu238,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu238.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu238.setAnnot1("Signals");
    pwr_pulldownmenu239.dd.setDynType(1);
    pwr_pulldownmenu239.dd.setActionType(524288);
    pwr_pulldownmenu239.dd.setAccess(65535);
    pwr_pulldownmenu239.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu239.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu239,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu239.setAnnot1("Methods");
    ...
    pwr_pulldownmenu240.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu240.dd, new String[] {
        JopLang.transl("Contactor"),null,null,JopLang.transl("FrequencyConverter"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.Contactor")
      }),
null,null,    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu240.setAnnot1("Components");
    pwr_motor241.dd.setDynType(0);
    pwr_motor241.dd.setActionType(66);
    pwr_motor241.dd.setAccess(65535);
    pwr_motor241.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_motor241.dd, "$object.Motor")
      ,new GeDynCommand(pwr_motor241.dd, "open graph/class/instance=$object.motor")
      });
    pwr_smallbuttoncenter42.dd.setDynType(129);
    pwr_smallbuttoncenter42.dd.setActionType(6);
    pwr_smallbuttoncenter42.dd.setAccess(65532);
    pwr_smallbuttoncenter42.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter42.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter42.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter42.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter42.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter42.setAnnot1("Man");
    pwr_indround43.dd.setDynType(133);
    pwr_indround43.dd.setActionType(0);
    pwr_indround43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround43.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround43.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround44.dd.setDynType(133);
    pwr_indround44.dd.setActionType(0);
    pwr_indround44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround44.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround44.dd, "$object.Mode.AutoMode##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter45.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter45.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter45.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter45.dd, "$object.MOde.OpManStart##Boolean")
      });
    pwr_smallbuttoncenter45.setAnnot1("Start");
    ...
    pwr_smallbuttoncenter46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter46.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter46.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter46.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter46.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter46.setAnnot1("Stop");
    pwr_indround47.dd.setDynType(133);
    pwr_indround47.dd.setActionType(0);
    pwr_indround47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround47.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround47.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    pwr_indround48.dd.setDynType(5);
    pwr_indround48.dd.setActionType(0);
    pwr_indround48.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround48.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    grp169_49.dd.setDynType(129);
    grp169_49.dd.setActionType(0);
    grp169_49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp169_49.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter50.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter50.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(pwr_smallbuttoncenter50.dd, "$object.OpPowerOn##Boolean")
      });
    pwr_smallbuttoncenter50.setAnnot1("On");
    pwr_smallbuttoncenter51.dd.setDynType(129);
    pwr_smallbuttoncenter51.dd.setActionType(6);
    pwr_smallbuttoncenter51.dd.setAccess(65532);
    pwr_smallbuttoncenter51.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter51.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter51.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(pwr_smallbuttoncenter51.dd, "$object.OpPowerOff##Boolean")
      });
    pwr_smallbuttoncenter51.setAnnot1("Off");
    pwr_indsquare52.dd.setDynType(117);
    pwr_indsquare52.dd.setActionType(2);
    pwr_indsquare52.dd.setAccess(65532);
    pwr_indsquare52.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare52.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare52.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare52.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare52.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare52.dd, "$object.FrequencyConverter")
      });
    pwr_indround54.dd.setDynType(5);
    pwr_indround54.dd.setActionType(0);
    pwr_indround54.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround54.dd, "$object.Contactor.IndFeedback##Boolean",29)
      });
    pwr_smallbuttoncenter57.dd.setDynType(1);
    pwr_smallbuttoncenter57.dd.setActionType(4);
    pwr_smallbuttoncenter57.dd.setAccess(65532);
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter57.setAnnot1("Reset");
    pwr_valuemedium58.dd.setDynType(1024);
    pwr_valuemedium58.dd.setActionType(2);
    pwr_valuemedium58.dd.setAccess(65532);
    pwr_valuemedium58.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium58.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium58.dd, "$object.FrequencyConverter.ActSpeed")
      });
    pwr_valuemedium59.dd.setDynType(1025);
    pwr_valuemedium59.dd.setActionType(2);
    pwr_valuemedium59.dd.setAccess(65532);
    pwr_valuemedium59.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium59.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium59.dd, "$object.FrequencyConverter.ActTorque")
      });
    pwr_valuemedium61.dd.setDynType(1025);
    pwr_valuemedium61.dd.setActionType(0);
    pwr_valuemedium61.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium61.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd65.dd.setDynType(1153);
    pwr_valueinputmediumrd65.dd.setActionType(4096);
    pwr_valueinputmediumrd65.dd.setAccess(65532);
    pwr_valueinputmediumrd65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd65.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd65.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd65.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd65.setAnnot1Font(pwr_valueinputmediumrd65.annotFont.deriveFont((float)14));
    grp210_66.dd.setDynType(129);
    grp210_66.dd.setActionType(0);
    grp210_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_66.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_67.dd.setDynType(129);
    grp212_67.dd.setActionType(0);
    grp212_67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_67.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_valuemedium68.dd.setDynType(1025);
    pwr_valuemedium68.dd.setActionType(2);
    pwr_valuemedium68.dd.setAccess(65532);
    pwr_valuemedium68.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium68.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium68.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    pwr_indsquare72.dd.setDynType(5);
    pwr_indsquare72.dd.setActionType(0);
    pwr_indsquare72.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare72.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate73.dd.setDynType(129);
    pwr_mbsimulate73.dd.setActionType(8256);
    pwr_mbsimulate73.dd.setAccess(65532);
    pwr_mbsimulate73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate73.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate73.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate73.dd, JopLang.transl("Open simulate graph"))
      });
    ...
    pwr_pumpanim277.dd.setDynType(66612);
    pwr_pumpanim277.dd.setActionType(0);
    pwr_pumpanim277.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim277.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim277.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim277.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim277.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim277.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump378.dd.setDynType(1);
    pwr_pump378.dd.setActionType(66);
    pwr_pump378.dd.setAccess(65532);
    pwr_pump378.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump378.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump378.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim79.dd.setDynType(65537);
    pwr_rodcouplinganim79.dd.setActionType(0);
    pwr_rodcouplinganim79.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim79.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    grp226_80.dd.setDynType(129);
    grp226_80.dd.setActionType(0);
    grp226_80.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_80.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter81.dd.setDynType(129);
    pwr_smallbuttoncenter81.dd.setActionType(6);
    pwr_smallbuttoncenter81.dd.setAccess(65532);
    pwr_smallbuttoncenter81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter81.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter81.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter81.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter81.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter81.setAnnot1("Auto");
    pwr_fuse385.dd.setDynType(1);
    pwr_fuse385.dd.setActionType(0);
    pwr_contactor286.dd.setDynType(32769);
    pwr_contactor286.dd.setActionType(66);
    pwr_contactor286.dd.setAccess(65535);
    pwr_contactor286.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor286.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor286.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor286.dd, "open graph /class/instance=$object.Contactor")
      });
    bcomp_fc87.dd.setDynType(1);
    bcomp_fc87.dd.setActionType(66);
    bcomp_fc87.dd.setAccess(65535);
    bcomp_fc87.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc87.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc87.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 630;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7516F, 280.82F, 361.014F, 323.778F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 281, 281, 282, 282, 604, 605}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 605, 281, 282, 604, 604, 605}, 6), 
    ...
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {508, 508, 504, 472, 504, 508}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 366);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 413);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),361, 547);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 547);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 529);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 565);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 565);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 11, 41, 44}, new int[] { 14, 11, 11,14}, 4),
    ...
    new Polygon( new int[] { 56, 57, 14, 14}, new int[] { 62, 65, 65,62}, 4),
    new Polygon( new int[] { 14, 14, 7, 8}, new int[] { 62, 65, 60,58}, 4),
    new Polygon( new int[] { 8, 7, 5, 6}, new int[] { 58, 60, 52,52}, 4),
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 52, 52, 8,8}, 4),
    new Polygon( new int[] { 6, 5, 11, 14}, new int[] { 8, 8, 11,-77}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 40, 36, 24,24}, 4),
    new Polygon( new int[] { 6, 9, 13, 10}, new int[] { 24, 24, 19,18}, 4),
    new Polygon( new int[] { 10, 13, 15, 14}, new int[] { 18, 19, 15,14}, 4),
    new Polygon( new int[] { 14, 15, 43, 44}, new int[] { 14, 15, 15,14}, 4),
    new Polygon( new int[] { 44, 43, 45, 46}, new int[] { 14, 15, 23,24}, 4),
    new Polygon( new int[] { 46, 45, 18, 18}, new int[] { 24, 23, 23,24}, 4),
    new Polygon( new int[] { 18, 18, 13, 12}, new int[] { 24, 23, 27,28}, 4),
    new Polygon( new int[] { 12, 13, 7, 10}, new int[] { 28, 27, 39,32}, 4),
    new Polygon( new int[] { 10, 7, 9, 6}, new int[] { 32, 39, 36,40}, 4),
    new Polygon( new int[] { 6, 9, 159, 14}, new int[] { 40, 36, -1219915453,-77}, 4),
    new Polygon( new int[] { 6, 10, 18, 52, 56, 58, 58, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {44, 50, 52, 52, 48, 38, 10, 10, 52, 58, 62, 62, 58, 52, 46}, 15),
    new Polygon( new int[] { 6, 11, 10, 10}, new int[] { 44, 54, 53,50}, 4),
    new Polygon( new int[] { 10, 10, 18, 18}, new int[] { 50, 53, 55,52}, 4),
    ...
    new Polygon( new int[] { 14, 15, 13, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 13, 11, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 11, 11, 6}, new int[] { 52, 52, 46,46}, 4),
    new Polygon( new int[] { 6, 11, 11, 14}, new int[] { 46, 46, 54,-77}, 4),
    ...
    new Polygon( new int[] { 18, 18, 11, 10}, new int[] { 46, 48, 46,44}, 4),
    new Polygon( new int[] { 10, 11, 10, 6}, new int[] { 44, 46, 45,42}, 4),
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 42, 45, 43,44}, 4),
    new Polygon( new int[] { 6, 10, 13, 10}, new int[] { 44, 43, 48,50}, 4),
    new Polygon( new int[] { 10, 13, 18, 18}, new int[] { 50, 48, 50,52}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915361, 14}, new int[] { 10, 12, -1219915453,-77}, 4),
    new Polygon( new int[] { 6, 44, 44, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {14, 14, 10, 10, 52, 58, 62, 62, 58, 52, 14}, 11),
    new Polygon( new int[] { 6, 11, 47, 44}, new int[] { 14, 17, 17,14}, 4),
    ...
    new Polygon( new int[] { 14, 15, 13, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 13, 11, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 11, 11, 6}, new int[] { 52, 52, 17,14}, 4),
    new Polygon( new int[] { 6, 11, -1219915361, 14}, new int[] { 14, 17, -1219915453,-77}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915343, 32}, new int[] { 12, 13, -1219915423,-47}, 4),
