...
public class JopcBasefcppo3pumpaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,592,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,591,336,23));
    ...
    pwr_motor243.setBounds(new Rectangle(160,491,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(161,391,16,16));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(36,410,57,23));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(308,501,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(358,504,20,14));
    ...
    pwr_indsquare70.setBounds(new Rectangle(161,466,16,16));
    ...
    pwr_pump374.setBounds(new Rectangle(77,492,84,74));
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(154,518,12,22));
    ...
    pwr_contactor282.setBounds(new Rectangle(267,332,38,38));
    ...
    bcomp_fc83.setBounds(new Rectangle(255,381,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 115, -5}, new int[] { 40, 36, -1220222553,22}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222581, -5}, new int[] { 10, 14, -1220222553,22}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222581, -5}, new int[] { 14, 19, -1220222553,22}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222563, 12}, new int[] { 12, 15, -1220222523,52}, 4),
