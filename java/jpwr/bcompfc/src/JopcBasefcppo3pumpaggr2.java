...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 83, -5}, new int[] { 40, 36, -1219980889,22}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980917, -5}, new int[] { 10, 14, -1219980889,22}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893314, -5}, new int[] { 14, 19, 144132702,22}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 12, 12}, new int[] { 12, 15, 56,52}, 4),
