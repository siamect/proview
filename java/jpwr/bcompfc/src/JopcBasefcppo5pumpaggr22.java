...
public class JopcBasefcppo5pumpaggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc83;
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo5pumpaggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr22");
...
null,null,null,    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
...
null,null,    new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indround49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround49.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    ...
    pwr_indsquare51.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare51.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare51.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare51.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare51.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare51.dd, "$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter55.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter55.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    ...
    pwr_valuemedium56.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium56.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium56.dd, "$object.FrequencyConverter.ActSpeed")
      });
    ...
    pwr_valuemedium57.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium57.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium57.dd, "$object.FrequencyConverter.ActTorque")
      });
    ...
    pwr_valuemedium66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium66.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium66.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    ...
    pwr_pumpanim275.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim275.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim275.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim275.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_rodcouplinganim77.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim77.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("StartLock"),36, 460);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 364);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),363, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 526);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, 0}, new int[] { 8, 10, 13,25}, 4),
    ...
    new Polygon( new int[] { 6, 7, 0, 0}, new int[] { 40, 36, 25,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 0}, new int[] { 46, 46, 54,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915376, 0}, new int[] { 10, 14, -1219915350,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 0, 0}, new int[] { 14, 19, 25,25}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915358, 17}, new int[] { 12, 15, -1219915320,55}, 4),
