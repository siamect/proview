...
public class JopcBasefcppo5pumpaggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbsimulate	pwr_mbsimulate69;
  pwr_indsquare	pwr_indsquare70;
  Grp223_	grp223_71;
  pwr_pumpanim2	pwr_pumpanim273;
  pwr_pump3	pwr_pump374;
  pwr_rodcouplinganim	pwr_rodcouplinganim75;
  Grp228_	grp228_76;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter77;
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo5pumpaggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr11");
    ...
    pwr_valuelong22.setBounds(new Rectangle(17,69,367,20));
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(5,505,45,19));
    pwr_smallbuttoncenter23.setFillColor(102);
    ...
    pwr_valuelong24.setBounds(new Rectangle(61,504,334,21));
    ...
    pwr_indsquare25 = new pwr_indsquare(session);
    pwr_indsquare25.setBounds(new Rectangle(349,97,14,15));
    pwr_indsquare25.setFillColor(295);
    pwr_indsquare25.setShadow(1);
    localPanel.add(pwr_indsquare25, new Proportion(pwr_indsquare25.getBounds(), dsize));
    pwr_indsquare28 = new pwr_indsquare(session);
    pwr_indsquare28.setBounds(new Rectangle(349,118,14,15));
    pwr_indsquare28.setFillColor(175);
    ...
    pwr_valuesmall31.setBounds(new Rectangle(302,230,70,16));
    ...
    pwr_valuesmall32.setBounds(new Rectangle(302,249,70,16));
    localPanel.add(pwr_valuesmall32, new Proportion(pwr_valuesmall32.getBounds(), dsize));
    pwr_menubar233 = new pwr_menubar2(session);
    pwr_menubar233.setBounds(new Rectangle(1,1,407,22));
    pwr_menubar233.setShadow(1);
    localPanel.add(pwr_menubar233, new Proportion(pwr_menubar233.getBounds(), dsize));
    pwr_pulldownmenu234 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu234.setBounds(new Rectangle(9,1,42,22));
    ...
    pwr_pulldownmenu235.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu236.setBounds(new Rectangle(221,1,67,22));
    ...
    pwr_pulldownmenu237.setBounds(new Rectangle(53,1,67,22));
    ...
    pwr_pulldownmenu238.setBounds(new Rectangle(125,1,86,22));
    ...
    pwr_motor239.setBounds(new Rectangle(161,404,96,72));
    localPanel.add(pwr_motor239, new Proportion(pwr_motor239.getBounds(), dsize));
    bcomp_fc40 = new bcomp_fc(session);
    bcomp_fc40.setBounds(new Rectangle(256,294,62,82));
    bcomp_fc40.setShadow(1);
    localPanel.add(bcomp_fc40, new Proportion(bcomp_fc40.getBounds(), dsize));
    pwr_smallbuttoncenter41 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter41.setBounds(new Rectangle(34,172,45,19));
    ...
    pwr_indround42.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround43.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter44.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround46.setBounds(new Rectangle(86,248,16,15));
    ...
    pwr_indround47.setBounds(new Rectangle(193,174,16,15));
    ...
    grp169_48.setBounds(new Rectangle(35,249,35,16));
    localPanel.add(grp169_48, new Proportion(grp169_48.getBounds(), dsize));
    pwr_indsquare49 = new pwr_indsquare(session);
    pwr_indsquare49.setBounds(new Rectangle(162,304,14,15));
    pwr_indsquare49.setFillColor(294);
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(37,323,55,21));
    pwr_smallbuttoncenter53.setFillColor(32);
    pwr_smallbuttoncenter53.setShadow(1);
    ...
    pwr_valuemedium54.setBounds(new Rectangle(309,414,49,15));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(309,432,49,15));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(359,417,18,12));
    ...
    pwr_valuemedium64.setBounds(new Rectangle(309,450,49,15));
    ...
    pwr_indsquare68.setBounds(new Rectangle(308,176,14,15));
    pwr_indsquare68.setFillColor(175);
    pwr_indsquare68.setShadow(1);
    localPanel.add(pwr_indsquare68, new Proportion(pwr_indsquare68.getBounds(), dsize));
    pwr_mbsimulate69 = new pwr_mbsimulate(session);
    pwr_mbsimulate69.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate69, new Proportion(pwr_mbsimulate69.getBounds(), dsize));
    pwr_indsquare70 = new pwr_indsquare(session);
    pwr_indsquare70.setBounds(new Rectangle(162,379,14,15));
    ...
    grp223_71 = new Grp223_(session);
    grp223_71.setBounds(new Rectangle(35,378,38,16));
    localPanel.add(grp223_71, new Proportion(grp223_71.getBounds(), dsize));
    pwr_pumpanim273 = new pwr_pumpanim2(session);
    pwr_pumpanim273.setBounds(new Rectangle(118,96,62,42));
    pwr_pumpanim273.setShadow(1);
    pwr_pumpanim273.setGradient(12);
    localPanel.add(pwr_pumpanim273, new Proportion(pwr_pumpanim273.getBounds(), dsize));
    pwr_pump374 = new pwr_pump3(session);
    pwr_pump374.setBounds(new Rectangle(78,405,82,72));
    pwr_pump374.setColorTone(7);
    localPanel.add(pwr_pump374, new Proportion(pwr_pump374.getBounds(), dsize));
    pwr_rodcouplinganim75 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim75.setBounds(new Rectangle(155,431,10,20));
    localPanel.add(pwr_rodcouplinganim75, new Proportion(pwr_rodcouplinganim75.getBounds(), dsize));
    grp228_76 = new Grp228_(session);
    grp228_76.setBounds(new Rectangle(36,197,39,16));
    localPanel.add(grp228_76, new Proportion(grp228_76.getBounds(), dsize));
    ...
    pwr_valuelong22.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong22.dd, "$object.Specification##String80","%s")
      });
    ...
    pwr_indsquare25.dd.setDynType(5);
    pwr_indsquare25.dd.setActionType(0);
    pwr_indsquare25.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare25.dd, "$object.Ready##Boolean",29)
      });
    pwr_indsquare28.dd.setDynType(5);
    pwr_indsquare28.dd.setActionType(0);
    pwr_indsquare28.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare28.dd, "$object.ExtInterlock##Boolean",29)
      });
    pwr_valuesmall31.dd.setDynType(1025);
    pwr_valuesmall31.dd.setActionType(0);
    pwr_valuesmall31.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall31.dd, "$object.RunTimeCounter.TotalNOfStarts##UInt32","%d")
      });
    pwr_valuesmall32.dd.setDynType(1025);
    pwr_valuesmall32.dd.setActionType(0);
    pwr_valuesmall32.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall32.dd, "$object.RunTimeCounter.TotalRunTime##DeltaTime","%1t")
      });
    pwr_menubar233.dd.setDynType(1);
    pwr_menubar233.dd.setActionType(0);
    pwr_pulldownmenu234.dd.setDynType(0);
    ...
    new GeDyn(pwr_pulldownmenu234,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu234.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu234.setAnnot1("File");
    ...
    new GeDyn(pwr_pulldownmenu235,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu235.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu235.setAnnot1("Help");
    ...
    pwr_pulldownmenu236.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu236.dd, new String[] {
        JopLang.transl("FrequencyConverter.ActSpeed"),null,null,null,null,JopLang.transl("FrequencyConverter.ActTorque"),JopLang.transl("FrequencyConverter.ActCurrent"),JopLang.transl("FrequencyConverter.RefSpeed"),JopLang.transl("Motor.TempSwitch.Switch Di"),JopLang.transl("Motor.TempSensor.Value Ai"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu236,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu236.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu236,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu236.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu236.setAnnot1("Signals");
    ...
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu237.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu237.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu237.setAnnot1("Methods");
...
null,null,null,    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu238.setAnnot1("Components");
    pwr_motor239.dd.setDynType(0);
    pwr_motor239.dd.setActionType(66);
    pwr_motor239.dd.setAccess(65535);
    ...
    bcomp_fc40.dd.setDynType(1);
    bcomp_fc40.dd.setActionType(66);
    bcomp_fc40.dd.setAccess(65535);
    bcomp_fc40.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc40.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc40.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_indsquare49.dd.setDynType(117);
    pwr_indsquare49.dd.setActionType(2);
    pwr_indsquare49.dd.setAccess(65532);
    pwr_indsquare49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare49.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare49.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare49.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare49.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare49.dd, "$object.FrequencyConverter")
      });
    pwr_smallbuttoncenter53.dd.setDynType(1);
    pwr_smallbuttoncenter53.dd.setActionType(4);
    pwr_smallbuttoncenter53.dd.setAccess(65532);
    pwr_smallbuttoncenter53.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter53.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter53.setAnnot1("Reset");
    pwr_valuemedium54.dd.setDynType(1024);
    ...
    pwr_valuemedium54.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium54.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium54.dd, "$object.FrequencyConverter.ActSpeed")
      });
    pwr_valuemedium55.dd.setDynType(1025);
    ...
    pwr_valuemedium55.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium55.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium55.dd, "$object.FrequencyConverter.ActTorque")
      });
    ...
    pwr_valuemedium64.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium64.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium64.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    pwr_indsquare68.dd.setDynType(5);
    pwr_indsquare68.dd.setActionType(0);
    pwr_indsquare68.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare68.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate69.dd.setDynType(129);
    pwr_mbsimulate69.dd.setActionType(8256);
    pwr_mbsimulate69.dd.setAccess(65532);
    pwr_mbsimulate69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate69.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate69.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate69.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare70.dd.setDynType(176);
    pwr_indsquare70.dd.setActionType(2);
    pwr_indsquare70.dd.setAccess(65532);
    pwr_indsquare70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare70.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare70.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare70.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare70.dd, "$object.Motor")
      });
    grp223_71.dd.setDynType(129);
    grp223_71.dd.setActionType(0);
    grp223_71.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_71.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim273.dd.setDynType(66612);
    pwr_pumpanim273.dd.setActionType(0);
    pwr_pumpanim273.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim273.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim273.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim273.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim273.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim273.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump374.dd.setDynType(1);
    pwr_pump374.dd.setActionType(66);
    pwr_pump374.dd.setAccess(65532);
    pwr_pump374.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump374.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump374.dd, "open graph/class/inst=$object.Pump")
      });
    ...
    grp228_76.dd.setDynType(129);
    grp228_76.dd.setActionType(0);
    grp228_76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_76.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {408, 408, 404, 376, 404, 408}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 445);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 445);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 427);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 463);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 463);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 11, 16}, new int[] { 8, 8, 11,-50}, 4),
    ...
    new Polygon( new int[] { 6, 9, 177, 16}, new int[] { 40, 36, -1219915426,-50}, 4),
    ...
    new Polygon( new int[] { 6, 11, 11, 16}, new int[] { 46, 46, 54,-50}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915359, 16}, new int[] { 10, 12, -1219915426,-50}, 4),
    ...
    new Polygon( new int[] { 6, 11, -1219915359, 16}, new int[] { 14, 17, -1219915426,-50}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 34, 34}, new int[] { 12, 13, 36,-20}, 4),
