...
public class JopcBasefcppo5param extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasefcppo5param( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5param( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5param");
    pwr_menubar23 = new pwr_menubar2(session);
    pwr_menubar23.setBounds(new Rectangle(1,1,404,22));
    ...
    pwr_pulldownmenu25.setBounds(new Rectangle(318,1,67,22));
    ...
    pwr_smallbuttoncenter7.setBounds(new Rectangle(20,113,55,21));
    ...
    pwr_valuemedium8.setBounds(new Rectangle(98,147,62,22));
    ...
    pwr_valuemedium10.setBounds(new Rectangle(122,246,62,22));
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(216,113,55,21));
    ...
    pwr_valueinputmediumrd17.setBounds(new Rectangle(119,68,68,28));
    ...
    pwr_valueinputmediumrd18.setBounds(new Rectangle(298,142,67,28));
    ...
    pwr_valuemedium19.setBounds(new Rectangle(301,246,62,22));
    ...
    pwr_indsquare21.setBounds(new Rectangle(100,250,14,15));
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(216,301,55,21));
    ...
    pwr_valuemedium23.setBounds(new Rectangle(98,174,62,22));
    ...
    pwr_valuemedium24.setBounds(new Rectangle(23,201,136,22));
