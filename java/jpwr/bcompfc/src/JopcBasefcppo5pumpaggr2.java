...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 19, -5}, new int[] { 40, 36, -1219980886,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980917, -5}, new int[] { 10, 14, -1219980886,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980917, -5}, new int[] { 14, 19, -1219980886,25}, 4),
