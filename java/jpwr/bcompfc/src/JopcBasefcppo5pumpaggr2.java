...
public class JopcBasefcppo5pumpaggr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc89;
  pwr_mbup	pwr_mbup90;
  public JopcBasefcppo5pumpaggr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr2");
    ...
    bcomp_fc89.setBounds(new Rectangle(256,382,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pumpanim279.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim279.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim279.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim279.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -5}, new int[] { 8, 10, 13,25}, 4),
    ...
    new Polygon( new int[] { 6, 7, -5, -5}, new int[] { 40, 36, 25,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -5}, new int[] { 46, 46, 54,25}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915381, -5}, new int[] { 10, 14, -1219915350,25}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893314, -5}, new int[] { 14, 19, 144126449,25}, 4),
