...
public class JopcBasefcppo3pumpaggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc81;
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3pumpaggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr16");
    ...
    pwr_valuemedium59.setBounds(new Rectangle(356,562,20,14));
    ...
    pwr_indsquare68.setBounds(new Rectangle(161,524,16,17));
    ...
    grp221_69.setBounds(new Rectangle(34,523,40,18));
    ...
    pwr_pump372.setBounds(new Rectangle(75,550,84,74));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -21}, new int[] { 8, 8, 11,-3}, 4),
    ...
    new Polygon( new int[] { 6, 7, 971, -21}, new int[] { 40, 36, -1220222579,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -21}, new int[] { 46, 46, 54,-3}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222597, -21}, new int[] { 10, 12, -1220222579,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893298, -21}, new int[] { 14, 17, 144130516,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222579, -3}, new int[] { 12, 15, -1220222549,26}, 4),
