...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 39, -17}, new int[] { 40, 36, -1220222563,12}, 4),
    ...
    new Polygon( new int[] { 54, 56, 150689606, -17}, new int[] { 10, 13, 40,12}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222593, -17}, new int[] { 14, 17, -1220222563,12}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222575, 0}, new int[] { 12, 15, -1220222533,42}, 4),
