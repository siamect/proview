...
public class JopcBasefcppo3fanaggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo3fanaggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr15");
    ...
    pwr_valuemedium58.setBounds(new Rectangle(358,565,20,14));
    ...
    pwr_indsquare67.setBounds(new Rectangle(161,527,16,16));
    ...
    pwr_rod71.setBounds(new Rectangle(131,584,39,10));
    ...
    pwr_fananim72.setBounds(new Rectangle(119,544,19,91));
    pwr_fananim72.setShadow(1);
    localPanel.add(pwr_fananim72, new Proportion(pwr_fananim72.getBounds(), dsize));
    grp230_73 = new Grp230_(session);
    grp230_73.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp230_73, new Proportion(grp230_73.getBounds(), dsize));
    ...
    bcomp_fc81.setBounds(new Rectangle(255,392,64,84));
    ...
    pwr_safetyswitch82.setBounds(new Rectangle(268,488,38,39));
    ...
    pwr_mbup83.setBounds(new Rectangle(347,24,19,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp230_73.dd.setDynType(129);
    grp230_73.dd.setActionType(0);
    grp230_73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_73.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 145580334, -9}, new int[] { 12, 15, 144057515,27}, 4),
