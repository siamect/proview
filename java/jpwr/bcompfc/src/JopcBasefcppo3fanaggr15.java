...
public class JopcBasefcppo3fanaggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium58.setBounds(new Rectangle(359,566,18,12));
    ...
    pwr_indsquare67.setBounds(new Rectangle(162,528,14,14));
    ...
    pwr_rod71.setBounds(new Rectangle(132,585,37,8));
    ...
    pwr_fananim72.setBounds(new Rectangle(120,545,17,89));
    ...
    grp230_73.setBounds(new Rectangle(37,197,39,16));
    ...
    bcomp_fc81.setBounds(new Rectangle(256,393,62,82));
    ...
    pwr_safetyswitch82.setBounds(new Rectangle(269,489,36,37));
    ...
    pwr_mbup83.setBounds(new Rectangle(348,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915385, -9}, new int[] { 12, 15, -1219915348,27}, 4),
