...
public class JopcBasefcppo3motoraggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare9.setBounds(new Rectangle(161,446,16,16));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(4,601,48,21));
    ...
    pwr_valuelong27.setBounds(new Rectangle(60,600,336,23));
    ...
    pwr_safetyswitch30.setBounds(new Rectangle(198,434,38,39));
    ...
    pwr_indsquare53.setBounds(new Rectangle(161,350,16,16));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(36,369,57,23));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,510,51,17));
    ...
    pwr_rodcouplinganim68.setBounds(new Rectangle(154,527,12,22));
    ...
    pwr_indsquare70.setBounds(new Rectangle(161,475,16,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857021, -10}, new int[] { 12, 15, 158591241,41}, 4),
