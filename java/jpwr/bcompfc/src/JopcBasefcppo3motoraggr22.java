...
public class JopcBasefcppo3motoraggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup76;
  public JopcBasefcppo3motoraggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr22");
    ...
    pwr_indsquare9.setBounds(new Rectangle(162,447,14,14));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(5,602,46,19));
    ...
    pwr_valuelong27.setBounds(new Rectangle(61,601,334,21));
    ...
    pwr_safetyswitch30.setBounds(new Rectangle(199,435,36,37));
    ...
    pwr_indsquare53.setBounds(new Rectangle(162,351,14,14));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,370,55,21));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,511,49,15));
    ...
    pwr_rodcouplinganim68.setBounds(new Rectangle(155,528,10,20));
    ...
    pwr_indsquare70.setBounds(new Rectangle(162,476,14,14));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("StartLock"),36, 458);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915386, -10}, new int[] { 12, 15, -1219915334,41}, 4),
