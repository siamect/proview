...
public class JopcBasefcppo3fanaggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo3fanaggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr7");
    ...
    grp221_77.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_rod80.setBounds(new Rectangle(128,528,39,10));
    ...
    pwr_fananim81.setBounds(new Rectangle(116,488,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 145580363, 19}, new int[] { 12, 15, 144057537,49}, 4),
