...
public class JopcBasefcppo3fanaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp221_77.setBounds(new Rectangle(35,471,38,16));
    ...
    pwr_rod80.setBounds(new Rectangle(129,529,37,8));
    ...
    pwr_fananim81.setBounds(new Rectangle(117,489,17,89));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915356, 19}, new int[] { 12, 15, -1219915326,49}, 4),
