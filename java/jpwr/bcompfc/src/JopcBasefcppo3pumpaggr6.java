...
public class JopcBasefcppo3pumpaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,442,14,14));
    ...
    pwr_motor243.setBounds(new Rectangle(161,496,96,72));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,365,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,506,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(359,509,18,12));
    ...
    pwr_indsquare70.setBounds(new Rectangle(162,471,14,14));
    ...
    grp223_71.setBounds(new Rectangle(35,470,38,16));
    ...
    pwr_pump374.setBounds(new Rectangle(78,497,82,72));
    ...
    grp227_76.setBounds(new Rectangle(36,197,39,16));
    ...
    pwr_contactor281.setBounds(new Rectangle(268,287,36,36));
    ...
    pwr_safetyswitch83.setBounds(new Rectangle(269,432,36,37));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -16, -16}, new int[] { 40, 36, 7,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, 159979487, -16}, new int[] { 10, 12, 144033783,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, -16, -16}, new int[] { 14, 17, 7,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915374, 1}, new int[] { 12, 15, -1219915338,37}, 4),
