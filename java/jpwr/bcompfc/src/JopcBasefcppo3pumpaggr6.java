...
public class JopcBasefcppo3pumpaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor281;
  bcomp_fc	bcomp_fc82;
  pwr_safetyswitch	pwr_safetyswitch83;
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo3pumpaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr6");
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,441,16,16));
    ...
    pwr_motor243.setBounds(new Rectangle(160,495,98,74));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(308,505,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(358,508,20,14));
    ...
    pwr_indsquare70.setBounds(new Rectangle(161,470,16,16));
    ...
    grp223_71.setBounds(new Rectangle(34,469,40,18));
    ...
    pwr_pump374.setBounds(new Rectangle(77,496,84,74));
    ...
    grp227_76.setBounds(new Rectangle(35,196,41,18));
    ...
    pwr_contactor281 = new pwr_contactor2(session);
    pwr_contactor281.setBounds(new Rectangle(267,286,38,38));
    pwr_contactor281.setFillColor(32);
    pwr_contactor281.setShadow(1);
    localPanel.add(pwr_contactor281, new Proportion(pwr_contactor281.getBounds(), dsize));
    ...
    pwr_safetyswitch83 = new pwr_safetyswitch(session);
    pwr_safetyswitch83.setBounds(new Rectangle(268,431,38,39));
    pwr_safetyswitch83.setFillColor(32);
    pwr_safetyswitch83.setShadow(1);
    localPanel.add(pwr_safetyswitch83, new Proportion(pwr_safetyswitch83.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_contactor281.dd.setDynType(32769);
    pwr_contactor281.dd.setActionType(66);
    pwr_contactor281.dd.setAccess(65535);
    pwr_contactor281.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor281.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor281.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor281.dd, "open graph /class/instance=$object.Contactor")
      });
    ...
    pwr_safetyswitch83.dd.setDynType(32769);
    pwr_safetyswitch83.dd.setActionType(66);
    pwr_safetyswitch83.dd.setAccess(65535);
    pwr_safetyswitch83.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch83.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch83.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch83.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Contactor",36, 310);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SafetySwitch",36, 453);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -16}, new int[] { 8, 8, 11,7}, 4),
    ...
    new Polygon( new int[] { 6, 7, 264, -16}, new int[] { 40, 36, -1220222568,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -16}, new int[] { 46, 46, 54,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222592, -16}, new int[] { 10, 12, -1220222568,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222592, -16}, new int[] { 14, 17, -1220222568,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140859529, 1}, new int[] { 12, 15, 148762797,37}, 4),
