...
public class JopcBasefcppo3pumpaggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,496,14,14));
    ...
    pwr_motor243.setBounds(new Rectangle(161,550,96,72));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(240,174,34,19));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(240,198,34,19));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,400,14,15));
    ...
    pwr_indround56.setBounds(new Rectangle(286,174,15,16));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,419,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,560,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(359,563,18,12));
    ...
    pwr_indsquare68.setBounds(new Rectangle(358,200,14,15));
    ...
    pwr_indsquare70.setBounds(new Rectangle(162,525,14,15));
    ...
    pwr_pump374.setBounds(new Rectangle(78,551,82,72));
    ...
    pwr_contactor283.setBounds(new Rectangle(268,341,36,36));
    ...
    bcomp_fc84.setBounds(new Rectangle(256,390,62,82));
    ...
    pwr_safetyswitch85.setBounds(new Rectangle(269,486,36,37));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 118, 5}, new int[] { 40, 36, -1219915353,22}, 4),
    ...
    new Polygon( new int[] { 54, 56, 9, 5}, new int[] { 10, 14, 54,22}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915370, 5}, new int[] { 14, 19, -1219915353,22}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915352, 23}, new int[] { 12, 15, -1219915323,52}, 4),
