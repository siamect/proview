...
public class JopcBasefcppo5sim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasefcppo5sim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5sim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5sim");
    pwr_smallbuttoncenter2 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter2.setBounds(new Rectangle(263,138,34,18));
    ...
    pwr_indsquare3.setBounds(new Rectangle(230,140,13,14));
    ...
    pwr_smallbuttoncenter5.setBounds(new Rectangle(263,93,34,18));
    ...
    pwr_indsquare6.setBounds(new Rectangle(230,95,13,14));
    ...
    pwr_smallbuttoncenter8.setBounds(new Rectangle(263,162,34,18));
    ...
    pwr_indsquare9.setBounds(new Rectangle(230,164,13,14));
    ...
    pwr_smallbuttoncenter11.setBounds(new Rectangle(263,186,34,18));
    ...
    pwr_indsquare12.setBounds(new Rectangle(230,188,13,14));
    ...
    pwr_indsquare15.setBounds(new Rectangle(230,116,13,14));
    ...
    pwr_smallbuttoncenter16.setBounds(new Rectangle(263,115,34,18));
    ...
    pwr_menubar217.setBounds(new Rectangle(3,4,312,21));
    ...
    pwr_pulldownmenu218.setBounds(new Rectangle(14,4,64,21));
    ...
    pwr_pulldownmenu219.setBounds(new Rectangle(237,4,64,21));
    ...
    pwr_mbopenobject20.setBounds(new Rectangle(29,28,17,17));
    ...
    pwr_mbopenplc21.setBounds(new Rectangle(48,28,17,17));
    ...
    pwr_mbrtnavigator22.setBounds(new Rectangle(10,28,17,17));
    ...
    pwr_mbhelpclass23.setBounds(new Rectangle(68,28,17,17));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(70,4,64,21));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseFcPPO5",18, 68);
    g.setColor(GeColor.getColor(3, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
