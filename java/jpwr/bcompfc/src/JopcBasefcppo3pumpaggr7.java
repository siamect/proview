...
public class JopcBasefcppo3pumpaggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc83;
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo3pumpaggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr7");
    ...
    pwr_valuemedium62.setBounds(new Rectangle(357,510,18,12));
    ...
    pwr_indsquare71.setBounds(new Rectangle(162,472,14,14));
    ...
    grp221_72.setBounds(new Rectangle(35,471,38,16));
    ...
    pwr_pump375.setBounds(new Rectangle(76,498,82,72));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(153,524,10,20));
    localPanel.add(pwr_rodcouplinganim76, new Proportion(pwr_rodcouplinganim76.getBounds(), dsize));
    grp225_77 = new Grp225_(session);
    grp225_77.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp225_77, new Proportion(grp225_77.getBounds(), dsize));
    ...
    bcomp_fc83.setBounds(new Rectangle(256,337,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp225_77.dd.setDynType(129);
    grp225_77.dd.setActionType(0);
    grp225_77.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp225_77.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, 2}, new int[] { 8, 8, 11,2}, 4),
    ...
    new Polygon( new int[] { 6, 7, 83, 2}, new int[] { 40, 36, -1219915373,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 2}, new int[] { 46, 46, 54,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915373, 2}, new int[] { 10, 12, -1219915373,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 160162490, 2}, new int[] { 14, 17, 144033778,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915355, 20}, new int[] { 12, 15, -1219915343,32}, 4),
