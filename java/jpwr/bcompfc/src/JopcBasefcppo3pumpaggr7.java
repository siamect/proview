...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 203, 2}, new int[] { 40, 36, -1220222573,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222573, 2}, new int[] { 10, 12, -1220222573,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222573, 2}, new int[] { 14, 17, -1220222573,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222555, 20}, new int[] { 12, 15, -1220222543,32}, 4),
