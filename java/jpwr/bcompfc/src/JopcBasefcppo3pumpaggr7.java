...
public class JopcBasefcppo3pumpaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium62.setBounds(new Rectangle(356,509,20,14));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,471,16,16));
    ...
    grp221_72.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_pump375.setBounds(new Rectangle(75,497,84,74));
    ...
    bcomp_fc83.setBounds(new Rectangle(255,336,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 75, 2}, new int[] { 40, 36, -1219980909,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980909, 2}, new int[] { 10, 12, -1219980909,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219980909, 2}, new int[] { 14, 17, -1219980909,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980891, 20}, new int[] { 12, 15, -1219980879,32}, 4),
