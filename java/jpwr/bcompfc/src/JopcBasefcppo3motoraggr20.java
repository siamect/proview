...
public class JopcBasefcppo3motoraggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo3motoraggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr20");
    pwr_indsquare8 = new pwr_indsquare(session);
    pwr_indsquare8.setBounds(new Rectangle(162,350,14,14));
    ...
    pwr_mbnote23.setBounds(new Rectangle(36,25,18,18));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(5,606,46,19));
    ...
    pwr_valuelong27.setBounds(new Rectangle(61,609,334,21));
    ...
    pwr_contactor230.setBounds(new Rectangle(268,340,36,36));
    pwr_contactor230.setFillColor(32);
    ...
    pwr_valuemedium61.setBounds(new Rectangle(307,513,49,15));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(357,516,18,12));
    ...
    pwr_fuse376.setBounds(new Rectangle(281,295,13,35));
    ...
    grp224_77.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_contactor230.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor230.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor230.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor230.dd, "open graph /class/instance=$object.Contactor")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 363);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 410);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915393, -17}, new int[] { 12, 15, -1219915336,39}, 4),
