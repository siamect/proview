...
public class JopcBasefcppo3motoraggr20 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,349,16,16));
    ...
    pwr_mbnote23.setBounds(new Rectangle(35,24,20,20));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(4,605,48,21));
    ...
    pwr_valuelong27.setBounds(new Rectangle(60,608,336,23));
    ...
    pwr_contactor230.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(306,512,51,17));
    ...
    pwr_fuse376.setBounds(new Rectangle(280,294,15,37));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980929, -17}, new int[] { 12, 15, -1219980872,39}, 4),
