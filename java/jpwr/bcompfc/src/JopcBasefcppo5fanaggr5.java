...
public class JopcBasefcppo5fanaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbnote22.setBounds(new Rectangle(35,24,20,20));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,548,48,21));
    ...
    grp210_63.setBounds(new Rectangle(126,227,41,18));
    ...
    bcomp_fc82.setBounds(new Rectangle(255,335,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980935, -23}, new int[] { 12, 15, -1219980883,28}, 4),
