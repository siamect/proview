...
public class JopcBasefcppo5fanaggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc82;
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5fanaggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr5");
    ...
    pwr_mbnote22.setBounds(new Rectangle(36,25,18,18));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,549,46,19));
    ...
    grp210_63.setBounds(new Rectangle(127,228,39,16));
    ...
    bcomp_fc82 = new bcomp_fc(session);
    bcomp_fc82.setBounds(new Rectangle(256,336,62,82));
    bcomp_fc82.setShadow(1);
    localPanel.add(bcomp_fc82, new Proportion(bcomp_fc82.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc82.dd.setDynType(1);
    bcomp_fc82.dd.setActionType(66);
    bcomp_fc82.dd.setAccess(65535);
    bcomp_fc82.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc82.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc82.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915399, -23}, new int[] { 12, 15, -1219915347,28}, 4),
