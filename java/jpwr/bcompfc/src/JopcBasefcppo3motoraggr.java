...
public class JopcBasefcppo3motoraggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare14.setBounds(new Rectangle(161,487,16,16));
    ...
    pwr_safetyswitch37.setBounds(new Rectangle(268,477,38,39));
    ...
    pwr_motor250.setBounds(new Rectangle(160,541,98,74));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(308,551,51,17));
    ...
    pwr_valuemedium69.setBounds(new Rectangle(358,554,20,14));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(154,568,12,22));
    ...
    pwr_motorman79.setBounds(new Rectangle(114,95,64,44));
    ...
    grp225_82.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_smallbuttoncenter83.setBounds(new Rectangle(33,196,48,21));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 159137551, 0}, new int[] { 12, 15, 144032830,30}, 4),
