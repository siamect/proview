...
public class JopcBasefcppo3motoraggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,350,14,14));
    ...
    pwr_indsquare13.setBounds(new Rectangle(162,495,14,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,650,45,18));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,649,334,21));
    ...
    pwr_contactor234.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(269,485,36,37));
    ...
    pwr_indsquare60.setBounds(new Rectangle(162,399,14,15));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(37,418,55,21));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(309,559,49,15));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(359,562,18,12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 158521855, 0}, new int[] { 12, 15, 144033819,43}, 4),
