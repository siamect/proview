...
public class JopcBasefcppo3motoraggr18 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo3motoraggr18( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr18( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr18");
    pwr_indsquare10 = new pwr_indsquare(session);
    pwr_indsquare10.setBounds(new Rectangle(161,349,16,16));
    ...
    pwr_indsquare13.setBounds(new Rectangle(161,494,16,17));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,649,47,20));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,648,336,23));
    ...
    pwr_contactor234.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(268,484,38,39));
    ...
    pwr_indsquare60.setBounds(new Rectangle(161,398,16,17));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(36,417,57,23));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,558,51,17));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(358,561,20,14));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(154,575,12,22));
    ...
    pwr_indsquare78.setBounds(new Rectangle(161,523,16,17));
    ...
    grp227_82.setBounds(new Rectangle(36,196,41,18));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SafetySwitch",36, 506);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222576, 0}, new int[] { 12, 15, -1220222532,43}, 4),
