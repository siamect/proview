...
public class JopcBasefcppo5motoraggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motorman	pwr_motorman71;
  pwr_indsquare	pwr_indsquare72;
  Grp223_	grp223_73;
  Grp226_	grp226_74;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter75;
  pwr_mbup	pwr_mbup77;
  public JopcBasefcppo5motoraggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr11");
    ...
    pwr_rodcouplinganim70.setBounds(new Rectangle(155,431,10,19));
    localPanel.add(pwr_rodcouplinganim70, new Proportion(pwr_rodcouplinganim70.getBounds(), dsize));
    pwr_motorman71 = new pwr_motorman(session);
    pwr_motorman71.setBounds(new Rectangle(115,96,62,42));
    pwr_motorman71.setShadow(1);
    pwr_motorman71.setGradient(12);
    localPanel.add(pwr_motorman71, new Proportion(pwr_motorman71.getBounds(), dsize));
    pwr_indsquare72 = new pwr_indsquare(session);
    pwr_indsquare72.setBounds(new Rectangle(162,379,14,15));
    ...
    grp223_73.setBounds(new Rectangle(35,378,38,16));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman71.dd.setDynType(1077);
    pwr_motorman71.dd.setActionType(0);
    pwr_motorman71.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman71.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman71.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman71.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_motorman71.dd, "$object.Mode.IndMode##String8","%s")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915367, 8}, new int[] { 12, 15, -1219915358,17}, 4),
