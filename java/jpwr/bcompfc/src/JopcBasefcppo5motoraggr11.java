...
public class JopcBasefcppo5motoraggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim70.setBounds(new Rectangle(154,430,12,21));
    ...
    pwr_motorman71.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,378,16,17));
    ...
    grp223_73.setBounds(new Rectangle(34,377,40,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 8, 8}, new int[] { 12, 15, 498,17}, 4),
