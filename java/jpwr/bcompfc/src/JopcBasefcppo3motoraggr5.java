...
public class JopcBasefcppo3motoraggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,548,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,547,336,23));
    ...
    pwr_manswitch331.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_indsquare54.setBounds(new Rectangle(161,345,16,16));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,457,51,17));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(152,474,12,21));
    ...
    grp224_73.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980912, 0}, new int[] { 12, 15, -1219980869,42}, 4),
