...
public class JopcBasefcppo3motoraggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup75;
  public JopcBasefcppo3motoraggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr5");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,549,45,19));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,548,334,21));
    ...
    pwr_manswitch331.setBounds(new Rectangle(268,285,36,36));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,346,14,14));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,458,49,15));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(153,475,10,19));
    ...
    grp224_73 = new Grp224_(session);
    grp224_73.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp224_73, new Proportion(grp224_73.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp224_73.dd.setDynType(129);
    grp224_73.dd.setActionType(0);
    grp224_73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp224_73.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915376, 0}, new int[] { 12, 15, -1219915333,42}, 4),
