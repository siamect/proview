...
public class JopcBasefcppo5fanaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo5fanaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr8");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,554,46,19));
    ...
    pwr_fananim83.setBounds(new Rectangle(119,443,17,89));
    pwr_fananim83.setShadow(1);
    localPanel.add(pwr_fananim83, new Proportion(pwr_fananim83.getBounds(), dsize));
    grp226_84 = new Grp226_(session);
    grp226_84.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_84, new Proportion(grp226_84.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim281.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim281.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim281.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim281.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim83.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim83.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim83.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim83.dd, "open graph/class/inst=$object.Fan")
      });
    grp226_84.dd.setDynType(129);
    grp226_84.dd.setActionType(0);
    grp226_84.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_84.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915385, -9}, new int[] { 12, 15, -1219915337,38}, 4),
