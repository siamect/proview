...
public class JopcBasefcppo5fanaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,553,48,21));
    ...
    pwr_fananim281.setBounds(new Rectangle(115,95,64,44));
    ...
    pwr_rod82.setBounds(new Rectangle(130,482,39,10));
    ...
    pwr_fananim83.setBounds(new Rectangle(118,442,19,91));
    ...
    grp226_84.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -9, -9}, new int[] { 12, 15, 479,38}, 4),
