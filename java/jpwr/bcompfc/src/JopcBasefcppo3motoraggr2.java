...
public class JopcBasefcppo3motoraggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,593,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,592,334,21));
    ...
    pwr_indsquare60.setBounds(new Rectangle(162,392,14,14));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(37,411,55,21));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(309,502,49,15));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(359,505,18,12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915358, 17}, new int[] { 12, 15, -1219915317,58}, 4),
