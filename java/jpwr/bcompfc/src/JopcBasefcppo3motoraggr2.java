...
public class JopcBasefcppo3motoraggr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3motoraggr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr2");
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,592,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,591,336,23));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(36,410,57,23));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,501,51,17));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(358,504,20,14));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222558, 17}, new int[] { 12, 15, -1220222517,58}, 4),
