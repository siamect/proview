...
public class JopcBasefcppo3pumpaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium55.setBounds(new Rectangle(358,416,20,14));
    ...
    pwr_valueinputmediumrd58.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_59.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_59, new Proportion(grp210_59.getBounds(), dsize));
    grp212_60 = new Grp212_(session);
    grp212_60.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_indsquare62.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_pump368.setBounds(new Rectangle(77,404,84,74));
    ...
    pwr_smallbuttoncenter71.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_mbup73.setBounds(new Rectangle(346,24,20,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 23, -9}, new int[] { 40, 36, -1219980900,11}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980921, -9}, new int[] { 10, 13, -1219980900,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, -9, -9}, new int[] { 14, 17, 84,11}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980903, 8}, new int[] { 12, 15, -1219980870,41}, 4),
