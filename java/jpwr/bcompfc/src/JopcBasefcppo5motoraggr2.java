...
public class JopcBasefcppo5motoraggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_contactor285.setBounds(new Rectangle(267,332,38,38));
    ...
    bcomp_fc86.setBounds(new Rectangle(255,381,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222542, 33}, new int[] { 12, 15, -1220222525,50}, 4),
