...
public class JopcBasefcppo5motoraggr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup88;
  public JopcBasefcppo5motoraggr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr2");
    ...
    pwr_contactor285.setBounds(new Rectangle(268,333,36,36));
    ...
    bcomp_fc86 = new bcomp_fc(session);
    bcomp_fc86.setBounds(new Rectangle(256,382,62,82));
    bcomp_fc86.setShadow(1);
    localPanel.add(bcomp_fc86, new Proportion(bcomp_fc86.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    bcomp_fc86.dd.setDynType(1);
    bcomp_fc86.dd.setActionType(66);
    bcomp_fc86.dd.setAccess(65535);
    bcomp_fc86.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc86.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc86.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915342, 33}, new int[] { 12, 15, -1219915325,50}, 4),
