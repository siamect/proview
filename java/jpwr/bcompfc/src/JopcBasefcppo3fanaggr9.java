...
public class JopcBasefcppo3fanaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim272.setBounds(new Rectangle(119,95,64,44));
    ...
    pwr_rod73.setBounds(new Rectangle(132,485,39,10));
    ...
    pwr_fananim74.setBounds(new Rectangle(120,445,19,91));
    ...
    grp228_75.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_mbup77.setBounds(new Rectangle(348,24,20,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 48, 17}, new int[] { 12, 15, 83,51}, 4),
