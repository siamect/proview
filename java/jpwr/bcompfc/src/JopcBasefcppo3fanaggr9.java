...
public class JopcBasefcppo3fanaggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup77;
  public JopcBasefcppo3fanaggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr9");
    ...
    pwr_fananim74.setBounds(new Rectangle(121,446,17,89));
    pwr_fananim74.setShadow(1);
    localPanel.add(pwr_fananim74, new Proportion(pwr_fananim74.getBounds(), dsize));
    grp228_75 = new Grp228_(session);
    grp228_75.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp228_75, new Proportion(grp228_75.getBounds(), dsize));
    ...
    pwr_mbup77.setBounds(new Rectangle(349,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim272.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim272.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim272.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim272.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim74.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim74.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim74.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim74.dd, "open graph/class/inst=$object.Fan")
      });
    grp228_75.dd.setDynType(129);
    grp228_75.dd.setActionType(0);
    grp228_75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_75.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 412);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915358, 17}, new int[] { 12, 15, -1219915324,51}, 4),
