...
public class JopcBasefcppo3fanaggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc81;
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3fanaggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr16");
    ...
    pwr_valuemedium59.setBounds(new Rectangle(356,564,20,14));
    ...
    pwr_indsquare66.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_indsquare68.setBounds(new Rectangle(161,526,16,17));
    ...
    pwr_rod72.setBounds(new Rectangle(129,583,39,10));
    ...
    pwr_fananim73.setBounds(new Rectangle(117,543,19,91));
    pwr_fananim73.setShadow(1);
    localPanel.add(pwr_fananim73, new Proportion(pwr_fananim73.getBounds(), dsize));
    grp228_74 = new Grp228_(session);
    grp228_74.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp228_74, new Proportion(grp228_74.getBounds(), dsize));
    pwr_smallbuttoncenter75 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter75.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_manswitch380.setBounds(new Rectangle(267,340,38,38));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp228_74.dd.setDynType(129);
    grp228_74.dd.setActionType(0);
    grp228_74.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_74.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Circuit breaker",37, 365);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Startlock",37, 502);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Frequencyconverter",37, 414);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222524, 51}, new int[] { 12, 15, -1220222526,49}, 4),
