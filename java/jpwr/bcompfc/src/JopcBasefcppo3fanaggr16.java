...
public class JopcBasefcppo3fanaggr16 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium59.setBounds(new Rectangle(357,565,18,12));
    ...
    pwr_indsquare66.setBounds(new Rectangle(312,174,14,15));
    ...
    pwr_indsquare68.setBounds(new Rectangle(162,527,14,15));
    ...
    pwr_rod72.setBounds(new Rectangle(130,584,37,8));
    ...
    pwr_fananim73.setBounds(new Rectangle(118,544,17,89));
    ...
    grp228_74.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(34,197,45,19));
    ...
    pwr_manswitch380.setBounds(new Rectangle(268,341,36,36));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Circuit breaker"),37, 365);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),37, 502);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),37, 414);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("Speed"),263, 576);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140856123, 51}, new int[] { 12, 15, 157760745,49}, 4),
