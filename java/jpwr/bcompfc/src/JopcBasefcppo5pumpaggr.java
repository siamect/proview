...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 25, -15}, new int[] { 40, 36, -1220222564,11}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222591, -15}, new int[] { 10, 13, -1220222564,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, -15, -15}, new int[] { 14, 17, 11,11}, 4),
