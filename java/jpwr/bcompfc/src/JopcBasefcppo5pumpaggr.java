...
public class JopcBasefcppo5pumpaggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,487,16,16));
    ...
    pwr_motor245.setBounds(new Rectangle(160,541,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(161,391,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(36,410,57,23));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(308,551,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(308,569,51,17));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(358,554,20,14));
    ...
    pwr_valuemedium72.setBounds(new Rectangle(308,587,51,17));
    ...
    grp223_79.setBounds(new Rectangle(34,515,40,17));
    ...
    pwr_pump382.setBounds(new Rectangle(77,542,84,74));
    ...
    pwr_manswitch390.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_contactor291.setBounds(new Rectangle(267,332,38,38));
    ...
    bcomp_fc92.setBounds(new Rectangle(255,381,64,84));
    ...
    pwr_safetyswitch93.setBounds(new Rectangle(268,477,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219980927, -15}, new int[] { 10, 13, -1219980900,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, 164560384, -15}, new int[] { 14, 17, 144032811,11}, 4),
