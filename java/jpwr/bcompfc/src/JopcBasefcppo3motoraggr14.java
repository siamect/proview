...
public class JopcBasefcppo3motoraggr14 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,397,16,17));
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,351,16,17));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,647,48,20));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,646,336,23));
    ...
    pwr_manswitch334.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_contactor235.setBounds(new Rectangle(267,387,38,38));
    ...
    pwr_indsquare60.setBounds(new Rectangle(161,446,16,16));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(36,465,57,23));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,556,51,17));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(358,559,20,14));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -29, -29}, new int[] { 12, 15, 149,52}, 4),
