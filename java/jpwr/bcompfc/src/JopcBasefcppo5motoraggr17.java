...
public class JopcBasefcppo5motoraggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp221_74.setBounds(new Rectangle(34,476,40,17));
    ...
    pwr_fuse380.setBounds(new Rectangle(280,296,15,37));
    ...
    bcomp_fc82.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980899, 12}, new int[] { 12, 15, -1219980856,55}, 4),
