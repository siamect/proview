...
public class JopcBasefcppo5motoraggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc82;
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo5motoraggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr17");
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,478,14,15));
    ...
    grp221_74.setBounds(new Rectangle(35,477,38,15));
    ...
    pwr_fuse380.setBounds(new Rectangle(281,297,13,35));
    ...
    bcomp_fc82.setBounds(new Rectangle(256,391,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_rodcouplinganim71.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim71.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    ...
    pwr_motorman72.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman72.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915363, 12}, new int[] { 12, 15, -1219915320,55}, 4),
