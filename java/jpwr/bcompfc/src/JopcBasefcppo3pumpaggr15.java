...
public class JopcBasefcppo3pumpaggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcBasefcppo3pumpaggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -23}, new int[] { 8, 8, 11,-1}, 4),
    ...
    new Polygon( new int[] { 6, 7, 969, -23}, new int[] { 40, 36, -1220222577,-1}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -23}, new int[] { 46, 46, 54,-1}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222599, -23}, new int[] { 10, 12, -1220222577,-1}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893296, -23}, new int[] { 14, 17, 144130518,-1}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222581, -5}, new int[] { 12, 15, -1220222547,28}, 4),
