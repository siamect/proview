...
public class JopcBasefcppo3fanaggr19 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc85;
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo3fanaggr19( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr19( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr19");
    ...
    pwr_fananim274.setBounds(new Rectangle(114,96,62,42));
    ...
    pwr_rod75.setBounds(new Rectangle(129,583,37,8));
    ...
    pwr_fananim76.setBounds(new Rectangle(117,543,17,89));
    ...
    pwr_mbup86.setBounds(new Rectangle(348,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915353, 22}, new int[] { 12, 15, -1219915333,42}, 4),
