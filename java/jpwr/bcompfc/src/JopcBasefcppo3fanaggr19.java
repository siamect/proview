...
public class JopcBasefcppo3fanaggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim274.setBounds(new Rectangle(113,95,64,44));
    ...
    pwr_rod75.setBounds(new Rectangle(128,582,39,10));
    ...
    pwr_fananim76.setBounds(new Rectangle(116,542,19,91));
    ...
    pwr_mbup86.setBounds(new Rectangle(347,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980889, 22}, new int[] { 12, 15, -1219980869,42}, 4),
