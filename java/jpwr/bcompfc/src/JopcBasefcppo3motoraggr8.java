...
public class JopcBasefcppo3motoraggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup78;
  public JopcBasefcppo3motoraggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr8");
    ...
    grp210_67.setBounds(new Rectangle(127,228,39,16));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(153,478,10,20));
    ...
    grp223_76.setBounds(new Rectangle(37,197,39,16));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp223_76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_76.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915404, -28}, new int[] { 12, 15, -1219915347,28}, 4),
