...
public class JopcBasefcppo3motoraggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp210_67.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(152,477,12,22));
    ...
    grp223_76.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222604, -28}, new int[] { 12, 15, -1220222547,28}, 4),
