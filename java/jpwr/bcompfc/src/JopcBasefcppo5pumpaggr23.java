...
public class JopcBasefcppo5pumpaggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_70;
  pwr_pumpanim2	pwr_pumpanim272;
  pwr_pump3	pwr_pump373;
  ...
  bcomp_fc	bcomp_fc80;
  pwr_mbup	pwr_mbup81;
  public JopcBasefcppo5pumpaggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr23");
    ...
    pwr_valuemedium54.setBounds(new Rectangle(309,481,49,15));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(359,466,18,12));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(309,499,49,15));
    ...
    pwr_indsquare67.setBounds(new Rectangle(308,176,14,15));
    ...
    grp223_70.setBounds(new Rectangle(35,427,38,15));
    localPanel.add(grp223_70, new Proportion(grp223_70.getBounds(), dsize));
    pwr_pumpanim272 = new pwr_pumpanim2(session);
    pwr_pumpanim272.setBounds(new Rectangle(118,96,62,42));
    pwr_pumpanim272.setShadow(1);
    pwr_pumpanim272.setGradient(12);
    localPanel.add(pwr_pumpanim272, new Proportion(pwr_pumpanim272.getBounds(), dsize));
    pwr_pump373 = new pwr_pump3(session);
    pwr_pump373.setBounds(new Rectangle(78,454,82,72));
    pwr_pump373.setColorTone(7);
    localPanel.add(pwr_pump373, new Proportion(pwr_pump373.getBounds(), dsize));
    pwr_rodcouplinganim74 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim74.setBounds(new Rectangle(155,480,10,20));
    localPanel.add(pwr_rodcouplinganim74, new Proportion(pwr_rodcouplinganim74.getBounds(), dsize));
    grp229_75 = new Grp229_(session);
    grp229_75.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_fuse379.setBounds(new Rectangle(281,299,13,35));
    pwr_fuse379.setRotate(-90);
    pwr_fuse379.setShadow(1);
    localPanel.add(pwr_fuse379, new Proportion(pwr_fuse379.getBounds(), dsize));
    bcomp_fc80 = new bcomp_fc(session);
    bcomp_fc80.setBounds(new Rectangle(256,343,62,82));
    bcomp_fc80.setShadow(1);
    localPanel.add(bcomp_fc80, new Proportion(bcomp_fc80.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuemedium54.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium54.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium54.dd, "$object.FrequencyConverter.ActTorque")
      });
    ...
    pwr_valuemedium63.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium63.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium63.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    ...
    pwr_pumpanim272.dd.setDynType(66612);
    pwr_pumpanim272.dd.setActionType(0);
    pwr_pumpanim272.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim272.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim272.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim272.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim272.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim272.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump373.dd.setDynType(1);
    pwr_pump373.dd.setActionType(66);
    pwr_pump373.dd.setAccess(65532);
    pwr_pump373.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump373.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump373.dd, "open graph/class/inst=$object.Pump")
      });
    ...
    bcomp_fc80.dd.setDynType(1);
    bcomp_fc80.dd.setActionType(66);
    bcomp_fc80.dd.setAccess(65535);
    bcomp_fc80.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc80.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc80.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 10, 10}, new int[] { 8, 8, 11,-2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 10, 10}, new int[] { 40, 34, -2,-2}, 4),
    ...
    new Polygon( new int[] { 6, 10, 10, 10}, new int[] { 46, 46, 57,-2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915365, 10}, new int[] { 10, 12, -1219915378,-2}, 4),
    ...
    new Polygon( new int[] { 6, 10, 140893330, 10}, new int[] { 14, 17, 144126421,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915347, 28}, new int[] { 12, 15, -1219915348,27}, 4),
