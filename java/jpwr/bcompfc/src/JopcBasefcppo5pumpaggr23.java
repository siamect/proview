...
public class JopcBasefcppo5pumpaggr23 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium54.setBounds(new Rectangle(308,480,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(358,465,20,14));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(308,498,51,17));
    ...
    pwr_indsquare69.setBounds(new Rectangle(161,427,16,17));
    ...
    pwr_pump373.setBounds(new Rectangle(77,453,84,74));
    ...
    pwr_fuse379.setBounds(new Rectangle(280,298,15,37));
    ...
    bcomp_fc80.setBounds(new Rectangle(255,342,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 99, 10}, new int[] { 40, 34, -1220222578,-2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222565, 10}, new int[] { 10, 12, -1220222578,-2}, 4),
    ...
    new Polygon( new int[] { 6, 10, -1220222565, 10}, new int[] { 14, 17, -1220222578,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 28, 28}, new int[] { 12, 15, 92,27}, 4),
