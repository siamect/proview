...
public class JopcBasefcppo3pumpaggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch377;
  bcomp_fc	bcomp_fc78;
  pwr_mbup	pwr_mbup79;
  public JopcBasefcppo3pumpaggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr17");
    ...
    pwr_valuemedium56.setBounds(new Rectangle(357,516,18,12));
    ...
    pwr_indsquare65.setBounds(new Rectangle(162,478,14,15));
    ...
    grp221_66.setBounds(new Rectangle(35,477,38,15));
    ...
    pwr_pump369.setBounds(new Rectangle(76,504,82,72));
    ...
    pwr_rodcouplinganim70.setBounds(new Rectangle(153,530,10,20));
    localPanel.add(pwr_rodcouplinganim70, new Proportion(pwr_rodcouplinganim70.getBounds(), dsize));
    grp227_71 = new Grp227_(session);
    grp227_71.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp227_71, new Proportion(grp227_71.getBounds(), dsize));
    ...
    pwr_manswitch377 = new pwr_manswitch3(session);
    pwr_manswitch377.setBounds(new Rectangle(268,340,36,36));
    pwr_manswitch377.setFillColor(32);
    pwr_manswitch377.setShadow(1);
    localPanel.add(pwr_manswitch377, new Proportion(pwr_manswitch377.getBounds(), dsize));
    bcomp_fc78 = new bcomp_fc(session);
    bcomp_fc78.setBounds(new Rectangle(256,391,62,82));
    bcomp_fc78.setShadow(1);
    localPanel.add(bcomp_fc78, new Proportion(bcomp_fc78.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp227_71.dd.setDynType(129);
    grp227_71.dd.setActionType(0);
    grp227_71.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp227_71.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_manswitch377.dd.setDynType(32769);
    pwr_manswitch377.dd.setActionType(66);
    pwr_manswitch377.dd.setAccess(65535);
    pwr_manswitch377.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch377.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch377.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch377.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    bcomp_fc78.dd.setDynType(1);
    bcomp_fc78.dd.setActionType(66);
    bcomp_fc78.dd.setAccess(65535);
    bcomp_fc78.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc78.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc78.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),243, 187);
    {
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -1}, new int[] { 8, 10, 13,24}, 4),
    ...
    new Polygon( new int[] { 6, 7, 11, 10}, new int[] { 24, 24, 21,18}, 4),
    new Polygon( new int[] { 10, 11, 14, 14}, new int[] { 18, 21, 17,14}, 4),
    new Polygon( new int[] { 14, 14, 43, 44}, new int[] { 14, 17, 17,14}, 4),
    new Polygon( new int[] { 44, 43, 45, 46}, new int[] { 14, 17, 24,24}, 4),
    new Polygon( new int[] { 46, 45, 18, 18}, new int[] { 24, 24, 24,24}, 4),
    new Polygon( new int[] { 18, 18, 11, 12}, new int[] { 24, 24, 27,28}, 4),
    new Polygon( new int[] { 12, 11, 5, 10}, new int[] { 28, 27, 39,32}, 4),
    new Polygon( new int[] { 10, 5, 7, 6}, new int[] { 32, 39, 36,40}, 4),
    new Polygon( new int[] { 6, 7, -1, -1}, new int[] { 40, 36, 24,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -1}, new int[] { 46, 46, 54,24}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915377, -1}, new int[] { 10, 14, -1219915351,24}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1, -1}, new int[] { 14, 19, 24,24}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915359, 16}, new int[] { 12, 15, -1219915321,54}, 4),
