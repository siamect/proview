...
public class JopcBasefcppo3fanaggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(162,448,16,17));
    ...
    pwr_mbopenobject11.setBounds(new Rectangle(195,24,20,20));
    ...
    pwr_mbtrend12.setBounds(new Rectangle(56,24,20,20));
    ...
    pwr_mbfast13.setBounds(new Rectangle(76,24,20,20));
    ...
    pwr_mbrtnavigator18.setBounds(new Rectangle(175,24,20,20));
    ...
    pwr_mbblockevents20.setBounds(new Rectangle(155,24,20,20));
    ...
    pwr_mbnote22.setBounds(new Rectangle(36,24,19,20));
    ...
    pwr_indsquare27.setBounds(new Rectangle(349,96,16,17));
    ...
    pwr_safetyswitch29.setBounds(new Rectangle(198,436,38,39));
    ...
    pwr_indsquare31.setBounds(new Rectangle(349,117,16,17));
    ...
    pwr_valuesmall34.setBounds(new Rectangle(302,229,72,17));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(302,248,72,18));
    ...
    pwr_motor242.setBounds(new Rectangle(160,502,98,74));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(34,171,47,21));
    ...
    pwr_smallbuttoncenter46.setBounds(new Rectangle(124,172,61,21));
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(124,196,61,21));
    ...
    pwr_indround48.setBounds(new Rectangle(86,247,18,17));
    ...
    pwr_indround49.setBounds(new Rectangle(193,173,18,17));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(36,371,57,23));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,512,51,17));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(358,515,20,14));
    ...
    grp210_61.setBounds(new Rectangle(127,227,40,18));
    ...
    pwr_indsquare64.setBounds(new Rectangle(308,175,16,17));
    ...
    pwr_rod70.setBounds(new Rectangle(131,534,39,10));
    ...
    pwr_fananim71.setBounds(new Rectangle(119,494,19,91));
    ...
    grp230_72.setBounds(new Rectangle(37,196,41,18));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(34,196,47,21));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980868, 43}, new int[] { 12, 15, -1219980850,61}, 4),
