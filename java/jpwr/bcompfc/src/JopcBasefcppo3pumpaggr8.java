...
public class JopcBasefcppo3pumpaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium63.setBounds(new Rectangle(356,463,20,14));
    ...
    pwr_indsquare70.setBounds(new Rectangle(357,199,16,17));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,425,16,16));
    ...
    grp221_73.setBounds(new Rectangle(34,424,40,18));
    ...
    pwr_pump376.setBounds(new Rectangle(75,451,84,74));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu241.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu241.dd, new String[] {
        "Contactor.Order Do",null,"Contactor.Feedback Di",null,"FrequencyConverter.ActSpeed","FrequencyConverter.ActTorque",null,null,"Motor.TempSwitch.Switch Di","Motor.TempSensor.Value Ai",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 15, -17}, new int[] { 40, 36, -1220222557,18}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220222593, -17}, new int[] { 10, 14, -1220222557,18}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220222593, -17}, new int[] { 14, 18, -1220222557,18}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222575, 0}, new int[] { 12, 15, -1220222527,48}, 4),
