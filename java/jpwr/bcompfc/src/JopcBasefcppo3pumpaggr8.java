...
public class JopcBasefcppo3pumpaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup80;
  public JopcBasefcppo3pumpaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr8");
    ...
    pwr_valuemedium63.setBounds(new Rectangle(357,464,18,12));
    ...
    pwr_indsquare72.setBounds(new Rectangle(162,426,14,14));
    ...
    pwr_pump376.setBounds(new Rectangle(76,452,82,72));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -17}, new int[] { 8, 10, 13,18}, 4),
    ...
    new Polygon( new int[] { 6, 7, 151, -17}, new int[] { 40, 36, -1219915357,18}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -17}, new int[] { 46, 46, 54,18}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915393, -17}, new int[] { 10, 14, -1219915357,18}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915393, -17}, new int[] { 14, 18, -1219915357,18}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915375, 0}, new int[] { 12, 15, -1219915327,48}, 4),
