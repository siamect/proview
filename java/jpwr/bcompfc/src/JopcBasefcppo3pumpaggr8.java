...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 7, -17}, new int[] { 40, 36, -1219980893,18}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980929, -17}, new int[] { 10, 14, -1219980893,18}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893302, -17}, new int[] { 14, 18, 144132698,18}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 0, 0}, new int[] { 12, 15, 48,48}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 160434624, 0}, new int[] { 12, 15, 144032848,48}, 4),
