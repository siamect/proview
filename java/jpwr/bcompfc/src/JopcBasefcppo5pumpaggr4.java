...
public class JopcBasefcppo5pumpaggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  bcomp_fc	bcomp_fc85;
  pwr_mbup	pwr_mbup86;
  public JopcBasefcppo5pumpaggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr4");
    ...
    grp221_75.setBounds(new Rectangle(35,470,38,15));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -34}, new int[] { 8, 8, 11,-3}, 4),
    ...
    new Polygon( new int[] { 6, 7, -34, -34}, new int[] { 40, 36, -3,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -34}, new int[] { 46, 46, 54,-3}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915410, -34}, new int[] { 10, 12, -1219915379,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, -34, -34}, new int[] { 14, 17, -3,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915392, -16}, new int[] { 12, 15, -1219915349,26}, 4),
