...
public class JopcBasefcppo3fanaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare13.setBounds(new Rectangle(162,442,14,14));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,597,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,596,334,21));
    ...
    pwr_contactor234.setBounds(new Rectangle(268,287,36,36));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(269,432,36,37));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(34,172,45,19));
    ...
    pwr_indsquare60.setBounds(new Rectangle(162,346,14,14));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(37,365,55,21));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(309,506,49,15));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(359,509,18,12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857071, 39}, new int[] { 12, 15, 156930793,41}, 4),
