...
public class JopcBasefcppo3fanaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo3fanaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr6");
    ...
    pwr_indsquare13.setBounds(new Rectangle(161,441,16,16));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,596,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,595,336,23));
    ...
    pwr_contactor234.setBounds(new Rectangle(267,286,38,38));
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(268,431,38,39));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_indsquare60.setBounds(new Rectangle(161,345,16,16));
    ...
    pwr_smallbuttoncenter65.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,505,51,17));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(358,508,20,14));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222536, 39}, new int[] { 12, 15, -1220222534,41}, 4),
