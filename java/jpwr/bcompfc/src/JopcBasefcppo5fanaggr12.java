...
public class JopcBasefcppo5fanaggr12 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_indsquare	pwr_indsquare20;
  pwr_mbopenobject	pwr_mbopenobject23;
  pwr_mbtrend	pwr_mbtrend24;
  pwr_mbfast	pwr_mbfast25;
  pwr_mbphoto	pwr_mbphoto26;
  pwr_mbdatasheet	pwr_mbdatasheet27;
  pwr_mbopenplc	pwr_mbopenplc28;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram29;
  pwr_mbrtnavigator	pwr_mbrtnavigator30;
  pwr_mbhelpclass	pwr_mbhelpclass31;
  pwr_mbblockevents	pwr_mbblockevents32;
  pwr_mbhistevent	pwr_mbhistevent33;
  pwr_mbnote	pwr_mbnote34;
  pwr_mbhelp	pwr_mbhelp35;
  pwr_valuelong	pwr_valuelong36;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter37;
  pwr_valuelong	pwr_valuelong38;
  pwr_indsquare	pwr_indsquare39;
  pwr_manswitch3	pwr_manswitch341;
  pwr_contactor2	pwr_contactor242;
  pwr_safetyswitch	pwr_safetyswitch43;
  pwr_indsquare	pwr_indsquare45;
  pwr_valuesmall	pwr_valuesmall48;
  pwr_valuesmall	pwr_valuesmall49;
  pwr_menubar2	pwr_menubar250;
  pwr_pulldownmenu2	pwr_pulldownmenu251;
  pwr_pulldownmenu2	pwr_pulldownmenu252;
  pwr_pulldownmenu2	pwr_pulldownmenu253;
  pwr_pulldownmenu2	pwr_pulldownmenu254;
  pwr_pulldownmenu2	pwr_pulldownmenu255;
  pwr_motor2	pwr_motor256;
  bcomp_fc	bcomp_fc57;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter58;
  pwr_indround	pwr_indround59;
  pwr_indround	pwr_indround60;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter61;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter62;
  pwr_indround	pwr_indround63;
  pwr_indround	pwr_indround64;
  Grp169_	grp169_65;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter66;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter67;
  pwr_indsquare	pwr_indsquare68;
  pwr_indround	pwr_indround70;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter73;
  pwr_valuemedium	pwr_valuemedium74;
  pwr_valuemedium	pwr_valuemedium75;
  pwr_valuemedium	pwr_valuemedium77;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd81;
  Grp210_	grp210_82;
  Grp212_	grp212_83;
  pwr_valuemedium	pwr_valuemedium84;
  pwr_indsquare	pwr_indsquare88;
  pwr_mbsimulate	pwr_mbsimulate89;
  pwr_indsquare	pwr_indsquare90;
  Grp223_	grp223_91;
  pwr_fananim2	pwr_fananim293;
  pwr_rod	pwr_rod94;
  pwr_fananim	pwr_fananim95;
  pwr_fuse3	pwr_fuse396;
  Grp229_	grp229_97;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter98;
  pwr_mbup	pwr_mbup99;
  public JopcBasefcppo5fanaggr12( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5fanaggr12( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5fanaggr12");
    pwr_indsquare15 = new pwr_indsquare(session);
    pwr_indsquare15.setBounds(new Rectangle(161,397,16,17));
    ...
    pwr_indsquare17.setBounds(new Rectangle(161,351,16,17));
    pwr_indsquare17.setFillColor(294);
    ...
    pwr_valuelong19.setBounds(new Rectangle(16,46,369,22));
    ...
    pwr_indsquare20 = new pwr_indsquare(session);
    pwr_indsquare20.setBounds(new Rectangle(161,542,16,17));
    pwr_indsquare20.setFillColor(294);
    pwr_indsquare20.setShadow(1);
    localPanel.add(pwr_indsquare20, new Proportion(pwr_indsquare20.getBounds(), dsize));
    pwr_mbopenobject23 = new pwr_mbopenobject(session);
    pwr_mbopenobject23.setBounds(new Rectangle(194,24,20,20));
    pwr_mbopenobject23.setShadow(1);
    localPanel.add(pwr_mbopenobject23, new Proportion(pwr_mbopenobject23.getBounds(), dsize));
    pwr_mbtrend24 = new pwr_mbtrend(session);
    pwr_mbtrend24.setBounds(new Rectangle(55,24,20,20));
    pwr_mbtrend24.setShadow(1);
    localPanel.add(pwr_mbtrend24, new Proportion(pwr_mbtrend24.getBounds(), dsize));
    pwr_mbfast25 = new pwr_mbfast(session);
    pwr_mbfast25.setBounds(new Rectangle(75,24,20,20));
    pwr_mbfast25.setShadow(1);
    localPanel.add(pwr_mbfast25, new Proportion(pwr_mbfast25.getBounds(), dsize));
    pwr_mbphoto26 = new pwr_mbphoto(session);
    pwr_mbphoto26.setBounds(new Rectangle(95,24,20,20));
    pwr_mbphoto26.setShadow(1);
    localPanel.add(pwr_mbphoto26, new Proportion(pwr_mbphoto26.getBounds(), dsize));
    pwr_mbdatasheet27 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet27.setBounds(new Rectangle(115,24,20,20));
    pwr_mbdatasheet27.setShadow(1);
    localPanel.add(pwr_mbdatasheet27, new Proportion(pwr_mbdatasheet27.getBounds(), dsize));
    pwr_mbopenplc28 = new pwr_mbopenplc(session);
    pwr_mbopenplc28.setBounds(new Rectangle(214,24,20,20));
    pwr_mbopenplc28.setShadow(1);
    localPanel.add(pwr_mbopenplc28, new Proportion(pwr_mbopenplc28.getBounds(), dsize));
    pwr_mbcircuitdiagram29 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram29.setBounds(new Rectangle(234,24,20,20));
    pwr_mbcircuitdiagram29.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram29, new Proportion(pwr_mbcircuitdiagram29.getBounds(), dsize));
    pwr_mbrtnavigator30 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator30.setBounds(new Rectangle(174,24,20,20));
    pwr_mbrtnavigator30.setShadow(1);
    localPanel.add(pwr_mbrtnavigator30, new Proportion(pwr_mbrtnavigator30.getBounds(), dsize));
    pwr_mbhelpclass31 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass31.setBounds(new Rectangle(254,24,20,20));
    pwr_mbhelpclass31.setShadow(1);
    localPanel.add(pwr_mbhelpclass31, new Proportion(pwr_mbhelpclass31.getBounds(), dsize));
    pwr_mbblockevents32 = new pwr_mbblockevents(session);
    pwr_mbblockevents32.setBounds(new Rectangle(154,24,20,20));
    pwr_mbblockevents32.setShadow(1);
    localPanel.add(pwr_mbblockevents32, new Proportion(pwr_mbblockevents32.getBounds(), dsize));
    pwr_mbhistevent33 = new pwr_mbhistevent(session);
    pwr_mbhistevent33.setBounds(new Rectangle(135,24,20,20));
    localPanel.add(pwr_mbhistevent33, new Proportion(pwr_mbhistevent33.getBounds(), dsize));
    pwr_mbnote34 = new pwr_mbnote(session);
    pwr_mbnote34.setBounds(new Rectangle(35,24,20,20));
    localPanel.add(pwr_mbnote34, new Proportion(pwr_mbnote34.getBounds(), dsize));
    pwr_mbhelp35 = new pwr_mbhelp(session);
    pwr_mbhelp35.setBounds(new Rectangle(16,24,20,20));
    localPanel.add(pwr_mbhelp35, new Proportion(pwr_mbhelp35.getBounds(), dsize));
    pwr_valuelong36 = new pwr_valuelong(session);
    pwr_valuelong36.setBounds(new Rectangle(16,68,369,22));
    pwr_valuelong36.setFillColor(31);
    pwr_valuelong36.setBorderColor(32);
    localPanel.add(pwr_valuelong36, new Proportion(pwr_valuelong36.getBounds(), dsize));
    pwr_smallbuttoncenter37 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter37.setBounds(new Rectangle(4,697,48,20));
    pwr_smallbuttoncenter37.setFillColor(102);
    pwr_smallbuttoncenter37.setBorderColor(37);
    ...
    pwr_valuelong38.setBounds(new Rectangle(60,696,336,23));
    pwr_valuelong38.setFillColor(31);
    pwr_valuelong38.setBorderColor(31);
    localPanel.add(pwr_valuelong38, new Proportion(pwr_valuelong38.getBounds(), dsize));
    pwr_indsquare39 = new pwr_indsquare(session);
    pwr_indsquare39.setBounds(new Rectangle(348,96,16,17));
    pwr_indsquare39.setFillColor(295);
    pwr_indsquare39.setShadow(1);
    localPanel.add(pwr_indsquare39, new Proportion(pwr_indsquare39.getBounds(), dsize));
    pwr_manswitch341 = new pwr_manswitch3(session);
    pwr_manswitch341.setBounds(new Rectangle(267,339,38,38));
    pwr_manswitch341.setFillColor(32);
    pwr_manswitch341.setShadow(1);
    localPanel.add(pwr_manswitch341, new Proportion(pwr_manswitch341.getBounds(), dsize));
    pwr_contactor242 = new pwr_contactor2(session);
    pwr_contactor242.setBounds(new Rectangle(267,387,38,38));
    pwr_contactor242.setFillColor(32);
    pwr_contactor242.setShadow(1);
    localPanel.add(pwr_contactor242, new Proportion(pwr_contactor242.getBounds(), dsize));
    pwr_safetyswitch43 = new pwr_safetyswitch(session);
    pwr_safetyswitch43.setBounds(new Rectangle(268,532,38,39));
    pwr_safetyswitch43.setFillColor(32);
    pwr_safetyswitch43.setShadow(1);
    localPanel.add(pwr_safetyswitch43, new Proportion(pwr_safetyswitch43.getBounds(), dsize));
    pwr_indsquare45 = new pwr_indsquare(session);
    pwr_indsquare45.setBounds(new Rectangle(348,117,16,17));
    pwr_indsquare45.setFillColor(175);
    pwr_indsquare45.setShadow(1);
    localPanel.add(pwr_indsquare45, new Proportion(pwr_indsquare45.getBounds(), dsize));
    pwr_valuesmall48 = new pwr_valuesmall(session);
    pwr_valuesmall48.setBounds(new Rectangle(301,229,72,17));
    ...
    pwr_valuesmall49.setBounds(new Rectangle(301,248,72,18));
    localPanel.add(pwr_valuesmall49, new Proportion(pwr_valuesmall49.getBounds(), dsize));
    pwr_menubar250 = new pwr_menubar2(session);
    pwr_menubar250.setBounds(new Rectangle(0,0,409,24));
    pwr_menubar250.setShadow(1);
    localPanel.add(pwr_menubar250, new Proportion(pwr_menubar250.getBounds(), dsize));
    pwr_pulldownmenu251 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu251.setBounds(new Rectangle(8,0,44,24));
    pwr_pulldownmenu251.setShadow(1);
    localPanel.add(pwr_pulldownmenu251, new Proportion(pwr_pulldownmenu251.getBounds(), dsize));
    pwr_pulldownmenu252 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu252.setBounds(new Rectangle(328,0,69,24));
    pwr_pulldownmenu252.setShadow(1);
    localPanel.add(pwr_pulldownmenu252, new Proportion(pwr_pulldownmenu252.getBounds(), dsize));
    pwr_pulldownmenu253 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu253.setBounds(new Rectangle(220,0,69,24));
    ...
    pwr_pulldownmenu254.setBounds(new Rectangle(52,0,69,24));
    ...
    pwr_pulldownmenu255.setBounds(new Rectangle(124,0,88,24));
    pwr_pulldownmenu255.setShadow(1);
    localPanel.add(pwr_pulldownmenu255, new Proportion(pwr_pulldownmenu255.getBounds(), dsize));
    pwr_motor256 = new pwr_motor2(session);
    pwr_motor256.setBounds(new Rectangle(160,596,98,74));
    localPanel.add(pwr_motor256, new Proportion(pwr_motor256.getBounds(), dsize));
    bcomp_fc57 = new bcomp_fc(session);
    bcomp_fc57.setBounds(new Rectangle(255,436,64,84));
    bcomp_fc57.setShadow(1);
    localPanel.add(bcomp_fc57, new Proportion(bcomp_fc57.getBounds(), dsize));
    pwr_smallbuttoncenter58 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter58.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_indround59.setBounds(new Rectangle(87,173,18,17));
    pwr_indround59.setShadow(1);
    localPanel.add(pwr_indround59, new Proportion(pwr_indround59.getBounds(), dsize));
    pwr_indround60 = new pwr_indround(session);
    pwr_indround60.setBounds(new Rectangle(87,196,18,18));
    pwr_indround60.setShadow(1);
    localPanel.add(pwr_indround60, new Proportion(pwr_indround60.getBounds(), dsize));
    pwr_smallbuttoncenter61 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter61.setBounds(new Rectangle(123,172,61,21));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(123,196,61,21));
    ...
    pwr_indround63 = new pwr_indround(session);
    pwr_indround63.setBounds(new Rectangle(85,247,18,18));
    pwr_indround63.setFillColor(114);
    pwr_indround63.setShadow(1);
    localPanel.add(pwr_indround63, new Proportion(pwr_indround63.getBounds(), dsize));
    pwr_indround64 = new pwr_indround(session);
    pwr_indround64.setBounds(new Rectangle(192,173,18,17));
    pwr_indround64.setFillColor(294);
    pwr_indround64.setShadow(1);
    localPanel.add(pwr_indround64, new Proportion(pwr_indround64.getBounds(), dsize));
    grp169_65 = new Grp169_(session);
    grp169_65.setBounds(new Rectangle(34,248,37,18));
    localPanel.add(grp169_65, new Proportion(grp169_65.getBounds(), dsize));
    pwr_smallbuttoncenter66 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter66.setBounds(new Rectangle(239,173,36,21));
    pwr_smallbuttoncenter66.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter66, new Proportion(pwr_smallbuttoncenter66.getBounds(), dsize));
    pwr_smallbuttoncenter67 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter67.setBounds(new Rectangle(239,197,36,21));
    pwr_smallbuttoncenter67.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter67, new Proportion(pwr_smallbuttoncenter67.getBounds(), dsize));
    pwr_indsquare68 = new pwr_indsquare(session);
    pwr_indsquare68.setBounds(new Rectangle(161,446,16,16));
    pwr_indsquare68.setFillColor(294);
    pwr_indsquare68.setShadow(1);
    localPanel.add(pwr_indsquare68, new Proportion(pwr_indsquare68.getBounds(), dsize));
    pwr_indround70 = new pwr_indround(session);
    pwr_indround70.setBounds(new Rectangle(285,173,18,17));
    pwr_indround70.setFillColor(294);
    pwr_indround70.setShadow(1);
    localPanel.add(pwr_indround70, new Proportion(pwr_indround70.getBounds(), dsize));
    pwr_smallbuttoncenter73 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter73.setBounds(new Rectangle(36,465,57,23));
    pwr_smallbuttoncenter73.setFillColor(32);
    pwr_smallbuttoncenter73.setShadow(1);
    localPanel.add(pwr_smallbuttoncenter73, new Proportion(pwr_smallbuttoncenter73.getBounds(), dsize));
    pwr_valuemedium74 = new pwr_valuemedium(session);
    pwr_valuemedium74.setBounds(new Rectangle(308,606,51,17));
    pwr_valuemedium74.setShadow(1);
    localPanel.add(pwr_valuemedium74, new Proportion(pwr_valuemedium74.getBounds(), dsize));
    pwr_valuemedium75 = new pwr_valuemedium(session);
    pwr_valuemedium75.setBounds(new Rectangle(308,624,51,17));
    pwr_valuemedium75.setShadow(1);
    localPanel.add(pwr_valuemedium75, new Proportion(pwr_valuemedium75.getBounds(), dsize));
    pwr_valuemedium77 = new pwr_valuemedium(session);
    pwr_valuemedium77.setBounds(new Rectangle(358,609,20,14));
    pwr_valuemedium77.setFillColor(31);
    pwr_valuemedium77.setBorderColor(31);
    localPanel.add(pwr_valuemedium77, new Proportion(pwr_valuemedium77.getBounds(), dsize));
    pwr_valueinputmediumrd81 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd81.setBounds(new Rectangle(122,241,77,30));
    pwr_valueinputmediumrd81.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd81, new Proportion(pwr_valueinputmediumrd81.getBounds(), dsize));
    grp210_82 = new Grp210_(session);
    grp210_82.setBounds(new Rectangle(126,227,41,18));
    localPanel.add(grp210_82, new Proportion(grp210_82.getBounds(), dsize));
    grp212_83 = new Grp212_(session);
    grp212_83.setBounds(new Rectangle(198,246,28,20));
    grp212_83.setFillColor(31);
    grp212_83.setBorderColor(31);
    localPanel.add(grp212_83, new Proportion(grp212_83.getBounds(), dsize));
    pwr_valuemedium84 = new pwr_valuemedium(session);
    pwr_valuemedium84.setBounds(new Rectangle(308,642,51,17));
    pwr_valuemedium84.setShadow(1);
    localPanel.add(pwr_valuemedium84, new Proportion(pwr_valuemedium84.getBounds(), dsize));
    pwr_indsquare88 = new pwr_indsquare(session);
    pwr_indsquare88.setBounds(new Rectangle(357,199,16,17));
    pwr_indsquare88.setFillColor(175);
    pwr_indsquare88.setShadow(1);
    localPanel.add(pwr_indsquare88, new Proportion(pwr_indsquare88.getBounds(), dsize));
    pwr_mbsimulate89 = new pwr_mbsimulate(session);
    pwr_mbsimulate89.setBounds(new Rectangle(365,24,20,20));
    localPanel.add(pwr_mbsimulate89, new Proportion(pwr_mbsimulate89.getBounds(), dsize));
    pwr_indsquare90 = new pwr_indsquare(session);
    pwr_indsquare90.setBounds(new Rectangle(161,571,16,17));
    pwr_indsquare90.setFillColor(294);
    pwr_indsquare90.setShadow(1);
    localPanel.add(pwr_indsquare90, new Proportion(pwr_indsquare90.getBounds(), dsize));
    grp223_91 = new Grp223_(session);
    grp223_91.setBounds(new Rectangle(34,570,40,17));
    localPanel.add(grp223_91, new Proportion(grp223_91.getBounds(), dsize));
    pwr_fananim293 = new pwr_fananim2(session);
    pwr_fananim293.setBounds(new Rectangle(112,95,64,43));
    pwr_fananim293.setBorderColor(29);
    pwr_fananim293.setTextColor(0);
    pwr_fananim293.setShadow(1);
    pwr_fananim293.setGradient(12);
    localPanel.add(pwr_fananim293, new Proportion(pwr_fananim293.getBounds(), dsize));
    pwr_rod94 = new pwr_rod(session);
    pwr_rod94.setBounds(new Rectangle(132,628,39,10));
    pwr_rod94.setShadow(1);
    localPanel.add(pwr_rod94, new Proportion(pwr_rod94.getBounds(), dsize));
    pwr_fananim95 = new pwr_fananim(session);
    pwr_fananim95.setBounds(new Rectangle(120,588,19,91));
    pwr_fananim95.setShadow(1);
    localPanel.add(pwr_fananim95, new Proportion(pwr_fananim95.getBounds(), dsize));
    pwr_fuse396 = new pwr_fuse3(session);
    pwr_fuse396.setBounds(new Rectangle(280,294,15,37));
    pwr_fuse396.setRotate(-90);
    pwr_fuse396.setShadow(1);
    localPanel.add(pwr_fuse396, new Proportion(pwr_fuse396.getBounds(), dsize));
    grp229_97 = new Grp229_(session);
    grp229_97.setBounds(new Rectangle(36,196,41,18));
    localPanel.add(grp229_97, new Proportion(grp229_97.getBounds(), dsize));
    ...
    pwr_indsquare15.dd.setDynType(13);
    pwr_indsquare15.dd.setActionType(2);
    pwr_indsquare15.dd.setAccess(65532);
    pwr_indsquare15.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare15.dd, "$object.Contactor.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare15.dd, "$object.Contactor.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare15.dd, "$object.Contactor.Feedback")
      });
    pwr_indsquare17.dd.setDynType(5);
    pwr_indsquare17.dd.setActionType(2);
    pwr_indsquare17.dd.setAccess(65532);
    pwr_indsquare17.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare17.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean",176)
      ,new GeDynPopupMenu(pwr_indsquare17.dd, "$object.CircuitBreaker.NotTripped")
      });
    pwr_valuelong19.dd.setDynType(1025);
    pwr_valuelong19.dd.setActionType(0);
    pwr_valuelong19.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong19.dd, "$object.Description##String80","%s")
      });
    pwr_indsquare20.dd.setDynType(5);
    pwr_indsquare20.dd.setActionType(2);
    pwr_indsquare20.dd.setAccess(65532);
    pwr_indsquare20.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare20.dd, "$object.SafetySwitch.On.ActualValue##Boolean",114)
      ,new GeDynPopupMenu(pwr_indsquare20.dd, "$object.SafetySwitch.On")
      });
    ...
    pwr_mbopenobject23.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenobject23.dd, JopLang.transl("Open Object"))
      });
    pwr_mbtrend24.dd.setDynType(129);
    pwr_mbtrend24.dd.setActionType(8256);
    pwr_mbtrend24.dd.setAccess(65532);
    pwr_mbtrend24.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend24.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend24.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend24.dd, JopLang.transl("Trend"))
      });
    pwr_mbfast25.dd.setDynType(129);
    pwr_mbfast25.dd.setActionType(8256);
    pwr_mbfast25.dd.setAccess(65532);
    pwr_mbfast25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast25.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast25.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast25.dd, JopLang.transl("Fast"))
      });
    pwr_mbphoto26.dd.setDynType(129);
    pwr_mbphoto26.dd.setActionType(8256);
    pwr_mbphoto26.dd.setAccess(65532);
    pwr_mbphoto26.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto26.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto26.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto26.dd, JopLang.transl("Photo"))
      });
    pwr_mbdatasheet27.dd.setDynType(129);
    pwr_mbdatasheet27.dd.setActionType(8256);
    pwr_mbdatasheet27.dd.setAccess(65532);
    pwr_mbdatasheet27.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet27.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet27.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet27.dd, JopLang.transl("DataSheet"))
      });
    pwr_mbopenplc28.dd.setDynType(129);
    pwr_mbopenplc28.dd.setActionType(8256);
    pwr_mbopenplc28.dd.setAccess(65532);
    pwr_mbopenplc28.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc28.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc28.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc28.dd, JopLang.transl("Open Plc"))
      });
    pwr_mbcircuitdiagram29.dd.setDynType(129);
    pwr_mbcircuitdiagram29.dd.setActionType(8256);
    pwr_mbcircuitdiagram29.dd.setAccess(65535);
    pwr_mbcircuitdiagram29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram29.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram29.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram29.dd, JopLang.transl("CircuitDiagram"))
      });
    pwr_mbrtnavigator30.dd.setDynType(129);
    pwr_mbrtnavigator30.dd.setActionType(8256);
    pwr_mbrtnavigator30.dd.setAccess(65532);
    pwr_mbrtnavigator30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator30.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator30.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator30.dd, JopLang.transl("RtNavigator"))
      });
    pwr_mbhelpclass31.dd.setDynType(129);
    pwr_mbhelpclass31.dd.setActionType(8256);
    pwr_mbhelpclass31.dd.setAccess(65532);
    pwr_mbhelpclass31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass31.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass31.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass31.dd, JopLang.transl("Help Class"))
      });
    pwr_mbblockevents32.dd.setDynType(129);
    pwr_mbblockevents32.dd.setActionType(8256);
    pwr_mbblockevents32.dd.setAccess(65532);
    pwr_mbblockevents32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents32.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents32.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents32.dd, JopLang.transl("Block Events"))
      });
    pwr_mbhistevent33.dd.setDynType(129);
    pwr_mbhistevent33.dd.setActionType(8256);
    pwr_mbhistevent33.dd.setAccess(65532);
    pwr_mbhistevent33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent33.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent33.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent33.dd, JopLang.transl("Hist Event"))
      });
    pwr_mbnote34.dd.setDynType(129);
    pwr_mbnote34.dd.setActionType(8256);
    pwr_mbnote34.dd.setAccess(65532);
    pwr_mbnote34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote34.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote34.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote34.dd, JopLang.transl("Note"))
      });
    pwr_mbhelp35.dd.setDynType(128);
    pwr_mbhelp35.dd.setActionType(8256);
    pwr_mbhelp35.dd.setAccess(65532);
    pwr_mbhelp35.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp35.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp35.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp35.dd, JopLang.transl("Help"))
      });
    pwr_valuelong36.dd.setDynType(1025);
    pwr_valuelong36.dd.setActionType(0);
    pwr_valuelong36.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong36.dd, "$object.Specification##String80","%s")
      });
    pwr_smallbuttoncenter37.dd.setDynType(128);
    pwr_smallbuttoncenter37.dd.setActionType(64);
    pwr_smallbuttoncenter37.dd.setAccess(65532);
    pwr_smallbuttoncenter37.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter37.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter37.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter37.setAnnot1("Note !");
    pwr_valuelong38.dd.setDynType(1025);
    pwr_valuelong38.dd.setActionType(0);
    pwr_valuelong38.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong38.dd, "$object.Note##String80","%s")
      });
    pwr_indsquare39.dd.setDynType(5);
    pwr_indsquare39.dd.setActionType(0);
    pwr_indsquare39.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare39.dd, "$object.Ready##Boolean",29)
      });
    pwr_manswitch341.dd.setDynType(32769);
    pwr_manswitch341.dd.setActionType(66);
    pwr_manswitch341.dd.setAccess(65535);
    pwr_manswitch341.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch341.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch341.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch341.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    pwr_contactor242.dd.setDynType(32769);
    pwr_contactor242.dd.setActionType(66);
    pwr_contactor242.dd.setAccess(65535);
    pwr_contactor242.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor242.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor242.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor242.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_safetyswitch43.dd.setDynType(32769);
    pwr_safetyswitch43.dd.setActionType(66);
    pwr_safetyswitch43.dd.setAccess(65535);
    pwr_safetyswitch43.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch43.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch43.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch43.dd, "open graph/class/instance=$object.SafetySwitch")
      });
    pwr_indsquare45.dd.setDynType(5);
    pwr_indsquare45.dd.setActionType(0);
    pwr_indsquare45.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare45.dd, "$object.ExtInterlock##Boolean",29)
      });
    pwr_valuesmall48.dd.setDynType(1025);
    pwr_valuesmall48.dd.setActionType(0);
    pwr_valuesmall48.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall48.dd, "$object.RunTimeCounter.TotalNOfStarts##UInt32","%d")
      });
    pwr_valuesmall49.dd.setDynType(1025);
    pwr_valuesmall49.dd.setActionType(0);
    pwr_valuesmall49.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall49.dd, "$object.RunTimeCounter.TotalRunTime##DeltaTime","%1t")
      });
    pwr_menubar250.dd.setDynType(1);
    pwr_menubar250.dd.setActionType(0);
    pwr_pulldownmenu251.dd.setDynType(0);
    pwr_pulldownmenu251.dd.setActionType(524288);
    pwr_pulldownmenu251.dd.setAccess(65535);
    pwr_pulldownmenu251.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu251.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu251,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu251.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu251,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu251.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu251.setAnnot1("File");
    pwr_pulldownmenu252.dd.setDynType(1);
    pwr_pulldownmenu252.dd.setActionType(524288);
    pwr_pulldownmenu252.dd.setAccess(65532);
    pwr_pulldownmenu252.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu252.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu252,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu252.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu252,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu252.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu252.setAnnot1("Help");
    pwr_pulldownmenu253.dd.setDynType(1);
    ...
    pwr_pulldownmenu253.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.CircuitBreaker.NotTripped")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.Contactor.Order")
      }),
    new GeDyn(pwr_pulldownmenu253,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu253.dd, "$object.Contactor.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.Contactor.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu253,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu253.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu253,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu253.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu253.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu253.setAnnot1("Signals");
    pwr_pulldownmenu254.dd.setDynType(1);
    pwr_pulldownmenu254.dd.setActionType(524288);
    pwr_pulldownmenu254.dd.setAccess(65535);
    pwr_pulldownmenu254.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu254.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu254,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu254.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu254.setAnnot1("Methods");
    ...
    pwr_pulldownmenu255.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.CircuitBreaker")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Contactor")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu255.setAnnot1("Components");
    pwr_motor256.dd.setDynType(0);
    pwr_motor256.dd.setActionType(66);
    pwr_motor256.dd.setAccess(65535);
    pwr_motor256.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_motor256.dd, "$object.Motor")
      ,new GeDynCommand(pwr_motor256.dd, "open graph/class/instance=$object.motor")
      });
    bcomp_fc57.dd.setDynType(1);
    bcomp_fc57.dd.setActionType(66);
    bcomp_fc57.dd.setAccess(65535);
    bcomp_fc57.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc57.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc57.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter58.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter58.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter58.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter58.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter58.setAnnot1("Man");
    pwr_indround59.dd.setDynType(133);
    pwr_indround59.dd.setActionType(0);
    pwr_indround59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround59.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround59.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround60.dd.setDynType(133);
    pwr_indround60.dd.setActionType(0);
    pwr_indround60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround60.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround60.dd, "$object.Mode.AutoMode##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter61.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter61.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter61.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter61.dd, "$object.MOde.OpManStart##Boolean")
      });
    pwr_smallbuttoncenter61.setAnnot1("Start");
    ...
    pwr_smallbuttoncenter62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter62.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter62.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter62.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter62.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter62.setAnnot1("Stop");
    pwr_indround63.dd.setDynType(133);
    pwr_indround63.dd.setActionType(0);
    pwr_indround63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround63.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround63.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    pwr_indround64.dd.setDynType(5);
    pwr_indround64.dd.setActionType(0);
    pwr_indround64.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround64.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    grp169_65.dd.setDynType(129);
    grp169_65.dd.setActionType(0);
    grp169_65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp169_65.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    pwr_smallbuttoncenter66.dd.setDynType(129);
    pwr_smallbuttoncenter66.dd.setActionType(6);
    pwr_smallbuttoncenter66.dd.setAccess(65532);
    pwr_smallbuttoncenter66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter66.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter66.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(pwr_smallbuttoncenter66.dd, "$object.OpPowerOn##Boolean")
      });
    pwr_smallbuttoncenter66.setAnnot1("On");
    pwr_smallbuttoncenter67.dd.setDynType(129);
    pwr_smallbuttoncenter67.dd.setActionType(6);
    pwr_smallbuttoncenter67.dd.setAccess(65532);
    pwr_smallbuttoncenter67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter67.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter67.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(pwr_smallbuttoncenter67.dd, "$object.OpPowerOff##Boolean")
      });
    pwr_smallbuttoncenter67.setAnnot1("Off");
    pwr_indsquare68.dd.setDynType(117);
    pwr_indsquare68.dd.setActionType(2);
    pwr_indsquare68.dd.setAccess(65532);
    pwr_indsquare68.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare68.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare68.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare68.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare68.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare68.dd, "$object.FrequencyConverter")
      });
    pwr_indround70.dd.setDynType(5);
    pwr_indround70.dd.setActionType(0);
    pwr_indround70.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround70.dd, "$object.Contactor.IndFeedback##Boolean",29)
      });
    pwr_smallbuttoncenter73.dd.setDynType(1);
    pwr_smallbuttoncenter73.dd.setActionType(4);
    pwr_smallbuttoncenter73.dd.setAccess(65532);
    pwr_smallbuttoncenter73.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter73.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter73.setAnnot1("Reset");
    pwr_valuemedium74.dd.setDynType(1024);
    pwr_valuemedium74.dd.setActionType(2);
    pwr_valuemedium74.dd.setAccess(65532);
    pwr_valuemedium74.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium74.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium74.dd, "$object.FrequencyConverter.ActSpeed")
      });
    pwr_valuemedium75.dd.setDynType(1025);
    pwr_valuemedium75.dd.setActionType(2);
    pwr_valuemedium75.dd.setAccess(65532);
    pwr_valuemedium75.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium75.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium75.dd, "$object.FrequencyConverter.ActTorque")
      });
    pwr_valuemedium77.dd.setDynType(1025);
    pwr_valuemedium77.dd.setActionType(0);
    pwr_valuemedium77.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium77.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd81.dd.setDynType(1153);
    pwr_valueinputmediumrd81.dd.setActionType(4096);
    pwr_valueinputmediumrd81.dd.setAccess(65532);
    pwr_valueinputmediumrd81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd81.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd81.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd81.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd81.setAnnot1Font(pwr_valueinputmediumrd81.annotFont.deriveFont((float)14));
    grp210_82.dd.setDynType(129);
    grp210_82.dd.setActionType(0);
    grp210_82.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_82.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_83.dd.setDynType(129);
    grp212_83.dd.setActionType(0);
    grp212_83.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_83.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_valuemedium84.dd.setDynType(1025);
    pwr_valuemedium84.dd.setActionType(2);
    pwr_valuemedium84.dd.setAccess(65532);
    pwr_valuemedium84.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium84.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium84.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    pwr_indsquare88.dd.setDynType(5);
    pwr_indsquare88.dd.setActionType(0);
    pwr_indsquare88.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare88.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate89.dd.setDynType(129);
    pwr_mbsimulate89.dd.setActionType(8256);
    pwr_mbsimulate89.dd.setAccess(65532);
    pwr_mbsimulate89.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate89.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate89.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate89.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare90.dd.setDynType(176);
    pwr_indsquare90.dd.setActionType(2);
    pwr_indsquare90.dd.setAccess(65532);
    pwr_indsquare90.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare90.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare90.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare90.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare90.dd, "$object.Motor")
      });
    grp223_91.dd.setDynType(129);
    grp223_91.dd.setActionType(0);
    grp223_91.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_91.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_fananim293.dd.setDynType(66612);
    pwr_fananim293.dd.setActionType(0);
    pwr_fananim293.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim293.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim293.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim293.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim293.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim293.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim293.setAnnot1("L");
    pwr_rod94.dd.setDynType(1);
    pwr_rod94.dd.setActionType(0);
    pwr_fananim95.dd.setDynType(65537);
    pwr_fananim95.dd.setActionType(66);
    pwr_fananim95.dd.setAccess(65532);
    pwr_fananim95.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim95.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim95.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim95.dd, "open graph/class/inst=$object.Fan")
      });
    pwr_fuse396.dd.setDynType(1);
    pwr_fuse396.dd.setActionType(0);
    grp229_97.dd.setDynType(129);
    grp229_97.dd.setActionType(0);
    grp229_97.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_97.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.4009F, 281.127F, 361.012F, 411.55F),
    new Polygon( new int[] { 19, 380, 379, 20, 20, 19}, new int[] { 281, 281, 282, 282, 692, 693}, 6), 
    new Polygon( new int[] { 380, 380, 379, 379, 20, 19}, new int[] { 693, 281, 282, 692, 692, 693}, 6), 
    ...
    new Rectangle2D.Float(37F, 113F, 196F, 7F),
    new Polygon( new int[] { 37, 233, 231, 39, 39, 37}, new int[] { 113, 113, 115, 115, 118, 120}, 6), 
    new Polygon( new int[] { 233, 233, 231, 231, 39, 37}, new int[] { 120, 113, 115, 118, 118, 120}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 411);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Circuit breaker"),36, 363);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 554);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 458);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),363, 638);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 638);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 620);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[21]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 656);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 656);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219981080, -168}, new int[] { 12, 15, -1219980806,105}, 4),
