...
public class JopcBasefcppo5fanaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare15.setBounds(new Rectangle(162,398,14,15));
    ...
    pwr_indsquare17.setBounds(new Rectangle(162,352,14,15));
    ...
    pwr_valuelong19.setBounds(new Rectangle(17,47,367,20));
    ...
    pwr_indsquare20.setBounds(new Rectangle(162,543,14,15));
    ...
    pwr_mbopenobject23.setBounds(new Rectangle(195,25,18,18));
    ...
    pwr_mbtrend24.setBounds(new Rectangle(56,25,18,18));
    ...
    pwr_mbfast25.setBounds(new Rectangle(76,25,18,18));
    ...
    pwr_mbphoto26.setBounds(new Rectangle(96,25,18,18));
    ...
    pwr_mbdatasheet27.setBounds(new Rectangle(116,25,18,18));
    ...
    pwr_mbopenplc28.setBounds(new Rectangle(215,25,18,18));
    ...
    pwr_mbcircuitdiagram29.setBounds(new Rectangle(235,25,18,18));
    ...
    pwr_mbrtnavigator30.setBounds(new Rectangle(175,25,18,18));
    ...
    pwr_mbhelpclass31.setBounds(new Rectangle(255,25,18,18));
    ...
    pwr_mbblockevents32.setBounds(new Rectangle(155,25,18,18));
    ...
    pwr_smallbuttoncenter37.setBounds(new Rectangle(5,698,46,18));
    ...
    pwr_valuelong38.setBounds(new Rectangle(61,697,334,21));
    ...
    pwr_indsquare39.setBounds(new Rectangle(349,97,14,15));
    ...
    pwr_manswitch341.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_contactor242.setBounds(new Rectangle(268,388,36,36));
    ...
    pwr_safetyswitch43.setBounds(new Rectangle(269,533,36,37));
    ...
    pwr_indsquare45.setBounds(new Rectangle(349,118,14,15));
    ...
    pwr_valuesmall48.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_pulldownmenu251.setBounds(new Rectangle(9,1,42,22));
    ...
    pwr_pulldownmenu252.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu253.setBounds(new Rectangle(221,1,67,22));
    ...
    pwr_pulldownmenu254.setBounds(new Rectangle(53,1,67,22));
    ...
    pwr_pulldownmenu255.setBounds(new Rectangle(125,1,86,22));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_indround59.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround60.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround63.setBounds(new Rectangle(86,248,16,16));
    ...
    pwr_indround64.setBounds(new Rectangle(193,174,16,15));
    ...
    grp169_65.setBounds(new Rectangle(35,249,35,16));
    ...
    pwr_smallbuttoncenter66.setBounds(new Rectangle(240,174,34,19));
    ...
    pwr_smallbuttoncenter67.setBounds(new Rectangle(240,198,34,19));
    ...
    pwr_indsquare68.setBounds(new Rectangle(162,447,14,14));
    ...
    pwr_indround70.setBounds(new Rectangle(286,174,16,15));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(37,466,55,21));
    ...
    pwr_valuemedium74.setBounds(new Rectangle(309,607,49,15));
    ...
    pwr_valuemedium75.setBounds(new Rectangle(309,625,49,15));
    ...
    pwr_valuemedium77.setBounds(new Rectangle(359,610,18,12));
    ...
    pwr_valueinputmediumrd81.setBounds(new Rectangle(123,242,75,28));
    ...
    grp210_82.setBounds(new Rectangle(127,228,39,16));
    localPanel.add(grp210_82, new Proportion(grp210_82.getBounds(), dsize));
    grp212_83 = new Grp212_(session);
    grp212_83.setBounds(new Rectangle(199,247,26,18));
    ...
    pwr_valuemedium84.setBounds(new Rectangle(309,643,49,15));
    ...
    pwr_indsquare88.setBounds(new Rectangle(358,200,14,15));
    ...
    pwr_rod94.setBounds(new Rectangle(133,629,37,8));
    ...
    pwr_fananim95.setBounds(new Rectangle(121,589,17,89));
    ...
    pwr_fuse396.setBounds(new Rectangle(281,295,13,35));
    ...
    grp229_97.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_smallbuttoncenter98.setBounds(new Rectangle(34,197,46,19));
    ...
    pwr_mbup99.setBounds(new Rectangle(347,25,18,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915544, -168}, new int[] { 12, 15, -1219915270,105}, 4),
