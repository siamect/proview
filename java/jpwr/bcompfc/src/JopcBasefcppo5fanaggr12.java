...
public class JopcBasefcppo5fanaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbtrend24.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbtrend24.dd, "Trend")
      });
    ...
    pwr_mbfast25.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbfast25.dd, "Fast")
      });
    ...
    pwr_mbphoto26.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbphoto26.dd, "Photo")
      });
    ...
    pwr_mbdatasheet27.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbdatasheet27.dd, "DataSheet")
      });
    ...
    pwr_mbopenplc28.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenplc28.dd, "Open Plc")
      });
    ...
    pwr_mbcircuitdiagram29.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbcircuitdiagram29.dd, "CircuitDiagram")
      });
    ...
    pwr_mbrtnavigator30.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbrtnavigator30.dd, "RtNavigator")
      });
    ...
    pwr_mbhelpclass31.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelpclass31.dd, "Help Class")
      });
    ...
    pwr_mbblockevents32.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbblockevents32.dd, "Block Events")
      });
    ...
    pwr_mbhistevent33.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhistevent33.dd, "Hist Event")
      });
    ...
    pwr_mbnote34.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbnote34.dd, "Note")
      });
    ...
    pwr_mbhelp35.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelp35.dd, "Help")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate89.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate89.dd, "Open simulate graph")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Contactor",36, 411);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Circuit breaker",36, 363);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SafetySwitch",36, 554);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Frequencyconverter",36, 458);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( "%",363, 638);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Torque",264, 638);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Speed",264, 620);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[21]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "A",363, 656);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Current",264, 656);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222744, -168}, new int[] { 12, 15, -1220222470,105}, 4),
