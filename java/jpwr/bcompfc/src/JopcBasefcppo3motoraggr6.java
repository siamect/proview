...
public class JopcBasefcppo3motoraggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3motoraggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3motoraggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3motoraggr6");
    ...
    pwr_indsquare12.setBounds(new Rectangle(162,442,14,14));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(5,597,45,19));
    ...
    pwr_valuelong30.setBounds(new Rectangle(61,596,334,21));
    ...
    pwr_contactor233.setBounds(new Rectangle(268,287,36,36));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(269,432,36,37));
    ...
    pwr_valuesmall39.setBounds(new Rectangle(302,230,70,16));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_indround50.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround51.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround54.setBounds(new Rectangle(86,248,16,15));
    ...
    pwr_indround55.setBounds(new Rectangle(193,174,16,15));
    ...
    grp169_56.setBounds(new Rectangle(35,249,35,16));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(240,174,34,19));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(240,198,34,19));
    ...
    pwr_indsquare59.setBounds(new Rectangle(162,346,14,14));
    ...
    pwr_indround61.setBounds(new Rectangle(286,174,15,16));
    ...
    pwr_smallbuttoncenter64.setBounds(new Rectangle(37,365,55,21));
    pwr_smallbuttoncenter64.setFillColor(32);
    pwr_smallbuttoncenter64.setShadow(1);
    ...
    pwr_valuemedium65.setBounds(new Rectangle(309,506,49,15));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(359,509,18,12));
    ...
    grp223_78.setBounds(new Rectangle(35,470,38,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter57.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.OpPowerOn##Boolean")
      });
    pwr_smallbuttoncenter57.setAnnot1("On");
    ...
    pwr_smallbuttoncenter58.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter58.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(pwr_smallbuttoncenter58.dd, "$object.OpPowerOff##Boolean")
      });
    pwr_smallbuttoncenter58.setAnnot1("Off");
    ...
    pwr_smallbuttoncenter64.dd.setDynType(1);
    ...
    pwr_smallbuttoncenter64.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter64.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter64.setAnnot1("Reset");
    ...
    pwr_valuemedium65.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium65.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium65.dd, "$object.FrequencyConverter.ActSpeed")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 310);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 453);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Speed"),264, 519);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[17]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915350, 25}, new int[] { 12, 15, -1219915349,26}, 4),
