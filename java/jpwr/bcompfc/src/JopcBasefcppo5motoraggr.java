...
public class JopcBasefcppo5motoraggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,487,16,17));
    ...
    pwr_contactor288.setBounds(new Rectangle(267,332,38,38));
    ...
    bcomp_fc90.setBounds(new Rectangle(255,381,64,84));
    ...
    pwr_safetyswitch91.setBounds(new Rectangle(268,477,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980903, 8}, new int[] { 12, 15, -1219980860,51}, 4),
