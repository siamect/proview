...
public class JopcBasefcppo5motoraggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(152,477,12,22));
    ...
    pwr_indsquare80.setBounds(new Rectangle(161,425,16,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 163106963, -4}, new int[] { 12, 15, 144032828,28}, 4),
