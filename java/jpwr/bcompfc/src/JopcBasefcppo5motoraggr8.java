...
public class JopcBasefcppo5motoraggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup84;
  public JopcBasefcppo5motoraggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5motoraggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5motoraggr8");
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(153,478,10,20));
    ...
    pwr_indsquare80.setBounds(new Rectangle(162,426,14,14));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp223_82.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_82.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915380, -4}, new int[] { 12, 15, -1219915347,28}, 4),
