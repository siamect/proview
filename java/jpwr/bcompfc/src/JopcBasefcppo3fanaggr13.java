...
public class JopcBasefcppo3fanaggr13 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium64.setBounds(new Rectangle(356,608,20,14));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,570,16,17));
    ...
    pwr_rod77.setBounds(new Rectangle(125,627,39,9));
    ...
    pwr_fananim78.setBounds(new Rectangle(113,587,19,91));
    ...
    pwr_fuse386.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_manswitch387.setBounds(new Rectangle(267,338,38,38));
    ...
    pwr_contactor288.setBounds(new Rectangle(267,386,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 13, 11}, new int[] { 12, 15, 39,39}, 4),
