...
public class JopcBasefcppo3fanaggr13 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch387;
  pwr_contactor2	pwr_contactor288;
  bcomp_fc	bcomp_fc89;
  pwr_mbup	pwr_mbup90;
  public JopcBasefcppo3fanaggr13( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr13( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr13");
    ...
    pwr_valuemedium64.setBounds(new Rectangle(357,609,18,12));
    ...
    pwr_valueinputmediumrd67.setBounds(new Rectangle(123,242,75,28));
    ...
    grp210_68.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_68, new Proportion(grp210_68.getBounds(), dsize));
    grp212_69 = new Grp212_(session);
    grp212_69.setBounds(new Rectangle(199,247,26,18));
    ...
    pwr_indsquare71.setBounds(new Rectangle(358,200,14,15));
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,571,14,15));
    ...
    pwr_rod77.setBounds(new Rectangle(126,628,37,7));
    ...
    pwr_fananim78.setBounds(new Rectangle(114,588,17,89));
    pwr_fananim78.setShadow(1);
    localPanel.add(pwr_fananim78, new Proportion(pwr_fananim78.getBounds(), dsize));
    grp227_79 = new Grp227_(session);
    grp227_79.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp227_79, new Proportion(grp227_79.getBounds(), dsize));
    ...
    pwr_fuse386.setBounds(new Rectangle(281,295,13,35));
    pwr_fuse386.setRotate(-90);
    pwr_fuse386.setShadow(1);
    localPanel.add(pwr_fuse386, new Proportion(pwr_fuse386.getBounds(), dsize));
    pwr_manswitch387 = new pwr_manswitch3(session);
    pwr_manswitch387.setBounds(new Rectangle(268,339,36,36));
    pwr_manswitch387.setFillColor(32);
    pwr_manswitch387.setShadow(1);
    localPanel.add(pwr_manswitch387, new Proportion(pwr_manswitch387.getBounds(), dsize));
    pwr_contactor288 = new pwr_contactor2(session);
    pwr_contactor288.setBounds(new Rectangle(268,387,36,36));
    ...
    bcomp_fc89 = new bcomp_fc(session);
    bcomp_fc89.setBounds(new Rectangle(256,436,62,82));
    bcomp_fc89.setShadow(1);
    localPanel.add(bcomp_fc89, new Proportion(bcomp_fc89.getBounds(), dsize));
    pwr_mbup90 = new pwr_mbup(session);
    pwr_mbup90.setBounds(new Rectangle(348,25,17,18));
...
null,null,    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp227_79.dd.setDynType(129);
    grp227_79.dd.setActionType(0);
    grp227_79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp227_79.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_manswitch387.dd.setDynType(32769);
    pwr_manswitch387.dd.setActionType(66);
    pwr_manswitch387.dd.setAccess(65535);
    pwr_manswitch387.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch387.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch387.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch387.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    ...
    bcomp_fc89.dd.setDynType(1);
    bcomp_fc89.dd.setActionType(66);
    bcomp_fc89.dd.setAccess(65535);
    bcomp_fc89.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc89.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc89.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 410);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Circuit breaker"),36, 362);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),36, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 457);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("Speed"),262, 619);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915364, 11}, new int[] { 12, 15, -1219915336,39}, 4),
