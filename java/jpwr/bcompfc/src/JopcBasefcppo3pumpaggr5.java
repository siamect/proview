...
public class JopcBasefcppo3pumpaggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch375;
  bcomp_fc	bcomp_fc76;
  pwr_mbup	pwr_mbup77;
  public JopcBasefcppo3pumpaggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3pumpaggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3pumpaggr5");
    ...
    pwr_valuemedium56.setBounds(new Rectangle(354,450,18,12));
    ...
    pwr_indsquare63.setBounds(new Rectangle(312,174,14,15));
    ...
    pwr_indsquare65.setBounds(new Rectangle(162,423,14,15));
    ...
    grp221_66 = new Grp221_(session);
    grp221_66.setBounds(new Rectangle(35,422,38,15));
    localPanel.add(grp221_66, new Proportion(grp221_66.getBounds(), dsize));
    pwr_pumpanim268 = new pwr_pumpanim2(session);
    pwr_pumpanim268.setBounds(new Rectangle(117,96,62,42));
    ...
    pwr_pump369.setBounds(new Rectangle(76,449,82,72));
    ...
    pwr_rodcouplinganim70.setBounds(new Rectangle(153,475,10,19));
    localPanel.add(pwr_rodcouplinganim70, new Proportion(pwr_rodcouplinganim70.getBounds(), dsize));
    grp226_71 = new Grp226_(session);
    grp226_71.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_71, new Proportion(grp226_71.getBounds(), dsize));
    ...
    pwr_manswitch375 = new pwr_manswitch3(session);
    pwr_manswitch375.setBounds(new Rectangle(268,285,36,36));
    pwr_manswitch375.setFillColor(32);
    pwr_manswitch375.setShadow(1);
    localPanel.add(pwr_manswitch375, new Proportion(pwr_manswitch375.getBounds(), dsize));
    bcomp_fc76 = new bcomp_fc(session);
    bcomp_fc76.setBounds(new Rectangle(256,336,62,82));
    bcomp_fc76.setShadow(1);
    localPanel.add(bcomp_fc76, new Proportion(bcomp_fc76.getBounds(), dsize));
    pwr_mbup77 = new pwr_mbup(session);
    pwr_mbup77.setBounds(new Rectangle(347,25,18,18));
    localPanel.add(pwr_mbup77, new Proportion(pwr_mbup77.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp221_66.dd.setDynType(129);
    grp221_66.dd.setActionType(0);
    grp221_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp221_66.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    ...
    grp226_71.dd.setDynType(129);
    grp226_71.dd.setActionType(0);
    grp226_71.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_71.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_manswitch375.dd.setDynType(32769);
    pwr_manswitch375.dd.setActionType(66);
    pwr_manswitch375.dd.setAccess(65535);
    pwr_manswitch375.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch375.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch375.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch375.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    bcomp_fc76.dd.setDynType(1);
    bcomp_fc76.dd.setActionType(66);
    bcomp_fc76.dd.setAccess(65535);
    bcomp_fc76.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc76.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc76.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    pwr_mbup77.dd.setDynType(129);
    pwr_mbup77.dd.setActionType(8256);
    pwr_mbup77.dd.setAccess(33619967);
    pwr_mbup77.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup77.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup77.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup77.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(34.5788F, 144.332F, 207.761F, 130.401F),
    new Polygon( new int[] { 35, 242, 241, 35, 35, 35}, new int[] { 144, 144, 145, 145, 274, 275}, 6), 
    new Polygon( new int[] { 242, 242, 241, 241, 35, 35}, new int[] { 275, 144, 145, 274, 274, 275}, 6), 
    ...
    new Line2D.Float( 288F, 338F, 288F, 322F),
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {450, 450, 446, 418, 446, 450}, 6),
  };
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 10, 41, 44}, new int[] { 14, 13, 13,14}, 4),
    ...
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 52, 52, 10,8}, 4),
    new Polygon( new int[] { 6, 5, 10, 7}, new int[] { 8, 10, 13,17}, 4),
    ...
    new Polygon( new int[] { 10, 11, 14, 14}, new int[] { 18, 19, 17,14}, 4),
    new Polygon( new int[] { 14, 14, 43, 44}, new int[] { 14, 17, 17,14}, 4),
    new Polygon( new int[] { 44, 43, 45, 46}, new int[] { 14, 17, 23,24}, 4),
    ...
    new Polygon( new int[] { 6, 8, 7, 7}, new int[] { 40, 34, 17,17}, 4),
    ...
    new Polygon( new int[] { 6, 10, 10, 7}, new int[] { 46, 46, 57,17}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915368, 7}, new int[] { 10, 14, -1219915358,17}, 4),
    new Polygon( new int[] { 6, 44, 44, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {14, 14, 10, 10, 52, 58, 62, 62, 58, 52, 14}, 11),
    new Polygon( new int[] { 6, 10, 47, 44}, new int[] { 14, 18, 18,14}, 4),
    new Polygon( new int[] { 44, 47, 47, 44}, new int[] { 14, 18, 15,10}, 4),
    ...
    new Polygon( new int[] { 14, 15, 11, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 11, 10, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 52, 52, 18,14}, 4),
    new Polygon( new int[] { 6, 10, 7, 7}, new int[] { 14, 18, 17,17}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 25, 25}, new int[] { 12, 15, 80,47}, 4),
