...
public class JopcBasefcppo3pumpaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium56.setBounds(new Rectangle(353,449,20,14));
    ...
    pwr_indsquare63.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_indsquare65.setBounds(new Rectangle(161,422,16,17));
    ...
    pwr_pump369.setBounds(new Rectangle(75,448,84,74));
    ...
    pwr_manswitch375.setBounds(new Rectangle(267,284,38,38));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 8, 80, 7}, new int[] { 40, 34, -1219980894,17}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980904, 7}, new int[] { 10, 14, -1219980894,17}, 4),
    ...
    new Polygon( new int[] { 6, 10, 140893327, 7}, new int[] { 14, 18, 144132697,17}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 25, 25}, new int[] { 12, 15, 488,47}, 4),
