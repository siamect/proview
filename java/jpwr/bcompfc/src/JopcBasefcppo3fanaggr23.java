...
public class JopcBasefcppo3fanaggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_64;
  pwr_fananim2	pwr_fananim266;
  pwr_rod	pwr_rod67;
  pwr_fananim	pwr_fananim68;
  Grp230_	grp230_69;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter70;
  bcomp_fc	bcomp_fc73;
  pwr_fuse3	pwr_fuse374;
  pwr_mbup	pwr_mbup75;
  public JopcBasefcppo3fanaggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr23");
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(5,553,45,19));
    ...
    pwr_valuelong24.setBounds(new Rectangle(61,552,334,21));
    ...
    pwr_motor239.setBounds(new Rectangle(161,452,96,72));
    ...
    pwr_smallbuttoncenter40.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_indsquare48.setBounds(new Rectangle(162,352,14,14));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(37,371,55,21));
    ...
    pwr_valuemedium53.setBounds(new Rectangle(309,462,49,15));
    ...
    pwr_valuemedium54.setBounds(new Rectangle(359,465,18,12));
    ...
    pwr_indsquare63.setBounds(new Rectangle(162,427,14,14));
    ...
    grp223_64.setBounds(new Rectangle(35,426,38,16));
    localPanel.add(grp223_64, new Proportion(grp223_64.getBounds(), dsize));
    pwr_fananim266 = new pwr_fananim2(session);
    pwr_fananim266.setBounds(new Rectangle(116,96,62,42));
    pwr_fananim266.setBorderColor(29);
    pwr_fananim266.setTextColor(0);
    pwr_fananim266.setShadow(1);
    pwr_fananim266.setGradient(12);
    localPanel.add(pwr_fananim266, new Proportion(pwr_fananim266.getBounds(), dsize));
    pwr_rod67 = new pwr_rod(session);
    pwr_rod67.setBounds(new Rectangle(133,484,37,8));
    pwr_rod67.setShadow(1);
    localPanel.add(pwr_rod67, new Proportion(pwr_rod67.getBounds(), dsize));
    pwr_fananim68 = new pwr_fananim(session);
    pwr_fananim68.setBounds(new Rectangle(121,444,17,89));
    pwr_fananim68.setShadow(1);
    localPanel.add(pwr_fananim68, new Proportion(pwr_fananim68.getBounds(), dsize));
    grp230_69 = new Grp230_(session);
    grp230_69.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp230_69, new Proportion(grp230_69.getBounds(), dsize));
    ...
    bcomp_fc73 = new bcomp_fc(session);
    bcomp_fc73.setBounds(new Rectangle(256,342,62,82));
    bcomp_fc73.setShadow(1);
    localPanel.add(bcomp_fc73, new Proportion(bcomp_fc73.getBounds(), dsize));
    pwr_fuse374 = new pwr_fuse3(session);
    pwr_fuse374.setBounds(new Rectangle(281,297,13,35));
    pwr_fuse374.setRotate(-90);
    pwr_fuse374.setShadow(1);
    localPanel.add(pwr_fuse374, new Proportion(pwr_fuse374.getBounds(), dsize));
    pwr_mbup75 = new pwr_mbup(session);
    pwr_mbup75.setBounds(new Rectangle(348,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim266.dd.setDynType(66612);
    pwr_fananim266.dd.setActionType(0);
    pwr_fananim266.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim266.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim266.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim266.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim266.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim266.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim266.setAnnot1("L");
    pwr_rod67.dd.setDynType(1);
    pwr_rod67.dd.setActionType(0);
    pwr_fananim68.dd.setDynType(65537);
    pwr_fananim68.dd.setActionType(66);
    pwr_fananim68.dd.setAccess(65532);
    pwr_fananim68.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim68.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim68.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim68.dd, "open graph/class/inst=$object.Fan")
      });
    grp230_69.dd.setDynType(129);
    grp230_69.dd.setActionType(0);
    grp230_69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_69.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    bcomp_fc73.dd.setDynType(1);
    bcomp_fc73.dd.setActionType(66);
    bcomp_fc73.dd.setAccess(65535);
    bcomp_fc73.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc73.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc73.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    pwr_fuse374.dd.setDynType(1);
    pwr_fuse374.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 279.906F, 361.006F, 269.792F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 280, 280, 281, 281, 549, 550}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 550, 280, 281, 549, 549, 550}, 6), 
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 2, 2}, new int[] { 12, 15, 528,47}, 4),
