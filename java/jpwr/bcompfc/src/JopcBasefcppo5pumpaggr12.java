...
public class JopcBasefcppo5pumpaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbopenobject25.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenobject25.dd, "Open Object")
      });
    ...
    pwr_mbtrend26.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbtrend26.dd, "Trend")
      });
    ...
    pwr_mbfast27.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbfast27.dd, "Fast")
      });
    ...
    pwr_mbphoto28.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbphoto28.dd, "Photo")
      });
    ...
    pwr_mbdatasheet29.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbdatasheet29.dd, "DataSheet")
      });
    ...
    pwr_mbopenplc30.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenplc30.dd, "Open Plc")
      });
    ...
    pwr_mbcircuitdiagram31.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbcircuitdiagram31.dd, "CircuitDiagram")
      });
    ...
    pwr_mbrtnavigator32.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbrtnavigator32.dd, "RtNavigator")
      });
    ...
    pwr_mbhelpclass33.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelpclass33.dd, "Help Class")
      });
    ...
    pwr_mbblockevents34.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbblockevents34.dd, "Block Events")
      });
    ...
    pwr_mbhistevent35.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhistevent35.dd, "Hist Event")
      });
    ...
    pwr_mbnote36.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbnote36.dd, "Note")
      });
    ...
    pwr_mbhelp37.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelp37.dd, "Help")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu255.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu255.dd, new String[] {
        "CircuitBreaker.NotTripped Di","Contactor.Order Do","Contactor.Feedback Di","SafetySwitch.On Di","FrequencyConverter.ActSpeed","FrequencyConverter.ActTorque","FrequencyConverter.ActCurrent","FrequencyConverter.RefSpeed","Motor.TempSwitch.Switch Di","Motor.TempSensor.Value Ai",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate91.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate91.dd, "Open simulate graph")
      });
    ...
    pwr_mbup101.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbup101.dd, "Open parent object graph")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SafetySwitch",36, 555);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( "%",363, 639);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Torque",264, 639);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Speed",264, 621);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[25]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "A",363, 657);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Current",264, 657);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1220222613, -37}, new int[] { 10, 14, -1220222561,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, 150455306, -37}, new int[] { 14, 17, 144057502,14}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 150064764, -19}, new int[] { 12, 15, 72,44}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140859508, -19}, new int[] { 12, 15, 149860388,44}, 4),
