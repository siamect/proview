...
public class JopcBasefcppo5pumpaggr12 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  BorderLayout borderLayout1 = new BorderLayout();
  public LocalPanel localPanel = new LocalPanel();
  boolean scrollbar = false;
  Dimension size;
  pwr_indsquare	pwr_indsquare17;
  pwr_indsquare	pwr_indsquare19;
  pwr_valuelong	pwr_valuelong21;
  pwr_indsquare	pwr_indsquare22;
  pwr_mbopenobject	pwr_mbopenobject25;
  pwr_mbtrend	pwr_mbtrend26;
  pwr_mbfast	pwr_mbfast27;
  pwr_mbphoto	pwr_mbphoto28;
  pwr_mbdatasheet	pwr_mbdatasheet29;
  pwr_mbopenplc	pwr_mbopenplc30;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram31;
  pwr_mbrtnavigator	pwr_mbrtnavigator32;
  pwr_mbhelpclass	pwr_mbhelpclass33;
  pwr_mbblockevents	pwr_mbblockevents34;
  pwr_mbhistevent	pwr_mbhistevent35;
  pwr_mbnote	pwr_mbnote36;
  pwr_mbhelp	pwr_mbhelp37;
  pwr_valuelong	pwr_valuelong38;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter39;
  pwr_valuelong	pwr_valuelong40;
  pwr_indsquare	pwr_indsquare41;
  pwr_manswitch3	pwr_manswitch343;
  pwr_contactor2	pwr_contactor244;
  pwr_safetyswitch	pwr_safetyswitch45;
  pwr_indsquare	pwr_indsquare47;
  pwr_valuesmall	pwr_valuesmall50;
  pwr_valuesmall	pwr_valuesmall51;
  pwr_menubar2	pwr_menubar252;
  pwr_pulldownmenu2	pwr_pulldownmenu253;
  pwr_pulldownmenu2	pwr_pulldownmenu254;
  pwr_pulldownmenu2	pwr_pulldownmenu255;
  pwr_pulldownmenu2	pwr_pulldownmenu256;
  pwr_pulldownmenu2	pwr_pulldownmenu257;
  pwr_motor2	pwr_motor258;
  bcomp_fc	bcomp_fc59;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter60;
  pwr_indround	pwr_indround61;
  pwr_indround	pwr_indround62;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter63;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter64;
  pwr_indround	pwr_indround65;
  pwr_indround	pwr_indround66;
  Grp169_	grp169_67;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter68;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter69;
  pwr_indsquare	pwr_indsquare70;
  pwr_indround	pwr_indround72;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter75;
  pwr_valuemedium	pwr_valuemedium76;
  pwr_valuemedium	pwr_valuemedium77;
  pwr_valuemedium	pwr_valuemedium79;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd83;
  Grp210_	grp210_84;
  Grp212_	grp212_85;
  pwr_valuemedium	pwr_valuemedium86;
  pwr_indsquare	pwr_indsquare90;
  pwr_mbsimulate	pwr_mbsimulate91;
  pwr_indsquare	pwr_indsquare92;
  Grp223_	grp223_93;
  pwr_pumpanim2	pwr_pumpanim295;
  pwr_pump3	pwr_pump396;
  pwr_rodcouplinganim	pwr_rodcouplinganim97;
  pwr_fuse3	pwr_fuse398;
  Grp228_	grp228_99;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter100;
  pwr_mbup	pwr_mbup101;
  public JopcBasefcppo5pumpaggr12( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo5pumpaggr12( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo5pumpaggr12");
    pwr_indsquare17 = new pwr_indsquare(session);
    pwr_indsquare17.setBounds(new Rectangle(162,399,14,15));
    pwr_indsquare17.setShadow(1);
    localPanel.add(pwr_indsquare17, new Proportion(pwr_indsquare17.getBounds(), dsize));
    pwr_indsquare19 = new pwr_indsquare(session);
    pwr_indsquare19.setBounds(new Rectangle(162,353,14,15));
    pwr_indsquare19.setFillColor(294);
    ...
    pwr_valuelong21.setBounds(new Rectangle(17,47,367,20));
    ...
    pwr_indsquare22.setBounds(new Rectangle(162,544,14,15));
    pwr_indsquare22.setFillColor(294);
    pwr_indsquare22.setShadow(1);
    localPanel.add(pwr_indsquare22, new Proportion(pwr_indsquare22.getBounds(), dsize));
    pwr_mbopenobject25 = new pwr_mbopenobject(session);
    pwr_mbopenobject25.setBounds(new Rectangle(195,25,18,18));
    pwr_mbopenobject25.setShadow(1);
    localPanel.add(pwr_mbopenobject25, new Proportion(pwr_mbopenobject25.getBounds(), dsize));
    pwr_mbtrend26 = new pwr_mbtrend(session);
    pwr_mbtrend26.setBounds(new Rectangle(56,25,18,18));
    pwr_mbtrend26.setShadow(1);
    localPanel.add(pwr_mbtrend26, new Proportion(pwr_mbtrend26.getBounds(), dsize));
    pwr_mbfast27 = new pwr_mbfast(session);
    pwr_mbfast27.setBounds(new Rectangle(76,25,18,18));
    pwr_mbfast27.setShadow(1);
    localPanel.add(pwr_mbfast27, new Proportion(pwr_mbfast27.getBounds(), dsize));
    pwr_mbphoto28 = new pwr_mbphoto(session);
    pwr_mbphoto28.setBounds(new Rectangle(96,25,18,18));
    pwr_mbphoto28.setShadow(1);
    localPanel.add(pwr_mbphoto28, new Proportion(pwr_mbphoto28.getBounds(), dsize));
    pwr_mbdatasheet29 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet29.setBounds(new Rectangle(116,25,18,18));
    pwr_mbdatasheet29.setShadow(1);
    localPanel.add(pwr_mbdatasheet29, new Proportion(pwr_mbdatasheet29.getBounds(), dsize));
    pwr_mbopenplc30 = new pwr_mbopenplc(session);
    pwr_mbopenplc30.setBounds(new Rectangle(215,25,18,18));
    pwr_mbopenplc30.setShadow(1);
    localPanel.add(pwr_mbopenplc30, new Proportion(pwr_mbopenplc30.getBounds(), dsize));
    pwr_mbcircuitdiagram31 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram31.setBounds(new Rectangle(235,25,18,18));
    pwr_mbcircuitdiagram31.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram31, new Proportion(pwr_mbcircuitdiagram31.getBounds(), dsize));
    pwr_mbrtnavigator32 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator32.setBounds(new Rectangle(175,25,18,18));
    pwr_mbrtnavigator32.setShadow(1);
    localPanel.add(pwr_mbrtnavigator32, new Proportion(pwr_mbrtnavigator32.getBounds(), dsize));
    pwr_mbhelpclass33 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass33.setBounds(new Rectangle(255,25,18,18));
    pwr_mbhelpclass33.setShadow(1);
    localPanel.add(pwr_mbhelpclass33, new Proportion(pwr_mbhelpclass33.getBounds(), dsize));
    pwr_mbblockevents34 = new pwr_mbblockevents(session);
    pwr_mbblockevents34.setBounds(new Rectangle(155,25,18,18));
    pwr_mbblockevents34.setShadow(1);
    localPanel.add(pwr_mbblockevents34, new Proportion(pwr_mbblockevents34.getBounds(), dsize));
    pwr_mbhistevent35 = new pwr_mbhistevent(session);
    pwr_mbhistevent35.setBounds(new Rectangle(136,25,18,18));
    localPanel.add(pwr_mbhistevent35, new Proportion(pwr_mbhistevent35.getBounds(), dsize));
    pwr_mbnote36 = new pwr_mbnote(session);
    pwr_mbnote36.setBounds(new Rectangle(36,25,18,18));
    localPanel.add(pwr_mbnote36, new Proportion(pwr_mbnote36.getBounds(), dsize));
    pwr_mbhelp37 = new pwr_mbhelp(session);
    pwr_mbhelp37.setBounds(new Rectangle(17,25,18,18));
    localPanel.add(pwr_mbhelp37, new Proportion(pwr_mbhelp37.getBounds(), dsize));
    pwr_valuelong38 = new pwr_valuelong(session);
    pwr_valuelong38.setBounds(new Rectangle(17,69,367,20));
    pwr_valuelong38.setFillColor(31);
    pwr_valuelong38.setBorderColor(32);
    localPanel.add(pwr_valuelong38, new Proportion(pwr_valuelong38.getBounds(), dsize));
    pwr_smallbuttoncenter39 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter39.setBounds(new Rectangle(5,699,46,18));
    pwr_smallbuttoncenter39.setFillColor(102);
    pwr_smallbuttoncenter39.setBorderColor(37);
    localPanel.add(pwr_smallbuttoncenter39, new Proportion(pwr_smallbuttoncenter39.getBounds(), dsize));
    pwr_valuelong40 = new pwr_valuelong(session);
    pwr_valuelong40.setBounds(new Rectangle(61,698,334,21));
    pwr_valuelong40.setFillColor(31);
    pwr_valuelong40.setBorderColor(31);
    localPanel.add(pwr_valuelong40, new Proportion(pwr_valuelong40.getBounds(), dsize));
    pwr_indsquare41 = new pwr_indsquare(session);
    pwr_indsquare41.setBounds(new Rectangle(349,97,14,15));
    pwr_indsquare41.setFillColor(295);
    pwr_indsquare41.setShadow(1);
    localPanel.add(pwr_indsquare41, new Proportion(pwr_indsquare41.getBounds(), dsize));
    pwr_manswitch343 = new pwr_manswitch3(session);
    pwr_manswitch343.setBounds(new Rectangle(268,341,36,36));
    pwr_manswitch343.setFillColor(32);
    pwr_manswitch343.setShadow(1);
    localPanel.add(pwr_manswitch343, new Proportion(pwr_manswitch343.getBounds(), dsize));
    pwr_contactor244 = new pwr_contactor2(session);
    pwr_contactor244.setBounds(new Rectangle(268,389,36,36));
    pwr_contactor244.setFillColor(32);
    pwr_contactor244.setShadow(1);
    localPanel.add(pwr_contactor244, new Proportion(pwr_contactor244.getBounds(), dsize));
    pwr_safetyswitch45 = new pwr_safetyswitch(session);
    pwr_safetyswitch45.setBounds(new Rectangle(269,534,36,37));
    pwr_safetyswitch45.setFillColor(32);
    pwr_safetyswitch45.setShadow(1);
    localPanel.add(pwr_safetyswitch45, new Proportion(pwr_safetyswitch45.getBounds(), dsize));
    pwr_indsquare47 = new pwr_indsquare(session);
    pwr_indsquare47.setBounds(new Rectangle(349,118,14,15));
    pwr_indsquare47.setFillColor(175);
    pwr_indsquare47.setShadow(1);
    localPanel.add(pwr_indsquare47, new Proportion(pwr_indsquare47.getBounds(), dsize));
    pwr_valuesmall50 = new pwr_valuesmall(session);
    pwr_valuesmall50.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_valuesmall51.setBounds(new Rectangle(302,249,70,16));
    localPanel.add(pwr_valuesmall51, new Proportion(pwr_valuesmall51.getBounds(), dsize));
    pwr_menubar252 = new pwr_menubar2(session);
    pwr_menubar252.setBounds(new Rectangle(1,1,407,22));
    pwr_menubar252.setShadow(1);
    localPanel.add(pwr_menubar252, new Proportion(pwr_menubar252.getBounds(), dsize));
    pwr_pulldownmenu253 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu253.setBounds(new Rectangle(9,1,42,22));
    pwr_pulldownmenu253.setShadow(1);
    localPanel.add(pwr_pulldownmenu253, new Proportion(pwr_pulldownmenu253.getBounds(), dsize));
    pwr_pulldownmenu254 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu254.setBounds(new Rectangle(329,1,67,22));
    pwr_pulldownmenu254.setShadow(1);
    localPanel.add(pwr_pulldownmenu254, new Proportion(pwr_pulldownmenu254.getBounds(), dsize));
    pwr_pulldownmenu255 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu255.setBounds(new Rectangle(221,1,67,22));
    pwr_pulldownmenu255.setShadow(1);
    localPanel.add(pwr_pulldownmenu255, new Proportion(pwr_pulldownmenu255.getBounds(), dsize));
    pwr_pulldownmenu256 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu256.setBounds(new Rectangle(53,1,67,22));
    pwr_pulldownmenu256.setShadow(1);
    localPanel.add(pwr_pulldownmenu256, new Proportion(pwr_pulldownmenu256.getBounds(), dsize));
    pwr_pulldownmenu257 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu257.setBounds(new Rectangle(125,1,86,22));
    pwr_pulldownmenu257.setShadow(1);
    localPanel.add(pwr_pulldownmenu257, new Proportion(pwr_pulldownmenu257.getBounds(), dsize));
    pwr_motor258 = new pwr_motor2(session);
    pwr_motor258.setBounds(new Rectangle(161,598,96,72));
    localPanel.add(pwr_motor258, new Proportion(pwr_motor258.getBounds(), dsize));
    bcomp_fc59 = new bcomp_fc(session);
    bcomp_fc59.setBounds(new Rectangle(256,438,62,82));
    bcomp_fc59.setShadow(1);
    localPanel.add(bcomp_fc59, new Proportion(bcomp_fc59.getBounds(), dsize));
    pwr_smallbuttoncenter60 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter60.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_indround61 = new pwr_indround(session);
    pwr_indround61.setBounds(new Rectangle(88,174,16,15));
    pwr_indround61.setShadow(1);
    localPanel.add(pwr_indround61, new Proportion(pwr_indround61.getBounds(), dsize));
    pwr_indround62 = new pwr_indround(session);
    pwr_indround62.setBounds(new Rectangle(88,197,16,16));
    pwr_indround62.setShadow(1);
    localPanel.add(pwr_indround62, new Proportion(pwr_indround62.getBounds(), dsize));
    pwr_smallbuttoncenter63 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter63.setBounds(new Rectangle(124,173,59,19));
    pwr_smallbuttoncenter63.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter63, new Proportion(pwr_smallbuttoncenter63.getBounds(), dsize));
    pwr_smallbuttoncenter64 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter64.setBounds(new Rectangle(124,197,59,19));
    pwr_smallbuttoncenter64.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter64, new Proportion(pwr_smallbuttoncenter64.getBounds(), dsize));
    pwr_indround65 = new pwr_indround(session);
    pwr_indround65.setBounds(new Rectangle(86,248,16,15));
    pwr_indround65.setFillColor(114);
    pwr_indround65.setShadow(1);
    localPanel.add(pwr_indround65, new Proportion(pwr_indround65.getBounds(), dsize));
    pwr_indround66 = new pwr_indround(session);
    pwr_indround66.setBounds(new Rectangle(193,174,16,15));
    pwr_indround66.setFillColor(294);
    pwr_indround66.setShadow(1);
    localPanel.add(pwr_indround66, new Proportion(pwr_indround66.getBounds(), dsize));
    grp169_67 = new Grp169_(session);
    grp169_67.setBounds(new Rectangle(35,249,35,16));
    localPanel.add(grp169_67, new Proportion(grp169_67.getBounds(), dsize));
    pwr_smallbuttoncenter68 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter68.setBounds(new Rectangle(240,174,34,19));
    pwr_smallbuttoncenter68.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter68, new Proportion(pwr_smallbuttoncenter68.getBounds(), dsize));
    pwr_smallbuttoncenter69 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter69.setBounds(new Rectangle(240,198,34,19));
    pwr_smallbuttoncenter69.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter69, new Proportion(pwr_smallbuttoncenter69.getBounds(), dsize));
    pwr_indsquare70 = new pwr_indsquare(session);
    pwr_indsquare70.setBounds(new Rectangle(162,448,14,15));
    pwr_indsquare70.setFillColor(294);
    pwr_indsquare70.setShadow(1);
    localPanel.add(pwr_indsquare70, new Proportion(pwr_indsquare70.getBounds(), dsize));
    pwr_indround72 = new pwr_indround(session);
    pwr_indround72.setBounds(new Rectangle(286,174,15,16));
    pwr_indround72.setFillColor(294);
    pwr_indround72.setShadow(1);
    localPanel.add(pwr_indround72, new Proportion(pwr_indround72.getBounds(), dsize));
    pwr_smallbuttoncenter75 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter75.setBounds(new Rectangle(37,467,55,21));
    pwr_smallbuttoncenter75.setFillColor(32);
    pwr_smallbuttoncenter75.setShadow(1);
    localPanel.add(pwr_smallbuttoncenter75, new Proportion(pwr_smallbuttoncenter75.getBounds(), dsize));
    pwr_valuemedium76 = new pwr_valuemedium(session);
    pwr_valuemedium76.setBounds(new Rectangle(309,608,49,15));
    pwr_valuemedium76.setShadow(1);
    localPanel.add(pwr_valuemedium76, new Proportion(pwr_valuemedium76.getBounds(), dsize));
    pwr_valuemedium77 = new pwr_valuemedium(session);
    pwr_valuemedium77.setBounds(new Rectangle(309,626,49,15));
    pwr_valuemedium77.setShadow(1);
    localPanel.add(pwr_valuemedium77, new Proportion(pwr_valuemedium77.getBounds(), dsize));
    pwr_valuemedium79 = new pwr_valuemedium(session);
    pwr_valuemedium79.setBounds(new Rectangle(359,611,18,12));
    pwr_valuemedium79.setFillColor(31);
    pwr_valuemedium79.setBorderColor(31);
    localPanel.add(pwr_valuemedium79, new Proportion(pwr_valuemedium79.getBounds(), dsize));
    pwr_valueinputmediumrd83 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd83.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd83.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd83, new Proportion(pwr_valueinputmediumrd83.getBounds(), dsize));
    grp210_84 = new Grp210_(session);
    grp210_84.setBounds(new Rectangle(127,228,39,16));
    localPanel.add(grp210_84, new Proportion(grp210_84.getBounds(), dsize));
    grp212_85 = new Grp212_(session);
    grp212_85.setBounds(new Rectangle(199,247,26,18));
    grp212_85.setFillColor(31);
    grp212_85.setBorderColor(31);
    localPanel.add(grp212_85, new Proportion(grp212_85.getBounds(), dsize));
    pwr_valuemedium86 = new pwr_valuemedium(session);
    pwr_valuemedium86.setBounds(new Rectangle(309,644,49,15));
    pwr_valuemedium86.setShadow(1);
    localPanel.add(pwr_valuemedium86, new Proportion(pwr_valuemedium86.getBounds(), dsize));
    pwr_indsquare90 = new pwr_indsquare(session);
    pwr_indsquare90.setBounds(new Rectangle(358,200,14,15));
    pwr_indsquare90.setFillColor(175);
    pwr_indsquare90.setShadow(1);
    localPanel.add(pwr_indsquare90, new Proportion(pwr_indsquare90.getBounds(), dsize));
    pwr_mbsimulate91 = new pwr_mbsimulate(session);
    pwr_mbsimulate91.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate91, new Proportion(pwr_mbsimulate91.getBounds(), dsize));
    pwr_indsquare92 = new pwr_indsquare(session);
    pwr_indsquare92.setBounds(new Rectangle(162,573,14,14));
    pwr_indsquare92.setFillColor(294);
    pwr_indsquare92.setShadow(1);
    localPanel.add(pwr_indsquare92, new Proportion(pwr_indsquare92.getBounds(), dsize));
    grp223_93 = new Grp223_(session);
    grp223_93.setBounds(new Rectangle(35,572,38,16));
    localPanel.add(grp223_93, new Proportion(grp223_93.getBounds(), dsize));
    pwr_pumpanim295 = new pwr_pumpanim2(session);
    pwr_pumpanim295.setBounds(new Rectangle(120,96,62,42));
    pwr_pumpanim295.setShadow(1);
    pwr_pumpanim295.setGradient(12);
    localPanel.add(pwr_pumpanim295, new Proportion(pwr_pumpanim295.getBounds(), dsize));
    pwr_pump396 = new pwr_pump3(session);
    pwr_pump396.setBounds(new Rectangle(78,599,82,72));
    pwr_pump396.setColorTone(7);
    localPanel.add(pwr_pump396, new Proportion(pwr_pump396.getBounds(), dsize));
    pwr_rodcouplinganim97 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim97.setBounds(new Rectangle(155,625,10,20));
    localPanel.add(pwr_rodcouplinganim97, new Proportion(pwr_rodcouplinganim97.getBounds(), dsize));
    pwr_fuse398 = new pwr_fuse3(session);
    pwr_fuse398.setBounds(new Rectangle(281,297,13,35));
    pwr_fuse398.setRotate(-90);
    pwr_fuse398.setShadow(1);
    localPanel.add(pwr_fuse398, new Proportion(pwr_fuse398.getBounds(), dsize));
    grp228_99 = new Grp228_(session);
    grp228_99.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp228_99, new Proportion(grp228_99.getBounds(), dsize));
    pwr_smallbuttoncenter100 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter100.setBounds(new Rectangle(34,197,46,19));
    pwr_smallbuttoncenter100.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter100, new Proportion(pwr_smallbuttoncenter100.getBounds(), dsize));
    pwr_mbup101 = new pwr_mbup(session);
    pwr_mbup101.setBounds(new Rectangle(347,25,18,18));
    localPanel.add(pwr_mbup101, new Proportion(pwr_mbup101.getBounds(), dsize));
    pwr_indsquare17.dd.setDynType(13);
    pwr_indsquare17.dd.setActionType(2);
    pwr_indsquare17.dd.setAccess(65532);
    pwr_indsquare17.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare17.dd, "$object.Contactor.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare17.dd, "$object.Contactor.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare17.dd, "$object.Contactor.Feedback")
      });
    pwr_indsquare19.dd.setDynType(5);
    pwr_indsquare19.dd.setActionType(2);
    pwr_indsquare19.dd.setAccess(65532);
    pwr_indsquare19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare19.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean",176)
      ,new GeDynPopupMenu(pwr_indsquare19.dd, "$object.CircuitBreaker.NotTripped")
      });
    pwr_valuelong21.dd.setDynType(1025);
    pwr_valuelong21.dd.setActionType(0);
    pwr_valuelong21.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong21.dd, "$object.Description##String80","%s")
      });
    pwr_indsquare22.dd.setDynType(5);
    pwr_indsquare22.dd.setActionType(2);
    pwr_indsquare22.dd.setAccess(65532);
    pwr_indsquare22.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare22.dd, "$object.SafetySwitch.On.ActualValue##Boolean",114)
      ,new GeDynPopupMenu(pwr_indsquare22.dd, "$object.SafetySwitch.On")
      });
    pwr_mbopenobject25.dd.setDynType(129);
    pwr_mbopenobject25.dd.setActionType(8256);
    pwr_mbopenobject25.dd.setAccess(65532);
    pwr_mbopenobject25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject25.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject25.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject25.dd, JopLang.transl("Open Object"))
      });
    pwr_mbtrend26.dd.setDynType(129);
    pwr_mbtrend26.dd.setActionType(8256);
    pwr_mbtrend26.dd.setAccess(65532);
    pwr_mbtrend26.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend26.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend26.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend26.dd, JopLang.transl("Trend"))
      });
    pwr_mbfast27.dd.setDynType(129);
    pwr_mbfast27.dd.setActionType(8256);
    pwr_mbfast27.dd.setAccess(65532);
    pwr_mbfast27.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast27.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast27.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast27.dd, JopLang.transl("Fast"))
      });
    pwr_mbphoto28.dd.setDynType(129);
    pwr_mbphoto28.dd.setActionType(8256);
    pwr_mbphoto28.dd.setAccess(65532);
    pwr_mbphoto28.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto28.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto28.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto28.dd, JopLang.transl("Photo"))
      });
    pwr_mbdatasheet29.dd.setDynType(129);
    pwr_mbdatasheet29.dd.setActionType(8256);
    pwr_mbdatasheet29.dd.setAccess(65532);
    pwr_mbdatasheet29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet29.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet29.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet29.dd, JopLang.transl("DataSheet"))
      });
    pwr_mbopenplc30.dd.setDynType(129);
    pwr_mbopenplc30.dd.setActionType(8256);
    pwr_mbopenplc30.dd.setAccess(65532);
    pwr_mbopenplc30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc30.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc30.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc30.dd, JopLang.transl("Open Plc"))
      });
    pwr_mbcircuitdiagram31.dd.setDynType(129);
    pwr_mbcircuitdiagram31.dd.setActionType(8256);
    pwr_mbcircuitdiagram31.dd.setAccess(65535);
    pwr_mbcircuitdiagram31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram31.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram31.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram31.dd, JopLang.transl("CircuitDiagram"))
      });
    pwr_mbrtnavigator32.dd.setDynType(129);
    pwr_mbrtnavigator32.dd.setActionType(8256);
    pwr_mbrtnavigator32.dd.setAccess(65532);
    pwr_mbrtnavigator32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator32.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator32.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator32.dd, JopLang.transl("RtNavigator"))
      });
    pwr_mbhelpclass33.dd.setDynType(129);
    pwr_mbhelpclass33.dd.setActionType(8256);
    pwr_mbhelpclass33.dd.setAccess(65532);
    pwr_mbhelpclass33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass33.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass33.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass33.dd, JopLang.transl("Help Class"))
      });
    pwr_mbblockevents34.dd.setDynType(129);
    pwr_mbblockevents34.dd.setActionType(8256);
    pwr_mbblockevents34.dd.setAccess(65532);
    pwr_mbblockevents34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents34.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents34.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents34.dd, JopLang.transl("Block Events"))
      });
    pwr_mbhistevent35.dd.setDynType(129);
    pwr_mbhistevent35.dd.setActionType(8256);
    pwr_mbhistevent35.dd.setAccess(65532);
    pwr_mbhistevent35.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent35.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent35.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent35.dd, JopLang.transl("Hist Event"))
      });
    pwr_mbnote36.dd.setDynType(129);
    pwr_mbnote36.dd.setActionType(8256);
    pwr_mbnote36.dd.setAccess(65532);
    pwr_mbnote36.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote36.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote36.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote36.dd, JopLang.transl("Note"))
      });
    pwr_mbhelp37.dd.setDynType(128);
    pwr_mbhelp37.dd.setActionType(8256);
    pwr_mbhelp37.dd.setAccess(65532);
    pwr_mbhelp37.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp37.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp37.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp37.dd, JopLang.transl("Help"))
      });
    pwr_valuelong38.dd.setDynType(1025);
    pwr_valuelong38.dd.setActionType(0);
    pwr_valuelong38.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong38.dd, "$object.Specification##String80","%s")
      });
    pwr_smallbuttoncenter39.dd.setDynType(128);
    pwr_smallbuttoncenter39.dd.setActionType(64);
    pwr_smallbuttoncenter39.dd.setAccess(65532);
    pwr_smallbuttoncenter39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter39.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter39.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter39.setAnnot1("Note !");
    pwr_valuelong40.dd.setDynType(1025);
    pwr_valuelong40.dd.setActionType(0);
    pwr_valuelong40.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong40.dd, "$object.Note##String80","%s")
      });
    pwr_indsquare41.dd.setDynType(5);
    pwr_indsquare41.dd.setActionType(0);
    pwr_indsquare41.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare41.dd, "$object.Ready##Boolean",29)
      });
    pwr_manswitch343.dd.setDynType(32769);
    pwr_manswitch343.dd.setActionType(66);
    pwr_manswitch343.dd.setAccess(65535);
    pwr_manswitch343.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch343.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch343.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch343.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    pwr_contactor244.dd.setDynType(32769);
    pwr_contactor244.dd.setActionType(66);
    pwr_contactor244.dd.setAccess(65535);
    pwr_contactor244.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor244.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor244.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor244.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_safetyswitch45.dd.setDynType(32769);
    pwr_safetyswitch45.dd.setActionType(66);
    pwr_safetyswitch45.dd.setAccess(65535);
    pwr_safetyswitch45.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch45.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch45.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch45.dd, "open graph/class/instance=$object.SafetySwitch")
      });
    pwr_indsquare47.dd.setDynType(5);
    pwr_indsquare47.dd.setActionType(0);
    pwr_indsquare47.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare47.dd, "$object.ExtInterlock##Boolean",29)
      });
    ...
    pwr_menubar252.dd.setDynType(1);
    pwr_menubar252.dd.setActionType(0);
    pwr_pulldownmenu253.dd.setDynType(0);
    pwr_pulldownmenu253.dd.setActionType(524288);
    pwr_pulldownmenu253.dd.setAccess(65535);
    pwr_pulldownmenu253.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu253.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu253,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu253.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu253,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu253.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu253.setAnnot1("File");
    pwr_pulldownmenu254.dd.setDynType(1);
    pwr_pulldownmenu254.dd.setActionType(524288);
    pwr_pulldownmenu254.dd.setAccess(65532);
    pwr_pulldownmenu254.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu254.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu254,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu254,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu254.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu254.setAnnot1("Help");
    ...
    pwr_pulldownmenu255.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu255.dd, new String[] {
        JopLang.transl("CircuitBreaker.NotTripped Di"),JopLang.transl("Contactor.Order Do"),JopLang.transl("Contactor.Feedback Di"),JopLang.transl("SafetySwitch.On Di"),JopLang.transl("FrequencyConverter.ActSpeed"),JopLang.transl("FrequencyConverter.ActTorque"),JopLang.transl("FrequencyConverter.ActCurrent"),JopLang.transl("FrequencyConverter.RefSpeed"),JopLang.transl("Motor.TempSwitch.Switch Di"),JopLang.transl("Motor.TempSensor.Value Ai"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.CircuitBreaker.NotTripped")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Contactor.Order")
      }),
    new GeDyn(pwr_pulldownmenu255,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu255.dd, "$object.Contactor.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Contactor.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.FrequencyConverter.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.FrequencyConverter.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.FrequencyConverter.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu255,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.FrequencyConverter.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu255,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu255.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu255,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu255.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu255.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu255.setAnnot1("Signals");
    pwr_pulldownmenu256.dd.setDynType(1);
    pwr_pulldownmenu256.dd.setActionType(524288);
    pwr_pulldownmenu256.dd.setAccess(65535);
    pwr_pulldownmenu256.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu256.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu256,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu256,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu256.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu256.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu256.setAnnot1("Methods");
    pwr_pulldownmenu257.dd.setDynType(1);
    pwr_pulldownmenu257.dd.setActionType(524288);
    pwr_pulldownmenu257.dd.setAccess(65535);
    pwr_pulldownmenu257.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu257.dd, new String[] {
        JopLang.transl("CircuitBreaker"),JopLang.transl("Contactor"),JopLang.transl("SafetySwitch"),JopLang.transl("FrequencyConverter"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.CircuitBreaker")
      }),
    new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.Contactor")
      }),
    new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
    new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.FrequencyConverter")
      }),
    new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu257.setAnnot1("Components");
    pwr_motor258.dd.setDynType(0);
    pwr_motor258.dd.setActionType(66);
    pwr_motor258.dd.setAccess(65535);
    pwr_motor258.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_motor258.dd, "$object.Motor")
      ,new GeDynCommand(pwr_motor258.dd, "open graph/class/instance=$object.motor")
      });
    bcomp_fc59.dd.setDynType(1);
    bcomp_fc59.dd.setActionType(66);
    bcomp_fc59.dd.setAccess(65535);
    bcomp_fc59.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(bcomp_fc59.dd, "$object.FrequencyConverter")
      ,new GeDynCommand(bcomp_fc59.dd, "open graph /class/instance=$object.FrequencyConverter")
      });
    ...
    pwr_smallbuttoncenter60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter60.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter60.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter60.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter60.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter60.setAnnot1("Man");
    pwr_indround61.dd.setDynType(133);
    pwr_indround61.dd.setActionType(0);
    pwr_indround61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround61.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround61.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround62.dd.setDynType(133);
    pwr_indround62.dd.setActionType(0);
    pwr_indround62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround62.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround62.dd, "$object.Mode.AutoMode##Boolean",29)
      });
    pwr_smallbuttoncenter63.dd.setDynType(129);
    pwr_smallbuttoncenter63.dd.setActionType(6);
    pwr_smallbuttoncenter63.dd.setAccess(65532);
    pwr_smallbuttoncenter63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter63.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter63.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter63.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter63.dd, "$object.MOde.OpManStart##Boolean")
      });
    pwr_smallbuttoncenter63.setAnnot1("Start");
    pwr_smallbuttoncenter64.dd.setDynType(129);
    pwr_smallbuttoncenter64.dd.setActionType(6);
    pwr_smallbuttoncenter64.dd.setAccess(65532);
    pwr_smallbuttoncenter64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter64.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter64.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter64.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter64.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter64.setAnnot1("Stop");
    pwr_indround65.dd.setDynType(133);
    pwr_indround65.dd.setActionType(0);
    pwr_indround65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround65.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround65.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    pwr_indround66.dd.setDynType(5);
    pwr_indround66.dd.setActionType(0);
    pwr_indround66.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround66.dd, "$object.FrequencyConverter.ConvertRun##Boolean",29)
      });
    grp169_67.dd.setDynType(129);
    grp169_67.dd.setActionType(0);
    grp169_67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp169_67.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    pwr_smallbuttoncenter68.dd.setDynType(129);
    pwr_smallbuttoncenter68.dd.setActionType(6);
    pwr_smallbuttoncenter68.dd.setAccess(65532);
    pwr_smallbuttoncenter68.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter68.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter68.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(pwr_smallbuttoncenter68.dd, "$object.OpPowerOn##Boolean")
      });
    pwr_smallbuttoncenter68.setAnnot1("On");
    pwr_smallbuttoncenter69.dd.setDynType(129);
    pwr_smallbuttoncenter69.dd.setActionType(6);
    pwr_smallbuttoncenter69.dd.setAccess(65532);
    pwr_smallbuttoncenter69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter69.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter69.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(pwr_smallbuttoncenter69.dd, "$object.OpPowerOff##Boolean")
      });
    pwr_smallbuttoncenter69.setAnnot1("Off");
    pwr_indsquare70.dd.setDynType(117);
    pwr_indsquare70.dd.setActionType(2);
    pwr_indsquare70.dd.setAccess(65532);
    pwr_indsquare70.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare70.dd, "$object.FrequencyConverter.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare70.dd, "$object.FrequencyConverter.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare70.dd, "$object.FrequencyConverter.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare70.dd, "$object.FrequencyConverter.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare70.dd, "$object.FrequencyConverter")
      });
    pwr_indround72.dd.setDynType(5);
    pwr_indround72.dd.setActionType(0);
    pwr_indround72.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround72.dd, "$object.Contactor.IndFeedback##Boolean",29)
      });
    pwr_smallbuttoncenter75.dd.setDynType(1);
    pwr_smallbuttoncenter75.dd.setActionType(4);
    pwr_smallbuttoncenter75.dd.setAccess(65532);
    pwr_smallbuttoncenter75.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter75.dd, "$object.FrequencyConverter.OpReset##Boolean")
      });
    pwr_smallbuttoncenter75.setAnnot1("Reset");
    pwr_valuemedium76.dd.setDynType(1024);
    pwr_valuemedium76.dd.setActionType(2);
    pwr_valuemedium76.dd.setAccess(65532);
    pwr_valuemedium76.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium76.dd, "$object.FrequencyConverter.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium76.dd, "$object.FrequencyConverter.ActSpeed")
      });
    pwr_valuemedium77.dd.setDynType(1025);
    pwr_valuemedium77.dd.setActionType(2);
    pwr_valuemedium77.dd.setAccess(65532);
    pwr_valuemedium77.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium77.dd, "$object.FrequencyConverter.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium77.dd, "$object.FrequencyConverter.ActTorque")
      });
    pwr_valuemedium79.dd.setDynType(1025);
    pwr_valuemedium79.dd.setActionType(0);
    pwr_valuemedium79.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium79.dd, "$object.FrequencyConverter.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd83.dd.setDynType(1153);
    pwr_valueinputmediumrd83.dd.setActionType(4096);
    pwr_valueinputmediumrd83.dd.setAccess(65532);
    pwr_valueinputmediumrd83.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd83.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd83.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd83.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd83.setAnnot1Font(pwr_valueinputmediumrd83.annotFont.deriveFont((float)14));
    grp210_84.dd.setDynType(129);
    grp210_84.dd.setActionType(0);
    grp210_84.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_84.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_85.dd.setDynType(129);
    grp212_85.dd.setActionType(0);
    grp212_85.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_85.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_valuemedium86.dd.setDynType(1025);
    pwr_valuemedium86.dd.setActionType(2);
    pwr_valuemedium86.dd.setAccess(65532);
    pwr_valuemedium86.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium86.dd, "$object.FrequencyConverter.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium86.dd, "$object.FrequencyConverter.ActCurrrent")
      });
    pwr_indsquare90.dd.setDynType(5);
    pwr_indsquare90.dd.setActionType(0);
    pwr_indsquare90.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare90.dd, "$object.PowExtInterlock##Boolean",29)
      });
    pwr_mbsimulate91.dd.setDynType(129);
    pwr_mbsimulate91.dd.setActionType(8256);
    pwr_mbsimulate91.dd.setAccess(65532);
    pwr_mbsimulate91.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate91.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate91.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate91.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare92.dd.setDynType(176);
    pwr_indsquare92.dd.setActionType(2);
    pwr_indsquare92.dd.setAccess(65532);
    pwr_indsquare92.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare92.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare92.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare92.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare92.dd, "$object.Motor")
      });
    grp223_93.dd.setDynType(129);
    grp223_93.dd.setActionType(0);
    grp223_93.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_93.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim295.dd.setDynType(66612);
    pwr_pumpanim295.dd.setActionType(0);
    pwr_pumpanim295.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim295.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim295.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim295.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim295.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim295.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_pump396.dd.setDynType(1);
    pwr_pump396.dd.setActionType(66);
    pwr_pump396.dd.setAccess(65532);
    pwr_pump396.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump396.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump396.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim97.dd.setDynType(65537);
    pwr_rodcouplinganim97.dd.setActionType(0);
    pwr_rodcouplinganim97.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim97.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      });
    pwr_fuse398.dd.setDynType(1);
    pwr_fuse398.dd.setActionType(0);
    grp228_99.dd.setDynType(129);
    grp228_99.dd.setActionType(0);
    grp228_99.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_99.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter100.dd.setDynType(129);
    pwr_smallbuttoncenter100.dd.setActionType(6);
    pwr_smallbuttoncenter100.dd.setAccess(65532);
    pwr_smallbuttoncenter100.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter100.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter100.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter100.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter100.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter100.setAnnot1("Auto");
    pwr_mbup101.dd.setDynType(129);
    pwr_mbup101.dd.setActionType(8256);
    pwr_mbup101.dd.setAccess(33619967);
    pwr_mbup101.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup101.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup101.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup101.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 720;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {600, 600, 596, 570, 596, 600}, 6),
    new Line2D.Float( 288F, 536F, 288F, 518F),
    new Line2D.Float( 288F, 440F, 288F, 424F),
    new Line2D.Float( 288F, 392F, 288F, 378F),
    new Line2D.Float( 288F, 286F, 288F, 342F),
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {600, 600, 596, 570, 596, 600}, 6),
    new Line2D.Float( 288F, 536F, 288F, 518F),
    new Line2D.Float( 288F, 440F, 288F, 424F),
    ...
    new Rectangle2D.Float(19.7573F, 279.338F, 361.009F, 412.716F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 279, 279, 280, 280, 691, 692}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 692, 279, 280, 691, 691, 692}, 6), 
    ...
    new Rectangle2D.Float(41F, 113F, 196F, 7F),
    new Polygon( new int[] { 41, 237, 235, 43, 43, 41}, new int[] { 113, 113, 115, 115, 118, 120}, 6), 
    new Polygon( new int[] { 237, 237, 235, 235, 43, 41}, new int[] { 120, 113, 115, 118, 118, 120}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 555);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),363, 639);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 639);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 621);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[25]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 657);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 657);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 41, 44}, new int[] { 14, 12, 12,14}, 4),
    new Polygon( new int[] { 44, 41, 41, 44}, new int[] { 14, 12, 9,10}, 4),
    new Polygon( new int[] { 44, 41, 67, 64}, new int[] { 10, 9, 9,10}, 4),
    new Polygon( new int[] { 64, 67, 67, 64}, new int[] { 10, 9, 52,52}, 4),
    ...
    new Polygon( new int[] { 6, 3, 9, -37}, new int[] { 8, 10, 12,14}, 4),
    ...
    new Polygon( new int[] { 6, 7, -12, -37}, new int[] { 40, 36, -1219915361,14}, 4),
    ...
    new Polygon( new int[] { 58, 61, 61, 58}, new int[] { 38, 38, 14,10}, 4),
    new Polygon( new int[] { 58, 61, 61, 64}, new int[] { 10, 14, 14,10}, 4),
    new Polygon( new int[] { 64, 61, 61, 64}, new int[] { 10, 14, 52,52}, 4),
    ...
    new Polygon( new int[] { 58, 56, 56, 58}, new int[] { 38, 38, 14,10}, 4),
    new Polygon( new int[] { 58, 56, 56, 54}, new int[] { 10, 14, 14,10}, 4),
    new Polygon( new int[] { 54, 56, -1219915413, -37}, new int[] { 10, 14, -1219915361,14}, 4),
    ...
    new Polygon( new int[] { 44, 47, 47, 44}, new int[] { 14, 17, 14,10}, 4),
    new Polygon( new int[] { 44, 47, 61, 64}, new int[] { 10, 14, 14,10}, 4),
    new Polygon( new int[] { 64, 61, 61, 64}, new int[] { 10, 14, 52,52}, 4),
    new Polygon( new int[] { 64, 61, 59, 62}, new int[] { 52, 52, 56,58}, 4),
    new Polygon( new int[] { 62, 59, 55, 56}, new int[] { 58, 56, 59,62}, 4),
    new Polygon( new int[] { 56, 55, 15, 14}, new int[] { 62, 59, 59,62}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915413, -37}, new int[] { 14, 17, -1219915361,14}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915395, -19}, new int[] { 12, 15, -1219915331,44}, 4),
...
protected class Grp228_ extends GeComponent {
  // Dimension size;
  public Grp228_( JopSession session)
  {
    super( session);
    size = new Dimension( 40, 18);
  }
