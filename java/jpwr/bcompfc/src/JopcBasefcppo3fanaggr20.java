...
public class JopcBasefcppo3fanaggr20 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium59.setBounds(new Rectangle(356,516,20,14));
    ...
    pwr_indsquare68.setBounds(new Rectangle(161,478,16,17));
    ...
    pwr_rod72.setBounds(new Rectangle(130,535,39,10));
    ...
    pwr_fananim73.setBounds(new Rectangle(118,495,19,91));
    ...
    grp227_74.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_fuse379.setBounds(new Rectangle(280,296,15,37));
    ...
    pwr_contactor280.setBounds(new Rectangle(267,340,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222579, -3}, new int[] { 12, 15, -1220222533,42}, 4),
