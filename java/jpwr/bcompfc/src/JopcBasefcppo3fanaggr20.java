...
public class JopcBasefcppo3fanaggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp221_	grp221_69;
  pwr_fananim2	pwr_fananim271;
  pwr_rod	pwr_rod72;
  pwr_fananim	pwr_fananim73;
  Grp227_	grp227_74;
  ...
  bcomp_fc	bcomp_fc81;
  pwr_mbup	pwr_mbup82;
  public JopcBasefcppo3fanaggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefcppo3fanaggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefcppo3fanaggr20");
    ...
    pwr_valuemedium59.setBounds(new Rectangle(357,517,18,12));
    ...
    pwr_indsquare68.setBounds(new Rectangle(162,479,14,15));
    ...
    grp221_69.setBounds(new Rectangle(35,478,38,16));
    localPanel.add(grp221_69, new Proportion(grp221_69.getBounds(), dsize));
    pwr_fananim271 = new pwr_fananim2(session);
    pwr_fananim271.setBounds(new Rectangle(116,96,62,42));
    pwr_fananim271.setBorderColor(29);
    pwr_fananim271.setTextColor(0);
    pwr_fananim271.setShadow(1);
    pwr_fananim271.setGradient(12);
    localPanel.add(pwr_fananim271, new Proportion(pwr_fananim271.getBounds(), dsize));
    pwr_rod72 = new pwr_rod(session);
    pwr_rod72.setBounds(new Rectangle(131,536,37,8));
    pwr_rod72.setShadow(1);
    localPanel.add(pwr_rod72, new Proportion(pwr_rod72.getBounds(), dsize));
    pwr_fananim73 = new pwr_fananim(session);
    pwr_fananim73.setBounds(new Rectangle(119,496,17,89));
    pwr_fananim73.setShadow(1);
    localPanel.add(pwr_fananim73, new Proportion(pwr_fananim73.getBounds(), dsize));
    grp227_74 = new Grp227_(session);
    grp227_74.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp227_74, new Proportion(grp227_74.getBounds(), dsize));
    ...
    pwr_fuse379.setBounds(new Rectangle(281,297,13,35));
    ...
    pwr_contactor280.setBounds(new Rectangle(268,341,36,36));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim271.dd.setDynType(66612);
    pwr_fananim271.dd.setActionType(0);
    pwr_fananim271.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim271.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim271.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim271.dd, "$object.FrequencyConverter.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim271.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim271.dd, "$object.FrequencyConverter.ConvertRun##Boolean",2)
      });
    pwr_fananim271.setAnnot1("L");
    pwr_rod72.dd.setDynType(1);
    pwr_rod72.dd.setActionType(0);
    pwr_fananim73.dd.setDynType(65537);
    pwr_fananim73.dd.setActionType(66);
    pwr_fananim73.dd.setAccess(65532);
    pwr_fananim73.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim73.dd, "$object.FrequencyConverter.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim73.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim73.dd, "open graph/class/inst=$object.Fan")
      });
    grp227_74.dd.setDynType(129);
    grp227_74.dd.setActionType(0);
    grp227_74.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp227_74.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915379, -3}, new int[] { 12, 15, -1219915333,42}, 4),
