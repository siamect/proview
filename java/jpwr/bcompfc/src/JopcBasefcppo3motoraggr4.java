...
public class JopcBasefcppo3motoraggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(152,522,12,22));
    ...
    grp224_76.setBounds(new Rectangle(35,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220222564, 11}, new int[] { 12, 15, -1220222548,27}, 4),
