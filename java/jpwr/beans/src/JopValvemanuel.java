/* 
 * Proview   $Id: JopValvemanuel.java,v 1.3 2005-09-01 14:57:50 claes Exp $
...
public class JopValvemanuel extends JComponent implements JopDynamic, ActionListener{
  Dimension size;
  Object root;
  JopEngine en;
  Timer timer = new Timer(500, this);
  public JopValvemanuel()
  {
    try {
      jbInit();
    }
  ...
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 2, 2, 42, 42, 2}, new int[] {8, 28, 8, 28, 8}, 5),
    new Line2D.Float( 32F, 2F, 12F, 2F),
    new Line2D.Float( 22F, 18F, 22F, 2F),
  };
