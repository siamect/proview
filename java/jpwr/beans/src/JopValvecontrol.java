/* 
 * Proview   $Id: JopValvecontrol.java,v 1.3 2005-09-01 14:57:50 claes Exp $
...
public class JopValvecontrol extends JComponent implements JopDynamic, ActionListener{
  Dimension size;
  Object root;
  JopEngine en;
  Timer timer = new Timer(500, this);
  public JopValvecontrol()
  {
    try {
      jbInit();
    }
  ...
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 2, 2, 42, 42, 2}, new int[] {10, 30, 10, 30, 10}, 5),
    new Polygon( new int[] { 10, 34, 30, 22, 14, 10}, new int[] {8, 8, 4, 2, 4, 8}, 6),
    new Line2D.Float( 22F, 20F, 22F, 8F),
  };
