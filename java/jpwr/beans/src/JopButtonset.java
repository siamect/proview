/* 
 * Proview   $Id: JopButtonset.java,v 1.4 2005-09-01 14:57:49 claes Exp $
...
public class JopButtonset extends JComponent implements JopDynamic, JopConfirm, ActionListener{
  Dimension size;
  Object root;
  JopEngine en;
  ...
  JopSession session;
  public JopButtonset component = this;
  public JopButtonset()
  {
    try {
      jbInit();
