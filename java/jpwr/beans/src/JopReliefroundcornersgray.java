/* 
 * Proview   $Id: JopReliefroundcornersgray.java,v 1.3 2005-09-01 14:57:49 claes Exp $
...
import javax.swing.*;
public class JopReliefroundcornersgray extends JComponent {
  Dimension size;
  public JopReliefroundcornersgray()
  {
    try {
      jbInit();
    }
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 38, 6, 6, 26, 26, 70, 124, 36}, new int[] {6, 80, 120, 120, 138, 138, 6, 6}, 8),
    new Polygon( new int[] { 136, 82, 210, 238, 238, 218, 218, 136}, new int[] {6, 138, 138, 76, 24, 24, 6, 6}, 8),
    new Polygon( new int[] { 164, 112, 164, 214, 164}, new int[] {6, 138, 138, 6, 6}, 5),
  };
