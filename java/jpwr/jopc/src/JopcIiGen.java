...
public class JopcIiGen extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputmedium	pwr_valueinputmedium15;
  ...
  pwr_mbcrossreferences	pwr_mbcrossreferences31;
  JopSmallbutton	jopSmallbutton32;
  pwr_valuelong	pwr_valuelong33;
  pwr_buttoncommandcenter	pwr_buttoncommandcenter34;
  public JopcIiGen( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcIiGen( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcIiGen");
    pwr_valuemedium2 = new pwr_valuemedium(session);
    pwr_valuemedium2.setBounds(new Rectangle(128,128,92,21));
    ...
    jopBar4.setBounds(new Rectangle(254,66,12,141));
    ...
    jopTrend5.setBounds(new Rectangle(291,65,475,141));
    ...
    pwr_valuelong11.setBounds(new Rectangle(126,28,676,20));
    ...
    pwr_sliderbackground112.setBounds(new Rectangle(783,54,18,165));
    ...
    pwr_slider113.setBounds(new Rectangle(784,59,19,16));
    ...
    jopSmallbutton14.setBounds(new Rectangle(676,210,61,18));
    jopSmallbutton14.setColorTone(1);
    localPanel.add(jopSmallbutton14, new Proportion(jopSmallbutton14.getBounds(), dsize));
    pwr_valueinputmedium15 = new pwr_valueinputmedium(session);
    pwr_valueinputmedium15.setBounds(new Rectangle(128,103,92,21));
    pwr_valueinputmedium15.setBorderColor(47);
    localPanel.add(pwr_valueinputmedium15, new Proportion(pwr_valueinputmedium15.getBounds(), dsize));
    pwr_valueinputreliefup16 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup16.setBounds(new Rectangle(204,59,39,16));
    ...
    pwr_valueinputreliefup17.setBounds(new Rectangle(204,201,39,16));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(290,213,39,16));
    ...
    pwr_mbopenobject19.setBounds(new Rectangle(183,6,17,17));
    pwr_mbopenobject19.setColorTone(19);
    ...
    pwr_mbtrend20.setBounds(new Rectangle(49,6,17,17));
    pwr_mbtrend20.setColorTone(19);
    ...
    pwr_mbfast21.setBounds(new Rectangle(68,6,17,17));
    pwr_mbfast21.setColorTone(19);
    ...
    pwr_mbphoto22.setBounds(new Rectangle(87,6,17,17));
    pwr_mbphoto22.setColorTone(19);
    ...
    pwr_mbdatasheet23.setBounds(new Rectangle(106,6,17,17));
    pwr_mbdatasheet23.setColorTone(19);
    ...
    pwr_mbcircuitdiagram24.setBounds(new Rectangle(221,6,17,17));
    pwr_mbcircuitdiagram24.setColorTone(19);
    ...
    pwr_mbrtnavigator25.setBounds(new Rectangle(164,6,17,17));
    pwr_mbrtnavigator25.setColorTone(19);
    ...
    pwr_mbhelpclass26.setBounds(new Rectangle(241,6,17,17));
    pwr_mbhelpclass26.setColorTone(19);
    ...
    pwr_mbblockevents27.setBounds(new Rectangle(145,6,17,17));
    pwr_mbblockevents27.setColorTone(19);
    ...
    pwr_mbhistevent28.setBounds(new Rectangle(125,6,17,17));
    pwr_mbhistevent28.setColorTone(19);
    localPanel.add(pwr_mbhistevent28, new Proportion(pwr_mbhistevent28.getBounds(), dsize));
    pwr_mbnote29 = new pwr_mbnote(session);
    pwr_mbnote29.setBounds(new Rectangle(29,6,17,17));
    pwr_mbnote29.setColorTone(19);
    localPanel.add(pwr_mbnote29, new Proportion(pwr_mbnote29.getBounds(), dsize));
    pwr_mbhelp30 = new pwr_mbhelp(session);
    pwr_mbhelp30.setBounds(new Rectangle(10,6,17,17));
    pwr_mbhelp30.setColorTone(19);
    localPanel.add(pwr_mbhelp30, new Proportion(pwr_mbhelp30.getBounds(), dsize));
    pwr_mbcrossreferences31 = new pwr_mbcrossreferences(session);
    pwr_mbcrossreferences31.setBounds(new Rectangle(202,6,17,17));
    pwr_mbcrossreferences31.setColorTone(19);
    localPanel.add(pwr_mbcrossreferences31, new Proportion(pwr_mbcrossreferences31.getBounds(), dsize));
    jopSmallbutton32 = new JopSmallbutton(session);
    jopSmallbutton32.setBounds(new Rectangle(280,6,44,18));
    ...
    pwr_valuelong33.setBounds(new Rectangle(334,6,470,20));
    pwr_valuelong33.setFillColor(41);
    pwr_valuelong33.setBorderColor(31);
    localPanel.add(pwr_valuelong33, new Proportion(pwr_valuelong33.getBounds(), dsize));
    pwr_buttoncommandcenter34 = new pwr_buttoncommandcenter(session);
    pwr_buttoncommandcenter34.setBounds(new Rectangle(12,199,81,27));
    pwr_buttoncommandcenter34.setFillColor(32);
    localPanel.add(pwr_buttoncommandcenter34, new Proportion(pwr_buttoncommandcenter34.getBounds(), dsize));
    ...
    jopBar4.setMinValueAttr("$object.PresMinLimit##Float32");
    jopBar4.setMaxValueAttr("$object.PresMaxLimit##Float32");
    jopTrend5.setPwrAttribute1("$object.ActualValue##Int32");
    jopTrend5.setMinValueAttr1("$object.PresMinLimit##Float32");
    jopTrend5.setMaxValueAttr1("$object.PresMaxLimit##Float32");
    ...
    pwr_sliderbackground112.dd.setDynType(524289);
    ...
    pwr_slider113.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider113.dd, "$object.ActualValue##Int32",0,100,4,61.7336,201.659,"$object.PresMinLimit##Float32","$object.PresMaxLimit##Float32","!$local.SliderEnable##Boolean",800,240.194)
      });
    jopSmallbutton14.dd.setDynType(4);
    jopSmallbutton14.dd.setActionType(16);
    jopSmallbutton14.dd.setAccess(6);
    jopSmallbutton14.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(jopSmallbutton14.dd, "!$local.SliderEnable##Boolean",102)
      ,new GeDynToggleDig(jopSmallbutton14.dd, "$local.SliderEnable##Boolean")
      });
    jopSmallbutton14.setAnnot1(" Slider");
    pwr_valueinputmedium15.dd.setDynType(1024);
    pwr_valueinputmedium15.dd.setActionType(4096);
    pwr_valueinputmedium15.dd.setAccess(6);
    pwr_valueinputmedium15.dd.setElements(new GeDynElemIfc[] {
    ...
    pwr_mbhistevent28.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent28.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",1)
    ...
    pwr_mbnote29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote29.dd, "$cmd(check method/method=\"Note\"/object=$object)",1)
    ...
    pwr_mbcrossreferences31.dd.setDynType(128);
    pwr_mbcrossreferences31.dd.setActionType(8256);
    pwr_mbcrossreferences31.dd.setAccess(65532);
    pwr_mbcrossreferences31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcrossreferences31.dd, "$cmd(check method/method=\"Crossreferences\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcrossreferences31.dd, "call method/method=\"Crossreferences\"/object=$object")
      ,new GeDynTipText(pwr_mbcrossreferences31.dd, JopLang.transl("Crossreferences"))
      });
    ...
    pwr_buttoncommandcenter34.dd.setDynType(1);
    pwr_buttoncommandcenter34.dd.setActionType(64);
    pwr_buttoncommandcenter34.dd.setAccess(33619967);
    pwr_buttoncommandcenter34.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_buttoncommandcenter34.dd, "open graph/classgraph/inst=&$object.SigChanCon")
      });
    pwr_buttoncommandcenter34.setAnnot1("Channel");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Description"),20, 43);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("ActualValue"),20, 118);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("InitialValue"),20, 143);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("0"),761, 220);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommandcenter extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 94.9153F, 30.9927F),
    new Polygon( new int[] { 2, 97, 92, 7, 7, 2}, new int[] { 2, 2, 7, 7, 28, 33}, 6), 
    new Polygon( new int[] { 97, 97, 92, 92, 7, 2}, new int[] { 33, 2, 7, 28, 28, 33}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,1,-1,2F,2F,94.9153F,30.9927F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    ...
    if ( annot1 != null)
      g.drawString( annot1, 50 * original_height / height * width / original_width- (float)g.getFont().getStringBounds(annot1, frc).getWidth()/2, 22F);
...
protected class pwr_mbopenobject extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,15.4964F,15.4964F, false,34, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
...
protected class pwr_mbtrend extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Line2D.Float( 13.6223F, 13.6223F, 5.87409F, 13.6223F),
    new Line2D.Float( 13.6223F, 5.87409F, 13.6223F, 13.6223F),
...
protected class pwr_mbfast extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Line2D.Float( 13.6223F, 13.6223F, 5.87409F, 13.6223F),
    new Line2D.Float( 5.87409F, 5.87409F, 5.87409F, 13.6223F),
...
protected class pwr_mbphoto extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 14, 13, 6, 6, 6}, new int[] { 6, 6, 6, 6, 13, 14}, 6), 
    new Polygon( new int[] { 14, 14, 13, 13, 6, 6}, new int[] { 14, 6, 6, 13, 13, 14}, 6), 
    new Arc2D.Float(8.77966F, 7.81114F, 2.90557F, 2.90557F, 35F, 140F, Arc2D.PIE),
    new Arc2D.Float(8.77966F, 7.81114F, 2.90557F, 2.90557F, 215F, 140F, Arc2D.PIE),
    new Arc2D.Float(8.77966F, 7.81114F, 2.90557F, 2.90557F, -5F, 40F, Arc2D.PIE),
    new Arc2D.Float(8.77966F, 7.81114F, 2.90557F, 2.90557F, 175F, 40F, Arc2D.PIE),
    new Arc2D.Float(8.92494F, 7.95642F, 2.61501F, 2.61501F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(8.77966F, 7.81114F, 2.90557F, 2.90557F, 0F, 360F, Arc2D.PIE),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, 9,2,-2,8.77966F,7.81114F,2.90557F,2.90557F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[11]);
    GeGradient.paint( g, gradient,2,-2,8.77966F,7.81114F,2.90557F,2.90557F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[10]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
...
protected class pwr_mbdatasheet extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Rectangle2D.Float(6.84262F, 5.87409F, 5.81114F, 7.74818F),
    new Polygon( new int[] { 7, 13, 12, 7, 7, 7}, new int[] { 6, 6, 6, 6, 13, 14}, 6), 
    new Polygon( new int[] { 13, 13, 12, 12, 7, 7}, new int[] { 14, 6, 6, 13, 13, 14}, 6), 
...
protected class pwr_mbcircuitdiagram extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Rectangle2D.Float(4.90557F, 6.84262F, 9.68523F, 6.77966F),
    new Polygon( new int[] { 5, 15, 14, 5, 5, 5}, new int[] { 7, 7, 7, 7, 13, 14}, 6), 
    new Polygon( new int[] { 15, 15, 14, 14, 5, 5}, new int[] { 14, 7, 7, 13, 13, 14}, 6), 
    new Line2D.Float( 14.5908F, 12.6538F, 4.90557F, 12.6538F),
    new Line2D.Float( 10.7167F, 8.77966F, 4.90557F, 8.77966F),
    new Line2D.Float( 10.7167F, 10.7167F, 10.7167F, 8.77966F),
    new Rectangle2D.Float(6.84262F, 10.7167F, 3.87409F, 0.968523F),
    ...
    new Line2D.Float( 14.5908F, 9.74818F, 10.7167F, 9.74818F),
    new Line2D.Float( 14.5908F, 7.81114F, 10.7167F, 7.81114F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,6.84262F,10.7167F,3.87409F,0.968523F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[9]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_mbrtnavigator extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Rectangle2D.Float(5.87409F, 5.87409F, 3.87409F, 2.90557F),
    new Polygon( new int[] { 6, 10, 10, 6, 6, 6}, new int[] { 6, 6, 6, 6, 9, 9}, 6), 
    new Polygon( new int[] { 10, 10, 10, 10, 6, 6}, new int[] { 9, 6, 6, 9, 9, 9}, 6), 
    new Rectangle2D.Float(7.81114F, 9.74818F, 3.87409F, 4.84262F),
    new Polygon( new int[] { 8, 12, 11, 8, 8, 8}, new int[] { 10, 10, 10, 10, 14, 15}, 6), 
    new Polygon( new int[] { 12, 12, 11, 11, 8, 8}, new int[] { 15, 10, 10, 14, 14, 15}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,5.87409F,5.87409F,3.87409F,2.90557F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[3]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,7.81114F,9.74818F,3.87409F,4.84262F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[6]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_mbhelpclass extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 9.74818F, 13.4015F, 9.74818F, 12.6538F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_mbblockevents extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Line2D.Float( 9.74818F, 13.4015F, 9.74818F, 12.6538F),
    new Line2D.Float( 9.74818F, 10.7167F, 9.74818F, 5.87409F),
    new Line2D.Float( 13.6223F, 13.6223F, 5.87409F, 5.87409F),
    new Line2D.Float( 13.6223F, 5.87409F, 5.87409F, 13.6223F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_mbhistevent extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 9.74818F, 10.7167F, 9.74818F, 7.81114F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_mbhelp extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Line2D.Float( 9.74818F, 6.62179F, 9.74818F, 5.87409F),
    new Line2D.Float( 10.5423F, 12.6538F, 8.60522F, 12.6538F),
...
protected class pwr_valuelong extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,515.254F,13.5593F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_mbcrossreferences extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 17, 15, 4, 4, 2}, new int[] { 2, 2, 4, 4, 15, 17}, 6), 
    new Polygon( new int[] { 17, 17, 15, 15, 4, 2}, new int[] { 17, 2, 4, 15, 15, 17}, 6), 
    new Rectangle2D.Float(9.74818F, 5.87409F, 3.87409F, 7.74818F),
    new Polygon( new int[] { 10, 14, 13, 10, 10, 10}, new int[] { 6, 6, 6, 6, 13, 14}, 6), 
    new Polygon( new int[] { 14, 14, 13, 13, 10, 10}, new int[] { 14, 6, 6, 13, 13, 14}, 6), 
    new Line2D.Float( 13.6223F, 7.81114F, 9.74818F, 7.81114F),
    new Line2D.Float( 7.81114F, 9.74818F, 5.87409F, 9.74818F),
...
protected class pwr_valuemedium extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,58.1114F,19.3705F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class JopSmallbutton extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 42.615F, 16.4649F),
    new Polygon( new int[] { 2, 45, 42, 5, 5, 2}, new int[] { 2, 2, 5, 5, 16, 18}, 6), 
    new Polygon( new int[] { 45, 45, 42, 42, 5, 2}, new int[] { 18, 2, 5, 16, 16, 18}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,42.615F,16.4649F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
