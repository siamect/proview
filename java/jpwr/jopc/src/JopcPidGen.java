...
public class JopcPidGen extends JopFrame implements JopUtilityIfc {
  ...
  pwr_menubar2	pwr_menubar249;
  pwr_pulldownmenu2	pwr_pulldownmenu250;
  pwr_pulldownmenu2	pwr_pulldownmenu251;
  pwr_mbopenobject	pwr_mbopenobject52;
  pwr_mbtrend	pwr_mbtrend53;
  pwr_mbfast	pwr_mbfast54;
  pwr_mbphoto	pwr_mbphoto55;
  pwr_mbdatasheet	pwr_mbdatasheet56;
  pwr_mbopenplc	pwr_mbopenplc57;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram58;
  pwr_mbrtnavigator	pwr_mbrtnavigator59;
  pwr_mbhelpclass	pwr_mbhelpclass60;
  pwr_mbblockevents	pwr_mbblockevents61;
  pwr_mbhistevent	pwr_mbhistevent62;
  pwr_mbnote	pwr_mbnote63;
  pwr_mbhelp	pwr_mbhelp64;
  pwr_pulldownmenu2	pwr_pulldownmenu265;
  ...
  public void geInit() {
    ...
    pwr_valuemedium0.setBounds(new Rectangle(83,128,98,24));
    ...
    pwr_valuemedium2.setBounds(new Rectangle(83,150,98,24));
    ...
    jopBar4.setBounds(new Rectangle(291,63,17,151));
    ...
    jopTrend5.setBounds(new Rectangle(329,62,501,151));
    ...
    jopBar12.setBounds(new Rectangle(291,230,17,151));
    ...
    pwr_valuemedium15.setBounds(new Rectangle(83,59,98,24));
    ...
    pwr_indroundlarge26.setBounds(new Rectangle(119,340,23,23));
    ...
    pwr_indroundlarge28.setBounds(new Rectangle(119,364,23,23));
    ...
    pwr_valuemedium29.setBounds(new Rectangle(83,389,98,24));
    ...
    pwr_valuesmall31.setBounds(new Rectangle(219,77,41,18));
    ...
    pwr_valuesmall32.setBounds(new Rectangle(219,246,41,18));
    ...
    pwr_buttoncommand33.setBounds(new Rectangle(221,389,72,27));
    ...
    pwr_indroundlarge35.setBounds(new Rectangle(119,316,23,23));
    ...
    pwr_valueinputmedium36.setBounds(new Rectangle(83,82,98,24));
    ...
    pwr_valueinputmedium37.setBounds(new Rectangle(83,105,98,24));
    ...
    pwr_valueinputmedium38.setBounds(new Rectangle(83,173,98,24));
    ...
    pwr_valueinputmedium39.setBounds(new Rectangle(83,196,98,24));
    ...
    pwr_valueinputmedium40.setBounds(new Rectangle(83,219,98,24));
    ...
    pwr_valueinputmedium41.setBounds(new Rectangle(83,241,98,24));
    ...
    pwr_valueinputmedium42.setBounds(new Rectangle(83,264,98,24));
    ...
    pwr_valueinputmedium43.setBounds(new Rectangle(83,287,98,24));
    ...
    pwr_valueinputreliefup44.setBounds(new Rectangle(218,223,42,19));
    ...
    pwr_valueinputreliefup45.setBounds(new Rectangle(218,370,42,19));
    ...
    pwr_valueinputreliefup46.setBounds(new Rectangle(330,384,42,19));
    ...
    pwr_valueinputreliefup47.setBounds(new Rectangle(218,56,42,19));
    ...
    pwr_valueinputreliefup48.setBounds(new Rectangle(218,203,42,19));
    ...
    pwr_menubar249 = new pwr_menubar2(session);
    pwr_menubar249.setBounds(new Rectangle(0,5,841,24));
    pwr_menubar249.setShadow(1);
    localPanel.add(pwr_menubar249, new Proportion(pwr_menubar249.getBounds(), dsize));
    pwr_pulldownmenu250 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu250.setBounds(new Rectangle(11,5,70,24));
    ...
    pwr_pulldownmenu251.setBounds(new Rectangle(759,5,70,24));
    pwr_pulldownmenu251.setShadow(1);
    localPanel.add(pwr_pulldownmenu251, new Proportion(pwr_pulldownmenu251.getBounds(), dsize));
    pwr_mbopenobject52 = new pwr_mbopenobject(session);
    pwr_mbopenobject52.setBounds(new Rectangle(196,30,20,20));
    pwr_mbopenobject52.setShadow(1);
    localPanel.add(pwr_mbopenobject52, new Proportion(pwr_mbopenobject52.getBounds(), dsize));
    pwr_mbtrend53 = new pwr_mbtrend(session);
    pwr_mbtrend53.setBounds(new Rectangle(56,30,20,20));
    pwr_mbtrend53.setShadow(1);
    localPanel.add(pwr_mbtrend53, new Proportion(pwr_mbtrend53.getBounds(), dsize));
    pwr_mbfast54 = new pwr_mbfast(session);
    pwr_mbfast54.setBounds(new Rectangle(76,30,20,20));
    pwr_mbfast54.setShadow(1);
    localPanel.add(pwr_mbfast54, new Proportion(pwr_mbfast54.getBounds(), dsize));
    pwr_mbphoto55 = new pwr_mbphoto(session);
    pwr_mbphoto55.setBounds(new Rectangle(96,30,20,20));
    pwr_mbphoto55.setShadow(1);
    localPanel.add(pwr_mbphoto55, new Proportion(pwr_mbphoto55.getBounds(), dsize));
    pwr_mbdatasheet56 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet56.setBounds(new Rectangle(116,30,20,20));
    pwr_mbdatasheet56.setShadow(1);
    localPanel.add(pwr_mbdatasheet56, new Proportion(pwr_mbdatasheet56.getBounds(), dsize));
    pwr_mbopenplc57 = new pwr_mbopenplc(session);
    pwr_mbopenplc57.setBounds(new Rectangle(216,30,20,20));
    pwr_mbopenplc57.setShadow(1);
    localPanel.add(pwr_mbopenplc57, new Proportion(pwr_mbopenplc57.getBounds(), dsize));
    pwr_mbcircuitdiagram58 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram58.setBounds(new Rectangle(237,30,20,20));
    pwr_mbcircuitdiagram58.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram58, new Proportion(pwr_mbcircuitdiagram58.getBounds(), dsize));
    pwr_mbrtnavigator59 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator59.setBounds(new Rectangle(176,30,20,20));
    pwr_mbrtnavigator59.setShadow(1);
    localPanel.add(pwr_mbrtnavigator59, new Proportion(pwr_mbrtnavigator59.getBounds(), dsize));
    pwr_mbhelpclass60 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass60.setBounds(new Rectangle(257,30,20,20));
    pwr_mbhelpclass60.setShadow(1);
    localPanel.add(pwr_mbhelpclass60, new Proportion(pwr_mbhelpclass60.getBounds(), dsize));
    pwr_mbblockevents61 = new pwr_mbblockevents(session);
    pwr_mbblockevents61.setBounds(new Rectangle(156,30,20,20));
    pwr_mbblockevents61.setShadow(1);
    localPanel.add(pwr_mbblockevents61, new Proportion(pwr_mbblockevents61.getBounds(), dsize));
    pwr_mbhistevent62 = new pwr_mbhistevent(session);
    pwr_mbhistevent62.setBounds(new Rectangle(136,30,20,20));
    localPanel.add(pwr_mbhistevent62, new Proportion(pwr_mbhistevent62.getBounds(), dsize));
    pwr_mbnote63 = new pwr_mbnote(session);
    pwr_mbnote63.setBounds(new Rectangle(36,30,20,20));
    localPanel.add(pwr_mbnote63, new Proportion(pwr_mbnote63.getBounds(), dsize));
    pwr_mbhelp64 = new pwr_mbhelp(session);
    pwr_mbhelp64.setBounds(new Rectangle(16,30,20,20));
    localPanel.add(pwr_mbhelp64, new Proportion(pwr_mbhelp64.getBounds(), dsize));
    pwr_pulldownmenu265 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu265.setBounds(new Rectangle(70,5,70,24));
    pwr_pulldownmenu265.setShadow(1);
    localPanel.add(pwr_pulldownmenu265, new Proportion(pwr_pulldownmenu265.getBounds(), dsize));
    ...
    jopBar4.setMinValueAttr("$object.SetMinShow##Float32");
    jopBar4.setMaxValueAttr("$object.SetMaxShow##Float32");
    jopTrend5.setPwrAttribute1("$object.SetVal##Float32");
    jopTrend5.setPwrAttribute2("$object.ProcVal##Float32");
    jopTrend5.setMinValueAttr1("$object.SetMinShow##Float32");
    jopTrend5.setMaxValueAttr1("$object.SetMaxShow##Float32");
    jopTrend5.setMinValueAttr2("$object.SetMinShow##Float32");
    jopTrend5.setMaxValueAttr2("$object.SetMaxShow##Float32");
    ...
    jopSmallbutton10.dd.setDynType(4);
    jopSmallbutton10.dd.setActionType(16);
    jopSmallbutton10.dd.setAccess(65535);
    jopSmallbutton10.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(jopSmallbutton10.dd, "!$local.TrendHold##Boolean",102)
      ,new GeDynToggleDig(jopSmallbutton10.dd, "$local.TrendHold##Boolean")
      });
    jopSmallbutton10.setAnnot1("   Hold");
    jopTrend11.setPwrAttribute1("$object.OutVal##Float32");
    jopTrend11.setMinValueAttr1("$object.OutMinShow##Float32");
    jopTrend11.setMaxValueAttr1("$object.OutMaxShow##Float32");
    jopBar12.setPwrAttribute("$object.OutVal##Float32");
    jopBar12.setMinValueAttr("$object.OutMinShow##Float32");
    jopBar12.setMaxValueAttr("$object.OutMaxShow##Float32");
    pwr_framethin13.dd.setDynType(1);
    pwr_framethin13.dd.setActionType(0);
    jopBar14.setPwrAttribute("$object.ProcVal##Float32");
    jopBar14.setMinValueAttr("$object.SetMinShow##Float32");
    jopBar14.setMaxValueAttr("$object.SetMaxShow##Float32");
    ...
    pwr_indroundlarge35.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indroundlarge35.dd, "$object.Inverse##Boolean",10)
      });
    ...
    pwr_valueinputmedium36.setAnnot1Font(pwr_valueinputmedium36.annotFont.deriveFont((float)14.1697));
    ...
    pwr_valueinputreliefup44.setAnnot1Font(pwr_valueinputreliefup44.annotFont.deriveFont((float)11.1333));
    ...
    pwr_menubar249.dd.setDynType(1);
    pwr_menubar249.dd.setActionType(0);
    pwr_pulldownmenu250.dd.setDynType(0);
    ...
    pwr_pulldownmenu250.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu250.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu250,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu250.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu250.setAnnot1("File");
    pwr_pulldownmenu251.dd.setDynType(1);
    pwr_pulldownmenu251.dd.setActionType(524288);
    pwr_pulldownmenu251.dd.setAccess(65532);
    ...
    new GeDyn(pwr_pulldownmenu251,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu251.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu251.setAnnot1("Help");
    pwr_mbopenobject52.dd.setDynType(129);
    pwr_mbopenobject52.dd.setActionType(8256);
    pwr_mbopenobject52.dd.setAccess(65532);
    pwr_mbopenobject52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject52.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject52.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject52.dd, "Open Object")
      });
    pwr_mbtrend53.dd.setDynType(129);
    pwr_mbtrend53.dd.setActionType(8256);
    pwr_mbtrend53.dd.setAccess(65532);
    pwr_mbtrend53.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend53.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend53.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend53.dd, "Trend")
      });
    pwr_mbfast54.dd.setDynType(129);
    pwr_mbfast54.dd.setActionType(8256);
    pwr_mbfast54.dd.setAccess(65532);
    pwr_mbfast54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast54.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast54.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast54.dd, "Fast")
      });
    pwr_mbphoto55.dd.setDynType(129);
    pwr_mbphoto55.dd.setActionType(8256);
    pwr_mbphoto55.dd.setAccess(65532);
    pwr_mbphoto55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto55.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto55.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto55.dd, "Photo")
      });
    pwr_mbdatasheet56.dd.setDynType(129);
    pwr_mbdatasheet56.dd.setActionType(8256);
    pwr_mbdatasheet56.dd.setAccess(65532);
    pwr_mbdatasheet56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet56.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet56.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet56.dd, "DataSheet")
      });
    pwr_mbopenplc57.dd.setDynType(129);
    pwr_mbopenplc57.dd.setActionType(8256);
    pwr_mbopenplc57.dd.setAccess(65532);
    pwr_mbopenplc57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc57.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc57.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc57.dd, "Open Plc")
      });
    pwr_mbcircuitdiagram58.dd.setDynType(129);
    pwr_mbcircuitdiagram58.dd.setActionType(8256);
    pwr_mbcircuitdiagram58.dd.setAccess(65535);
    pwr_mbcircuitdiagram58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram58.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram58.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram58.dd, "CircuitDiagram")
      });
    pwr_mbrtnavigator59.dd.setDynType(129);
    pwr_mbrtnavigator59.dd.setActionType(8256);
    pwr_mbrtnavigator59.dd.setAccess(65532);
    pwr_mbrtnavigator59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator59.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator59.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator59.dd, "RtNavigator")
      });
    pwr_mbhelpclass60.dd.setDynType(129);
    pwr_mbhelpclass60.dd.setActionType(8256);
    pwr_mbhelpclass60.dd.setAccess(65532);
    pwr_mbhelpclass60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass60.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass60.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass60.dd, "Help Class")
      });
    pwr_mbblockevents61.dd.setDynType(129);
    pwr_mbblockevents61.dd.setActionType(8256);
    pwr_mbblockevents61.dd.setAccess(65532);
    pwr_mbblockevents61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents61.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents61.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents61.dd, "Block Events")
      });
    pwr_mbhistevent62.dd.setDynType(129);
    pwr_mbhistevent62.dd.setActionType(8256);
    pwr_mbhistevent62.dd.setAccess(65532);
    pwr_mbhistevent62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent62.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent62.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent62.dd, "Hist Event")
      });
    pwr_mbnote63.dd.setDynType(129);
    pwr_mbnote63.dd.setActionType(8256);
    pwr_mbnote63.dd.setAccess(65532);
    pwr_mbnote63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote63.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote63.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote63.dd, "Note")
      });
    pwr_mbhelp64.dd.setDynType(128);
    pwr_mbhelp64.dd.setActionType(8256);
    pwr_mbhelp64.dd.setAccess(65532);
    pwr_mbhelp64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp64.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp64.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp64.dd, "Help")
      });
    pwr_pulldownmenu265.dd.setDynType(1);
    pwr_pulldownmenu265.dd.setActionType(524288);
    pwr_pulldownmenu265.dd.setAccess(65535);
    pwr_pulldownmenu265.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu265.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu265,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu265,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu265.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu265.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu265.setAnnot1("Methods");
...
protected class pwr_indroundlarge extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 11, 9, 9, 1}, new int[] { 16, 24, 24,23}, 4),
    ...
    new Polygon( new int[] { 40, 39, 37, 1}, new int[] { 11, 13, 15,23}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, -1219899021, -29}, new int[] { 34, 29, -1219899000,-8}, 4),
    ...
    new Polygon( new int[] { 2, 7, -1219899021, -29}, new int[] { 34, 32, -1219899000,-8}, 4),
    new Rectangle2D.Float(2F, 2F, 99.1879F, 32.3879F),
    new Polygon( new int[] { 2, 101, 100, 4, 4, 2}, new int[] { 2, 2, 4, 4, 33, 34}, 6), 
    new Polygon( new int[] { 101, 101, 100, 100, 4, 2}, new int[] { 34, 2, 4, 33, 33, 34}, 6), 
  };
...
protected class JopSmallbutton extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,44.5333F,17.2061F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
