...
public class JopcModeGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_slider110.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider110.dd, "$object.SetVal##Float32",0,100,4,56.1702,362.553,null,null,
null)
      });
    ...
    pwr_slider111.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider111.dd, "$object.ForcVal##Float32",0,100,4,56.1702,362.553,null,null,
null)
      });
    ...
    pwr_valueinputmedium46.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputmedium46.dd, 0,0,null,null)
      });
