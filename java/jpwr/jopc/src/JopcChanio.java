...
public class JopcChanio extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_buttoncommand	pwr_buttoncommand4;
  pwr_valuelong	pwr_valuelong5;
  pwr_valuemedium	pwr_valuemedium7;
  pwr_valuemedium	pwr_valuemedium9;
  pwr_valuemedium	pwr_valuemedium11;
  pwr_framethin	pwr_framethin13;
  public JopcChanio( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcChanio( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_buttoncommand4.setBounds(new Rectangle(8,143,83,28));
    ...
    pwr_valuemedium7.setBounds(new Rectangle(132,84,91,22));
    ...
    pwr_valuemedium9 = new pwr_valuemedium(session);
    pwr_valuemedium9.setBounds(new Rectangle(132,111,91,22));
    pwr_valuemedium9.setFillColor(51);
    pwr_valuemedium9.setBorderColor(56);
    localPanel.add(pwr_valuemedium9, new Proportion(pwr_valuemedium9.getBounds(), dsize));
    pwr_valuemedium11 = new pwr_valuemedium(session);
    pwr_valuemedium11.setBounds(new Rectangle(342,84,91,22));
    ...
    pwr_framethin13.setBounds(new Rectangle(0,80,467,29));
    ...
    pwr_buttoncommand4.dd.setDynType(1);
    pwr_buttoncommand4.dd.setActionType(64);
    pwr_buttoncommand4.dd.setAccess(65535);
    pwr_buttoncommand4.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_buttoncommand4.dd, "open graph/classgraph/inst=&$object.SigChanCon")
      });
    pwr_buttoncommand4.setAnnot1("Signal");
    pwr_valuelong5.dd.setDynType(1025);
    pwr_valuelong5.dd.setActionType(0);
    pwr_valuelong5.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong5.dd, "$object.Identity##String80","%s")
      });
    pwr_valuemedium7.dd.setDynType(1024);
    pwr_valuemedium7.dd.setActionType(4096);
    pwr_valuemedium7.dd.setAccess(38);
    pwr_valuemedium7.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium7.dd, "$object.TestOn##Boolean","%d")
      });
    pwr_valuemedium9.dd.setDynType(1025);
    pwr_valuemedium9.dd.setActionType(0);
    pwr_valuemedium9.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium9.dd, "$object.FixedOutValue##Int32","%d")
      });
    pwr_valuemedium11.dd.setDynType(1024);
    pwr_valuemedium11.dd.setActionType(4096);
    pwr_valuemedium11.dd.setAccess(38);
    pwr_valuemedium11.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium11.dd, "$object.TestValue##Int32","%d")
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 182;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("Identity"),10, 42);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("TestOn"),9, 101);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("FixedOutValue"),8, 124);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("TestValue"),247, 100);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 145486657, -206}, new int[] { 32, 26, -136,-136}, 4),
    ...
    new Polygon( new int[] { 2, 6, -204, -206}, new int[] { 32, 30, -136,-136}, 4),
    new Rectangle2D.Float(2F, 2F, 92.0805F, 30.0671F),
    new Polygon( new int[] { 2, 94, 93, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 32}, 6), 
    new Polygon( new int[] { 94, 94, 93, 93, 4, 2}, new int[] { 32, 2, 4, 31, 31, 32}, 6), 
  };
