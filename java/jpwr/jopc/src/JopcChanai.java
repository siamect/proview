...
public class JopcChanai extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium3.setBounds(new Rectangle(133,80,89,20));
    ...
    pwr_valuemedium5.setBounds(new Rectangle(133,105,89,20));
    ...
    pwr_valuemedium11.setBounds(new Rectangle(133,130,89,20));
    ...
    pwr_valuemedium13.setBounds(new Rectangle(170,188,89,20));
    ...
    pwr_valuemedium15.setBounds(new Rectangle(286,188,89,20));
    ...
    pwr_valuemedium17.setBounds(new Rectangle(170,213,89,20));
    ...
    pwr_valuemedium19.setBounds(new Rectangle(286,213,89,20));
    ...
    pwr_valuemedium21.setBounds(new Rectangle(170,239,89,20));
    ...
    pwr_valuemedium23.setBounds(new Rectangle(286,239,89,20));
    ...
    pwr_valuemedium25.setBounds(new Rectangle(170,265,89,20));
    ...
    pwr_valuemedium27.setBounds(new Rectangle(286,265,89,20));
    ...
    pwr_framethin30.setBounds(new Rectangle(1,158,387,140));
    ...
    jopButtontoggle32.setBounds(new Rectangle(283,162,97,17));
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, -1219419835, -75}, new int[] { 32, 26, -1219419747,12}, 4),
    ...
    new Polygon( new int[] { 2, 6, -1219419835, -75}, new int[] { 32, 30, -1219419747,12}, 4),
    new Rectangle2D.Float(2F, 2F, 92.0805F, 30.0671F),
    new Polygon( new int[] { 2, 94, 93, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 32}, 6), 
    new Polygon( new int[] { 94, 94, 93, 93, 4, 2}, new int[] { 32, 2, 4, 31, 31, 32}, 6), 
  };
