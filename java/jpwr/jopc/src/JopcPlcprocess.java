...
public class JopcPlcprocess extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp60_4.setBounds(new Rectangle(17,176,21,18));
    localPanel.add(grp60_4, new Proportion(grp60_4.getBounds(), dsize));
    grp65_5 = new Grp65_(session);
    grp65_5.setBounds(new Rectangle(17,196,21,18));
    ...
    pwr_valuelong32.setBounds(new Rectangle(135,14,544,22));
    ...
    pwr_valuesmall34.setBounds(new Rectangle(134,38,53,17));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(134,58,53,17));
    ...
    pwr_valuesmall36.setBounds(new Rectangle(369,58,53,17));
