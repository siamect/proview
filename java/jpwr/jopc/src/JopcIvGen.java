...
public class JopcIvGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_framethin6.setBounds(new Rectangle(9,87,223,79));
    ...
    pwr_valueinputreliefup15.setBounds(new Rectangle(203,58,41,18));
    ...
    pwr_valueinputreliefup16.setBounds(new Rectangle(203,200,41,18));
    ...
    pwr_valueinputreliefup17.setBounds(new Rectangle(289,212,41,18));
    ...
    pwr_valueinputmedium18.setBounds(new Rectangle(127,102,94,23));
    ...
    pwr_mbopenobject19.setBounds(new Rectangle(182,4,19,19));
    ...
    pwr_mbtrend20.setBounds(new Rectangle(48,4,19,19));
    ...
    pwr_mbfast21.setBounds(new Rectangle(67,4,19,19));
    ...
    pwr_mbphoto22.setBounds(new Rectangle(86,4,19,19));
    ...
    pwr_mbdatasheet23.setBounds(new Rectangle(105,4,19,19));
    ...
    pwr_mbcircuitdiagram24.setBounds(new Rectangle(220,4,19,19));
    ...
    pwr_mbrtnavigator25.setBounds(new Rectangle(163,4,19,19));
    ...
    pwr_mbhelpclass26.setBounds(new Rectangle(240,4,19,19));
    ...
    pwr_mbblockevents27.setBounds(new Rectangle(144,4,19,19));
    ...
    pwr_mbhistevent28.setBounds(new Rectangle(124,4,19,19));
    ...
    pwr_mbnote29.setBounds(new Rectangle(28,4,19,19));
    ...
    pwr_mbhelp30.setBounds(new Rectangle(9,4,19,19));
    ...
    pwr_mbcrossreferences31.setBounds(new Rectangle(201,4,19,19));
    ...
    jopSmallbutton32.setBounds(new Rectangle(279,4,46,20));
    ...
    pwr_valuelong33.setBounds(new Rectangle(333,4,472,22));
    ...
    pwr_slider113.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider113.dd, "$object.ActualValue##Int32",0,100,4,58.1114,200.097,"$object.PresMinLimit##Float32","$object.PresMaxLimit##Float32",
"!$local.SliderEnable##Boolean")
    ...
    pwr_valueinputreliefup15.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputreliefup15.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup15.setAnnot1Font(pwr_valueinputreliefup15.annotFont.deriveFont((float)10.6538));
    ...
    pwr_valueinputreliefup17.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputreliefup17.dd, 4,100000,null,null)
      });
    ...
    pwr_valueinputmedium18.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputmedium18.dd, 0,0,null,null)
      });
    pwr_valueinputmedium18.setAnnot1Font(pwr_valueinputmedium18.annotFont.deriveFont((float)13.5593));
    ...
    pwr_mbcrossreferences31.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbcrossreferences31.dd, "Crossreferences")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Description",20, 43);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( "ActualValue",20, 118);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( "InitialValue",20, 143);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "0",761, 220);
    g.setTransform(save);
  }
...
protected class pwr_sliderbackground1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, -47, -47}, new int[] { 2, 3, -89,-89}, 4),
    ...
    new Polygon( new int[] { 41, 40, 146213920, -47}, new int[] { 2, 4, 146275854,-89}, 4),
    ...
    new Polygon( new int[] { 2, 3, 146213920, -47}, new int[] { 2, 4, 146275854,-89}, 4),
    ...
    new Polygon( new int[] { 2, 4, 1, -47}, new int[] { 215, 214, -1219899081,-89}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,38.7409F,19.3705F, false,43, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,21.3705F,2F,19.3705F,213.075F, false,46, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,19.3705F,213.075F, false,42, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[11]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,195.705F,38.7409F,19.3705F, false,43, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[17]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,17.4964F,17.4964F,7.74818F,182.082F, false,28, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[22]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_slider1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 23, 24, -1219899041, -49}, new int[] { 2, 7, -1219899079,-87}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,29.0557F,27.1186F, false,28, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,21.3075F,19.3705F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[8]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,21.3075F,5.81114F, false,100, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[11]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,15.5593F,21.3075F,5.81114F, false,108, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[14]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
