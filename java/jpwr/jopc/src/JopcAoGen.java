...
public class JopcAoGen extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputreliefup	pwr_valueinputreliefup20;
  pwr_valueinputreliefup	pwr_valueinputreliefup21;
  pwr_mbopenobject	pwr_mbopenobject22;
  pwr_mbtrend	pwr_mbtrend23;
  pwr_mbfast	pwr_mbfast24;
  pwr_mbphoto	pwr_mbphoto25;
  pwr_mbdatasheet	pwr_mbdatasheet26;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram27;
  pwr_mbrtnavigator	pwr_mbrtnavigator28;
  pwr_mbhelpclass	pwr_mbhelpclass29;
  pwr_mbblockevents	pwr_mbblockevents30;
  pwr_mbhistevent	pwr_mbhistevent31;
  pwr_mbnote	pwr_mbnote32;
  pwr_mbhelp	pwr_mbhelp33;
  pwr_mbcrossreferences	pwr_mbcrossreferences34;
  JopButtontoggle	jopButtontoggle35;
  pwr_valuelong	pwr_valuelong36;
  public JopcAoGen( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAoGen( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAoGen");
    pwr_valuemedium2 = new pwr_valuemedium(session);
    pwr_valuemedium2.setBounds(new Rectangle(121,128,97,24));
    ...
    pwr_valuemedium4.setBounds(new Rectangle(121,155,97,24));
    ...
    jopBar5.setBounds(new Rectangle(250,63,17,149));
    ...
    jopTrend6.setBounds(new Rectangle(288,62,495,150));
    ...
    jopButtontoggle12.setBounds(new Rectangle(512,213,61,21));
    ...
    pwr_valuelong13.setBounds(new Rectangle(119,25,700,23));
    ...
    pwr_sliderbackground114.setBounds(new Rectangle(797,51,20,173));
    ...
    pwr_slider115.setBounds(new Rectangle(799,56,22,19));
    ...
    jopButtontoggle16.setBounds(new Rectangle(687,213,65,21));
    ...
    pwr_buttoncommand17.setBounds(new Rectangle(1,203,89,29));
    ...
    pwr_valueinputmedium18.setBounds(new Rectangle(121,102,97,24));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(199,56,42,19));
    ...
    pwr_valueinputreliefup20 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup20.setBounds(new Rectangle(199,203,42,19));
    pwr_valueinputreliefup20.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup20, new Proportion(pwr_valueinputreliefup20.getBounds(), dsize));
    pwr_valueinputreliefup21 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup21.setBounds(new Rectangle(288,215,42,19));
    pwr_valueinputreliefup21.setColorShift(1);
    localPanel.add(pwr_valueinputreliefup21, new Proportion(pwr_valueinputreliefup21.getBounds(), dsize));
    pwr_mbopenobject22 = new pwr_mbopenobject(session);
    pwr_mbopenobject22.setBounds(new Rectangle(179,0,20,20));
    pwr_mbopenobject22.setColorTone(19);
    pwr_mbopenobject22.setShadow(1);
    localPanel.add(pwr_mbopenobject22, new Proportion(pwr_mbopenobject22.getBounds(), dsize));
    pwr_mbtrend23 = new pwr_mbtrend(session);
    pwr_mbtrend23.setBounds(new Rectangle(40,0,20,20));
    pwr_mbtrend23.setColorTone(19);
    pwr_mbtrend23.setShadow(1);
    localPanel.add(pwr_mbtrend23, new Proportion(pwr_mbtrend23.getBounds(), dsize));
    pwr_mbfast24 = new pwr_mbfast(session);
    pwr_mbfast24.setBounds(new Rectangle(60,0,20,20));
    pwr_mbfast24.setColorTone(19);
    pwr_mbfast24.setShadow(1);
    localPanel.add(pwr_mbfast24, new Proportion(pwr_mbfast24.getBounds(), dsize));
    pwr_mbphoto25 = new pwr_mbphoto(session);
    pwr_mbphoto25.setBounds(new Rectangle(80,0,20,20));
    pwr_mbphoto25.setColorTone(19);
    pwr_mbphoto25.setShadow(1);
    localPanel.add(pwr_mbphoto25, new Proportion(pwr_mbphoto25.getBounds(), dsize));
    pwr_mbdatasheet26 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet26.setBounds(new Rectangle(100,0,20,20));
    pwr_mbdatasheet26.setColorTone(19);
    pwr_mbdatasheet26.setShadow(1);
    localPanel.add(pwr_mbdatasheet26, new Proportion(pwr_mbdatasheet26.getBounds(), dsize));
    pwr_mbcircuitdiagram27 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram27.setBounds(new Rectangle(219,0,20,20));
    pwr_mbcircuitdiagram27.setColorTone(19);
    pwr_mbcircuitdiagram27.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram27, new Proportion(pwr_mbcircuitdiagram27.getBounds(), dsize));
    pwr_mbrtnavigator28 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator28.setBounds(new Rectangle(159,0,20,20));
    pwr_mbrtnavigator28.setColorTone(19);
    pwr_mbrtnavigator28.setShadow(1);
    localPanel.add(pwr_mbrtnavigator28, new Proportion(pwr_mbrtnavigator28.getBounds(), dsize));
    pwr_mbhelpclass29 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass29.setBounds(new Rectangle(238,0,20,20));
    pwr_mbhelpclass29.setColorTone(19);
    pwr_mbhelpclass29.setShadow(1);
    localPanel.add(pwr_mbhelpclass29, new Proportion(pwr_mbhelpclass29.getBounds(), dsize));
    pwr_mbblockevents30 = new pwr_mbblockevents(session);
    pwr_mbblockevents30.setBounds(new Rectangle(139,0,20,20));
    pwr_mbblockevents30.setColorTone(19);
    pwr_mbblockevents30.setShadow(1);
    localPanel.add(pwr_mbblockevents30, new Proportion(pwr_mbblockevents30.getBounds(), dsize));
    pwr_mbhistevent31 = new pwr_mbhistevent(session);
    pwr_mbhistevent31.setBounds(new Rectangle(119,0,20,20));
    pwr_mbhistevent31.setColorTone(19);
    localPanel.add(pwr_mbhistevent31, new Proportion(pwr_mbhistevent31.getBounds(), dsize));
    pwr_mbnote32 = new pwr_mbnote(session);
    pwr_mbnote32.setBounds(new Rectangle(20,0,20,20));
    pwr_mbnote32.setColorTone(19);
    localPanel.add(pwr_mbnote32, new Proportion(pwr_mbnote32.getBounds(), dsize));
    pwr_mbhelp33 = new pwr_mbhelp(session);
    pwr_mbhelp33.setBounds(new Rectangle(0,0,20,20));
    pwr_mbhelp33.setColorTone(19);
    localPanel.add(pwr_mbhelp33, new Proportion(pwr_mbhelp33.getBounds(), dsize));
    pwr_mbcrossreferences34 = new pwr_mbcrossreferences(session);
    pwr_mbcrossreferences34.setBounds(new Rectangle(199,0,20,20));
    pwr_mbcrossreferences34.setColorTone(19);
    localPanel.add(pwr_mbcrossreferences34, new Proportion(pwr_mbcrossreferences34.getBounds(), dsize));
    jopButtontoggle35 = new JopButtontoggle(session);
    jopButtontoggle35.setBounds(new Rectangle(279,0,48,21));
    jopButtontoggle35.setBorderColor(37);
    localPanel.add(jopButtontoggle35, new Proportion(jopButtontoggle35.getBounds(), dsize));
    pwr_valuelong36 = new pwr_valuelong(session);
    pwr_valuelong36.setBounds(new Rectangle(334,0,488,23));
    pwr_valuelong36.setFillColor(41);
    ...
    pwr_slider115.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider115.dd, "$object.ActualValue##Float32",0,100,4,56.7176,203.318,null,null,
null)
      });
    ...
    pwr_buttoncommand17.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_buttoncommand17.dd, "open graph/classgraph/inst=&$object.SigChanCon")
      });
    pwr_buttoncommand17.setAnnot1("Channel");
    ...
    pwr_valueinputmedium18.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputmedium18.dd, "$object.ActualValue##Float32","%10.3f")
    ...
    pwr_valueinputreliefup19.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup19.dd, "$object.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup19.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup20.dd.setDynType(1024);
    pwr_valueinputreliefup20.dd.setActionType(4096);
    pwr_valueinputreliefup20.dd.setAccess(65535);
    pwr_valueinputreliefup20.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup20.dd, "$object.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup20.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup21.dd.setDynType(1024);
    pwr_valueinputreliefup21.dd.setActionType(4096);
    pwr_valueinputreliefup21.dd.setAccess(65535);
    pwr_valueinputreliefup21.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup21.dd, "$local.ScanTime##Float32","%5.0f")
      ,new GeDynValueInput(pwr_valueinputreliefup21.dd, 4,100000,null,null)
      });
    pwr_mbopenobject22.dd.setDynType(129);
    pwr_mbopenobject22.dd.setActionType(8256);
    pwr_mbopenobject22.dd.setAccess(65532);
    pwr_mbopenobject22.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject22.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject22.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject22.dd, "Open Object")
      });
    pwr_mbtrend23.dd.setDynType(129);
    pwr_mbtrend23.dd.setActionType(8256);
    pwr_mbtrend23.dd.setAccess(65532);
    pwr_mbtrend23.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend23.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend23.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend23.dd, "Trend")
      });
    pwr_mbfast24.dd.setDynType(129);
    pwr_mbfast24.dd.setActionType(8256);
    pwr_mbfast24.dd.setAccess(65532);
    pwr_mbfast24.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast24.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast24.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast24.dd, "Fast")
      });
    pwr_mbphoto25.dd.setDynType(129);
    pwr_mbphoto25.dd.setActionType(8256);
    pwr_mbphoto25.dd.setAccess(65532);
    pwr_mbphoto25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto25.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto25.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto25.dd, "Photo")
      });
    pwr_mbdatasheet26.dd.setDynType(129);
    pwr_mbdatasheet26.dd.setActionType(8256);
    pwr_mbdatasheet26.dd.setAccess(65532);
    pwr_mbdatasheet26.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet26.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet26.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet26.dd, "DataSheet")
      });
    pwr_mbcircuitdiagram27.dd.setDynType(129);
    pwr_mbcircuitdiagram27.dd.setActionType(8256);
    pwr_mbcircuitdiagram27.dd.setAccess(65535);
    pwr_mbcircuitdiagram27.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram27.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram27.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram27.dd, "CircuitDiagram")
      });
    pwr_mbrtnavigator28.dd.setDynType(129);
    pwr_mbrtnavigator28.dd.setActionType(8256);
    pwr_mbrtnavigator28.dd.setAccess(65532);
    pwr_mbrtnavigator28.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator28.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator28.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator28.dd, "RtNavigator")
      });
    pwr_mbhelpclass29.dd.setDynType(129);
    pwr_mbhelpclass29.dd.setActionType(8256);
    pwr_mbhelpclass29.dd.setAccess(65532);
    pwr_mbhelpclass29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass29.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass29.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass29.dd, "Help Class")
      });
    pwr_mbblockevents30.dd.setDynType(129);
    pwr_mbblockevents30.dd.setActionType(8256);
    pwr_mbblockevents30.dd.setAccess(65532);
    pwr_mbblockevents30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents30.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents30.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents30.dd, "Block Events")
      });
    pwr_mbhistevent31.dd.setDynType(129);
    pwr_mbhistevent31.dd.setActionType(8256);
    pwr_mbhistevent31.dd.setAccess(65532);
    pwr_mbhistevent31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent31.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhistevent31.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent31.dd, "Hist Event")
      });
    pwr_mbnote32.dd.setDynType(129);
    pwr_mbnote32.dd.setActionType(8256);
    pwr_mbnote32.dd.setAccess(65532);
    pwr_mbnote32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote32.dd, "$cmd(check method/method=\"Note\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbnote32.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote32.dd, "Note")
      });
    pwr_mbhelp33.dd.setDynType(128);
    pwr_mbhelp33.dd.setActionType(8256);
    pwr_mbhelp33.dd.setAccess(65532);
    pwr_mbhelp33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp33.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp33.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp33.dd, "Help")
      });
    pwr_mbcrossreferences34.dd.setDynType(128);
    pwr_mbcrossreferences34.dd.setActionType(8256);
    pwr_mbcrossreferences34.dd.setAccess(65532);
    pwr_mbcrossreferences34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcrossreferences34.dd, "$cmd(check method/method=\"Crossreferences\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcrossreferences34.dd, "call method/method=\"Crossreferences\"/object=$object")
      ,new GeDynTipText(pwr_mbcrossreferences34.dd, "Crossreferences")
      });
    jopButtontoggle35.dd.setDynType(128);
    jopButtontoggle35.dd.setActionType(64);
    jopButtontoggle35.dd.setAccess(65532);
    jopButtontoggle35.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopButtontoggle35.dd, "$object.Note##String80",0)
      ,new GeDynCommand(jopButtontoggle35.dd, "call method/method=\"Note\"/object=$object")
      });
    jopButtontoggle35.setAnnot1("Note !");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Description",10, 41);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "ActualValue",10, 118);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "InitialValue",10, 144);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 14));
    g.drawString( "Unit",10, 171);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( "0",775, 224);
    g.setTransform(save);
  }
...
protected class pwr_sliderbackground1 extends GeComponent {
  ...
  public int original_height = 224;
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 2, 42, 22, 2}, new int[] {2, 2, 22, 2}, 4),
    new Polygon( new int[] { 2, 4, 40, 42}, new int[] { 2, 3, 3,2}, 4),
    new Polygon( new int[] { 42, 40, 22, 22}, new int[] { 2, 3, 21,22}, 4),
    new Polygon( new int[] { 22, 22, 4, 2}, new int[] { 22, 21, 3,2}, 4),
    new Polygon( new int[] { 42, 22, 22, 42, 42}, new int[] {2, 22, 202, 222, 2}, 5),
    new Polygon( new int[] { 42, 41, 23, 22}, new int[] { 2, 4, 22,22}, 4),
    new Polygon( new int[] { 22, 23, 23, 22}, new int[] { 22, 22, 202,202}, 4),
    new Polygon( new int[] { 22, 23, 41, 42}, new int[] { 202, 202, 220,222}, 4),
    new Polygon( new int[] { 42, 41, 41, 42}, new int[] { 222, 220, 4,2}, 4),
    new Polygon( new int[] { 2, 2, 22, 22, 2}, new int[] {2, 222, 202, 22, 2}, 5),
    new Polygon( new int[] { 2, 3, 3, 2}, new int[] { 2, 4, 220,222}, 4),
    new Polygon( new int[] { 2, 3, 21, 22}, new int[] { 222, 220, 202,202}, 4),
    new Polygon( new int[] { 22, 21, 21, 22}, new int[] { 202, 202, 22,22}, 4),
    new Polygon( new int[] { 22, 21, 3, 2}, new int[] { 22, 22, 4,2}, 4),
    new Polygon( new int[] { 2, 22, 42, 2}, new int[] {222, 202, 222, 222}, 4),
    new Polygon( new int[] { 2, 4, 22, 22}, new int[] { 222, 221, 203,202}, 4),
    new Polygon( new int[] { 22, 22, 40, 42}, new int[] { 202, 203, 221,222}, 4),
    new Polygon( new int[] { 42, 40, 4, 2}, new int[] { 222, 221, 221,222}, 4),
    new Rectangle2D.Float(18F, 18F, 8F, 188F),
    new Polygon( new int[] { 18, 26, 26, 18, 18, 18}, new int[] { 18, 18, 18, 18, 206, 206}, 6), 
    new Polygon( new int[] { 26, 26, 26, 26, 18, 18}, new int[] { 206, 18, 18, 206, 206, 206}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_slider1 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 24, 25, 31, 32}, new int[] { 2, 8, 24,24}, 4),
    new Polygon( new int[] { 32, 31, 31, 32}, new int[] { 24, 24, 29,30}, 4),
    new Polygon( new int[] { 32, 31, 12, 12}, new int[] { 30, 29, 29,30}, 4),
    new Polygon( new int[] { 12, 12, 5, 2}, new int[] { 30, 29, 23,22}, 4),
    new Polygon( new int[] { 2, 5, 25, 24}, new int[] { 22, 23, 23,22}, 4),
    new Polygon( new int[] { 24, 25, 25, 24}, new int[] { 22, 23, 8,2}, 4),
    ...
    new Polygon( new int[] { 2, 24, 24, 2, 2, 2}, new int[] { 16, 16, 16, 16, 22, 22}, 6), 
    new Polygon( new int[] { 24, 24, 24, 24, 2, 2}, new int[] { 22, 16, 16, 22, 22, 22}, 6), 
