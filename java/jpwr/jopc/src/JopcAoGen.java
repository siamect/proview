/* 
 * Proview   $Id: JopcAoGen.java,v 1.3 2005-09-01 14:57:51 claes Exp $
...
public class JopcAoGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_slider115.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider115.dd, "$object.ActualValue##Float32",0,100,4,56.7176,203.318)
      });
    ...
    pwr_valueinputreliefup19.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputreliefup19.dd, 0,0)
      });
    ...
    pwr_valueinputreliefup20.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputreliefup20.dd, 0,0)
      });
    ...
    pwr_valueinputreliefup21.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValueInput(pwr_valueinputreliefup21.dd, 4,100000)
      });
