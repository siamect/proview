...
public class JopcAoGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium2.setBounds(new Rectangle(123,128,97,24));
    ...
    pwr_valuemedium4.setBounds(new Rectangle(123,155,97,24));
    ...
    jopBar5.setBounds(new Rectangle(251,63,17,149));
    ...
    jopTrend6.setBounds(new Rectangle(289,62,495,150));
    ...
    pwr_valuelong13.setBounds(new Rectangle(120,25,700,23));
    ...
    pwr_sliderbackground114.setBounds(new Rectangle(798,51,20,173));
    ...
    pwr_slider115.setBounds(new Rectangle(800,56,22,19));
    ...
    jopSmallbutton16.setBounds(new Rectangle(688,213,65,21));
    ...
    pwr_valueinputmedium17.setBounds(new Rectangle(123,102,97,24));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(201,56,42,19));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(201,203,42,19));
    ...
    pwr_valueinputreliefup20.setBounds(new Rectangle(290,215,42,19));
    ...
    pwr_mbopenobject21.setBounds(new Rectangle(180,0,20,20));
    ...
    pwr_mbtrend22.setBounds(new Rectangle(41,0,20,20));
    ...
    pwr_mbfast23.setBounds(new Rectangle(61,0,20,20));
    ...
    pwr_mbphoto24.setBounds(new Rectangle(81,0,20,20));
    ...
    pwr_mbdatasheet25.setBounds(new Rectangle(101,0,20,20));
    ...
    pwr_mbcircuitdiagram26.setBounds(new Rectangle(220,0,20,20));
    ...
    pwr_mbrtnavigator27.setBounds(new Rectangle(160,0,20,20));
    ...
    pwr_mbhelpclass28.setBounds(new Rectangle(240,0,20,20));
    ...
    pwr_mbblockevents29.setBounds(new Rectangle(140,0,20,20));
    ...
    pwr_mbhistevent30.setBounds(new Rectangle(121,0,20,20));
    ...
    pwr_mbnote31.setBounds(new Rectangle(21,0,20,20));
    ...
    pwr_mbhelp32.setBounds(new Rectangle(2,0,20,20));
    ...
    pwr_mbcrossreferences33.setBounds(new Rectangle(200,0,20,20));
    ...
    jopSmallbutton34.setBounds(new Rectangle(281,0,48,21));
    ...
    pwr_valuelong35.setBounds(new Rectangle(335,0,488,23));
    ...
    pwr_buttoncommandcenter36.setBounds(new Rectangle(0,203,86,30));
    ...
    pwr_slider115.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider115.dd, "$object.ActualValue##Float32",0,100,4,58.3925,202.865,"$object.PresMinLimit##Float32","$object.PresMaxLimit##Float32",
