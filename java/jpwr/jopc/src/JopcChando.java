...
public class JopcChando extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcChando( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcChando( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_buttoncommand4.setBounds(new Rectangle(8,82,83,28));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Description"),7, 20);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("Number"),7, 68);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("Identity"),9, 42);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 7, 8}, new int[] { 32, 26, 25,26}, 4),
    new Polygon( new int[] { 8, 7, 7, 8}, new int[] { 26, 25, 5,8}, 4),
    new Polygon( new int[] { 8, 7, 87, 88}, new int[] { 8, 5, 5,8}, 4),
    new Polygon( new int[] { 88, 87, 88, 94}, new int[] { 8, 5, 4,2}, 4),
    new Polygon( new int[] { 94, 88, 6, 2}, new int[] { 2, 4, 4,2}, 4),
    new Polygon( new int[] { 2, 6, 6, 2}, new int[] { 2, 4, 26,32}, 4),
    new Polygon( new int[] { 2, 6, 71, 19}, new int[] { 32, 26, -9,-10}, 4),
    new Polygon( new int[] { 2, 8, 88, 88, 94, 94, 2}, new int[] {32, 26, 26, 8, 2, 32, 32}, 7),
    new Polygon( new int[] { 2, 8, 10, 8}, new int[] { 32, 30, 28,26}, 4),
    new Polygon( new int[] { 8, 10, 90, 88}, new int[] { 26, 28, 28,26}, 4),
    ...
    new Polygon( new int[] { 94, 92, 8, 2}, new int[] { 32, 30, 30,32}, 4),
    new Polygon( new int[] { 2, 8, 144862275, 19}, new int[] { 32, 30, 145206317,-10}, 4),
    new Rectangle2D.Float(2F, 2F, 92.0805F, 30.0671F),
    new Polygon( new int[] { 2, 94, 93, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 32}, 6), 
    new Polygon( new int[] { 94, 94, 93, 93, 4, 2}, new int[] { 32, 2, 4, 31, 31, 32}, 6), 
  };
