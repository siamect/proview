...
public class JopcDiGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopTrend2.setBounds(new Rectangle(184,61,590,28));
    ...
    pwr_valuelong7.setBounds(new Rectangle(122,24,677,21));
    ...
    pwr_valuemedium8.setBounds(new Rectangle(122,83,27,20));
    ...
    pwr_sliderbackground127.setBounds(new Rectangle(777,58,18,35));
    ...
    pwr_slider128.setBounds(new Rectangle(779,70,20,17));
    ...
    jopSmallbutton29.setBounds(new Rectangle(668,93,63,19));
    ...
    pwr_buttoncommandcenter30.setBounds(new Rectangle(8,111,84,28));
    ...
    pwr_slider128.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider128.dd, "$object.ActualValue##Int32",0,1,4,56.7177,84.9872,null,null,"!$local.SliderEnable##Boolean",797.281,141.045)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 801;
  public int original_height = 145;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Description"),10, 39);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("ActualValue"),10, 74);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("0"),770, 102);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("FilterType"),9, 100);
    g.setTransform(save);
  }
