...
public class JopcMessagehandler extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valuesmall	pwr_valuesmall9;
  pwr_valuesmall	pwr_valuesmall11;
  public JopcMessagehandler( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcMessagehandler( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_valuelong5.setBounds(new Rectangle(151,99,535,17));
    ...
    pwr_valuesmall7.setBounds(new Rectangle(133,10,54,17));
    ...
    pwr_valuesmall9 = new pwr_valuesmall(session);
    pwr_valuesmall9.setBounds(new Rectangle(133,31,54,17));
    pwr_valuesmall9.setFillColor(31);
    pwr_valuesmall9.setBorderColor(33);
    localPanel.add(pwr_valuesmall9, new Proportion(pwr_valuesmall9.getBounds(), dsize));
    pwr_valuesmall11 = new pwr_valuesmall(session);
    pwr_valuesmall11.setBounds(new Rectangle(133,54,54,17));
...
protected class pwr_valuesmall extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 52.443F, 15.9609F),
    new Polygon( new int[] { 2, 54, 54, 3, 3, 2}, new int[] { 2, 2, 3, 3, 17, 18}, 6), 
    new Polygon( new int[] { 54, 54, 54, 54, 3, 2}, new int[] { 18, 2, 3, 17, 17, 18}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,52.443F,15.9609F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
...
protected class pwr_valuelong extends GeComponent {
  ...
  public int original_height = 19;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 606.515F, 15.9609F),
    new Polygon( new int[] { 2, 609, 608, 3, 3, 2}, new int[] { 2, 2, 3, 3, 17, 18}, 6), 
    new Polygon( new int[] { 609, 609, 608, 608, 3, 2}, new int[] { 18, 2, 3, 17, 17, 18}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,606.515F,15.9609F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_indsquare extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 13.6808F, 14.8208F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,13.6808F,14.8208F, false,293, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
