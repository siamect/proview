...
public class JopcDstrendconf extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  BorderLayout borderLayout1 = new BorderLayout();
  public LocalPanel localPanel = new LocalPanel();
  boolean scrollbar = false;
  Dimension size;
  pwr_valuesmall	pwr_valuesmall3;
  pwr_indsquare	pwr_indsquare4;
  pwr_indsquare	pwr_indsquare5;
  pwr_valuelong	pwr_valuelong6;
  pwr_valuelong	pwr_valuelong7;
  public JopcDstrendconf( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcDstrendconf( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Status"),10, 47);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("LogMessage"),10, 70);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("ScanTime"),10, 24);
    g.setTransform(save);
  }
...
protected class pwr_valuelong extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 605.528F, 15.935F),
    new Polygon( new int[] { 2, 608, 607, 3, 3, 2}, new int[] { 2, 2, 3, 3, 17, 18}, 6), 
    new Polygon( new int[] { 608, 608, 607, 607, 3, 2}, new int[] { 18, 2, 3, 17, 17, 18}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,605.528F,15.935F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
...
protected class pwr_indsquare extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 13.6585F, 14.7967F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,13.6585F,14.7967F, false,293, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_valuesmall extends GeComponent {
  ...
  public int original_height = 19;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 52.3577F, 15.935F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,52.3577F,15.935F, false,41, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
