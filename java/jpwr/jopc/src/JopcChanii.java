...
public class JopcChanii extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcChanii( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcChanii( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_valuemedium7.dd.setDynType(1025);
    pwr_valuemedium7.dd.setActionType(0);
    pwr_valuemedium7.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium7.dd, "$object.ConversionOn##Boolean","%d")
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 157;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("ConversionOn"),8, 94);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, -59, -59}, new int[] { 32, 26, -79,-87}, 4),
    ...
    new Polygon( new int[] { 2, 6, -7, -59}, new int[] { 32, 30, -86,-87}, 4),
    new Rectangle2D.Float(2F, 2F, 92.0805F, 30.0671F),
    new Polygon( new int[] { 2, 94, 93, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 32}, 6), 
    new Polygon( new int[] { 94, 94, 93, 93, 4, 2}, new int[] { 32, 2, 4, 31, 31, 32}, 6), 
  };
