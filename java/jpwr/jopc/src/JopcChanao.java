...
public class JopcChanao extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valuemedium	pwr_valuemedium33;
  pwr_framethin	pwr_framethin35;
  public JopcChanao( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcChanao( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_valuemedium3.setBounds(new Rectangle(133,83,89,20));
    ...
    pwr_valuemedium5.setBounds(new Rectangle(133,110,89,20));
    ...
    pwr_valuelong7.setBounds(new Rectangle(133,5,568,19));
    ...
    pwr_buttoncommand8.setBounds(new Rectangle(9,309,81,26));
    ...
    pwr_valuelong9.setBounds(new Rectangle(133,30,568,19));
    ...
    pwr_valuemedium11.setBounds(new Rectangle(133,135,89,20));
    ...
    pwr_valuemedium13.setBounds(new Rectangle(165,192,89,20));
    ...
    pwr_valuemedium15.setBounds(new Rectangle(280,192,89,20));
    ...
    pwr_valuemedium17.setBounds(new Rectangle(165,218,89,20));
    ...
    pwr_valuemedium19.setBounds(new Rectangle(280,218,89,20));
    ...
    pwr_valuemedium21.setBounds(new Rectangle(165,244,89,20));
    ...
    pwr_valuemedium23.setBounds(new Rectangle(280,244,89,20));
    ...
    pwr_valuemedium25.setBounds(new Rectangle(165,270,89,20));
    ...
    pwr_valuemedium27.setBounds(new Rectangle(280,270,89,20));
    ...
    pwr_framethin30.setBounds(new Rectangle(1,163,376,140));
    ...
    jopButtontoggle32.setBounds(new Rectangle(276,167,98,17));
    jopButtontoggle32.setColorTone(1);
    localPanel.add(jopButtontoggle32, new Proportion(jopButtontoggle32.getBounds(), dsize));
    pwr_valuemedium33 = new pwr_valuemedium(session);
    pwr_valuemedium33.setBounds(new Rectangle(343,82,89,20));
    pwr_valuemedium33.setFillColor(51);
    pwr_valuemedium33.setBorderColor(56);
    localPanel.add(pwr_valuemedium33, new Proportion(pwr_valuemedium33.getBounds(), dsize));
    pwr_framethin35 = new pwr_framethin(session);
    pwr_framethin35.setBounds(new Rectangle(1,78,465,27));
    localPanel.add(pwr_framethin35, new Proportion(pwr_framethin35.getBounds(), dsize));
    ...
    pwr_valuemedium3.dd.setActionType(4096);
    pwr_valuemedium3.dd.setAccess(38);
    pwr_valuemedium3.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium3.dd, "$object.TestOn##Boolean","%d")
      });
    pwr_valuemedium5.dd.setDynType(1025);
    pwr_valuemedium5.dd.setActionType(0);
    pwr_valuemedium5.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium5.dd, "$object.FixedOutValue##Float32","%10.3f")
      });
    ...
    pwr_valuemedium11.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium11.dd, "$object.OutPolyType##UInt32","%d")
      });
    ...
    pwr_valuemedium33.dd.setDynType(1024);
    pwr_valuemedium33.dd.setActionType(4096);
    pwr_valuemedium33.dd.setAccess(38);
    pwr_valuemedium33.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium33.dd, "$object.TestValue##Float32","%10.3f")
      });
    pwr_framethin35.dd.setDynType(1);
    pwr_framethin35.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Line2D.Float( 375.278F, 187.101F, 2.9396F, 187.101F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("TestOn"),9, 97);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("FixedOutValue"),8, 122);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("OutPolyType"),8, 149);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("ActualValue"),8, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("-"),263, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("SensorSignalValue"),8, 233);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("-"),263, 233);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("ChannelSignalValue"),8, 259);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("-"),263, 259);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("RawValue"),8, 284);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("-"),263, 284);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("Range"),8, 180);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 14));
    g.drawString( JopLang.transl("TestValue"),247, 96);
    g.setTransform(save);
  }
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 8, 5, 5, 8}, new int[] { 26, 25, 5,8}, 4),
    new Polygon( new int[] { 8, 5, 87, 88}, new int[] { 8, 5, 5,8}, 4),
    ...
    new Polygon( new int[] { 2, 4, -41, -41}, new int[] { 32, 26, -57,-57}, 4),
    ...
    new Polygon( new int[] { 88, 90, 90, 88}, new int[] { 26, 28, 8,8}, 4),
    ...
    new Polygon( new int[] { 2, 6, -41, -41}, new int[] { 32, 30, -57,-57}, 4),
    new Rectangle2D.Float(2F, 2F, 92.0805F, 30.0671F),
    new Polygon( new int[] { 2, 94, 93, 4, 4, 2}, new int[] { 2, 2, 4, 4, 31, 32}, 6), 
    new Polygon( new int[] { 94, 94, 93, 93, 4, 2}, new int[] { 32, 2, 4, 31, 31, 32}, 6), 
  };
