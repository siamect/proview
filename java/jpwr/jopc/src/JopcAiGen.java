...
public class JopcAiGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium2.setBounds(new Rectangle(123,129,95,22));
    ...
    pwr_valuemedium4.setBounds(new Rectangle(123,156,95,22));
    ...
    jopBar5.setBounds(new Rectangle(252,65,13,145));
    ...
    jopTrend6.setBounds(new Rectangle(290,64,491,146));
    ...
    pwr_valuelong13.setBounds(new Rectangle(120,26,698,21));
    ...
    pwr_sliderbackground114.setBounds(new Rectangle(798,52,18,171));
    ...
    pwr_slider115.setBounds(new Rectangle(800,57,20,17));
    ...
    jopSmallbutton16.setBounds(new Rectangle(688,214,63,19));
    ...
    pwr_valueinputreliefup17.setBounds(new Rectangle(201,56,40,17));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(201,203,40,17));
    ...
    pwr_valueinputreliefup19.setBounds(new Rectangle(290,215,40,17));
    ...
    pwr_valueinputmedium20.setBounds(new Rectangle(123,102,95,22));
    ...
    pwr_mbopenobject21.setBounds(new Rectangle(179,1,18,18));
    ...
    pwr_mbtrend22.setBounds(new Rectangle(40,1,18,18));
    ...
    pwr_mbfast23.setBounds(new Rectangle(60,1,18,18));
    ...
    pwr_mbphoto24.setBounds(new Rectangle(80,1,18,18));
    ...
    pwr_mbdatasheet25.setBounds(new Rectangle(100,1,18,18));
    ...
    pwr_mbcircuitdiagram26.setBounds(new Rectangle(219,1,18,18));
    ...
    pwr_mbrtnavigator27.setBounds(new Rectangle(159,1,18,18));
    ...
    pwr_mbhelpclass28.setBounds(new Rectangle(239,1,18,18));
    ...
    pwr_mbblockevents29.setBounds(new Rectangle(139,1,18,18));
    ...
    pwr_mbhistevent30.setBounds(new Rectangle(120,1,18,18));
    ...
    pwr_mbnote31.setBounds(new Rectangle(20,1,18,18));
    ...
    pwr_mbhelp32.setBounds(new Rectangle(1,1,18,18));
    ...
    pwr_mbcrossreferences33.setBounds(new Rectangle(199,1,18,18));
    ...
    jopSmallbutton34.setBounds(new Rectangle(280,1,45,19));
    ...
    pwr_valuelong35.setBounds(new Rectangle(334,1,486,21));
    ...
    pwr_buttoncommandcenter36.setBounds(new Rectangle(10,201,84,28));
    ...
    pwr_slider115.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider115.dd, "$object.ActualValue##Float32",0,100,4,60.3925,204.865,"$object.PresMinLimit##Float32","$object.PresMaxLimit##Float32","!$local.SliderEnable##Boolean",818.039,234.688)
      });
    ...
    pwr_valueinputreliefup17.setAnnot1Font(pwr_valueinputreliefup17.annotFont.deriveFont((float)11));
    ...
    pwr_valueinputmedium20.setAnnot1Font(pwr_valueinputmedium20.annotFont.deriveFont((float)14));
