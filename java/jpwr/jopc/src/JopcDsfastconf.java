...
public class JopcDsfastconf extends JopFrame implements JopUtilityIfc {
  ...
  public JopcDsfastconf( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
...
protected class pwr_valuelong extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 604.545F, 15.9091F),
    new Polygon( new int[] { 2, 607, 606, 3, 3, 2}, new int[] { 2, 2, 3, 3, 17, 18}, 6), 
    new Polygon( new int[] { 607, 607, 606, 606, 3, 2}, new int[] { 18, 2, 3, 17, 17, 18}, 6), 
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_indsquare extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 13.6364F, 14.7727F),
...
protected class pwr_valuesmall extends GeComponent {
  ...
  public int original_height = 19;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 52.2727F, 15.9091F),
