...
public class JopcIoGen extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium2.setBounds(new Rectangle(127,127,94,23));
    ...
    jopBar4.setBounds(new Rectangle(252,64,16,145));
    ...
    jopTrend5.setBounds(new Rectangle(289,63,479,145));
    ...
    pwr_valuelong11.setBounds(new Rectangle(125,27,678,22));
    ...
    pwr_sliderbackground112.setBounds(new Rectangle(782,53,20,167));
    ...
    pwr_slider113.setBounds(new Rectangle(783,58,21,18));
    ...
    jopSmallbutton14.setBounds(new Rectangle(675,209,63,20));
    ...
    pwr_valueinputmedium15.setBounds(new Rectangle(127,102,94,23));
    ...
    pwr_valueinputreliefup16.setBounds(new Rectangle(203,58,41,18));
    ...
    pwr_valueinputreliefup17.setBounds(new Rectangle(203,200,41,18));
    ...
    pwr_valueinputreliefup18.setBounds(new Rectangle(289,212,41,18));
    ...
    pwr_mbopenobject19.setBounds(new Rectangle(182,5,19,19));
    ...
    pwr_mbtrend20.setBounds(new Rectangle(48,5,19,19));
    ...
    pwr_mbfast21.setBounds(new Rectangle(67,5,19,19));
    ...
    pwr_mbphoto22.setBounds(new Rectangle(86,5,19,19));
    ...
    pwr_mbdatasheet23.setBounds(new Rectangle(105,5,19,19));
    ...
    pwr_mbcircuitdiagram24.setBounds(new Rectangle(220,5,19,19));
    ...
    pwr_mbrtnavigator25.setBounds(new Rectangle(163,5,19,19));
    ...
    pwr_mbhelpclass26.setBounds(new Rectangle(240,5,19,19));
    ...
    pwr_mbblockevents27.setBounds(new Rectangle(144,5,19,19));
    ...
    pwr_mbhistevent28.setBounds(new Rectangle(124,5,19,19));
    ...
    pwr_mbnote29.setBounds(new Rectangle(28,5,19,19));
    ...
    pwr_mbhelp30.setBounds(new Rectangle(9,5,19,19));
    ...
    pwr_mbcrossreferences31.setBounds(new Rectangle(201,5,19,19));
    ...
    jopSmallbutton32.setBounds(new Rectangle(279,5,46,20));
    ...
    pwr_valuelong33.setBounds(new Rectangle(333,5,472,22));
    ...
    pwr_buttoncommandcenter34.setBounds(new Rectangle(11,200,83,29));
    ...
    pwr_slider113.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider113.dd, "$object.ActualValue##Int32",0,100,4,59.7336,199.659,"$object.PresMinLimit##Float32","$object.PresMaxLimit##Float32",
"!$local.SliderEnable##Boolean")
      });
