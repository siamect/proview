...
public class JopcAbb_acs800fanaggr14 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,648,48,20));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,575,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,560,20,14));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(308,593,51,17));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,522,16,16));
    ...
    grp223_77.setBounds(new Rectangle(34,521,40,18));
    ...
    pwr_rod80.setBounds(new Rectangle(132,579,39,10));
    ...
    pwr_fananim81.setBounds(new Rectangle(120,539,19,91));
    ...
    grp230_82.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_manswitch389.setBounds(new Rectangle(267,340,38,38));
    ...
    pwr_contactor290.setBounds(new Rectangle(267,388,38,38));
    ...
    pwr_acs80091.setBounds(new Rectangle(255,437,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -45, -45}, new int[] { 12, 15, 24,24}, 4),
