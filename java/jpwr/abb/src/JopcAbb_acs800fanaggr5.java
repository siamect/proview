...
public class JopcAbb_acs800fanaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp221_72.setBounds(new Rectangle(34,421,39,17));
    ...
    pwr_rod75.setBounds(new Rectangle(129,479,39,10));
    ...
    pwr_fananim76.setBounds(new Rectangle(117,439,19,91));
    ...
    grp227_77.setBounds(new Rectangle(35,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808822, 57}, new int[] { 12, 15, -1219808855,24}, 4),
