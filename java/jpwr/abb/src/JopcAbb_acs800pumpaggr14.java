...
public class JopcAbb_acs800pumpaggr14 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup92;
  public JopcAbb_acs800pumpaggr14( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr14( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr14");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,647,46,19));
    ...
    pwr_motor243.setBounds(new Rectangle(161,546,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,446,14,14));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,465,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,556,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,574,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,559,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,592,49,15));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,521,14,15));
    ...
    grp223_77.setBounds(new Rectangle(35,520,38,16));
    ...
    pwr_pump380.setBounds(new Rectangle(78,547,82,72));
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(155,573,10,20));
    ...
    pwr_fuse388.setBounds(new Rectangle(281,295,13,35));
    ...
    pwr_manswitch389.setBounds(new Rectangle(268,339,36,36));
    ...
    pwr_contactor290.setBounds(new Rectangle(268,387,36,36));
    ...
    pwr_acs80091.setBounds(new Rectangle(256,436,62,82));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 279.16F, 361.006F, 365.408F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 279, 279, 280, 280, 643, 645}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 645, 279, 280, 643, 643, 645}, 6), 
    ...
    new Line2D.Float( 288F, 388F, 288F, 374F),
    new Line2D.Float( 288F, 438F, 288F, 422F),
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {548, 548, 544, 516, 544, 548}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 587);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 587);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 569);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 605);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 605);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -25}, new int[] { 8, 10, 12,13}, 4),
    ...
    new Polygon( new int[] { 6, 7, 0, -25}, new int[] { 40, 36, -1220128354,13}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -25}, new int[] { 46, 46, 54,13}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128393, -25}, new int[] { 10, 13, -1220128354,13}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128393, -25}, new int[] { 14, 17, -1220128354,13}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128375, -7}, new int[] { 12, 15, -1220128324,43}, 4),
