...
public class JopcAbb_acs800fanaggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare51.setBounds(new Rectangle(161,352,16,17));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,530,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(358,515,20,14));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,548,51,17));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,477,16,17));
    ...
    grp223_73.setBounds(new Rectangle(34,476,40,17));
    ...
    pwr_rod76.setBounds(new Rectangle(131,534,39,10));
    ...
    pwr_fananim77.setBounds(new Rectangle(119,494,19,91));
    ...
    grp230_78.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_acs80083.setBounds(new Rectangle(255,342,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 45, 43}, new int[] { 12, 15, 42,42}, 4),
