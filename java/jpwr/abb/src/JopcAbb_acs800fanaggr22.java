...
public class JopcAbb_acs800fanaggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup84;
  public JopcAbb_acs800fanaggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr22");
    ...
    pwr_indsquare51.setBounds(new Rectangle(162,353,14,15));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(309,531,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(359,516,18,12));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(309,549,49,15));
    ...
    pwr_indsquare72.setBounds(new Rectangle(162,478,14,15));
    ...
    grp223_73.setBounds(new Rectangle(35,477,38,15));
    ...
    pwr_rod76.setBounds(new Rectangle(132,535,37,8));
    ...
    pwr_fananim77.setBounds(new Rectangle(120,495,17,89));
    pwr_fananim77.setShadow(1);
    localPanel.add(pwr_fananim77, new Proportion(pwr_fananim77.getBounds(), dsize));
    grp230_78 = new Grp230_(session);
    grp230_78.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp230_78, new Proportion(grp230_78.getBounds(), dsize));
    ...
    pwr_acs80083.setBounds(new Rectangle(256,343,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp230_78.dd.setDynType(129);
    grp230_78.dd.setActionType(0);
    grp230_78.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_78.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 280.243F, 361.006F, 321.793F),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 94, 43}, new int[] { 12, 15, 43,42}, 4),
