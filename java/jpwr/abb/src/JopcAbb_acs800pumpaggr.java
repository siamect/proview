...
public class JopcAbb_acs800pumpaggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_acs80092 = new pwr_acs800(session);
    pwr_acs80092.setBounds(new Rectangle(256,382,62,82));
    pwr_acs80092.setShadow(1);
    localPanel.add(pwr_acs80092, new Proportion(pwr_acs80092.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_acs80092.dd.setDynType(1);
    pwr_acs80092.dd.setActionType(66);
    pwr_acs80092.dd.setAccess(65535);
    pwr_acs80092.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80092.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80092.dd, "open graph /class/instance=$object.ACS800")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -15}, new int[] { 8, 10, 12,14}, 4),
    ...
    new Polygon( new int[] { 6, 7, 1, -15}, new int[] { 40, 36, -1220128353,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -15}, new int[] { 46, 46, 54,14}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128383, -15}, new int[] { 10, 14, -1220128353,14}, 4),
    ...
    new Polygon( new int[] { 6, 9, -15, -15}, new int[] { 14, 17, 455,14}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128365, 2}, new int[] { 12, 15, -1220128323,44}, 4),
