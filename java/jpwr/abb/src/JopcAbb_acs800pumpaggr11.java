...
public class JopcAbb_acs800pumpaggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcAbb_acs800pumpaggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr11");
    ...
    pwr_valuesmall31.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_acs80040 = new pwr_acs800(session);
    pwr_acs80040.setBounds(new Rectangle(256,294,62,82));
    pwr_acs80040.setShadow(1);
    localPanel.add(pwr_acs80040, new Proportion(pwr_acs80040.getBounds(), dsize));
    pwr_smallbuttoncenter41 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter41.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(155,431,10,19));
    ...
    pwr_mbup79.setBounds(new Rectangle(346,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu236.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu236.dd, new String[] {
        JopLang.transl("ASC800.ActSpeed"),null,null,null,null,JopLang.transl("ASC800.ActTorque"),JopLang.transl("ASC800.ActCurrent"),JopLang.transl("ASC800.RefSpeed"),JopLang.transl("Motor.TempSwitch.Switch Di"),JopLang.transl("Motor.TempSensor.Value Ai"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.ACS800.ActSpeed")
      }),
null,null,null,null,    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.ACS800.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.ACS800.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu236,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu236.dd, "open graph /class /inst=$object.ACS800.RefSpeed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu238.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.ACS800")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_acs80040.dd.setDynType(1);
    pwr_acs80040.dd.setActionType(66);
    pwr_acs80040.dd.setAccess(65535);
    pwr_acs80040.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80040.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80040.dd, "open graph /class/instance=$object.ACS800")
      });
    ...
    pwr_indround47.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround47.dd, "$object.ACS800.ConvertRun##Boolean",29)
      });
    ...
    pwr_indsquare49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare49.dd, "$object.ACS800.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare49.dd, "$object.ACS800.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare49.dd, "$object.ACS800.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare49.dd, "$object.ACS800.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare49.dd, "$object.ACS800")
      });
    ...
    pwr_smallbuttoncenter53.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter53.dd, "$object.ACS800.OpReset##Boolean")
      });
    ...
    pwr_valuemedium54.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium54.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium54.dd, "$object.ACS800.ActSpeed")
      });
    ...
    pwr_valuemedium55.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium55.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium55.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium57.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium57.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium64.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium64.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium64.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_pumpanim273.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim273.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim273.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim273.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    pwr_rodcouplinganim75.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim75.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 446);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 446);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 428);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 464);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 464);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 135, -9}, new int[] { 40, 36, -1220128346,21}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128377, -9}, new int[] { 10, 14, -1220128346,21}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128377, -9}, new int[] { 14, 19, -1220128346,21}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128359, 8}, new int[] { 12, 15, -1220128316,51}, 4),
