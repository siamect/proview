...
public class JopcAbb_acs800pumpaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pumpanim272.setBounds(new Rectangle(117,95,64,43));
    ...
    pwr_pump373.setBounds(new Rectangle(77,404,84,74));
