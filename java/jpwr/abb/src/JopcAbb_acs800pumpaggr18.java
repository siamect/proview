...
public class JopcAbb_acs800pumpaggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,577,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,562,20,14));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(308,595,51,17));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,524,16,17));
    ...
    grp223_77.setBounds(new Rectangle(34,523,40,18));
    ...
    pwr_pump380.setBounds(new Rectangle(77,550,84,74));
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(154,576,12,22));
    ...
    pwr_fuse388.setBounds(new Rectangle(280,296,15,37));
    ...
    pwr_contactor289.setBounds(new Rectangle(267,340,38,38));
    ...
    pwr_acs80090.setBounds(new Rectangle(255,389,64,84));
    ...
    pwr_safetyswitch91.setBounds(new Rectangle(268,485,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 94, 5}, new int[] { 40, 36, -1219808868,11}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219808874, 5}, new int[] { 10, 13, -1219808868,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219808874, 5}, new int[] { 14, 17, -1219808868,11}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 23, 23}, new int[] { 12, 15, 306,41}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 23, 23}, new int[] { 12, 15, 482,41}, 4),
