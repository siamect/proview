...
public class JopcAbb_acs800pumpaggr18 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup92;
  public JopcAbb_acs800pumpaggr18( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr18( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr18");
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,578,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,563,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,596,49,15));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,525,14,15));
    ...
    grp223_77.setBounds(new Rectangle(35,524,38,16));
    ...
    pwr_pump380.setBounds(new Rectangle(78,551,82,72));
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(155,577,10,20));
    ...
    pwr_fuse388.setBounds(new Rectangle(281,297,13,35));
    ...
    pwr_contactor289.setBounds(new Rectangle(268,341,36,36));
    ...
    pwr_acs80090.setBounds(new Rectangle(256,390,62,82));
    ...
    pwr_safetyswitch91.setBounds(new Rectangle(269,486,36,37));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 507);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),363, 591);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 591);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 573);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 609);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 609);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 4, 9, 5}, new int[] { 8, 10, 11,11}, 4),
    ...
    new Polygon( new int[] { 6, 7, 5, 5}, new int[] { 40, 36, 11,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 5}, new int[] { 46, 46, 54,11}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128362, 5}, new int[] { 10, 13, -1220128356,11}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 17, 144126179,11}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128344, 23}, new int[] { 12, 15, -1220128326,41}, 4),
