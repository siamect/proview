...
public class JopcAbb_acs800fanaggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800fanaggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr20");
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,607,45,19));
    ...
    pwr_valuelong26.setBounds(new Rectangle(61,606,334,21));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,400,14,15));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,419,55,21));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,514,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,532,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(357,517,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(307,550,49,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,479,14,15));
    ...
    grp221_75.setBounds(new Rectangle(35,478,38,16));
    ...
    pwr_rod78.setBounds(new Rectangle(131,536,37,8));
    ...
    pwr_fananim79.setBounds(new Rectangle(119,496,17,89));
    pwr_fananim79.setShadow(1);
    localPanel.add(pwr_fananim79, new Proportion(pwr_fananim79.getBounds(), dsize));
    grp227_80 = new Grp227_(session);
    grp227_80.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp227_80, new Proportion(grp227_80.getBounds(), dsize));
    ...
    pwr_contactor286.setBounds(new Rectangle(268,341,36,36));
    ...
    pwr_acs80087.setBounds(new Rectangle(256,390,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp227_80.dd.setDynType(129);
    grp227_80.dd.setActionType(0);
    grp227_80.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp227_80.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 628;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7573F, 281.062F, 361.009F, 321.537F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 281, 281, 282, 282, 602, 603}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 603, 281, 282, 602, 602, 603}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 364);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 411);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),361, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 527);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 563);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 563);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128371, -3}, new int[] { 12, 15, -1220128345,22}, 4),
