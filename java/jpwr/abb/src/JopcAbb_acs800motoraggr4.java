...
public class JopcAbb_acs800motoraggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch382;
  pwr_acs800	pwr_acs80083;
  pwr_mbup	pwr_mbup84;
  public JopcAbb_acs800motoraggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr4");
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(153,523,10,20));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,471,14,14));
    ...
    pwr_manswitch382 = new pwr_manswitch3(session);
    pwr_manswitch382.setBounds(new Rectangle(268,285,36,36));
    pwr_manswitch382.setFillColor(32);
    pwr_manswitch382.setShadow(1);
    localPanel.add(pwr_manswitch382, new Proportion(pwr_manswitch382.getBounds(), dsize));
    pwr_acs80083 = new pwr_acs800(session);
    pwr_acs80083.setBounds(new Rectangle(256,336,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_manswitch382.dd.setDynType(32769);
    pwr_manswitch382.dd.setActionType(66);
    pwr_manswitch382.dd.setAccess(65535);
    pwr_manswitch382.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch382.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch382.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch382.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128327, 40}, new int[] { 12, 15, -1220128311,56}, 4),
