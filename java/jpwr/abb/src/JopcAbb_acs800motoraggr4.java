...
public class JopcAbb_acs800motoraggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(152,522,12,22));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,470,16,16));
    ...
    pwr_manswitch382.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_acs80083.setBounds(new Rectangle(255,335,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808839, 40}, new int[] { 12, 15, -1219808823,56}, 4),
