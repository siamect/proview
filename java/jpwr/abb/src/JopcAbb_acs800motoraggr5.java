...
public class JopcAbb_acs800motoraggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim71.setBounds(new Rectangle(152,474,12,22));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,422,16,17));
    ...
    pwr_smallbuttoncenter76.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_acs80079.setBounds(new Rectangle(255,335,64,84));
    ...
    pwr_manswitch380.setBounds(new Rectangle(267,284,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808844, 35}, new int[] { 12, 15, -1219808859,20}, 4),
