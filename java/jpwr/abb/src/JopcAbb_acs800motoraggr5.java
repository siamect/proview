...
public class JopcAbb_acs800motoraggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch380;
  pwr_mbup	pwr_mbup81;
  public JopcAbb_acs800motoraggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr5");
    ...
    pwr_rodcouplinganim71.setBounds(new Rectangle(153,475,10,20));
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,423,14,15));
    ...
    grp221_74.setBounds(new Rectangle(35,422,38,15));
    localPanel.add(grp221_74, new Proportion(grp221_74.getBounds(), dsize));
    grp224_75 = new Grp224_(session);
    grp224_75.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp224_75, new Proportion(grp224_75.getBounds(), dsize));
    pwr_smallbuttoncenter76 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter76.setBounds(new Rectangle(34,197,45,19));
    ...
    pwr_acs80079.setBounds(new Rectangle(256,336,62,82));
    ...
    pwr_manswitch380.setBounds(new Rectangle(268,285,36,36));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp224_75.dd.setDynType(129);
    grp224_75.dd.setActionType(0);
    grp224_75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp224_75.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_manswitch380.dd.setDynType(32769);
    pwr_manswitch380.dd.setActionType(66);
    pwr_manswitch380.dd.setAccess(65535);
    pwr_manswitch380.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch380.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch380.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch380.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128332, 35}, new int[] { 12, 15, -1220128347,20}, 4),
