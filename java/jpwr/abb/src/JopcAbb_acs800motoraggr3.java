...
public class JopcAbb_acs800motoraggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup85;
  public JopcAbb_acs800motoraggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr3");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,598,46,19));
    ...
    pwr_indround49.setBounds(new Rectangle(86,248,16,16));
    ...
    pwr_rodcouplinganim73.setBounds(new Rectangle(155,524,10,20));
    ...
    pwr_indsquare75.setBounds(new Rectangle(162,472,14,14));
    ...
    grp223_76.setBounds(new Rectangle(35,471,38,16));
    ...
    pwr_safetyswitch84.setBounds(new Rectangle(269,433,36,37));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128393, -25}, new int[] { 12, 15, -1220128301,66}, 4),
