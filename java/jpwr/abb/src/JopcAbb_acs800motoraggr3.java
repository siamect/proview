...
public class JopcAbb_acs800motoraggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,597,48,21));
    ...
    pwr_indround49.setBounds(new Rectangle(85,247,18,18));
    ...
    pwr_rodcouplinganim73.setBounds(new Rectangle(154,523,12,22));
    ...
    pwr_indsquare75.setBounds(new Rectangle(161,471,16,16));
    ...
    grp223_76.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_safetyswitch84.setBounds(new Rectangle(268,432,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808905, -25}, new int[] { 12, 15, -1219808813,66}, 4),
