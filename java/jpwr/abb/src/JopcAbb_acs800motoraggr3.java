...
public class JopcAbb_acs800motoraggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton26.setBounds(new Rectangle(4,597,48,21));
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(154,523,12,22));
