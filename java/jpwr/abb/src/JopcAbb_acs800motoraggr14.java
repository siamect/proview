...
public class JopcAbb_acs800motoraggr14 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800motoraggr14( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr14( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr14");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,648,46,18));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,647,334,21));
    ...
    pwr_motor243.setBounds(new Rectangle(161,547,96,71));
    ...
    pwr_indsquare54.setBounds(new Rectangle(162,447,14,14));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,466,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,557,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,575,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,560,18,12));
    ...
    grp210_68.setBounds(new Rectangle(127,228,39,16));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,593,49,15));
    ...
    pwr_manswitch387.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_contactor288.setBounds(new Rectangle(268,388,36,36));
    ...
    pwr_acs80089.setBounds(new Rectangle(256,437,62,82));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 588);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 588);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 570);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 606);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 606);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -18, -18}, new int[] { 12, 15, 478,37}, 4),
