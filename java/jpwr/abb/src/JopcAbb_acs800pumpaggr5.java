...
public class JopcAbb_acs800pumpaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(161,296,16,17));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,548,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,547,336,23));
    ...
    pwr_motor241.setBounds(new Rectangle(158,447,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,345,16,16));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,364,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(306,457,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(306,475,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(356,460,20,14));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(306,493,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,422,16,17));
    ...
    pwr_pump375.setBounds(new Rectangle(75,448,84,74));
    ...
    pwr_smallbuttoncenter78.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_manswitch381.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_acs80082.setBounds(new Rectangle(255,335,64,84));
    ...
    pwr_mbup83.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808872, 7}, new int[] { 10, 12, -1219808882,-2}, 4),
    ...
    new Polygon( new int[] { 6, 10, 146743063, 7}, new int[] { 14, 17, 147821397,-2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808854, 25}, new int[] { 12, 15, -1219808852,27}, 4),
