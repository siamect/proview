...
public class JopcAbb_acs800motoraggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motorman	pwr_motorman74;
  pwr_indsquare	pwr_indsquare75;
  Grp223_	grp223_76;
  pwr_fuse3	pwr_fuse377;
  Grp226_	grp226_78;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter79;
  pwr_mbup	pwr_mbup83;
  public JopcAbb_acs800motoraggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr21");
    ...
    pwr_safetyswitch29.setBounds(new Rectangle(269,439,36,37));
    ...
    pwr_acs80043 = new pwr_acs800(session);
    pwr_acs80043.setBounds(new Rectangle(256,343,62,82));
    pwr_acs80043.setShadow(1);
    localPanel.add(pwr_acs80043, new Proportion(pwr_acs80043.getBounds(), dsize));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,353,14,15));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(37,372,55,21));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(309,513,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,531,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(359,516,18,12));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(309,549,49,15));
    ...
    pwr_rodcouplinganim73.setBounds(new Rectangle(155,530,10,20));
    localPanel.add(pwr_rodcouplinganim73, new Proportion(pwr_rodcouplinganim73.getBounds(), dsize));
    pwr_motorman74 = new pwr_motorman(session);
    pwr_motorman74.setBounds(new Rectangle(115,96,62,42));
    pwr_motorman74.setShadow(1);
    pwr_motorman74.setGradient(12);
    localPanel.add(pwr_motorman74, new Proportion(pwr_motorman74.getBounds(), dsize));
    pwr_indsquare75 = new pwr_indsquare(session);
    pwr_indsquare75.setBounds(new Rectangle(162,478,14,15));
    pwr_indsquare75.setFillColor(294);
    pwr_indsquare75.setShadow(1);
    localPanel.add(pwr_indsquare75, new Proportion(pwr_indsquare75.getBounds(), dsize));
    grp223_76 = new Grp223_(session);
    grp223_76.setBounds(new Rectangle(35,477,38,15));
    localPanel.add(grp223_76, new Proportion(grp223_76.getBounds(), dsize));
    pwr_fuse377 = new pwr_fuse3(session);
    pwr_fuse377.setBounds(new Rectangle(281,299,13,35));
    pwr_fuse377.setRotate(-90);
    pwr_fuse377.setShadow(1);
    localPanel.add(pwr_fuse377, new Proportion(pwr_fuse377.getBounds(), dsize));
    grp226_78 = new Grp226_(session);
    grp226_78.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp226_78, new Proportion(grp226_78.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_acs80043.dd.setDynType(1);
    pwr_acs80043.dd.setActionType(66);
    pwr_acs80043.dd.setAccess(65535);
    pwr_acs80043.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80043.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80043.dd, "open graph /class/instance=$object.ACS800")
      });
    ...
    pwr_indround50.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround50.dd, "$object.ACS800.ConvertRun##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter56.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter56.dd, "$object.ACS800.OpReset##Boolean")
      });
    ...
    pwr_valuemedium57.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium57.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium57.dd, "$object.ACS800.ActSpeed")
      });
    ...
    pwr_valuemedium58.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium58.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium58.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium60.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium60.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium67.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium67.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium67.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_rodcouplinganim73.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim73.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
    pwr_motorman74.dd.setDynType(1077);
    pwr_motorman74.dd.setActionType(0);
    pwr_motorman74.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman74.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman74.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman74.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_motorman74.dd, "$object.Mode.IndMode##String8","%s")
      });
    pwr_indsquare75.dd.setDynType(176);
    pwr_indsquare75.dd.setActionType(2);
    pwr_indsquare75.dd.setAccess(65532);
    pwr_indsquare75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare75.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare75.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare75.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare75.dd, "$object.Motor")
      });
    grp223_76.dd.setDynType(129);
    grp223_76.dd.setActionType(0);
    grp223_76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_76.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_fuse377.dd.setDynType(1);
    pwr_fuse377.dd.setActionType(0);
    grp226_78.dd.setDynType(129);
    grp226_78.dd.setActionType(0);
    grp226_78.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_78.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 22F, 404.413F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2F,44.4305F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2F,22F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),37, 460);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),364, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),265, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),364, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),265, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 2, 2}, new int[] { 12, 15, 103,38}, 4),
