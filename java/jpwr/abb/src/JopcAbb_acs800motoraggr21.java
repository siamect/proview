...
public class JopcAbb_acs800motoraggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch29.setBounds(new Rectangle(268,438,38,39));
    ...
    pwr_acs80043.setBounds(new Rectangle(255,342,64,84));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,352,16,17));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(36,371,57,23));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,512,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,530,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(358,515,20,14));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(308,548,51,17));
    ...
    pwr_rodcouplinganim73.setBounds(new Rectangle(154,529,12,22));
    ...
    pwr_motorman74.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare75.setBounds(new Rectangle(161,477,16,17));
    ...
    grp226_78.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808877, 2}, new int[] { 12, 15, -1219808841,38}, 4),
