...
public class JopcAbb_acs800fanaggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup89;
  public JopcAbb_acs800fanaggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr15");
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,499,14,15));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,654,45,18));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,653,334,21));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(269,489,36,37));
    ...
    pwr_motor244.setBounds(new Rectangle(161,553,96,72));
    ...
    pwr_indsquare53.setBounds(new Rectangle(162,403,14,15));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,422,55,21));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,563,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(309,581,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(359,566,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(309,599,49,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,528,14,14));
    ...
    pwr_rod78.setBounds(new Rectangle(132,585,37,8));
    ...
    pwr_fananim79.setBounds(new Rectangle(120,545,17,89));
    pwr_fananim79.setShadow(1);
    localPanel.add(pwr_fananim79, new Proportion(pwr_fananim79.getBounds(), dsize));
    grp230_80 = new Grp230_(session);
    grp230_80.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp230_80, new Proportion(grp230_80.getBounds(), dsize));
    ...
    pwr_fuse386.setBounds(new Rectangle(281,297,13,35));
    ...
    pwr_manswitch387.setBounds(new Rectangle(268,341,36,36));
    ...
    pwr_acs80088.setBounds(new Rectangle(256,393,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp230_80.dd.setDynType(129);
    grp230_80.dd.setActionType(0);
    grp230_80.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp230_80.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7573F, 280.443F, 361.009F, 369.393F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 280, 280, 282, 282, 649, 650}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 650, 280, 282, 649, 649, 650}, 6), 
    ...
    new Line2D.Float( 288F, 492F, 288F, 474F),
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {556, 556, 552, 526, 552, 556}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 510);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),363, 594);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 594);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 576);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 612);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 612);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 16, 16}, new int[] { 12, 13, 2526,-10}, 4),
