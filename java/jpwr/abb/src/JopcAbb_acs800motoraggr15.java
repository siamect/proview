...
public class JopcAbb_acs800motoraggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp227_78.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_manswitch385.setBounds(new Rectangle(267,338,38,38));
    ...
    pwr_acs80086.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808896, -16}, new int[] { 12, 15, -1219808860,19}, 4),
