...
public class JopcAbb_acs800motoraggr15 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_fuse3	pwr_fuse384;
  pwr_manswitch3	pwr_manswitch385;
  pwr_acs800	pwr_acs80086;
  pwr_mbup	pwr_mbup87;
  public JopcAbb_acs800motoraggr15( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr15( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr15");
    ...
    grp227_78.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_fuse384 = new pwr_fuse3(session);
    pwr_fuse384.setBounds(new Rectangle(281,295,13,35));
    pwr_fuse384.setRotate(-90);
    pwr_fuse384.setShadow(1);
    localPanel.add(pwr_fuse384, new Proportion(pwr_fuse384.getBounds(), dsize));
    pwr_manswitch385 = new pwr_manswitch3(session);
    pwr_manswitch385.setBounds(new Rectangle(268,339,36,36));
    pwr_manswitch385.setFillColor(32);
    pwr_manswitch385.setShadow(1);
    localPanel.add(pwr_manswitch385, new Proportion(pwr_manswitch385.getBounds(), dsize));
    pwr_acs80086 = new pwr_acs800(session);
    pwr_acs80086.setBounds(new Rectangle(256,391,62,82));
    pwr_acs80086.setShadow(1);
    localPanel.add(pwr_acs80086, new Proportion(pwr_acs80086.getBounds(), dsize));
    pwr_mbup87 = new pwr_mbup(session);
    pwr_mbup87.setBounds(new Rectangle(346,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse384.dd.setDynType(1);
    pwr_fuse384.dd.setActionType(0);
    pwr_manswitch385.dd.setDynType(32769);
    pwr_manswitch385.dd.setActionType(66);
    pwr_manswitch385.dd.setAccess(65535);
    pwr_manswitch385.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch385.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch385.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch385.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    pwr_acs80086.dd.setDynType(1);
    pwr_acs80086.dd.setActionType(66);
    pwr_acs80086.dd.setAccess(65535);
    pwr_acs80086.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80086.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80086.dd, "open graph /class/instance=$object.ACS800")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857015, -16}, new int[] { 12, 15, 146127115,19}, 4),
