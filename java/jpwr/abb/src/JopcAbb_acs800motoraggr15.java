...
public class JopcAbb_acs800motoraggr15 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim75.setBounds(new Rectangle(154,577,12,22));
    ...
    pwr_indsquare77.setBounds(new Rectangle(161,525,16,16));
    ...
    grp227_81.setBounds(new Rectangle(36,196,43,18));
