...
public class JopcAbb_acs800motoraggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_acs800	pwr_acs80078;
  pwr_mbup	pwr_mbup79;
  public JopcAbb_acs800motoraggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr23");
    ...
    pwr_valuemedium54.setBounds(new Rectangle(309,480,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(309,498,49,15));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(155,479,10,20));
    ...
    pwr_indsquare71.setBounds(new Rectangle(162,427,14,14));
    ...
    pwr_fuse377.setBounds(new Rectangle(281,297,13,35));
    pwr_fuse377.setRotate(-90);
    pwr_fuse377.setShadow(1);
    localPanel.add(pwr_fuse377, new Proportion(pwr_fuse377.getBounds(), dsize));
    pwr_acs80078 = new pwr_acs800(session);
    pwr_acs80078.setBounds(new Rectangle(256,342,62,82));
    pwr_acs80078.setShadow(1);
    localPanel.add(pwr_acs80078, new Proportion(pwr_acs80078.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_rodcouplinganim69.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim69.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
    ...
    pwr_motorman70.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman70.dd, "$object.ACS800.ConvertRun##Boolean",37)
    ...
    pwr_acs80078.dd.setDynType(1);
    pwr_acs80078.dd.setActionType(66);
    pwr_acs80078.dd.setAccess(65535);
    pwr_acs80078.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80078.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80078.dd, "open graph /class/instance=$object.ACS800")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(3.37535F, 22.7708F, 404.413F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 3.37535F,45.2013F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        3.37535F,22.7708F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.drawString( JopLang.transl("%"),363, 493);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 493);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 511);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 511);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128358, 9}, new int[] { 12, 15, -1220128310,57}, 4),
