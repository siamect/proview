...
public class JopcAbb_acs800motoraggr23 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium54.setBounds(new Rectangle(308,479,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(308,497,51,17));
    ...
    pwr_rodcouplinganim69.setBounds(new Rectangle(154,478,12,22));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,426,16,16));
    ...
    pwr_acs80078.setBounds(new Rectangle(255,341,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808870, 9}, new int[] { 12, 15, -1219808822,57}, 4),
