...
public class JopcAbb_acs800motoraggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,494,16,17));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,649,47,20));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,648,336,23));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(268,484,38,39));
    ...
    pwr_valuesmall36.setBounds(new Rectangle(301,229,72,18));
    ...
    pwr_motor244.setBounds(new Rectangle(160,548,98,74));
    ...
    pwr_indsquare55.setBounds(new Rectangle(161,398,16,17));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(36,417,57,23));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,558,51,17));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(308,576,51,17));
    ...
    pwr_valuemedium64.setBounds(new Rectangle(358,561,20,14));
    ...
    pwr_valuemedium71.setBounds(new Rectangle(308,594,51,17));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(154,575,12,22));
    ...
    pwr_indsquare79.setBounds(new Rectangle(161,523,16,17));
    ...
    pwr_fuse387.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_contactor288.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_acs80089.setBounds(new Rectangle(255,388,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808809, 70}, new int[] { 12, 15, -1219808856,23}, 4),
