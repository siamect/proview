...
public class JopcAbb_acs800pumpaggr23 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_acs800	pwr_acs80080;
  pwr_mbup	pwr_mbup81;
  public JopcAbb_acs800pumpaggr23( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr23( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr23");
    ...
    pwr_acs80080 = new pwr_acs800(session);
    pwr_acs80080.setBounds(new Rectangle(256,343,62,82));
    pwr_acs80080.setShadow(1);
    localPanel.add(pwr_acs80080, new Proportion(pwr_acs80080.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter52.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter52.dd, "$object.ACS800.OpReset##Boolean")
      });
    ...
    pwr_pumpanim272.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim272.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim272.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim272.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    pwr_acs80080.dd.setDynType(1);
    pwr_acs80080.dd.setActionType(66);
    pwr_acs80080.dd.setAccess(65535);
    pwr_acs80080.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80080.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80080.dd, "open graph /class/instance=$object.ACS800")
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 10, 10}, new int[] { 8, 8, 11,-8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 59, 10}, new int[] { 40, 34, -1220128376,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 10, 10, 10}, new int[] { 46, 46, 57,-8}, 4),
    ...
    new Polygon( new int[] { 54, 56, 148697106, 10}, new int[] { 10, 12, 144052695,-8}, 4),
    ...
    new Polygon( new int[] { 6, 10, -1220128357, 10}, new int[] { 14, 17, -1220128376,-8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128339, 28}, new int[] { 12, 15, -1220128346,21}, 4),
