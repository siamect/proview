...
public class JopcAbb_acs800fanaggr18 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcAbb_acs800fanaggr18( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr18( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr18");
    ...
    pwr_valuemedium62.setBounds(new Rectangle(308,560,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(308,578,51,17));
    ...
    pwr_valuemedium72.setBounds(new Rectangle(308,596,51,17));
    ...
    grp223_79.setBounds(new Rectangle(34,524,39,18));
    ...
    pwr_rod82.setBounds(new Rectangle(130,582,39,10));
    ...
    pwr_fananim83.setBounds(new Rectangle(118,542,19,91));
    ...
    pwr_fuse385.setBounds(new Rectangle(279,297,15,37));
