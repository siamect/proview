...
public class JopcAbb_acs800fanaggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,420,55,21));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(309,561,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,579,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,564,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,597,49,15));
    ...
    pwr_rod80.setBounds(new Rectangle(131,583,37,8));
    ...
    pwr_fananim81.setBounds(new Rectangle(119,543,17,89));
    ...
    pwr_fuse388.setBounds(new Rectangle(281,299,13,35));
    ...
    pwr_contactor289.setBounds(new Rectangle(268,342,36,36));
    ...
    pwr_acs80090.setBounds(new Rectangle(256,391,62,82));
    ...
    pwr_safetyswitch91.setBounds(new Rectangle(269,487,36,37));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 32, 32}, new int[] { 12, 15, 25,25}, 4),
