...
public class JopcAbb_acs800pumpaggr20 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_acs800	pwr_acs80087;
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800pumpaggr20( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr20( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    JopSpider.setSystemName( "‰7ò∑D¡Ô∑D¡Ô∑póuƒœó∑´ù∑†£ù∑∏_âøÁï∑D¡Ô∑D¡Ô∑xóu†£ù∑");
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr20");
    ...
    pwr_valuelong26.setBorderColor(31);
    ...
    pwr_smallbuttoncenter42.setBounds(new Rectangle(34,172,46,19));
    ...
    pwr_indround43.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround48.setBounds(new Rectangle(193,174,16,15));
    ...
    grp221_75.setBounds(new Rectangle(35,480,38,15));
    ...
    pwr_smallbuttoncenter81.setBounds(new Rectangle(34,197,46,19));
    ...
    pwr_acs80087 = new pwr_acs800(session);
    pwr_acs80087.setBounds(new Rectangle(256,392,62,82));
    pwr_acs80087.setShadow(1);
    localPanel.add(pwr_acs80087, new Proportion(pwr_acs80087.getBounds(), dsize));
    pwr_mbup88 = new pwr_mbup(session);
    pwr_mbup88.setBounds(new Rectangle(346,25,17,18));
...
null,    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.ACS800.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.ACS800.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.ACS800.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu238,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "open graph /class /inst=$object.ACS800.RefSpeed")
      }),
...
null,null,    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.ACS800")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indround48.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround48.dd, "$object.ACS800.ConvertRun##Boolean",29)
      });
    ...
    pwr_indsquare52.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare52.dd, "$object.ACS800.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare52.dd, "$object.ACS800.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare52.dd, "$object.ACS800.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare52.dd, "$object.ACS800.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare52.dd, "$object.ACS800")
      });
    ...
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.ACS800.OpReset##Boolean")
      });
    ...
    pwr_valuemedium58.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium58.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium58.dd, "$object.ACS800.ActSpeed")
      });
    ...
    pwr_valuemedium59.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium59.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium59.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium61.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium61.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium68.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium68.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium68.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_pumpanim277.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim277.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim277.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim277.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    pwr_rodcouplinganim79.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim79.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
    ...
    pwr_acs80087.dd.setDynType(1);
    pwr_acs80087.dd.setActionType(66);
    pwr_acs80087.dd.setAccess(65535);
    pwr_acs80087.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80087.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80087.dd, "open graph /class/instance=$object.ACS800")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.37535F, 22.7708F, 404.413F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.37535F,45.2013F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.37535F,22.7708F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -16}, new int[] { 8, 8, 11,-3}, 4),
    ...
    new Polygon( new int[] { 6, 7, -16, -16}, new int[] { 40, 36, -3,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -16}, new int[] { 46, 46, 54,-3}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128384, -16}, new int[] { 10, 12, -1220128371,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 148561287, -16}, new int[] { 14, 17, 144052700,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 146398377, 1}, new int[] { 12, 15, 144052730,26}, 4),
...
protected class pwr_acs800 extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,20F,17.1346F,24F,40F, false,34, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[6]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
