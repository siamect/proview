...
public class JopcAbb_acs800pumpaggr20 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter42.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_indround43.setBounds(new Rectangle(87,173,18,17));
    ...
    pwr_indround48.setBounds(new Rectangle(192,173,18,17));
    ...
    grp221_75.setBounds(new Rectangle(34,479,40,17));
    ...
    pwr_smallbuttoncenter81.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_acs80087.setBounds(new Rectangle(255,391,64,84));
    ...
    pwr_mbup88.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808896, -16}, new int[] { 10, 12, -1219808883,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893303, -16}, new int[] { 14, 17, 144131284,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 1, 1}, new int[] { 12, 15, 83,26}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 1, 1}, new int[] { 12, 15, 507,26}, 4),
