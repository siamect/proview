...
public class JopcAbb_acs800pumpaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,554,48,21));
    ...
    pwr_safetyswitch29.setBounds(new Rectangle(198,387,38,39));
    ...
    pwr_motor242.setBounds(new Rectangle(160,453,98,74));
    ...
    pwr_indsquare51.setBounds(new Rectangle(161,303,16,17));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(36,322,57,23));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,463,51,17));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,481,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(358,466,20,14));
    ...
    grp210_64.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,499,51,17));
    ...
    pwr_indsquare72.setBounds(new Rectangle(161,428,16,17));
    ...
    grp223_73.setBounds(new Rectangle(34,427,40,18));
    ...
    pwr_pump376.setBounds(new Rectangle(77,454,84,74));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -43, -43}, new int[] { 40, 36, 15,15}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219808923, -43}, new int[] { 10, 14, -1219808864,15}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893276, -43}, new int[] { 14, 18, 144131303,15}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -25, -25}, new int[] { 12, 15, 486,45}, 4),
