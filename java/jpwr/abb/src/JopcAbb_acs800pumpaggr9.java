...
public class JopcAbb_acs800pumpaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump375.setBounds(new Rectangle(77,454,84,74));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(154,480,12,22));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 39, -2}, new int[] { 14, 17, 9,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 145642599, 15}, new int[] { 12, 15, 144057526,38}, 4),
