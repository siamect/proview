...
public class JopcAbb_acs800pumpaggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup83;
  public JopcAbb_acs800pumpaggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr9");
    ...
    pwr_pump375.setBounds(new Rectangle(78,455,82,72));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(155,481,10,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 22, -2}, new int[] { 40, 36, -1220128359,8}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128370, -2}, new int[] { 10, 12, -1220128359,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128370, -2}, new int[] { 14, 17, -1220128359,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 15, 15}, new int[] { 12, 15, 38,38}, 4),
