...
public class JopcAbb_acs800motoraggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch29.setBounds(new Rectangle(198,434,38,39));
    ...
    pwr_motor242.setBounds(new Rectangle(160,500,98,74));
    ...
    pwr_indsquare51.setBounds(new Rectangle(161,350,16,16));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(36,369,57,23));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,510,51,17));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,528,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(358,513,20,14));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(308,546,51,17));
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(154,527,12,22));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,475,16,16));
    ...
    pwr_smallbuttoncenter77.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_acs80081.setBounds(new Rectangle(255,340,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808860, 19}, new int[] { 12, 15, -1219808826,53}, 4),
