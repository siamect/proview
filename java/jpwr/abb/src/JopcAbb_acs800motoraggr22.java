...
public class JopcAbb_acs800motoraggr22 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch28.setBounds(new Rectangle(198,432,39,41));
    ...
    grp227_78.setBounds(new Rectangle(36,196,43,18));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 288F, 422F, 288F, 493F),
