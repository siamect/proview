...
public class JopcAbb_acs800motoraggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,296,16,17));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(154,518,12,22));
    ...
    pwr_indsquare80.setBounds(new Rectangle(161,466,16,16));
