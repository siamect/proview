...
public class JopcAbb_acs800motoraggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(154,518,12,22));
    ...
    pwr_indsquare78.setBounds(new Rectangle(161,466,16,16));
    ...
    grp223_79.setBounds(new Rectangle(34,465,40,18));
    ...
    pwr_manswitch385.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_contactor286.setBounds(new Rectangle(267,332,38,38));
    ...
    pwr_acs80087.setBounds(new Rectangle(255,381,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808846, 33}, new int[] { 12, 15, -1219808824,55}, 4),
