...
public class JopcAbb_acs800motoraggr12 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcAbb_acs800motoraggr12( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr12( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr12");
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,351,16,17));
    ...
    pwr_indsquare83.setBounds(new Rectangle(161,571,16,16));
