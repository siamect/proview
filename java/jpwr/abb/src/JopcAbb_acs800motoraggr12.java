...
public class JopcAbb_acs800motoraggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(161,397,16,17));
    ...
    pwr_indsquare12.setBounds(new Rectangle(161,542,16,16));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(4,697,48,20));
    ...
    pwr_valuelong30.setBounds(new Rectangle(60,696,336,23));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(301,229,72,18));
    ...
    pwr_motor245.setBounds(new Rectangle(160,596,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(161,446,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(36,465,57,23));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(308,606,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(308,624,51,17));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(358,609,20,14));
    ...
    grp210_70.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_valuemedium72.setBounds(new Rectangle(308,642,51,17));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(154,623,12,22));
    ...
    pwr_indsquare80.setBounds(new Rectangle(161,571,16,17));
    ...
    pwr_manswitch390.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_contactor291.setBounds(new Rectangle(267,387,38,38));
    ...
    pwr_acs80092.setBounds(new Rectangle(255,436,64,84));
    ...
    pwr_safetyswitch93.setBounds(new Rectangle(268,532,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808896, -16}, new int[] { 12, 15, -1219808864,15}, 4),
