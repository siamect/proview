...
public class JopcAbb_acs800fanaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim276.setBounds(new Rectangle(113,95,64,44));
    ...
    pwr_rod77.setBounds(new Rectangle(131,528,39,10));
    ...
    pwr_fananim78.setBounds(new Rectangle(119,488,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 6, 6}, new int[] { 12, 15, 55,55}, 4),
