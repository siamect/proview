...
public class JopcAbb_acs800fanaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare78.setBounds(new Rectangle(161,571,16,17));
    ...
    grp223_79.setBounds(new Rectangle(34,570,40,17));
    ...
    pwr_rod82.setBounds(new Rectangle(132,628,39,10));
    ...
    pwr_fananim83.setBounds(new Rectangle(120,588,19,91));
    ...
    grp229_84.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_fuse391.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_manswitch392.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_contactor293.setBounds(new Rectangle(267,387,38,38));
    ...
    pwr_acs80094.setBounds(new Rectangle(255,436,64,84));
    ...
    pwr_safetyswitch95.setBounds(new Rectangle(268,532,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808895, -15}, new int[] { 12, 15, -1219808824,55}, 4),
