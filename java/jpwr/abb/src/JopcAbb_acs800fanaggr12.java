...
public class JopcAbb_acs800fanaggr12 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare78.setBounds(new Rectangle(162,572,14,15));
    ...
    grp223_79.setBounds(new Rectangle(35,571,38,15));
    ...
    pwr_rod82.setBounds(new Rectangle(133,629,37,8));
    ...
    pwr_fananim83.setBounds(new Rectangle(121,589,17,89));
    pwr_fananim83.setShadow(1);
    localPanel.add(pwr_fananim83, new Proportion(pwr_fananim83.getBounds(), dsize));
    grp229_84 = new Grp229_(session);
    grp229_84.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp229_84, new Proportion(grp229_84.getBounds(), dsize));
    ...
    pwr_fuse391.setBounds(new Rectangle(281,295,13,35));
    ...
    pwr_manswitch392.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_contactor293.setBounds(new Rectangle(268,388,36,36));
    ...
    pwr_acs80094.setBounds(new Rectangle(256,437,62,82));
    ...
    pwr_safetyswitch95.setBounds(new Rectangle(269,533,36,37));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp229_84.dd.setDynType(129);
    grp229_84.dd.setActionType(0);
    grp229_84.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_84.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 4194292, -15}, new int[] { 12, 15, 55,55}, 4),
