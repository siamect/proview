...
public class JopcAbb_acs800motoraggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor285;
  pwr_acs800	pwr_acs80086;
  pwr_safetyswitch	pwr_safetyswitch87;
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800motoraggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr6");
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(155,523,10,20));
    ...
    pwr_indsquare78.setBounds(new Rectangle(162,471,14,14));
    ...
    grp223_79.setBounds(new Rectangle(35,470,38,16));
    ...
    pwr_contactor285 = new pwr_contactor2(session);
    pwr_contactor285.setBounds(new Rectangle(268,287,36,36));
    pwr_contactor285.setFillColor(32);
    pwr_contactor285.setShadow(1);
    localPanel.add(pwr_contactor285, new Proportion(pwr_contactor285.getBounds(), dsize));
    pwr_acs80086 = new pwr_acs800(session);
    pwr_acs80086.setBounds(new Rectangle(256,336,62,82));
    pwr_acs80086.setShadow(1);
    localPanel.add(pwr_acs80086, new Proportion(pwr_acs80086.getBounds(), dsize));
    pwr_safetyswitch87 = new pwr_safetyswitch(session);
    pwr_safetyswitch87.setBounds(new Rectangle(269,432,36,37));
    pwr_safetyswitch87.setFillColor(32);
    pwr_safetyswitch87.setShadow(1);
    localPanel.add(pwr_safetyswitch87, new Proportion(pwr_safetyswitch87.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman77.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman77.dd, "$object.ACS800.ConvertRun##Boolean",37)
    ...
    pwr_contactor285.dd.setDynType(32769);
    pwr_contactor285.dd.setActionType(66);
    pwr_contactor285.dd.setAccess(65535);
    pwr_contactor285.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor285.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor285.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor285.dd, "open graph /class/instance=$object.Contactor")
      });
    ...
    pwr_safetyswitch87.dd.setDynType(32769);
    pwr_safetyswitch87.dd.setActionType(66);
    pwr_safetyswitch87.dd.setAccess(65535);
    pwr_safetyswitch87.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch87.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch87.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch87.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128322, 45}, new int[] { 12, 15, -1220128313,54}, 4),
