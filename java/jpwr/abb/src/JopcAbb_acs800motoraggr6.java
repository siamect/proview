...
public class JopcAbb_acs800motoraggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(154,522,12,22));
    ...
    grp223_79.setBounds(new Rectangle(34,469,40,18));
    ...
    pwr_contactor285.setBounds(new Rectangle(267,286,38,38));
    ...
    pwr_acs80086.setBounds(new Rectangle(255,335,64,84));
    ...
    pwr_safetyswitch87.setBounds(new Rectangle(268,431,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808834, 45}, new int[] { 12, 15, -1219808825,54}, 4),
