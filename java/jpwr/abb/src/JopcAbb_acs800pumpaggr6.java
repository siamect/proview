...
public class JopcAbb_acs800pumpaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,523,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,508,20,14));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(308,541,51,17));
    ...
    pwr_pump380.setBounds(new Rectangle(77,496,84,74));
    ...
    pwr_contactor287.setBounds(new Rectangle(267,286,38,38));
    ...
    pwr_acs80088.setBounds(new Rectangle(255,335,64,84));
    ...
    pwr_safetyswitch89.setBounds(new Rectangle(268,431,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808896, -16}, new int[] { 10, 12, -1219808871,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 148799647, -16}, new int[] { 14, 17, 145495352,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808878, 1}, new int[] { 12, 15, -1219808841,38}, 4),
