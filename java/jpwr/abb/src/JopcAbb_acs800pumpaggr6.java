...
public class JopcAbb_acs800pumpaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800pumpaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr6");
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,524,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,509,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,542,49,15));
    ...
    pwr_pump380.setBounds(new Rectangle(78,497,82,72));
    ...
    pwr_contactor287.setBounds(new Rectangle(268,287,36,36));
    ...
    pwr_acs80088.setBounds(new Rectangle(256,336,62,82));
    ...
    pwr_safetyswitch89.setBounds(new Rectangle(269,432,36,37));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 537);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 537);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 555);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 555);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -16}, new int[] { 8, 8, 11,8}, 4),
    ...
    new Polygon( new int[] { 6, 7, -16, -16}, new int[] { 40, 36, 8,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -16}, new int[] { 46, 46, 54,8}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128384, -16}, new int[] { 10, 12, -1220128359,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, -16, -16}, new int[] { 14, 17, 8,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128366, 1}, new int[] { 12, 15, -1220128329,38}, 4),
