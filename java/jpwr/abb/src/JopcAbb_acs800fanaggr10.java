...
public class JopcAbb_acs800fanaggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_73;
  pwr_fananim2	pwr_fananim275;
  pwr_rod	pwr_rod76;
  pwr_fananim	pwr_fananim77;
  Grp229_	grp229_78;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter79;
  pwr_acs800	pwr_acs80081;
  pwr_mbup	pwr_mbup82;
  public JopcAbb_acs800fanaggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr10");
    ...
    pwr_valuesmall34.setBounds(new Rectangle(302,230,70,16));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(34,172,45,19));
    ...
    pwr_fananim275 = new pwr_fananim2(session);
    pwr_fananim275.setBounds(new Rectangle(118,96,62,42));
    pwr_fananim275.setBorderColor(29);
    pwr_fananim275.setTextColor(0);
    pwr_fananim275.setShadow(1);
    pwr_fananim275.setGradient(12);
    localPanel.add(pwr_fananim275, new Proportion(pwr_fananim275.getBounds(), dsize));
    pwr_rod76 = new pwr_rod(session);
    pwr_rod76.setBounds(new Rectangle(132,486,37,8));
    pwr_rod76.setShadow(1);
    localPanel.add(pwr_rod76, new Proportion(pwr_rod76.getBounds(), dsize));
    pwr_fananim77 = new pwr_fananim(session);
    pwr_fananim77.setBounds(new Rectangle(120,446,17,89));
    pwr_fananim77.setShadow(1);
    localPanel.add(pwr_fananim77, new Proportion(pwr_fananim77.getBounds(), dsize));
    ...
    pwr_smallbuttoncenter79.setBounds(new Rectangle(34,197,45,19));
    ...
    pwr_mbup82.setBounds(new Rectangle(346,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim275.dd.setDynType(66612);
    pwr_fananim275.dd.setActionType(0);
    pwr_fananim275.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim275.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim275.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim275.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim275.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim275.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_fananim275.setAnnot1("L");
    pwr_rod76.dd.setDynType(1);
    pwr_rod76.dd.setActionType(0);
    pwr_fananim77.dd.setDynType(65537);
    pwr_fananim77.dd.setActionType(66);
    pwr_fananim77.dd.setAccess(65532);
    pwr_fananim77.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim77.dd, "$object.ACS800.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim77.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim77.dd, "open graph/class/inst=$object.Fan")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(42F, 113F, 196F, 7F),
    new Polygon( new int[] { 42, 238, 236, 44, 44, 42}, new int[] { 113, 113, 115, 115, 118, 120}, 6), 
    new Polygon( new int[] { 238, 238, 236, 236, 44, 42}, new int[] { 120, 113, 115, 118, 118, 120}, 6), 
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128330, 37}, new int[] { 12, 15, -1220128346,21}, 4),
