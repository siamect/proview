...
public class JopcAbb_acs800fanaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuesmall34.setBounds(new Rectangle(301,229,72,18));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_fananim275.setBounds(new Rectangle(117,95,64,44));
    ...
    pwr_rod76.setBounds(new Rectangle(131,485,39,10));
    ...
    pwr_fananim77.setBounds(new Rectangle(119,445,19,91));
    ...
    pwr_smallbuttoncenter79.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_mbup82.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808842, 37}, new int[] { 12, 15, -1219808858,21}, 4),
