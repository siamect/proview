...
public class JopcAbb_acs800motoraggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(152,577,12,22));
    ...
    pwr_motorman78.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare79.setBounds(new Rectangle(161,525,16,17));
    ...
    pwr_smallbuttoncenter82.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_contactor288.setBounds(new Rectangle(267,341,38,38));
    ...
    pwr_acs80089.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 52, 52}, new int[] { 12, 15, 60,35}, 4),
