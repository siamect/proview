...
public class JopcAbb_acs800motoraggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(152,577,12,22));
    ...
    pwr_motorman79.setBounds(new Rectangle(114,95,64,43));
    ...
    pwr_indsquare80.setBounds(new Rectangle(161,525,16,16));
    ...
    grp221_81.setBounds(new Rectangle(34,524,38,18));
    localPanel.add(grp221_81, new Proportion(grp221_81.getBounds(), dsize));
    pwr_fuse383 = new pwr_fuse3(session);
    pwr_fuse383.setBounds(new Rectangle(279,296,15,37));
    pwr_fuse383.setRotate(-90);
    pwr_fuse383.setShadow(1);
    localPanel.add(pwr_fuse383, new Proportion(pwr_fuse383.getBounds(), dsize));
    grp224_84 = new Grp224_(session);
    grp224_84.setBounds(new Rectangle(36,196,43,18));
    localPanel.add(grp224_84, new Proportion(grp224_84.getBounds(), dsize));
    jopSmallbutton85 = new JopSmallbutton(session);
    jopSmallbutton85.setBounds(new Rectangle(33,196,47,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp224_84.dd.setDynType(129);
    grp224_84.dd.setActionType(0);
    grp224_84.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp224_84.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
