...
public class JopcAbb_acs800motoraggr19 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motorman	pwr_motorman78;
  pwr_indsquare	pwr_indsquare79;
  Grp221_	grp221_80;
  Grp224_	grp224_81;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter82;
  pwr_fuse3	pwr_fuse387;
  pwr_contactor2	pwr_contactor288;
  pwr_acs800	pwr_acs80089;
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800motoraggr19( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr19( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr19");
    ...
    pwr_valuelong9.setBorderColor(31);
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(34,172,45,19));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(153,578,10,20));
    localPanel.add(pwr_rodcouplinganim77, new Proportion(pwr_rodcouplinganim77.getBounds(), dsize));
    pwr_motorman78 = new pwr_motorman(session);
    pwr_motorman78.setBounds(new Rectangle(115,96,62,42));
    pwr_motorman78.setShadow(1);
    pwr_motorman78.setGradient(12);
    localPanel.add(pwr_motorman78, new Proportion(pwr_motorman78.getBounds(), dsize));
    pwr_indsquare79 = new pwr_indsquare(session);
    pwr_indsquare79.setBounds(new Rectangle(162,526,14,15));
    ...
    grp221_80.setBounds(new Rectangle(35,525,37,16));
    localPanel.add(grp221_80, new Proportion(grp221_80.getBounds(), dsize));
    grp224_81 = new Grp224_(session);
    grp224_81.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp224_81, new Proportion(grp224_81.getBounds(), dsize));
    pwr_smallbuttoncenter82 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter82.setBounds(new Rectangle(34,197,45,19));
    pwr_smallbuttoncenter82.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter82, new Proportion(pwr_smallbuttoncenter82.getBounds(), dsize));
    ...
    pwr_contactor288.setBounds(new Rectangle(268,342,36,36));
    ...
    pwr_acs80089.setBounds(new Rectangle(256,391,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman78.dd.setDynType(1077);
    pwr_motorman78.dd.setActionType(0);
    pwr_motorman78.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman78.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman78.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman78.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_motorman78.dd, "$object.Mode.IndMode##String8","%s")
      });
    ...
    grp224_81.dd.setDynType(129);
    grp224_81.dd.setActionType(0);
    grp224_81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp224_81.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    pwr_smallbuttoncenter82.dd.setDynType(129);
    pwr_smallbuttoncenter82.dd.setActionType(6);
    pwr_smallbuttoncenter82.dd.setAccess(65532);
    pwr_smallbuttoncenter82.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter82.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter82.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter82.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter82.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter82.setAnnot1("Auto");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 281.227F, 361.006F, 368.281F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 281, 281, 282, 282, 648, 650}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 650, 281, 282, 648, 648, 650}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),37, 365);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),37, 500);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),37, 412);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Power/Contactor"),245, 160);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[14]);
    ...
    g.drawString( JopLang.transl("%"),362, 592);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),263, 592);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),263, 574);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),362, 610);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),263, 610);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),290, 212);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[16]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 52, 52}, new int[] { 12, 15, 516,35}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 52, 52}, new int[] { 12, 15, 476,35}, 4),
