...
public class JopcAbb_acc800 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_acs80069.setBounds(new Rectangle(655,88,64,84));
    ...
    pwr_indsquare78.setBounds(new Rectangle(486,200,16,17));
    ...
    pwr_valuelong79.setBounds(new Rectangle(512,198,275,22));
    ...
    pwr_smallbuttoncenter80.setBounds(new Rectangle(677,25,58,21));
    ...
    pwr_mbsimulate81.setBounds(new Rectangle(771,24,20,20));
    ...
    pwr_valuemedium82.setBounds(new Rectangle(187,313,28,18));
    ...
    pwr_valuemedium83.setBounds(new Rectangle(187,339,28,18));
    ...
    pwr_mbup84.setBounds(new Rectangle(751,24,20,20));
