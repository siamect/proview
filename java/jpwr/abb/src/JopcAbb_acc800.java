...
public class JopcAbb_acc800 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_acs800	pwr_acs80069;
  pwr_indsquare	pwr_indsquare78;
  pwr_valuelong	pwr_valuelong79;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter80;
  pwr_mbsimulate	pwr_mbsimulate81;
  pwr_valuemedium	pwr_valuemedium82;
  pwr_valuemedium	pwr_valuemedium83;
  pwr_mbup	pwr_mbup84;
  public JopcAbb_acc800( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acc800( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare32.setFillColor(33);
    pwr_indsquare32.setBorderColor(35);
    ...
    pwr_acs80069 = new pwr_acs800(session);
    pwr_acs80069.setBounds(new Rectangle(656,89,62,82));
    pwr_acs80069.setShadow(1);
    localPanel.add(pwr_acs80069, new Proportion(pwr_acs80069.getBounds(), dsize));
    pwr_indsquare78 = new pwr_indsquare(session);
    pwr_indsquare78.setBounds(new Rectangle(487,201,14,15));
    pwr_indsquare78.setFillColor(295);
    ...
    pwr_valuelong79.setBounds(new Rectangle(513,199,273,20));
    pwr_valuelong79.setFillColor(31);
    pwr_valuelong79.setBorderColor(32);
    ...
    pwr_smallbuttoncenter80.setBounds(new Rectangle(678,26,56,19));
    pwr_smallbuttoncenter80.setFillColor(33);
    localPanel.add(pwr_smallbuttoncenter80, new Proportion(pwr_smallbuttoncenter80.getBounds(), dsize));
    pwr_mbsimulate81 = new pwr_mbsimulate(session);
    pwr_mbsimulate81.setBounds(new Rectangle(772,25,18,18));
    localPanel.add(pwr_mbsimulate81, new Proportion(pwr_mbsimulate81.getBounds(), dsize));
    pwr_valuemedium82 = new pwr_valuemedium(session);
    pwr_valuemedium82.setBounds(new Rectangle(188,314,26,16));
    ...
    pwr_valuemedium83 = new pwr_valuemedium(session);
    pwr_valuemedium83.setBounds(new Rectangle(188,340,26,16));
    pwr_valuemedium83.setFillColor(31);
    pwr_valuemedium83.setBorderColor(31);
    localPanel.add(pwr_valuemedium83, new Proportion(pwr_valuemedium83.getBounds(), dsize));
    pwr_mbup84 = new pwr_mbup(session);
    pwr_mbup84.setBounds(new Rectangle(752,25,18,18));
    ...
    pwr_valuelong19.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong19.dd, "$object.Specification##String80","%s")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare34.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare34.dd, "$object.ConvertFault##Boolean",29)
      });
    ...
    pwr_acs80069.dd.setDynType(1);
    pwr_acs80069.dd.setActionType(0);
    pwr_indsquare78.dd.setDynType(33554432);
    pwr_indsquare78.dd.setActionType(0);
    pwr_indsquare78.dd.setElements(new GeDynElemIfc[] {
      new GeDynStatusColor(pwr_indsquare78.dd, "$object.IoStatus##Status",58)
      });
    pwr_valuelong79.dd.setDynType(1025);
    pwr_valuelong79.dd.setActionType(0);
    pwr_valuelong79.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong79.dd, "$object.IoStatus##Status","%1m")
      });
    pwr_smallbuttoncenter80.dd.setDynType(1);
    pwr_smallbuttoncenter80.dd.setActionType(64);
    pwr_smallbuttoncenter80.dd.setAccess(33619964);
    pwr_smallbuttoncenter80.dd.setElements(new GeDynElemIfc[] {
      new GeDynCommand(pwr_smallbuttoncenter80.dd, "open graph pwr_c_abb_acs800_1param/inst=$object")
      });
    pwr_smallbuttoncenter80.setAnnot1("More...");
    pwr_mbsimulate81.dd.setDynType(129);
    pwr_mbsimulate81.dd.setActionType(8256);
    pwr_mbsimulate81.dd.setAccess(65532);
    pwr_mbsimulate81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate81.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate81.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate81.dd, JopLang.transl("Open simulate graph"))
      });
    ...
    pwr_valuemedium83.dd.setDynType(1025);
    pwr_valuemedium83.dd.setActionType(0);
    pwr_valuemedium83.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium83.dd, "$object.ActSpeed.Unit##String16","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.33706F, 23.1001F, 795.667F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.33706F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.33706F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.drawString( JopLang.transl("Status"),190, 152);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Ready"),513, 77);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Run"),513, 97);
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Tripped"),513, 186);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch-On inhibit"),513, 117);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Warning"),513, 136);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Local control"),513, 155);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Status"),417, 111);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SetValue"),30, 356);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("ActualValue"),30, 329);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Moment"),30, 495);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Current"),30, 519);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("A"),197, 519);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),195, 495);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("0"),775, 578);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("100"),291, 578);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Speed"),29, 257);
    {
    int fcolor = GeColor.getDrawtype(102, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.getColor( fcolor));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Bus com"),417, 214);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
