...
public class JopcAbb_acs800motoraggr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp221_	grp221_84;
  Grp223_	grp223_85;
  JopSmallbutton	jopSmallbutton86;
  public JopcAbb_acs800motoraggr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr1");
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(152,568,12,22));
    ...
    pwr_indsquare83.setBounds(new Rectangle(161,516,16,16));
    ...
    grp221_84.setBounds(new Rectangle(34,515,39,18));
    localPanel.add(grp221_84, new Proportion(grp221_84.getBounds(), dsize));
    grp223_85 = new Grp223_(session);
    grp223_85.setBounds(new Rectangle(36,196,43,18));
    localPanel.add(grp223_85, new Proportion(grp223_85.getBounds(), dsize));
    jopSmallbutton86 = new JopSmallbutton(session);
    jopSmallbutton86.setBounds(new Rectangle(33,196,48,21));
    jopSmallbutton86.setFillColor(32);
    localPanel.add(jopSmallbutton86, new Proportion(jopSmallbutton86.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp223_85.dd.setDynType(129);
    grp223_85.dd.setActionType(0);
    grp223_85.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_85.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    jopSmallbutton86.dd.setDynType(129);
    jopSmallbutton86.dd.setActionType(6);
    jopSmallbutton86.dd.setAccess(65532);
    jopSmallbutton86.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton86.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton86.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton86.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(jopSmallbutton86.dd, "$object.Mode.OpAuto##Boolean")
      });
    jopSmallbutton86.setAnnot1(" Auto");
