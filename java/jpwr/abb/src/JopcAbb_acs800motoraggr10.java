...
public class JopcAbb_acs800motoraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim72.setBounds(new Rectangle(154,480,12,21));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,428,16,17));
    ...
    pwr_smallbuttoncenter77.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_mbup80.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808847, 32}, new int[] { 12, 15, -1219808825,54}, 4),
