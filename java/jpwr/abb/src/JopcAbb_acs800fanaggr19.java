...
public class JopcAbb_acs800fanaggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod81.setBounds(new Rectangle(128,582,39,10));
    ...
    pwr_fananim82.setBounds(new Rectangle(116,542,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808857, 22}, new int[] { 12, 15, -1219808857,22}, 4),
