...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim273.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_fananim273.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim273.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim273.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    pwr_fananim75.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim75.dd, "$object.ACS800.ConvertRun##Boolean",1)
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808877, 2}, new int[] { 12, 15, -1219808827,52}, 4),
