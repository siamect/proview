...
public class JopcAbb_acs800fanaggr1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbnote26.setBounds(new Rectangle(35,24,20,20));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(4,642,48,20));
    ...
    grp210_71.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_rod83.setBounds(new Rectangle(125,573,39,10));
    ...
    pwr_fananim84.setBounds(new Rectangle(113,533,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140859218, -21}, new int[] { 12, 15, 146494404,60}, 4),
