...
public class JopcAbb_acs800fanaggr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup94;
  public JopcAbb_acs800fanaggr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr1");
    ...
    pwr_mbnote26.setBounds(new Rectangle(36,25,18,18));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(5,643,46,18));
    ...
    pwr_rod83.setBounds(new Rectangle(126,574,37,8));
    ...
    pwr_fananim84.setBounds(new Rectangle(114,534,17,89));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 96, 95, 95, 96}, new int[] { 14, 17, 60,60}, 4),
    new Polygon( new int[] { 96, 95, 92, 92}, new int[] { 60, 60, 61,62}, 4),
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, -1220128389, -21}, new int[] { 12, 15, -1220128307,60}, 4),
