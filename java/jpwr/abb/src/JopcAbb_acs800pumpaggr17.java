...
public class JopcAbb_acs800pumpaggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,603,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,602,336,23));
    ...
    pwr_motor241.setBounds(new Rectangle(158,502,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,400,16,16));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,419,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(306,512,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(306,530,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(356,515,20,14));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(306,548,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,477,16,17));
    ...
    grp221_72.setBounds(new Rectangle(34,476,40,17));
    ...
    pwr_pump375.setBounds(new Rectangle(75,503,84,74));
    ...
    pwr_manswitch383.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_acs80084.setBounds(new Rectangle(255,390,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -1, -1}, new int[] { 40, 36, 10,10}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219808881, -1}, new int[] { 10, 12, -1219808869,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893318, -1}, new int[] { 14, 17, 144131298,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808863, 16}, new int[] { 12, 15, -1219808839,40}, 4),
