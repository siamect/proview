...
public class JopcAbb_acs800pumpaggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup85;
  public JopcAbb_acs800pumpaggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr17");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(162,352,14,15));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,604,45,19));
    ...
    pwr_valuelong26.setBounds(new Rectangle(61,603,334,21));
    ...
    pwr_motor241.setBounds(new Rectangle(159,503,96,72));
    ...
    pwr_indsquare50.setBounds(new Rectangle(162,401,14,14));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(37,420,55,21));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(307,513,49,15));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(307,531,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(357,516,18,12));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(307,549,49,15));
    ...
    pwr_indsquare71.setBounds(new Rectangle(162,478,14,15));
    ...
    grp221_72.setBounds(new Rectangle(35,477,38,15));
    ...
    pwr_pump375.setBounds(new Rectangle(76,504,82,72));
    ...
    pwr_manswitch383.setBounds(new Rectangle(268,340,36,36));
    ...
    pwr_acs80084.setBounds(new Rectangle(256,391,62,82));
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 625;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.763F, 280.202F, 361.003F, 320.231F),
    ...
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {506, 506, 502, 472, 502, 506}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),361, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 544);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 526);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 562);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -1}, new int[] { 8, 10, 11,10}, 4),
    ...
    new Polygon( new int[] { 6, 7, 31, -1}, new int[] { 40, 36, -1220128357,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -1}, new int[] { 46, 46, 54,10}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128369, -1}, new int[] { 10, 12, -1220128357,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128369, -1}, new int[] { 14, 17, -1220128357,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128351, 16}, new int[] { 12, 15, -1220128327,40}, 4),
