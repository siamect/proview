...
public class JopcAbb_acs800pumpaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,442,16,17));
    ...
    pwr_motor243.setBounds(new Rectangle(160,496,98,74));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(36,365,57,23));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(308,506,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(308,524,51,17));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(358,509,20,14));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(308,542,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(310,175,16,17));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,471,16,16));
    ...
    grp223_74.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_pump377.setBounds(new Rectangle(77,497,84,74));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(154,523,12,22));
    ...
    pwr_safetyswitch86.setBounds(new Rectangle(268,432,38,39));
    ...
    pwr_mbup87.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808874, 5}, new int[] { 10, 12, -1219808871,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 17, 144131296,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808856, 23}, new int[] { 12, 15, -1219808841,38}, 4),
