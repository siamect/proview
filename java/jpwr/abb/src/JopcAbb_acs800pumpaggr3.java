...
public class JopcAbb_acs800pumpaggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup87;
  public JopcAbb_acs800pumpaggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr3");
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,443,14,15));
    ...
    pwr_motor243.setBounds(new Rectangle(161,497,96,72));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(37,366,55,21));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(309,507,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(309,525,49,15));
    ...
    pwr_valuemedium60.setBounds(new Rectangle(359,510,18,12));
    ...
    pwr_valuemedium67.setBounds(new Rectangle(309,543,49,15));
    ...
    pwr_indsquare71.setBounds(new Rectangle(311,176,14,15));
    ...
    pwr_indsquare73.setBounds(new Rectangle(162,472,14,14));
    ...
    grp223_74.setBounds(new Rectangle(35,471,38,16));
    ...
    pwr_pump377.setBounds(new Rectangle(78,498,82,72));
    ...
    pwr_rodcouplinganim78.setBounds(new Rectangle(155,524,10,20));
    ...
    pwr_safetyswitch86.setBounds(new Rectangle(269,433,36,37));
...
null,null,    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.ACS800.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.ACS800.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.ACS800.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "open graph /class /inst=$object.ACS800.RefSpeed")
      }),
...
null,    new GeDyn(pwr_pulldownmenu242,1,65,65535,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu242,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu242.dd, "open graph /class /inst=$object.ACS800")
      }),
    new GeDyn(pwr_pulldownmenu242,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pumpanim276.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim276.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim276.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim276.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    pwr_rodcouplinganim78.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim78.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 538);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 538);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 556);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 556);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 8, 5, 4, 6}, new int[] { 58, 60, 52,52}, 4),
    new Polygon( new int[] { 6, 4, 4, 6}, new int[] { 52, 52, 8,8}, 4),
    new Polygon( new int[] { 6, 4, 9, 5}, new int[] { 8, 8, 11,8}, 4),
    ...
    new Polygon( new int[] { 6, 7, 5, 5}, new int[] { 40, 36, 8,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 5}, new int[] { 46, 46, 54,8}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128362, 5}, new int[] { 10, 12, -1220128359,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893325, 5}, new int[] { 14, 17, 144126176,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128344, 23}, new int[] { 12, 15, -1220128329,38}, 4),
