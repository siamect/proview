...
public class JopcAbb_acs800pumpaggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motor2	pwr_motor242;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter43;
  ...
  pwr_valuemedium	pwr_valuemedium57;
  pwr_valuemedium	pwr_valuemedium59;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd63;
  Grp210_	grp210_64;
  Grp212_	grp212_65;
  ...
  Grp223_	grp223_73;
  pwr_pumpanim2	pwr_pumpanim275;
  pwr_pump3	pwr_pump376;
  pwr_rodcouplinganim	pwr_rodcouplinganim77;
  Grp229_	grp229_78;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter79;
  pwr_fuse3	pwr_fuse382;
  pwr_acs800	pwr_acs80083;
  pwr_mbup	pwr_mbup84;
  public JopcAbb_acs800pumpaggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr22");
    ...
    pwr_safetyswitch29 = new pwr_safetyswitch(session);
    pwr_safetyswitch29.setBounds(new Rectangle(199,436,36,37));
    pwr_safetyswitch29.setFillColor(32);
    pwr_safetyswitch29.setShadow(1);
    localPanel.add(pwr_safetyswitch29, new Proportion(pwr_safetyswitch29.getBounds(), dsize));
    pwr_indsquare31 = new pwr_indsquare(session);
    pwr_indsquare31.setBounds(new Rectangle(349,118,14,15));
    pwr_indsquare31.setFillColor(175);
    ...
    pwr_valuesmall34.setBounds(new Rectangle(302,230,70,15));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(302,249,70,16));
    localPanel.add(pwr_valuesmall35, new Proportion(pwr_valuesmall35.getBounds(), dsize));
    pwr_menubar236 = new pwr_menubar2(session);
    pwr_menubar236.setBounds(new Rectangle(1,1,407,22));
    pwr_menubar236.setShadow(1);
    localPanel.add(pwr_menubar236, new Proportion(pwr_menubar236.getBounds(), dsize));
    pwr_pulldownmenu237 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu237.setBounds(new Rectangle(9,1,42,22));
    ...
    pwr_pulldownmenu238.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu239.setBounds(new Rectangle(221,1,67,22));
    ...
    pwr_pulldownmenu240.setBounds(new Rectangle(53,1,67,22));
    ...
    pwr_pulldownmenu241.setBounds(new Rectangle(125,1,86,22));
    pwr_pulldownmenu241.setShadow(1);
    localPanel.add(pwr_pulldownmenu241, new Proportion(pwr_pulldownmenu241.getBounds(), dsize));
    pwr_motor242 = new pwr_motor2(session);
    pwr_motor242.setBounds(new Rectangle(161,502,96,72));
    localPanel.add(pwr_motor242, new Proportion(pwr_motor242.getBounds(), dsize));
    pwr_smallbuttoncenter43 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter43.setBounds(new Rectangle(34,172,46,19));
    pwr_smallbuttoncenter43.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter43, new Proportion(pwr_smallbuttoncenter43.getBounds(), dsize));
    pwr_indround44 = new pwr_indround(session);
    pwr_indround44.setBounds(new Rectangle(88,174,16,15));
    ...
    pwr_indround45.setBounds(new Rectangle(88,197,16,16));
    ...
    pwr_smallbuttoncenter46.setBounds(new Rectangle(124,173,59,19));
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(124,197,59,19));
    ...
    pwr_indround48.setBounds(new Rectangle(86,248,16,15));
    pwr_indround48.setFillColor(114);
    ...
    pwr_indround49.setBounds(new Rectangle(193,174,16,15));
    pwr_indround49.setFillColor(294);
    pwr_indround49.setShadow(1);
    localPanel.add(pwr_indround49, new Proportion(pwr_indround49.getBounds(), dsize));
    grp169_50 = new Grp169_(session);
    grp169_50.setBounds(new Rectangle(35,249,35,16));
    localPanel.add(grp169_50, new Proportion(grp169_50.getBounds(), dsize));
    pwr_indsquare51 = new pwr_indsquare(session);
    pwr_indsquare51.setBounds(new Rectangle(162,352,14,14));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(37,371,55,21));
    pwr_smallbuttoncenter55.setFillColor(32);
    pwr_smallbuttoncenter55.setShadow(1);
    ...
    pwr_valuemedium56.setBounds(new Rectangle(309,512,49,15));
    ...
    pwr_valuemedium57.setBounds(new Rectangle(309,530,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(359,515,18,12));
    ...
    pwr_valueinputmediumrd63 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd63.setBounds(new Rectangle(123,242,75,28));
    pwr_valueinputmediumrd63.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd63, new Proportion(pwr_valueinputmediumrd63.getBounds(), dsize));
    grp210_64 = new Grp210_(session);
    grp210_64.setBounds(new Rectangle(127,228,38,16));
    localPanel.add(grp210_64, new Proportion(grp210_64.getBounds(), dsize));
    grp212_65 = new Grp212_(session);
    grp212_65.setBounds(new Rectangle(199,247,26,18));
    grp212_65.setFillColor(31);
    grp212_65.setBorderColor(31);
    localPanel.add(grp212_65, new Proportion(grp212_65.getBounds(), dsize));
    pwr_valuemedium66 = new pwr_valuemedium(session);
    pwr_valuemedium66.setBounds(new Rectangle(309,548,49,15));
    ...
    pwr_indsquare70.setBounds(new Rectangle(308,176,14,15));
    ...
    pwr_mbsimulate71.setBounds(new Rectangle(366,25,17,18));
    localPanel.add(pwr_mbsimulate71, new Proportion(pwr_mbsimulate71.getBounds(), dsize));
    pwr_indsquare72 = new pwr_indsquare(session);
    pwr_indsquare72.setBounds(new Rectangle(162,477,14,14));
    pwr_indsquare72.setFillColor(294);
    pwr_indsquare72.setShadow(1);
    localPanel.add(pwr_indsquare72, new Proportion(pwr_indsquare72.getBounds(), dsize));
    grp223_73 = new Grp223_(session);
    grp223_73.setBounds(new Rectangle(35,476,38,16));
    localPanel.add(grp223_73, new Proportion(grp223_73.getBounds(), dsize));
    pwr_pumpanim275 = new pwr_pumpanim2(session);
    pwr_pumpanim275.setBounds(new Rectangle(120,96,62,42));
    pwr_pumpanim275.setShadow(1);
    pwr_pumpanim275.setGradient(12);
    localPanel.add(pwr_pumpanim275, new Proportion(pwr_pumpanim275.getBounds(), dsize));
    pwr_pump376 = new pwr_pump3(session);
    pwr_pump376.setBounds(new Rectangle(78,503,82,72));
    pwr_pump376.setColorTone(7);
    localPanel.add(pwr_pump376, new Proportion(pwr_pump376.getBounds(), dsize));
    pwr_rodcouplinganim77 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim77.setBounds(new Rectangle(155,529,10,20));
    localPanel.add(pwr_rodcouplinganim77, new Proportion(pwr_rodcouplinganim77.getBounds(), dsize));
    grp229_78 = new Grp229_(session);
    grp229_78.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp229_78, new Proportion(grp229_78.getBounds(), dsize));
    pwr_smallbuttoncenter79 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter79.setBounds(new Rectangle(34,197,46,19));
    ...
    pwr_mbup84.setBounds(new Rectangle(346,25,17,18));
    ...
    pwr_safetyswitch29.dd.setDynType(32769);
    pwr_safetyswitch29.dd.setActionType(66);
    pwr_safetyswitch29.dd.setAccess(65535);
    pwr_safetyswitch29.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch29.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch29.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch29.dd, "open graph/class/instance=$object.SafetySwitch")
      });
    pwr_indsquare31.dd.setDynType(5);
    pwr_indsquare31.dd.setActionType(0);
    pwr_indsquare31.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare31.dd, "$object.ExtInterlock##Boolean",29)
      });
    pwr_valuesmall34.dd.setDynType(1025);
    pwr_valuesmall34.dd.setActionType(0);
    pwr_valuesmall34.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall34.dd, "$object.RunTimeCounter.TotalNOfStarts##UInt32","%d")
      });
    pwr_valuesmall35.dd.setDynType(1025);
    pwr_valuesmall35.dd.setActionType(0);
    pwr_valuesmall35.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall35.dd, "$object.RunTimeCounter.TotalRunTime##DeltaTime","%1t")
      });
    pwr_menubar236.dd.setDynType(1);
    pwr_menubar236.dd.setActionType(0);
    pwr_pulldownmenu237.dd.setDynType(0);
    ...
    pwr_pulldownmenu237.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu237.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu237,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu237.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu237.setAnnot1("File");
    pwr_pulldownmenu238.dd.setDynType(1);
    pwr_pulldownmenu238.dd.setActionType(524288);
    pwr_pulldownmenu238.dd.setAccess(65532);
    ...
    new GeDyn(pwr_pulldownmenu238,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu238.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu238.setAnnot1("Help");
    ...
    pwr_pulldownmenu239.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
null,null,null,    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.ACS800.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.ACS800.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.ACS800.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu239,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.ACS800.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu239,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu239.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu239.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu239.setAnnot1("Signals");
    ...
    pwr_pulldownmenu240.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu240.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu240,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu240.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu240.setAnnot1("Methods");
    ...
    pwr_pulldownmenu241.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu241.dd, new String[] {
        JopLang.transl("StartLock"),null,null,JopLang.transl("FrequencyConverter"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
null,null,    new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.ACS800")
      }),
    new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu241.setAnnot1("Components");
    pwr_motor242.dd.setDynType(0);
    pwr_motor242.dd.setActionType(66);
    pwr_motor242.dd.setAccess(65535);
    pwr_motor242.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_motor242.dd, "$object.Motor")
      ,new GeDynCommand(pwr_motor242.dd, "open graph/class/instance=$object.motor")
      });
    pwr_smallbuttoncenter43.dd.setDynType(129);
    pwr_smallbuttoncenter43.dd.setActionType(6);
    pwr_smallbuttoncenter43.dd.setAccess(65532);
    pwr_smallbuttoncenter43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter43.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter43.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter43.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter43.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter43.setAnnot1("Man");
    pwr_indround44.dd.setDynType(133);
    pwr_indround44.dd.setActionType(0);
    pwr_indround44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround44.dd, "$object.Mode.ManAutoHide##Boolean",0)
    ...
    pwr_indround45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround45.dd, "$object.Mode.ExternOrdHide##Boolean",0)
    ...
    pwr_smallbuttoncenter46.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter46.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter46.dd, "$object.MOde.OpManStart##Boolean")
      });
    pwr_smallbuttoncenter46.setAnnot1("Start");
    ...
    pwr_smallbuttoncenter47.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter47.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter47.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter47.setAnnot1("Stop");
    pwr_indround48.dd.setDynType(133);
    pwr_indround48.dd.setActionType(0);
    pwr_indround48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround48.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround48.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    pwr_indround49.dd.setDynType(5);
    pwr_indround49.dd.setActionType(0);
    pwr_indround49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround49.dd, "$object.ACS800.ConvertRun##Boolean",29)
      });
    grp169_50.dd.setDynType(129);
    grp169_50.dd.setActionType(0);
    grp169_50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp169_50.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    pwr_indsquare51.dd.setDynType(117);
    pwr_indsquare51.dd.setActionType(2);
    pwr_indsquare51.dd.setAccess(65532);
    pwr_indsquare51.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare51.dd, "$object.ACS800.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare51.dd, "$object.ACS800.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare51.dd, "$object.ACS800.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare51.dd, "$object.ACS800.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare51.dd, "$object.ACS800")
      });
    pwr_smallbuttoncenter55.dd.setDynType(1);
    pwr_smallbuttoncenter55.dd.setActionType(4);
    pwr_smallbuttoncenter55.dd.setAccess(65532);
    pwr_smallbuttoncenter55.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter55.dd, "$object.ACS800.OpReset##Boolean")
      });
    pwr_smallbuttoncenter55.setAnnot1("Reset");
    pwr_valuemedium56.dd.setDynType(1024);
    ...
    pwr_valuemedium56.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium56.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium56.dd, "$object.ACS800.ActSpeed")
      });
    pwr_valuemedium57.dd.setDynType(1025);
    pwr_valuemedium57.dd.setActionType(2);
    pwr_valuemedium57.dd.setAccess(65532);
    pwr_valuemedium57.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium57.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium57.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium59.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium59.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    pwr_valueinputmediumrd63.dd.setDynType(1153);
    pwr_valueinputmediumrd63.dd.setActionType(4096);
    pwr_valueinputmediumrd63.dd.setAccess(65532);
    pwr_valueinputmediumrd63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputmediumrd63.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynValue(pwr_valueinputmediumrd63.dd, "$object.Mode.OpRefMan##Float32","%9.3f")
      ,new GeDynValueInput(pwr_valueinputmediumrd63.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputmediumrd63.setAnnot1Font(pwr_valueinputmediumrd63.annotFont.deriveFont((float)14));
    grp210_64.dd.setDynType(129);
    grp210_64.dd.setActionType(0);
    grp210_64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp210_64.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    grp212_65.dd.setDynType(129);
    grp212_65.dd.setActionType(0);
    grp212_65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp212_65.dd, "$object.Mode.ManOrdHide##Boolean",0)
      });
    pwr_valuemedium66.dd.setDynType(1025);
    ...
    pwr_valuemedium66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium66.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium66.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_indsquare72.dd.setDynType(176);
    pwr_indsquare72.dd.setActionType(2);
    pwr_indsquare72.dd.setAccess(65532);
    pwr_indsquare72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare72.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare72.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare72.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare72.dd, "$object.Motor")
      });
    grp223_73.dd.setDynType(129);
    grp223_73.dd.setActionType(0);
    grp223_73.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_73.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_pumpanim275.dd.setDynType(66612);
    pwr_pumpanim275.dd.setActionType(0);
    pwr_pumpanim275.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim275.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim275.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim275.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim275.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim275.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_pump376.dd.setDynType(1);
    pwr_pump376.dd.setActionType(66);
    pwr_pump376.dd.setAccess(65532);
    pwr_pump376.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump376.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump376.dd, "open graph/class/inst=$object.Pump")
      });
    pwr_rodcouplinganim77.dd.setDynType(65537);
    pwr_rodcouplinganim77.dd.setActionType(0);
    pwr_rodcouplinganim77.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim77.dd, "$object.ACS800.ConvertRun##Boolean",1)
      });
    grp229_78.dd.setDynType(129);
    grp229_78.dd.setActionType(0);
    grp229_78.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp229_78.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.763F, 280.43F, 361.003F, 320.606F),
    ...
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {506, 506, 502, 424, 502, 506}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("StartLock"),36, 459);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, 0}, new int[] { 8, 10, 13,29}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 7, 7, 6}, new int[] { 40, 36, 26,24}, 4),
    ...
    new Polygon( new int[] { 12, 11, 9, 10}, new int[] { 28, 29, 31,32}, 4),
    new Polygon( new int[] { 10, 9, 7, 6}, new int[] { 32, 31, 36,40}, 4),
    new Polygon( new int[] { 6, 7, 64, 0}, new int[] { 40, 36, -1220128338,29}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 0}, new int[] { 46, 46, 54,29}, 4),
    ...
    new Polygon( new int[] { 54, 56, 147163223, 0}, new int[] { 10, 14, 144052733,29}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128368, 0}, new int[] { 14, 19, -1220128338,29}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128350, 17}, new int[] { 12, 15, -1220128308,59}, 4),
