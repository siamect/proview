...
public class JopcAbb_acs800motoraggr extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_manswitch388.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_contactor289.setBounds(new Rectangle(267,332,38,38));
    ...
    pwr_acs80090.setBounds(new Rectangle(255,381,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808871, 8}, new int[] { 12, 15, -1219808850,29}, 4),
