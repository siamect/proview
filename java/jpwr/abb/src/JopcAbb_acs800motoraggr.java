...
public class JopcAbb_acs800motoraggr extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcAbb_acs800motoraggr( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr");
    ...
    pwr_rodcouplinganim81.setBounds(new Rectangle(154,568,12,22));
