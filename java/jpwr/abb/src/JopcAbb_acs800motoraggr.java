...
public class JopcAbb_acs800motoraggr extends JopFrame implements JopUtilityIfc {
  ...
  pwr_manswitch3	pwr_manswitch388;
  pwr_contactor2	pwr_contactor289;
  pwr_acs800	pwr_acs80090;
  ...
  public void geInit() {
    ...
    pwr_manswitch388 = new pwr_manswitch3(session);
    pwr_manswitch388.setBounds(new Rectangle(268,285,36,36));
    pwr_manswitch388.setFillColor(32);
    pwr_manswitch388.setShadow(1);
    localPanel.add(pwr_manswitch388, new Proportion(pwr_manswitch388.getBounds(), dsize));
    pwr_contactor289 = new pwr_contactor2(session);
    pwr_contactor289.setBounds(new Rectangle(268,333,36,36));
    ...
    pwr_acs80090 = new pwr_acs800(session);
    pwr_acs80090.setBounds(new Rectangle(256,382,62,82));
    pwr_acs80090.setShadow(1);
    localPanel.add(pwr_acs80090, new Proportion(pwr_acs80090.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_manswitch388.dd.setDynType(32769);
    pwr_manswitch388.dd.setActionType(66);
    pwr_manswitch388.dd.setAccess(65535);
    pwr_manswitch388.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch388.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch388.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch388.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    ...
    pwr_acs80090.dd.setDynType(1);
    pwr_acs80090.dd.setActionType(66);
    pwr_acs80090.dd.setAccess(65535);
    pwr_acs80090.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80090.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80090.dd, "open graph /class/instance=$object.ACS800")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128359, 8}, new int[] { 12, 15, -1220128338,29}, 4),
