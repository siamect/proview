...
public class JopcAbb_acs800fanaggr17 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,604,47,20));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,603,336,23));
    ...
    pwr_valuesmall33.setBounds(new Rectangle(301,229,72,17));
    ...
    pwr_motor241.setBounds(new Rectangle(158,503,98,74));
    ...
    pwr_smallbuttoncenter42.setBounds(new Rectangle(33,171,47,21));
    ...
    pwr_indround47.setBounds(new Rectangle(85,247,18,18));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,401,16,16));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,420,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(306,513,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(306,531,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(356,516,20,14));
    ...
    pwr_valueinputmediumrd62.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_63.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_63, new Proportion(grp210_63.getBounds(), dsize));
    grp212_64 = new Grp212_(session);
    grp212_64.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(306,549,51,17));
    ...
    pwr_indsquare69.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_rod75.setBounds(new Rectangle(129,535,39,10));
    ...
    pwr_fananim76.setBounds(new Rectangle(117,495,19,91));
    ...
    grp228_77.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_smallbuttoncenter78.setBounds(new Rectangle(33,196,47,21));
    ...
    pwr_fuse382.setBounds(new Rectangle(280,296,15,37));
    ...
    pwr_manswitch383.setBounds(new Rectangle(267,340,38,38));
    ...
    pwr_acs80084.setBounds(new Rectangle(255,391,64,84));
    ...
    pwr_mbup85.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808822, 57}, new int[] { 12, 15, -1219808814,65}, 4),
