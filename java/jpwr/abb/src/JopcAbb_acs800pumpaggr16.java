...
public class JopcAbb_acs800pumpaggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch386;
  pwr_acs800	pwr_acs80087;
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800pumpaggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr16");
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,488,14,14));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,651,45,18));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,650,334,21));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(197,477,36,37));
    ...
    pwr_motor244.setBounds(new Rectangle(159,550,96,72));
    ...
    pwr_indsquare53.setBounds(new Rectangle(162,400,14,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,560,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,578,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(357,563,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(307,596,49,15));
    ...
    pwr_indsquare72.setBounds(new Rectangle(312,174,14,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,525,14,15));
    ...
    grp221_75.setBounds(new Rectangle(35,524,38,16));
    ...
    pwr_pump378.setBounds(new Rectangle(76,551,82,72));
    ...
    pwr_fuse385.setBounds(new Rectangle(281,295,13,35));
    pwr_fuse385.setRotate(-90);
    pwr_fuse385.setShadow(1);
    localPanel.add(pwr_fuse385, new Proportion(pwr_fuse385.getBounds(), dsize));
    pwr_manswitch386 = new pwr_manswitch3(session);
    pwr_manswitch386.setBounds(new Rectangle(268,339,36,36));
    pwr_manswitch386.setFillColor(32);
    pwr_manswitch386.setShadow(1);
    localPanel.add(pwr_manswitch386, new Proportion(pwr_manswitch386.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_manswitch386.dd.setDynType(32769);
    pwr_manswitch386.dd.setActionType(66);
    pwr_manswitch386.dd.setAccess(65535);
    pwr_manswitch386.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch386.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch386.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch386.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 672;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7516F, 279.127F, 361.014F, 369.715F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 279, 279, 280, 280, 648, 649}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 649, 279, 280, 648, 648, 649}, 6), 
    ...
    new Line2D.Float( 288F, 284F, 288F, 340F),
    new Line2D.Float( 288F, 392F, 288F, 374F),
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {552, 552, 548, 470, 548, 552}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),36, 499);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),361, 591);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 591);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 573);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 609);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 609);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 13, 7, 8}, new int[] { 62, 65, 60,58}, 4),
    new Polygon( new int[] { 8, 7, 5, 6}, new int[] { 58, 60, 52,52}, 4),
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 52, 52, 8,8}, 4),
    new Polygon( new int[] { 6, 5, 10, 9}, new int[] { 8, 8, 11,-26}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 40, 34, 24,24}, 4),
    new Polygon( new int[] { 6, 9, 11, 10}, new int[] { 24, 24, 19,18}, 4),
    ...
    new Polygon( new int[] { 10, 9, 9, 6}, new int[] { 32, 32, 34,40}, 4),
    new Polygon( new int[] { 6, 9, 9, 9}, new int[] { 40, 34, -26,-26}, 4),
    new Polygon( new int[] { 6, 10, 18, 52, 56, 58, 58, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {44, 50, 52, 52, 48, 38, 10, 10, 52, 58, 62, 62, 58, 52, 46}, 15),
    new Polygon( new int[] { 6, 10, 9, 10}, new int[] { 44, 57, 53,50}, 4),
    new Polygon( new int[] { 10, 9, 18, 18}, new int[] { 50, 53, 55,52}, 4),
    ...
    new Polygon( new int[] { 14, 15, 12, 8}, new int[] { 62, 59, 56,58}, 4),
    new Polygon( new int[] { 8, 12, 10, 6}, new int[] { 58, 56, 52,52}, 4),
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 52, 52, 46,46}, 4),
    new Polygon( new int[] { 6, 10, 10, 9}, new int[] { 46, 46, 57,-26}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128358, 9}, new int[] { 10, 12, -1220128394,-26}, 4),
    ...
    new Polygon( new int[] { 6, 10, 140893329, 9}, new int[] { 14, 17, 144126141,-26}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128340, 27}, new int[] { 12, 13, -1220128364,3}, 4),
