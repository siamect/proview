...
public class JopcAbb_acs800pumpaggr16 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,487,16,16));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,650,47,20));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,649,336,23));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(196,476,38,39));
    ...
    pwr_motor244.setBounds(new Rectangle(158,549,98,74));
    ...
    pwr_indsquare53.setBounds(new Rectangle(161,399,16,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,559,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,577,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(356,562,20,14));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(306,595,51,17));
    ...
    pwr_indsquare72.setBounds(new Rectangle(311,173,16,17));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,524,16,17));
    ...
    grp221_75.setBounds(new Rectangle(34,523,40,18));
    ...
    pwr_pump378.setBounds(new Rectangle(75,550,84,74));
    ...
    pwr_fuse385.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_manswitch386.setBounds(new Rectangle(267,338,38,38));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808870, 9}, new int[] { 10, 12, -1219808906,-26}, 4),
    ...
    new Polygon( new int[] { 6, 10, 146428193, 9}, new int[] { 14, 17, 145408189,-26}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808852, 27}, new int[] { 12, 13, -1219808876,3}, 4),
