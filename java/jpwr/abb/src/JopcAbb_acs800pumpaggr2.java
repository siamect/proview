...
public class JopcAbb_acs800pumpaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuemedium61.setBounds(new Rectangle(308,519,51,17));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(358,504,20,14));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(308,537,51,17));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,466,16,16));
    ...
    pwr_pump380.setBounds(new Rectangle(77,492,84,74));
    ...
    pwr_manswitch387.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_acs80089.setBounds(new Rectangle(255,381,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808863, 16}, new int[] { 10, 12, -1219808877,2}, 4),
    ...
    new Polygon( new int[] { 6, 11, 16, 16}, new int[] { 14, 17, 144057490,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 148878586, 34}, new int[] { 12, 15, 144057520,32}, 4),
