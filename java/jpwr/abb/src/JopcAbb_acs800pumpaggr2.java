...
public class JopcAbb_acs800pumpaggr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp223_	grp223_77;
  pwr_pumpanim2	pwr_pumpanim279;
  pwr_pump3	pwr_pump380;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800pumpaggr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr2");
    ...
    pwr_valuemedium61.setBounds(new Rectangle(309,520,49,15));
    ...
    pwr_valuemedium63.setBounds(new Rectangle(359,505,18,12));
    ...
    pwr_valuemedium70.setBounds(new Rectangle(309,538,49,15));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,467,14,14));
    ...
    grp223_77.setBounds(new Rectangle(35,466,38,16));
    localPanel.add(grp223_77, new Proportion(grp223_77.getBounds(), dsize));
    pwr_pumpanim279 = new pwr_pumpanim2(session);
    pwr_pumpanim279.setBounds(new Rectangle(119,96,62,42));
    pwr_pumpanim279.setShadow(1);
    pwr_pumpanim279.setGradient(12);
    localPanel.add(pwr_pumpanim279, new Proportion(pwr_pumpanim279.getBounds(), dsize));
    pwr_pump380 = new pwr_pump3(session);
    pwr_pump380.setBounds(new Rectangle(78,493,82,72));
    pwr_pump380.setColorTone(7);
    localPanel.add(pwr_pump380, new Proportion(pwr_pump380.getBounds(), dsize));
    pwr_rodcouplinganim81 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim81.setBounds(new Rectangle(155,519,10,20));
    localPanel.add(pwr_rodcouplinganim81, new Proportion(pwr_rodcouplinganim81.getBounds(), dsize));
    grp228_82 = new Grp228_(session);
    grp228_82.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp228_82, new Proportion(grp228_82.getBounds(), dsize));
    pwr_smallbuttoncenter83 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter83.setBounds(new Rectangle(34,197,45,19));
    ...
    pwr_manswitch387.setBounds(new Rectangle(268,285,36,36));
    ...
    pwr_acs80089.setBounds(new Rectangle(256,382,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter59.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter59.dd, "$object.ACS800.OpReset##Boolean")
      });
    ...
    pwr_valuemedium60.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium60.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium60.dd, "$object.ACS800.ActSpeed")
      });
    ...
    pwr_valuemedium61.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium61.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium61.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium63.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium63.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium70.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium70.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium70.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_pumpanim279.dd.setDynType(66612);
    pwr_pumpanim279.dd.setActionType(0);
    pwr_pumpanim279.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_pumpanim279.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_pumpanim279.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_pumpanim279.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim279.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim279.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_pump380.dd.setDynType(1);
    pwr_pump380.dd.setActionType(66);
    pwr_pump380.dd.setAccess(65532);
    pwr_pump380.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_pump380.dd, "$object.Pump")
      ,new GeDynCommand(pwr_pump380.dd, "open graph/class/inst=$object.Pump")
      });
    ...
    grp228_82.dd.setDynType(129);
    grp228_82.dd.setActionType(0);
    grp228_82.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_82.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("%"),363, 533);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 533);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 515);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 551);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 551);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 11, 16}, new int[] { 8, 8, 11,2}, 4),
    ...
    new Polygon( new int[] { 6, 9, 16, 16}, new int[] { 40, 36, 2,2}, 4),
    ...
    new Polygon( new int[] { 6, 11, 11, 16}, new int[] { 46, 46, 54,2}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220128351, 16}, new int[] { 10, 12, -1220128365,2}, 4),
    ...
    new Polygon( new int[] { 6, 11, 140893336, 16}, new int[] { 14, 17, 144126170,2}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128333, 34}, new int[] { 12, 15, -1220128335,32}, 4),
