...
public class JopcAbb_acs800motoraggr20 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(161,349,16,16));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,605,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,608,336,23));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,398,16,17));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(36,417,57,23));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,512,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,530,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(356,515,20,14));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(306,548,51,17));
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(152,529,12,22));
    ...
    pwr_motorman75.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,477,16,17));
    ...
    pwr_fuse383.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_contactor284.setBounds(new Rectangle(267,339,38,38));
    ...
    pwr_acs80085.setBounds(new Rectangle(255,388,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 51, 3}, new int[] { 12, 15, 55,54}, 4),
