...
public class JopcAbb_acs800pumpaggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,447,16,17));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,602,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,601,336,23));
    ...
    pwr_motor241.setBounds(new Rectangle(160,501,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,351,16,16));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,370,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(308,511,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,529,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(358,514,20,14));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(308,547,51,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,476,16,16));
    ...
    pwr_pump375.setBounds(new Rectangle(77,502,84,74));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(154,528,12,22));
    ...
    pwr_acs80083.setBounds(new Rectangle(255,341,64,84));
    ...
    pwr_safetyswitch84.setBounds(new Rectangle(268,437,38,39));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808882, -2}, new int[] { 10, 12, -1219808871,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893317, -2}, new int[] { 14, 17, 144131296,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140859255, 15}, new int[] { 12, 15, 145615758,38}, 4),
