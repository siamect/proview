...
public class JopcAbb_acs800pumpaggr21 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup85;
  public JopcAbb_acs800pumpaggr21( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr21( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr21");
    ...
    pwr_indsquare8.setBounds(new Rectangle(162,448,14,15));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,603,45,19));
    ...
    pwr_valuelong26.setBounds(new Rectangle(61,602,334,21));
    ...
    pwr_motor241.setBounds(new Rectangle(161,502,96,72));
    ...
    pwr_indsquare50.setBounds(new Rectangle(162,352,14,14));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(37,371,55,21));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(309,512,49,15));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(309,530,49,15));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(359,515,18,12));
    pwr_valuemedium58.setFillColor(31);
    pwr_valuemedium58.setBorderColor(32);
    ...
    pwr_indsquare71.setBounds(new Rectangle(162,477,14,14));
    ...
    pwr_pump375.setBounds(new Rectangle(78,503,82,72));
    ...
    pwr_rodcouplinganim76.setBounds(new Rectangle(155,529,10,20));
    ...
    pwr_acs80083.setBounds(new Rectangle(256,342,62,82));
    ...
    pwr_safetyswitch84.setBounds(new Rectangle(269,438,36,37));
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 624;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7515F, 280.458F, 361.015F, 320.579F),
    ...
    new Line2D.Float( 288F, 442F, 288F, 424F),
    new Polygon( new int[] { 214, 284, 288, 288, 288, 284}, new int[] {506, 506, 502, 474, 502, 506}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("SafetySwitch"),36, 459);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),363, 543);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),264, 543);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),264, 525);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),363, 561);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),264, 561);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -2}, new int[] { 8, 8, 11,8}, 4),
    ...
    new Polygon( new int[] { 6, 7, -2, -2}, new int[] { 40, 36, 8,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -2}, new int[] { 46, 46, 54,8}, 4),
    ...
    new Polygon( new int[] { 54, 56, -2, -2}, new int[] { 10, 12, 49,8}, 4),
    ...
    new Polygon( new int[] { 6, 9, -2, -2}, new int[] { 14, 17, 9,8}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128352, 15}, new int[] { 12, 15, -1220128329,38}, 4),
