...
public class JopcAbb_acs800pumpaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,434,16,17));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,597,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,596,336,23));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(196,423,38,39));
    ...
    pwr_motor244.setBounds(new Rectangle(158,496,98,74));
    ...
    pwr_indsquare55.setBounds(new Rectangle(161,346,16,16));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(36,365,57,23));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(306,506,51,17));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(306,524,51,17));
    ...
    pwr_valuemedium64.setBounds(new Rectangle(356,509,20,14));
    ...
    pwr_valuemedium71.setBounds(new Rectangle(306,542,51,17));
    ...
    pwr_indsquare77.setBounds(new Rectangle(161,471,16,16));
    ...
    grp221_78.setBounds(new Rectangle(34,470,40,18));
    ...
    pwr_pump381.setBounds(new Rectangle(75,497,84,74));
    ...
    pwr_contactor288.setBounds(new Rectangle(267,287,38,38));
    ...
    pwr_acs80089.setBounds(new Rectangle(255,336,64,84));
    ...
    pwr_mbup90.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 59, 2}, new int[] { 40, 36, -1219808876,3}, 4),
    ...
    new Polygon( new int[] { 54, 56, 148878554, 2}, new int[] { 10, 12, 144057491,3}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219808877, 2}, new int[] { 14, 17, -1219808876,3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808859, 20}, new int[] { 12, 15, -1219808846,33}, 4),
