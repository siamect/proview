...
public class JopcAbb_acs800pumpaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pumpanim281.setBounds(new Rectangle(122,95,64,43));
    ...
    pwr_pump382.setBounds(new Rectangle(75,497,84,74));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 8, 5, 4, 6}, new int[] { 58, 62, 54,52}, 4),
