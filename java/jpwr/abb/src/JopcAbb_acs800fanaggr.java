...
public class JopcAbb_acs800fanaggr extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcAbb_acs800fanaggr( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr");
    ...
    pwr_rod85.setBounds(new Rectangle(132,573,39,10));
    ...
    pwr_fananim86.setBounds(new Rectangle(120,533,19,91));
    pwr_fananim86.setShadow(1);
    localPanel.add(pwr_fananim86, new Proportion(pwr_fananim86.getBounds(), dsize));
    grp228_87 = new Grp228_(session);
    grp228_87.setBounds(new Rectangle(36,196,43,18));
    localPanel.add(grp228_87, new Proportion(grp228_87.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp228_87.dd.setDynType(129);
    grp228_87.dd.setActionType(0);
    grp228_87.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp228_87.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
