...
public class JopcAbb_acs800fanaggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup86;
  public JopcAbb_acs800fanaggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr4");
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,597,45,19));
    ...
    pwr_valuemedium61.setTextColor(31);
    ...
    pwr_rod78.setBounds(new Rectangle(130,528,37,8));
    ...
    pwr_fananim79.setBounds(new Rectangle(118,488,17,89));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128356, 11}, new int[] { 12, 15, -1220128331,36}, 4),
