...
public class JopcAbb_acs800fanaggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,596,47,21));
    ...
    pwr_rod78.setBounds(new Rectangle(129,527,39,10));
    ...
    pwr_fananim79.setBounds(new Rectangle(117,487,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808868, 11}, new int[] { 12, 15, -1219808843,36}, 4),
