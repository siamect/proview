...
public class JopcAbb_acs800fanaggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton26.setBounds(new Rectangle(4,596,47,21));
    ...
    pwr_fananim278.setBounds(new Rectangle(118,95,64,44));
    ...
    pwr_rod79.setBounds(new Rectangle(129,527,39,10));
    ...
    pwr_fananim80.setBounds(new Rectangle(117,487,19,91));
    ...
    grp227_81.setBounds(new Rectangle(35,196,43,18));
