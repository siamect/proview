...
public class JopcAbb_acs800motoraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim71.setBounds(new Rectangle(154,480,12,22));
    ...
    pwr_motorman72.setBounds(new Rectangle(114,95,64,44));
    ...
    pwr_indsquare73.setBounds(new Rectangle(161,428,16,17));
    ...
    pwr_smallbuttoncenter76.setBounds(new Rectangle(33,196,48,21));
    ...
    pwr_acs80079.setBounds(new Rectangle(255,293,64,84));
    ...
    pwr_safetyswitch80.setBounds(new Rectangle(268,389,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808859, 20}, new int[] { 12, 15, -1219808859,20}, 4),
