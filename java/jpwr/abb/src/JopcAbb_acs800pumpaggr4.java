...
public class JopcAbb_acs800pumpaggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,433,16,17));
    ...
    pwr_mbnote24.setBounds(new Rectangle(35,24,20,20));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,523,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(356,508,20,14));
    ...
    grp210_66.setBounds(new Rectangle(126,227,41,18));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(306,541,51,17));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,470,16,16));
    ...
    grp221_75.setBounds(new Rectangle(34,469,40,18));
    ...
    pwr_pump378.setBounds(new Rectangle(75,496,84,74));
    ...
    pwr_rodcouplinganim79.setBounds(new Rectangle(152,522,12,22));
    ...
    pwr_manswitch384.setBounds(new Rectangle(267,284,38,38));
    ...
    pwr_acs80085.setBounds(new Rectangle(255,335,64,84));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219808914, -34}, new int[] { 10, 12, -1219808880,0}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893285, -34}, new int[] { 14, 17, 144131287,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857015, -16}, new int[] { 12, 15, 145178341,29}, 4),
