...
public class JopcAbb_acs800motoraggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(152,477,12,22));
    ...
    pwr_indsquare76.setBounds(new Rectangle(161,425,16,16));
    ...
    pwr_contactor282.setBounds(new Rectangle(267,287,38,38));
    ...
    pwr_acs80083.setBounds(new Rectangle(255,336,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808883, -3}, new int[] { 12, 15, -1219808823,56}, 4),
