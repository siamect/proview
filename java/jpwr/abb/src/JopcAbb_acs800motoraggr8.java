...
public class JopcAbb_acs800motoraggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor282;
  pwr_acs800	pwr_acs80083;
  pwr_mbup	pwr_mbup84;
  public JopcAbb_acs800motoraggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr8");
    ...
    pwr_rodcouplinganim74.setBounds(new Rectangle(153,478,10,20));
    ...
    pwr_indsquare76.setBounds(new Rectangle(162,426,14,14));
    ...
    grp221_77.setBounds(new Rectangle(35,425,38,16));
    localPanel.add(grp221_77, new Proportion(grp221_77.getBounds(), dsize));
    grp223_78 = new Grp223_(session);
    grp223_78.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp223_78, new Proportion(grp223_78.getBounds(), dsize));
    ...
    pwr_contactor282 = new pwr_contactor2(session);
    pwr_contactor282.setBounds(new Rectangle(268,288,36,36));
    pwr_contactor282.setFillColor(32);
    pwr_contactor282.setShadow(1);
    localPanel.add(pwr_contactor282, new Proportion(pwr_contactor282.getBounds(), dsize));
    pwr_acs80083 = new pwr_acs800(session);
    pwr_acs80083.setBounds(new Rectangle(256,337,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp223_78.dd.setDynType(129);
    grp223_78.dd.setActionType(0);
    grp223_78.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_78.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_contactor282.dd.setDynType(32769);
    pwr_contactor282.dd.setActionType(66);
    pwr_contactor282.dd.setAccess(65535);
    pwr_contactor282.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor282.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor282.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor282.dd, "open graph /class/instance=$object.Contactor")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 286F, 340F, 286F, 324F),
    new Polygon( new int[] { 210, 282, 286, 286, 286, 282}, new int[] {454, 454, 450, 418, 450, 454}, 6),
  };
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -3, -3}, new int[] { 12, 15, 497,56}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, -3, -3}, new int[] { 12, 15, 113,56}, 4),
