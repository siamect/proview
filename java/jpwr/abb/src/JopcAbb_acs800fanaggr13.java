...
public class JopcAbb_acs800fanaggr13 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp221_	grp221_82;
  pwr_fananim2	pwr_fananim284;
  pwr_rod	pwr_rod85;
  pwr_fananim	pwr_fananim86;
  pwr_fuse3	pwr_fuse388;
  Grp227_	grp227_89;
  JopSmallbutton	jopSmallbutton90;
  public JopcAbb_acs800fanaggr13( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr13( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr13");
    pwr_indsquare6 = new pwr_indsquare(session);
    pwr_indsquare6.setBounds(new Rectangle(161,396,16,16));
    ...
    grp169_56.setBounds(new Rectangle(34,248,34,18));
    ...
    pwr_fananim284 = new pwr_fananim2(session);
    pwr_fananim284.setBounds(new Rectangle(115,94,64,44));
    pwr_fananim284.setBorderColor(29);
    pwr_fananim284.setTextColor(0);
    pwr_fananim284.setShadow(1);
    localPanel.add(pwr_fananim284, new Proportion(pwr_fananim284.getBounds(), dsize));
    pwr_rod85 = new pwr_rod(session);
    pwr_rod85.setBounds(new Rectangle(125,627,39,9));
    pwr_rod85.setShadow(1);
    localPanel.add(pwr_rod85, new Proportion(pwr_rod85.getBounds(), dsize));
    pwr_fananim86 = new pwr_fananim(session);
    pwr_fananim86.setBounds(new Rectangle(113,587,19,91));
    pwr_fananim86.setShadow(1);
    localPanel.add(pwr_fananim86, new Proportion(pwr_fananim86.getBounds(), dsize));
    ...
    grp227_89 = new Grp227_(session);
    grp227_89.setBounds(new Rectangle(36,196,43,18));
    localPanel.add(grp227_89, new Proportion(grp227_89.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim284.dd.setDynType(66612);
    pwr_fananim284.dd.setActionType(0);
    pwr_fananim284.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim284.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim284.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim284.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim284.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim284.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_fananim284.setAnnot1("L");
    pwr_rod85.dd.setDynType(1);
    pwr_rod85.dd.setActionType(0);
    pwr_fananim86.dd.setDynType(65537);
    pwr_fananim86.dd.setActionType(66);
    pwr_fananim86.dd.setAccess(65532);
    pwr_fananim86.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim86.dd, "$object.ACS800.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim86.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim86.dd, "open graph/class/inst=$object.Fan")
      });
    pwr_fuse388.dd.setDynType(1);
    pwr_fuse388.dd.setActionType(0);
    grp227_89.dd.setDynType(129);
    grp227_89.dd.setActionType(0);
    grp227_89.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp227_89.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7573F, 279.519F, 361.009F, 410.537F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 280, 280, 281, 281, 689, 690}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 690, 280, 281, 689, 689, 690}, 6), 
...
protected class pwr_rodcouplinganim__p6 extends GeComponent {
  // Dimension size;
  public pwr_rodcouplinganim__p6( JopSession session)
  {
    super( session);
