...
public class JopcAbb_acs800fanaggr13 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim282.setBounds(new Rectangle(115,94,64,44));
    ...
    pwr_rod83.setBounds(new Rectangle(125,627,39,9));
    ...
    pwr_fananim84.setBounds(new Rectangle(113,587,19,91));
    ...
    grp227_85.setBounds(new Rectangle(36,196,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808866, 13}, new int[] { 12, 15, -1219808824,55}, 4),
