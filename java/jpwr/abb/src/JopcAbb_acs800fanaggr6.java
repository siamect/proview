...
public class JopcAbb_acs800fanaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800fanaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr6");
    ...
    grp223_77.setBounds(new Rectangle(35,470,38,15));
    ...
    pwr_rod80.setBounds(new Rectangle(131,528,37,8));
    ...
    pwr_fananim81.setBounds(new Rectangle(119,488,17,89));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128327, 40}, new int[] { 12, 15, -1220128342,25}, 4),
