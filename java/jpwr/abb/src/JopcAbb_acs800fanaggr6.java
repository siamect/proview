...
public class JopcAbb_acs800fanaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp223_77.setBounds(new Rectangle(34,469,40,17));
    ...
    pwr_rod80.setBounds(new Rectangle(130,527,39,10));
    ...
    pwr_fananim81.setBounds(new Rectangle(118,487,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808839, 40}, new int[] { 12, 15, -1219808854,25}, 4),
