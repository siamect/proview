...
public class JopcAbb_acs800motoraggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800motoraggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800motoraggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800motoraggr7");
    ...
    pwr_indround50.setBounds(new Rectangle(86,248,16,16));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(153,524,10,20));
    ...
    pwr_indsquare79.setBounds(new Rectangle(162,472,14,14));
    ...
    pwr_contactor286.setBounds(new Rectangle(268,288,36,36));
    ...
    pwr_acs80087.setBounds(new Rectangle(256,337,62,82));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp223_81.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp223_81.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128324, 43}, new int[] { 12, 15, -1220128296,71}, 4),
