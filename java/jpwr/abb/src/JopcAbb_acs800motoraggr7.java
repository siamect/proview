...
public class JopcAbb_acs800motoraggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indround50.setBounds(new Rectangle(85,247,18,18));
    ...
    pwr_rodcouplinganim77.setBounds(new Rectangle(152,523,12,22));
    ...
    pwr_indsquare79.setBounds(new Rectangle(161,471,16,16));
    ...
    pwr_contactor286.setBounds(new Rectangle(267,287,38,38));
    ...
    pwr_acs80087.setBounds(new Rectangle(255,336,64,84));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 1953723759, 43}, new int[] { 12, 15, 1869444016,71}, 4),
