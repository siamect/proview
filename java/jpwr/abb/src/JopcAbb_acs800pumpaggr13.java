...
public class JopcAbb_acs800pumpaggr13 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_manswitch3	pwr_manswitch332;
  ...
  JopSmallbutton	jopSmallbutton58;
  ...
  Grp226_	grp226_89;
  JopSmallbutton	jopSmallbutton90;
  ...
  public void geInit() {
    ...
    pwr_indsquare6.setBounds(new Rectangle(161,396,16,17));
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,350,16,16));
    ...
    pwr_indsquare11.setBounds(new Rectangle(161,533,16,17));
    ...
    jopSmallbutton28.setBounds(new Rectangle(4,696,47,21));
    ...
    pwr_valuelong29.setBounds(new Rectangle(60,695,336,23));
    ...
    pwr_manswitch332 = new pwr_manswitch3(session);
    pwr_manswitch332.setBounds(new Rectangle(267,338,38,38));
    pwr_manswitch332.setShadow(1);
    localPanel.add(pwr_manswitch332, new Proportion(pwr_manswitch332.getBounds(), dsize));
    pwr_contactor233 = new pwr_contactor2(session);
    pwr_contactor233.setBounds(new Rectangle(267,386,38,38));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(196,520,39,41));
    ...
    pwr_motor247.setBounds(new Rectangle(158,595,98,74));
    localPanel.add(pwr_motor247, new Proportion(pwr_motor247.getBounds(), dsize));
    pwr_acs80048 = new pwr_acs800(session);
    pwr_acs80048.setBounds(new Rectangle(255,435,64,84));
    pwr_acs80048.setShadow(1);
    localPanel.add(pwr_acs80048, new Proportion(pwr_acs80048.getBounds(), dsize));
    jopSmallbutton49 = new JopSmallbutton(session);
    jopSmallbutton49.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_indround51.setBounds(new Rectangle(87,196,18,17));
    ...
    jopSmallbutton52.setBounds(new Rectangle(123,172,61,21));
    ...
    jopSmallbutton53.setBounds(new Rectangle(123,196,61,21));
    ...
    grp169_56.setBounds(new Rectangle(34,248,35,18));
    localPanel.add(grp169_56, new Proportion(grp169_56.getBounds(), dsize));
    jopSmallbutton57 = new JopSmallbutton(session);
    jopSmallbutton57.setBounds(new Rectangle(239,173,36,21));
    jopSmallbutton57.setFillColor(32);
    localPanel.add(jopSmallbutton57, new Proportion(jopSmallbutton57.getBounds(), dsize));
    jopSmallbutton58 = new JopSmallbutton(session);
    jopSmallbutton58.setBounds(new Rectangle(239,197,36,21));
    jopSmallbutton58.setFillColor(32);
    localPanel.add(jopSmallbutton58, new Proportion(jopSmallbutton58.getBounds(), dsize));
    pwr_indsquare59 = new pwr_indsquare(session);
    pwr_indsquare59.setBounds(new Rectangle(161,445,16,16));
    ...
    pwr_indround61.setBounds(new Rectangle(285,173,17,17));
    ...
    jopSmallbutton64.setBounds(new Rectangle(36,464,57,23));
    jopSmallbutton64.setFillColor(32);
    jopSmallbutton64.setShadow(1);
    ...
    pwr_valuemedium65.setBounds(new Rectangle(306,605,51,17));
    ...
    pwr_valuemedium66.setBounds(new Rectangle(306,623,51,17));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(356,608,20,14));
    pwr_valuemedium68.setFillColor(33);
    pwr_valuemedium68.setBorderColor(33);
    ...
    pwr_valueinputmediumrd72.setColorBrightness(-2);
    ...
    pwr_valuemedium75.setBounds(new Rectangle(306,641,51,17));
    ...
    pwr_indsquare81.setBounds(new Rectangle(161,570,16,16));
    ...
    grp221_82.setBounds(new Rectangle(34,569,39,18));
    ...
    pwr_pump385.setBounds(new Rectangle(75,596,84,74));
    ...
    pwr_rodcouplinganim86.setBounds(new Rectangle(152,621,12,21));
    ...
    pwr_fuse388.setBounds(new Rectangle(279,294,15,37));
    pwr_fuse388.setRotate(-90);
    pwr_fuse388.setShadow(1);
    localPanel.add(pwr_fuse388, new Proportion(pwr_fuse388.getBounds(), dsize));
    grp226_89 = new Grp226_(session);
    grp226_89.setBounds(new Rectangle(36,196,43,18));
    localPanel.add(grp226_89, new Proportion(grp226_89.getBounds(), dsize));
    jopSmallbutton90 = new JopSmallbutton(session);
    jopSmallbutton90.setBounds(new Rectangle(33,196,48,21));
    jopSmallbutton90.setFillColor(32);
    localPanel.add(jopSmallbutton90, new Proportion(jopSmallbutton90.getBounds(), dsize));
    ...
    pwr_manswitch332.dd.setDynType(32769);
    pwr_manswitch332.dd.setActionType(66);
    pwr_manswitch332.dd.setAccess(65535);
    pwr_manswitch332.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch332.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch332.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch332.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
    ...
    pwr_contactor233.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor233.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor233.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor233.dd, "open graph /class/instance=$object.Contactor")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ACS800.ActSpeed")
      }),
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ACS800.ActTorque")
      }),
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ACS800.ActCurrent")
      }),
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ACS800.RefSpeed")
      }),
    new GeDyn(pwr_pulldownmenu44,129,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu46.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu46.dd, "open graph /class /inst=$object.CircuitBreaker")
      }),
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu46.dd, "open graph /class /inst=$object.ACS800")
      }),
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_acs80048.dd.setDynType(1);
    pwr_acs80048.dd.setActionType(66);
    pwr_acs80048.dd.setAccess(65535);
    pwr_acs80048.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80048.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80048.dd, "open graph /class/instance=$object.ACS800")
      });
    ...
    jopSmallbutton49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton49.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton49.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton49.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(jopSmallbutton49.dd, "$object.Mode.OpMan##Boolean")
      });
    jopSmallbutton49.setAnnot1(" Man");
    ...
    jopSmallbutton52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton52.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton52.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton52.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(jopSmallbutton52.dd, "$object.MOde.OpManStart##Boolean")
      });
    jopSmallbutton52.setAnnot1(" Start");
    ...
    jopSmallbutton53.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton53.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton53.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton53.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(jopSmallbutton53.dd, "$object.Mode.OpManStop##Boolean")
      });
    jopSmallbutton53.setAnnot1(" Stop");
    ...
    pwr_indround55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround55.dd, "$object.ACS800.ConvertRun##Boolean",29)
      });
    ...
    jopSmallbutton57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton57.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton57.dd, "$object.OpPowerOn")
      ,new GeDynSetDig(jopSmallbutton57.dd, "$object.OpPowerOn##Boolean")
      });
    jopSmallbutton57.setAnnot1("On");
    jopSmallbutton58.dd.setDynType(129);
    jopSmallbutton58.dd.setActionType(6);
    jopSmallbutton58.dd.setAccess(65532);
    jopSmallbutton58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton58.dd, "$object.PowOnOffDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton58.dd, "$object.OpPowerOff")
      ,new GeDynSetDig(jopSmallbutton58.dd, "$object.OpPowerOff##Boolean")
      });
    jopSmallbutton58.setAnnot1("Off");
    pwr_indsquare59.dd.setDynType(117);
    pwr_indsquare59.dd.setActionType(2);
    pwr_indsquare59.dd.setAccess(65532);
    pwr_indsquare59.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigFlash(pwr_indsquare59.dd, "$object.ACS800.PowerStartUp##Boolean",294,9999)
      ,new GeDynDigError(pwr_indsquare59.dd, "$object.ACS800.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare59.dd, "$object.ACS800.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare59.dd, "$object.ACS800.ReadyRemote##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare59.dd, "$object.ACS800")
      });
    pwr_indround61.dd.setDynType(5);
    pwr_indround61.dd.setActionType(0);
    pwr_indround61.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround61.dd, "$object.Contactor.IndFeedback##Boolean",29)
      });
    jopSmallbutton64.dd.setDynType(1);
    jopSmallbutton64.dd.setActionType(4);
    jopSmallbutton64.dd.setAccess(65532);
    jopSmallbutton64.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(jopSmallbutton64.dd, "$object.ACS800.OpReset##Boolean")
      });
    jopSmallbutton64.setAnnot1("Reset");
    pwr_valuemedium65.dd.setDynType(1024);
    ...
    pwr_valuemedium65.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium65.dd, "$object.ACS800.ActSpeed.ActualValue##Float32","%9.3f")
      ,new GeDynPopupMenu(pwr_valuemedium65.dd, "$object.ACS800.ActSpeed")
      });
    ...
    pwr_valuemedium66.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium66.dd, "$object.ACS800.ActTorque.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium66.dd, "$object.ACS800.ActTorque")
      });
    ...
    pwr_valuemedium68.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium68.dd, "$object.ACS800.ActSpeed.Unit##String16","%s")
      });
    ...
    pwr_valuemedium75.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium75.dd, "$object.ACS800.ActCurrent.ActualValue##Float32","%7.1f")
      ,new GeDynPopupMenu(pwr_valuemedium75.dd, "$object.ACS800.ActCurrrent")
      });
    ...
    pwr_pumpanim284.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_pumpanim284.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_pumpanim284.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_pumpanim284.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    ...
    grp226_89.dd.setDynType(129);
    grp226_89.dd.setActionType(0);
    grp226_89.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp226_89.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    jopSmallbutton90.dd.setDynType(129);
    jopSmallbutton90.dd.setActionType(6);
    jopSmallbutton90.dd.setAccess(65532);
    jopSmallbutton90.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton90.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton90.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton90.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(jopSmallbutton90.dd, "$object.Mode.OpAuto##Boolean")
      });
    jopSmallbutton90.setAnnot1(" Auto");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 287F, 284.573F, 287F, 340.573F),
    new Line2D.Float( 287F, 389F, 287F, 376F),
    new Line2D.Float( 288F, 389F, 288F, 376F),
    new Line2D.Float( 286F, 389F, 286F, 376F),
    new Line2D.Float( 287F, 389F, 287F, 376F),
    new Line2D.Float( 287F, 389F, 287F, 376F),
    new Line2D.Float( 287F, 437F, 287F, 424F),
    new Line2D.Float( 287F, 437F, 287F, 424F),
    new Line2D.Float( 287F, 437F, 287F, 424F),
    new Line2D.Float( 212F, 598F, 278F, 598F),
    new Line2D.Float( 288F, 588F, 288F, 517F),
    new Arc2D.Float(268F, 578F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Line2D.Float( 212F, 598F, 278F, 598F),
    new Line2D.Float( 212F, 598F, 278F, 598F),
    new Line2D.Float( 288F, 588F, 288F, 517F),
    new Line2D.Float( 288F, 588F, 288F, 517F),
    new Arc2D.Float(268F, 578F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Arc2D.Float(268F, 578F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Line2D.Float( 216F, 525F, 216F, 416F),
    new Line2D.Float( 226F, 406F, 270F, 406F),
    new Arc2D.Float(216F, 406F, 20F, 20F, 90F, 90F, Arc2D.OPEN),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Contactor",36, 410);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Circuit breaker",36, 362);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Startlock",36, 545);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Frequencyconverter",36, 457);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( "%",361, 637);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Torque",262, 637);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Speed",262, 619);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[14]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "A",361, 655);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( "Current",262, 655);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 56, 57, 13, 14}, new int[] { 62, 67, 67,62}, 4),
    new Polygon( new int[] { 14, 13, 5, 8}, new int[] { 62, 67, 62,58}, 4),
    new Polygon( new int[] { 8, 5, 3, 6}, new int[] { 58, 62, 54,52}, 4),
    new Polygon( new int[] { 6, 3, 3, 6}, new int[] { 52, 54, 10,8}, 4),
    new Polygon( new int[] { 6, 6, 10, 14, 44, 46, 18, 12, 10, 6}, new int[] {40, 24, 18, 14, 14, 24, 24, 28, 32, 40}, 10),
    new Polygon( new int[] { 6, 7, 7, 6}, new int[] { 40, 38, 26,24}, 4),
    ...
    new Polygon( new int[] { 12, 11, 5, 10}, new int[] { 28, 29, 41,32}, 4),
    new Polygon( new int[] { 10, 5, 7, 6}, new int[] { 32, 41, 38,40}, 4),
    new Polygon( new int[] { 6, 10, 18, 52, 56, 58, 58, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {44, 50, 52, 52, 48, 38, 10, 10, 52, 58, 62, 62, 58, 52, 46}, 15),
    new Polygon( new int[] { 6, 9, 8, 10}, new int[] { 44, 56, 55,50}, 4),
    new Polygon( new int[] { 10, 8, 18, 18}, new int[] { 50, 55, 57,52}, 4),
    new Polygon( new int[] { 18, 18, 53, 52}, new int[] { 52, 57, 57,52}, 4),
    ...
    new Polygon( new int[] { 56, 55, 15, 14}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 14, 15, 11, 8}, new int[] { 62, 61, 58,58}, 4),
    new Polygon( new int[] { 8, 11, 9, 6}, new int[] { 58, 58, 54,52}, 4),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 52, 54, 48,46}, 4),
    ...
    new Polygon( new int[] { 50, 51, 18, 18}, new int[] { 46, 50, 50,46}, 4),
    new Polygon( new int[] { 18, 18, 9, 10}, new int[] { 46, 50, 48,44}, 4),
    new Polygon( new int[] { 10, 9, 8, 6}, new int[] { 44, 48, 47,42}, 4),
    new Polygon( new int[] { 6, 8, 8, 6}, new int[] { 42, 47, 45,44}, 4),
    new Polygon( new int[] { 6, 8, 11, 10}, new int[] { 44, 45, 50,50}, 4),
    new Polygon( new int[] { 10, 11, 18, 18}, new int[] { 50, 50, 52,52}, 4),
    new Polygon( new int[] { 18, 18, 51, 52}, new int[] { 52, 52, 52,52}, 4),
    ...
    new Polygon( new int[] { 14, 15, 11, 8}, new int[] { 62, 61, 58,58}, 4),
    new Polygon( new int[] { 8, 11, 9, 6}, new int[] { 58, 58, 54,52}, 4),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 52, 54, 19,14}, 4),
