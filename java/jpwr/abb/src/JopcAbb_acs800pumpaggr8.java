...
public class JopcAbb_acs800pumpaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(161,297,16,17));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,553,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,552,336,23));
    ...
    pwr_motor241.setBounds(new Rectangle(158,450,98,74));
    ...
    pwr_indsquare52.setBounds(new Rectangle(161,346,16,16));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(36,365,57,23));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,460,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,478,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(356,463,20,14));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(306,496,51,17));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,425,16,16));
    ...
    grp221_75.setBounds(new Rectangle(34,424,40,18));
    ...
    pwr_pump378.setBounds(new Rectangle(75,451,84,74));
    ...
    pwr_contactor284.setBounds(new Rectangle(267,287,38,38));
    ...
    pwr_acs80085.setBounds(new Rectangle(255,336,64,84));
    ...
    pwr_mbup86.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 16, 12}, new int[] { 40, 36, -1219808883,-3}, 4),
    ...
    new Polygon( new int[] { 54, 56, -16, -16}, new int[] { 10, 12, 61,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219808896, -16}, new int[] { 14, 17, -1219808883,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140859529, 1}, new int[] { 12, 15, 146121874,26}, 4),
