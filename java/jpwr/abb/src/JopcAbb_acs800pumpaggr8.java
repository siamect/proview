...
public class JopcAbb_acs800pumpaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor284;
  pwr_acs800	pwr_acs80085;
  pwr_mbup	pwr_mbup86;
  public JopcAbb_acs800pumpaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800pumpaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800pumpaggr8");
    pwr_indsquare7 = new pwr_indsquare(session);
    pwr_indsquare7.setBounds(new Rectangle(162,298,14,15));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,554,45,19));
    ...
    pwr_valuelong26.setBounds(new Rectangle(61,553,334,21));
    ...
    pwr_motor241.setBounds(new Rectangle(159,451,96,72));
    ...
    pwr_indsquare52.setBounds(new Rectangle(162,347,14,14));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,366,55,21));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,461,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,479,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(357,464,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(307,497,49,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,426,14,14));
    ...
    grp221_75.setBounds(new Rectangle(35,425,38,16));
    ...
    pwr_pump378.setBounds(new Rectangle(76,452,82,72));
    ...
    pwr_rodcouplinganim79.setBounds(new Rectangle(153,478,10,20));
    localPanel.add(pwr_rodcouplinganim79, new Proportion(pwr_rodcouplinganim79.getBounds(), dsize));
    grp225_80 = new Grp225_(session);
    grp225_80.setBounds(new Rectangle(37,197,39,16));
    localPanel.add(grp225_80, new Proportion(grp225_80.getBounds(), dsize));
    ...
    pwr_contactor284 = new pwr_contactor2(session);
    pwr_contactor284.setBounds(new Rectangle(268,288,36,36));
    pwr_contactor284.setFillColor(32);
    pwr_contactor284.setShadow(1);
    localPanel.add(pwr_contactor284, new Proportion(pwr_contactor284.getBounds(), dsize));
    pwr_acs80085 = new pwr_acs800(session);
    pwr_acs80085.setBounds(new Rectangle(256,337,62,82));
    pwr_acs80085.setShadow(1);
    localPanel.add(pwr_acs80085, new Proportion(pwr_acs80085.getBounds(), dsize));
    pwr_mbup86 = new pwr_mbup(session);
    pwr_mbup86.setBounds(new Rectangle(346,25,17,18));
    localPanel.add(pwr_mbup86, new Proportion(pwr_mbup86.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp225_80.dd.setDynType(129);
    grp225_80.dd.setActionType(0);
    grp225_80.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp225_80.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_contactor284.dd.setDynType(32769);
    pwr_contactor284.dd.setActionType(66);
    pwr_contactor284.dd.setAccess(65535);
    pwr_contactor284.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor284.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor284.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor284.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_acs80085.dd.setDynType(1);
    pwr_acs80085.dd.setActionType(66);
    pwr_acs80085.dd.setAccess(65535);
    pwr_acs80085.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_acs80085.dd, "$object.ACS800")
      ,new GeDynCommand(pwr_acs80085.dd, "open graph /class/instance=$object.ACS800")
      });
    pwr_mbup86.dd.setDynType(129);
    pwr_mbup86.dd.setActionType(8256);
    pwr_mbup86.dd.setAccess(33619967);
    pwr_mbup86.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup86.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup86.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup86.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 575;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(18.7432F, 277.214F, 362.023F, 272.385F),
    new Polygon( new int[] { 19, 381, 380, 20, 20, 19}, new int[] { 277, 277, 278, 278, 549, 550}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 20, 19}, new int[] { 550, 277, 278, 549, 549, 550}, 6), 
    ...
    new Line2D.Float( 288F, 340F, 288F, 324F),
    new Polygon( new int[] { 212, 284, 288, 288, 288, 284}, new int[] {454, 454, 450, 418, 450, 454}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 311);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 358);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),361, 492);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 492);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 474);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 510);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 510);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 16, -16}, new int[] { 40, 36, -1220128371,-3}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220128384, -16}, new int[] { 14, 17, -1220128371,-3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128366, 1}, new int[] { 12, 15, -1220128341,26}, 4),
