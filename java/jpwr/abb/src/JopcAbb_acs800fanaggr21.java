...
public class JopcAbb_acs800fanaggr21 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare8.setBounds(new Rectangle(161,446,16,16));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,601,47,21));
    ...
    pwr_valuelong26.setBounds(new Rectangle(60,600,336,23));
    ...
    pwr_motor241.setBounds(new Rectangle(160,500,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(161,350,16,16));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(36,369,57,23));
    ...
    pwr_valuemedium55.setBounds(new Rectangle(308,510,51,17));
    ...
    pwr_valuemedium56.setBounds(new Rectangle(308,528,51,17));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(358,513,20,14));
    ...
    pwr_valuemedium65.setBounds(new Rectangle(308,546,51,17));
    ...
    pwr_indsquare69.setBounds(new Rectangle(307,175,16,17));
    ...
    pwr_indsquare71.setBounds(new Rectangle(161,475,16,16));
    ...
    pwr_rod75.setBounds(new Rectangle(132,532,39,10));
    ...
    pwr_fananim76.setBounds(new Rectangle(120,492,19,91));
    ...
    grp229_77.setBounds(new Rectangle(35,196,41,18));
    ...
    pwr_fuse382.setBounds(new Rectangle(280,294,15,37));
    ...
    pwr_acs80083.setBounds(new Rectangle(255,340,64,84));
    ...
    pwr_safetyswitch84.setBounds(new Rectangle(268,436,38,39));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808862, 17}, new int[] { 12, 15, -1219808821,58}, 4),
