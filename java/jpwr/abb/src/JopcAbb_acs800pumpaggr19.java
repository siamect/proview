...
public class JopcAbb_acs800pumpaggr19 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,488,16,17));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(196,477,38,39));
    ...
    pwr_motor244.setBounds(new Rectangle(158,550,98,74));
    ...
    pwr_smallbuttoncenter45.setBounds(new Rectangle(33,171,48,21));
    ...
    pwr_indround46.setBounds(new Rectangle(87,173,18,17));
    ...
    pwr_indround47.setBounds(new Rectangle(87,196,18,18));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(123,172,61,21));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(123,196,61,21));
    ...
    pwr_indround50.setBounds(new Rectangle(85,247,18,17));
    ...
    pwr_indround51.setBounds(new Rectangle(192,173,18,17));
    ...
    grp169_52.setBounds(new Rectangle(34,248,37,18));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(239,173,36,21));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(239,197,36,21));
    ...
    pwr_indsquare55.setBounds(new Rectangle(161,400,16,16));
    ...
    pwr_indround57.setBounds(new Rectangle(285,173,17,18));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(36,419,57,23));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(306,560,51,17));
    ...
    pwr_valuemedium62.setBounds(new Rectangle(306,578,51,17));
    ...
    pwr_valuemedium64.setBounds(new Rectangle(356,563,20,14));
    ...
    pwr_valueinputmediumrd68.setBounds(new Rectangle(122,241,77,30));
    ...
    grp210_69.setBounds(new Rectangle(126,227,40,18));
    localPanel.add(grp210_69, new Proportion(grp210_69.getBounds(), dsize));
    grp212_70 = new Grp212_(session);
    grp212_70.setBounds(new Rectangle(198,246,28,20));
    ...
    pwr_valuemedium71.setBounds(new Rectangle(306,596,51,17));
    ...
    pwr_indsquare77.setBounds(new Rectangle(161,525,16,17));
    ...
    pwr_pump381.setBounds(new Rectangle(75,551,84,74));
    ...
    pwr_fuse389.setBounds(new Rectangle(280,296,15,37));
    ...
    pwr_contactor290.setBounds(new Rectangle(267,341,38,38));
    ...
    pwr_acs80091.setBounds(new Rectangle(255,390,64,84));
    ...
    pwr_mbup92.setBounds(new Rectangle(345,24,19,20));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 90, 1}, new int[] { 40, 36, -1219808860,19}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219808878, 1}, new int[] { 10, 14, -1219808860,19}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219808878, 1}, new int[] { 14, 19, -1219808860,19}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 19, 19}, new int[] { 12, 15, 106,49}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 19, 19}, new int[] { 12, 15, 490,49}, 4),
