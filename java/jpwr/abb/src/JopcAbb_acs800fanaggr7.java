...
public class JopcAbb_acs800fanaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_fananim280.setBounds(new Rectangle(113,95,64,44));
    ...
    pwr_rod81.setBounds(new Rectangle(128,528,39,10));
    ...
    pwr_fananim82.setBounds(new Rectangle(116,488,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808859, 20}, new int[] { 12, 15, -1219808824,55}, 4),
