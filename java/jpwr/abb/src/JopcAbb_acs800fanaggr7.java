...
public class JopcAbb_acs800fanaggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp221_	grp221_78;
  pwr_fananim2	pwr_fananim280;
  pwr_rod	pwr_rod81;
  pwr_fananim	pwr_fananim82;
  Grp226_	grp226_83;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter84;
  pwr_contactor2	pwr_contactor288;
  pwr_acs800	pwr_acs80089;
  pwr_mbup	pwr_mbup90;
  public JopcAbb_acs800fanaggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr7");
    ...
    pwr_fananim280 = new pwr_fananim2(session);
    pwr_fananim280.setBounds(new Rectangle(114,96,62,42));
    pwr_fananim280.setBorderColor(29);
    pwr_fananim280.setTextColor(0);
    pwr_fananim280.setShadow(1);
    pwr_fananim280.setGradient(12);
    localPanel.add(pwr_fananim280, new Proportion(pwr_fananim280.getBounds(), dsize));
    pwr_rod81 = new pwr_rod(session);
    pwr_rod81.setBounds(new Rectangle(129,529,37,8));
    pwr_rod81.setShadow(1);
    localPanel.add(pwr_rod81, new Proportion(pwr_rod81.getBounds(), dsize));
    pwr_fananim82 = new pwr_fananim(session);
    pwr_fananim82.setBounds(new Rectangle(117,489,17,89));
    pwr_fananim82.setShadow(1);
    localPanel.add(pwr_fananim82, new Proportion(pwr_fananim82.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim280.dd.setDynType(66612);
    pwr_fananim280.dd.setActionType(0);
    pwr_fananim280.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim280.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim280.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim280.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim280.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim280.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_fananim280.setAnnot1("L");
    pwr_rod81.dd.setDynType(1);
    pwr_rod81.dd.setActionType(0);
    pwr_fananim82.dd.setDynType(65537);
    pwr_fananim82.dd.setActionType(66);
    pwr_fananim82.dd.setAccess(65532);
    pwr_fananim82.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim82.dd, "$object.ACS800.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim82.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim82.dd, "open graph/class/inst=$object.Fan")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),36, 447);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),361, 539);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 539);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 521);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 557);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 557);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128347, 20}, new int[] { 12, 15, -1220128312,55}, 4),
