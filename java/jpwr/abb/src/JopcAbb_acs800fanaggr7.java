...
public class JopcAbb_acs800fanaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    grp221_79.setBounds(new Rectangle(34,470,39,18));
    ...
    pwr_rod82.setBounds(new Rectangle(128,528,39,10));
    ...
    pwr_fananim83.setBounds(new Rectangle(116,488,19,91));
    ...
    grp226_84.setBounds(new Rectangle(36,196,43,18));
