...
public class JopcAbb_acs800fanaggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup88;
  public JopcAbb_acs800fanaggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr16");
    ...
    pwr_indsquare10.setBounds(new Rectangle(162,490,14,15));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(5,653,45,18));
    ...
    pwr_valuelong28.setBounds(new Rectangle(61,652,334,21));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(197,479,36,37));
    ...
    pwr_motor244.setBounds(new Rectangle(159,552,96,71));
    ...
    pwr_indsquare53.setBounds(new Rectangle(162,402,14,14));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(307,562,49,15));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(307,580,49,15));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(357,565,18,12));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(307,598,49,15));
    ...
    pwr_indsquare74.setBounds(new Rectangle(162,527,14,15));
    ...
    pwr_rod78.setBounds(new Rectangle(130,584,37,8));
    ...
    pwr_fananim79.setBounds(new Rectangle(118,544,17,89));
    ...
    grp228_80.setBounds(new Rectangle(37,197,39,16));
    ...
    pwr_manswitch386.setBounds(new Rectangle(268,341,36,36));
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 674;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.7601F, 280.278F, 361.006F, 370.566F),
    new Polygon( new int[] { 20, 381, 380, 21, 21, 20}, new int[] { 280, 280, 281, 281, 650, 651}, 6), 
    new Polygon( new int[] { 381, 381, 380, 380, 21, 20}, new int[] { 651, 280, 281, 650, 650, 651}, 6), 
    ...
    new Rectangle2D.Float(43F, 113F, 196F, 7F),
    new Polygon( new int[] { 43, 239, 237, 45, 45, 43}, new int[] { 113, 113, 115, 115, 118, 120}, 6), 
    new Polygon( new int[] { 239, 239, 237, 237, 45, 43}, new int[] { 120, 113, 115, 118, 118, 120}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Startlock"),37, 501);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("%"),362, 593);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),263, 593);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),263, 575);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),362, 611);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),263, 611);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 51, 51}, new int[] { 12, 15, 28,27}, 4),
