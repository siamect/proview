...
public class JopcAbb_acs800fanaggr16 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(161,489,16,17));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,652,47,20));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,651,336,23));
    ...
    pwr_safetyswitch31.setBounds(new Rectangle(196,478,38,39));
    ...
    pwr_motor244.setBounds(new Rectangle(158,551,98,73));
    ...
    pwr_valuemedium58.setBounds(new Rectangle(306,561,51,17));
    ...
    pwr_valuemedium59.setBounds(new Rectangle(306,579,51,17));
    ...
    pwr_valuemedium61.setBounds(new Rectangle(356,564,20,14));
    ...
    pwr_valuemedium68.setBounds(new Rectangle(306,597,51,17));
    ...
    pwr_indsquare74.setBounds(new Rectangle(161,526,16,17));
    ...
    pwr_rod78.setBounds(new Rectangle(129,583,39,10));
    ...
    pwr_fananim79.setBounds(new Rectangle(117,543,19,91));
    ...
    grp228_80.setBounds(new Rectangle(36,196,41,18));
    ...
    pwr_manswitch386.setBounds(new Rectangle(267,340,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 51, 51}, new int[] { 12, 15, 668,27}, 4),
