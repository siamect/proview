...
public class JopcAbb_acs800fanaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(4,553,48,21));
    ...
    pwr_fananim277.setBounds(new Rectangle(115,95,64,44));
    ...
    pwr_rod78.setBounds(new Rectangle(130,482,39,10));
    ...
    pwr_fananim79.setBounds(new Rectangle(118,442,19,91));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219808888, -8}, new int[] { 12, 15, -1219808824,55}, 4),
