...
public class JopcAbb_acs800fanaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp221_	grp221_75;
  pwr_fananim2	pwr_fananim277;
  pwr_rod	pwr_rod78;
  pwr_fananim	pwr_fananim79;
  Grp226_	grp226_80;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter81;
  pwr_contactor2	pwr_contactor284;
  pwr_acs800	pwr_acs80085;
  pwr_mbup	pwr_mbup86;
  public JopcAbb_acs800fanaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcAbb_acs800fanaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcAbb_acs800fanaggr8");
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(5,554,46,19));
    ...
    pwr_valueinputmediumrd65.setColorBrightness(-2);
    ...
    pwr_fananim277 = new pwr_fananim2(session);
    pwr_fananim277.setBounds(new Rectangle(116,96,62,42));
    pwr_fananim277.setBorderColor(29);
    pwr_fananim277.setTextColor(0);
    pwr_fananim277.setShadow(1);
    pwr_fananim277.setGradient(12);
    localPanel.add(pwr_fananim277, new Proportion(pwr_fananim277.getBounds(), dsize));
    pwr_rod78 = new pwr_rod(session);
    pwr_rod78.setBounds(new Rectangle(131,483,37,8));
    pwr_rod78.setShadow(1);
    localPanel.add(pwr_rod78, new Proportion(pwr_rod78.getBounds(), dsize));
    pwr_fananim79 = new pwr_fananim(session);
    pwr_fananim79.setBounds(new Rectangle(119,443,17,89));
    pwr_fananim79.setShadow(1);
    localPanel.add(pwr_fananim79, new Proportion(pwr_fananim79.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fananim277.dd.setDynType(66612);
    pwr_fananim277.dd.setActionType(0);
    pwr_fananim277.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim277.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim277.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim277.dd, "$object.ACS800.ConvertRun##Boolean",37)
      ,new GeDynValue(pwr_fananim277.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_fananim277.dd, "$object.ACS800.ConvertRun##Boolean",2)
      });
    pwr_fananim277.setAnnot1("L");
    pwr_rod78.dd.setDynType(1);
    pwr_rod78.dd.setActionType(0);
    pwr_fananim79.dd.setDynType(65537);
    pwr_fananim79.dd.setActionType(66);
    pwr_fananim79.dd.setAccess(65532);
    pwr_fananim79.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim79.dd, "$object.ACS800.ConvertRun##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim79.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim79.dd, "open graph/class/inst=$object.Fan")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Contactor"),36, 312);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Frequencyconverter"),36, 359);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("%"),361, 493);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Torque"),262, 493);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Speed"),262, 475);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(35, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("A"),361, 511);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Current"),262, 511);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220128376, -8}, new int[] { 12, 15, -1220128312,55}, 4),
