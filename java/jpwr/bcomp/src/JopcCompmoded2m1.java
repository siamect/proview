...
public class JopcCompmoded2m1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup33;
  public JopcCompmoded2m1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcCompmoded2m1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcCompmoded2m1");
    pwr_menubar23 = new pwr_menubar2(session);
    pwr_menubar23.setBounds(new Rectangle(1,1,310,22));
    ...
    pwr_pulldownmenu24.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu25.setBounds(new Rectangle(236,1,67,22));
    ...
    pwr_mbopenobject6.setBounds(new Rectangle(188,25,18,18));
    ...
    pwr_mbtrend7.setBounds(new Rectangle(49,25,18,18));
    ...
    pwr_mbfast8.setBounds(new Rectangle(69,25,18,18));
    ...
    pwr_mbphoto9.setBounds(new Rectangle(89,25,17,18));
    ...
    pwr_mbdatasheet10.setBounds(new Rectangle(109,25,18,18));
    ...
    pwr_mbopenplc11.setBounds(new Rectangle(208,25,18,18));
    ...
    pwr_mbcircuitdiagram12.setBounds(new Rectangle(228,25,18,18));
    ...
    pwr_mbrtnavigator13.setBounds(new Rectangle(168,25,18,18));
    ...
    pwr_mbhelpclass14.setBounds(new Rectangle(248,25,18,18));
    ...
    pwr_mbblockevents15.setBounds(new Rectangle(148,25,18,18));
    ...
    pwr_smallbuttoncenter20.setBounds(new Rectangle(27,116,46,19));
    pwr_smallbuttoncenter20.setFillColor(32);
    ...
    pwr_indround21.setBounds(new Rectangle(89,95,16,16));
    ...
    pwr_indround22.setBounds(new Rectangle(89,117,16,15));
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(27,94,46,18));
    ...
    pwr_smallbuttoncenter25.setBounds(new Rectangle(157,116,89,19));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(157,92,89,19));
    ...
    pwr_indround28.setBounds(new Rectangle(266,95,16,16));
    ...
    pwr_indround29.setBounds(new Rectangle(266,117,16,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(157,142,89,19));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(157,92,89,19));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(157,116,89,19));
    ...
    pwr_mbup33.setBounds(new Rectangle(281,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu219.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"Help\"/object=$object")
      }),
null,null,null,null,null,    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu219.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu219.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
null,    new GeDyn(pwr_pulldownmenu219,129,65,65532,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter20.dd.setDynType(129);
    pwr_smallbuttoncenter20.dd.setActionType(4);
    pwr_smallbuttoncenter20.dd.setAccess(65532);
    pwr_smallbuttoncenter20.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter20.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter20.dd, "$object.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter20.setAnnot1("Auto");
    ...
    pwr_indround22.dd.setDynType(133);
    pwr_indround22.dd.setActionType(0);
    pwr_indround22.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround22.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround22.dd, "!$object.ManMode##Boolean",29)
      });
    pwr_smallbuttoncenter24.dd.setDynType(128);
    pwr_smallbuttoncenter24.dd.setActionType(4);
    ...
    pwr_smallbuttoncenter24.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter24.dd, "$object.OpMan##Boolean")
      });
    pwr_smallbuttoncenter24.setAnnot1("Man");
    pwr_smallbuttoncenter25.dd.setDynType(129);
    pwr_smallbuttoncenter25.dd.setActionType(16);
    pwr_smallbuttoncenter25.dd.setAccess(65532);
    pwr_smallbuttoncenter25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter25.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter25.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter25.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynToggleDig(pwr_smallbuttoncenter25.dd, "$object.OpOrderManDecr##Boolean")
      });
    pwr_smallbuttoncenter25.setAnnot1("Backward");
    pwr_smallbuttoncenter26.dd.setDynType(128);
    pwr_smallbuttoncenter26.dd.setActionType(16);
    pwr_smallbuttoncenter26.dd.setAccess(65532);
    pwr_smallbuttoncenter26.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter26.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter26.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter26.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynToggleDig(pwr_smallbuttoncenter26.dd, "$object.OpOrderManIncr##Boolean")
      });
    pwr_smallbuttoncenter26.setAnnot1("Forward");
    ...
    pwr_indround28.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround28.dd, "$object.OpOrderManIncr##Boolean",29)
      });
    pwr_indround29.dd.setDynType(133);
    pwr_indround29.dd.setActionType(0);
    pwr_indround29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround29.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround29.dd, "$object.OpOrderManDecr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter30.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter30.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter30.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynSetDig(pwr_smallbuttoncenter30.dd, "$object.OpOrderManStop##Boolean")
      });
    pwr_smallbuttoncenter30.setAnnot1("Stop");
    pwr_smallbuttoncenter31.dd.setDynType(128);
    pwr_smallbuttoncenter31.dd.setActionType(32);
    pwr_smallbuttoncenter31.dd.setAccess(65532);
    pwr_smallbuttoncenter31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter31.dd, "!$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter31.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter31.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynStoDig(pwr_smallbuttoncenter31.dd, "$object.OpOrderManIncr##Boolean")
      });
    pwr_smallbuttoncenter31.setAnnot1("Forward");
    pwr_smallbuttoncenter32.dd.setDynType(129);
    pwr_smallbuttoncenter32.dd.setActionType(32);
    pwr_smallbuttoncenter32.dd.setAccess(65532);
    pwr_smallbuttoncenter32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter32.dd, "!$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter32.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter32.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynStoDig(pwr_smallbuttoncenter32.dd, "$object.OpOrderManDecr##Boolean")
      });
    pwr_smallbuttoncenter32.setAnnot1("Backward");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23F, 308.946F, 22.4305F),
    new Line2D.Float( 295.608F, 79.042F, 9.49869F, 79.042F),
    new Rectangle2D.Float(8.99996F, 54.1389F, 290.269F, 127.638F),
    new Polygon( new int[] { 9, 299, 298, 10, 10, 9}, new int[] { 54, 54, 55, 55, 181, 182}, 6), 
    new Polygon( new int[] { 299, 299, 298, 298, 10, 9}, new int[] { 182, 54, 55, 181, 181, 182}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Mode"),30, 74);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Man"),159, 74);
    g.setTransform(save);
  }
