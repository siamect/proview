...
public class JopcCompmoded extends JopFrame implements JopUtilityIfc {
  ...
  public JopcCompmoded( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter3.setBounds(new Rectangle(21,79,46,19));
    ...
    pwr_indround4.setBounds(new Rectangle(82,82,16,15));
    ...
    pwr_indround5.setBounds(new Rectangle(82,104,16,16));
    ...
    pwr_mbopenobject8.setBounds(new Rectangle(191,26,18,18));
    ...
    pwr_mbtrend9.setBounds(new Rectangle(52,26,18,18));
    ...
    pwr_mbfast10.setBounds(new Rectangle(72,26,18,18));
    ...
    pwr_mbphoto11.setBounds(new Rectangle(92,26,18,18));
    ...
    pwr_mbdatasheet12.setBounds(new Rectangle(112,26,18,18));
    ...
    pwr_mbopenplc13.setBounds(new Rectangle(211,26,18,18));
    ...
    pwr_mbcircuitdiagram14.setBounds(new Rectangle(231,26,18,18));
    ...
    pwr_mbrtnavigator15.setBounds(new Rectangle(171,26,18,18));
    ...
    pwr_mbhelpclass16.setBounds(new Rectangle(251,26,18,18));
    ...
    pwr_mbblockevents17.setBounds(new Rectangle(151,26,18,18));
    ...
    pwr_indround22.setBounds(new Rectangle(199,83,16,16));
    ...
    pwr_menubar223.setBounds(new Rectangle(2,1,304,22));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(10,1,42,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(54,1,67,22));
    ...
    grp166_27.setBounds(new Rectangle(23,127,35,16));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(128,80,59,19));
    ...
    grp182_30.setBounds(new Rectangle(22,104,39,16));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(21,103,46,19));
    ...
    pwr_mbup32.setBounds(new Rectangle(279,26,18,18));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Mode"),27, 71);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Start"),139, 93);
    g.setTransform(save);
  }
