...
public class JopcBasemotorincrdecraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay4.setBounds(new Rectangle(248,372,38,27));
    ...
    pwr_indsquare7.setBounds(new Rectangle(150,346,16,16));
    ...
    jopSmallbutton13.setBounds(new Rectangle(154,193,62,21));
    ...
    jopSmallbutton30.setBounds(new Rectangle(4,549,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,548,336,23));
    ...
    pwr_contactor235.setBounds(new Rectangle(248,336,38,38));
    ...
    grp166_45.setBounds(new Rectangle(42,217,35,18));
    ...
    pwr_contactor257.setBounds(new Rectangle(305,336,38,38));
    ...
    pwr_indsquare59.setBounds(new Rectangle(211,346,16,16));
    ...
    jopSmallbutton13.dd.setActionType(34);
    jopSmallbutton13.dd.setAccess(65532);
    jopSmallbutton13.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton13.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynStoDig(jopSmallbutton13.dd, "$object.Mode.OpManDecr##Boolean")
      });
    jopSmallbutton13.setAnnot1("  Decr");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu41.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu41.dd, "open graph /class /inst=$object.ContactorIncr.Order")
      }),
null,    new GeDyn(pwr_pulldownmenu41,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu41.dd, "$object.ContactorIncr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu41.dd, "open graph /class /inst=$object.ContactorIncr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu41,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu41.dd, "open graph /class /inst=$object.ContactorDecr.Order")
      }),
    new GeDyn(pwr_pulldownmenu41,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu41.dd, "$object.ContactorDecr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu41.dd, "open graph /class /inst=$object.ContactorDecr.Feedback")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu43.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu43.dd, "open graph /class /inst=$object.ContactorIncr")
      }),
null,    new GeDyn(pwr_pulldownmenu43,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu43.dd, "open graph /class /inst=$object.ContactorDecr")
      }),
    new GeDyn(pwr_pulldownmenu43,1,65,65535,new GeDynElemIfc[] {
