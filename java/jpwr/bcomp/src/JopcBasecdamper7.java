...
public class JopcBasecdamper7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_sliderbackground1_2	pwr_sliderbackground1_246;
  pwr_slider1	pwr_slider147;
  pwr_valueinputsmallrd	pwr_valueinputsmallrd48;
  pwr_indsquare	pwr_indsquare50;
  Grp167_	grp167_51;
  pwr_mbsimulate	pwr_mbsimulate52;
  pwr_actuator	pwr_actuator53;
  ...
  pwr_basedamper	pwr_basedamper62;
  pwr_dampercontrol2	pwr_dampercontrol263;
  pwr_mbup	pwr_mbup64;
  pwr_indsquare	pwr_indsquare66;
  public JopcBasecdamper7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecdamper7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecdamper7");
    ...
    jopBar38.setBounds(new Rectangle(357,134,20,238));
    jopBar38.setFillColor(39);
    jopBar38.setBorderColor(0);
    jopBar38.setFillColorBar(167);
    jopBar38.setBorderColorBar(161);
    ...
    jopBar39.setBounds(new Rectangle(411,134,20,238));
    jopBar39.setFillColor(58);
    jopBar39.setBorderColor(0);
    jopBar39.setFillColorBar(105);
    jopBar39.setBorderColorBar(101);
    ...
    jopAxis40.setBounds(new Rectangle(327,134,11,238));
    ...
    pwr_valuesmall41.setBounds(new Rectangle(398,392,48,15));
    ...
    pwr_smallbuttoncenter42.setBounds(new Rectangle(37,366,46,19));
    ...
    pwr_indround43.setBounds(new Rectangle(97,345,16,16));
    ...
    pwr_indround44.setBounds(new Rectangle(97,367,16,16));
    pwr_indround44.setShadow(1);
    localPanel.add(pwr_indround44, new Proportion(pwr_indround44.getBounds(), dsize));
    pwr_sliderbackground1_246 = new pwr_sliderbackground1_2(session);
    pwr_sliderbackground1_246.setBounds(new Rectangle(475,120,32,267));
    pwr_sliderbackground1_246.setShadow(1);
    localPanel.add(pwr_sliderbackground1_246, new Proportion(pwr_sliderbackground1_246.getBounds(), dsize));
    pwr_slider147 = new pwr_slider1(session);
    pwr_slider147.setBounds(new Rectangle(479,302,32,30));
    localPanel.add(pwr_slider147, new Proportion(pwr_slider147.getBounds(), dsize));
    pwr_valueinputsmallrd48 = new pwr_valueinputsmallrd(session);
    pwr_valueinputsmallrd48.setBounds(new Rectangle(465,389,54,22));
    pwr_valueinputsmallrd48.setShadow(1);
    localPanel.add(pwr_valueinputsmallrd48, new Proportion(pwr_valueinputsmallrd48.getBounds(), dsize));
    pwr_indsquare50 = new pwr_indsquare(session);
    pwr_indsquare50.setBounds(new Rectangle(166,228,13,15));
    pwr_indsquare50.setFillColor(176);
    pwr_indsquare50.setShadow(1);
    localPanel.add(pwr_indsquare50, new Proportion(pwr_indsquare50.getBounds(), dsize));
    grp167_51 = new Grp167_(session);
    grp167_51.setBounds(new Rectangle(473,107,42,16));
    localPanel.add(grp167_51, new Proportion(grp167_51.getBounds(), dsize));
    pwr_mbsimulate52 = new pwr_mbsimulate(session);
    pwr_mbsimulate52.setBounds(new Rectangle(509,25,18,18));
    localPanel.add(pwr_mbsimulate52, new Proportion(pwr_mbsimulate52.getBounds(), dsize));
    pwr_actuator53 = new pwr_actuator(session);
    pwr_actuator53.setBounds(new Rectangle(261,454,130,82));
    pwr_actuator53.setShadow(1);
    localPanel.add(pwr_actuator53, new Proportion(pwr_actuator53.getBounds(), dsize));
    pwr_pulldownmenu256 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu256.setBounds(new Rectangle(161,1,67,22));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround58.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_59 = new Grp175_(session);
    grp175_59.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_59, new Proportion(grp175_59.getBounds(), dsize));
    pwr_indsquare60 = new pwr_indsquare(session);
    pwr_indsquare60.setBounds(new Rectangle(183,488,14,14));
    ...
    pwr_basedamper62 = new pwr_basedamper(session);
    pwr_basedamper62.setBounds(new Rectangle(281,535,89,100));
    localPanel.add(pwr_basedamper62, new Proportion(pwr_basedamper62.getBounds(), dsize));
    pwr_dampercontrol263 = new pwr_dampercontrol2(session);
    pwr_dampercontrol263.setBounds(new Rectangle(102,103,62,57));
    pwr_dampercontrol263.setShadow(1);
    localPanel.add(pwr_dampercontrol263, new Proportion(pwr_dampercontrol263.getBounds(), dsize));
    pwr_mbup64 = new pwr_mbup(session);
    pwr_mbup64.setBounds(new Rectangle(488,25,18,18));
    localPanel.add(pwr_mbup64, new Proportion(pwr_mbup64.getBounds(), dsize));
    pwr_indsquare66 = new pwr_indsquare(session);
    pwr_indsquare66.setBounds(new Rectangle(167,260,14,15));
    pwr_indsquare66.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu230.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu230.dd, new String[] {
        JopLang.transl("Position Ai"),JopLang.transl("Order Ao"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar38.setPwrAttribute("$object.Actuator.Position.ActualValue##Float32");
    ...
    jopBar39.setPwrAttribute("$object.Actuator.Order.ActualValue##Float32");
    jopBar39.setMinValueAttr("$object.Actuator.Order.PresMinLimit##Float32");
    jopBar39.setMaxValueAttr("$object.Actuator.Order.PresMaxLimit##Float32");
    pwr_valuesmall41.dd.setDynType(1025);
    pwr_valuesmall41.dd.setActionType(2);
    pwr_valuesmall41.dd.setAccess(65532);
    pwr_valuesmall41.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall41.dd, "$object.Actuator.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall41.dd, "$object.Actuator.Order")
      });
    pwr_smallbuttoncenter42.dd.setDynType(129);
    pwr_smallbuttoncenter42.dd.setActionType(4);
    pwr_smallbuttoncenter42.dd.setAccess(65532);
    pwr_smallbuttoncenter42.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter42.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter42.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter42.setAnnot1("Auto");
    ...
    pwr_indround44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround44.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround44.dd, "!$object.Actuator.Mode.ManMode##Boolean",29)
      });
    pwr_sliderbackground1_246.dd.setDynType(524417);
    pwr_sliderbackground1_246.dd.setActionType(0);
    pwr_sliderbackground1_246.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_246.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_slider147.dd.setDynType(129);
    pwr_slider147.dd.setActionType(2048);
    pwr_slider147.dd.setAccess(65532);
    pwr_slider147.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider147.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider147.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,527.029,685.913)
      });
    pwr_valueinputsmallrd48.dd.setDynType(1153);
    pwr_valueinputsmallrd48.dd.setActionType(4096);
    pwr_valueinputsmallrd48.dd.setAccess(65532);
    pwr_valueinputsmallrd48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd48.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd48.dd, "$object.Actuator.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd48.dd, 0,0,"$object.Actuator.Mode.OpMinRefMan##Float32","$object.Actuator.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputsmallrd48.setAnnot1Font(pwr_valueinputsmallrd48.annotFont.deriveFont((float)10));
    pwr_indsquare50.dd.setDynType(5);
    pwr_indsquare50.dd.setActionType(0);
    pwr_indsquare50.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare50.dd, "$object.Actuator.DiffPosError##Boolean",29)
      });
    grp167_51.dd.setDynType(129);
    grp167_51.dd.setActionType(0);
    grp167_51.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_51.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_actuator53.dd.setDynType(1);
    pwr_actuator53.dd.setActionType(66);
    pwr_actuator53.dd.setAccess(65532);
    pwr_actuator53.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator53.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator53.dd, "open graph/class/inst=$object.Actuator")
      });
    ...
    pwr_pulldownmenu256.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu256.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu256,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu256.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu256,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu256.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu256.setAnnot1("Components");
    pwr_smallbuttoncenter57.dd.setDynType(128);
    ...
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter57.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter57.setAnnot1("Man");
    pwr_indround58.dd.setDynType(133);
    pwr_indround58.dd.setActionType(0);
    pwr_indround58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround58.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround58.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_59.dd.setDynType(129);
    grp175_59.dd.setActionType(0);
    grp175_59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_59.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare60.dd.setDynType(13);
    pwr_indsquare60.dd.setActionType(0);
    pwr_indsquare60.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare60.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare60.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    pwr_basedamper62.dd.setDynType(16384);
    pwr_basedamper62.dd.setActionType(66);
    pwr_basedamper62.dd.setAccess(65532);
    pwr_basedamper62.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basedamper62.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basedamper62.dd, "$object.Damper")
      ,new GeDynCommand(pwr_basedamper62.dd, "open graph/class/inst=$object.Damper")
      });
    pwr_dampercontrol263.dd.setDynType(19504);
    pwr_dampercontrol263.dd.setActionType(0);
    pwr_dampercontrol263.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_dampercontrol263.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_dampercontrol263.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynAnalogColor(pwr_dampercontrol263.dd, "$object.Actuator.PosEnum##Int32",1,4,30)
      ,new GeDynValue(pwr_dampercontrol263.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_dampercontrol263.dd, "$object.Actuator.PosEnum##Int32")
      });
    ...
    pwr_indsquare66.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare66.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(44F, 143F, 143F, 7F),
    new Polygon( new int[] { 44, 187, 185, 46, 46, 44}, new int[] { 143, 143, 145, 145, 148, 150}, 6), 
    new Polygon( new int[] { 187, 187, 185, 185, 46, 44}, new int[] { 150, 143, 145, 148, 148, 150}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Damper"),98, 601);
    {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 271);
    g.setTransform(save);
  }
