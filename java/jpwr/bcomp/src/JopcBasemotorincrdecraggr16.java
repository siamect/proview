...
public class JopcBasemotorincrdecraggr16 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_smallbuttoncenter	pwr_smallbuttoncenter10;
  pwr_indround	pwr_indround11;
  pwr_indround	pwr_indround12;
  pwr_mbopenobject	pwr_mbopenobject14;
  pwr_mbtrend	pwr_mbtrend15;
  pwr_mbfast	pwr_mbfast16;
  pwr_mbphoto	pwr_mbphoto17;
  pwr_mbdatasheet	pwr_mbdatasheet18;
  pwr_mbopenplc	pwr_mbopenplc19;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram20;
  pwr_mbrtnavigator	pwr_mbrtnavigator21;
  pwr_mbhelpclass	pwr_mbhelpclass22;
  pwr_mbblockevents	pwr_mbblockevents23;
  pwr_mbhistevent	pwr_mbhistevent24;
  pwr_mbnote	pwr_mbnote25;
  pwr_mbhelp	pwr_mbhelp26;
  ...
  pwr_mbsimulate	pwr_mbsimulate50;
  pwr_indsquare	pwr_indsquare51;
  Grp173_	grp173_52;
  pwr_indsquare	pwr_indsquare53;
  pwr_motorman	pwr_motorman55;
  pwr_rodcouplinganim	pwr_rodcouplinganim56;
  pwr_contactor2	pwr_contactor257;
  pwr_indsquare	pwr_indsquare59;
  pwr_indround	pwr_indround60;
  pwr_indsquare	pwr_indsquare61;
  pwr_indsquare	pwr_indsquare62;
  Grp190_	grp190_66;
  Grp199_	grp199_68;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcBasemotorincrdecraggr16( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr16( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr16");
    pwr_overloadrelay2 = new pwr_overloadrelay(session);
    pwr_overloadrelay2.setBounds(new Rectangle(249,330,36,25));
    pwr_overloadrelay2.setFillColor(32);
    ...
    pwr_indsquare5.setBounds(new Rectangle(151,304,14,15));
    ...
    pwr_indsquare8.setBounds(new Rectangle(151,374,14,15));
    ...
    pwr_smallbuttoncenter10 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter10.setBounds(new Rectangle(41,169,46,19));
    pwr_smallbuttoncenter10.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter10, new Proportion(pwr_smallbuttoncenter10.getBounds(), dsize));
    pwr_indround11 = new pwr_indround(session);
    pwr_indround11.setBounds(new Rectangle(101,173,16,16));
    ...
    pwr_indround12.setBounds(new Rectangle(101,195,16,16));
    pwr_indround12.setShadow(1);
    localPanel.add(pwr_indround12, new Proportion(pwr_indround12.getBounds(), dsize));
    pwr_mbopenobject14 = new pwr_mbopenobject(session);
    pwr_mbopenobject14.setBounds(new Rectangle(195,25,18,18));
    pwr_mbopenobject14.setShadow(1);
    localPanel.add(pwr_mbopenobject14, new Proportion(pwr_mbopenobject14.getBounds(), dsize));
    pwr_mbtrend15 = new pwr_mbtrend(session);
    pwr_mbtrend15.setBounds(new Rectangle(56,25,18,18));
    pwr_mbtrend15.setShadow(1);
    localPanel.add(pwr_mbtrend15, new Proportion(pwr_mbtrend15.getBounds(), dsize));
    pwr_mbfast16 = new pwr_mbfast(session);
    pwr_mbfast16.setBounds(new Rectangle(76,25,18,18));
    pwr_mbfast16.setShadow(1);
    localPanel.add(pwr_mbfast16, new Proportion(pwr_mbfast16.getBounds(), dsize));
    pwr_mbphoto17 = new pwr_mbphoto(session);
    pwr_mbphoto17.setBounds(new Rectangle(96,25,18,18));
    pwr_mbphoto17.setShadow(1);
    localPanel.add(pwr_mbphoto17, new Proportion(pwr_mbphoto17.getBounds(), dsize));
    pwr_mbdatasheet18 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet18.setBounds(new Rectangle(116,25,18,18));
    pwr_mbdatasheet18.setShadow(1);
    localPanel.add(pwr_mbdatasheet18, new Proportion(pwr_mbdatasheet18.getBounds(), dsize));
    pwr_mbopenplc19 = new pwr_mbopenplc(session);
    pwr_mbopenplc19.setBounds(new Rectangle(215,25,18,18));
    pwr_mbopenplc19.setShadow(1);
    localPanel.add(pwr_mbopenplc19, new Proportion(pwr_mbopenplc19.getBounds(), dsize));
    pwr_mbcircuitdiagram20 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram20.setBounds(new Rectangle(235,25,18,18));
    pwr_mbcircuitdiagram20.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram20, new Proportion(pwr_mbcircuitdiagram20.getBounds(), dsize));
    pwr_mbrtnavigator21 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator21.setBounds(new Rectangle(175,25,18,18));
    pwr_mbrtnavigator21.setShadow(1);
    localPanel.add(pwr_mbrtnavigator21, new Proportion(pwr_mbrtnavigator21.getBounds(), dsize));
    pwr_mbhelpclass22 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass22.setBounds(new Rectangle(255,25,18,18));
    pwr_mbhelpclass22.setShadow(1);
    localPanel.add(pwr_mbhelpclass22, new Proportion(pwr_mbhelpclass22.getBounds(), dsize));
    pwr_mbblockevents23 = new pwr_mbblockevents(session);
    pwr_mbblockevents23.setBounds(new Rectangle(155,25,18,18));
    pwr_mbblockevents23.setShadow(1);
    localPanel.add(pwr_mbblockevents23, new Proportion(pwr_mbblockevents23.getBounds(), dsize));
    pwr_mbhistevent24 = new pwr_mbhistevent(session);
    pwr_mbhistevent24.setBounds(new Rectangle(136,25,18,18));
    localPanel.add(pwr_mbhistevent24, new Proportion(pwr_mbhistevent24.getBounds(), dsize));
    pwr_mbnote25 = new pwr_mbnote(session);
    pwr_mbnote25.setBounds(new Rectangle(36,25,17,18));
    localPanel.add(pwr_mbnote25, new Proportion(pwr_mbnote25.getBounds(), dsize));
    pwr_mbhelp26 = new pwr_mbhelp(session);
    pwr_mbhelp26.setBounds(new Rectangle(17,25,18,18));
    localPanel.add(pwr_mbhelp26, new Proportion(pwr_mbhelp26.getBounds(), dsize));
    pwr_indround27 = new pwr_indround(session);
    pwr_indround27.setBounds(new Rectangle(101,217,16,16));
    pwr_indround27.setFillColor(114);
    ...
    pwr_valuelong28.setBounds(new Rectangle(17,69,367,20));
    ...
    pwr_smallbuttoncenter29.setBounds(new Rectangle(5,544,45,19));
    ...
    pwr_valuelong30.setBounds(new Rectangle(61,543,334,21));
    ...
    pwr_indsquare31.setBounds(new Rectangle(349,97,14,15));
    ...
    pwr_indround33.setBounds(new Rectangle(227,174,16,16));
    pwr_indround33.setFillColor(294);
    ...
    pwr_contactor234.setBounds(new Rectangle(249,294,36,36));
    pwr_contactor234.setFillColor(32);
    ...
    pwr_safetyswitch35.setBounds(new Rectangle(249,364,36,37));
    pwr_safetyswitch35.setFillColor(32);
    ...
    pwr_menubar238 = new pwr_menubar2(session);
    pwr_menubar238.setBounds(new Rectangle(1,1,407,22));
    pwr_menubar238.setShadow(1);
    localPanel.add(pwr_menubar238, new Proportion(pwr_menubar238.getBounds(), dsize));
    pwr_pulldownmenu239 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu239.setBounds(new Rectangle(9,1,42,22));
    ...
    pwr_pulldownmenu240.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu241.setBounds(new Rectangle(221,1,67,22));
    ...
    pwr_pulldownmenu242.setBounds(new Rectangle(53,1,67,22));
    ...
    pwr_pulldownmenu243.setBounds(new Rectangle(125,1,86,22));
    ...
    pwr_valuesmall47.setBounds(new Rectangle(304,247,69,16));
    localPanel.add(pwr_valuesmall47, new Proportion(pwr_valuesmall47.getBounds(), dsize));
    pwr_mbsimulate50 = new pwr_mbsimulate(session);
    pwr_mbsimulate50.setBounds(new Rectangle(364,25,17,18));
    localPanel.add(pwr_mbsimulate50, new Proportion(pwr_mbsimulate50.getBounds(), dsize));
    pwr_indsquare51 = new pwr_indsquare(session);
    pwr_indsquare51.setBounds(new Rectangle(151,400,14,14));
    pwr_indsquare51.setFillColor(294);
    pwr_indsquare51.setShadow(1);
    localPanel.add(pwr_indsquare51, new Proportion(pwr_indsquare51.getBounds(), dsize));
    grp173_52 = new Grp173_(session);
    grp173_52.setBounds(new Rectangle(35,400,38,16));
    localPanel.add(grp173_52, new Proportion(grp173_52.getBounds(), dsize));
    pwr_indsquare53 = new pwr_indsquare(session);
    pwr_indsquare53.setBounds(new Rectangle(151,336,14,14));
    pwr_indsquare53.setShadow(1);
    localPanel.add(pwr_indsquare53, new Proportion(pwr_indsquare53.getBounds(), dsize));
    pwr_motorman55 = new pwr_motorman(session);
    pwr_motorman55.setBounds(new Rectangle(102,96,62,42));
    pwr_motorman55.setShadow(1);
    pwr_motorman55.setGradient(12);
    localPanel.add(pwr_motorman55, new Proportion(pwr_motorman55.getBounds(), dsize));
    pwr_rodcouplinganim56 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim56.setBounds(new Rectangle(169,465,10,20));
    pwr_rodcouplinganim56.setShadow(1);
    localPanel.add(pwr_rodcouplinganim56, new Proportion(pwr_rodcouplinganim56.getBounds(), dsize));
    pwr_contactor257 = new pwr_contactor2(session);
    pwr_contactor257.setBounds(new Rectangle(306,294,36,36));
    pwr_contactor257.setFillColor(32);
    pwr_contactor257.setShadow(1);
    localPanel.add(pwr_contactor257, new Proportion(pwr_contactor257.getBounds(), dsize));
    pwr_indsquare59 = new pwr_indsquare(session);
    pwr_indsquare59.setBounds(new Rectangle(212,304,14,15));
    ...
    pwr_indround60.setBounds(new Rectangle(227,196,16,15));
    ...
    pwr_indsquare61.setBounds(new Rectangle(277,174,14,15));
    ...
    pwr_indsquare62 = new pwr_indsquare(session);
    pwr_indsquare62.setBounds(new Rectangle(277,197,14,15));
    pwr_indsquare62.setFillColor(294);
    pwr_indsquare62.setShadow(1);
    localPanel.add(pwr_indsquare62, new Proportion(pwr_indsquare62.getBounds(), dsize));
    grp190_66 = new Grp190_(session);
    grp190_66.setBounds(new Rectangle(261,149,85,16));
    localPanel.add(grp190_66, new Proportion(grp190_66.getBounds(), dsize));
    grp199_68 = new Grp199_(session);
    grp199_68.setBounds(new Rectangle(43,195,38,16));
    localPanel.add(grp199_68, new Proportion(grp199_68.getBounds(), dsize));
    pwr_smallbuttoncenter69 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter69.setBounds(new Rectangle(41,194,46,19));
    ...
    pwr_smallbuttoncenter74.setBounds(new Rectangle(141,170,78,19));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(141,194,78,19));
    ...
    pwr_smallbuttoncenter76.setBounds(new Rectangle(141,217,78,19));
    ...
    pwr_smallbuttoncenter77.setBounds(new Rectangle(142,194,78,19));
    ...
    pwr_smallbuttoncenter78.setBounds(new Rectangle(142,170,78,19));
    ...
    pwr_mbup79 = new pwr_mbup(session);
    pwr_mbup79.setBounds(new Rectangle(345,25,17,18));
    localPanel.add(pwr_mbup79, new Proportion(pwr_mbup79.getBounds(), dsize));
    ...
    pwr_indsquare5.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare5.dd, "$object.ContactorIncr.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare5.dd, "$object.ContactorIncr.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare5.dd, "$object.ContactorIncr.Feedback")
      });
    ...
    pwr_smallbuttoncenter10.dd.setDynType(129);
    pwr_smallbuttoncenter10.dd.setActionType(6);
    pwr_smallbuttoncenter10.dd.setAccess(65532);
    pwr_smallbuttoncenter10.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter10.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter10.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter10.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter10.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter10.setAnnot1("Man");
    ...
    pwr_mbopenobject14.dd.setDynType(129);
    pwr_mbopenobject14.dd.setActionType(8256);
    pwr_mbopenobject14.dd.setAccess(65532);
    pwr_mbopenobject14.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject14.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject14.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject14.dd, JopLang.transl("Open Object"))
      });
    pwr_mbtrend15.dd.setDynType(129);
    pwr_mbtrend15.dd.setActionType(8256);
    pwr_mbtrend15.dd.setAccess(65532);
    pwr_mbtrend15.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend15.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend15.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend15.dd, JopLang.transl("Trend"))
      });
    pwr_mbfast16.dd.setDynType(129);
    pwr_mbfast16.dd.setActionType(8256);
    pwr_mbfast16.dd.setAccess(65532);
    pwr_mbfast16.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast16.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast16.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast16.dd, JopLang.transl("Fast"))
      });
    pwr_mbphoto17.dd.setDynType(129);
    pwr_mbphoto17.dd.setActionType(8256);
    pwr_mbphoto17.dd.setAccess(65532);
    pwr_mbphoto17.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto17.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto17.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto17.dd, JopLang.transl("Photo"))
      });
    pwr_mbdatasheet18.dd.setDynType(129);
    pwr_mbdatasheet18.dd.setActionType(8256);
    pwr_mbdatasheet18.dd.setAccess(65532);
    pwr_mbdatasheet18.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet18.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet18.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet18.dd, JopLang.transl("DataSheet"))
      });
    pwr_mbopenplc19.dd.setDynType(129);
    pwr_mbopenplc19.dd.setActionType(8256);
    pwr_mbopenplc19.dd.setAccess(65532);
    pwr_mbopenplc19.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc19.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc19.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc19.dd, JopLang.transl("Open Plc"))
      });
    pwr_mbcircuitdiagram20.dd.setDynType(129);
    pwr_mbcircuitdiagram20.dd.setActionType(8256);
    pwr_mbcircuitdiagram20.dd.setAccess(65535);
    pwr_mbcircuitdiagram20.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram20.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram20.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram20.dd, JopLang.transl("CircuitDiagram"))
      });
    pwr_mbrtnavigator21.dd.setDynType(129);
    pwr_mbrtnavigator21.dd.setActionType(8256);
    pwr_mbrtnavigator21.dd.setAccess(65532);
    pwr_mbrtnavigator21.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator21.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator21.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator21.dd, JopLang.transl("RtNavigator"))
      });
    pwr_mbhelpclass22.dd.setDynType(129);
    pwr_mbhelpclass22.dd.setActionType(8256);
    pwr_mbhelpclass22.dd.setAccess(65532);
    pwr_mbhelpclass22.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass22.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass22.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass22.dd, JopLang.transl("Help Class"))
      });
    pwr_mbblockevents23.dd.setDynType(129);
    pwr_mbblockevents23.dd.setActionType(8256);
    pwr_mbblockevents23.dd.setAccess(65532);
    pwr_mbblockevents23.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents23.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents23.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents23.dd, JopLang.transl("Block Events"))
      });
    pwr_mbhistevent24.dd.setDynType(129);
    pwr_mbhistevent24.dd.setActionType(8256);
    pwr_mbhistevent24.dd.setAccess(65532);
    pwr_mbhistevent24.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent24.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent24.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent24.dd, JopLang.transl("Hist Event"))
      });
    pwr_mbnote25.dd.setDynType(129);
    pwr_mbnote25.dd.setActionType(8256);
    pwr_mbnote25.dd.setAccess(65532);
    pwr_mbnote25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote25.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote25.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote25.dd, JopLang.transl("Note"))
      });
    pwr_mbhelp26.dd.setDynType(128);
    pwr_mbhelp26.dd.setActionType(8256);
    pwr_mbhelp26.dd.setAccess(65532);
    pwr_mbhelp26.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp26.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp26.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp26.dd, JopLang.transl("Help"))
      });
    pwr_indround27.dd.setDynType(133);
    pwr_indround27.dd.setActionType(0);
    pwr_indround27.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround27.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround27.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    ...
    pwr_indsquare31.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_indsquare31.dd, "$object.Ready")
      });
    pwr_indround33.dd.setDynType(5);
    pwr_indround33.dd.setActionType(0);
    pwr_indround33.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround33.dd, "$object.Mode.FeedbackIncr##Boolean",29)
      });
    ...
    pwr_contactor234.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor234.dd, "$object.ContactorIncr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor234.dd, "$object.ContactorIncr")
      ,new GeDynCommand(pwr_contactor234.dd, "open graph /class/instance=$object.ContactorIncr")
      });
    ...
    pwr_menubar238.dd.setDynType(1);
    pwr_menubar238.dd.setActionType(0);
    pwr_pulldownmenu239.dd.setDynType(0);
    ...
    pwr_pulldownmenu239.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu239.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu239,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu239.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu239.setAnnot1("File");
    pwr_pulldownmenu240.dd.setDynType(1);
    pwr_pulldownmenu240.dd.setActionType(524288);
    pwr_pulldownmenu240.dd.setAccess(65532);
    pwr_pulldownmenu240.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu240,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu240.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu240.setAnnot1("Help");
    ...
    pwr_pulldownmenu241.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.ContactorIncr.Order")
      }),
null,    new GeDyn(pwr_pulldownmenu241,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu241.dd, "$object.ContactorIncr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.ContactorIncr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu241,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.ContactorDecr.Order")
      }),
    new GeDyn(pwr_pulldownmenu241,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu241.dd, "$object.ContactorDecr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.ContactorDecr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu241,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.OverloadRelay.Overload")
      }),
    new GeDyn(pwr_pulldownmenu241,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
    new GeDyn(pwr_pulldownmenu241,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu241.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu241,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu241.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu241.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu241.setAnnot1("Signals");
    ...
    pwr_pulldownmenu242.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu242,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu242.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu242.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu242.setAnnot1("Methods");
    ...
    pwr_pulldownmenu243.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu243.dd, new String[] {
        JopLang.transl("ContactorIncr"),null,JopLang.transl("ContactorDecr"),JopLang.transl("OverloadRelay"),JopLang.transl("SafetySwitch"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.ContactorIncr")
      }),
null,    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.ContactorDecr")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.OverloadRelay")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
    new GeDyn(pwr_pulldownmenu243,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu243.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu243.setAnnot1("Components");
    ...
    pwr_mbsimulate50.dd.setDynType(129);
    pwr_mbsimulate50.dd.setActionType(8256);
    pwr_mbsimulate50.dd.setAccess(65532);
    pwr_mbsimulate50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate50.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate50.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate50.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare51.dd.setDynType(176);
    pwr_indsquare51.dd.setActionType(2);
    pwr_indsquare51.dd.setAccess(65535);
    pwr_indsquare51.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare51.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare51.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare51.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare51.dd, "$object.Motor")
      });
    grp173_52.dd.setDynType(129);
    grp173_52.dd.setActionType(0);
    grp173_52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_52.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_indsquare53.dd.setDynType(16);
    pwr_indsquare53.dd.setActionType(2);
    pwr_indsquare53.dd.setAccess(65532);
    pwr_indsquare53.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare53.dd, "$object.OverloadRelay.Overload.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare53.dd, "$object.OverloadRelay.Overload")
      });
    pwr_motorman55.dd.setDynType(1077);
    pwr_motorman55.dd.setActionType(0);
    pwr_motorman55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman55.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman55.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman55.dd, "$object.IndRunning##Boolean",37)
      ,new GeDynValue(pwr_motorman55.dd, "$object.Mode.IndMode##String8","%s")
      });
    pwr_rodcouplinganim56.dd.setDynType(65537);
    pwr_rodcouplinganim56.dd.setActionType(0);
    pwr_rodcouplinganim56.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim56.dd, "$object.IndRunning##Boolean",1)
      });
    pwr_contactor257.dd.setDynType(32769);
    pwr_contactor257.dd.setActionType(66);
    pwr_contactor257.dd.setAccess(65535);
    pwr_contactor257.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor257.dd, "$object.ContactorDecr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor257.dd, "$object.ContactorDecr")
      ,new GeDynCommand(pwr_contactor257.dd, "open graph /class/instance=$object.ContactorDecr")
      });
    ...
    pwr_indsquare59.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare59.dd, "$object.ContactorDecr.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare59.dd, "$object.ContactorDecr.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare59.dd, "$object.ContactorDecr.Feedback")
      });
    pwr_indround60.dd.setDynType(5);
    pwr_indround60.dd.setActionType(0);
    pwr_indround60.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround60.dd, "$object.Mode.FeedbackDecr##Boolean",29)
      });
    ...
    pwr_indsquare61.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigColor(pwr_indsquare61.dd, "$object.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare61.dd, "$object.Mode.LimitSwitchIncr##Boolean",29)
      });
    pwr_indsquare62.dd.setDynType(141);
    pwr_indsquare62.dd.setActionType(0);
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare62.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare62.dd, "$object.Mode.ErrorDecr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare62.dd, "$object.Mode.LimitSwitchDecr##Boolean",29)
      });
    grp190_66.dd.setDynType(129);
    grp190_66.dd.setActionType(0);
    grp190_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp190_66.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      });
    grp199_68.dd.setDynType(129);
    grp199_68.dd.setActionType(0);
    grp199_68.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp199_68.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter69.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter69.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter69.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter69.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter69.setAnnot1("Auto");
    pwr_smallbuttoncenter74.dd.setDynType(129);
    pwr_smallbuttoncenter74.dd.setActionType(34);
    ...
    pwr_smallbuttoncenter74.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynStoDig(pwr_smallbuttoncenter74.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter74.setAnnot1("Forward");
    pwr_smallbuttoncenter75.dd.setDynType(129);
    pwr_smallbuttoncenter75.dd.setActionType(34);
    pwr_smallbuttoncenter75.dd.setAccess(65532);
    pwr_smallbuttoncenter75.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter75.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter75.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter75.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter75.dd, "$object.Mode.OpManStop")
      ,new GeDynStoDig(pwr_smallbuttoncenter75.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter75.setAnnot1("Backward");
    ...
    pwr_smallbuttoncenter76.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter76.dd, "$object.Mode.ManStopHide##Boolean",0)
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter76.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter76.setAnnot1("Stop");
    ...
    pwr_smallbuttoncenter77.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter77.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter77.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter77.setAnnot1("Backward");
    ...
    pwr_smallbuttoncenter78.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter78.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter78.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter78.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter78.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter78.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter78.setAnnot1("Forward");
    pwr_mbup79.dd.setDynType(129);
    pwr_mbup79.dd.setActionType(8256);
    pwr_mbup79.dd.setAccess(33619967);
    pwr_mbup79.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup79.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup79.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup79.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 565;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.6571F, 275.998F, 360.366F, 261.613F),
    new Polygon( new int[] { 20, 380, 379, 20, 20, 20}, new int[] { 276, 276, 277, 277, 537, 538}, 6), 
    new Polygon( new int[] { 380, 380, 379, 379, 20, 20}, new int[] { 538, 276, 277, 537, 537, 538}, 6), 
    ...
    new Polygon( new int[] { 20, 21, 148795405, -18}, new int[] { 146, 147, 147012095,0}, 4),
    ...
    new Line2D.Float( 227F, 441F, 257F, 441F),
    new Line2D.Float( 267F, 431F, 267F, 401F),
    new Arc2D.Float(247F, 421F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Line2D.Float( 227F, 441F, 257F, 441F),
    new Line2D.Float( 227F, 441F, 257F, 441F),
    new Line2D.Float( 267F, 431F, 267F, 401F),
    new Line2D.Float( 267F, 431F, 267F, 401F),
    new Arc2D.Float(247F, 421F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Arc2D.Float(247F, 421F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Line2D.Float( 267F, 366F, 267F, 355F),
    new Line2D.Float( 267F, 366F, 267F, 355F),
    new Line2D.Float( 267F, 366F, 267F, 355F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),37, 387);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Overload relay"),37, 348);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Backward"),147, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Forward"),147, 184);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
