...
public class JopcBasemotorincrdecraggr26 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton72.setBounds(new Rectangle(149,169,62,21));
    ...
    jopSmallbutton73.setBounds(new Rectangle(149,193,62,21));
    ...
    jopSmallbutton74.setBounds(new Rectangle(149,216,62,21));
    ...
    jopSmallbutton75.setBounds(new Rectangle(150,193,62,21));
    ...
    jopSmallbutton76.setBounds(new Rectangle(150,169,62,21));
