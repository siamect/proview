...
public class JopcBaseactuatorincrdecr extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp243_	grp243_57;
  pwr_mbup	pwr_mbup58;
  public JopcBaseactuatorincrdecr( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatorincrdecr( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatorincrdecr");
    pwr_valuelong4 = new pwr_valuelong(session);
    pwr_valuelong4.setBounds(new Rectangle(18,47,383,20));
    ...
    pwr_menubar25.setBounds(new Rectangle(1,1,421,22));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(349,1,67,22));
    ...
    pwr_mbdatasheet12.setBounds(new Rectangle(117,25,18,18));
    ...
    pwr_mbhelpclass16.setBounds(new Rectangle(256,25,18,18));
    ...
    pwr_mbhistevent18.setBounds(new Rectangle(137,25,18,18));
    ...
    pwr_mbhelp20.setBounds(new Rectangle(18,25,18,18));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(19,434,46,19));
    ...
    pwr_valuelong22.setBounds(new Rectangle(18,71,383,20));
    ...
    pwr_valuelong23.setBounds(new Rectangle(76,433,334,21));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(155,1,67,22));
    ...
    pwr_indsquare29.setBounds(new Rectangle(330,205,14,15));
    ...
    pwr_indsquare32.setBounds(new Rectangle(330,239,14,15));
    ...
    pwr_actuator33 = new pwr_actuator(session);
    pwr_actuator33.setBounds(new Rectangle(178,113,66,42));
    pwr_actuator33.setShadow(1);
    localPanel.add(pwr_actuator33, new Proportion(pwr_actuator33.getBounds(), dsize));
    pwr_smallbuttoncenter36 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter36.setBounds(new Rectangle(175,339,60,19));
    ...
    pwr_smallbuttoncenter37.setBounds(new Rectangle(39,338,46,19));
    ...
    pwr_indround38.setBounds(new Rectangle(99,342,16,16));
    ...
    pwr_indround39.setBounds(new Rectangle(99,364,16,16));
    ...
    pwr_smallbuttoncenter40.setBounds(new Rectangle(175,363,60,19));
    ...
    pwr_indround41.setBounds(new Rectangle(99,388,16,16));
    ...
    pwr_indround42.setBounds(new Rectangle(247,343,16,16));
    ...
    pwr_indsquare45.setBounds(new Rectangle(293,343,14,15));
    pwr_indsquare45.setFillColor(294);
    ...
    pwr_smallbuttoncenter46.setBounds(new Rectangle(175,386,60,19));
    ...
    pwr_indsquare47.setBounds(new Rectangle(293,366,14,14));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(175,363,60,19));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(175,339,60,19));
    ...
    grp207_50 = new Grp207_(session);
    grp207_50.setBounds(new Rectangle(41,364,39,16));
    localPanel.add(grp207_50, new Proportion(grp207_50.getBounds(), dsize));
    pwr_smallbuttoncenter51 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter51.setBounds(new Rectangle(39,363,46,19));
    ...
    pwr_indsquare55.setBounds(new Rectangle(138,186,14,15));
    ...
    pwr_indsquare56.setBounds(new Rectangle(139,205,14,15));
    ...
    grp243_57 = new Grp243_(session);
    grp243_57.setBounds(new Rectangle(280,312,48,16));
    localPanel.add(grp243_57, new Proportion(grp243_57.getBounds(), dsize));
    pwr_mbup58 = new pwr_mbup(session);
    pwr_mbup58.setBounds(new Rectangle(381,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare32.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare32.dd, "$object.SwitchError##Boolean",29)
      });
    pwr_actuator33.dd.setDynType(1);
    pwr_actuator33.dd.setActionType(0);
    ...
    pwr_smallbuttoncenter36.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter36.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter36.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter36.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter36.dd, "$object.Mode.OpManStart")
      ,new GeDynStoDig(pwr_smallbuttoncenter36.dd, "$object.Mode.OpManIncr##Boolean")
      });
    ...
    pwr_smallbuttoncenter37.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter37.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter37.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter37.dd, "$object.Mode.OpMan")
    ...
    pwr_indround38.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround38.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround38.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround39.dd.setDynType(133);
    pwr_indround39.dd.setActionType(0);
    pwr_indround39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround39.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround39.dd, "$object.Mode.AutoMode##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter40.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter40.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter40.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter40.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter40.dd, "$object.Mode.OpManStop")
      ,new GeDynStoDig(pwr_smallbuttoncenter40.dd, "$object.Mode.OpManDecr##Boolean")
      });
    ...
    pwr_indround41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround41.dd, "$object.Mode.LocalModHide##Boolean",0)
    ...
    pwr_indround42.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround42.dd, "$object.Mode.FeedbackIncr##Boolean",29)
      });
    grp203_43.dd.setDynType(129);
    grp203_43.dd.setActionType(0);
    grp203_43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp203_43.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    pwr_indround44.dd.setDynType(5);
    pwr_indround44.dd.setActionType(0);
    pwr_indround44.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround44.dd, "$object.Mode.FeedbackDecr##Boolean",29)
      });
    pwr_indsquare45.dd.setDynType(141);
    pwr_indsquare45.dd.setActionType(0);
    pwr_indsquare45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare45.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare45.dd, "$object.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare45.dd, "$object.Mode.LimitSwitchIncr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter46.dd, "$object.Mode.ManStopHide##Boolean",0)
    ...
    pwr_indsquare47.dd.setDynType(141);
    pwr_indsquare47.dd.setActionType(0);
    pwr_indsquare47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare47.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare47.dd, "$object.Mode.ErrorDecr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare47.dd, "$object.Mode.LimitSwitchDecr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter48.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter48.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter48.setAnnot1("Decr");
    ...
    pwr_smallbuttoncenter49.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter49.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter49.setAnnot1("Incr");
    grp207_50.dd.setDynType(129);
    grp207_50.dd.setActionType(0);
    grp207_50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp207_50.dd, "$object.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter51.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynInvisible(pwr_smallbuttoncenter51.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter51.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter51.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter51.setAnnot1("Auto");
    ...
    pwr_indsquare55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare55.dd, "$object.OrderIncr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare55.dd, "$object.OrderIncr")
      });
    ...
    pwr_indsquare56.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare56.dd, "$object.OrderDecr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare56.dd, "$object.OrderDecr")
      });
    grp243_57.dd.setDynType(128);
    grp243_57.dd.setActionType(0);
    grp243_57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp243_57.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(18.0003F, 304.139F, 381.885F, 121.555F),
    new Polygon( new int[] { 18, 400, 399, 19, 19, 18}, new int[] { 304, 304, 305, 305, 425, 426}, 6), 
    new Polygon( new int[] { 400, 400, 399, 399, 19, 18}, new int[] { 426, 304, 305, 425, 425, 426}, 6), 
    new Rectangle2D.Float(2F, 22.5515F, 419.853F, 22.4305F),
    new Line2D.Float( 398.206F, 329.042F, 18.6622F, 329.042F),
    new Rectangle2D.Float(18.0003F, 98.9982F, 381.885F, 197.211F),
    new Polygon( new int[] { 18, 400, 399, 19, 19, 18}, new int[] { 99, 99, 100, 100, 295, 296}, 6), 
    new Polygon( new int[] { 400, 400, 399, 399, 19, 18}, new int[] { 296, 99, 100, 295, 295, 296}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("SwitchOpen"),201, 199);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SwitchClosed"),201, 219);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch error"),201, 253);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Decr"),190, 375);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),190, 352);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order incr"),40, 199);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order decr"),40, 219);
    g.setTransform(save);
  }
