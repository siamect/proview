...
public class JopcBasemotorincrdecraggr42 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasemotorincrdecraggr42( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr42( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr42");
    ...
    jopSmallbutton70.setBounds(new Rectangle(150,169,62,21));
    ...
    jopSmallbutton71.setBounds(new Rectangle(150,193,62,21));
    ...
    jopSmallbutton72.setBounds(new Rectangle(150,216,62,21));
    ...
    jopSmallbutton73.setBounds(new Rectangle(151,193,62,21));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Close",162, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Open ",162, 184);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
