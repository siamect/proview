...
public class JopcBasemotorincrdecraggr42 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter71.setBounds(new Rectangle(151,169,62,21));
    ...
    pwr_smallbuttoncenter72.setBounds(new Rectangle(151,193,62,21));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(151,216,62,21));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 150648773, -18}, new int[] { 146, 147, 151362095,0}, 4),
