...
public class JopcBasemotoraggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(248,325,38,39));
    ...
    pwr_rodcouplinganim61.setBounds(new Rectangle(169,426,12,22));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980908, 3}, new int[] { 12, 15, -1219980850,61}, 4),
