...
public class JopcBasemotoraggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasemotoraggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr4");
    ...
    pwr_indsquare8.setBounds(new Rectangle(185,335,16,17));
    ...
    jopSmallbutton30.setBounds(new Rectangle(4,507,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,506,336,23));
    ...
    pwr_safetyswitch36.setBounds(new Rectangle(248,323,39,41));
    ...
    pwr_motor245.setBounds(new Rectangle(173,401,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(185,361,16,17));
    ...
    grp181_60 = new Grp181_(session);
    grp181_60.setBounds(new Rectangle(30,193,43,18));
    localPanel.add(grp181_60, new Proportion(grp181_60.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp181_60.dd.setDynType(129);
    grp181_60.dd.setActionType(0);
    grp181_60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp181_60.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
