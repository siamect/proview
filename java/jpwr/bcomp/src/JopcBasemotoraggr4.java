...
public class JopcBasemotoraggr4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(249,326,36,37));
    ...
    pwr_motor247.setBounds(new Rectangle(174,402,96,72));
    ...
    pwr_indsquare56.setBounds(new Rectangle(186,362,14,15));
    ...
    pwr_motorman60.setBounds(new Rectangle(102,96,62,42));
    pwr_motorman60.setShadow(1);
    pwr_motorman60.setGradient(12);
    ...
    pwr_rodcouplinganim61.setBounds(new Rectangle(170,427,10,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915372, 3}, new int[] { 12, 15, -1219915314,61}, 4),
