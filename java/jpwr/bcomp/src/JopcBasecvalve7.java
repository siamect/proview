...
public class JopcBasecvalve7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare50.setBounds(new Rectangle(165,223,15,17));
    ...
    pwr_basevalve54.setBounds(new Rectangle(285,533,80,122));
    ...
    pwr_valvecontrol264.setBounds(new Rectangle(110,115,66,43));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 2435, 34}, new int[] { 22, 27, -1219706437,-2147483648}, 4),
    ...
    new Polygon( new int[] { 42, 40, 2435, 34}, new int[] { 22, 27, -1219706437,42}, 4),
