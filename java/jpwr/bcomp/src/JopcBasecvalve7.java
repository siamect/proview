...
public class JopcBasecvalve7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valvecontrol2	pwr_valvecontrol264;
  pwr_mbup	pwr_mbup65;
  pwr_indsquare	pwr_indsquare67;
  public JopcBasecvalve7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare50.setBounds(new Rectangle(166,224,13,15));
    ...
    pwr_basevalve54 = new pwr_basevalve(session);
    pwr_basevalve54.setBounds(new Rectangle(286,534,78,120));
    pwr_basevalve54.setShadow(1);
    localPanel.add(pwr_basevalve54, new Proportion(pwr_basevalve54.getBounds(), dsize));
    ...
    pwr_valvecontrol264 = new pwr_valvecontrol2(session);
    pwr_valvecontrol264.setBounds(new Rectangle(111,116,64,41));
    pwr_valvecontrol264.setShadow(1);
    localPanel.add(pwr_valvecontrol264, new Proportion(pwr_valvecontrol264.getBounds(), dsize));
    pwr_mbup65 = new pwr_mbup(session);
    pwr_mbup65.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup65, new Proportion(pwr_mbup65.getBounds(), dsize));
    pwr_indsquare67 = new pwr_indsquare(session);
    pwr_indsquare67.setBounds(new Rectangle(167,260,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider147.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider147.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,535.042,685.913)
      });
    ...
    pwr_basevalve54.dd.setDynType(16385);
    pwr_basevalve54.dd.setActionType(66);
    pwr_basevalve54.dd.setAccess(65532);
    pwr_basevalve54.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve54.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve54.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve54.dd, "open graph/class/inst=$object.Valve")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valvecontrol264.dd.setDynType(1034);
    pwr_valvecontrol264.dd.setActionType(0);
    pwr_valvecontrol264.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol264.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol264.dd, "$object.Actuator.IndWarning##Boolean",30)
      ,new GeDynValue(pwr_valvecontrol264.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.38076F, 23.1001F, 534.661F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.38076F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.38076F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Position error"),38, 237);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 155, 34}, new int[] { 22, 27, -1219915333,18}, 4),
    ...
    new Polygon( new int[] { 42, 40, 155, 34}, new int[] { 22, 27, -1219915333,18}, 4),
