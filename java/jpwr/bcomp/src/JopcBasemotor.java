...
public class JopcBasemotor extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbsimulate	pwr_mbsimulate28;
  pwr_indsquare	pwr_indsquare30;
  pwr_mbup	pwr_mbup31;
  public JopcBasemotor( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotor( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter15.setBounds(new Rectangle(19,192,46,19));
    ...
    pwr_valuelong17.setBounds(new Rectangle(76,192,334,21));
    ...
    pwr_motor218.setBounds(new Rectangle(235,101,96,72));
    localPanel.add(pwr_motor218, new Proportion(pwr_motor218.getBounds(), dsize));
    pwr_indsquare20 = new pwr_indsquare(session);
    pwr_indsquare20.setBounds(new Rectangle(159,113,13,15));
    pwr_indsquare20.setFillColor(114);
    ...
    pwr_menubar222.setBounds(new Rectangle(1,1,407,22));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(251,1,67,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(71,1,67,22));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(147,1,87,22));
    pwr_pulldownmenu227.setShadow(1);
    localPanel.add(pwr_pulldownmenu227, new Proportion(pwr_pulldownmenu227.getBounds(), dsize));
    pwr_mbsimulate28 = new pwr_mbsimulate(session);
    pwr_mbsimulate28.setBounds(new Rectangle(374,25,18,18));
    localPanel.add(pwr_mbsimulate28, new Proportion(pwr_mbsimulate28.getBounds(), dsize));
    pwr_indsquare30 = new pwr_indsquare(session);
    pwr_indsquare30.setBounds(new Rectangle(160,174,14,15));
    ...
    pwr_mbup31.setBounds(new Rectangle(354,25,18,18));
    ...
    pwr_motor218.dd.setDynType(11);
    pwr_motor218.dd.setActionType(0);
    pwr_motor218.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_motor218.dd, "$object.OverTemp.ActualValue##Boolean",5)
      });
    pwr_indsquare20.dd.setDynType(21);
    pwr_indsquare20.dd.setActionType(0);
    pwr_indsquare20.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare20.dd, "$object.IndError##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare20.dd, "$object.IndWarning##Boolean",29)
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu225.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu225.dd, new String[] {
        JopLang.transl("TempSwitch.Switch Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu225,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu225.dd, "open graph /class /inst=$object.TempSwitch.Switch")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu225.setAnnot1("Signals");
    ...
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,65532,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu227.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu227.dd, new String[] {
        JopLang.transl("TempSwitch"),JopLang.transl("TempSensor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu227,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu227.dd, "$object.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu227.dd, "open graph /class /inst=$object.TempSwitch")
      }),
    new GeDyn(pwr_pulldownmenu227,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu227.dd, "$object.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu227.dd, "open graph /class /inst=$object.TempSensor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu227.setAnnot1("Components");
    pwr_mbsimulate28.dd.setDynType(129);
    pwr_mbsimulate28.dd.setActionType(8256);
    pwr_mbsimulate28.dd.setAccess(65532);
    pwr_mbsimulate28.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate28.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate28.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate28.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare30.dd.setDynType(5);
    pwr_indsquare30.dd.setActionType(0);
    pwr_indsquare30.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare30.dd, "$object.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(18F, 98F, 179.619F, 71.3333F),
    new Polygon( new int[] { 18, 198, 197, 19, 19, 18}, new int[] { 98, 98, 99, 99, 169, 169}, 6), 
    new Polygon( new int[] { 198, 198, 197, 197, 19, 18}, new int[] { 169, 98, 99, 169, 169, 169}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("OverTemperature"),36, 125);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("Supervision disabled"),36, 185);
    g.setTransform(save);
  }
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -18, -18}, new int[] { 12, 13, 27,-13}, 4),
