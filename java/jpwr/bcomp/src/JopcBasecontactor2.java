...
public class JopcBasecontactor2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor	pwr_contactor19;
  pwr_valuelong	pwr_valuelong22;
  pwr_contactor2	pwr_contactor223;
  ...
  Grp97_	grp97_30;
  pwr_mbup	pwr_mbup31;
  public JopcBasecontactor2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecontactor2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecontactor2");
    pwr_indsquare2 = new pwr_indsquare(session);
    pwr_indsquare2.setBounds(new Rectangle(131,116,13,14));
    ...
    pwr_valuelong3.setBounds(new Rectangle(15,40,364,20));
    ...
    pwr_mbopenobject4.setBounds(new Rectangle(193,19,17,17));
    ...
    pwr_mbtrend5.setBounds(new Rectangle(55,19,17,17));
    ...
    pwr_mbfast6.setBounds(new Rectangle(74,19,17,17));
    ...
    pwr_mbphoto7.setBounds(new Rectangle(94,19,17,17));
    ...
    pwr_mbdatasheet8.setBounds(new Rectangle(114,19,17,17));
    ...
    pwr_mbopenplc9.setBounds(new Rectangle(212,19,17,17));
    ...
    pwr_mbcircuitdiagram10.setBounds(new Rectangle(232,19,17,17));
    ...
    pwr_mbrtnavigator11.setBounds(new Rectangle(173,19,17,17));
    ...
    pwr_mbhelpclass12.setBounds(new Rectangle(252,19,17,17));
    ...
    pwr_mbblockevents13.setBounds(new Rectangle(153,19,17,17));
    ...
    pwr_smallbuttoncenter17.setBounds(new Rectangle(16,255,45,18));
    pwr_smallbuttoncenter17.setFillColor(102);
    pwr_smallbuttoncenter17.setBorderColor(37);
    ...
    pwr_valuelong18.setBounds(new Rectangle(15,64,364,20));
    pwr_valuelong18.setFillColor(31);
    pwr_valuelong18.setBorderColor(32);
    localPanel.add(pwr_valuelong18, new Proportion(pwr_valuelong18.getBounds(), dsize));
    pwr_contactor19 = new pwr_contactor(session);
    pwr_contactor19.setBounds(new Rectangle(87,168,38,63));
    localPanel.add(pwr_contactor19, new Proportion(pwr_contactor19.getBounds(), dsize));
    pwr_valuelong22 = new pwr_valuelong(session);
    pwr_valuelong22.setBounds(new Rectangle(73,255,331,20));
    ...
    pwr_contactor223 = new pwr_contactor2(session);
    pwr_contactor223.setBounds(new Rectangle(241,112,108,108));
    pwr_contactor223.setFillColor(32);
    pwr_contactor223.setShadow(1);
    localPanel.add(pwr_contactor223, new Proportion(pwr_contactor223.getBounds(), dsize));
    pwr_menubar224 = new pwr_menubar2(session);
    pwr_menubar224.setBounds(new Rectangle(0,-4,404,21));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(10,-4,67,21));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(325,-4,67,21));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(149,-4,67,21));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(68,-4,67,21));
    ...
    pwr_mbsimulate29.setBounds(new Rectangle(371,19,17,17));
    localPanel.add(pwr_mbsimulate29, new Proportion(pwr_mbsimulate29.getBounds(), dsize));
    grp97_30 = new Grp97_(session);
    grp97_30.setBounds(new Rectangle(31,115,57,16));
    localPanel.add(grp97_30, new Proportion(grp97_30.getBounds(), dsize));
    pwr_mbup31 = new pwr_mbup(session);
    pwr_mbup31.setBounds(new Rectangle(351,19,17,17));
    localPanel.add(pwr_mbup31, new Proportion(pwr_mbup31.getBounds(), dsize));
    pwr_indsquare2.dd.setDynType(141);
    pwr_indsquare2.dd.setActionType(2);
    pwr_indsquare2.dd.setAccess(65532);
    pwr_indsquare2.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare2.dd, "$object.DisableFeedback##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare2.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare2.dd, "$object.Feedback.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare2.dd, "$object.Feedback")
      });
    ...
    pwr_mbopenobject4.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenobject4.dd, JopLang.transl("Open Object"))
      });
    ...
    pwr_mbtrend5.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbtrend5.dd, JopLang.transl("Trend"))
      });
    ...
    pwr_mbfast6.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbfast6.dd, JopLang.transl("Fast"))
      });
    ...
    pwr_mbphoto7.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbphoto7.dd, JopLang.transl("Photo"))
      });
    ...
    pwr_mbdatasheet8.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbdatasheet8.dd, JopLang.transl("DataSheet"))
      });
    ...
    pwr_mbopenplc9.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenplc9.dd, JopLang.transl("Open Plc"))
      });
    ...
    pwr_mbcircuitdiagram10.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbcircuitdiagram10.dd, JopLang.transl("CircuitDiagram"))
      });
    ...
    pwr_mbrtnavigator11.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbrtnavigator11.dd, JopLang.transl("RtNavigator"))
      });
    ...
    pwr_mbhelpclass12.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelpclass12.dd, JopLang.transl("Help Class"))
      });
    ...
    pwr_mbblockevents13.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbblockevents13.dd, JopLang.transl("Block Events"))
      });
    ...
    pwr_mbhistevent14.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhistevent14.dd, JopLang.transl("Hist Event"))
      });
    ...
    pwr_mbnote15.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbnote15.dd, JopLang.transl("Note"))
      });
    ...
    pwr_mbhelp16.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelp16.dd, JopLang.transl("Help"))
      });
    pwr_smallbuttoncenter17.dd.setDynType(128);
    pwr_smallbuttoncenter17.dd.setActionType(64);
    pwr_smallbuttoncenter17.dd.setAccess(65532);
    pwr_smallbuttoncenter17.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter17.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter17.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter17.setAnnot1("Note !");
    ...
    pwr_contactor19.dd.setDynType(32769);
    pwr_contactor19.dd.setActionType(0);
    pwr_contactor19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor19.dd, "$object.Feedback.ActualValue##Boolean")
      });
    ...
    pwr_contactor223.dd.setDynType(32769);
    pwr_contactor223.dd.setActionType(0);
    pwr_contactor223.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor223.dd, "$object.Feedback.ActualValue##Boolean")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu227.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu227.dd, new String[] {
        JopLang.transl("FeedBack Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu227,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu227.dd, "open graph /class /inst=$object.FeedBack")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate29.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate29.dd, JopLang.transl("Open simulate graph"))
      });
    grp97_30.dd.setDynType(129);
    grp97_30.dd.setActionType(0);
    grp97_30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp97_30.dd, "$object.DisableFeedback##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(1.37996F, 16.9848F, 401.948F, 22.2593F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 1.37996F,39.2441F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        1.37996F,16.9848F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class Grp97_ extends GeComponent {
  // Dimension size;
  public Grp97_( JopSession session)
  {
    super( session);
    size = new Dimension( 59, 18);
  }
  public int original_width = 59;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Feedback"),2, 13);
    }
    if ( rounds == 2)
      g.setClip(null);
    g.setTransform(save);
