...
public class JopcBasemotoraggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,484,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,483,334,21));
    ...
    pwr_contactor235.setBounds(new Rectangle(249,307,36,36));
    ...
    pwr_motorman56.setBounds(new Rectangle(102,97,62,42));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(168,409,10,19));
    ...
    grp184_58.setBounds(new Rectangle(31,194,39,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915367, 8}, new int[] { 12, 15, -1219915343,32}, 4),
