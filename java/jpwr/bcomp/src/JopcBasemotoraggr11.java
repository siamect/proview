...
public class JopcBasemotoraggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp173_	grp173_52;
  pwr_fuse3	pwr_fuse353;
  pwr_motorman	pwr_motorman54;
  pwr_rodcouplinganim	pwr_rodcouplinganim55;
  Grp184_	grp184_56;
  JopSmallbutton	jopSmallbutton57;
  public JopcBasemotoraggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr11");
    pwr_indsquare5 = new pwr_indsquare(session);
    pwr_indsquare5.setBounds(new Rectangle(185,315,16,17));
    ...
    jopSmallbutton28.setBounds(new Rectangle(4,483,47,21));
    ...
    pwr_valuelong29.setBounds(new Rectangle(60,482,336,23));
    ...
    pwr_contactor233.setBounds(new Rectangle(248,306,38,38));
    ...
    pwr_motor242.setBounds(new Rectangle(173,383,98,74));
    ...
    pwr_indsquare51.setBounds(new Rectangle(185,343,16,16));
    ...
    grp173_52.setBounds(new Rectangle(69,343,38,17));
    localPanel.add(grp173_52, new Proportion(grp173_52.getBounds(), dsize));
    pwr_fuse353 = new pwr_fuse3(session);
    pwr_fuse353.setBounds(new Rectangle(259,263,15,37));
    pwr_fuse353.setRotate(-90);
    pwr_fuse353.setShadow(1);
    localPanel.add(pwr_fuse353, new Proportion(pwr_fuse353.getBounds(), dsize));
    pwr_motorman54 = new pwr_motorman(session);
    pwr_motorman54.setBounds(new Rectangle(101,96,64,44));
    ...
    pwr_rodcouplinganim55.setBounds(new Rectangle(167,408,12,21));
    ...
    grp184_56 = new Grp184_(session);
    grp184_56.setBounds(new Rectangle(30,193,43,18));
    localPanel.add(grp184_56, new Proportion(grp184_56.getBounds(), dsize));
...
null,null,    new GeDyn(pwr_pulldownmenu39,129,65,33619967,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu41,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse353.dd.setDynType(1);
    pwr_fuse353.dd.setActionType(0);
    ...
    pwr_motorman54.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman54.dd, "$object.Contactor.Feedback.ActualValue##Boolean",37)
    ...
    pwr_rodcouplinganim55.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim55.dd, "$object.Contactor.IndFeedback##Boolean",1)
      });
    grp184_56.dd.setDynType(129);
    grp184_56.dd.setActionType(0);
    grp184_56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp184_56.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
