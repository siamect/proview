...
public class JopcBasemanvalve2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_handwheel	pwr_handwheel29;
  pwr_basevalve2	pwr_basevalve230;
  pwr_mbsimulate	pwr_mbsimulate31;
  pwr_mbup	pwr_mbup32;
  public JopcBasemanvalve2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemanvalve2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemanvalve2");
    pwr_indsquare2 = new pwr_indsquare(session);
    pwr_indsquare2.setBounds(new Rectangle(134,122,13,15));
    pwr_indsquare2.setShadow(1);
    localPanel.add(pwr_indsquare2, new Proportion(pwr_indsquare2.getBounds(), dsize));
    pwr_valveanim4 = new pwr_valveanim(session);
    pwr_valveanim4.setBounds(new Rectangle(239,101,64,64));
    pwr_valveanim4.setFillColor(64);
    pwr_valveanim4.setShadow(1);
    localPanel.add(pwr_valveanim4, new Proportion(pwr_valveanim4.getBounds(), dsize));
    pwr_valuelong5 = new pwr_valuelong(session);
    pwr_valuelong5.setBounds(new Rectangle(17,47,367,20));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(18,442,45,19));
    ...
    pwr_valuelong22.setBounds(new Rectangle(73,441,334,21));
    ...
    pwr_valuelong23.setBounds(new Rectangle(17,71,367,20));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(13,1,67,22));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(153,1,67,22));
    ...
    pwr_handwheel29 = new pwr_handwheel(session);
    pwr_handwheel29.setBounds(new Rectangle(143,189,121,87));
    pwr_handwheel29.setShadow(1);
    localPanel.add(pwr_handwheel29, new Proportion(pwr_handwheel29.getBounds(), dsize));
    pwr_basevalve230 = new pwr_basevalve2(session);
    pwr_basevalve230.setBounds(new Rectangle(177,258,104,160));
    pwr_basevalve230.setShadow(1);
    localPanel.add(pwr_basevalve230, new Proportion(pwr_basevalve230.getBounds(), dsize));
    pwr_mbsimulate31 = new pwr_mbsimulate(session);
    pwr_mbsimulate31.setBounds(new Rectangle(372,25,18,18));
    localPanel.add(pwr_mbsimulate31, new Proportion(pwr_mbsimulate31.getBounds(), dsize));
    pwr_mbup32 = new pwr_mbup(session);
    pwr_mbup32.setBounds(new Rectangle(353,25,17,18));
    ...
    pwr_indsquare2.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare2.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare2.dd, "$object.SwitchClosed")
      });
    pwr_valveanim4.dd.setDynType(65545);
    pwr_valveanim4.dd.setActionType(0);
    pwr_valveanim4.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valveanim4.dd, "$object.SwitchClosed.ActualValue##Boolean",20)
      ,new GeDynAnimation(pwr_valveanim4.dd, "$object.SwitchClosed.ActualValue##Boolean",2)
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu227.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu227.dd, new String[] {
        JopLang.transl("SwitchClosed Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu227,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu227.dd, "open graph /class /inst=$object.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_handwheel29.dd.setDynType(1);
    pwr_handwheel29.dd.setActionType(0);
    pwr_basevalve230.dd.setDynType(32769);
    pwr_basevalve230.dd.setActionType(0);
    pwr_basevalve230.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_basevalve230.dd, "!$object.SwitchClosed.ActualValue##Boolean")
      });
    ...
    pwr_mbup32.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbup32.dd, JopLang.transl("Open parent object graph"))
      });
...
protected class pwr_valveanim extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 16, 19, 33,36}, 4),
    new Polygon( new int[] { 6, 10, 24, 26}, new int[] { 36, 33, 26,26}, 4),
    new Polygon( new int[] { 26, 24, 10, 6}, new int[] { 26, 26, 19,16}, 4),
    new Polygon( new int[] { 6, 10, 130, 41}, new int[] { 16, 19, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 46, 26, 46, 46}, new int[] {16, 26, 36, 16}, 4),
    new Polygon( new int[] { 46, 44, 32, 26}, new int[] { 16, 19, 26,26}, 4),
    new Polygon( new int[] { 26, 32, 44, 46}, new int[] { 26, 26, 33,36}, 4),
    new Polygon( new int[] { 46, 44, 44, 46}, new int[] { 36, 33, 19,16}, 4),
    new Polygon( new int[] { 46, 44, 130, 41}, new int[] { 16, 19, -1219915410,-34}, 4),
  };
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 9, 12, 9, 4}, new int[] { 11, 15, 27,30}, 4),
    new Polygon( new int[] { 4, 9, 24, 26}, new int[] { 30, 27, 25,26}, 4),
    new Polygon( new int[] { 26, 24, 12, 9}, new int[] { 26, 25, 15,11}, 4),
    new Polygon( new int[] { 9, 12, 130, 41}, new int[] { 11, 15, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 48, 26, 43, 48}, new int[] {22, 26, 41, 22}, 4),
    new Polygon( new int[] { 48, 45, 32, 26}, new int[] { 22, 25, 27,26}, 4),
    new Polygon( new int[] { 26, 32, 42, 43}, new int[] { 26, 27, 37,41}, 4),
    new Polygon( new int[] { 43, 42, 45, 48}, new int[] { 41, 37, 25,22}, 4),
    new Polygon( new int[] { 48, 45, 130, 41}, new int[] { 22, 25, -1219915410,-34}, 4),
  };
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 16, 8, 4}, new int[] { 7, 9, 24,25}, 4),
    new Polygon( new int[] { 4, 8, 26, 26}, new int[] { 25, 24, 25,26}, 4),
    new Polygon( new int[] { 26, 26, 16, 14}, new int[] { 26, 25, 9,7}, 4),
    new Polygon( new int[] { 14, 16, 130, 41}, new int[] { 7, 9, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 48, 26, 38, 48}, new int[] {27, 26, 45, 27}, 4),
    new Polygon( new int[] { 48, 46, 30, 26}, new int[] { 27, 28, 27,26}, 4),
    new Polygon( new int[] { 26, 30, 40, 38}, new int[] { 26, 27, 43,45}, 4),
    new Polygon( new int[] { 38, 40, 46, 48}, new int[] { 45, 43, 28,27}, 4),
    new Polygon( new int[] { 48, 46, 130, 41}, new int[] { 27, 28, -1219915410,-34}, 4),
  };
  ...
  Shape[] shapes_p4 = new Shape[] { 
    ...
    new Polygon( new int[] { 19, 20, 11, 5}, new int[] { 5, 9, 18,19}, 4),
    new Polygon( new int[] { 5, 11, 25, 26}, new int[] { 19, 18, 23,26}, 4),
    new Polygon( new int[] { 26, 25, 20, 19}, new int[] { 26, 23, 9,5}, 4),
    new Polygon( new int[] { 19, 20, 130, 41}, new int[] { 5, 9, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 47, 26, 33, 47}, new int[] {33, 26, 47, 33}, 4),
    new Polygon( new int[] { 47, 43, 31, 26}, new int[] { 33, 34, 29,26}, 4),
    new Polygon( new int[] { 26, 31, 36, 33}, new int[] { 26, 29, 43,47}, 4),
    new Polygon( new int[] { 33, 36, 43, 47}, new int[] { 47, 43, 34,33}, 4),
    new Polygon( new int[] { 47, 43, 130, 41}, new int[] { 33, 34, -1219915410,-34}, 4),
  };
  ...
  Shape[] shapes_p5 = new Shape[] { 
    ...
    new Polygon( new int[] { 25, 26, 11, 7}, new int[] { 4, 6, 14,14}, 4),
    new Polygon( new int[] { 7, 11, 27, 26}, new int[] { 14, 14, 24,26}, 4),
    new Polygon( new int[] { 26, 27, 26, 25}, new int[] { 26, 24, 6,4}, 4),
    new Polygon( new int[] { 25, 26, 130, 41}, new int[] { 4, 6, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 45, 26, 27, 45}, new int[] {38, 26, 48, 38}, 4),
    new Polygon( new int[] { 45, 43, 29, 26}, new int[] { 38, 38, 28,26}, 4),
    new Polygon( new int[] { 26, 29, 30, 27}, new int[] { 26, 28, 46,48}, 4),
    new Polygon( new int[] { 27, 30, 43, 45}, new int[] { 48, 46, 38,38}, 4),
    new Polygon( new int[] { 45, 43, 130, 41}, new int[] { 38, 38, -1219915410,-34}, 4),
  };
  ...
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 30, 29, 17, 11}, new int[] { 4, 7, 10,9}, 4),
    new Polygon( new int[] { 11, 17, 27, 26}, new int[] { 9, 10, 22,26}, 4),
    new Polygon( new int[] { 26, 27, 29, 30}, new int[] { 26, 22, 7,4}, 4),
    new Polygon( new int[] { 30, 29, 130, 41}, new int[] { 4, 7, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 41, 26, 22, 41}, new int[] {43, 26, 48, 43}, 4),
    new Polygon( new int[] { 41, 39, 29, 26}, new int[] { 43, 42, 31,26}, 4),
    new Polygon( new int[] { 26, 29, 27, 22}, new int[] { 26, 31, 45,48}, 4),
    new Polygon( new int[] { 22, 27, 39, 41}, new int[] { 48, 45, 42,43}, 4),
    new Polygon( new int[] { 41, 39, 130, 41}, new int[] { 43, 42, -1219915410,-2147483648}, 4),
  };
  ...
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 36, 35, 21, 16}, new int[] { 6, 8, 8,6}, 4),
    new Polygon( new int[] { 16, 21, 28, 26}, new int[] { 6, 8, 22,26}, 4),
    new Polygon( new int[] { 26, 28, 35, 36}, new int[] { 26, 22, 8,6}, 4),
    new Polygon( new int[] { 36, 35, 130, 41}, new int[] { 6, 8, -1219915410,-2147483648}, 4),
    new Polygon( new int[] { 36, 26, 16, 36}, new int[] {46, 26, 46, 46}, 4),
    new Polygon( new int[] { 36, 35, 28, 26}, new int[] { 46, 44, 30,26}, 4),
    new Polygon( new int[] { 26, 28, 21, 16}, new int[] { 26, 30, 44,46}, 4),
    new Polygon( new int[] { 16, 21, 35, 36}, new int[] { 46, 44, 44,46}, 4),
    new Polygon( new int[] { 36, 35, 130, 41}, new int[] { 46, 44, -1219915410,-2147483648}, 4),
  };
  public void paintComponent(Graphics g1) {
    switch ( page) {
      case 2 :
