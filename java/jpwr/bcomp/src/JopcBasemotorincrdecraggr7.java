...
public class JopcBasemotorincrdecraggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor255;
  ...
  pwr_mbup	pwr_mbup73;
  public JopcBasemotorincrdecraggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr7");
    ...
    pwr_indsquare7.setBounds(new Rectangle(151,304,14,15));
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(156,194,60,19));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,476,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,475,334,21));
    ...
    pwr_contactor235.setBounds(new Rectangle(249,294,36,36));
    ...
    pwr_motor244.setBounds(new Rectangle(174,371,96,72));
    ...
    pwr_indsquare51.setBounds(new Rectangle(151,332,14,14));
    ...
    grp173_52.setBounds(new Rectangle(35,332,38,16));
    ...
    pwr_rodcouplinganim54.setBounds(new Rectangle(169,397,10,19));
    ...
    pwr_contactor255 = new pwr_contactor2(session);
    pwr_contactor255.setBounds(new Rectangle(306,294,36,36));
    pwr_contactor255.setFillColor(32);
    pwr_contactor255.setShadow(1);
    localPanel.add(pwr_contactor255, new Proportion(pwr_contactor255.getBounds(), dsize));
    pwr_indsquare57 = new pwr_indsquare(session);
    pwr_indsquare57.setBounds(new Rectangle(212,304,14,15));
    ...
    pwr_indround58.setBounds(new Rectangle(227,196,16,15));
    ...
    pwr_indsquare59.setBounds(new Rectangle(277,174,14,15));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(156,217,60,19));
    ...
    pwr_indsquare61.setBounds(new Rectangle(277,197,14,15));
    ...
    grp190_65.setBounds(new Rectangle(261,149,85,16));
    ...
    pwr_smallbuttoncenter67.setBounds(new Rectangle(155,194,60,19));
    ...
    pwr_smallbuttoncenter68.setBounds(new Rectangle(155,170,60,19));
    ...
    grp199_69 = new Grp199_(session);
    grp199_69.setBounds(new Rectangle(43,195,38,16));
    localPanel.add(grp199_69, new Proportion(grp199_69.getBounds(), dsize));
    pwr_smallbuttoncenter70 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter70.setBounds(new Rectangle(41,194,46,19));
    ...
    pwr_smallbuttoncenter13.dd.setActionType(34);
    pwr_smallbuttoncenter13.dd.setAccess(65532);
    pwr_smallbuttoncenter13.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter13.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter13.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter13.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter13.dd, "$object.Mode.OpManStop")
      ,new GeDynStoDig(pwr_smallbuttoncenter13.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter13.setAnnot1("Decr");
...
null,null,    new GeDyn(pwr_pulldownmenu241,129,65,33619964,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu243,1,65,33619967,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman53.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman53.dd, "$object.IndRunning##Boolean",37)
    ...
    pwr_rodcouplinganim54.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim54.dd, "$object.IndRunning##Boolean",1)
      });
    pwr_contactor255.dd.setDynType(32769);
    pwr_contactor255.dd.setActionType(66);
    pwr_contactor255.dd.setAccess(65535);
    pwr_contactor255.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor255.dd, "$object.ContactorDecr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor255.dd, "$object.ContactorDecr")
      ,new GeDynCommand(pwr_contactor255.dd, "open graph /class/instance=$object.ContactorDecr")
      });
    pwr_indsquare57.dd.setDynType(13);
    pwr_indsquare57.dd.setActionType(2);
    pwr_indsquare57.dd.setAccess(65532);
    pwr_indsquare57.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare57.dd, "$object.ContactorDecr.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare57.dd, "$object.ContactorDecr.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare57.dd, "$object.ContactorDecr.Feedback")
      });
    pwr_indround58.dd.setDynType(5);
    pwr_indround58.dd.setActionType(0);
    pwr_indround58.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround58.dd, "$object.Mode.FeedbackDecr##Boolean",29)
      });
    ...
    pwr_indsquare59.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigColor(pwr_indsquare59.dd, "$object.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare59.dd, "$object.Mode.LimitSwitchIncr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter60.dd, "$object.Mode.ManStopHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter60.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter60.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter60.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter60.setAnnot1("Stop");
    ...
    pwr_smallbuttoncenter67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter67.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter67.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter67.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter67.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter67.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter67.setAnnot1("Decr");
    ...
    pwr_smallbuttoncenter68.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter68.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter68.setAnnot1("Incr");
    grp199_69.dd.setDynType(129);
    grp199_69.dd.setActionType(0);
    grp199_69.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp199_69.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter70.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter70.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter70.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter70.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter70.setAnnot1("Auto");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 145612261, -18}, new int[] { 146, 147, 149594471,0}, 4),
