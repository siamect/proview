...
public class JopcBaseoverloadrelaysim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBaseoverloadrelaysim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseoverloadrelaysim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseoverloadrelaysim");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter5.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter5.dd, "$object.Overload.ActualValue##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter5.dd, "Toggle Overload")
      });
    pwr_indsquare6.dd.setDynType(5);
    pwr_indsquare6.dd.setActionType(0);
    pwr_indsquare6.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare6.dd, "$object.Overload.ActualValue##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseOverloadRelay",19, 47);
    {
