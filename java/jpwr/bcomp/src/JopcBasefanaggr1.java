...
public class JopcBasefanaggr1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare11.setBounds(new Rectangle(186,354,14,14));
    ...
    pwr_rod33.setBounds(new Rectangle(139,450,37,8));
    ...
    pwr_smallbuttoncenter34.setBounds(new Rectangle(5,514,45,19));
    ...
    pwr_valuelong35.setBounds(new Rectangle(61,513,334,21));
    ...
    pwr_fananim39.setBounds(new Rectangle(124,408,17,89));
    ...
    pwr_motor249.setBounds(new Rectangle(174,418,96,72));
    ...
    pwr_indsquare58.setBounds(new Rectangle(186,380,14,14));
    ...
    pwr_safetyswitch67.setBounds(new Rectangle(249,344,36,37));
    ...
    pwr_mbup68.setBounds(new Rectangle(345,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857049, 17}, new int[] { 12, 15, 148147713,41}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 148180801, 17}, new int[] { 12, 15, 144033817,41}, 4),
