...
public class JopcBaseelheatersim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBaseelheatersim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseelheatersim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseelheatersim");
    pwr_menubar21 = new pwr_menubar2(session);
    pwr_menubar21.setBounds(new Rectangle(6,0,324,22));
    ...
    pwr_smallbuttoncenter5.setBounds(new Rectangle(196,68,36,19));
    ...
    pwr_indsquare6.setBounds(new Rectangle(167,70,14,15));
    ...
    pwr_smallbuttoncenter8.setBounds(new Rectangle(129,92,166,19));
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 127;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(18.8424F, 57.0436F, 294.487F, 61.6117F),
    new Polygon( new int[] { 19, 313, 313, 19, 19, 19}, new int[] { 57, 57, 58, 58, 118, 119}, 6), 
    new Polygon( new int[] { 313, 313, 313, 313, 19, 19}, new int[] { 119, 57, 58, 118, 118, 119}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseElHeater",19, 47);
    {
