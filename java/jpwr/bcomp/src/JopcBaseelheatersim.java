...
public class JopcBaseelheatersim extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar21.setBounds(new Rectangle(5,0,326,24));
    ...
    pwr_smallbuttoncenter5.setBounds(new Rectangle(195,67,38,21));
    ...
    pwr_indsquare6.setBounds(new Rectangle(166,69,16,17));
    ...
    pwr_smallbuttoncenter8.setBounds(new Rectangle(128,91,168,21));
