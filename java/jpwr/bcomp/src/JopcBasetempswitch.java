...
public class JopcBasetempswitch extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup29;
  public JopcBasetempswitch( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasetempswitch( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasetempswitch");
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(18,208,46,19));
    ...
    pwr_valuelong21.setBounds(new Rectangle(75,208,334,21));
    pwr_valuelong21.setFillColor(31);
    pwr_valuelong21.setBorderColor(31);
    pwr_valuelong21.setTextColor(31);
    localPanel.add(pwr_valuelong21, new Proportion(pwr_valuelong21.getBounds(), dsize));
    pwr_switch23 = new pwr_switch(session);
    pwr_switch23.setBounds(new Rectangle(85,117,32,32));
    pwr_switch23.setShadow(1);
    localPanel.add(pwr_switch23, new Proportion(pwr_switch23.getBounds(), dsize));
    ...
    pwr_mbup29 = new pwr_mbup(session);
    pwr_mbup29.setBounds(new Rectangle(362,25,18,18));
    localPanel.add(pwr_mbup29, new Proportion(pwr_mbup29.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_switch23.dd.setDynType(9);
    pwr_switch23.dd.setActionType(0);
    pwr_switch23.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_switch23.dd, "!$object.Switch.ActualValue##Boolean",176)
      });
    pwr_switch23.setAnnot1("T");
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu224.dd, new String[] {
        JopLang.transl("Switch Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.Switch")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare27.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare27.dd, "$object.Switch.ActualValue##Boolean",29)
      });
    pwr_mbup29.dd.setDynType(129);
    pwr_mbup29.dd.setActionType(8256);
    pwr_mbup29.dd.setAccess(33619967);
    pwr_mbup29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup29.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup29.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup29.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(18F, 97.4448F, 382.409F, 99.7523F),
    ...
    new Line2D.Float( 100.93F, 176.31F, 100.93F, 146.956F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Value"),210, 140);
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, 89, -23}, new int[] { 22, 18, 154063775,-8}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 11 * original_height / height * width / original_width, 14F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
