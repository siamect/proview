...
public class JopcBasetempswitch extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(17,207,48,21));
    ...
    pwr_valuelong21.setBounds(new Rectangle(74,207,336,23));
    ...
    pwr_switch23.setBounds(new Rectangle(84,116,34,34));
    ...
    pwr_mbup29.setBounds(new Rectangle(361,24,20,20));
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, 81, -23}, new int[] { 22, 18, -1219980920,-8}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
