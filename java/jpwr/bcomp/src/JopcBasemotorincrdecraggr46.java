...
public class JopcBasemotorincrdecraggr46 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare4.setBounds(new Rectangle(150,347,16,16));
    ...
    pwr_indsquare7.setBounds(new Rectangle(150,392,16,16));
    ...
    pwr_smallbuttoncenter28.setBounds(new Rectangle(4,562,47,21));
    ...
    pwr_valuelong29.setBounds(new Rectangle(60,561,336,23));
    ...
    pwr_contactor233.setBounds(new Rectangle(248,337,38,38));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(248,382,38,39));
    ...
    pwr_motor243.setBounds(new Rectangle(173,457,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(150,418,16,17));
    ...
    grp173_51.setBounds(new Rectangle(34,418,40,17));
    ...
    pwr_rodcouplinganim53.setBounds(new Rectangle(168,483,12,22));
    ...
    pwr_contactor254.setBounds(new Rectangle(305,337,38,38));
    ...
    pwr_indsquare56.setBounds(new Rectangle(211,347,16,16));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140857013, -18}, new int[] { 146, 147, 152138615,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857087, 55}, new int[] { 12, 15, 152138669,53}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 152651391, 55}, new int[] { 12, 15, 144032853,53}, 4),
