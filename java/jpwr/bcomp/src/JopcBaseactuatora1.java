...
public class JopcBaseactuatora1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(17,431,47,21));
    ...
    pwr_valuelong24.setBounds(new Rectangle(74,430,336,23));
    ...
    pwr_actuator51.setBounds(new Rectangle(105,115,68,44));
    ...
    pwr_indsquare57.setBounds(new Rectangle(166,266,16,17));
