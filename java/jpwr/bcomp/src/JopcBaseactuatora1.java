...
public class JopcBaseactuatora1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  JopSmallbutton	jopSmallbutton19;
  pwr_valuelong	pwr_valuelong20;
  pwr_valuelong	pwr_valuelong21;
  pwr_sliderbackground3	pwr_sliderbackground322;
  pwr_valueinputreliefup	pwr_valueinputreliefup23;
  pwr_valueinputreliefup	pwr_valueinputreliefup24;
  ...
  pwr_actuator	pwr_actuator38;
  pwr_indround	pwr_indround39;
  Grp173_	grp173_40;
  public JopcBaseactuatora1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora1");
    ...
    pwr_menubar3.setBounds(new Rectangle(0,0,429,24));
    ...
    pwr_pulldownmenu5.setBounds(new Rectangle(341,0,69,24));
    ...
    jopSmallbutton19 = new JopSmallbutton(session);
    jopSmallbutton19.setBounds(new Rectangle(17,439,47,21));
    jopSmallbutton19.setBorderColor(37);
    localPanel.add(jopSmallbutton19, new Proportion(jopSmallbutton19.getBounds(), dsize));
    ...
    pwr_valuelong21.setBounds(new Rectangle(74,439,336,23));
    ...
    pwr_sliderbackground322 = new pwr_sliderbackground3(session);
    pwr_sliderbackground322.setBounds(new Rectangle(337,132,61,243));
    pwr_sliderbackground322.setFillColor(35);
    localPanel.add(pwr_sliderbackground322, new Proportion(pwr_sliderbackground322.getBounds(), dsize));
    pwr_valueinputreliefup23 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup23.setBounds(new Rectangle(273,131,51,18));
    localPanel.add(pwr_valueinputreliefup23, new Proportion(pwr_valueinputreliefup23.getBounds(), dsize));
    pwr_valueinputreliefup24 = new pwr_valueinputreliefup(session);
    pwr_valueinputreliefup24.setBounds(new Rectangle(273,358,51,18));
    localPanel.add(pwr_valueinputreliefup24, new Proportion(pwr_valueinputreliefup24.getBounds(), dsize));
    pwr_pulldownmenu25 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu25.setBounds(new Rectangle(147,0,69,24));
    ...
    pwr_indsquare29.setBounds(new Rectangle(171,109,16,17));
    ...
    jopBar35 = new JopBar(session);
    jopBar35.setBounds(new Rectangle(356,132,24,242));
    jopBar35.setFillColor(58);
    jopBar35.setBorderColor(0);
    jopBar35.setFillColorBar(105);
    jopBar35.setBorderColorBar(101);
    jopBar35.setDrawFill(1);
    jopBar35.setDrawBorder(1);
    jopBar35.setBarBorderWidth(1);
    jopBar35.setLineWidth(1);
    jopBar35.setMinValue(0F);
    jopBar35.setMaxValue(100F);
    jopBar35.setRotate(0);
    localPanel.add(jopBar35, new Proportion(jopBar35.getBounds(), dsize));
    jopAxis36 = new JopAxis();
    jopAxis36.setBounds(new Rectangle(327,134,11,238));
    jopAxis36.setBorderColor(0);
    jopAxis36.setTextColor(0);
    jopAxis36.setLineWidth(1);
    jopAxis36.setMinValue(0F);
    jopAxis36.setMaxValue(0F);
    ...
    jopAxis36.setFormat("%3.0f");
    localPanel.add(jopAxis36, new Proportion(jopAxis36.getBounds(), dsize));
    pwr_valuesmall37 = new pwr_valuesmall(session);
    pwr_valuesmall37.setBounds(new Rectangle(343,391,50,17));
    localPanel.add(pwr_valuesmall37, new Proportion(pwr_valuesmall37.getBounds(), dsize));
    pwr_actuator38 = new pwr_actuator(session);
    pwr_actuator38.setBounds(new Rectangle(56,237,132,84));
    pwr_actuator38.setShadow(1);
    localPanel.add(pwr_actuator38, new Proportion(pwr_actuator38.getBounds(), dsize));
    pwr_indround39 = new pwr_indround(session);
    pwr_indround39.setBounds(new Rectangle(105,388,17,18));
    ...
    grp173_40 = new Grp173_(session);
    grp173_40.setBounds(new Rectangle(48,387,35,18));
    localPanel.add(grp173_40, new Proportion(grp173_40.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton19.dd.setDynType(128);
    jopSmallbutton19.dd.setActionType(64);
    jopSmallbutton19.dd.setAccess(65532);
    jopSmallbutton19.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton19.dd, "$object.Note##String80",0)
      ,new GeDynCommand(jopSmallbutton19.dd, "call method/method=\"Note\"/object=$object")
      });
    jopSmallbutton19.setAnnot1("Note !");
    ...
    pwr_sliderbackground322.dd.setDynType(524289);
    pwr_sliderbackground322.dd.setActionType(0);
    pwr_valueinputreliefup23.dd.setDynType(1025);
    pwr_valueinputreliefup23.dd.setActionType(4096);
    pwr_valueinputreliefup23.dd.setAccess(65532);
    pwr_valueinputreliefup23.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup23.dd, "$object.Order.PresMaxLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup23.dd, 0,0,null,null)
      });
    pwr_valueinputreliefup24.dd.setDynType(1025);
    pwr_valueinputreliefup24.dd.setActionType(4096);
    pwr_valueinputreliefup24.dd.setAccess(65532);
    pwr_valueinputreliefup24.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup24.dd, "$object.Order.PresMinLimit##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputreliefup24.dd, 0,0,null,null)
      });
    ...
    pwr_pulldownmenu25.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu25.dd, "open graph /class /inst=$object.Position")
      }),
    new GeDyn(pwr_pulldownmenu25,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar35.setPwrAttribute("$object.Order.ActualValue##Float32");
    jopBar35.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar35.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    pwr_valuesmall37.dd.setDynType(1025);
    pwr_valuesmall37.dd.setActionType(2);
    pwr_valuesmall37.dd.setAccess(65532);
    pwr_valuesmall37.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall37.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall37.dd, "$object.Order")
      });
    pwr_actuator38.dd.setDynType(1);
    pwr_actuator38.dd.setActionType(2);
    pwr_actuator38.dd.setAccess(65532);
    pwr_actuator38.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator38.dd, "$object.Actuator")
      });
    pwr_indround39.dd.setDynType(133);
    pwr_indround39.dd.setActionType(0);
    pwr_indround39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround39.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround39.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp173_40.dd.setDynType(129);
    grp173_40.dd.setActionType(0);
    grp173_40.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_40.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 429;
  public int original_height = 462;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(254F, 103F, 163.417F, 327.444F),
    new Polygon( new int[] { 254, 417, 417, 255, 255, 254}, new int[] { 103, 103, 104, 104, 430, 430}, 6), 
    new Polygon( new int[] { 417, 417, 417, 417, 255, 254}, new int[] { 430, 103, 104, 430, 430, 430}, 6), 
    new Rectangle2D.Float(18.3448F, 102.283F, 227.941F, 59.1477F),
    new Polygon( new int[] { 18, 246, 245, 20, 20, 18}, new int[] { 102, 102, 103, 103, 160, 161}, 6), 
    new Polygon( new int[] { 246, 246, 245, 245, 20, 18}, new int[] { 161, 102, 103, 160, 160, 161}, 6), 
    new Line2D.Float( 395.951F, 181F, 337.871F, 181F),
    new Line2D.Float( 395.951F, 229F, 337.871F, 229F),
    new Line2D.Float( 395.951F, 276F, 337.871F, 276F),
    new Line2D.Float( 395.951F, 325F, 337.871F, 325F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Order",351, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SwitchOpen",43, 123);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
