...
public class JopcBasemvalve2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_smallbuttoncenter	pwr_smallbuttoncenter38;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter39;
  pwr_indround	pwr_indround41;
  pwr_indround	pwr_indround42;
  pwr_valveanim2	pwr_valveanim243;
  pwr_mvalve	pwr_mvalve44;
  pwr_indsquare	pwr_indsquare46;
  pwr_indround	pwr_indround47;
  Grp196_	grp196_48;
  pwr_indsquare	pwr_indsquare50;
  pwr_mbup	pwr_mbup51;
  public JopcBasemvalve2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemvalve2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu28.setBounds(new Rectangle(11,0,69,24));
    ...
    pwr_pulldownmenu29.setBounds(new Rectangle(446,0,69,24));
    ...
    pwr_mbopenobject10.setBounds(new Rectangle(195,24,20,20));
    ...
    pwr_mbtrend11.setBounds(new Rectangle(56,24,20,20));
    ...
    pwr_mbfast12.setBounds(new Rectangle(76,24,20,20));
    ...
    pwr_mbphoto13.setBounds(new Rectangle(96,24,20,20));
    ...
    pwr_mbopenplc15.setBounds(new Rectangle(215,24,20,20));
    ...
    pwr_mbcircuitdiagram16.setBounds(new Rectangle(235,24,20,20));
    ...
    pwr_mbrtnavigator17.setBounds(new Rectangle(175,24,20,20));
    ...
    pwr_mbblockevents19.setBounds(new Rectangle(155,24,20,20));
    ...
    pwr_mbnote21.setBounds(new Rectangle(36,24,19,20));
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(17,408,47,21));
    ...
    pwr_valuelong25.setBounds(new Rectangle(74,407,336,23));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(152,0,69,24));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(70,0,69,24));
    ...
    pwr_indsquare29.setBounds(new Rectangle(166,188,16,17));
    pwr_indsquare29.setFillColor(294);
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(36,340,48,21));
    pwr_smallbuttoncenter30.setFillColor(32);
    ...
    pwr_indround31.setBounds(new Rectangle(96,319,18,18));
    ...
    pwr_indround32.setBounds(new Rectangle(96,341,18,18));
    ...
    pwr_mbsimulate34.setBounds(new Rectangle(508,24,20,20));
    ...
    pwr_smallbuttoncenter35.setBounds(new Rectangle(36,317,48,21));
    pwr_smallbuttoncenter35.setFillColor(32);
    ...
    pwr_indsquare37.setBounds(new Rectangle(166,221,16,17));
    pwr_indsquare37.setFillColor(294);
    pwr_indsquare37.setShadow(1);
    localPanel.add(pwr_indsquare37, new Proportion(pwr_indsquare37.getBounds(), dsize));
    pwr_smallbuttoncenter38 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter38.setBounds(new Rectangle(160,340,56,21));
    pwr_smallbuttoncenter38.setFillColor(32);
    localPanel.add(pwr_smallbuttoncenter38, new Proportion(pwr_smallbuttoncenter38.getBounds(), dsize));
    pwr_smallbuttoncenter39 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter39.setBounds(new Rectangle(160,316,56,21));
    ...
    pwr_indround41.setBounds(new Rectangle(228,319,17,18));
    ...
    pwr_indround42.setBounds(new Rectangle(228,341,17,18));
    pwr_indround42.setShadow(1);
    localPanel.add(pwr_indround42, new Proportion(pwr_indround42.getBounds(), dsize));
    pwr_valveanim243 = new pwr_valveanim2(session);
    pwr_valveanim243.setBounds(new Rectangle(114,116,71,64));
    pwr_valveanim243.setShadow(1);
    localPanel.add(pwr_valveanim243, new Proportion(pwr_valveanim243.getBounds(), dsize));
    pwr_mvalve44 = new pwr_mvalve(session);
    pwr_mvalve44.setBounds(new Rectangle(326,155,155,147));
    pwr_mvalve44.setShadow(1);
    localPanel.add(pwr_mvalve44, new Proportion(pwr_mvalve44.getBounds(), dsize));
    pwr_indsquare46 = new pwr_indsquare(session);
    pwr_indsquare46.setBounds(new Rectangle(166,241,16,17));
    ...
    pwr_indround47.setBounds(new Rectangle(96,362,18,18));
    ...
    grp196_48.setBounds(new Rectangle(40,363,37,18));
    localPanel.add(grp196_48, new Proportion(grp196_48.getBounds(), dsize));
    pwr_indsquare50 = new pwr_indsquare(session);
    pwr_indsquare50.setBounds(new Rectangle(166,391,16,17));
    pwr_indsquare50.setFillColor(295);
    ...
    pwr_mbup51.setBounds(new Rectangle(488,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu226.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu226.dd, new String[] {
        JopLang.transl("Order Do"),JopLang.transl("SwitchClosed Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare29.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare29.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare29.dd, "$object.SwitchClosed")
      });
    pwr_smallbuttoncenter30.dd.setDynType(129);
    pwr_smallbuttoncenter30.dd.setActionType(4);
    pwr_smallbuttoncenter30.dd.setAccess(65532);
    pwr_smallbuttoncenter30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter30.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter30.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter30.setAnnot1("Auto");
    pwr_indround31.dd.setDynType(133);
    pwr_indround31.dd.setActionType(0);
    pwr_indround31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround31.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround31.dd, "$object.Mode.ManMode##Boolean",29)
      });
    pwr_indround32.dd.setDynType(133);
    pwr_indround32.dd.setActionType(0);
    pwr_indround32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround32.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround32.dd, "!$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_mbsimulate34.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate34.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_smallbuttoncenter35.dd.setDynType(128);
    pwr_smallbuttoncenter35.dd.setActionType(4);
    pwr_smallbuttoncenter35.dd.setAccess(65532);
    pwr_smallbuttoncenter35.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter35.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter35.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter35.setAnnot1("Man");
    ...
    pwr_indsquare37.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare37.dd, "$object.Order.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare37.dd, "$object.Order")
      });
    pwr_smallbuttoncenter38.dd.setDynType(129);
    pwr_smallbuttoncenter38.dd.setActionType(8);
    pwr_smallbuttoncenter38.dd.setAccess(65532);
    pwr_smallbuttoncenter38.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter38.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter38.dd, "$object.Mode.OpManDimmed##Boolean",1)
      ,new GeDynResetDig(pwr_smallbuttoncenter38.dd, "$object.Mode.OpRefMan##Boolean")
      });
    pwr_smallbuttoncenter38.setAnnot1("Close");
    ...
    pwr_smallbuttoncenter39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter39.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter39.dd, "$object.Mode.OpManDimmed##Boolean",1)
      ,new GeDynSetDig(pwr_smallbuttoncenter39.dd, "$object.Mode.OpRefMan##Boolean")
      });
    pwr_smallbuttoncenter39.setAnnot1("Open ");
    pwr_indround41.dd.setDynType(133);
    pwr_indround41.dd.setActionType(0);
    pwr_indround41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround41.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround41.dd, "$object.Mode.OpRefMan##Boolean",29)
      });
    ...
    pwr_indround42.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround42.dd, "!$object.Mode.OpRefMan##Boolean",29)
      });
    pwr_valveanim243.dd.setDynType(66572);
    pwr_valveanim243.dd.setActionType(0);
    pwr_valveanim243.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valveanim243.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_valveanim243.dd, "$object.IndWarning##Boolean",114)
      ,new GeDynDigLowColor(pwr_valveanim243.dd, "!$object.SwitchClosed.ActualValue##Boolean",41)
      ,new GeDynValue(pwr_valveanim243.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_valveanim243.dd, "$object.SwitchClosed.ActualValue##Boolean",2)
      });
    pwr_mvalve44.dd.setDynType(1);
    pwr_mvalve44.dd.setActionType(0);
    ...
    pwr_indsquare50.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare50.dd, "$object.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 430;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.4296F, 526.622F, 22.4305F),
    new Rectangle2D.Float(67.5597F, 145.617F, 53.2796F, 3.889F),
    new Polygon( new int[] { 68, 121, 120, 69, 69, 68}, new int[] { 146, 146, 147, 147, 149, 150}, 6), 
    new Polygon( new int[] { 121, 121, 120, 120, 69, 68}, new int[] { 150, 146, 147, 149, 149, 150}, 6), 
    new Rectangle2D.Float(160.896F, 145.617F, 53.2796F, 3.889F),
    new Polygon( new int[] { 161, 214, 213, 162, 162, 161}, new int[] { 146, 146, 147, 147, 149, 150}, 6), 
    new Polygon( new int[] { 214, 214, 213, 213, 162, 161}, new int[] { 150, 146, 147, 149, 149, 150}, 6), 
    new Line2D.Float( 252.944F, 304.042F, 18.4089F, 304.042F),
    new Rectangle2D.Float(17.9999F, 279.139F, 237.944F, 106.801F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 279, 279, 280, 280, 385, 386}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 386, 279, 280, 385, 385, 386}, 6), 
    new Rectangle2D.Float(17.9086F, 101.639F, 237.944F, 171.927F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 102, 102, 102, 102, 273, 274}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 274, 102, 102, 273, 273, 274}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("SwitchClosed"),37, 204);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Mode"),37, 300);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order"),37, 238);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Man"),162, 300);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),37, 257);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("Supervision disabled"),39, 404);
    g.setTransform(save);
  }
...
protected class pwr_mvalve extends GeComponent {
  // Dimension size;
  public pwr_mvalve( JopSession session)
  {
    super( session);
    size = new Dimension( 76, 72);
  }
  public int original_width = 76;
  public int original_height = 72;
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 26, 26, 18, 18, 14, 10, 2, 2, 10, 14, 62, 66, 74, 74, 66, 62, 58, 58, 50, 50, 26}, new int[] {42, 46, 46, 52, 52, 50, 50, 70, 70, 68, 68, 70, 70, 50, 50, 52, 52, 46, 46, 42, 42}, 21),
    new Polygon( new int[] { 4, 4, 6, 6, 4, 4, 16, 16, 14, 14, 16, 16, 4}, new int[] {14, 6, 6, 4, 4, 2, 2, 4, 4, 6, 6, 14, 14}, 13),
    new Rectangle2D.Float(22F, 14F, 32F, 28F),
    new Polygon( new int[] { 22, 54, 52, 24, 24, 22}, new int[] { 14, 14, 16, 16, 40, 42}, 6), 
    new Polygon( new int[] { 54, 54, 52, 52, 24, 22}, new int[] { 42, 14, 16, 40, 40, 42}, 6), 
    new Rectangle2D.Float(2F, 14F, 20F, 20F),
    new Polygon( new int[] { 2, 22, 21, 3, 3, 2}, new int[] { 14, 14, 15, 15, 33, 34}, 6), 
    new Polygon( new int[] { 22, 22, 21, 21, 3, 2}, new int[] { 34, 14, 15, 33, 33, 34}, 6), 
    new Polygon( new int[] { 12, 12, 9, 9, 12, 12, 16, 16, 14, 14, 16, 16, 12}, new int[] {14, 6, 6, 4, 4, 2, 2, 4, 4, 6, 6, 14, 14}, 13),
    new Polygon( new int[] { 6, 8, 8, 6, 6}, new int[] {6, 6, 14, 14, 6}, 5),
    new Polygon( new int[] { 6, 8, 8, 6, 6}, new int[] {2, 2, 4, 4, 2}, 5),
    new Polygon( new int[] { 4, 4, 6, 6, 4, 4, 16, 16, 14, 14, 16, 16, 4}, new int[] {14, 6, 6, 4, 4, 2, 2, 4, 4, 6, 6, 14, 14}, 13),
    new Polygon( new int[] { 2, 10, 14, 18, 18, 48, 48, 62, 66, 74, 74, 66, 62, 14, 10, 2, 2}, new int[] {64, 64, 62, 62, 66, 66, 62, 62, 64, 64, 70, 70, 68, 68, 70, 70, 64}, 17),
    new Polygon( new int[] { 26, 50, 50, 26, 26}, new int[] {42, 42, 46, 46, 42}, 5),
    new Polygon( new int[] { 18, 58, 58, 60, 60, 22, 18}, new int[] {54, 54, 52, 52, 58, 58, 54}, 7),
    new Polygon( new int[] { 74, 66, 62, 60, 60, 74}, new int[] {52, 52, 54, 54, 56, 56}, 6),
    new Polygon( new int[] { 2, 10, 14, 18, 18, 2, 2}, new int[] {52, 52, 54, 54, 56, 56, 52}, 7),
    new Polygon( new int[] { 26, 26, 18, 18, 14, 10, 2, 2, 10, 14, 62, 66, 74, 74, 66, 62, 58, 58, 50, 50, 26}, new int[] {42, 46, 46, 52, 52, 50, 50, 70, 70, 68, 68, 70, 70, 50, 50, 52, 52, 46, 46, 42, 42}, 21),
    new Polygon( new int[] { 22, 20}, new int[] {60, 60}, 2),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
    ...
    GeGradient.paint( g, gradient,2,-2,22F,14F,32F,28F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[2]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,2F,14F,20F,20F, false,39, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_valveanim2 extends GeComponent {
  // Dimension size;
  public pwr_valveanim2( JopSession session)
  {
    super( session);
    size = new Dimension( 72, 64);
  ...
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 6, 6, 26, 6}, new int[] {22, 42, 32, 22}, 4),
    new Polygon( new int[] { 6, 10, 10, 6}, new int[] { 22, 27, 39,42}, 4),
    new Polygon( new int[] { 6, 10, 23, 26}, new int[] { 42, 39, 34,32}, 4),
    new Polygon( new int[] { 26, 23, 10, 6}, new int[] { 32, 34, 27,22}, 4),
    new Polygon( new int[] { 6, 10, 146, 65}, new int[] { 22, 27, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 46, 26, 46, 46}, new int[] {22, 32, 42, 22}, 4),
    new Polygon( new int[] { 46, 46, 33, 26}, new int[] { 22, 27, 34,32}, 4),
    new Polygon( new int[] { 26, 33, 46, 46}, new int[] { 32, 34, 39,42}, 4),
    new Polygon( new int[] { 46, 46, 46, 46}, new int[] { 42, 39, 27,22}, 4),
    new Polygon( new int[] { 46, 46, 146, 65}, new int[] { 22, 27, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50F, 12F, 20F, 16F),
  };
  int original_width_p2 = 72;
  int original_height_p2 = 64;
  Shape[] shapes_p2 = new Shape[] { 
    new Polygon( new int[] { 9, 4, 26, 9}, new int[] {17, 36, 32, 17}, 4),
    new Polygon( new int[] { 9, 12, 9, 4}, new int[] { 17, 23, 34,36}, 4),
    new Polygon( new int[] { 4, 9, 23, 26}, new int[] { 36, 34, 33,32}, 4),
    new Polygon( new int[] { 26, 23, 12, 9}, new int[] { 32, 33, 23,17}, 4),
    new Polygon( new int[] { 9, 12, 146, 65}, new int[] { 17, 23, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 48, 26, 43, 48}, new int[] {28, 32, 47, 28}, 4),
    new Polygon( new int[] { 48, 47, 33, 26}, new int[] { 28, 33, 34,32}, 4),
    new Polygon( new int[] { 26, 33, 44, 43}, new int[] { 32, 34, 44,47}, 4),
    new Polygon( new int[] { 43, 44, 47, 48}, new int[] { 47, 44, 33,28}, 4),
    new Polygon( new int[] { 48, 47, 146, 65}, new int[] { 28, 33, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  int original_width_p3 = 72;
  int original_height_p3 = 64;
  Shape[] shapes_p3 = new Shape[] { 
    new Polygon( new int[] { 14, 4, 26, 14}, new int[] {13, 31, 32, 13}, 4),
    new Polygon( new int[] { 14, 16, 8, 4}, new int[] { 13, 17, 32,31}, 4),
    new Polygon( new int[] { 4, 8, 26, 26}, new int[] { 31, 32, 33,32}, 4),
    new Polygon( new int[] { 26, 26, 16, 14}, new int[] { 32, 33, 17,13}, 4),
    new Polygon( new int[] { 14, 16, 146, 65}, new int[] { 13, 17, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 48, 26, 38, 48}, new int[] {33, 32, 51, 33}, 4),
    new Polygon( new int[] { 48, 48, 30, 26}, new int[] { 33, 35, 34,32}, 4),
    new Polygon( new int[] { 26, 30, 40, 38}, new int[] { 32, 34, 49,51}, 4),
    new Polygon( new int[] { 38, 40, 48, 48}, new int[] { 51, 49, 35,33}, 4),
    new Polygon( new int[] { 48, 48, 146, 65}, new int[] { 33, 35, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  int original_width_p4 = 72;
  int original_height_p4 = 64;
  Shape[] shapes_p4 = new Shape[] { 
    new Polygon( new int[] { 19, 5, 26, 19}, new int[] {11, 25, 32, 11}, 4),
    new Polygon( new int[] { 19, 20, 11, 5}, new int[] { 11, 17, 26,25}, 4),
    new Polygon( new int[] { 5, 11, 25, 26}, new int[] { 25, 26, 31,32}, 4),
    new Polygon( new int[] { 26, 25, 20, 19}, new int[] { 32, 31, 17,11}, 4),
    new Polygon( new int[] { 19, 20, 146, 65}, new int[] { 11, 17, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 47, 26, 33, 47}, new int[] {39, 32, 53, 39}, 4),
    new Polygon( new int[] { 47, 45, 31, 26}, new int[] { 39, 40, 36,32}, 4),
    new Polygon( new int[] { 26, 31, 36, 33}, new int[] { 32, 36, 49,53}, 4),
    new Polygon( new int[] { 33, 36, 45, 47}, new int[] { 53, 49, 40,39}, 4),
    new Polygon( new int[] { 47, 45, 146, 65}, new int[] { 39, 40, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50F, 12F, 20F, 16F),
  };
  int original_width_p5 = 72;
  int original_height_p5 = 64;
  Shape[] shapes_p5 = new Shape[] { 
    new Polygon( new int[] { 25, 7, 26, 25}, new int[] {10, 20, 32, 10}, 4),
    new Polygon( new int[] { 25, 26, 11, 7}, new int[] { 10, 14, 22,20}, 4),
    new Polygon( new int[] { 7, 11, 27, 26}, new int[] { 20, 22, 32,32}, 4),
    new Polygon( new int[] { 26, 27, 26, 25}, new int[] { 32, 32, 14,10}, 4),
    new Polygon( new int[] { 25, 26, 146, 65}, new int[] { 10, 14, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 45, 26, 27, 45}, new int[] {44, 32, 54, 44}, 4),
    new Polygon( new int[] { 45, 45, 29, 26}, new int[] { 44, 44, 35,32}, 4),
    new Polygon( new int[] { 26, 29, 30, 27}, new int[] { 32, 35, 52,54}, 4),
    new Polygon( new int[] { 27, 30, 45, 45}, new int[] { 54, 52, 44,44}, 4),
    new Polygon( new int[] { 45, 45, 146, 65}, new int[] { 44, 44, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  int original_width_p6 = 72;
  int original_height_p6 = 64;
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 11, 17, 27, 26}, new int[] { 15, 18, 30,32}, 4),
    new Polygon( new int[] { 26, 27, 29, 30}, new int[] { 32, 30, 15,10}, 4),
    new Polygon( new int[] { 30, 29, 146, 65}, new int[] { 10, 15, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 41, 26, 22, 41}, new int[] {49, 32, 54, 49}, 4),
    new Polygon( new int[] { 41, 39, 29, 26}, new int[] { 49, 48, 37,32}, 4),
    new Polygon( new int[] { 26, 29, 27, 22}, new int[] { 32, 37, 51,54}, 4),
    new Polygon( new int[] { 22, 27, 39, 41}, new int[] { 54, 51, 48,49}, 4),
    new Polygon( new int[] { 41, 39, 146, 65}, new int[] { 49, 48, -1219980877,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  int original_width_p7 = 72;
  int original_height_p7 = 64;
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 16, 21, 28, 26}, new int[] { 12, 16, 30,32}, 4),
    new Polygon( new int[] { 26, 28, 35, 36}, new int[] { 32, 30, 16,12}, 4),
    new Polygon( new int[] { 36, 35, 146, 65}, new int[] { 12, 16, -1219980877,-2147483648}, 4),
    new Polygon( new int[] { 36, 26, 16, 36}, new int[] {52, 32, 52, 52}, 4),
    new Polygon( new int[] { 36, 35, 28, 26}, new int[] { 52, 50, 37,32}, 4),
    new Polygon( new int[] { 26, 28, 21, 16}, new int[] { 32, 37, 50,52}, 4),
    new Polygon( new int[] { 16, 21, 35, 36}, new int[] { 52, 50, 50,52}, 4),
    new Polygon( new int[] { 36, 35, 146, 65}, new int[] { 52, 50, -1219980877,-2147483648}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,6F,22F,20F,20F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,26F,22F,20F,20F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 50 * original_height / height * width / original_width, 26F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
  ...
  public void paintComponent_p2(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,4.09329F,17.1644F,21.9067F,19.3185F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p2[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,26F,27.5171F,21.9067F,19.3185F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p2[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p3(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,3.67948F,13.3398F,22.3205F,18.6603F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p3[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,26F,32F,22.3205F,18.6603F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p3[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p4(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,4.7868F,10.7868F,21.2132F,21.2132F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p4[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,26F,32F,21.2132F,21.2132F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p4[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p5(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,7.33965F,9.67949F,18.6603F,22.3205F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p5[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,25.9999F,32F,18.6603F,22.3205F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p5[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p6(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,11.1644F,10.0933F,19.3185F,21.9067F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p6[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,21.5172F,32F,19.3185F,21.9067F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p6[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p7(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,16F,12F,20F,20F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p7[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, gradient,2,-2,16.0001F,32F,20F,20F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p7[5]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
