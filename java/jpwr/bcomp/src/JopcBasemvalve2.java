...
public class JopcBasemvalve2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu28.setBounds(new Rectangle(12,1,67,22));
    ...
    pwr_pulldownmenu29.setBounds(new Rectangle(447,1,67,22));
    ...
    pwr_mbopenobject10.setBounds(new Rectangle(196,25,18,18));
    ...
    pwr_mbtrend11.setBounds(new Rectangle(57,25,18,18));
    ...
    pwr_mbfast12.setBounds(new Rectangle(77,25,18,18));
    ...
    pwr_mbphoto13.setBounds(new Rectangle(97,25,18,18));
    ...
    pwr_mbopenplc15.setBounds(new Rectangle(216,25,18,18));
    ...
    pwr_mbcircuitdiagram16.setBounds(new Rectangle(236,25,18,18));
    ...
    pwr_mbrtnavigator17.setBounds(new Rectangle(176,25,18,18));
    ...
    pwr_mbblockevents19.setBounds(new Rectangle(156,25,18,18));
    ...
    pwr_mbnote21.setBounds(new Rectangle(37,25,17,18));
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(18,409,45,19));
    ...
    pwr_valuelong25.setBounds(new Rectangle(75,408,334,21));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(71,1,67,22));
    ...
    pwr_indsquare29.setBounds(new Rectangle(167,189,14,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(37,341,46,19));
    ...
    pwr_indround31.setBounds(new Rectangle(97,320,16,16));
    ...
    pwr_indround32.setBounds(new Rectangle(97,342,16,16));
    ...
    pwr_mbsimulate34.setBounds(new Rectangle(509,25,18,18));
    ...
    pwr_smallbuttoncenter35.setBounds(new Rectangle(37,318,46,19));
    ...
    pwr_indsquare37.setBounds(new Rectangle(167,222,14,15));
    ...
    pwr_smallbuttoncenter38.setBounds(new Rectangle(161,341,54,19));
    ...
    pwr_smallbuttoncenter39.setBounds(new Rectangle(161,317,54,19));
    ...
    pwr_indround41.setBounds(new Rectangle(229,320,15,16));
    ...
    pwr_indround42.setBounds(new Rectangle(229,342,15,16));
    ...
    pwr_valveanim243.setBounds(new Rectangle(115,117,69,62));
    ...
    pwr_mvalve44.setBounds(new Rectangle(327,156,153,145));
    ...
    pwr_indsquare46.setBounds(new Rectangle(167,242,14,15));
...
protected class pwr_valveanim2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 10, 82, 65}, new int[] { 22, 27, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 46, 46, 82, 65}, new int[] { 22, 27, -1219915341,-2147483648}, 4),
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 9, 12, 82, 65}, new int[] { 17, 23, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 48, 47, 82, 65}, new int[] { 28, 33, -1219915341,-2147483648}, 4),
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 16, 82, 65}, new int[] { 13, 17, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 48, 48, 82, 65}, new int[] { 33, 35, -1219915341,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p4 = new Shape[] { 
    ...
    new Polygon( new int[] { 19, 20, 82, 65}, new int[] { 11, 17, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 47, 45, 82, 65}, new int[] { 39, 40, -1219915341,-2147483648}, 4),
    new Rectangle2D.Float(50F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p5 = new Shape[] { 
    ...
    new Polygon( new int[] { 25, 26, 82, 65}, new int[] { 10, 14, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 45, 45, 82, 65}, new int[] { 44, 44, -1219915341,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 30, 29, 82, 65}, new int[] { 10, 15, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 41, 39, 82, 65}, new int[] { 49, 48, -1219915341,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 36, 35, 82, 65}, new int[] { 12, 16, -1219915341,-2147483648}, 4),
    ...
    new Polygon( new int[] { 36, 35, 82, 65}, new int[] { 52, 50, -1219915341,-2147483648}, 4),
