...
public class JopcBasemotorincrdecraggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay4.setBounds(new Rectangle(248,329,38,27));
    ...
    jopSmallbutton30.setBounds(new Rectangle(4,503,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,502,336,23));
    ...
    pwr_motor244.setBounds(new Rectangle(173,398,98,74));
    ...
    pwr_indsquare51.setBounds(new Rectangle(150,359,16,16));
    ...
    grp173_52.setBounds(new Rectangle(34,359,39,18));
    ...
    pwr_rodcouplinganim56.setBounds(new Rectangle(168,424,12,22));
