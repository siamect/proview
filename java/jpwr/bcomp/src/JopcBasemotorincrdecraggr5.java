...
public class JopcBasemotorincrdecraggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,504,45,19));
    ...
    pwr_valuelong32.setBounds(new Rectangle(61,503,334,21));
    ...
    pwr_contactor236.setBounds(new Rectangle(249,294,36,36));
    ...
    pwr_motor245.setBounds(new Rectangle(174,399,96,72));
    ...
    pwr_indsquare52.setBounds(new Rectangle(151,360,14,14));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(169,425,10,20));
    ...
    pwr_contactor258.setBounds(new Rectangle(306,294,36,36));
    ...
    pwr_indsquare60.setBounds(new Rectangle(212,304,14,15));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 152395637, -18}, new int[] { 146, 147, 144033775,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 152395711, 55}, new int[] { 12, 15, 144033829,53}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 152922655, 55}, new int[] { 12, 15, 144033829,53}, 4),
