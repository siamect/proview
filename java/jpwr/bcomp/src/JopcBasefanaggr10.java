...
public class JopcBasefanaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(185,317,16,17));
    ...
    pwr_indsquare10.setBounds(new Rectangle(185,364,16,16));
    ...
    pwr_smallbuttoncenter15.setBounds(new Rectangle(115,191,61,21));
    ...
    pwr_rod32.setBounds(new Rectangle(138,462,39,10));
    ...
    pwr_fananim38.setBounds(new Rectangle(123,420,19,91));
    ...
    pwr_motor248.setBounds(new Rectangle(173,430,98,74));
    ...
    pwr_indsquare57.setBounds(new Rectangle(185,390,16,17));
    ...
    grp182_60.setBounds(new Rectangle(30,193,41,18));
    ...
    pwr_mbup66.setBounds(new Rectangle(344,24,19,20));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),71, 330);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),71, 378);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 28, 27}, new int[] { 12, 15, 148397487,55}, 4),
