...
public class JopcBasefanaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(186,318,14,15));
    ...
    pwr_indsquare10.setBounds(new Rectangle(186,365,14,14));
    ...
    pwr_smallbuttoncenter15.setBounds(new Rectangle(116,192,59,19));
    ...
    pwr_rod32.setBounds(new Rectangle(139,463,37,8));
    ...
    pwr_fananim38.setBounds(new Rectangle(124,421,17,89));
    ...
    pwr_motor248.setBounds(new Rectangle(174,431,96,72));
    ...
    pwr_indsquare57.setBounds(new Rectangle(186,391,14,15));
    ...
    grp182_60.setBounds(new Rectangle(31,194,39,16));
    ...
    pwr_mbup66.setBounds(new Rectangle(345,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915348, 27}, new int[] { 12, 15, -1219915320,55}, 4),
