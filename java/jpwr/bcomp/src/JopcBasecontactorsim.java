...
public class JopcBasecontactorsim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecontactorsim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecontactorsim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter5.dd.setElements(new GeDynElemIfc[] {
      new GeDynSetDig(pwr_smallbuttoncenter5.dd, "$object.OpResetContactorFeedback##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter5.dd, "Reset Contactor feedback")
      });
    pwr_indsquare6.dd.setDynType(5);
    pwr_indsquare6.dd.setActionType(0);
    pwr_indsquare6.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare6.dd, "$object.IndContactorFeedback##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 314;
  public int original_height = 123;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(18.3161F, 55.3235F, 285.285F, 59.6863F),
    new Polygon( new int[] { 18, 304, 303, 19, 19, 18}, new int[] { 55, 55, 56, 56, 114, 115}, 6), 
    new Polygon( new int[] { 304, 304, 303, 303, 19, 18}, new int[] { 115, 55, 56, 114, 114, 115}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseContactor",18, 45);
    {
...
protected class pwr_indsquare extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 11.9231F, 12.9167F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,2F,2F,11.9231F,12.9167F, false,293, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class pwr_smallbuttoncenter extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 43.7179F, 16.891F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,1,-1,2F,2F,43.7179F,16.891F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
...
protected class pwr_menubar2 extends GeComponent {
  ...
  {
    super( session);
    size = new Dimension( 550, 23);
  }
  public int original_width = 550;
  public int original_height = 23;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 546.474F, 19.8718F),
    new Polygon( new int[] { 2, 2, 548, 548, 2}, new int[] {22, 20, 20, 22, 22}, 5),
    new Line2D.Float( 548.474F, 21.8718F, 2F, 21.8718F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_pulldownmenu2 extends GeComponent {
  ...
  public int original_height = 23;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 2F, 59.6154F, 19.8718F),
    new Polygon( new int[] { 2, 2, 62, 62, 2}, new int[] {20, 22, 22, 20, 20}, 5),
    new Line2D.Float( 61.6154F, 21.8718F, 2F, 21.8718F),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
