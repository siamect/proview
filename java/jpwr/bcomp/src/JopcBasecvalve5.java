...
public class JopcBasecvalve5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar26.setBounds(new Rectangle(0,0,542,24));
    ...
    pwr_indsquare53.setBounds(new Rectangle(166,226,15,17));
    ...
    pwr_indsquare54.setBounds(new Rectangle(166,245,16,17));
    ...
    pwr_pulldownmenu261.setBounds(new Rectangle(161,0,86,24));
    ...
    pwr_indsquare71.setBounds(new Rectangle(166,271,16,17));
