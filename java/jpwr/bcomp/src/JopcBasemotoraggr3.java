...
public class JopcBasemotoraggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,485,46,19));
    ...
    pwr_valuelong32.setBounds(new Rectangle(61,484,334,21));
    ...
    pwr_manswitch336.setBounds(new Rectangle(249,253,36,36));
    ...
    pwr_contactor237.setBounds(new Rectangle(249,301,36,36));
    ...
    pwr_motor246.setBounds(new Rectangle(174,374,96,72));
    ...
    pwr_indsquare55.setBounds(new Rectangle(186,334,14,14));
    ...
    grp173_56.setBounds(new Rectangle(70,334,38,15));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(170,399,10,19));
    ...
    grp183_59.setBounds(new Rectangle(31,194,39,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -7, -33}, new int[] { 12, 15, 88,56}, 4),
