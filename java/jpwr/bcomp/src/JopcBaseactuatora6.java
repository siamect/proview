...
public class JopcBaseactuatora6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBaseactuatora6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora6");
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(156,1,67,22));
    ...
    pwr_actuator56.setBounds(new Rectangle(103,113,66,42));
    ...
    pwr_indsquare62.setBounds(new Rectangle(167,269,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar40.setPwrAttribute("$object.Position.ActualValue##Float32");
    jopBar40.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar40.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    jopBar41.setPwrAttribute("$object.Order.ActualValue##Float32");
    ...
    pwr_valuesmall43.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall43.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall43.dd, "$object.Order")
      });
    ...
    pwr_smallbuttoncenter44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter44.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter44.dd, "$object.Mode.OpAuto##Boolean")
      });
    ...
    pwr_indround46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround46.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround46.dd, "!$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_slider149.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider149.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider149.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,526.65,448.913)
      });
    ...
    pwr_valueinputsmallrd50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd50.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd50.dd, "$object.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd50.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    ...
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter57.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.Mode.OpMan##Boolean")
      });
    ...
    pwr_indround58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround58.dd, "$object.Mode.OpNoLocal##Boolean",0)
    ...
    grp175_59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_59.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
    ...
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare62.dd, "$object.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 252.569F, 329.042F, 18.034F, 329.042F),
