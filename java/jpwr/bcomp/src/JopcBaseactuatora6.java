...
public class JopcBaseactuatora6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare31.setBounds(new Rectangle(172,114,16,17));
    ...
    jopBar37.setBounds(new Rectangle(355,132,24,242));
    ...
    jopBar38.setBounds(new Rectangle(409,132,24,242));
    ...
    pwr_indround42.setBounds(new Rectangle(105,388,17,18));
    ...
    grp173_43 = new Grp173_(session);
    grp173_43.setBounds(new Rectangle(48,387,35,18));
    localPanel.add(grp173_43, new Proportion(grp173_43.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_actuator41.dd.setActionType(2);
    ...
    pwr_indround42.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround42.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround42.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp173_43.dd.setDynType(129);
    grp173_43.dd.setActionType(0);
    grp173_43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_43.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SwitchClosed",43, 130);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
