...
public class JopcComponoffzone extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputmediumrd	pwr_valueinputmediumrd11;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd13;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd15;
  pwr_valueinputmediumrd	pwr_valueinputmediumrd17;
  public JopcComponoffzone( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcComponoffzone( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcComponoffzone");
    pwr_valuelong1 = new pwr_valuelong(session);
    pwr_valuelong1.setBounds(new Rectangle(11,29,385,22));
    ...
    pwr_menubar22.setBounds(new Rectangle(0,0,401,24));
    ...
    pwr_pulldownmenu24.setBounds(new Rectangle(313,0,69,24));
    ...
    pwr_indsquare6.setBounds(new Rectangle(213,71,15,17));
    ...
    pwr_valuemedium8.setBounds(new Rectangle(214,93,94,24));
    ...
    pwr_valuemedium10.setBounds(new Rectangle(214,119,94,24));
    localPanel.add(pwr_valuemedium10, new Proportion(pwr_valuemedium10.getBounds(), dsize));
    pwr_valueinputmediumrd11 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd11.setBounds(new Rectangle(210,144,103,30));
    pwr_valueinputmediumrd11.setColorTone(10);
    pwr_valueinputmediumrd11.setColorBrightness(2);
    pwr_valueinputmediumrd11.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd11, new Proportion(pwr_valueinputmediumrd11.getBounds(), dsize));
    pwr_valueinputmediumrd13 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd13.setBounds(new Rectangle(210,175,103,30));
    pwr_valueinputmediumrd13.setColorTone(10);
    pwr_valueinputmediumrd13.setColorBrightness(2);
    pwr_valueinputmediumrd13.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd13, new Proportion(pwr_valueinputmediumrd13.getBounds(), dsize));
    pwr_valueinputmediumrd15 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd15.setBounds(new Rectangle(210,206,103,30));
    pwr_valueinputmediumrd15.setColorTone(10);
    pwr_valueinputmediumrd15.setColorBrightness(2);
    pwr_valueinputmediumrd15.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd15, new Proportion(pwr_valueinputmediumrd15.getBounds(), dsize));
    pwr_valueinputmediumrd17 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd17.setBounds(new Rectangle(210,238,103,30));
    pwr_valueinputmediumrd17.setColorTone(10);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare6.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare6.dd, "$object.Executing##Boolean",29)
      });
    pwr_valuemedium8.dd.setDynType(1025);
    pwr_valuemedium8.dd.setActionType(0);
    pwr_valuemedium8.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium8.dd, "$object.NumberOfBurners##UInt32","%d")
      });
    ...
    pwr_valuemedium10.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuemedium10.dd, "$object.Power##Float32","%6.2f")
      });
    pwr_valueinputmediumrd11.dd.setDynType(1025);
    pwr_valueinputmediumrd11.dd.setActionType(4096);
    pwr_valueinputmediumrd11.dd.setAccess(33554492);
    pwr_valueinputmediumrd11.dd.setElements(new GeDynElemIfc[] {
    ...
    pwr_valueinputmediumrd13.dd.setElements(new GeDynElemIfc[] {
    ...
    pwr_valueinputmediumrd15.dd.setElements(new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 282;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(11.9087F, 55.6405F, 383.944F, 225.242F),
    new Polygon( new int[] { 12, 396, 394, 14, 14, 12}, new int[] { 56, 56, 58, 58, 279, 281}, 6), 
    new Polygon( new int[] { 396, 396, 394, 394, 14, 12}, new int[] { 281, 56, 58, 279, 279, 281}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Executing"),48, 84);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Number of burners"),48, 110);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Power"),48, 136);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("MinPower"),48, 162);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("MaxPower"),48, 193);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("BurnerTimeMinOn"),48, 225);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("BurnerTimeMinOff"),48, 256);
    g.setTransform(save);
  }
