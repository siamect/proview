...
public class JopcComponoffzone extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_valuelong1.setBounds(new Rectangle(12,30,383,20));
    ...
    pwr_menubar22.setBounds(new Rectangle(1,1,399,22));
    ...
    pwr_pulldownmenu24.setBounds(new Rectangle(314,1,67,22));
    ...
    pwr_indsquare6.setBounds(new Rectangle(214,72,13,15));
    ...
    pwr_valuemedium8.setBounds(new Rectangle(215,94,92,22));
    ...
    pwr_valuemedium10.setBounds(new Rectangle(215,120,92,22));
    ...
    pwr_valueinputmediumrd11.setBounds(new Rectangle(211,145,101,28));
    ...
    pwr_valueinputmediumrd13.setBounds(new Rectangle(211,176,101,28));
    ...
    pwr_valueinputmediumrd15.setBounds(new Rectangle(211,207,101,28));
    ...
    pwr_valueinputmediumrd17.setBounds(new Rectangle(211,239,101,28));
