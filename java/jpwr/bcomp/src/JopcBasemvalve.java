...
public class JopcBasemvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  JopSmallbutton	jopSmallbutton36;
  pwr_indsquare	pwr_indsquare38;
  JopSmallbutton	jopSmallbutton39;
  JopSmallbutton	jopSmallbutton40;
  pwr_indround	pwr_indround42;
  pwr_indround	pwr_indround43;
  pwr_valveanim2	pwr_valveanim244;
  pwr_mvalve	pwr_mvalve45;
  pwr_indsquare	pwr_indsquare47;
  public JopcBasemvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare29.setBounds(new Rectangle(165,185,15,17));
    ...
    pwr_indsquare30.setBounds(new Rectangle(166,204,16,17));
    ...
    jopSmallbutton31.setBounds(new Rectangle(36,340,48,21));
    jopSmallbutton31.setFillColor(32);
    localPanel.add(jopSmallbutton31, new Proportion(jopSmallbutton31.getBounds(), dsize));
    pwr_indround32 = new pwr_indround(session);
    pwr_indround32.setBounds(new Rectangle(96,319,18,18));
    ...
    pwr_indround33.setBounds(new Rectangle(96,341,18,18));
    ...
    pwr_mbsimulate35.setBounds(new Rectangle(508,24,20,20));
    localPanel.add(pwr_mbsimulate35, new Proportion(pwr_mbsimulate35.getBounds(), dsize));
    jopSmallbutton36 = new JopSmallbutton(session);
    jopSmallbutton36.setBounds(new Rectangle(36,317,48,21));
    jopSmallbutton36.setFillColor(32);
    localPanel.add(jopSmallbutton36, new Proportion(jopSmallbutton36.getBounds(), dsize));
    pwr_indsquare38 = new pwr_indsquare(session);
    pwr_indsquare38.setBounds(new Rectangle(166,233,16,17));
    ...
    jopSmallbutton39 = new JopSmallbutton(session);
    jopSmallbutton39.setBounds(new Rectangle(159,340,56,21));
    jopSmallbutton39.setFillColor(32);
    localPanel.add(jopSmallbutton39, new Proportion(jopSmallbutton39.getBounds(), dsize));
    jopSmallbutton40 = new JopSmallbutton(session);
    jopSmallbutton40.setBounds(new Rectangle(159,316,56,21));
    ...
    pwr_indround42.setBounds(new Rectangle(228,319,17,18));
    ...
    pwr_indround43.setBounds(new Rectangle(228,341,17,18));
    pwr_indround43.setShadow(1);
    localPanel.add(pwr_indround43, new Proportion(pwr_indround43.getBounds(), dsize));
    pwr_valveanim244 = new pwr_valveanim2(session);
    pwr_valveanim244.setBounds(new Rectangle(114,116,71,64));
    pwr_valveanim244.setShadow(1);
    localPanel.add(pwr_valveanim244, new Proportion(pwr_valveanim244.getBounds(), dsize));
    pwr_mvalve45 = new pwr_mvalve(session);
    pwr_mvalve45.setBounds(new Rectangle(326,155,155,147));
    pwr_mvalve45.setShadow(1);
    localPanel.add(pwr_mvalve45, new Proportion(pwr_mvalve45.getBounds(), dsize));
    pwr_indsquare47 = new pwr_indsquare(session);
    pwr_indsquare47.setBounds(new Rectangle(166,251,16,17));
    pwr_indsquare47.setFillColor(176);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu25.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu25.dd, new String[] {
        "Order Do","SwitchOpen Di","SwitchClosed Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare30.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare30.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare30.dd, "$object.SwitchClosed")
      });
    jopSmallbutton31.dd.setDynType(129);
    jopSmallbutton31.dd.setActionType(4);
    jopSmallbutton31.dd.setAccess(65532);
    jopSmallbutton31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton31.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton31.dd, "$object.Mode.OpAuto##Boolean")
      });
    jopSmallbutton31.setAnnot1(" Auto");
    ...
    pwr_mbsimulate35.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate35.dd, "Open simulate graph")
      });
    jopSmallbutton36.dd.setDynType(128);
    jopSmallbutton36.dd.setActionType(4);
    jopSmallbutton36.dd.setAccess(65532);
    jopSmallbutton36.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton36.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton36.dd, "$object.Mode.OpMan##Boolean")
      });
    jopSmallbutton36.setAnnot1(" Man");
    ...
    pwr_indsquare38.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare38.dd, "$object.Order.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare38.dd, "$object.Order")
      });
    jopSmallbutton39.dd.setDynType(129);
    jopSmallbutton39.dd.setActionType(8);
    jopSmallbutton39.dd.setAccess(65532);
    jopSmallbutton39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton39.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton39.dd, "!$object.Mode.ManMode##Boolean",1)
      ,new GeDynResetDig(jopSmallbutton39.dd, "$object.Mode.OpRefMan##Boolean")
      });
    jopSmallbutton39.setAnnot1("Close");
    jopSmallbutton40.dd.setDynType(128);
    jopSmallbutton40.dd.setActionType(4);
    jopSmallbutton40.dd.setAccess(65532);
    jopSmallbutton40.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton40.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton40.dd, "!$object.Mode.ManMode##Boolean",1)
      ,new GeDynSetDig(jopSmallbutton40.dd, "$object.Mode.OpRefMan##Boolean")
      });
    jopSmallbutton40.setAnnot1("Open ");
    ...
    pwr_valveanim244.dd.setDynType(66572);
    pwr_valveanim244.dd.setActionType(0);
    pwr_valveanim244.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valveanim244.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_valveanim244.dd, "$object.IndWarning##Boolean",114)
      ,new GeDynDigColor(pwr_valveanim244.dd, "$object.SwitchClosed.ActualValue##Boolean",31)
      ,new GeDynDigLowColor(pwr_valveanim244.dd, "$object.SwitchOpen.ActualValue##Boolean",37)
      ,new GeDynValue(pwr_valveanim244.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_valveanim244.dd, "!$object.SwitchOpen.ActualValue##Boolean",2)
      });
    pwr_mvalve45.dd.setDynType(1);
    pwr_mvalve45.dd.setActionType(0);
    ...
    pwr_indsquare47.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_indsquare47.dd, "$object.Order")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SwitchClosed",38, 220);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
