...
public class JopcBasefanaggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  BorderLayout borderLayout1 = new BorderLayout();
  LocalPanel localPanel = new LocalPanel();
  boolean scrollbar = false;
  Dimension size;
  pwr_overloadrelay	pwr_overloadrelay0;
  ...
  public JopcBasefanaggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefanaggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefanaggr4");
    pwr_overloadrelay0 = new pwr_overloadrelay(session);
    pwr_overloadrelay0.setBounds(new Rectangle(248,291,38,27));
    pwr_overloadrelay0.setShadow(1);
    localPanel.add(pwr_overloadrelay0, new Proportion(pwr_overloadrelay0.getBounds(), dsize));
    ...
    pwr_indsquare9.setBounds(new Rectangle(185,335,16,16));
    ...
    pwr_indround29.setBounds(new Rectangle(87,216,18,17));
    ...
    pwr_rod31.setBounds(new Rectangle(138,433,39,10));
    ...
    pwr_fananim39.setBounds(new Rectangle(123,391,19,91));
    ...
    pwr_motor249.setBounds(new Rectangle(173,401,98,74));
    ...
    pwr_indsquare58.setBounds(new Rectangle(185,361,16,17));
    ...
    grp179_62.setBounds(new Rectangle(30,193,43,18));
    ...
    pwr_overloadrelay0.dd.setDynType(1);
    pwr_overloadrelay0.dd.setActionType(66);
    pwr_overloadrelay0.dd.setAccess(33619967);
    pwr_overloadrelay0.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_overloadrelay0.dd, "$object.OverloadRelay")
      ,new GeDynCommand(pwr_overloadrelay0.dd, "open graph /class/instance=$object.OverloadRelay")
      });
