...
public class JopcBasepumpaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(93,373,84,74));
    ...
    pwr_motor245.setBounds(new Rectangle(173,373,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(185,333,16,16));
    ...
    grp173_55.setBounds(new Rectangle(69,333,40,17));
    ...
    grp185_58 = new Grp185_(session);
    grp185_58.setBounds(new Rectangle(30,193,41,18));
    localPanel.add(grp185_58, new Proportion(grp185_58.getBounds(), dsize));
...
null,null,    new GeDyn(pwr_pulldownmenu244,1,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp185_58.dd.setDynType(129);
    grp185_58.dd.setActionType(0);
    grp185_58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp185_58.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 268F, 304F, 268F, 290F),
    new Polygon( new int[] { 228, 264, 268, 268, 268, 264}, new int[] {378, 378, 374, 338, 374, 378}, 6),
  };
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, 0}, new int[] { 8, 10, 13,30}, 4),
    ...
    new Polygon( new int[] { 6, 7, 24, 0}, new int[] { 40, 36, -1220087377,30}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, 0}, new int[] { 46, 46, 54,30}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1220087408, 0}, new int[] { 10, 14, -1220087377,30}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1220087408, 0}, new int[] { 14, 19, -1220087377,30}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220087390, 17}, new int[] { 12, 15, -1220087347,60}, 4),
