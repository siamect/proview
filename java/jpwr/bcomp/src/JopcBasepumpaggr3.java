...
public class JopcBasepumpaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(94,374,82,72));
    ...
    pwr_motor245.setBounds(new Rectangle(174,374,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(186,334,14,14));
    ...
    grp185_58.setBounds(new Rectangle(31,194,39,16));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, 992, 0}, new int[] { 40, 36, -1219915345,30}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915376, 0}, new int[] { 10, 14, -1219915345,30}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893319, 0}, new int[] { 14, 19, 144126454,30}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915358, 17}, new int[] { 12, 15, -1219915315,60}, 4),
