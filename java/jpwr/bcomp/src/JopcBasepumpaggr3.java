...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219706480, 0}, new int[] { 10, 14, -1219706449,30}, 4),
    ...
    new Polygon( new int[] { 6, 9, 154360911, 0}, new int[] { 14, 19, 30,30}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706462, 17}, new int[] { 12, 15, -1219706419,60}, 4),
