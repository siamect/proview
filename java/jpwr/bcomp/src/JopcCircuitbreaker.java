...
public class JopcCircuitbreaker extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare2.setBounds(new Rectangle(133,110,13,14));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(16,208,45,18));
    ...
    pwr_valuelong20.setBounds(new Rectangle(73,208,331,20));
    ...
    pwr_mbup30.setBounds(new Rectangle(362,19,17,17));
