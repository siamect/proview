...
public class JopcBaseactuatorincrdecr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup49;
  public JopcBaseactuatorincrdecr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatorincrdecr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatorincrdecr3");
    ...
    pwr_menubar25.setBounds(new Rectangle(1,1,416,22));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(318,1,67,22));
    ...
    pwr_mbnote19.setBounds(new Rectangle(36,25,18,18));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(159,1,67,22));
    ...
    pwr_actuator27 = new pwr_actuator(session);
    pwr_actuator27.setBounds(new Rectangle(159,116,66,42));
    pwr_actuator27.setShadow(1);
    localPanel.add(pwr_actuator27, new Proportion(pwr_actuator27.getBounds(), dsize));
    pwr_smallbuttoncenter30 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter30.setBounds(new Rectangle(174,339,60,19));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(38,338,46,19));
    ...
    pwr_indround32.setBounds(new Rectangle(98,342,16,16));
    ...
    pwr_indround33.setBounds(new Rectangle(98,364,16,16));
    ...
    pwr_smallbuttoncenter34.setBounds(new Rectangle(174,363,60,19));
    ...
    pwr_indround35.setBounds(new Rectangle(98,388,16,16));
    pwr_indround35.setFillColor(114);
    ...
    pwr_indround36.setBounds(new Rectangle(246,343,16,16));
    ...
    grp203_37 = new Grp203_(session);
    grp203_37.setBounds(new Rectangle(40,389,35,16));
    localPanel.add(grp203_37, new Proportion(grp203_37.getBounds(), dsize));
    pwr_indround38 = new pwr_indround(session);
    pwr_indround38.setBounds(new Rectangle(246,365,16,16));
    ...
    pwr_smallbuttoncenter39.setBounds(new Rectangle(174,386,60,19));
    ...
    pwr_smallbuttoncenter40.setBounds(new Rectangle(174,363,60,19));
    ...
    pwr_smallbuttoncenter41.setBounds(new Rectangle(174,339,60,19));
    ...
    grp207_42 = new Grp207_(session);
    grp207_42.setBounds(new Rectangle(40,364,39,16));
    localPanel.add(grp207_42, new Proportion(grp207_42.getBounds(), dsize));
    pwr_smallbuttoncenter43 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter43.setBounds(new Rectangle(38,363,46,19));
    ...
    pwr_indsquare47.setBounds(new Rectangle(137,186,14,15));
    ...
    pwr_indsquare48.setBounds(new Rectangle(138,205,14,15));
    ...
    pwr_mbup49.setBounds(new Rectangle(382,25,18,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_actuator27.dd.setDynType(1);
    pwr_actuator27.dd.setActionType(0);
    pwr_smallbuttoncenter30.dd.setDynType(129);
    pwr_smallbuttoncenter30.dd.setActionType(34);
    pwr_smallbuttoncenter30.dd.setAccess(65532);
    pwr_smallbuttoncenter30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter30.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter30.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter30.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter30.dd, "$object.Mode.OpManStart")
      ,new GeDynStoDig(pwr_smallbuttoncenter30.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter30.setAnnot1("Incr");
    ...
    pwr_smallbuttoncenter31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter31.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter31.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter31.dd, "$object.Mode.OpMan")
    ...
    pwr_indround32.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround32.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround32.dd, "!$object.Mode.AutoMode##Boolean",29)
      });
    pwr_indround33.dd.setDynType(133);
    pwr_indround33.dd.setActionType(0);
    pwr_indround33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround33.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround33.dd, "$object.Mode.AutoMode##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter34.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter34.dd, "$object.Mode.OpManStop")
      ,new GeDynStoDig(pwr_smallbuttoncenter34.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter34.setAnnot1("Decr");
    pwr_indround35.dd.setDynType(133);
    pwr_indround35.dd.setActionType(0);
    pwr_indround35.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround35.dd, "$object.Mode.LocalModHide##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround35.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    ...
    grp203_37.dd.setDynType(129);
    grp203_37.dd.setActionType(0);
    grp203_37.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp203_37.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    pwr_indround38.dd.setDynType(5);
    pwr_indround38.dd.setActionType(0);
    pwr_indround38.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround38.dd, "$object.Mode.FeedbackDecr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter39.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter39.dd, "$object.Mode.ManStopHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter39.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter39.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter39.dd, "$object.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter39.setAnnot1("Stop");
    ...
    pwr_smallbuttoncenter40.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter40.dd, "$object.Mode.OpManDecr##Boolean")
      });
    ...
    pwr_smallbuttoncenter41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter41.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter41.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter41.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter41.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter41.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter41.setAnnot1("Incr");
    grp207_42.dd.setDynType(129);
    grp207_42.dd.setActionType(0);
    grp207_42.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp207_42.dd, "$object.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter43.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynInvisible(pwr_smallbuttoncenter43.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter43.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter43.dd, "$object.Mode.OpAuto##Boolean")
      });
    ...
    pwr_indsquare47.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare47.dd, "$object.OrderIncr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare47.dd, "$object.OrderIncr")
      });
    ...
    pwr_indsquare48.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare48.dd, "$object.OrderDecr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare48.dd, "$object.OrderDecr")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(17.0002F, 304.139F, 381.564F, 121.555F),
    new Polygon( new int[] { 17, 399, 398, 18, 18, 17}, new int[] { 304, 304, 305, 305, 425, 426}, 6), 
    new Polygon( new int[] { 399, 399, 398, 398, 18, 17}, new int[] { 426, 304, 305, 425, 425, 426}, 6), 
    new Rectangle2D.Float(2.00029F, 22.5515F, 414.802F, 22.4305F),
    new Line2D.Float( 396.986F, 329.042F, 17.6613F, 329.042F),
    new Rectangle2D.Float(17.0002F, 98.9982F, 381.564F, 197.211F),
    new Polygon( new int[] { 17, 399, 398, 18, 18, 17}, new int[] { 99, 99, 100, 100, 295, 296}, 6), 
    new Polygon( new int[] { 399, 399, 398, 398, 18, 17}, new int[] { 296, 99, 100, 295, 295, 296}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.00029F,44.982F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.00029F,22.5515F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[3]);
...
protected class pwr_basevalve__p3 extends GeComponent {
  // Dimension size;
  public pwr_basevalve__p3( JopSession session)
  {
    super( session);
