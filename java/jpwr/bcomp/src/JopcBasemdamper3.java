...
public class JopcBasemdamper3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp196_	grp196_42;
  pwr_damperanim2	pwr_damperanim245;
  pwr_mdamper	pwr_mdamper46;
  pwr_mbup	pwr_mbup47;
  public JopcBasemdamper3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemdamper3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemdamper3");
    ...
    pwr_valuelong23.setTextColor(31);
    ...
    pwr_damperanim245 = new pwr_damperanim2(session);
    pwr_damperanim245.setBounds(new Rectangle(124,119,63,44));
    pwr_damperanim245.setFillColor(74);
    pwr_damperanim245.setShadow(1);
    localPanel.add(pwr_damperanim245, new Proportion(pwr_damperanim245.getBounds(), dsize));
    pwr_mdamper46 = new pwr_mdamper(session);
    pwr_mdamper46.setBounds(new Rectangle(319,177,145,145));
    localPanel.add(pwr_mdamper46, new Proportion(pwr_mdamper46.getBounds(), dsize));
    pwr_mbup47 = new pwr_mbup(session);
    pwr_mbup47.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup47, new Proportion(pwr_mbup47.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_damperanim245.dd.setDynType(66572);
    pwr_damperanim245.dd.setActionType(0);
    pwr_damperanim245.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_damperanim245.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_damperanim245.dd, "$object.IndWarning##Boolean",114)
      ,new GeDynDigLowColor(pwr_damperanim245.dd, "$object.Order.ActualValue##Boolean",31)
      ,new GeDynValue(pwr_damperanim245.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_damperanim245.dd, "!$object.Order.ActualValue##Boolean",2)
      });
    pwr_mdamper46.dd.setDynType(1);
    pwr_mdamper46.dd.setActionType(0);
    pwr_mbup47.dd.setDynType(129);
    pwr_mbup47.dd.setActionType(8256);
    pwr_mbup47.dd.setAccess(33619967);
    pwr_mbup47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup47.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup47.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup47.dd, JopLang.transl("Open parent object graph"))
      });
