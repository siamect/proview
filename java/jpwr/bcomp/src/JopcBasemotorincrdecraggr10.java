...
public class JopcBasemotorincrdecraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(151,348,14,14));
    ...
    pwr_indsquare10.setBounds(new Rectangle(151,393,14,14));
    ...
    pwr_smallbuttoncenter15.setBounds(new Rectangle(156,194,60,19));
    ...
    pwr_indround30.setBounds(new Rectangle(101,217,16,16));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(5,563,45,19));
    ...
    pwr_valuelong33.setBounds(new Rectangle(61,562,334,21));
    ...
    pwr_indround36.setBounds(new Rectangle(227,174,16,16));
    ...
    pwr_contactor237.setBounds(new Rectangle(249,338,36,36));
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(249,383,36,37));
    ...
    pwr_motor247.setBounds(new Rectangle(174,458,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(151,419,14,15));
    ...
    grp173_55.setBounds(new Rectangle(35,419,38,15));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(169,484,10,20));
    ...
    pwr_contactor258.setBounds(new Rectangle(306,338,36,36));
    ...
    pwr_indsquare60.setBounds(new Rectangle(212,348,14,14));
    ...
    pwr_smallbuttoncenter15.dd.setActionType(34);
    pwr_smallbuttoncenter15.dd.setAccess(65532);
    pwr_smallbuttoncenter15.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter15.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynStoDig(pwr_smallbuttoncenter15.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter15.setAnnot1("Decr");
    ...
    pwr_indround36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround36.dd, "$object.Mode.FeedbackIncr##Boolean",29)
      });
...
null,    new GeDyn(pwr_pulldownmenu244,129,65,65535,new GeDynElemIfc[] {
...
null,    new GeDyn(pwr_pulldownmenu246,1,65,33619967,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, -18, -18}, new int[] { 146, 147, 48,0}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Decr"),177, 361);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),113, 361);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 55, 55}, new int[] { 12, 15, 102,53}, 4),
