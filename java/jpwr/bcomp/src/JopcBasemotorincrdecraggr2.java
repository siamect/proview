...
public class JopcBasemotorincrdecraggr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbsimulate	pwr_mbsimulate54;
  ...
  pwr_mbup	pwr_mbup78;
  public JopcBasemotorincrdecraggr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr2");
    ...
    pwr_valuelong12.setBorderColor(33);
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(40,168,48,21));
    ...
    pwr_smallbuttoncenter16.setBounds(new Rectangle(155,193,62,21));
    pwr_smallbuttoncenter16.setFillColor(32);
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,546,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,545,336,23));
    ...
    pwr_menubar242.setBounds(new Rectangle(0,0,409,24));
    ...
    pwr_pulldownmenu243.setBounds(new Rectangle(8,0,44,24));
    ...
    pwr_pulldownmenu244.setBounds(new Rectangle(328,0,69,24));
    ...
    pwr_pulldownmenu245.setBounds(new Rectangle(220,0,69,24));
    ...
    pwr_pulldownmenu246.setBounds(new Rectangle(52,0,69,24));
    ...
    pwr_pulldownmenu247.setBounds(new Rectangle(124,0,88,24));
    ...
    pwr_valuesmall51.setBounds(new Rectangle(303,246,71,18));
    localPanel.add(pwr_valuesmall51, new Proportion(pwr_valuesmall51.getBounds(), dsize));
    pwr_mbsimulate54 = new pwr_mbsimulate(session);
    pwr_mbsimulate54.setBounds(new Rectangle(363,24,19,20));
    localPanel.add(pwr_mbsimulate54, new Proportion(pwr_mbsimulate54.getBounds(), dsize));
    pwr_indsquare55 = new pwr_indsquare(session);
    pwr_indsquare55.setBounds(new Rectangle(150,402,16,16));
    ...
    grp173_56 = new Grp173_(session);
    grp173_56.setBounds(new Rectangle(34,402,40,18));
    localPanel.add(grp173_56, new Proportion(grp173_56.getBounds(), dsize));
    pwr_indsquare57 = new pwr_indsquare(session);
    pwr_indsquare57.setBounds(new Rectangle(150,374,16,16));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(168,467,12,21));
    ...
    pwr_smallbuttoncenter13.dd.setDynType(129);
    pwr_smallbuttoncenter13.dd.setActionType(6);
    pwr_smallbuttoncenter13.dd.setAccess(65532);
    pwr_smallbuttoncenter13.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter13.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter13.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter13.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(pwr_smallbuttoncenter13.dd, "$object.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter13.setAnnot1("Man");
    ...
    pwr_smallbuttoncenter16.dd.setDynType(129);
    pwr_smallbuttoncenter16.dd.setActionType(34);
    pwr_smallbuttoncenter16.dd.setAccess(65532);
    pwr_smallbuttoncenter16.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter16.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter16.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter16.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter16.dd, "$object.Mode.OpManStop")
      ,new GeDynStoDig(pwr_smallbuttoncenter16.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter16.setAnnot1("Decr");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu245,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.ContactorIncr.Order")
      }),
    new GeDyn(pwr_pulldownmenu245,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu245.dd, "$object.ContactorIncr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.ContactorIncr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu245,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.ContactorDecr.Order")
      }),
    new GeDyn(pwr_pulldownmenu245,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu245.dd, "$object.ContactorDecr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.ContactorDecr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu245,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.OverloadRelay.Overload")
      }),
null,    new GeDyn(pwr_pulldownmenu245,129,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.ContactorIncr")
      }),
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.ContactorDecr")
      }),
    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.OverloadRelay")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate54.dd.setDynType(129);
    pwr_mbsimulate54.dd.setActionType(8256);
    pwr_mbsimulate54.dd.setAccess(65532);
    pwr_mbsimulate54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate54.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate54.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate54.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_indsquare55.dd.setDynType(176);
    pwr_indsquare55.dd.setActionType(2);
    pwr_indsquare55.dd.setAccess(65535);
    pwr_indsquare55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare55.dd, "!$object.Motor.DisplayInd##Boolean",0)
      ,new GeDynDigError(pwr_indsquare55.dd, "$object.Motor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare55.dd, "$object.Motor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare55.dd, "$object.Motor")
      });
    grp173_56.dd.setDynType(129);
    grp173_56.dd.setActionType(0);
    grp173_56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_56.dd, "!$object.Motor.DisplayInd##Boolean",0)
      });
    pwr_indsquare57.dd.setDynType(16);
    pwr_indsquare57.dd.setActionType(2);
    pwr_indsquare57.dd.setAccess(65532);
    pwr_indsquare57.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare57.dd, "$object.OverloadRelay.Overload.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare57.dd, "$object.OverloadRelay.Overload")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140859501, -26}, new int[] { 146, 147, 151091202,-13}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 150032167, 47}, new int[] { 12, 15, 144032840,40}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140857079, 47}, new int[] { 12, 15, 151494640,40}, 4),
