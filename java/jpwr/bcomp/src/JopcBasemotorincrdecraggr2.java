...
public class JopcBasemotorincrdecraggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton12.setBounds(new Rectangle(40,168,48,21));
    ...
    jopSmallbutton15.setBounds(new Rectangle(154,193,62,21));
    ...
    jopSmallbutton32.setBounds(new Rectangle(4,546,47,21));
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,545,336,23));
    ...
    pwr_indsquare54.setBounds(new Rectangle(150,402,16,16));
    ...
    grp173_55.setBounds(new Rectangle(34,402,39,18));
    ...
    pwr_rodcouplinganim59.setBounds(new Rectangle(168,467,12,21));
    ...
    jopSmallbutton15.dd.setActionType(34);
    jopSmallbutton15.dd.setAccess(65532);
    jopSmallbutton15.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton15.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynStoDig(jopSmallbutton15.dd, "$object.Mode.OpManDecr##Boolean")
      });
    jopSmallbutton15.setAnnot1("  Decr");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ContactorIncr.Order")
      }),
    new GeDyn(pwr_pulldownmenu44,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu44.dd, "$object.ContactorIncr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ContactorIncr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ContactorDecr.Order")
      }),
    new GeDyn(pwr_pulldownmenu44,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu44.dd, "$object.ContactorDecr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.ContactorDecr.Feedback")
      }),
...
null,    new GeDyn(pwr_pulldownmenu44,129,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu46.dd, "open graph /class /inst=$object.ContactorIncr")
      }),
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu46.dd, "open graph /class /inst=$object.ContactorDecr")
      }),
    new GeDyn(pwr_pulldownmenu46,1,65,65535,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(19.6569F, 278F, 360.366F, 263.256F),
