...
public class JopcBasem3wayvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valve3way2	pwr_valve3way250;
  public JopcBasem3wayvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasem3wayvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasem3wayvalve");
    ...
    pwr_mbnote21.setBounds(new Rectangle(35,25,20,20));
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(17,393,48,21));
    ...
    pwr_valuelong25.setBounds(new Rectangle(74,392,336,23));
    ...
    pwr_indsquare30.setBounds(new Rectangle(165,185,16,17));
    ...
    pwr_mbsimulate36.setBounds(new Rectangle(508,25,20,20));
    ...
    pwr_indround43.setBounds(new Rectangle(228,319,18,18));
    ...
    pwr_indround44.setBounds(new Rectangle(228,341,18,18));
    ...
    pwr_indsquare46.setBounds(new Rectangle(166,251,16,17));
    ...
    grp196_48.setBounds(new Rectangle(38,363,37,17));
    localPanel.add(grp196_48, new Proportion(grp196_48.getBounds(), dsize));
    pwr_m3wayvalve49 = new pwr_m3wayvalve(session);
    pwr_m3wayvalve49.setBounds(new Rectangle(325,154,157,148));
    pwr_m3wayvalve49.setShadow(1);
    localPanel.add(pwr_m3wayvalve49, new Proportion(pwr_m3wayvalve49.getBounds(), dsize));
    pwr_valve3way250 = new pwr_valve3way2(session);
    pwr_valve3way250.setBounds(new Rectangle(114,108,68,44));
    pwr_valve3way250.setShadow(1);
    localPanel.add(pwr_valve3way250, new Proportion(pwr_valve3way250.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valve3way250.dd.setDynType(17421);
    pwr_valve3way250.dd.setActionType(0);
    pwr_valve3way250.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valve3way250.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_valve3way250.dd, "$object.IndWarning##Boolean",114)
      ,new GeDynDigColor(pwr_valve3way250.dd, "$object.SwitchOpen.ActualValue##Boolean",74)
      ,new GeDynDigLowColor(pwr_valve3way250.dd, "$object.SwitchClosed.ActualValue##Boolean",36)
      ,new GeDynValue(pwr_valve3way250.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_valve3way250.dd, "$object.PosEnum##Int32")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(18F, 101.999F, 237.944F, 171.927F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 102, 102, 103, 103, 273, 274}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 274, 102, 103, 273, 273, 274}, 6), 
    new Rectangle2D.Float(64F, 128F, 53.2796F, 3.889F),
    new Polygon( new int[] { 64, 117, 116, 65, 65, 64}, new int[] { 128, 128, 129, 129, 131, 132}, 6), 
    new Polygon( new int[] { 117, 117, 116, 116, 65, 64}, new int[] { 132, 128, 129, 131, 131, 132}, 6), 
    new Rectangle2D.Float(154F, 128F, 53.2796F, 3.889F),
    new Polygon( new int[] { 154, 207, 206, 155, 155, 154}, new int[] { 128, 128, 129, 129, 131, 132}, 6), 
    new Polygon( new int[] { 207, 207, 206, 206, 155, 154}, new int[] { 132, 128, 129, 131, 131, 132}, 6), 
    ...
    new Rectangle2D.Float(198F, 166F, 10F, 5F),
    new Line2D.Float( 198F, 169F, 207F, 169F),
    new Line2D.Float( 207F, 167F, 207F, 169F),
    new Line2D.Float( 198F, 167F, 207F, 167F),
    new Line2D.Float( 198F, 166F, 208F, 166F),
    new Line2D.Float( 198F, 170F, 208F, 170F),
    new Line2D.Float( 208F, 166F, 208F, 170F),
    new Line2D.Float( 136F, 150F, 136F, 159F),
    new Line2D.Float( 146F, 168F, 198F, 168F),
    new Arc2D.Float(136F, 150F, 20F, 18F, 180F, 90F, Arc2D.OPEN),
    ...
    new Line2D.Float( 146F, 167F, 198F, 167F),
    new Line2D.Float( 146F, 169F, 198F, 169F),
    new Line2D.Float( 146F, 166F, 198F, 166F),
    new Line2D.Float( 146F, 170F, 198F, 170F),
    new Arc2D.Float(135F, 149F, 22F, 20F, 225F, 45F, Arc2D.OPEN),
    new Arc2D.Float(135F, 149F, 22F, 20F, 180F, 45F, Arc2D.OPEN),
    new Arc2D.Float(137F, 151F, 18F, 16F, 225F, 45F, Arc2D.OPEN),
    new Arc2D.Float(137F, 151F, 18F, 16F, 180F, 45F, Arc2D.OPEN),
    new Arc2D.Float(134F, 148F, 24F, 22F, 180F, 90F, Arc2D.OPEN),
    new Arc2D.Float(138F, 152F, 16F, 14F, 180F, 90F, Arc2D.OPEN),
  };
...
protected class pwr_valve3way2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, -26, -51}, new int[] { 12, 15, 149217009,-118}, 4),
    ...
    new Polygon( new int[] { 42, 40, -26, -51}, new int[] { 12, 15, 149217009,-118}, 4),
    ...
    new Polygon( new int[] { 22, 22, -26, -51}, new int[] { 22, 26, 149217009,-118}, 4),
