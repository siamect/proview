...
public class JopcBasecvalve6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_basevalve58.setBounds(new Rectangle(286,533,80,122));
    ...
    pwr_pulldownmenu261.setBounds(new Rectangle(161,0,69,24));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(36,342,48,21));
    ...
    pwr_indround63.setBounds(new Rectangle(96,397,18,18));
    ...
    pwr_valvecontrol268.setBounds(new Rectangle(110,115,66,43));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 1369, 32}, new int[] { 22, 26, -1219706456,23}, 4),
    ...
    new Polygon( new int[] { 42, 40, 1369, 32}, new int[] { 22, 26, -1219706456,23}, 4),
