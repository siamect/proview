...
public class JopcBasecvalve6 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_valvecontrol2	pwr_valvecontrol268;
  pwr_mbup	pwr_mbup69;
  ...
  public void geInit() {
    ...
    pwr_basevalve58 = new pwr_basevalve(session);
    pwr_basevalve58.setBounds(new Rectangle(287,534,78,120));
    pwr_basevalve58.setShadow(1);
    localPanel.add(pwr_basevalve58, new Proportion(pwr_basevalve58.getBounds(), dsize));
    pwr_pulldownmenu261 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu261.setBounds(new Rectangle(162,1,67,22));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround63.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_64 = new Grp175_(session);
    grp175_64.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_64, new Proportion(grp175_64.getBounds(), dsize));
    pwr_indsquare65 = new pwr_indsquare(session);
    pwr_indsquare65.setBounds(new Rectangle(184,488,14,14));
    pwr_indsquare65.setFillColor(114);
    pwr_indsquare65.setShadow(1);
    localPanel.add(pwr_indsquare65, new Proportion(pwr_indsquare65.getBounds(), dsize));
    pwr_valvecontrol268 = new pwr_valvecontrol2(session);
    pwr_valvecontrol268.setBounds(new Rectangle(111,116,64,41));
    pwr_valvecontrol268.setShadow(1);
    localPanel.add(pwr_valvecontrol268, new Proportion(pwr_valvecontrol268.getBounds(), dsize));
    pwr_mbup69 = new pwr_mbup(session);
    pwr_mbup69.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup69, new Proportion(pwr_mbup69.getBounds(), dsize));
    pwr_indsquare71 = new pwr_indsquare(session);
    pwr_indsquare71.setBounds(new Rectangle(167,269,14,15));
    pwr_indsquare71.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider149.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider149.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,534.706,685.913)
      });
    ...
    pwr_basevalve58.dd.setDynType(16385);
    pwr_basevalve58.dd.setActionType(66);
    pwr_basevalve58.dd.setAccess(65532);
    pwr_basevalve58.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve58.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve58.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve58.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_pulldownmenu261.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu261.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu261,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu261.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu261.setAnnot1("Components");
    pwr_smallbuttoncenter62.dd.setDynType(128);
    ...
    pwr_smallbuttoncenter62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter62.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter62.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter62.setAnnot1("Man");
    pwr_indround63.dd.setDynType(133);
    pwr_indround63.dd.setActionType(0);
    pwr_indround63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround63.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround63.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_64.dd.setDynType(129);
    grp175_64.dd.setActionType(0);
    grp175_64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_64.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare65.dd.setDynType(13);
    pwr_indsquare65.dd.setActionType(0);
    pwr_indsquare65.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare65.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare65.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    pwr_valvecontrol268.dd.setDynType(1034);
    pwr_valvecontrol268.dd.setActionType(0);
    pwr_valvecontrol268.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol268.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol268.dd, "$object.Actuator.IndWarning##Boolean",30)
      ,new GeDynValue(pwr_valvecontrol268.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      });
    ...
    pwr_indsquare71.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare71.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.1001F, 534.706F, 22.4305F),
    new Line2D.Float( 252.569F, 329.042F, 18.0341F, 329.042F),
    new Rectangle2D.Float(17.6251F, 304.139F, 237.944F, 121.555F),
    ...
    new Rectangle2D.Float(17.6251F, 98.9982F, 237.944F, 197.211F),
    ...
    new Rectangle2D.Float(54.5455F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 55, 115, 113, 57, 57, 55}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 115, 115, 113, 113, 57, 55}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
    new Rectangle2D.Float(149.791F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 150, 210, 208, 152, 152, 150}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 210, 210, 208, 208, 152, 150}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
  };
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 129, 32}, new int[] { 22, 26, -1219915264,-2147483648}, 4),
    ...
    new Polygon( new int[] { 42, 40, 129, 32}, new int[] { 22, 26, -1219915264,23}, 4),
