...
public class JopcBasevalve extends JopFrame implements JopUtilityIfc {
  ...
  pwr_menubar	pwr_menubar1;
  pwr_pulldownmenu	pwr_pulldownmenu2;
  ...
  public void geInit() {
    ...
    pwr_valuelong0.setBounds(new Rectangle(16,46,385,22));
    ...
    pwr_menubar1 = new pwr_menubar(session);
    pwr_menubar1.setBounds(new Rectangle(0,0,408,24));
    pwr_menubar1.setShadow(1);
    localPanel.add(pwr_menubar1, new Proportion(pwr_menubar1.getBounds(), dsize));
    pwr_pulldownmenu2 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu2.setBounds(new Rectangle(10,0,69,24));
    pwr_pulldownmenu2.setShadow(1);
    localPanel.add(pwr_pulldownmenu2, new Proportion(pwr_pulldownmenu2.getBounds(), dsize));
    pwr_pulldownmenu3 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu3.setBounds(new Rectangle(328,0,69,24));
    ...
    jopSmallbutton17.setBounds(new Rectangle(17,316,48,21));
    ...
    pwr_valuelong18.setBounds(new Rectangle(16,70,385,22));
    ...
    pwr_valuelong19.setBounds(new Rectangle(74,315,336,23));
    ...
    pwr_basevalve21 = new pwr_basevalve(session);
    pwr_basevalve21.setBounds(new Rectangle(92,111,125,191));
    pwr_basevalve21.setShadow(1);
    localPanel.add(pwr_basevalve21, new Proportion(pwr_basevalve21.getBounds(), dsize));
    ...
    pwr_menubar1.dd.setDynType(1);
    pwr_menubar1.dd.setActionType(0);
    pwr_pulldownmenu2.dd.setDynType(0);
    pwr_pulldownmenu2.dd.setActionType(524288);
    pwr_pulldownmenu2.dd.setAccess(65535);
    pwr_pulldownmenu2.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu2.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu2,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu2.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu2,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu2.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu2.setAnnot1("File");
    pwr_pulldownmenu3.dd.setDynType(1);
    pwr_pulldownmenu3.dd.setActionType(524288);
    pwr_pulldownmenu3.dd.setAccess(65532);
    pwr_pulldownmenu3.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu3.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu3,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu3.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu3.setAnnot1("Help");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_basevalve21.dd.setDynType(1);
    pwr_basevalve21.dd.setActionType(0);
