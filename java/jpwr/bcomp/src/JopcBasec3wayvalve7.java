...
public class JopcBasec3wayvalve7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valve3waycontrol2	pwr_valve3waycontrol263;
  pwr_base3wayvalve	pwr_base3wayvalve65;
  pwr_base3wayvalve2	pwr_base3wayvalve266;
  pwr_mbup	pwr_mbup67;
  pwr_indsquare	pwr_indsquare69;
  public JopcBasec3wayvalve7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasec3wayvalve7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasec3wayvalve7");
    ...
    pwr_indsquare50.setBounds(new Rectangle(166,235,13,15));
    ...
    pwr_valve3waycontrol263 = new pwr_valve3waycontrol2(session);
    pwr_valve3waycontrol263.setBounds(new Rectangle(111,100,64,51));
    pwr_valve3waycontrol263.setShadow(1);
    localPanel.add(pwr_valve3waycontrol263, new Proportion(pwr_valve3waycontrol263.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valve3waycontrol263.dd.setDynType(17456);
    pwr_valve3waycontrol263.dd.setActionType(0);
    pwr_valve3waycontrol263.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_valve3waycontrol263.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_valve3waycontrol263.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynValue(pwr_valve3waycontrol263.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_valve3waycontrol263.dd, "$object.Actuator.PosEnum##Int32")
      });
    ...
    pwr_indsquare69.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare69.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Position error"),38, 248);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 280);
...
protected class pwr_base3wayvalve extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 42, 41, 45, 46}, new int[] { 68, 65, 65,68}, 4),
    ...
    new Polygon( new int[] { 46, 45, 43, 42}, new int[] { 20, 23, 23,20}, 4),
    new Polygon( new int[] { 42, 43, 39, 38}, new int[] { 20, 23, 21,18}, 4),
    new Polygon( new int[] { 38, 39, 29, 27}, new int[] { 18, 21, 21,18}, 4),
    new Polygon( new int[] { 27, 29, 29, 44}, new int[] { 18, 21, 21,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915267, 44}, new int[] { 48, 50, -1219915299,12}, 4),
    ...
    new Polygon( new int[] { 26, 29, -1219915331, 44}, new int[] { 18, 21, -1219915363,-2147483648}, 4),
...
protected class pwr_base3wayvalve2 extends GeComponent {
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {34, 30, 28, 34, 34, 38, 34}, 7),
    new Polygon( new int[] { 48, 42, 42, 40, 38, 38, 42, 42, 46, 48, 48}, new int[] {22, 22, 66, 66, 68, 78, 78, 68, 68, 66, 22}, 11),
    new Polygon( new int[] { 48, 47, 44, 42}, new int[] { 22, 23, 23,22}, 4),
    new Polygon( new int[] { 42, 44, 44, 42}, new int[] { 22, 23, 67,66}, 4),
    new Polygon( new int[] { 42, 44, 42, 40}, new int[] { 66, 67, 67,66}, 4),
    ...
    new Polygon( new int[] { 42, 43, 46, 46}, new int[] { 68, 67, 67,68}, 4),
    new Polygon( new int[] { 46, 46, 47, 48}, new int[] { 68, 67, 66,66}, 4),
    new Polygon( new int[] { 48, 47, 47, 48}, new int[] { 66, 66, 23,22}, 4),
    new Polygon( new int[] { 48, 47, 44, 44}, new int[] { 22, 23, 12,12}, 4),
    new Polygon( new int[] { 48, 22, 22, 16, 16, 18, 22, 26, 38, 42, 46, 48}, new int[] {22, 22, 66, 66, 22, 20, 20, 18, 18, 20, 20, 22}, 12),
    new Polygon( new int[] { 48, 44, 22, 22}, new int[] { 22, 20, 20,22}, 4),
    ...
    new Polygon( new int[] { 42, 44, 45, 46}, new int[] { 20, 22, 22,20}, 4),
    new Polygon( new int[] { 46, 45, 44, 48}, new int[] { 20, 22, 20,22}, 4),
    new Polygon( new int[] { 48, 44, 1645, 44}, new int[] { 22, 20, -1219915363,12}, 4),
    new Rectangle2D.Float(22F, 68F, 4F, 10F),
    new Polygon( new int[] { 22, 26, 26, 22, 22, 22}, new int[] { 68, 68, 68, 68, 78, 78}, 6), 
    new Polygon( new int[] { 26, 26, 26, 26, 22, 22}, new int[] { 78, 68, 68, 78, 78, 78}, 6), 
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {54, 50, 52, 44, 44, 48, 54}, 7),
    ...
    new Polygon( new int[] { 6, 11, 1645, 44}, new int[] { 52, 50, -1219915363,-2147483648}, 4),
    ...
    new Polygon( new int[] { 31, 34, 44, 44}, new int[] { 26, 27, 12,12}, 4),
...
protected class pwr_valve3waycontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 187, 34}, new int[] { 22, 27, 140891186,42}, 4),
    ...
    new Polygon( new int[] { 42, 40, 187, 34}, new int[] { 22, 27, 140891186,42}, 4),
    ...
    new Polygon( new int[] { 22, 24, 187, 34}, new int[] { 32, 38, 140891186,42}, 4),
