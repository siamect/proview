...
public class JopcCompmode_sub extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcCompmode_sub( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcCompmode_sub( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcCompmode_sub");
    ...
    pwr_smallbuttoncenter11.setBounds(new Rectangle(107,8,44,18));
    ...
    pwr_smallbuttoncenter12.setBounds(new Rectangle(247,9,43,18));
    pwr_smallbuttoncenter12.setColorTone(1);
    ...
    pwr_sliderbackground140.setBounds(new Rectangle(111,26,26,222));
    ...
    pwr_slider141.setBounds(new Rectangle(115,36,22,29));
    ...
    pwr_sliderbackground142.setBounds(new Rectangle(259,26,26,222));
    ...
    pwr_slider143.setBounds(new Rectangle(263,36,22,29));
    ...
    pwr_valueinputmediumcenter44.setBounds(new Rectangle(107,263,62,23));
    ...
    pwr_valueinputmediumcenter45.setBounds(new Rectangle(168,263,62,23));
    ...
    pwr_valueinputmediumcenter46.setBounds(new Rectangle(229,263,62,23));
    ...
    pwr_smallbuttoncenter11.dd.setAccess(-2147483626);
    pwr_smallbuttoncenter11.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_smallbuttoncenter11.dd, "!$local.SetSliderEnable##Boolean",102)
      ,new GeDynToggleDig(pwr_smallbuttoncenter11.dd, "$local.SetSliderEnable##Boolean")
      });
    pwr_smallbuttoncenter11.setAnnot1("Slider");
    pwr_smallbuttoncenter12.dd.setDynType(4);
    pwr_smallbuttoncenter12.dd.setActionType(16);
    pwr_smallbuttoncenter12.dd.setAccess(-2147483626);
    pwr_smallbuttoncenter12.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_smallbuttoncenter12.dd, "!$local.OutSliderEnable##Boolean",102)
      ,new GeDynToggleDig(pwr_smallbuttoncenter12.dd, "$local.OutSliderEnable##Boolean")
      });
    pwr_smallbuttoncenter12.setAnnot1("Slider");
    ...
    pwr_slider141.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider141.dd, "$object.SetVal##Float32",0,1,4,32.8699,219.653,"$object.MinSet##Float32","$object.MaxSet##Float32",
"!$local.SetSliderEnable##Boolean")
    ...
    pwr_slider143.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider143.dd, "$object.ForcVal##Float32",0,100,4,32.8699,219.653,"$object.MinOut##Float32","$object.MaxOut##Float32",
...
protected class pwr_indroundlarge extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 10, 11, 11, 28}, new int[] { 16, 26, 26,60}, 4),
    ...
    new Polygon( new int[] { 39, 39, 37, 28}, new int[] { 11, 14, 15,60}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 6, 8}, new int[] { 34, 29, 28,28}, 4),
    new Polygon( new int[] { 8, 6, 6, 8}, new int[] { 28, 28, 8,8}, 4),
    ...
    new Polygon( new int[] { 2, 4, -1, -2}, new int[] { 34, 29, 157228076,28}, 4),
    ...
    new Polygon( new int[] { 94, 96, 96, 94}, new int[] { 28, 30, 11,8}, 4),
    ...
    new Polygon( new int[] { 2, 7, -1, -2}, new int[] { 34, 32, 157228076,28}, 4),
    new Rectangle2D.Float(2F, 2F, 97.6689F, 31.8919F),
    new Polygon( new int[] { 2, 100, 98, 4, 4, 2}, new int[] { 2, 2, 4, 4, 32, 34}, 6), 
    new Polygon( new int[] { 100, 100, 98, 98, 4, 2}, new int[] { 34, 2, 4, 32, 32, 34}, 6), 
  };
...
protected class pwr_smallbuttoncenter extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,1,-1,2F,2F,43.8514F,16.9426F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 25 * original_height / height * width / original_width- (float)g.getFont().getStringBounds(annot1, frc).getWidth()/2, 14F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
