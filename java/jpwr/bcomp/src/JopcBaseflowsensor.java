...
public class JopcBaseflowsensor extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_mbsimulate68.setBounds(new Rectangle(381,24,20,20));
    ...
    pwr_mbup73.setBounds(new Rectangle(360,24,19,20));
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, -31, -112}, new int[] { 22, 18, -1219980928,-16}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
