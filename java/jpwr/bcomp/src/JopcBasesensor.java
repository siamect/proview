...
public class JopcBasesensor extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valuesmall	pwr_valuesmall70;
  pwr_mbup	pwr_mbup73;
  public JopcBasesensor( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasesensor( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_valuesmall24.setBounds(new Rectangle(161,116,48,16));
    ...
    pwr_sliderbackground325.setShadow(1);
    ...
    pwr_valuesmall36.setBounds(new Rectangle(117,307,39,16));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(163,307,39,16));
    ...
    pwr_valuesmall38.setBounds(new Rectangle(209,307,39,16));
    localPanel.add(pwr_valuesmall38, new Proportion(pwr_valuesmall38.getBounds(), dsize));
    pwr_checkbox39 = new pwr_checkbox(session);
    pwr_checkbox39.setBounds(new Rectangle(73,308,13,13));
    localPanel.add(pwr_checkbox39, new Proportion(pwr_checkbox39.getBounds(), dsize));
    pwr_valuesmall41 = new pwr_valuesmall(session);
    pwr_valuesmall41.setBounds(new Rectangle(117,325,39,16));
    ...
    pwr_valuesmall42.setBounds(new Rectangle(163,325,39,16));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(209,325,39,16));
    localPanel.add(pwr_valuesmall43, new Proportion(pwr_valuesmall43.getBounds(), dsize));
    pwr_checkbox44 = new pwr_checkbox(session);
    pwr_checkbox44.setBounds(new Rectangle(73,326,13,13));
    localPanel.add(pwr_checkbox44, new Proportion(pwr_checkbox44.getBounds(), dsize));
    pwr_valuesmall46 = new pwr_valuesmall(session);
    pwr_valuesmall46.setBounds(new Rectangle(117,342,39,15));
    ...
    pwr_valuesmall47.setBounds(new Rectangle(163,342,39,15));
    ...
    pwr_valuesmall48.setBounds(new Rectangle(209,342,39,15));
    localPanel.add(pwr_valuesmall48, new Proportion(pwr_valuesmall48.getBounds(), dsize));
    pwr_checkbox49 = new pwr_checkbox(session);
    pwr_checkbox49.setBounds(new Rectangle(73,344,13,13));
    localPanel.add(pwr_checkbox49, new Proportion(pwr_checkbox49.getBounds(), dsize));
    pwr_valuesmall51 = new pwr_valuesmall(session);
    pwr_valuesmall51.setBounds(new Rectangle(117,360,39,16));
    ...
    pwr_valuesmall52.setBounds(new Rectangle(163,360,39,16));
    ...
    pwr_valuesmall53.setBounds(new Rectangle(209,360,39,16));
    localPanel.add(pwr_valuesmall53, new Proportion(pwr_valuesmall53.getBounds(), dsize));
    pwr_checkbox54 = new pwr_checkbox(session);
    pwr_checkbox54.setBounds(new Rectangle(73,362,13,13));
    localPanel.add(pwr_checkbox54, new Proportion(pwr_checkbox54.getBounds(), dsize));
    pwr_switch55 = new pwr_switch(session);
    pwr_switch55.setBounds(new Rectangle(125,147,32,32));
    pwr_switch55.setShadow(1);
    localPanel.add(pwr_switch55, new Proportion(pwr_switch55.getBounds(), dsize));
    pwr_indsquare56 = new pwr_indsquare(session);
    pwr_indsquare56.setBounds(new Rectangle(96,307,14,15));
    ...
    pwr_indsquare57.setBounds(new Rectangle(96,325,14,14));
    ...
    pwr_indsquare58.setBounds(new Rectangle(96,343,14,15));
    ...
    pwr_indsquare59.setBounds(new Rectangle(96,361,14,14));
    ...
    pwr_indsquare69.setBounds(new Rectangle(231,263,14,15));
    ...
    pwr_valuesmall70 = new pwr_valuesmall(session);
    pwr_valuesmall70.setBounds(new Rectangle(214,116,33,16));
    pwr_valuesmall70.setFillColor(31);
    pwr_valuesmall70.setBorderColor(31);
    localPanel.add(pwr_valuesmall70, new Proportion(pwr_valuesmall70.getBounds(), dsize));
    pwr_mbup73 = new pwr_mbup(session);
    pwr_mbup73.setBounds(new Rectangle(363,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuesmall36.dd.setDynType(1153);
    pwr_valuesmall36.dd.setActionType(4096);
    pwr_valuesmall36.dd.setAccess(52);
    pwr_valuesmall36.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valuesmall36.dd, "!$object.LimitHH.Used##Boolean",0)
      ,new GeDynValue(pwr_valuesmall36.dd, "$object.LimitHH.Limit##Float32","%6.2f")
      });
    ...
    pwr_valuesmall37.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall37.dd, "$object.LimitHH.Hysteres##Float32","%5.1f")
      });
    ...
    pwr_valuesmall38.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall38.dd, "$object.LimitHH.TimeDelay##Float32","%5.1f")
      });
    pwr_checkbox39.dd.setDynType(32769);
    pwr_checkbox39.dd.setActionType(16);
    pwr_checkbox39.dd.setAccess(52);
    pwr_checkbox39.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_checkbox39.dd, "$object.LimitHH.Used##Boolean")
      ,new GeDynToggleDig(pwr_checkbox39.dd, "$object.LimitHH.Used##Boolean")
      });
    pwr_valuesmall41.dd.setDynType(1153);
    pwr_valuesmall41.dd.setActionType(4096);
    pwr_valuesmall41.dd.setAccess(52);
    pwr_valuesmall41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valuesmall41.dd, "!$object.LimitH.Used##Boolean",0)
      ,new GeDynValue(pwr_valuesmall41.dd, "$object.LimitH.Limit##Float32","%6.2f")
      });
    ...
    pwr_valuesmall42.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall42.dd, "$object.LimitH.Hysteres##Float32","%5.1f")
      });
    ...
    pwr_valuesmall43.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall43.dd, "$object.LimitH.TimeDelay##Float32","%5.1f")
      });
    pwr_checkbox44.dd.setDynType(32769);
    pwr_checkbox44.dd.setActionType(16);
    pwr_checkbox44.dd.setAccess(52);
    pwr_checkbox44.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_checkbox44.dd, "$object.LimitH.Used##Boolean")
      ,new GeDynToggleDig(pwr_checkbox44.dd, "$object.LimitH.Used##Boolean")
      });
    pwr_valuesmall46.dd.setDynType(1153);
    pwr_valuesmall46.dd.setActionType(4096);
    pwr_valuesmall46.dd.setAccess(52);
    pwr_valuesmall46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valuesmall46.dd, "!$object.LimitL.Used##Boolean",0)
      ,new GeDynValue(pwr_valuesmall46.dd, "$object.LimitL.Limit##Float32","%6.2f")
      });
    ...
    pwr_valuesmall47.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall47.dd, "$object.LimitL.Hysteres##Float32","%5.1f")
      });
    ...
    pwr_valuesmall48.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall48.dd, "$object.LimitL.TimeDelay##Float32","%5.1f")
      });
    pwr_checkbox49.dd.setDynType(32769);
    pwr_checkbox49.dd.setActionType(16);
    pwr_checkbox49.dd.setAccess(52);
    pwr_checkbox49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_checkbox49.dd, "$object.LimitL.Used##Boolean")
      ,new GeDynToggleDig(pwr_checkbox49.dd, "$object.LimitL.Used##Boolean")
      });
    pwr_valuesmall51.dd.setDynType(1153);
    pwr_valuesmall51.dd.setActionType(4096);
    pwr_valuesmall51.dd.setAccess(52);
    pwr_valuesmall51.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valuesmall51.dd, "!$object.LimitLL.Used##Boolean",0)
      ,new GeDynValue(pwr_valuesmall51.dd, "$object.LimitLL.Limit##Float32","%6.2f")
      });
    ...
    pwr_valuesmall52.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall52.dd, "$object.LimitLL.Hysteres##Float32","%5.1f")
      });
    ...
    pwr_valuesmall53.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valuesmall53.dd, "$object.LimitLL.TimeDelay##Float32","%5.1f")
      });
    pwr_checkbox54.dd.setDynType(32769);
    pwr_checkbox54.dd.setActionType(16);
    pwr_checkbox54.dd.setAccess(52);
    pwr_checkbox54.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_checkbox54.dd, "$object.LimitLL.Used##Boolean")
      ,new GeDynToggleDig(pwr_checkbox54.dd, "$object.LimitLL.Used##Boolean")
      });
    pwr_switch55.dd.setDynType(9);
    pwr_switch55.dd.setActionType(0);
    pwr_switch55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_switch55.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_switch55.dd, "$object.IndWarning##Boolean",114)
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar66.setPwrAttribute("$object.Value.ActualValue##Float32");
    ...
    pwr_valuesmall70.dd.setDynType(1025);
    pwr_valuesmall70.dd.setActionType(0);
    pwr_valuesmall70.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall70.dd, "$object.Value.Unit##String16","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 253.192F, 301.2F, 16.2012F, 301.2F),
    new Rectangle2D.Float(18F, 98.5733F, 237.944F, 145.199F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 99, 99, 99, 99, 243, 244}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 244, 99, 99, 243, 243, 244}, 6), 
    new Rectangle2D.Float(17F, 256.252F, 237.944F, 134.696F),
    new Polygon( new int[] { 17, 255, 254, 18, 18, 17}, new int[] { 256, 256, 257, 257, 390, 391}, 6), 
    new Polygon( new int[] { 255, 255, 254, 254, 18, 17}, new int[] { 391, 256, 257, 390, 390, 391}, 6), 
    new Rectangle2D.Float(61F, 203F, 155F, 5F),
    new Polygon( new int[] { 61, 216, 214, 63, 63, 61}, new int[] { 203, 203, 205, 205, 206, 208}, 6), 
    new Polygon( new int[] { 216, 216, 214, 214, 63, 61}, new int[] { 208, 203, 205, 206, 206, 208}, 6), 
    new Line2D.Float( 141F, 203F, 141F, 178F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Value"),34, 128);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, 2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Limits"),26, 274);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Used"),71, 296);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Limit"),118, 296);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Hysteresis"),158, 296);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Delay"),213, 296);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("Supervision disabled"),117, 275);
    {
...
protected class pwr_slider3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 58, 59, 59, 58}, new int[] { 3, 4, 12,11}, 4),
    new Polygon( new int[] { 58, 59, 49, 50}, new int[] { 11, 12, 12,11}, 4),
    new Polygon( new int[] { 50, 49, 49, 50}, new int[] { 11, 12, 6,3}, 4),
    new Polygon( new int[] { 50, 49, 50, 49}, new int[] { 3, 6, 6,3}, 4),
    new Polygon( new int[] { 49, 50, 50, 49}, new int[] { 3, 6, 11,12}, 4),
    new Polygon( new int[] { 49, 50, 58, 59}, new int[] { 12, 11, 11,12}, 4),
    new Polygon( new int[] { 59, 58, 58, 59}, new int[] { 12, 11, 5,2}, 4),
    new Polygon( new int[] { 59, 58, 50, 49}, new int[] { 2, 5, 5,2}, 4),
    new Polygon( new int[] { 49, 50, 50, 49}, new int[] { 2, 5, 4,3}, 4),
    new Polygon( new int[] { 49, 50, 50, 46}, new int[] { 3, 4, 4,7}, 4),
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 14, 7, 2}, new int[] { 22, 19, 6,2}, 4),
    new Polygon( new int[] { 2, 7, 19, 22}, new int[] { 2, 6, 6,2}, 4),
    new Polygon( new int[] { 22, 19, 14, 12}, new int[] { 2, 6, 19,22}, 4),
    new Polygon( new int[] { 12, 14, 145, 16}, new int[] { 22, 19, 154990910,22}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
