...
public class JopcBasemotorincrdecraggr37 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare4.setBounds(new Rectangle(150,342,16,16));
    ...
    pwr_indsquare6.setBounds(new Rectangle(150,296,16,17));
    ...
    pwr_indsquare9.setBounds(new Rectangle(150,388,16,17));
    ...
    pwr_smallbuttoncenter11.setBounds(new Rectangle(40,168,48,21));
    ...
    pwr_indround12.setBounds(new Rectangle(100,172,18,18));
    ...
    pwr_indround13.setBounds(new Rectangle(100,194,18,18));
    ...
    pwr_indround28.setBounds(new Rectangle(100,216,18,18));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,558,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,557,336,23));
    ...
    pwr_indround34.setBounds(new Rectangle(226,173,18,18));
    ...
    pwr_manswitch335.setBounds(new Rectangle(248,284,38,38));
    ...
    pwr_contactor236.setBounds(new Rectangle(248,332,38,38));
    ...
    pwr_safetyswitch37.setBounds(new Rectangle(248,378,38,39));
    ...
    pwr_valuesmall49.setBounds(new Rectangle(303,246,71,18));
    ...
    pwr_indsquare53.setBounds(new Rectangle(150,414,16,16));
    ...
    grp173_54.setBounds(new Rectangle(34,414,40,18));
    ...
    pwr_rodcouplinganim56.setBounds(new Rectangle(168,479,12,22));
    ...
    pwr_smallbuttoncenter74.setBounds(new Rectangle(153,193,62,21));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(153,216,62,21));
    ...
    pwr_smallbuttoncenter76.setBounds(new Rectangle(153,193,62,21));
    ...
    pwr_smallbuttoncenter77.setBounds(new Rectangle(153,169,62,21));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140856997, -34}, new int[] { 146, 147, 148563779,3}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857071, 39}, new int[] { 12, 15, 152051673,57}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 151609279, 39}, new int[] { 12, 15, 85,57}, 4),
