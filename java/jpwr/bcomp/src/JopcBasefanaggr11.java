...
public class JopcBasefanaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare7.setBounds(new Rectangle(185,315,16,17));
    ...
    pwr_smallbuttoncenter10.setBounds(new Rectangle(28,168,48,21));
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(115,191,61,21));
    ...
    pwr_rod30.setBounds(new Rectangle(138,415,39,10));
    ...
    grp173_56.setBounds(new Rectangle(69,343,40,17));
    ...
    grp182_58.setBounds(new Rectangle(30,193,41,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706439, 40}, new int[] { 12, 15, -1219706439,40}, 4),
