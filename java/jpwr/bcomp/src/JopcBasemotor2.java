...
public class JopcBasemotor2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu220.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu221.setBounds(new Rectangle(328,1,67,22));
    ...
    pwr_pulldownmenu222.setBounds(new Rectangle(70,1,67,22));
    ...
    pwr_mbup23.setBounds(new Rectangle(354,25,18,18));
