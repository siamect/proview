...
public class JopcBasemotor2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_menubar2	pwr_menubar219;
  pwr_pulldownmenu2	pwr_pulldownmenu220;
  pwr_pulldownmenu2	pwr_pulldownmenu221;
  pwr_pulldownmenu2	pwr_pulldownmenu222;
  pwr_mbup	pwr_mbup23;
  public JopcBasemotor2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotor2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_motor218.setBounds(new Rectangle(226,104,98,74));
    localPanel.add(pwr_motor218, new Proportion(pwr_motor218.getBounds(), dsize));
    pwr_menubar219 = new pwr_menubar2(session);
    pwr_menubar219.setBounds(new Rectangle(0,0,409,24));
    pwr_menubar219.setShadow(1);
    localPanel.add(pwr_menubar219, new Proportion(pwr_menubar219.getBounds(), dsize));
    pwr_pulldownmenu220 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu220.setBounds(new Rectangle(10,0,69,24));
    ...
    pwr_pulldownmenu221.setBounds(new Rectangle(327,0,69,24));
    ...
    pwr_pulldownmenu222.setBounds(new Rectangle(69,0,69,24));
    ...
    pwr_mbup23.setBounds(new Rectangle(353,24,20,20));
    ...
    pwr_menubar219.dd.setDynType(1);
    pwr_menubar219.dd.setActionType(0);
    pwr_pulldownmenu220.dd.setDynType(0);
    pwr_pulldownmenu220.dd.setActionType(524288);
    pwr_pulldownmenu220.dd.setAccess(65535);
    pwr_pulldownmenu220.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu220.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu220,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu220.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu220.setAnnot1("File");
    pwr_pulldownmenu221.dd.setDynType(1);
    pwr_pulldownmenu221.dd.setActionType(524288);
    pwr_pulldownmenu221.dd.setAccess(65532);
    ...
    new GeDyn(pwr_pulldownmenu221,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu221.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu221.setAnnot1("Help");
    ...
    pwr_pulldownmenu222.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu222.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu222,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu222,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu222.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu222.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu222.setAnnot1("Methods");
