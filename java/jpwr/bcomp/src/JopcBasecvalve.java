...
public class JopcBasecvalve extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar26.setBounds(new Rectangle(0,0,534,24));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(36,365,47,21));
    ...
    pwr_indsquare51.setBounds(new Rectangle(166,243,16,17));
    ...
    pwr_basevalve55.setBounds(new Rectangle(285,533,80,122));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(36,342,47,21));
    ...
    pwr_indsquare62.setBounds(new Rectangle(182,487,16,16));
    ...
    pwr_valvecontrol265.setBounds(new Rectangle(110,115,66,43));
    ...
    pwr_indsquare68.setBounds(new Rectangle(166,272,16,17));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 1343, 6}, new int[] { 22, 27, -1219706438,45}, 4),
    ...
    new Polygon( new int[] { 42, 40, 1343, 6}, new int[] { 22, 27, -1219706438,45}, 4),
