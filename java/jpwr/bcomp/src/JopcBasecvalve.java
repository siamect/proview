...
public class JopcBasecvalve extends JopFrame implements JopUtilityIfc {
  ...
  JopSmallbutton	jopSmallbutton45;
  pwr_indround	pwr_indround46;
  pwr_indround	pwr_indround47;
  pwr_sliderbackground1_2	pwr_sliderbackground1_249;
  pwr_slider1	pwr_slider150;
  pwr_valueinputsmallrd	pwr_valueinputsmallrd51;
  pwr_indsquare	pwr_indsquare53;
  Grp167_	grp167_54;
  pwr_mbsimulate	pwr_mbsimulate55;
  pwr_actuator	pwr_actuator56;
  pwr_basevalve	pwr_basevalve57;
  ...
  public void geInit() {
    ...
    pwr_sliderbackground324.setBounds(new Rectangle(336,132,66,243));
    ...
    pwr_valueinputreliefup25.setBounds(new Rectangle(273,131,51,18));
    ...
    jopBar42.setFillColor(58);
    jopBar42.setBorderColor(0);
    jopBar42.setFillColorBar(105);
    jopBar42.setBorderColorBar(101);
    ...
    jopAxis43 = new JopAxis();
    jopAxis43.setBounds(new Rectangle(327,134,11,238));
    jopAxis43.setBorderColor(0);
    jopAxis43.setTextColor(0);
    jopAxis43.setLineWidth(1);
    jopAxis43.setMinValue(0F);
    jopAxis43.setMaxValue(0F);
    jopAxis43.setLines(51);
    jopAxis43.setLongQuotient(5);
    jopAxis43.setValueQuotient(5);
    jopAxis43.setLineLength(11);
    jopAxis43.setLineWidth(1);
    jopAxis43.setRotate(0);
    jopAxis43.setFont(new Font("Helvetica", Font.PLAIN, 10));
    jopAxis43.setFormat("%3.0f");
    localPanel.add(jopAxis43, new Proportion(jopAxis43.getBounds(), dsize));
    pwr_valuesmall44 = new pwr_valuesmall(session);
    pwr_valuesmall44.setBounds(new Rectangle(345,391,50,17));
    localPanel.add(pwr_valuesmall44, new Proportion(pwr_valuesmall44.getBounds(), dsize));
    jopSmallbutton45 = new JopSmallbutton(session);
    jopSmallbutton45.setBounds(new Rectangle(36,365,48,21));
    jopSmallbutton45.setFillColor(32);
    localPanel.add(jopSmallbutton45, new Proportion(jopSmallbutton45.getBounds(), dsize));
    pwr_indround46 = new pwr_indround(session);
    pwr_indround46.setBounds(new Rectangle(96,344,18,18));
    ...
    pwr_indround47.setBounds(new Rectangle(96,366,18,18));
    pwr_indround47.setShadow(1);
    localPanel.add(pwr_indround47, new Proportion(pwr_indround47.getBounds(), dsize));
    pwr_sliderbackground1_249 = new pwr_sliderbackground1_2(session);
    pwr_sliderbackground1_249.setBounds(new Rectangle(422,119,34,269));
    pwr_sliderbackground1_249.setShadow(1);
    localPanel.add(pwr_sliderbackground1_249, new Proportion(pwr_sliderbackground1_249.getBounds(), dsize));
    pwr_slider150 = new pwr_slider1(session);
    pwr_slider150.setBounds(new Rectangle(426,301,34,32));
    localPanel.add(pwr_slider150, new Proportion(pwr_slider150.getBounds(), dsize));
    pwr_valueinputsmallrd51 = new pwr_valueinputsmallrd(session);
    pwr_valueinputsmallrd51.setBounds(new Rectangle(412,388,55,24));
    pwr_valueinputsmallrd51.setColorBrightness(-2);
    pwr_valueinputsmallrd51.setShadow(1);
    localPanel.add(pwr_valueinputsmallrd51, new Proportion(pwr_valueinputsmallrd51.getBounds(), dsize));
    pwr_indsquare53 = new pwr_indsquare(session);
    pwr_indsquare53.setBounds(new Rectangle(166,256,16,17));
    ...
    grp167_54 = new Grp167_(session);
    grp167_54.setBounds(new Rectangle(420,106,46,18));
    localPanel.add(grp167_54, new Proportion(grp167_54.getBounds(), dsize));
    pwr_mbsimulate55 = new pwr_mbsimulate(session);
    pwr_mbsimulate55.setBounds(new Rectangle(508,24,20,20));
    localPanel.add(pwr_mbsimulate55, new Proportion(pwr_mbsimulate55.getBounds(), dsize));
    pwr_actuator56 = new pwr_actuator(session);
    pwr_actuator56.setBounds(new Rectangle(260,453,132,84));
    pwr_actuator56.setShadow(1);
    localPanel.add(pwr_actuator56, new Proportion(pwr_actuator56.getBounds(), dsize));
    pwr_basevalve57 = new pwr_basevalve(session);
    pwr_basevalve57.setBounds(new Rectangle(285,533,80,122));
    pwr_basevalve57.setShadow(1);
    localPanel.add(pwr_basevalve57, new Proportion(pwr_basevalve57.getBounds(), dsize));
    pwr_pulldownmenu60 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu60.setBounds(new Rectangle(160,0,69,24));
    ...
    jopSmallbutton61.setBounds(new Rectangle(36,342,48,21));
    ...
    grp175_63.setBounds(new Rectangle(39,396,35,17));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valueinputreliefup25.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup25.dd, "$object.Actuator.Order.PresMaxLimit##Float32","%5.1f")
    ...
    pwr_valueinputreliefup26.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup26.dd, "$object.Actuator.Order.PresMinLimit##Float32","%5.1f")
    ...
    pwr_pulldownmenu29.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu29.dd, "open graph /class /inst=$object.Actuator.Order")
      }),
    new GeDyn(pwr_pulldownmenu29,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu29.dd, "open graph /class /inst=$object.Actuator.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu29,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu29.dd, "open graph /class /inst=$object.Actuator.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valvecontrol231.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol231.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol231.dd, "$object.Actuator.IndWarning##Boolean",30)
    ...
    jopBar42.setPwrAttribute("$object.Actuator.Order.ActualValue##Float32");
    ...
    pwr_valuesmall44.dd.setActionType(2);
    pwr_valuesmall44.dd.setAccess(65532);
    pwr_valuesmall44.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall44.dd, "$object.Actuator.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall44.dd, "$object.Actuator.Order")
      });
    jopSmallbutton45.dd.setDynType(129);
    jopSmallbutton45.dd.setActionType(4);
    jopSmallbutton45.dd.setAccess(65532);
    jopSmallbutton45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton45.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton45.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    jopSmallbutton45.setAnnot1(" Auto");
    ...
    pwr_sliderbackground1_249.dd.setDynType(524417);
    pwr_sliderbackground1_249.dd.setActionType(0);
    pwr_sliderbackground1_249.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_249.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_slider150.dd.setDynType(129);
    pwr_slider150.dd.setActionType(2048);
    pwr_slider150.dd.setAccess(65532);
    pwr_slider150.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider150.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider150.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,122.911,361.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",
null)
      });
    pwr_valueinputsmallrd51.dd.setDynType(1153);
    pwr_valueinputsmallrd51.dd.setActionType(4096);
    pwr_valueinputsmallrd51.dd.setAccess(65532);
    pwr_valueinputsmallrd51.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd51.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd51.dd, "$object.Actuator.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd51.dd, 0,0,"$object.Actuator.Mode.OpMinRefMan##Float32","$object.Actuator.Mode.OpMaxRefMan##Float32")
      });
    pwr_indsquare53.dd.setDynType(5);
    pwr_indsquare53.dd.setActionType(0);
    pwr_indsquare53.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare53.dd, "$object.Actuator.SwitchError##Boolean",29)
      });
    grp167_54.dd.setDynType(129);
    grp167_54.dd.setActionType(0);
    grp167_54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_54.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_actuator56.dd.setDynType(1);
    pwr_actuator56.dd.setActionType(66);
    pwr_actuator56.dd.setAccess(65532);
    pwr_actuator56.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator56.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator56.dd, "open graph/class/inst=$object.Actuator")
      });
    pwr_basevalve57.dd.setDynType(16385);
    pwr_basevalve57.dd.setActionType(66);
    pwr_basevalve57.dd.setAccess(65532);
    pwr_basevalve57.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve57.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve57.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve57.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_pulldownmenu60.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu60.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu60,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu60.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu60,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu60.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu60.setAnnot1("Components");
    jopSmallbutton61.dd.setDynType(128);
    jopSmallbutton61.dd.setActionType(4);
    jopSmallbutton61.dd.setAccess(65532);
    jopSmallbutton61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton61.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton61.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    jopSmallbutton61.setAnnot1(" Man");
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 6, 2}, new int[] { 22, 25, 39,42}, 4),
    new Polygon( new int[] { 2, 6, 20, 22}, new int[] { 42, 39, 32,32}, 4),
    new Polygon( new int[] { 22, 20, 6, 2}, new int[] { 32, 32, 25,22}, 4),
    ...
    new Polygon( new int[] { 22, 28, 40, 42}, new int[] { 32, 32, 25,22}, 4),
