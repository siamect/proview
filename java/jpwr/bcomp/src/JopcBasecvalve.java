...
public class JopcBasecvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valvecontrol2	pwr_valvecontrol265;
  pwr_mbup	pwr_mbup66;
  pwr_indsquare	pwr_indsquare68;
  public JopcBasecvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_menubar26.setBounds(new Rectangle(1,1,532,22));
    ...
    pwr_smallbuttoncenter22.setBorderColor(0);
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(37,366,45,19));
    ...
    pwr_indsquare51.setBounds(new Rectangle(167,244,14,15));
    ...
    pwr_basevalve55 = new pwr_basevalve(session);
    pwr_basevalve55.setBounds(new Rectangle(286,534,78,120));
    pwr_basevalve55.setShadow(1);
    localPanel.add(pwr_basevalve55, new Proportion(pwr_basevalve55.getBounds(), dsize));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(37,343,45,19));
    ...
    pwr_indsquare62.setBounds(new Rectangle(183,488,14,14));
    ...
    pwr_valvecontrol265 = new pwr_valvecontrol2(session);
    pwr_valvecontrol265.setBounds(new Rectangle(111,116,64,41));
    pwr_valvecontrol265.setShadow(1);
    localPanel.add(pwr_valvecontrol265, new Proportion(pwr_valvecontrol265.getBounds(), dsize));
    pwr_mbup66 = new pwr_mbup(session);
    pwr_mbup66.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup66, new Proportion(pwr_mbup66.getBounds(), dsize));
    pwr_indsquare68 = new pwr_indsquare(session);
    pwr_indsquare68.setBounds(new Rectangle(167,273,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider148.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider148.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,532.043,685.913)
      });
    ...
    pwr_basevalve55.dd.setDynType(16385);
    pwr_basevalve55.dd.setActionType(66);
    pwr_basevalve55.dd.setAccess(65532);
    pwr_basevalve55.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve55.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve55.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve55.dd, "open graph/class/inst=$object.Valve")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valvecontrol265.dd.setDynType(1034);
    pwr_valvecontrol265.dd.setActionType(0);
    pwr_valvecontrol265.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol265.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol265.dd, "$object.Actuator.IndWarning##Boolean",30)
      ,new GeDynValue(pwr_valvecontrol265.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.3783F, 23.1001F, 531.665F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.3783F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.3783F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    ...
    g.drawString( JopLang.transl("Supervision disabled"),36, 284);
    g.setTransform(save);
  }
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 18, 22}, new int[] { 42, 40, 34,32}, 4),
    new Polygon( new int[] { 22, 18, 6, 2}, new int[] { 32, 34, 27,22}, 4),
    new Polygon( new int[] { 2, 6, 2479, 6}, new int[] { 22, 27, -1219915334,45}, 4),
    new Polygon( new int[] { 42, 42, 22, 42}, new int[] {22, 42, 32, 22}, 4),
    new Polygon( new int[] { 42, 40, 40, 42}, new int[] { 22, 27, 40,42}, 4),
    new Polygon( new int[] { 42, 40, 27, 22}, new int[] { 42, 40, 34,32}, 4),
    new Polygon( new int[] { 22, 27, 40, 42}, new int[] { 32, 34, 27,22}, 4),
    new Polygon( new int[] { 42, 40, 2479, 6}, new int[] { 22, 27, -1219915334,45}, 4),
