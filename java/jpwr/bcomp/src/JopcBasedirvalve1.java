...
public class JopcBasedirvalve1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton20.setBounds(new Rectangle(17,410,47,21));
    ...
    pwr_valuelong22.setBounds(new Rectangle(74,409,336,23));
    ...
    jopSmallbutton25.setBounds(new Rectangle(34,340,47,21));
    ...
    pwr_mbsimulate29.setBounds(new Rectangle(500,24,20,20));
    ...
    jopSmallbutton30.setBounds(new Rectangle(34,317,47,21));
    ...
    jopSmallbutton33.setBounds(new Rectangle(130,340,78,21));
    ...
    jopSmallbutton34.setBounds(new Rectangle(130,316,78,21));
    ...
    pwr_indround36.setBounds(new Rectangle(219,319,18,18));
    ...
    pwr_indround37.setBounds(new Rectangle(219,341,18,18));
    ...
    jopSmallbutton46.setBounds(new Rectangle(130,366,78,21));
    ...
    jopSmallbutton47.setBounds(new Rectangle(130,316,78,21));
    ...
    jopSmallbutton48.setBounds(new Rectangle(130,340,78,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton33.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton33.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynToggleDig(jopSmallbutton33.dd, "$object.Mode.OpOrderManDecr##Boolean")
      });
    jopSmallbutton33.setAnnot1("Backward");
    ...
    jopSmallbutton34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton34.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynToggleDig(jopSmallbutton34.dd, "$object.Mode.OpOrderManIncr##Boolean")
      });
    jopSmallbutton34.setAnnot1("Forward");
    ...
    pwr_indround36.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround36.dd, "$object.Mode.OpOrderManIncr##Boolean",29)
      });
    ...
    pwr_indround37.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround37.dd, "$object.Mode.OpOrderManDecr##Boolean",29)
      });
    ...
    jopSmallbutton46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton46.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton46.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton46.dd, "!$object.Mode.ManMode##Boolean",1)
      ,new GeDynSetDig(jopSmallbutton46.dd, "$object.Mode.OpOrderManStop##Boolean")
      });
    jopSmallbutton46.setAnnot1("Stop");
    jopSmallbutton47.dd.setDynType(128);
    jopSmallbutton47.dd.setActionType(32);
    jopSmallbutton47.dd.setAccess(65532);
    jopSmallbutton47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton47.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton47.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton47.dd, "!$object.Mode.ManMode##Boolean",1)
      ,new GeDynStoDig(jopSmallbutton47.dd, "$object.Mode.OpOrderManIncr##Boolean")
      });
    jopSmallbutton47.setAnnot1("Forward");
    jopSmallbutton48.dd.setDynType(129);
    jopSmallbutton48.dd.setActionType(32);
    jopSmallbutton48.dd.setAccess(65532);
    jopSmallbutton48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton48.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton48.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton48.dd, "!$object.Mode.ManMode##Boolean",1)
      ,new GeDynStoDig(jopSmallbutton48.dd, "$object.Mode.OpOrderManDecr##Boolean")
      });
    jopSmallbutton48.setAnnot1("Backward");
