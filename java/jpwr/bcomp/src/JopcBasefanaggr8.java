...
public class JopcBasefanaggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_fananim	pwr_fananim38;
  pwr_fananim2	pwr_fananim239;
  ...
  pwr_mbup	pwr_mbup69;
  public JopcBasefanaggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefanaggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefanaggr8");
    ...
    pwr_smallbuttoncenter14.setBounds(new Rectangle(115,191,61,21));
    ...
    pwr_rod31.setBounds(new Rectangle(138,488,39,10));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,563,48,21));
    pwr_smallbuttoncenter32.setFillColor(103);
    pwr_smallbuttoncenter32.setBorderColor(31);
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,562,336,23));
    ...
    pwr_contactor237.setBounds(new Rectangle(248,311,38,38));
    ...
    pwr_fananim38 = new pwr_fananim(session);
    pwr_fananim38.setBounds(new Rectangle(123,446,19,91));
    pwr_fananim38.setShadow(1);
    localPanel.add(pwr_fananim38, new Proportion(pwr_fananim38.getBounds(), dsize));
    pwr_fananim239 = new pwr_fananim2(session);
    pwr_fananim239.setBounds(new Rectangle(101,94,64,44));
    pwr_fananim239.setBorderColor(29);
    pwr_fananim239.setTextColor(0);
    pwr_fananim239.setShadow(1);
    pwr_fananim239.setGradient(12);
    localPanel.add(pwr_fananim239, new Proportion(pwr_fananim239.getBounds(), dsize));
    ...
    grp166_49.setBounds(new Rectangle(30,216,37,18));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(115,169,61,21));
    ...
    grp173_58.setBounds(new Rectangle(69,416,40,18));
    ...
    grp181_61.setBounds(new Rectangle(30,193,41,18));
    ...
    pwr_fuse366.setBounds(new Rectangle(260,268,15,37));
    ...
    pwr_overloadrelay67.setBounds(new Rectangle(248,346,38,27));
    ...
    pwr_safetyswitch68.setBounds(new Rectangle(248,380,38,39));
    ...
    pwr_fananim38.dd.setDynType(65537);
    pwr_fananim38.dd.setActionType(66);
    pwr_fananim38.dd.setAccess(65532);
    pwr_fananim38.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim38.dd, "$object.Contactor.IndFeedback##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim38.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim38.dd, "open graph/class/inst=$object.Fan")
      });
    pwr_fananim239.dd.setDynType(99381);
    pwr_fananim239.dd.setActionType(0);
    pwr_fananim239.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim239.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim239.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim239.dd, "$object.Contactor.IndFeedback##Boolean",37)
      ,new GeDynValue(pwr_fananim239.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynDigShift(pwr_fananim239.dd, "")
      ,new GeDynAnimation(pwr_fananim239.dd, "$object.Contactor.IndFeedback##Boolean",2)
      });
    pwr_fananim239.setAnnot1("L");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 268F, 258F, 268F, 314F),
    new Line2D.Float( 268F, 384F, 268F, 372F),
    new Polygon( new int[] { 228, 264, 268, 268, 268, 264}, new int[] {458, 458, 454, 418, 454, 458}, 6),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),71, 333);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),71, 404);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Mode"),34, 162);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Ready"),261, 110);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),261, 131);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Run"),235, 229);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Starts"),235, 209);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Start"),127, 184);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Overload relay"),71, 365);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[14]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980919, -7}, new int[] { 12, 15, -1219980858,53}, 4),
