...
public class JopcBasefilter extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu25.setBounds(new Rectangle(327,0,69,24));
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(17,221,48,21));
    ...
    pwr_valuelong21.setBounds(new Rectangle(74,221,336,23));
    ...
    pwr_pulldownmenu222.setBounds(new Rectangle(150,0,69,24));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(69,0,69,24));
    ...
    jopFilter27.setBounds(new Rectangle(85,115,44,44));
    ...
    pwr_mbup31.setBounds(new Rectangle(360,24,19,20));
