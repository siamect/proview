...
public class JopcBasec3wayvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_sliderbackground1_2	pwr_sliderbackground1_247;
  pwr_slider1	pwr_slider148;
  pwr_valueinputsmallrd	pwr_valueinputsmallrd49;
  pwr_indsquare	pwr_indsquare51;
  Grp167_	grp167_52;
  pwr_mbsimulate	pwr_mbsimulate53;
  pwr_actuator	pwr_actuator54;
  ...
  pwr_valve3waycontrol2	pwr_valve3waycontrol264;
  pwr_base3wayvalve	pwr_base3wayvalve65;
  pwr_base3wayvalve2	pwr_base3wayvalve266;
  pwr_mbup	pwr_mbup68;
  pwr_indsquare	pwr_indsquare70;
  public JopcBasec3wayvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasec3wayvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasec3wayvalve");
    ...
    pwr_sliderbackground325.setBounds(new Rectangle(337,133,64,241));
    ...
    pwr_indsquare33.setBounds(new Rectangle(166,186,13,15));
    ...
    pwr_indsquare34.setBounds(new Rectangle(167,205,14,15));
    ...
    jopBar40.setBounds(new Rectangle(359,134,20,238));
    jopBar40.setFillColor(58);
    jopBar40.setBorderColor(0);
    jopBar40.setFillColorBar(105);
    jopBar40.setBorderColorBar(101);
    ...
    jopAxis41.setBounds(new Rectangle(327,134,11,238));
    jopAxis41.setBorderColor(0);
    jopAxis41.setTextColor(0);
    jopAxis41.setLineWidth(1);
    jopAxis41.setMinValue(0F);
    jopAxis41.setMaxValue(0F);
    jopAxis41.setLines(51);
    jopAxis41.setLongQuotient(5);
    jopAxis41.setValueQuotient(5);
    jopAxis41.setLineLength(11);
    jopAxis41.setLineWidth(1);
    jopAxis41.setRotate(0);
    jopAxis41.setFont(new Font("Helvetica", Font.PLAIN, 10));
    ...
    pwr_valuesmall42.setBounds(new Rectangle(346,392,48,15));
    ...
    pwr_smallbuttoncenter43.setBounds(new Rectangle(37,366,46,19));
    ...
    pwr_indround44.setBounds(new Rectangle(97,345,16,16));
    ...
    pwr_indround45.setBounds(new Rectangle(97,367,16,16));
    pwr_indround45.setShadow(1);
    localPanel.add(pwr_indround45, new Proportion(pwr_indround45.getBounds(), dsize));
    pwr_sliderbackground1_247 = new pwr_sliderbackground1_2(session);
    pwr_sliderbackground1_247.setBounds(new Rectangle(423,120,32,267));
    pwr_sliderbackground1_247.setShadow(1);
    localPanel.add(pwr_sliderbackground1_247, new Proportion(pwr_sliderbackground1_247.getBounds(), dsize));
    pwr_slider148 = new pwr_slider1(session);
    pwr_slider148.setBounds(new Rectangle(427,302,32,30));
    localPanel.add(pwr_slider148, new Proportion(pwr_slider148.getBounds(), dsize));
    pwr_valueinputsmallrd49 = new pwr_valueinputsmallrd(session);
    pwr_valueinputsmallrd49.setBounds(new Rectangle(413,389,53,22));
    pwr_valueinputsmallrd49.setShadow(1);
    localPanel.add(pwr_valueinputsmallrd49, new Proportion(pwr_valueinputsmallrd49.getBounds(), dsize));
    pwr_indsquare51 = new pwr_indsquare(session);
    pwr_indsquare51.setBounds(new Rectangle(167,245,14,15));
    pwr_indsquare51.setFillColor(176);
    pwr_indsquare51.setShadow(1);
    localPanel.add(pwr_indsquare51, new Proportion(pwr_indsquare51.getBounds(), dsize));
    grp167_52 = new Grp167_(session);
    grp167_52.setBounds(new Rectangle(421,107,43,16));
    localPanel.add(grp167_52, new Proportion(grp167_52.getBounds(), dsize));
    pwr_mbsimulate53 = new pwr_mbsimulate(session);
    pwr_mbsimulate53.setBounds(new Rectangle(509,25,18,18));
    localPanel.add(pwr_mbsimulate53, new Proportion(pwr_mbsimulate53.getBounds(), dsize));
    pwr_actuator54 = new pwr_actuator(session);
    pwr_actuator54.setBounds(new Rectangle(261,454,130,82));
    pwr_actuator54.setShadow(1);
    localPanel.add(pwr_actuator54, new Proportion(pwr_actuator54.getBounds(), dsize));
    pwr_pulldownmenu257 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu257.setBounds(new Rectangle(161,1,67,22));
    ...
    pwr_smallbuttoncenter58.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround59.setBounds(new Rectangle(97,398,16,16));
    ...
    pwr_valve3waycontrol264 = new pwr_valve3waycontrol2(session);
    pwr_valve3waycontrol264.setBounds(new Rectangle(111,100,64,51));
    pwr_valve3waycontrol264.setShadow(1);
    localPanel.add(pwr_valve3waycontrol264, new Proportion(pwr_valve3waycontrol264.getBounds(), dsize));
    pwr_base3wayvalve65 = new pwr_base3wayvalve(session);
    pwr_base3wayvalve65.setBounds(new Rectangle(276,533,98,130));
    localPanel.add(pwr_base3wayvalve65, new Proportion(pwr_base3wayvalve65.getBounds(), dsize));
    pwr_base3wayvalve266 = new pwr_base3wayvalve2(session);
    pwr_base3wayvalve266.setBounds(new Rectangle(430,533,97,129));
    localPanel.add(pwr_base3wayvalve266, new Proportion(pwr_base3wayvalve266.getBounds(), dsize));
    pwr_mbup68 = new pwr_mbup(session);
    pwr_mbup68.setBounds(new Rectangle(489,25,17,18));
    localPanel.add(pwr_mbup68, new Proportion(pwr_mbup68.getBounds(), dsize));
    pwr_indsquare70 = new pwr_indsquare(session);
    pwr_indsquare70.setBounds(new Rectangle(167,270,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu228,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu228.dd, "open graph /class /inst=$object.Actuator.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu228,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare33.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare33.dd, "$object.Actuator.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare33.dd, "$object.Actuator.SwitchOpen")
      });
    ...
    pwr_indsquare34.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare34.dd, "$object.Actuator.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare34.dd, "$object.Actuator.SwitchClosed")
      });
    jopBar40.setPwrAttribute("$object.Actuator.Order.ActualValue##Float32");
    ...
    pwr_valuesmall42.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall42.dd, "$object.Actuator.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall42.dd, "$object.Actuator.Order")
      });
    pwr_smallbuttoncenter43.dd.setDynType(129);
    pwr_smallbuttoncenter43.dd.setActionType(4);
    pwr_smallbuttoncenter43.dd.setAccess(65532);
    pwr_smallbuttoncenter43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter43.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter43.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter43.setAnnot1("Auto");
    ...
    pwr_sliderbackground1_247.dd.setDynType(524417);
    pwr_sliderbackground1_247.dd.setActionType(0);
    pwr_sliderbackground1_247.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_247.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_slider148.dd.setDynType(129);
    pwr_slider148.dd.setActionType(2048);
    pwr_slider148.dd.setAccess(65532);
    pwr_slider148.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider148.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider148.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,527.206,685.913)
      });
    pwr_valueinputsmallrd49.dd.setDynType(1153);
    pwr_valueinputsmallrd49.dd.setActionType(4096);
    pwr_valueinputsmallrd49.dd.setAccess(65532);
    pwr_valueinputsmallrd49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd49.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
    ...
    pwr_indsquare51.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare51.dd, "$object.Actuator.SwitchError##Boolean",29)
      });
    grp167_52.dd.setDynType(129);
    grp167_52.dd.setActionType(0);
    grp167_52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_52.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_actuator54.dd.setDynType(1);
    pwr_actuator54.dd.setActionType(66);
    pwr_actuator54.dd.setAccess(65532);
    pwr_actuator54.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator54.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator54.dd, "open graph/class/inst=$object.Actuator")
      });
    ...
    pwr_pulldownmenu257.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu257,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu257.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu257.setAnnot1("Components");
    pwr_smallbuttoncenter58.dd.setDynType(128);
    ...
    pwr_smallbuttoncenter58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter58.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter58.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    ...
    pwr_indround59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround59.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround59.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_60.dd.setDynType(129);
    grp175_60.dd.setActionType(0);
    grp175_60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_60.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare61.dd.setDynType(13);
    pwr_indsquare61.dd.setActionType(0);
    pwr_indsquare61.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare61.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare61.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    pwr_valve3waycontrol264.dd.setDynType(17456);
    pwr_valve3waycontrol264.dd.setActionType(0);
    pwr_valve3waycontrol264.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_valve3waycontrol264.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_valve3waycontrol264.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynValue(pwr_valve3waycontrol264.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_valve3waycontrol264.dd, "$object.Actuator.PosEnum##Int32")
      });
    pwr_base3wayvalve65.dd.setDynType(0);
    pwr_base3wayvalve65.dd.setActionType(66);
    pwr_base3wayvalve65.dd.setAccess(65532);
    pwr_base3wayvalve65.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_base3wayvalve65.dd, "$object.Valve")
      ,new GeDynCommand(pwr_base3wayvalve65.dd, "open graph/class/inst=$object.Valve")
      });
    pwr_base3wayvalve266.dd.setDynType(16384);
    pwr_base3wayvalve266.dd.setActionType(66);
    pwr_base3wayvalve266.dd.setAccess(65532);
    pwr_base3wayvalve266.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_base3wayvalve266.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_base3wayvalve266.dd, "$object.Valve")
      ,new GeDynCommand(pwr_base3wayvalve266.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_indsquare70.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare70.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.55231F, 23.1001F, 526.654F, 22.4305F),
    ...
    new Rectangle2D.Float(18F, 98.1642F, 237.944F, 197.211F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 98, 98, 99, 99, 294, 295}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 295, 98, 99, 294, 294, 295}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.55231F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.55231F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
...
protected class pwr_base3wayvalve extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 27, 39, 42}, new int[] { 78, 75, 75,78}, 4),
    new Polygon( new int[] { 42, 39, 39, 42}, new int[] { 78, 75, 65,68}, 4),
    new Polygon( new int[] { 42, 39, 45, 46}, new int[] { 68, 65, 65,68}, 4),
    ...
    new Polygon( new int[] { 58, 55, 48, 50}, new int[] { 34, 36, 34,30}, 4),
    new Polygon( new int[] { 50, 48, 45, 48}, new int[] { 30, 34, 31,28}, 4),
    new Polygon( new int[] { 48, 45, 45, 48}, new int[] { 28, 31, 25,22}, 4),
    new Polygon( new int[] { 48, 45, 45, 46}, new int[] { 22, 25, 25,20}, 4),
    new Polygon( new int[] { 46, 45, 41, 42}, new int[] { 20, 25, 25,20}, 4),
    new Polygon( new int[] { 42, 41, 37, 38}, new int[] { 20, 25, 23,18}, 4),
    new Polygon( new int[] { 38, 37, 29, 27}, new int[] { 18, 23, 23,18}, 4),
    new Polygon( new int[] { 27, 29, 29, 29}, new int[] { 18, 23, 23,32}, 4),
    ...
    new Polygon( new int[] { 6, 9, -1219915282, 29}, new int[] { 48, 50, -1219915279,32}, 4),
    ...
    new Polygon( new int[] { 26, 29, 29, 29}, new int[] { 18, 23, 32,32}, 4),
...
protected class pwr_base3wayvalve2 extends GeComponent {
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {34, 30, 28, 34, 34, 38, 34}, 7),
    new Polygon( new int[] { 48, 42, 42, 40, 38, 38, 42, 42, 46, 48, 48}, new int[] {22, 22, 66, 66, 68, 78, 78, 68, 68, 66, 22}, 11),
    new Polygon( new int[] { 48, 47, 43, 42}, new int[] { 22, 25, 25,22}, 4),
    new Polygon( new int[] { 42, 43, 43, 42}, new int[] { 22, 25, 67,66}, 4),
    new Polygon( new int[] { 42, 43, 40, 40}, new int[] { 66, 67, 67,66}, 4),
    new Polygon( new int[] { 40, 40, 39, 38}, new int[] { 66, 67, 68,68}, 4),
    new Polygon( new int[] { 38, 39, 39, 38}, new int[] { 68, 68, 77,78}, 4),
    new Polygon( new int[] { 38, 39, 41, 42}, new int[] { 78, 77, 77,78}, 4),
    new Polygon( new int[] { 42, 41, 41, 42}, new int[] { 78, 77, 67,68}, 4),
    ...
    new Polygon( new int[] { 48, 47, -1219915346, 29}, new int[] { 22, 25, -1219915343,32}, 4),
    new Polygon( new int[] { 48, 22, 22, 16, 16, 18, 22, 26, 38, 42, 46, 48}, new int[] {22, 22, 66, 66, 22, 20, 20, 18, 18, 20, 20, 22}, 12),
    ...
    new Polygon( new int[] { 26, 28, 38, 38}, new int[] { 18, 22, 22,18}, 4),
    ...
    new Polygon( new int[] { 48, 43, 102, 29}, new int[] { 22, 22, 140893352,32}, 4),
    new Rectangle2D.Float(22F, 68F, 4F, 10F),
    new Polygon( new int[] { 22, 26, 26, 22, 22, 22}, new int[] { 68, 68, 68, 68, 78, 78}, 6), 
    new Polygon( new int[] { 26, 26, 26, 26, 22, 22}, new int[] { 78, 68, 68, 78, 78, 78}, 6), 
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {54, 50, 52, 44, 44, 48, 54}, 7),
    ...
    new Polygon( new int[] { 24, 29, 37, 40}, new int[] { 78, 75, 75,78}, 4),
    new Polygon( new int[] { 40, 37, 37, 40}, new int[] { 78, 75, 38,43}, 4),
    new Polygon( new int[] { 40, 37, 55, 58}, new int[] { 43, 38, 47,52}, 4),
    new Polygon( new int[] { 58, 55, 55, 58}, new int[] { 52, 47, 38,36}, 4),
    new Polygon( new int[] { 58, 55, 39, 40}, new int[] { 36, 38, 31,26}, 4),
    new Polygon( new int[] { 40, 39, 29, 24}, new int[] { 26, 31, 31,26}, 4),
    ...
    new Polygon( new int[] { 6, 11, 102, 29}, new int[] { 52, 50, 140893352,32}, 4),
    ...
    new Polygon( new int[] { 26, 29, 31, 31}, new int[] { 46, 44, 42,43}, 4),
    new Polygon( new int[] { 31, 31, 33, 33}, new int[] { 43, 42, 42,43}, 4),
    new Polygon( new int[] { 33, 33, 37, 38}, new int[] { 43, 42, 44,46}, 4),
    new Polygon( new int[] { 38, 37, 37, 38}, new int[] { 46, 44, 45,44}, 4),
    ...
    new Polygon( new int[] { 31, 32, -1219915346, 29}, new int[] { 26, 29, -1219915343,32}, 4),
...
protected class pwr_valve3waycontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 19, 22}, new int[] { 42, 41, 34,32}, 4),
    new Polygon( new int[] { 22, 19, 6, 2}, new int[] { 32, 34, 27,22}, 4),
    new Polygon( new int[] { 2, 6, 68, 19}, new int[] { 22, 27, 145854286,-2147483648}, 4),
    new Polygon( new int[] { 42, 42, 22, 42}, new int[] {22, 42, 32, 22}, 4),
    new Polygon( new int[] { 42, 40, 40, 42}, new int[] { 22, 27, 41,42}, 4),
    new Polygon( new int[] { 42, 40, 26, 22}, new int[] { 42, 41, 34,32}, 4),
    new Polygon( new int[] { 22, 26, 40, 42}, new int[] { 32, 34, 27,22}, 4),
    new Polygon( new int[] { 42, 40, 68, 19}, new int[] { 22, 27, 145854286,-2147483648}, 4),
    ...
    new Polygon( new int[] { 22, 22, 17, 12}, new int[] { 32, 39, 52,52}, 4),
    new Polygon( new int[] { 12, 17, 29, 32}, new int[] { 52, 52, 52,52}, 4),
    new Polygon( new int[] { 32, 29, 22, 22}, new int[] { 52, 52, 39,32}, 4),
    new Polygon( new int[] { 22, 22, 68, 19}, new int[] { 32, 39, 145854286,-2147483648}, 4),
