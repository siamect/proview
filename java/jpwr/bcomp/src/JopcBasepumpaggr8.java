...
public class JopcBasepumpaggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(93,457,82,72));
    ...
    pwr_motor245.setBounds(new Rectangle(174,457,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(186,417,14,15));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(169,482,10,20));
    ...
    pwr_fuse365.setBounds(new Rectangle(261,269,13,35));
    ...
    pwr_contactor266.setBounds(new Rectangle(249,312,36,36));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 7, -5, -5}, new int[] { 40, 36, 7,7}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915381, -5}, new int[] { 10, 12, -1219915368,7}, 4),
    ...
    new Polygon( new int[] { 6, 9, 1885434465, -5}, new int[] { 14, 17, 111,7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915363, 12}, new int[] { 12, 15, -1219915338,37}, 4),
