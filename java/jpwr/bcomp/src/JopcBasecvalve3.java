...
public class JopcBasecvalve3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valvecontrol2	pwr_valvecontrol259;
  pwr_mbup	pwr_mbup60;
  pwr_indsquare	pwr_indsquare62;
  public JopcBasecvalve3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_menubar26.setBounds(new Rectangle(1,1,535,22));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(12,1,67,22));
    ...
    pwr_pulldownmenu28.setBounds(new Rectangle(447,1,67,22));
    ...
    pwr_mbopenobject9.setBounds(new Rectangle(196,25,18,18));
    ...
    pwr_mbtrend10.setBounds(new Rectangle(57,25,18,18));
    ...
    pwr_mbfast11.setBounds(new Rectangle(77,25,18,18));
    ...
    pwr_mbrtnavigator16.setBounds(new Rectangle(176,25,18,18));
    ...
    pwr_mbblockevents18.setBounds(new Rectangle(156,25,18,18));
    ...
    pwr_mbnote20.setBounds(new Rectangle(37,25,17,18));
    ...
    pwr_sliderbackground325.setBounds(new Rectangle(338,133,54,241));
    ...
    pwr_valueinputreliefup26.setBounds(new Rectangle(275,132,49,16));
    ...
    pwr_valueinputreliefup27.setBounds(new Rectangle(275,359,49,16));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(269,1,67,22));
    ...
    pwr_pulldownmenu229.setBounds(new Rectangle(71,1,67,22));
    ...
    jopBar36.setBounds(new Rectangle(353,134,20,238));
    ...
    pwr_basevalve49 = new pwr_basevalve(session);
    pwr_basevalve49.setBounds(new Rectangle(287,534,78,120));
    pwr_basevalve49.setShadow(1);
    localPanel.add(pwr_basevalve49, new Proportion(pwr_basevalve49.getBounds(), dsize));
    pwr_pulldownmenu252 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu252.setBounds(new Rectangle(162,1,67,22));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround54.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_55 = new Grp175_(session);
    grp175_55.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_55, new Proportion(grp175_55.getBounds(), dsize));
    pwr_indsquare56 = new pwr_indsquare(session);
    pwr_indsquare56.setBounds(new Rectangle(184,488,14,14));
    ...
    pwr_valvecontrol259 = new pwr_valvecontrol2(session);
    pwr_valvecontrol259.setBounds(new Rectangle(111,116,64,41));
    pwr_valvecontrol259.setShadow(1);
    localPanel.add(pwr_valvecontrol259, new Proportion(pwr_valvecontrol259.getBounds(), dsize));
    pwr_mbup60 = new pwr_mbup(session);
    pwr_mbup60.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup60, new Proportion(pwr_mbup60.getBounds(), dsize));
    pwr_indsquare62 = new pwr_indsquare(session);
    pwr_indsquare62.setBounds(new Rectangle(167,262,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider144.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider144.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,534.689,685.913)
      });
    ...
    pwr_basevalve49.dd.setDynType(16385);
    pwr_basevalve49.dd.setActionType(66);
    pwr_basevalve49.dd.setAccess(65532);
    pwr_basevalve49.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve49.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve49.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve49.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_pulldownmenu252.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu252.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu252,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu252.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu252.setAnnot1("Components");
    pwr_smallbuttoncenter53.dd.setDynType(128);
    ...
    pwr_smallbuttoncenter53.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter53.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter53.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    ...
    pwr_indround54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround54.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround54.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_55.dd.setDynType(129);
    grp175_55.dd.setActionType(0);
    grp175_55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_55.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare56.dd.setDynType(13);
    pwr_indsquare56.dd.setActionType(0);
    pwr_indsquare56.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare56.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare56.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    pwr_valvecontrol259.dd.setDynType(1034);
    pwr_valvecontrol259.dd.setActionType(0);
    pwr_valvecontrol259.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol259.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol259.dd, "$object.Actuator.IndWarning##Boolean",30)
      ,new GeDynValue(pwr_valvecontrol259.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      });
    ...
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare62.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.1001F, 534.689F, 22.4305F),
    new Line2D.Float( 252.569F, 329.042F, 18.0342F, 329.042F),
    new Rectangle2D.Float(17.6252F, 304.139F, 237.944F, 121.555F),
    ...
    new Rectangle2D.Float(259.626F, 98.9998F, 266.625F, 327.444F),
    ...
    new Rectangle2D.Float(17.6252F, 98.9982F, 237.944F, 197.211F),
    ...
    new Line2D.Float( 391.02F, 181F, 338.496F, 181F),
    new Line2D.Float( 391.02F, 229F, 338.496F, 229F),
    new Line2D.Float( 391.02F, 276F, 338.496F, 276F),
    new Line2D.Float( 391.02F, 325F, 338.496F, 325F),
    new Rectangle2D.Float(55.5456F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 56, 116, 114, 58, 58, 56}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 116, 116, 114, 114, 58, 56}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
    new Rectangle2D.Float(150.791F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 151, 211, 209, 153, 153, 151}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 211, 211, 209, 209, 153, 151}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 273);
    g.setTransform(save);
  }
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 290, 49}, new int[] { 22, 27, -1219915348,-2147483648}, 4),
    ...
    new Polygon( new int[] { 42, 42, 290, 49}, new int[] { 22, 27, -1219915348,-2147483648}, 4),
