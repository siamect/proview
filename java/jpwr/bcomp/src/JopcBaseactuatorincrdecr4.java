...
public class JopcBaseactuatorincrdecr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp243_	grp243_70;
  pwr_mbup	pwr_mbup71;
  public JopcBaseactuatorincrdecr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatorincrdecr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatorincrdecr4");
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(17,433,48,21));
    ...
    pwr_valuelong24.setBounds(new Rectangle(74,432,336,23));
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(148,0,69,24));
    ...
    pwr_actuator46 = new pwr_actuator(session);
    pwr_actuator46.setBounds(new Rectangle(162,111,68,44));
    pwr_actuator46.setShadow(1);
    localPanel.add(pwr_actuator46, new Proportion(pwr_actuator46.getBounds(), dsize));
    pwr_smallbuttoncenter49 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter49.setBounds(new Rectangle(173,338,62,21));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(37,337,48,21));
    ...
    pwr_indround51.setBounds(new Rectangle(97,341,18,18));
    ...
    pwr_indround52.setBounds(new Rectangle(97,363,18,18));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(173,362,62,21));
    ...
    pwr_indround54.setBounds(new Rectangle(97,387,18,18));
    ...
    pwr_indround55.setBounds(new Rectangle(245,342,18,18));
    ...
    pwr_indsquare58.setBounds(new Rectangle(290,342,16,17));
    ...
    pwr_smallbuttoncenter59.setBounds(new Rectangle(173,385,62,21));
    ...
    pwr_indsquare60.setBounds(new Rectangle(290,365,16,16));
    ...
    pwr_smallbuttoncenter61.setBounds(new Rectangle(173,362,62,21));
    ...
    pwr_smallbuttoncenter62.setBounds(new Rectangle(173,338,62,21));
    ...
    grp207_63 = new Grp207_(session);
    grp207_63.setBounds(new Rectangle(39,363,41,18));
    localPanel.add(grp207_63, new Proportion(grp207_63.getBounds(), dsize));
    pwr_smallbuttoncenter64 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter64.setBounds(new Rectangle(37,362,48,21));
    ...
    pwr_indsquare68.setBounds(new Rectangle(136,185,16,17));
    ...
    pwr_indsquare69.setBounds(new Rectangle(137,204,16,17));
    ...
    grp243_70 = new Grp243_(session);
    grp243_70.setBounds(new Rectangle(277,311,50,18));
    localPanel.add(grp243_70, new Proportion(grp243_70.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu230.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu230.dd, new String[] {
        "Position Ai","OrderIncr Do","OrderDecr Do","SwitchOpen Di","SwitchClosed Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare34.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare34.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare34.dd, "$object.SwitchOpen")
      });
    ...
    pwr_indsquare35.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare35.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare35.dd, "$object.SwitchClosed")
      });
    jopBar41.setPwrAttribute("$object.Position.ActualValue##Float32");
    jopBar41.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar41.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    pwr_indsquare45.dd.setDynType(5);
    pwr_indsquare45.dd.setActionType(0);
    pwr_indsquare45.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare45.dd, "$object.SwitchError##Boolean",29)
      });
    pwr_actuator46.dd.setDynType(1);
    pwr_actuator46.dd.setActionType(66);
    pwr_actuator46.dd.setAccess(65532);
    pwr_actuator46.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator46.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator46.dd, "open graph/class/inst=$object.Actuator")
      });
    ...
    pwr_smallbuttoncenter49.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynStoDig(pwr_smallbuttoncenter49.dd, "$object.Mode.OpManIncr##Boolean")
      });
    ...
    pwr_smallbuttoncenter53.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter53.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynStoDig(pwr_smallbuttoncenter53.dd, "$object.Mode.OpManDecr##Boolean")
      });
    ...
    pwr_indround55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround55.dd, "$object.Mode.FeedbackIncr##Boolean",29)
      });
    grp203_56.dd.setDynType(129);
    grp203_56.dd.setActionType(0);
    grp203_56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp203_56.dd, "$object.Mode.LocalModHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter59.dd, "$object.Mode.ManStopHide##Boolean",0)
    ...
    pwr_smallbuttoncenter61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter61.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter61.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter61.dd, "$object.Mode.OpManDecr##Boolean")
      });
    pwr_smallbuttoncenter61.setAnnot1("Decr");
    ...
    pwr_smallbuttoncenter62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter62.dd, "$object.Mode.OpNoStopButton##Boolean",0)
      ...
      ,new GeDynPopupMenu(pwr_smallbuttoncenter62.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(pwr_smallbuttoncenter62.dd, "$object.Mode.OpManIncr##Boolean")
      });
    pwr_smallbuttoncenter62.setAnnot1("Incr");
    grp207_63.dd.setDynType(129);
    grp207_63.dd.setActionType(0);
    grp207_63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp207_63.dd, "$object.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter64.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter64.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter64.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter64.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter64.setAnnot1("Auto");
    ...
    pwr_indsquare68.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare68.dd, "$object.OrderIncr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare68.dd, "$object.OrderIncr")
      });
    ...
    pwr_indsquare69.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare69.dd, "$object.OrderDecr.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare69.dd, "$object.OrderDecr")
      });
    grp243_70.dd.setDynType(128);
    grp243_70.dd.setActionType(0);
    grp243_70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp243_70.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.00001F, 22.5515F, 525.817F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.00001F,44.982F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.00001F,22.5515F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
