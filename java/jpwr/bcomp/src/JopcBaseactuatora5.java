...
public class JopcBaseactuatora5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBaseactuatora5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora5");
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(167,1,67,22));
    ...
    pwr_actuator56.setBounds(new Rectangle(109,112,66,42));
    ...
    pwr_indsquare62.setBounds(new Rectangle(167,272,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider149.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider149.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,537.686,448.913)
      });
