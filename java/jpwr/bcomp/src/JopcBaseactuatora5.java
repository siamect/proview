...
public class JopcBaseactuatora5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(166,0,69,24));
    ...
    pwr_actuator56.setBounds(new Rectangle(108,111,68,44));
    ...
    pwr_indsquare62.setBounds(new Rectangle(166,271,16,17));
