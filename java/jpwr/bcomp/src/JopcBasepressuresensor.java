...
public class JopcBasepressuresensor extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup73;
  public JopcBasepressuresensor( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasepressuresensor( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasepressuresensor");
    ...
    pwr_mbopenobject7.setBounds(new Rectangle(195,26,18,18));
    ...
    pwr_mbtrend8.setBounds(new Rectangle(56,26,18,18));
    ...
    pwr_mbfast9.setBounds(new Rectangle(76,26,18,18));
    ...
    pwr_mbphoto10.setBounds(new Rectangle(96,26,18,18));
    ...
    pwr_mbdatasheet11.setBounds(new Rectangle(116,26,18,18));
    ...
    pwr_mbopenplc12.setBounds(new Rectangle(215,26,18,18));
    ...
    pwr_mbcircuitdiagram13.setBounds(new Rectangle(235,26,18,18));
    ...
    pwr_mbrtnavigator14.setBounds(new Rectangle(175,26,18,18));
    ...
    pwr_mbhelpclass15.setBounds(new Rectangle(255,26,18,18));
    ...
    pwr_mbblockevents16.setBounds(new Rectangle(155,26,18,18));
    ...
    pwr_mbsimulate68.setBounds(new Rectangle(382,26,18,18));
    ...
    pwr_mbup73.setBounds(new Rectangle(362,26,18,18));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(18.0002F, 98.5732F, 237.944F, 141.02F),
    ...
    new Rectangle2D.Float(18.0002F, 247.987F, 237.944F, 140.96F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Pressure"),35, 128);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, 2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Limits"),27, 268);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Hysteresis"),160, 297);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 8));
    g.drawString( JopLang.transl("Delay"),215, 297);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( JopLang.transl("Supervision disabled"),128, 268);
    {
...
protected class pwr_slider3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 49, 50, 50, -101}, new int[] { 3, 2, 2,-77}, 4),
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, 309, -131}, new int[] { 22, 18, 140856969,-62}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
