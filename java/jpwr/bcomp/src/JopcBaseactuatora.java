...
public class JopcBaseactuatora extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_actuator	pwr_actuator40;
  pwr_indround	pwr_indround41;
  Grp173_	grp173_42;
  public JopcBaseactuatora( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora");
    ...
    pwr_indsquare30.setBounds(new Rectangle(171,109,16,17));
    ...
    pwr_indsquare31.setBounds(new Rectangle(172,128,16,17));
    ...
    jopBar37.setBounds(new Rectangle(356,132,24,242));
    jopBar37.setFillColor(58);
    jopBar37.setBorderColor(0);
    jopBar37.setFillColorBar(105);
    jopBar37.setBorderColorBar(101);
    ...
    jopAxis38.setBounds(new Rectangle(327,134,11,238));
    ...
    pwr_valuesmall39.setBounds(new Rectangle(343,391,50,17));
    localPanel.add(pwr_valuesmall39, new Proportion(pwr_valuesmall39.getBounds(), dsize));
    pwr_actuator40 = new pwr_actuator(session);
    pwr_actuator40.setBounds(new Rectangle(56,237,132,84));
    pwr_actuator40.setShadow(1);
    localPanel.add(pwr_actuator40, new Proportion(pwr_actuator40.getBounds(), dsize));
    pwr_indround41 = new pwr_indround(session);
    pwr_indround41.setBounds(new Rectangle(105,388,17,18));
    ...
    grp173_42 = new Grp173_(session);
    grp173_42.setBounds(new Rectangle(48,387,35,18));
    localPanel.add(grp173_42, new Proportion(grp173_42.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar37.setPwrAttribute("$object.Order.ActualValue##Float32");
    jopBar37.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar37.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    pwr_valuesmall39.dd.setDynType(1025);
    pwr_valuesmall39.dd.setActionType(2);
    pwr_valuesmall39.dd.setAccess(65532);
    pwr_valuesmall39.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall39.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall39.dd, "$object.Order")
      });
    pwr_actuator40.dd.setDynType(1);
    pwr_actuator40.dd.setActionType(2);
    pwr_actuator40.dd.setAccess(65532);
    pwr_actuator40.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator40.dd, "$object.Actuator")
      });
    pwr_indround41.dd.setDynType(133);
    pwr_indround41.dd.setActionType(0);
    pwr_indround41.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround41.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround41.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp173_42.dd.setDynType(129);
    grp173_42.dd.setActionType(0);
    grp173_42.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_42.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "SwitchClosed",43, 143);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
