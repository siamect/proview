...
public class JopcBaseactuatora extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(18,430,46,19));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(157,1,67,22));
    ...
    pwr_actuator53.setBounds(new Rectangle(110,116,66,42));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(37,343,45,19));
    ...
    pwr_indround55.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_56 = new Grp175_(session);
    grp175_56.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_56, new Proportion(grp175_56.getBounds(), dsize));
    pwr_mbup57 = new pwr_mbup(session);
    pwr_mbup57.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup57, new Proportion(pwr_mbup57.getBounds(), dsize));
    pwr_indsquare59 = new pwr_indsquare(session);
    pwr_indsquare59.setBounds(new Rectangle(167,273,14,15));
    pwr_indsquare59.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu228.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu228.dd, "open graph /class /inst=$object.Order")
      }),
    new GeDyn(pwr_pulldownmenu228,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu228.dd, "open graph /class /inst=$object.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu228,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu228.dd, "open graph /class /inst=$object.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare34.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare34.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare34.dd, "$object.SwitchClosed")
      });
    jopBar40.setPwrAttribute("$object.Order.ActualValue##Float32");
    jopBar40.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar40.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    ...
    pwr_valuesmall42.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall42.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall42.dd, "$object.Order")
      });
    ...
    pwr_smallbuttoncenter43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter43.dd, "$object.Mode.OpAutoOnly##Boolean",0)
    ...
    pwr_indround45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround45.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround45.dd, "!$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_slider148.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider148.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider148.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,527.025,447.913)
      });
    ...
    pwr_valueinputsmallrd49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd49.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd49.dd, "$object.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd49.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    ...
    pwr_indsquare51.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare51.dd, "$object.SwitchError##Boolean",29)
      });
    ...
    pwr_actuator53.dd.setActionType(0);
    pwr_smallbuttoncenter54.dd.setDynType(128);
    ...
    pwr_smallbuttoncenter54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter54.dd, "$object.Mode.OpAutoOnly##Boolean",0)
    ...
    pwr_indround55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround55.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround55.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp175_56.dd.setDynType(129);
    grp175_56.dd.setActionType(0);
    grp175_56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_56.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
    pwr_mbup57.dd.setDynType(129);
    pwr_mbup57.dd.setActionType(8256);
    pwr_mbup57.dd.setAccess(33619967);
    pwr_mbup57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup57.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup57.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup57.dd, JopLang.transl("Open parent object graph"))
      });
    pwr_indsquare59.dd.setDynType(5);
    pwr_indsquare59.dd.setActionType(0);
    pwr_indsquare59.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare59.dd, "$object.SupDisabled##Boolean",29)
      });
