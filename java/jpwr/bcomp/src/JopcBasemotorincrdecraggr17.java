...
public class JopcBasemotorincrdecraggr17 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motorman	pwr_motorman51;
  pwr_rodcouplinganim	pwr_rodcouplinganim52;
  pwr_contactor2	pwr_contactor253;
  ...
  public JopcBasemotorincrdecraggr17( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr17( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr17");
    pwr_overloadrelay1 = new pwr_overloadrelay(session);
    pwr_overloadrelay1.setBounds(new Rectangle(248,329,38,27));
    ...
    jopSmallbutton7.setBounds(new Rectangle(40,168,48,21));
    ...
    jopSmallbutton26.setBounds(new Rectangle(4,503,47,21));
    ...
    pwr_valuelong27.setBounds(new Rectangle(60,502,336,23));
    ...
    pwr_menubar34 = new pwr_menubar(session);
    pwr_menubar34.setBounds(new Rectangle(0,0,409,24));
    pwr_menubar34.setShadow(1);
    localPanel.add(pwr_menubar34, new Proportion(pwr_menubar34.getBounds(), dsize));
    pwr_pulldownmenu35 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu35.setBounds(new Rectangle(8,0,44,24));
    ...
    pwr_pulldownmenu36.setBounds(new Rectangle(328,0,69,24));
    ...
    pwr_pulldownmenu37.setBounds(new Rectangle(220,0,69,24));
    ...
    pwr_pulldownmenu38.setBounds(new Rectangle(52,0,69,24));
    ...
    pwr_pulldownmenu39.setBounds(new Rectangle(124,0,88,24));
    ...
    pwr_indsquare47.setBounds(new Rectangle(150,359,16,16));
    ...
    grp173_48.setBounds(new Rectangle(34,359,39,18));
    localPanel.add(grp173_48, new Proportion(grp173_48.getBounds(), dsize));
    pwr_indsquare49 = new pwr_indsquare(session);
    pwr_indsquare49.setBounds(new Rectangle(150,335,16,16));
    pwr_indsquare49.setShadow(1);
    localPanel.add(pwr_indsquare49, new Proportion(pwr_indsquare49.getBounds(), dsize));
    pwr_motorman51 = new pwr_motorman(session);
    pwr_motorman51.setBounds(new Rectangle(101,95,64,44));
    pwr_motorman51.setShadow(1);
    localPanel.add(pwr_motorman51, new Proportion(pwr_motorman51.getBounds(), dsize));
    pwr_rodcouplinganim52 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim52.setBounds(new Rectangle(168,424,12,22));
    pwr_rodcouplinganim52.setShadow(1);
    localPanel.add(pwr_rodcouplinganim52, new Proportion(pwr_rodcouplinganim52.getBounds(), dsize));
    pwr_contactor253 = new pwr_contactor2(session);
    pwr_contactor253.setBounds(new Rectangle(305,293,38,38));
    pwr_contactor253.setShadow(1);
    localPanel.add(pwr_contactor253, new Proportion(pwr_contactor253.getBounds(), dsize));
    pwr_indsquare55 = new pwr_indsquare(session);
    pwr_indsquare55.setBounds(new Rectangle(211,303,16,17));
    ...
    pwr_indround56.setBounds(new Rectangle(226,195,18,17));
    ...
    pwr_indsquare57.setBounds(new Rectangle(275,173,16,17));
    ...
    pwr_indsquare58.setBounds(new Rectangle(275,196,16,17));
    ...
    grp190_62 = new Grp190_(session);
    grp190_62.setBounds(new Rectangle(260,148,91,18));
    localPanel.add(grp190_62, new Proportion(grp190_62.getBounds(), dsize));
    grp199_64 = new Grp199_(session);
    grp199_64.setBounds(new Rectangle(42,194,43,18));
    localPanel.add(grp199_64, new Proportion(grp199_64.getBounds(), dsize));
    jopSmallbutton65 = new JopSmallbutton(session);
    jopSmallbutton65.setBounds(new Rectangle(40,193,48,21));
    ...
    jopSmallbutton70.setBounds(new Rectangle(141,169,80,21));
    ...
    jopSmallbutton71.setBounds(new Rectangle(141,193,80,21));
    ...
    jopSmallbutton72.setBounds(new Rectangle(141,216,80,21));
    ...
    jopSmallbutton73.setBounds(new Rectangle(142,193,80,21));
    ...
    jopSmallbutton74.setBounds(new Rectangle(142,169,80,21));
    ...
    jopSmallbutton7.dd.setDynType(129);
    jopSmallbutton7.dd.setActionType(6);
    jopSmallbutton7.dd.setAccess(65532);
    jopSmallbutton7.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton7.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton7.dd, "$object.Mode.ManModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton7.dd, "$object.Mode.OpMan")
      ,new GeDynSetDig(jopSmallbutton7.dd, "$object.Mode.OpMan##Boolean")
      });
    jopSmallbutton7.setAnnot1(" Man");
    ...
    pwr_menubar34.dd.setDynType(1);
    pwr_menubar34.dd.setActionType(0);
    pwr_pulldownmenu35.dd.setDynType(0);
    ...
    pwr_pulldownmenu35.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu35.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu35,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu35.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu35.setAnnot1("File");
    pwr_pulldownmenu36.dd.setDynType(1);
    pwr_pulldownmenu36.dd.setActionType(524288);
    pwr_pulldownmenu36.dd.setAccess(65532);
    ...
    new GeDyn(pwr_pulldownmenu36,1,65,65532,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu36.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu36.setAnnot1("Help");
    ...
    pwr_pulldownmenu37.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu37.dd, new String[] {
        "ContactorIncr.Order Do",null,"ContactorIncr.Feedback Di","ContactorDecr.Order Do","ContactorDecr.Feedback Di",null,"SafetySwitch.On Di","Motor.TempSwitch.Switch Di","Motor.TempSensor.Value Ai",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu37,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.ContactorIncr.Order")
      }),
null,    new GeDyn(pwr_pulldownmenu37,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu37.dd, "$object.ContactorIncr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.ContactorIncr.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu37,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.ContactorDecr.Order")
      }),
    new GeDyn(pwr_pulldownmenu37,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu37.dd, "$object.ContactorDecr.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.ContactorDecr.Feedback")
      }),
null,    new GeDyn(pwr_pulldownmenu37,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
    new GeDyn(pwr_pulldownmenu37,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu37.dd, "$object.Motor.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.Motor.TempSwitch.Switch")
      }),
    new GeDyn(pwr_pulldownmenu37,129,65,33619967,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu37.dd, "$object.Motor.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu37.dd, "open graph /class /inst=$object.Motor.TempSensor.Value")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu37.setAnnot1("Signals");
    ...
    pwr_pulldownmenu38.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu38.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu38,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu38,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu38.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu38.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu38.setAnnot1("Methods");
    ...
    pwr_pulldownmenu39.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu39.dd, new String[] {
        "ContactorIncr",null,"ContactorDecr","OverloadRelay",null,"Motor",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu39,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu39.dd, "open graph /class /inst=$object.ContactorIncr")
      }),
null,    new GeDyn(pwr_pulldownmenu39,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu39.dd, "open graph /class /inst=$object.ContactorDecr")
      }),
    new GeDyn(pwr_pulldownmenu39,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu39.dd, "open graph /class /inst=$object.OverloadRelay")
      }),
null,    new GeDyn(pwr_pulldownmenu39,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu39.dd, "open graph /class /inst=$object.Motor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu39.setAnnot1("Components");
    ...
    pwr_indsquare49.dd.setDynType(16);
    pwr_indsquare49.dd.setActionType(2);
    pwr_indsquare49.dd.setAccess(65532);
    pwr_indsquare49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare49.dd, "$object.OverloadRelay.Overload.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare49.dd, "$object.OverloadRelay.Overload")
      });
    pwr_motorman51.dd.setDynType(1077);
    pwr_motorman51.dd.setActionType(0);
    pwr_motorman51.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman51.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman51.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman51.dd, "$object.IndRunning##Boolean",37)
      ,new GeDynValue(pwr_motorman51.dd, "$object.Mode.IndMode##String8","%s")
      });
    pwr_rodcouplinganim52.dd.setDynType(65537);
    pwr_rodcouplinganim52.dd.setActionType(0);
    pwr_rodcouplinganim52.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim52.dd, "$object.IndRunning##Boolean",1)
      });
    pwr_contactor253.dd.setDynType(32769);
    pwr_contactor253.dd.setActionType(66);
    pwr_contactor253.dd.setAccess(65535);
    pwr_contactor253.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor253.dd, "$object.ContactorDecr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor253.dd, "$object.ContactorDecr")
      ,new GeDynCommand(pwr_contactor253.dd, "open graph /class/instance=$object.ContactorDecr")
      });
    pwr_indsquare55.dd.setDynType(13);
    pwr_indsquare55.dd.setActionType(2);
    pwr_indsquare55.dd.setAccess(65532);
    pwr_indsquare55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare55.dd, "$object.ContactorDecr.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare55.dd, "$object.ContactorDecr.IndFeedback##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare55.dd, "$object.ContactorDecr.Feedback")
      });
    pwr_indround56.dd.setDynType(5);
    pwr_indround56.dd.setActionType(0);
    pwr_indround56.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround56.dd, "$object.Mode.FeedbackDecr##Boolean",29)
      });
    pwr_indsquare57.dd.setDynType(141);
    pwr_indsquare57.dd.setActionType(0);
    pwr_indsquare57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare57.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare57.dd, "$object.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare57.dd, "$object.Mode.LimitSwitchIncr##Boolean",29)
      });
    pwr_indsquare58.dd.setDynType(141);
    pwr_indsquare58.dd.setActionType(0);
    pwr_indsquare58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare58.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare58.dd, "$object.Mode.ErrorDecr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare58.dd, "$object.Mode.LimitSwitchDecr##Boolean",29)
      });
    grp190_62.dd.setDynType(129);
    grp190_62.dd.setActionType(0);
    grp190_62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp190_62.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      });
    grp199_64.dd.setDynType(129);
    grp199_64.dd.setActionType(0);
    grp199_64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp199_64.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    jopSmallbutton65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton65.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton65.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton65.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(jopSmallbutton65.dd, "$object.Mode.OpAuto##Boolean")
      });
    jopSmallbutton65.setAnnot1(" Auto");
    jopSmallbutton70.dd.setDynType(129);
    jopSmallbutton70.dd.setActionType(34);
    jopSmallbutton70.dd.setAccess(65532);
    jopSmallbutton70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton70.dd, "!$object.Mode.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton70.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton70.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton70.dd, "$object.Mode.OpManStart")
      ,new GeDynStoDig(jopSmallbutton70.dd, "$object.Mode.OpManIncr##Boolean")
      });
    jopSmallbutton70.setAnnot1("Forward");
    jopSmallbutton71.dd.setDynType(129);
    jopSmallbutton71.dd.setActionType(34);
    ...
    jopSmallbutton71.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynStoDig(jopSmallbutton71.dd, "$object.Mode.OpManDecr##Boolean")
      });
    jopSmallbutton71.setAnnot1("Backward");
    ...
    jopSmallbutton72.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton72.dd, "$object.Mode.ManStopHide##Boolean",0)
      ...
      ,new GeDynSetDig(jopSmallbutton72.dd, "$object.Mode.OpManStop##Boolean")
      });
    jopSmallbutton72.setAnnot1("  Stop");
    ...
    jopSmallbutton73.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynPopupMenu(jopSmallbutton73.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(jopSmallbutton73.dd, "$object.Mode.OpManDecr##Boolean")
      });
    jopSmallbutton73.setAnnot1("Backward");
    jopSmallbutton74.dd.setDynType(129);
    jopSmallbutton74.dd.setActionType(6);
    ...
    jopSmallbutton74.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(jopSmallbutton74.dd, "$object.Mode.OpManIncr##Boolean")
      });
    jopSmallbutton74.setAnnot1("Forward");
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 525;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(19.6569F, 276F, 360.366F, 221.972F),
    new Polygon( new int[] { 20, 380, 379, 20, 20, 20}, new int[] { 276, 276, 277, 277, 497, 498}, 6), 
    new Polygon( new int[] { 380, 380, 379, 379, 20, 20}, new int[] { 498, 276, 277, 497, 497, 498}, 6), 
    ...
    new Line2D.Float( 267F, 291F, 267F, 295F),
    new Line2D.Float( 267F, 291F, 267F, 295F),
    new Line2D.Float( 227F, 401F, 257F, 401F),
    new Line2D.Float( 267F, 391F, 267F, 355F),
    new Arc2D.Float(247F, 381F, 20F, 20F, 270F, 90F, Arc2D.OPEN),
    new Line2D.Float( 227F, 401F, 257F, 401F),
    new Line2D.Float( 227F, 401F, 257F, 401F),
    new Line2D.Float( 267F, 391F, 267F, 355F),
    new Line2D.Float( 267F, 391F, 267F, 355F),
