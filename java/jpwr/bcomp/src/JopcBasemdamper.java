...
public class JopcBasemdamper extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(17,393,47,21));
    ...
    pwr_mdamper50.setBounds(new Rectangle(320,176,147,147));
...
protected class pwr_mdamper extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 5, -1220087356, 51}, new int[] { 28, 29, -1220087386,-2147483648}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
