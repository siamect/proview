...
public class JopcBasemanvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  JopButtontoggle	jopButtontoggle24;
  pwr_valuelong	pwr_valuelong25;
  pwr_valuelong	pwr_valuelong26;
  pwr_menubar	pwr_menubar27;
  pwr_pulldownmenu	pwr_pulldownmenu28;
  pwr_pulldownmenu	pwr_pulldownmenu29;
  pwr_pulldownmenu	pwr_pulldownmenu30;
  pwr_pulldownmenu	pwr_pulldownmenu31;
  pwr_handwheel	pwr_handwheel32;
  pwr_basevalve	pwr_basevalve33;
  pwr_mbsimulate	pwr_mbsimulate34;
  public JopcBasemanvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemanvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemanvalve");
    pwr_indsquare1 = new pwr_indsquare(session);
    pwr_indsquare1.setBounds(new Rectangle(133,102,15,17));
    ...
    pwr_indsquare3.setBounds(new Rectangle(133,121,15,17));
    ...
    pwr_indsquare6.setBounds(new Rectangle(133,140,15,17));
    pwr_indsquare6.setFillColor(175);
    pwr_indsquare6.setShadow(1);
    localPanel.add(pwr_indsquare6, new Proportion(pwr_indsquare6.getBounds(), dsize));
    pwr_valveanim7 = new pwr_valveanim(session);
    pwr_valveanim7.setBounds(new Rectangle(238,100,66,66));
    pwr_valveanim7.setFillColor(36);
    pwr_valveanim7.setShadow(1);
    localPanel.add(pwr_valveanim7, new Proportion(pwr_valveanim7.getBounds(), dsize));
    ...
    jopButtontoggle24 = new JopButtontoggle(session);
    jopButtontoggle24.setBounds(new Rectangle(16,441,48,21));
    jopButtontoggle24.setBorderColor(37);
    localPanel.add(jopButtontoggle24, new Proportion(jopButtontoggle24.getBounds(), dsize));
    pwr_valuelong25 = new pwr_valuelong(session);
    pwr_valuelong25.setBounds(new Rectangle(72,440,336,23));
    ...
    pwr_valuelong26.setBounds(new Rectangle(16,70,369,22));
    ...
    pwr_menubar27 = new pwr_menubar(session);
    pwr_menubar27.setBounds(new Rectangle(0,0,401,24));
    pwr_menubar27.setShadow(1);
    localPanel.add(pwr_menubar27, new Proportion(pwr_menubar27.getBounds(), dsize));
    pwr_pulldownmenu28 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu28.setBounds(new Rectangle(12,0,69,24));
    ...
    pwr_pulldownmenu29.setBounds(new Rectangle(321,0,69,24));
    ...
    pwr_pulldownmenu30.setBounds(new Rectangle(152,0,69,24));
    ...
    pwr_pulldownmenu31.setBounds(new Rectangle(70,0,69,24));
    pwr_pulldownmenu31.setShadow(1);
    localPanel.add(pwr_pulldownmenu31, new Proportion(pwr_pulldownmenu31.getBounds(), dsize));
    pwr_handwheel32 = new pwr_handwheel(session);
    pwr_handwheel32.setBounds(new Rectangle(163,191,127,91));
    pwr_handwheel32.setShadow(1);
    localPanel.add(pwr_handwheel32, new Proportion(pwr_handwheel32.getBounds(), dsize));
    pwr_basevalve33 = new pwr_basevalve(session);
    pwr_basevalve33.setBounds(new Rectangle(198,261,109,166));
    pwr_basevalve33.setShadow(1);
    localPanel.add(pwr_basevalve33, new Proportion(pwr_basevalve33.getBounds(), dsize));
    pwr_mbsimulate34 = new pwr_mbsimulate(session);
    pwr_mbsimulate34.setBounds(new Rectangle(375,24,20,20));
    localPanel.add(pwr_mbsimulate34, new Proportion(pwr_mbsimulate34.getBounds(), dsize));
    ...
    pwr_indsquare1.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare1.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare1.dd, "$object.SwitchOpen")
      });
    ...
    pwr_indsquare3.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare3.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare3.dd, "$object.SwitchClosed")
      });
    pwr_indsquare6.dd.setDynType(5);
    pwr_indsquare6.dd.setActionType(0);
    pwr_indsquare6.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare6.dd, "$object.IndError##Boolean",29)
      });
    pwr_valveanim7.dd.setDynType(65561);
    pwr_valveanim7.dd.setActionType(0);
    pwr_valveanim7.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_valveanim7.dd, "$object.IndError##Boolean")
      ,new GeDynDigColor(pwr_valveanim7.dd, "$object.SwitchOpen.ActualValue##Boolean",64)
      ,new GeDynDigColor(pwr_valveanim7.dd, "$object.SwitchClosed.ActualValue##Boolean",20)
      ,new GeDynAnimation(pwr_valveanim7.dd, "!$object.SwitchOpen.ActualValue##Boolean",2)
      });
    ...
    jopButtontoggle24.dd.setDynType(128);
    jopButtontoggle24.dd.setActionType(64);
    jopButtontoggle24.dd.setAccess(65532);
    jopButtontoggle24.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopButtontoggle24.dd, "$object.Note##String80",0)
      ,new GeDynCommand(jopButtontoggle24.dd, "call method/method=\"Note\"/object=$object")
      });
    jopButtontoggle24.setAnnot1("Note !");
    ...
    pwr_valuelong26.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong26.dd, "$object.Specification##String40","%s")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu30.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu30.dd, new String[] {
        "SwitchOpen Di","SwitchClosed Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu30,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu30.dd, "open graph /class /inst=$object.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu30,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu30.dd, "open graph /class /inst=$object.SwitchClosed")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu30.setAnnot1("Signals");
    ...
    pwr_pulldownmenu31.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu31.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu31,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu31,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu31.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu31.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu31.setAnnot1("Methods");
    pwr_handwheel32.dd.setDynType(1);
    pwr_handwheel32.dd.setActionType(0);
    pwr_basevalve33.dd.setDynType(16385);
    pwr_basevalve33.dd.setActionType(0);
    pwr_basevalve33.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve33.dd, "$object.PosEnum##Enum")
      });
    pwr_mbsimulate34.dd.setDynType(129);
    pwr_mbsimulate34.dd.setActionType(8256);
    pwr_mbsimulate34.dd.setAccess(65532);
    pwr_mbsimulate34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate34.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate34.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate34.dd, "Open simulate graph")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(211.565F, 130.558F, 34.2364F, 6.85393F),
    new Polygon( new int[] { 212, 246, 244, 214, 214, 212}, new int[] { 131, 131, 133, 133, 135, 137}, 6), 
    new Polygon( new int[] { 246, 246, 244, 244, 214, 212}, new int[] { 137, 131, 133, 135, 135, 137}, 6), 
    new Rectangle2D.Float(297.837F, 130.558F, 33.2152F, 6.85393F),
    new Polygon( new int[] { 298, 331, 329, 300, 300, 298}, new int[] { 131, 131, 133, 133, 135, 137}, 6), 
    new Polygon( new int[] { 331, 331, 329, 329, 300, 298}, new int[] { 137, 131, 133, 135, 135, 137}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Switch open",34, 115);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Switch closed",34, 134);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Switch error",34, 153);
    {
...
protected class pwr_valveanim extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 8, 8, 6}, new int[] { 16, 21, 34,36}, 4),
    new Polygon( new int[] { 6, 8, 21, 26}, new int[] { 36, 34, 28,26}, 4),
    new Polygon( new int[] { 26, 21, 8, 6}, new int[] { 26, 28, 21,16}, 4),
    new Polygon( new int[] { 46, 26, 46, 46}, new int[] {16, 26, 36, 16}, 4),
    new Polygon( new int[] { 46, 44, 31, 26}, new int[] { 16, 21, 28,26}, 4),
    new Polygon( new int[] { 26, 31, 44, 46}, new int[] { 26, 28, 34,36}, 4),
    new Polygon( new int[] { 46, 44, 44, 46}, new int[] { 36, 34, 21,16}, 4),
  };
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 9, 10, 8, 4}, new int[] { 11, 17, 29,30}, 4),
    new Polygon( new int[] { 4, 8, 22, 26}, new int[] { 30, 29, 27,26}, 4),
    new Polygon( new int[] { 26, 22, 10, 9}, new int[] { 26, 27, 17,11}, 4),
    new Polygon( new int[] { 48, 26, 43, 48}, new int[] {22, 26, 41, 22}, 4),
    new Polygon( new int[] { 48, 45, 31, 26}, new int[] { 22, 27, 29,26}, 4),
    new Polygon( new int[] { 26, 31, 42, 43}, new int[] { 26, 29, 38,41}, 4),
    new Polygon( new int[] { 43, 42, 45, 48}, new int[] { 41, 38, 27,22}, 4),
  };
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 14, 7, 4}, new int[] { 7, 11, 26,25}, 4),
    new Polygon( new int[] { 4, 7, 24, 26}, new int[] { 25, 26, 27,26}, 4),
    new Polygon( new int[] { 26, 24, 14, 14}, new int[] { 26, 27, 11,7}, 4),
    new Polygon( new int[] { 48, 26, 38, 48}, new int[] {27, 26, 45, 27}, 4),
    new Polygon( new int[] { 48, 46, 28, 26}, new int[] { 27, 30, 29,26}, 4),
    new Polygon( new int[] { 26, 28, 38, 38}, new int[] { 26, 29, 43,45}, 4),
    new Polygon( new int[] { 38, 38, 46, 48}, new int[] { 45, 43, 30,27}, 4),
  };
  ...
  Shape[] shapes_p4 = new Shape[] { 
    ...
    new Polygon( new int[] { 19, 18, 9, 5}, new int[] { 5, 11, 20,19}, 4),
    new Polygon( new int[] { 5, 9, 23, 26}, new int[] { 19, 20, 25,26}, 4),
    new Polygon( new int[] { 26, 23, 18, 19}, new int[] { 26, 25, 11,5}, 4),
    new Polygon( new int[] { 47, 26, 33, 47}, new int[] {33, 26, 47, 33}, 4),
    new Polygon( new int[] { 47, 43, 29, 26}, new int[] { 33, 35, 31,26}, 4),
    new Polygon( new int[] { 26, 29, 34, 33}, new int[] { 26, 31, 43,47}, 4),
    new Polygon( new int[] { 33, 34, 43, 47}, new int[] { 47, 43, 35,33}, 4),
  };
  ...
  Shape[] shapes_p5 = new Shape[] { 
    ...
    new Polygon( new int[] { 25, 24, 9, 7}, new int[] { 4, 8, 16,14}, 4),
    new Polygon( new int[] { 7, 9, 25, 26}, new int[] { 14, 16, 26,26}, 4),
    new Polygon( new int[] { 26, 25, 24, 25}, new int[] { 26, 26, 8,4}, 4),
    new Polygon( new int[] { 45, 26, 27, 45}, new int[] {38, 26, 48, 38}, 4),
    new Polygon( new int[] { 45, 43, 27, 26}, new int[] { 38, 38, 30,26}, 4),
    new Polygon( new int[] { 26, 27, 28, 27}, new int[] { 26, 30, 46,48}, 4),
  ...
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 30, 27, 15, 11}, new int[] { 4, 9, 12,9}, 4),
    new Polygon( new int[] { 11, 15, 25, 26}, new int[] { 9, 12, 24,26}, 4),
    new Polygon( new int[] { 26, 25, 27, 30}, new int[] { 26, 24, 9,4}, 4),
    new Polygon( new int[] { 41, 26, 22, 41}, new int[] {43, 26, 48, 43}, 4),
    new Polygon( new int[] { 41, 37, 27, 26}, new int[] { 43, 42, 32,26}, 4),
    new Polygon( new int[] { 26, 27, 25, 22}, new int[] { 26, 32, 45,48}, 4),
    new Polygon( new int[] { 22, 25, 37, 41}, new int[] { 48, 45, 42,43}, 4),
  };
  ...
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 36, 33, 19, 16}, new int[] { 6, 10, 10,6}, 4),
    new Polygon( new int[] { 16, 19, 26, 26}, new int[] { 6, 10, 24,26}, 4),
    new Polygon( new int[] { 26, 26, 33, 36}, new int[] { 26, 24, 10,6}, 4),
    new Polygon( new int[] { 36, 26, 16, 36}, new int[] {46, 26, 46, 46}, 4),
    new Polygon( new int[] { 36, 33, 26, 26}, new int[] { 46, 44, 32,26}, 4),
    new Polygon( new int[] { 26, 26, 19, 16}, new int[] { 26, 32, 44,46}, 4),
    new Polygon( new int[] { 16, 19, 33, 36}, new int[] { 46, 44, 44,46}, 4),
  };
  public void paintComponent(Graphics g1) {
    switch ( page) {
      case 2 :
...
protected class pwr_basevalve extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(36, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes[21]);
    ((Arc2D)shapes[21]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[21]);
  ...
  public void paintComponent_p2(Graphics g1) {
    ...
    ((Arc2D)shapes_p2[18]).setArcType(Arc2D.PIE);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p2[20]);
    ((Arc2D)shapes_p2[21]).setArcType(Arc2D.PIE);
    g.setColor(GeColor.getColor(36, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes_p2[21]);
    ((Arc2D)shapes_p2[21]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p2[21]);
  ...
  public void paintComponent_p3(Graphics g1) {
    ...
    ((Arc2D)shapes_p3[18]).setArcType(Arc2D.PIE);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[20]);
    ((Arc2D)shapes_p3[21]).setArcType(Arc2D.PIE);
    g.setColor(GeColor.getColor(36, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes_p3[21]);
    ((Arc2D)shapes_p3[21]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[21]);
