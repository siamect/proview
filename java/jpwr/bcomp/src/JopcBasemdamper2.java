...
public class JopcBasemdamper2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp196_	grp196_44;
  pwr_damperanim2	pwr_damperanim247;
  pwr_mdamper	pwr_mdamper48;
  pwr_mbup	pwr_mbup49;
  public JopcBasemdamper2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemdamper2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemdamper2");
    ...
    pwr_indsquare27.setBounds(new Rectangle(167,189,14,15));
    ...
    pwr_indsquare35.setBounds(new Rectangle(167,222,14,15));
    ...
    pwr_smallbuttoncenter36.setBounds(new Rectangle(160,341,54,19));
    ...
    pwr_smallbuttoncenter37.setBounds(new Rectangle(160,317,54,19));
    ...
    pwr_indsquare42.setBounds(new Rectangle(167,242,14,15));
    ...
    pwr_indround43.setBounds(new Rectangle(97,363,16,16));
    ...
    grp196_44.setBounds(new Rectangle(40,364,35,16));
    localPanel.add(grp196_44, new Proportion(grp196_44.getBounds(), dsize));
    pwr_damperanim247 = new pwr_damperanim2(session);
    pwr_damperanim247.setBounds(new Rectangle(123,119,63,44));
    pwr_damperanim247.setFillColor(74);
    pwr_damperanim247.setShadow(1);
    localPanel.add(pwr_damperanim247, new Proportion(pwr_damperanim247.getBounds(), dsize));
    pwr_mdamper48 = new pwr_mdamper(session);
    pwr_mdamper48.setBounds(new Rectangle(319,177,145,145));
    localPanel.add(pwr_mdamper48, new Proportion(pwr_mdamper48.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_damperanim247.dd.setDynType(66572);
    pwr_damperanim247.dd.setActionType(0);
    pwr_damperanim247.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_damperanim247.dd, "$object.IndError##Boolean",176)
      ,new GeDynDigColor(pwr_damperanim247.dd, "$object.IndWarning##Boolean",114)
      ,new GeDynDigLowColor(pwr_damperanim247.dd, "!$object.SwitchClosed.ActualValue##Boolean",41)
      ,new GeDynValue(pwr_damperanim247.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_damperanim247.dd, "$object.SwitchClosed.ActualValue##Boolean",2)
      });
    pwr_mdamper48.dd.setDynType(1);
    pwr_mdamper48.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(3.37529F, 23.1001F, 525.817F, 22.4305F),
    ...
    new Rectangle2D.Float(64.5597F, 145.617F, 62.8699F, 3.889F),
    new Polygon( new int[] { 65, 127, 126, 66, 66, 65}, new int[] { 146, 146, 147, 147, 149, 150}, 6), 
    new Polygon( new int[] { 127, 127, 126, 126, 66, 65}, new int[] { 150, 146, 147, 149, 149, 150}, 6), 
    new Rectangle2D.Float(152.568F, 145.617F, 58.6076F, 3.889F),
    new Polygon( new int[] { 153, 211, 210, 154, 154, 153}, new int[] { 146, 146, 147, 147, 149, 150}, 6), 
    new Polygon( new int[] { 211, 211, 210, 210, 154, 153}, new int[] { 150, 146, 147, 149, 149, 150}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 3.37529F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        3.37529F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
...
protected class pwr_mdamper extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 40, 43, 43, 40}, new int[] { 28, 29, 24,22}, 4),
    new Polygon( new int[] { 40, 43, 53, 52}, new int[] { 22, 24, 24,22}, 4),
    new Polygon( new int[] { 52, 53, 53, 52}, new int[] { 22, 24, 29,28}, 4),
    new Polygon( new int[] { 52, 53, 61, 60}, new int[] { 28, 29, 29,28}, 4),
    ...
    new Polygon( new int[] { 2, 5, -1219915314, 61}, new int[] { 28, 29, -1219915351,24}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
