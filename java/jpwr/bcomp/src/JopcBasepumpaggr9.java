...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),72, 328);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Overload relay"),72, 360);
    {
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 75, 42}, new int[] { 40, 36, -1219980912,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980869, 42}, new int[] { 10, 12, -1219980912,0}, 4),
    ...
    new Polygon( new int[] { 6, 11, 42, 42}, new int[] { 14, 17, 72,-2147483648}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980851, 60}, new int[] { 12, 15, -1219980882,29}, 4),
