...
public class JopcBasepumpaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(94,411,82,72));
    ...
    pwr_indsquare8.setBounds(new Rectangle(186,317,14,15));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,512,45,19));
    ...
    pwr_valuelong32.setBounds(new Rectangle(61,511,334,21));
    ...
    pwr_motor244.setBounds(new Rectangle(174,411,96,72));
    ...
    pwr_indsquare53.setBounds(new Rectangle(186,371,14,15));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(170,436,10,20));
    ...
    grp185_60.setBounds(new Rectangle(31,194,39,16));
    ...
    pwr_contactor263.setBounds(new Rectangle(249,308,36,36));
    ...
    pwr_overloadrelay64.setBounds(new Rectangle(249,343,36,25));
    ...
    pwr_mbup65.setBounds(new Rectangle(345,25,17,18));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 307, 42}, new int[] { 40, 36, -1219915376,0}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915333, 42}, new int[] { 10, 12, -1219915376,0}, 4),
    ...
    new Polygon( new int[] { 6, 11, -1219915333, 42}, new int[] { 14, 17, -1219915376,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915315, 60}, new int[] { 12, 15, -1219915346,29}, 4),
