...
public class JopcBasepumpaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump31.setBounds(new Rectangle(93,410,84,74));
    ...
    pwr_overloadrelay3.setBounds(new Rectangle(248,342,38,27));
    ...
    jopSmallbutton52.setBounds(new Rectangle(115,169,61,21));
    ...
    pwr_indsquare54.setBounds(new Rectangle(185,370,16,17));
    ...
    grp173_55.setBounds(new Rectangle(69,370,38,18));
    localPanel.add(grp173_55, new Proportion(grp173_55.getBounds(), dsize));
    pwr_indsquare56 = new pwr_indsquare(session);
    pwr_indsquare56.setBounds(new Rectangle(185,348,16,16));
    pwr_indsquare56.setShadow(1);
    localPanel.add(pwr_indsquare56, new Proportion(pwr_indsquare56.getBounds(), dsize));
    pwr_fuse358 = new pwr_fuse3(session);
    pwr_fuse358.setBounds(new Rectangle(259,262,15,37));
    pwr_fuse358.setRotate(-90);
    pwr_fuse358.setShadow(1);
    localPanel.add(pwr_fuse358, new Proportion(pwr_fuse358.getBounds(), dsize));
    pwr_rodcouplinganim59 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim59.setBounds(new Rectangle(169,435,12,22));
    ...
    grp185_61 = new Grp185_(session);
    grp185_61.setBounds(new Rectangle(30,193,43,18));
    localPanel.add(grp185_61, new Proportion(grp185_61.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu42.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu42.dd, "open graph /class /inst=$object.Contactor.Order")
      }),
    new GeDyn(pwr_pulldownmenu42,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu42.dd, "$object.Contactor.DisableFeedback##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu42.dd, "open graph /class /inst=$object.Contactor.Feedback")
      }),
    new GeDyn(pwr_pulldownmenu42,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu42.dd, "open graph /class /inst=$object.OverloadRelay.Overload")
      }),
null,    new GeDyn(pwr_pulldownmenu42,129,65,33619967,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu44.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.Contactor")
      }),
    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu44.dd, "open graph /class /inst=$object.OverloadRelay")
      }),
null,    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse358.dd.setDynType(1);
    pwr_fuse358.dd.setActionType(0);
    ...
    grp185_61.dd.setDynType(129);
    grp185_61.dd.setActionType(0);
    grp185_61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp185_61.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 11, 42, 44}, new int[] { 14, 13, 13,14}, 4),
    new Polygon( new int[] { 44, 42, 42, 44}, new int[] { 14, 13, 9,10}, 4),
    new Polygon( new int[] { 44, 42, 67, 64}, new int[] { 10, 9, 9,10}, 4),
