...
public class JopcBasevalveincrdecrsim extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter2.setBounds(new Rectangle(212,152,37,20));
    ...
    pwr_indsquare3.setBounds(new Rectangle(179,154,15,16));
    ...
    pwr_valueinputmediumrd5.setBounds(new Rectangle(299,147,69,29));
    ...
    pwr_sliderbackground26.setBounds(new Rectangle(25,191,380,43));
    ...
    pwr_slider27.setBounds(new Rectangle(78,197,23,15));
    ...
    pwr_menubar29.setBounds(new Rectangle(9,0,417,23));
    ...
    pwr_pulldownmenu210.setBounds(new Rectangle(20,0,68,23));
    ...
    pwr_pulldownmenu211.setBounds(new Rectangle(343,0,68,23));
    ...
    pwr_mbopenobject12.setBounds(new Rectangle(36,24,19,19));
    ...
    pwr_mbopenplc13.setBounds(new Rectangle(56,24,19,19));
    ...
    pwr_mbrtnavigator14.setBounds(new Rectangle(17,24,19,19));
    ...
    pwr_mbhelpclass15.setBounds(new Rectangle(76,24,19,19));
    ...
    pwr_pulldownmenu216.setBounds(new Rectangle(78,0,68,23));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(212,99,37,20));
    ...
    pwr_indsquare19.setBounds(new Rectangle(179,101,15,16));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(212,124,37,20));
    ...
    pwr_indsquare22.setBounds(new Rectangle(179,126,15,16));
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(326,99,37,20));
    ...
    pwr_indsquare26.setBounds(new Rectangle(298,101,15,16));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(326,124,37,20));
    ...
    pwr_indsquare29.setBounds(new Rectangle(298,126,15,16));
    ...
    pwr_slider27.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider27.dd, "$object.ManPositionValue##Float32",0,100,1,35.6604,372.453,null,null,
null)
      });
