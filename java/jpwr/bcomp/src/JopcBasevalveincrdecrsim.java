...
public class JopcBasevalveincrdecrsim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valueinputmediumrd	pwr_valueinputmediumrd5;
  pwr_sliderbackground2	pwr_sliderbackground26;
  pwr_slider2	pwr_slider27;
  JopAxis	jopAxis8;
  pwr_menubar2	pwr_menubar29;
  pwr_pulldownmenu2	pwr_pulldownmenu210;
  pwr_pulldownmenu2	pwr_pulldownmenu211;
  ...
  pwr_pulldownmenu2	pwr_pulldownmenu216;
  ...
  public JopcBasevalveincrdecrsim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasevalveincrdecrsim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasevalveincrdecrsim");
    pwr_smallbuttoncenter2 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter2.setBounds(new Rectangle(213,153,35,18));
    ...
    pwr_indsquare3.setBounds(new Rectangle(180,155,13,14));
    pwr_indsquare3.setShadow(1);
    localPanel.add(pwr_indsquare3, new Proportion(pwr_indsquare3.getBounds(), dsize));
    pwr_valueinputmediumrd5 = new pwr_valueinputmediumrd(session);
    pwr_valueinputmediumrd5.setBounds(new Rectangle(300,148,67,27));
    pwr_valueinputmediumrd5.setColorTone(16);
    pwr_valueinputmediumrd5.setColorBrightness(-5);
    pwr_valueinputmediumrd5.setShadow(1);
    localPanel.add(pwr_valueinputmediumrd5, new Proportion(pwr_valueinputmediumrd5.getBounds(), dsize));
    pwr_sliderbackground26 = new pwr_sliderbackground2(session);
    pwr_sliderbackground26.setBounds(new Rectangle(26,192,378,41));
    pwr_sliderbackground26.setRotate(-90);
    pwr_sliderbackground26.setShadow(1);
    localPanel.add(pwr_sliderbackground26, new Proportion(pwr_sliderbackground26.getBounds(), dsize));
    pwr_slider27 = new pwr_slider2(session);
    pwr_slider27.setBounds(new Rectangle(79,198,21,13));
    pwr_slider27.setRotate(-90);
    pwr_slider27.setShadow(1);
    localPanel.add(pwr_slider27, new Proportion(pwr_slider27.getBounds(), dsize));
    jopAxis8 = new JopAxis();
    jopAxis8.setBounds(new Rectangle(47,211,336,16));
    jopAxis8.setBorderColor(0);
    jopAxis8.setTextColor(0);
    jopAxis8.setLineWidth(1);
    jopAxis8.setMinValue(0F);
    jopAxis8.setMaxValue(100F);
    jopAxis8.setLines(51);
    jopAxis8.setLongQuotient(5);
    jopAxis8.setValueQuotient(5);
    jopAxis8.setLineLength(7);
    jopAxis8.setLineWidth(1);
    jopAxis8.setRotate(270);
    jopAxis8.setFont(new Font("Helvetica", Font.PLAIN, 8));
    jopAxis8.setFormat("%3.0f");
    localPanel.add(jopAxis8, new Proportion(jopAxis8.getBounds(), dsize));
    pwr_menubar29 = new pwr_menubar2(session);
    pwr_menubar29.setBounds(new Rectangle(10,0,415,21));
    pwr_menubar29.setShadow(1);
    localPanel.add(pwr_menubar29, new Proportion(pwr_menubar29.getBounds(), dsize));
    pwr_pulldownmenu210 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu210.setBounds(new Rectangle(21,0,66,21));
    pwr_pulldownmenu210.setShadow(1);
    localPanel.add(pwr_pulldownmenu210, new Proportion(pwr_pulldownmenu210.getBounds(), dsize));
    pwr_pulldownmenu211 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu211.setBounds(new Rectangle(344,0,66,21));
    pwr_pulldownmenu211.setShadow(1);
    localPanel.add(pwr_pulldownmenu211, new Proportion(pwr_pulldownmenu211.getBounds(), dsize));
    pwr_mbopenobject12 = new pwr_mbopenobject(session);
    pwr_mbopenobject12.setBounds(new Rectangle(37,25,17,17));
    ...
    pwr_mbopenplc13.setBounds(new Rectangle(57,25,17,17));
    ...
    pwr_mbrtnavigator14.setBounds(new Rectangle(18,25,17,17));
    ...
    pwr_mbhelpclass15.setBounds(new Rectangle(77,25,17,17));
    pwr_mbhelpclass15.setShadow(1);
    localPanel.add(pwr_mbhelpclass15, new Proportion(pwr_mbhelpclass15.getBounds(), dsize));
    pwr_pulldownmenu216 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu216.setBounds(new Rectangle(79,0,66,21));
    pwr_pulldownmenu216.setShadow(1);
    localPanel.add(pwr_pulldownmenu216, new Proportion(pwr_pulldownmenu216.getBounds(), dsize));
    pwr_smallbuttoncenter18 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter18.setBounds(new Rectangle(213,100,35,18));
    ...
    pwr_indsquare19.setBounds(new Rectangle(180,102,13,14));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(213,125,35,18));
    ...
    pwr_indsquare22.setBounds(new Rectangle(180,127,13,14));
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(327,100,35,18));
    ...
    pwr_indsquare26.setBounds(new Rectangle(299,102,13,14));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(327,125,35,18));
    ...
    pwr_indsquare29.setBounds(new Rectangle(299,127,13,14));
    ...
    pwr_smallbuttoncenter2.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter2.dd, "$object.ManPosition##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter2.dd, "Manual control of position")
      });
    pwr_indsquare3.dd.setDynType(5);
    pwr_indsquare3.dd.setActionType(0);
    pwr_indsquare3.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare3.dd, "$object.ManPosition##Boolean",29)
      });
    pwr_valueinputmediumrd5.dd.setDynType(1025);
    pwr_valueinputmediumrd5.dd.setActionType(4096);
    pwr_valueinputmediumrd5.dd.setAccess(65532);
    pwr_valueinputmediumrd5.dd.setElements(new GeDynElemIfc[] {
    ...
    pwr_slider27.dd.setActionType(2048);
    pwr_slider27.dd.setAccess(65532);
    pwr_slider27.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider27.dd, "$object.ManPositionValue##Float32",0,100,1,37.6604,374.453,null,null,null,420,263.491)
      });
    pwr_menubar29.dd.setDynType(1);
    pwr_menubar29.dd.setActionType(0);
    pwr_pulldownmenu210.dd.setDynType(0);
    pwr_pulldownmenu210.dd.setActionType(524288);
    pwr_pulldownmenu210.dd.setAccess(65535);
    pwr_pulldownmenu210.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu210.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu210,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu210.dd, "print graph/class/inst=$object")
      }),
    new GeDyn(pwr_pulldownmenu210,1,262145,65535,new GeDynElemIfc[] {
      new GeDynCloseGraph(pwr_pulldownmenu210.dd)
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu210.setAnnot1("File");
    pwr_pulldownmenu211.dd.setDynType(1);
    pwr_pulldownmenu211.dd.setActionType(524288);
    pwr_pulldownmenu211.dd.setAccess(65535);
    pwr_pulldownmenu211.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu211.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu211,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu211.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu211.setAnnot1("Help");
    ...
    pwr_pulldownmenu216.dd.setDynType(1);
    pwr_pulldownmenu216.dd.setActionType(524288);
    pwr_pulldownmenu216.dd.setAccess(65535);
    pwr_pulldownmenu216.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu216.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu216,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu216.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu216.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu216,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu216.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu216.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu216,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu216.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu216.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu216,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu216.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu216.dd, "call method/method=\"Fast\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu216.setAnnot1("Methods");
    ...
    pwr_smallbuttoncenter18.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter18.dd, "$object.ManSwitchOpen##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter18.dd, "Manual control of SwitchOpen")
      });
    pwr_indsquare19.dd.setDynType(5);
    pwr_indsquare19.dd.setActionType(0);
    pwr_indsquare19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare19.dd, "$object.ManSwitchOpen##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter21.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter21.dd, "$object.ManSwitchClosed##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter21.dd, "Manual control of SwitchClosed")
      });
    pwr_indsquare22.dd.setDynType(5);
    pwr_indsquare22.dd.setActionType(0);
    pwr_indsquare22.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare22.dd, "$object.ManSwitchClosed##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter24.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter24.dd, "$object.ManSwitchOpenValue##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter24.dd, "Toggle manual value")
      });
    pwr_indsquare26.dd.setDynType(5);
    pwr_indsquare26.dd.setActionType(0);
    pwr_indsquare26.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare26.dd, "$object.ManSwitchOpenValue##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter27.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter27.dd, "$object.ManSwitchClosedValue##Boolean")
    ...
    pwr_indsquare29.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare29.dd, "$object.ManSwitchClosedValue##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(17.8491F, 70.3285F, 402.589F, 184.477F),
    new Polygon( new int[] { 18, 420, 419, 20, 20, 18}, new int[] { 70, 70, 72, 72, 253, 255}, 6), 
    new Polygon( new int[] { 420, 420, 419, 419, 20, 18}, new int[] { 255, 70, 72, 253, 253, 255}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseValveIncrDecr",18, 60);
    g.setColor(GeColor.getColor(3, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
