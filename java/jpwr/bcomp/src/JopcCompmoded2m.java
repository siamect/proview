...
public class JopcCompmoded2m extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcCompmoded2m( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcCompmoded2m( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcCompmoded2m");
    pwr_menubar2 = new pwr_menubar(session);
    pwr_menubar2.setBounds(new Rectangle(0,0,275,24));
    ...
    pwr_pulldownmenu4.setBounds(new Rectangle(198,0,69,24));
    ...
    pwr_mbopenobject5.setBounds(new Rectangle(187,24,20,20));
    ...
    pwr_mbtrend6.setBounds(new Rectangle(48,24,20,20));
    ...
    pwr_mbfast7.setBounds(new Rectangle(68,24,20,20));
    ...
    pwr_mbphoto8.setBounds(new Rectangle(88,24,19,20));
    ...
    pwr_mbdatasheet9.setBounds(new Rectangle(108,24,20,20));
    ...
    pwr_mbopenplc10.setBounds(new Rectangle(207,24,20,20));
    ...
    pwr_mbcircuitdiagram11.setBounds(new Rectangle(227,24,20,20));
    ...
    pwr_mbrtnavigator12.setBounds(new Rectangle(167,24,20,20));
    ...
    pwr_mbhelpclass13.setBounds(new Rectangle(247,24,20,20));
    ...
    pwr_mbblockevents14.setBounds(new Rectangle(147,24,20,20));
    ...
    jopSmallbutton19.setBounds(new Rectangle(25,115,48,21));
    jopSmallbutton19.setFillColor(32);
    localPanel.add(jopSmallbutton19, new Proportion(jopSmallbutton19.getBounds(), dsize));
    pwr_indround20 = new pwr_indround(session);
    pwr_indround20.setBounds(new Rectangle(87,94,18,18));
    ...
    pwr_indround21.setBounds(new Rectangle(87,116,18,17));
    ...
    jopSmallbutton23.setBounds(new Rectangle(25,93,48,20));
    jopSmallbutton23.setFillColor(32);
    ...
    jopSmallbutton24.setBounds(new Rectangle(137,115,63,21));
    jopSmallbutton24.setFillColor(32);
    ...
    jopSmallbutton25.setBounds(new Rectangle(137,91,63,21));
    ...
    pwr_indround27.setBounds(new Rectangle(212,94,18,18));
    ...
    pwr_indround28.setBounds(new Rectangle(212,116,18,17));
    ...
    jopSmallbutton29.setBounds(new Rectangle(137,141,63,21));
    ...
    jopSmallbutton30.setBounds(new Rectangle(137,91,63,21));
    ...
    jopSmallbutton31.setBounds(new Rectangle(137,115,63,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu18.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu18.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu18,129,65,65535,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu18,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu18.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu18.dd, "call method/method=\"Help Class\"/object=$object")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu18.setAnnot1("Methods");
    jopSmallbutton19.dd.setDynType(129);
    jopSmallbutton19.dd.setActionType(4);
    jopSmallbutton19.dd.setAccess(65532);
    jopSmallbutton19.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton19.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton19.dd, "$object.OpAuto##Boolean")
      });
    jopSmallbutton19.setAnnot1(" Auto");
    ...
    jopSmallbutton23.dd.setDynType(128);
    jopSmallbutton23.dd.setActionType(4);
    jopSmallbutton23.dd.setAccess(65532);
    jopSmallbutton23.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton23.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton23.dd, "$object.OpMan##Boolean")
      });
    jopSmallbutton23.setAnnot1(" Man");
    jopSmallbutton24.dd.setDynType(129);
    jopSmallbutton24.dd.setActionType(16);
    jopSmallbutton24.dd.setAccess(65532);
    jopSmallbutton24.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton24.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton24.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton24.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynToggleDig(jopSmallbutton24.dd, "$object.OpOrderManDecr##Boolean")
      });
    jopSmallbutton24.setAnnot1("  Decr");
    jopSmallbutton25.dd.setDynType(128);
    jopSmallbutton25.dd.setActionType(16);
    jopSmallbutton25.dd.setAccess(65532);
    jopSmallbutton25.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton25.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton25.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton25.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynToggleDig(jopSmallbutton25.dd, "$object.OpOrderManIncr##Boolean")
      });
    jopSmallbutton25.setAnnot1("  Incr");
    ...
    pwr_indround27.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround27.dd, "$object.OpOrderManIncr##Boolean",29)
      });
    ...
    pwr_indround28.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround28.dd, "$object.OpOrderManDecr##Boolean",29)
      });
    ...
    jopSmallbutton29.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton29.dd, "$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton29.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton29.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynSetDig(jopSmallbutton29.dd, "$object.OpOrderManStop##Boolean")
      });
    jopSmallbutton29.setAnnot1("  Stop");
    jopSmallbutton30.dd.setDynType(128);
    jopSmallbutton30.dd.setActionType(32);
    jopSmallbutton30.dd.setAccess(65532);
    jopSmallbutton30.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton30.dd, "!$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton30.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton30.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynStoDig(jopSmallbutton30.dd, "$object.OpOrderManIncr##Boolean")
      });
    jopSmallbutton30.setAnnot1("  Incr");
    jopSmallbutton31.dd.setDynType(129);
    jopSmallbutton31.dd.setActionType(32);
    jopSmallbutton31.dd.setAccess(65532);
    jopSmallbutton31.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton31.dd, "!$object.OpNoStopButton##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton31.dd, "$object.OpAutoOnly##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton31.dd, "!$object.ManMode##Boolean",1)
      ,new GeDynStoDig(jopSmallbutton31.dd, "$object.OpOrderManDecr##Boolean")
      });
    jopSmallbutton31.setAnnot1("  Decr");
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 275;
  public int original_height = 183;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Line2D.Float( 265.119F, 79.042F, 9.44584F, 79.042F),
    new Rectangle2D.Float(8.99995F, 54.1389F, 259.39F, 127.638F),
    new Polygon( new int[] { 9, 268, 267, 10, 10, 9}, new int[] { 54, 54, 55, 55, 181, 182}, 6), 
    new Polygon( new int[] { 268, 268, 267, 267, 10, 9}, new int[] { 182, 54, 55, 181, 181, 182}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Mode",29, 74);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Man",139, 74);
    g.setTransform(save);
  }
...
protected class pwr_directvalve__p2 extends GeComponent {
  // Dimension size;
  public pwr_directvalve__p2( JopSession session)
  {
    super( session);
