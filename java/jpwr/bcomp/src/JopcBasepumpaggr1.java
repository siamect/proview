...
public class JopcBasepumpaggr1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(91,417,84,74));
    ...
    pwr_indsquare12.setBounds(new Rectangle(185,353,16,16));
    ...
    pwr_motor247.setBounds(new Rectangle(173,417,98,73));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,379,16,16));
    ...
    grp173_57.setBounds(new Rectangle(69,379,40,18));
    ...
    grp179_60.setBounds(new Rectangle(30,193,41,18));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 1018, 25}, new int[] { 40, 36, -1219980923,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219980886, 25}, new int[] { 10, 12, -1219980923,-11}, 4),
    ...
    new Polygon( new int[] { 6, 11, 140886273, 25}, new int[] { 14, 17, 144132668,-11}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980868, 43}, new int[] { 12, 15, -1219980893,18}, 4),
