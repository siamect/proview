...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 5, 11, 25}, new int[] { 8, 8, 11,-11}, 4),
    ...
    new Polygon( new int[] { 6, 9, 25, 25}, new int[] { 40, 36, -11,-11}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219706454, 25}, new int[] { 10, 12, -1219706491,-11}, 4),
    ...
    new Polygon( new int[] { 6, 11, 140885729, 25}, new int[] { 14, 17, 144132300,-11}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706436, 43}, new int[] { 12, 15, -1219706461,18}, 4),
