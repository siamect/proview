...
public class JopcBasemotoraggr9 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_fuse3	pwr_fuse356;
  pwr_motorman	pwr_motorman57;
  pwr_rodcouplinganim	pwr_rodcouplinganim58;
  Grp183_	grp183_59;
  JopSmallbutton	jopSmallbutton60;
  public JopcBasemotoraggr9( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr9( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr9");
    ...
    pwr_indsquare6.setBounds(new Rectangle(185,316,16,17));
    ...
    jopSmallbutton29.setBounds(new Rectangle(4,511,47,21));
    ...
    pwr_valuelong30.setBounds(new Rectangle(60,510,336,23));
    ...
    pwr_contactor234.setBounds(new Rectangle(248,307,38,38));
    ...
    pwr_motor243.setBounds(new Rectangle(173,410,98,74));
    ...
    pwr_valuesmall45.setBounds(new Rectangle(282,196,71,18));
    ...
    pwr_indsquare52.setBounds(new Rectangle(185,370,16,17));
    ...
    grp173_53.setBounds(new Rectangle(69,370,38,18));
    localPanel.add(grp173_53, new Proportion(grp173_53.getBounds(), dsize));
    pwr_indsquare54 = new pwr_indsquare(session);
    pwr_indsquare54.setBounds(new Rectangle(185,348,16,16));
    pwr_indsquare54.setShadow(1);
    localPanel.add(pwr_indsquare54, new Proportion(pwr_indsquare54.getBounds(), dsize));
    pwr_fuse356 = new pwr_fuse3(session);
    pwr_fuse356.setBounds(new Rectangle(259,262,15,37));
    pwr_fuse356.setRotate(-90);
    pwr_fuse356.setShadow(1);
    localPanel.add(pwr_fuse356, new Proportion(pwr_fuse356.getBounds(), dsize));
    ...
    grp183_59.setBounds(new Rectangle(30,193,43,18));
    ...
    pwr_contactor234.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor234.dd, "$object.Contactor.IndFeedback##Boolean")
...
null,    new GeDyn(pwr_pulldownmenu40,129,65,33619967,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse356.dd.setDynType(1);
    pwr_fuse356.dd.setActionType(0);
