...
public class JopcBasemotoraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay4.setBounds(new Rectangle(249,343,36,25));
    ...
    pwr_contactor236.setBounds(new Rectangle(249,308,36,36));
    ...
    pwr_motor245.setBounds(new Rectangle(174,411,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(186,371,14,15));
    ...
    pwr_fuse358.setBounds(new Rectangle(260,263,13,35));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(170,436,10,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 149007516, 12}, new int[] { 12, 15, 144033816,40}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 149545420, 12}, new int[] { 12, 15, 144033816,40}, 4),
