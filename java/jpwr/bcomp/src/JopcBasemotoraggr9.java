...
public class JopcBasemotoraggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay4.setBounds(new Rectangle(248,342,38,27));
    pwr_overloadrelay4.setFillColor(32);
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(116,169,61,21));
    ...
    grp173_55.setBounds(new Rectangle(69,370,40,18));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(169,435,12,22));
    ...
    pwr_mbup63.setBounds(new Rectangle(344,24,19,20));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 150649812, 12}, new int[] { 12, 15, 144032840,40}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 150609540, 12}, new int[] { 12, 15, 144032840,40}, 4),
