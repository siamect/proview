...
public class JopcBasemotorincrdecraggr43 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup73;
  public JopcBasemotorincrdecraggr43( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr43( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr43");
    ...
    pwr_smallbuttoncenter68.setBounds(new Rectangle(154,169,62,21));
    ...
    pwr_smallbuttoncenter69.setBounds(new Rectangle(154,193,62,21));
    ...
    pwr_smallbuttoncenter70.setBounds(new Rectangle(154,216,62,21));
    ...
    pwr_smallbuttoncenter71.setBounds(new Rectangle(154,193,62,21));
    ...
    pwr_smallbuttoncenter72.setBounds(new Rectangle(154,169,62,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter68.setAnnot1("Open ");
    ...
    pwr_smallbuttoncenter69.setAnnot1("Close");
    ...
    pwr_smallbuttoncenter71.setAnnot1("Close");
    ...
    pwr_smallbuttoncenter72.setAnnot1("Open ");
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 152034661, -18}, new int[] { 146, 147, 144032799,0}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Close"),177, 317);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Open "),113, 317);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Close"),165, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Open "),165, 184);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 152034735, 55}, new int[] { 12, 15, 144032853,53}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140856127, 55}, new int[] { 12, 15, 151615237,53}, 4),
