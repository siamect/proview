...
public class JopcBaseoverloadrelay extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare2.setBounds(new Rectangle(137,109,15,16));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(15,221,47,20));
    ...
    pwr_valuelong20.setBounds(new Rectangle(72,221,333,22));
    ...
    pwr_menubar221.setBounds(new Rectangle(0,-5,406,23));
    ...
    pwr_pulldownmenu222.setBounds(new Rectangle(9,-5,69,23));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(324,-5,69,23));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(148,-5,69,23));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(67,-5,69,23));
    ...
    pwr_mbsimulate26.setBounds(new Rectangle(370,18,19,19));
    ...
    pwr_overloadrelay27.setBounds(new Rectangle(249,115,97,66));
    ...
    pwr_overloadrelay228.setBounds(new Rectangle(82,136,27,33));
    ...
    pwr_indsquare34.setBounds(new Rectangle(137,198,15,16));
    ...
    pwr_mbup35.setBounds(new Rectangle(350,18,19,19));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu224.dd, new String[] {
        "Overload Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Supervision disabled",33, 211);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[20]);
