...
public class JopcBasedamper extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_basedamper	pwr_basedamper22;
  pwr_mbup	pwr_mbup23;
  public JopcBasedamper( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasedamper( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_menubar22.setBounds(new Rectangle(0,0,408,24));
    ...
    pwr_pulldownmenu23.setBounds(new Rectangle(10,0,69,24));
    ...
    pwr_pulldownmenu24.setBounds(new Rectangle(328,0,69,24));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(17,316,48,21));
    ...
    pwr_valuelong20.setBounds(new Rectangle(74,315,336,23));
    ...
    pwr_basedamper22 = new pwr_basedamper(session);
    pwr_basedamper22.setBounds(new Rectangle(109,119,141,158));
    localPanel.add(pwr_basedamper22, new Proportion(pwr_basedamper22.getBounds(), dsize));
    pwr_mbup23 = new pwr_mbup(session);
    pwr_mbup23.setBounds(new Rectangle(381,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_basedamper22.dd.setDynType(1);
    pwr_basedamper22.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.37538F, 23.1001F, 404.724F, 22.4305F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.37538F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.37538F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    g.setTransform(save);
