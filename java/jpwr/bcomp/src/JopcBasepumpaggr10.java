...
public class JopcBasepumpaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(95,431,82,72));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(5,527,46,19));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(170,456,10,20));
    ...
    grp186_60.setBounds(new Rectangle(31,194,38,16));
    ...
    pwr_contactor264.setBounds(new Rectangle(249,309,36,36));
    ...
    pwr_safetyswitch65.setBounds(new Rectangle(249,355,36,37));
    ...
    pwr_mbup66.setBounds(new Rectangle(345,25,18,18));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1219915512, -136}, new int[] { 10, 14, -1219915348,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893183, -136}, new int[] { 14, 19, 144126451,27}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -118, -118}, new int[] { 12, 15, 85995447,57}, 4),
