...
public class JopcBasepumpaggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump31.setBounds(new Rectangle(94,430,84,74));
    ...
    jopSmallbutton12.setBounds(new Rectangle(28,168,47,21));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,390,16,17));
    ...
    grp186_61 = new Grp186_(session);
    grp186_61.setBounds(new Rectangle(30,193,42,18));
    localPanel.add(grp186_61, new Proportion(grp186_61.getBounds(), dsize));
    jopSmallbutton62 = new JopSmallbutton(session);
    jopSmallbutton62.setBounds(new Rectangle(28,191,47,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp186_61.dd.setDynType(129);
    grp186_61.dd.setActionType(0);
    grp186_61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp186_61.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 11, 43, 44}, new int[] { 14, 11, 11,14}, 4),
    new Polygon( new int[] { 44, 43, 43, 44}, new int[] { 14, 11, 7,10}, 4),
    new Polygon( new int[] { 44, 43, 67, 64}, new int[] { 10, 7, 7,10}, 4),
    new Polygon( new int[] { 64, 67, 67, 64}, new int[] { 10, 7, 52,52}, 4),
    new Polygon( new int[] { 64, 67, 65, 62}, new int[] { 52, 52, 60,58}, 4),
    new Polygon( new int[] { 62, 65, 58, 56}, new int[] { 58, 60, 65,62}, 4),
    new Polygon( new int[] { 56, 58, 15, 14}, new int[] { 62, 65, 65,62}, 4),
    ...
    new Polygon( new int[] { 14, 16, 45, 44}, new int[] { 14, 15, 15,14}, 4),
    new Polygon( new int[] { 44, 45, 47, 46}, new int[] { 14, 15, 23,24}, 4),
    new Polygon( new int[] { 46, 47, 20, 18}, new int[] { 24, 23, 23,24}, 4),
    ...
    new Polygon( new int[] { 18, 20, 55, 52}, new int[] { 52, 55, 55,52}, 4),
    new Polygon( new int[] { 52, 55, 60, 56}, new int[] { 52, 55, 49,48}, 4),
    new Polygon( new int[] { 56, 60, 61, 58}, new int[] { 48, 49, 38,38}, 4),
    ...
    new Polygon( new int[] { 62, 59, 57, 56}, new int[] { 58, 56, 59,62}, 4),
    new Polygon( new int[] { 56, 57, 17, 14}, new int[] { 62, 59, 59,62}, 4),
    ...
    new Polygon( new int[] { 54, 58, 58, 54}, new int[] { 10, 12, 38,38}, 4),
    new Polygon( new int[] { 54, 58, 56, 52}, new int[] { 38, 38, 45,44}, 4),
    new Polygon( new int[] { 52, 56, 53, 50}, new int[] { 44, 45, 48,46}, 4),
    new Polygon( new int[] { 50, 53, 20, 18}, new int[] { 46, 48, 48,46}, 4),
    ...
    new Polygon( new int[] { 18, 20, 53, 52}, new int[] { 52, 50, 50,52}, 4),
    new Polygon( new int[] { 52, 53, 56, 56}, new int[] { 52, 50, 47,48}, 4),
    new Polygon( new int[] { 56, 56, 57, 58}, new int[] { 48, 47, 38,38}, 4),
    new Polygon( new int[] { 58, 57, 57, 58}, new int[] { 38, 38, 12,10}, 4),
    new Polygon( new int[] { 58, 57, 58, 54}, new int[] { 10, 12, 12,10}, 4),
    new Polygon( new int[] { 6, 44, 44, 64, 64, 62, 56, 14, 8, 6, 6}, new int[] {14, 14, 10, 10, 52, 58, 62, 62, 58, 52, 14}, 11),
    new Polygon( new int[] { 6, 11, 49, 44}, new int[] { 14, 17, 17,14}, 4),
    new Polygon( new int[] { 44, 49, 49, 44}, new int[] { 14, 17, 13,10}, 4),
    new Polygon( new int[] { 44, 49, 61, 64}, new int[] { 10, 13, 13,10}, 4),
    new Polygon( new int[] { 64, 61, 61, 64}, new int[] { 10, 13, 52,52}, 4),
    new Polygon( new int[] { 64, 61, 59, 62}, new int[] { 52, 52, 56,58}, 4),
    new Polygon( new int[] { 62, 59, 57, 56}, new int[] { 58, 56, 59,62}, 4),
    new Polygon( new int[] { 56, 57, 17, 14}, new int[] { 62, 59, 59,62}, 4),
