...
public class JopcBasepumpaggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup66;
  public JopcBasepumpaggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasepumpaggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasepumpaggr10");
    pwr_pump32 = new pwr_pump3(session);
    pwr_pump32.setBounds(new Rectangle(94,430,84,74));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,526,48,21));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(169,455,12,22));
    ...
    pwr_pumpanim259.setBounds(new Rectangle(102,95,64,44));
    ...
    grp186_60 = new Grp186_(session);
    grp186_60.setBounds(new Rectangle(30,193,40,18));
    localPanel.add(grp186_60, new Proportion(grp186_60.getBounds(), dsize));
    ...
    pwr_contactor264.setBounds(new Rectangle(248,308,38,38));
    ...
    pwr_safetyswitch65.setBounds(new Rectangle(248,354,38,39));
    ...
    pwr_mbup66.setBounds(new Rectangle(344,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp186_60.dd.setDynType(129);
    grp186_60.dd.setActionType(0);
    grp186_60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp186_60.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_contactor264.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor264.dd, "$object.Contactor.Feedback.ActualValue##Boolean")
    ...
    pwr_safetyswitch65.dd.setAccess(65535);
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),72, 329);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),72, 377);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 3, 9, -136}, new int[] { 8, 10, 13,27}, 4),
    ...
    new Polygon( new int[] { 6, 7, -136, -136}, new int[] { 40, 36, 27,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 9, -136}, new int[] { 46, 46, 54,27}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219706616, -136}, new int[] { 10, 14, -1219706452,27}, 4),
    ...
    new Polygon( new int[] { 6, 9, 140893183, -136}, new int[] { 14, 19, 144132339,27}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706598, -118}, new int[] { 12, 15, -1219706422,57}, 4),
...
protected class Grp186_ extends GeComponent {
  // Dimension size;
  public Grp186_( JopSession session)
  {
    super( session);
