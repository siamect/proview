...
public class JopcBasepumpaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(92,334,82,72));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,446,45,19));
    ...
    pwr_motor243.setBounds(new Rectangle(174,334,96,72));
    ...
    pwr_indsquare52.setBounds(new Rectangle(186,294,14,15));
    ...
    grp173_53.setBounds(new Rectangle(70,294,38,15));
    ...
    pwr_pumpanim255.setBounds(new Rectangle(103,96,62,42));
    ...
    grp185_56.setBounds(new Rectangle(31,194,39,16));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(29,192,46,19));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 127, 14}, new int[] { 40, 36, -1219915383,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915361, 14}, new int[] { 10, 12, -1219915383,-7}, 4),
    ...
    new Polygon( new int[] { 6, 11, 140893334, 14}, new int[] { 14, 17, 144126416,-7}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915343, 32}, new int[] { 12, 15, -1219915353,22}, 4),
