...
public class JopcBasepositsensor extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar25.setBounds(new Rectangle(0,0,409,24));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(327,0,69,24));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(18,451,48,21));
    ...
    pwr_valuelong23.setBounds(new Rectangle(75,450,336,23));
    ...
    pwr_valuesmall25.setBounds(new Rectangle(163,114,50,18));
    ...
    pwr_sliderbackground326.setBounds(new Rectangle(334,116,64,244));
    ...
    pwr_slider327.setBounds(new Rectangle(334,336,64,14));
    ...
    pwr_slider328.setBounds(new Rectangle(334,316,64,14));
    ...
    pwr_slider329.setBounds(new Rectangle(334,136,64,14));
    ...
    pwr_slider330.setBounds(new Rectangle(334,156,64,14));
    ...
    pwr_valueinputreliefup32.setBounds(new Rectangle(273,115,51,18));
    ...
    pwr_valueinputreliefup33.setBounds(new Rectangle(273,342,51,18));
    ...
    pwr_valuesmall34.setBounds(new Rectangle(213,114,35,18));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(116,271,41,18));
    ...
    pwr_valuesmall38.setBounds(new Rectangle(162,271,41,18));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(162,289,41,18));
    ...
    pwr_valuesmall48.setBounds(new Rectangle(162,306,41,17));
    ...
    pwr_valuesmall53.setBounds(new Rectangle(162,324,41,18));
    ...
    pwr_indsquare57.setBounds(new Rectangle(95,289,16,17));
    ...
    pwr_indsquare58.setBounds(new Rectangle(95,307,16,17));
    ...
    pwr_indsquare59.setBounds(new Rectangle(95,325,16,16));
    ...
    pwr_pulldownmenu260.setBounds(new Rectangle(150,0,69,24));
    ...
    pwr_pulldownmenu261.setBounds(new Rectangle(69,0,69,24));
    ...
    jopBar66.setBounds(new Rectangle(344,117,30,242));
    ...
    pwr_valuesmall72.setBounds(new Rectangle(101,416,58,17));
    ...
    pwr_valuesmall73.setBounds(new Rectangle(178,416,58,17));
    ...
    pwr_smallbuttoncenter74.setBounds(new Rectangle(102,390,41,21));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(179,390,41,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider327.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider327.dd, "$object.LimitLL.Limit##Float32",0,100,4,111,351,"$object.Value.PresMinLimit##Float32","$object.Value.PresMaxLimit##Float32",
null)
      });
    ...
    pwr_slider328.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider328.dd, "$object.LimitL.Limit##Float32",0,100,4,111,351,"$object.Value.PresMinLimit##Float32","$object.Value.PresMaxLimit##Float32",
null)
      });
    ...
    pwr_slider329.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider329.dd, "$object.LimitHH.Limit##Float32",0,100,4,111,351,"$object.Value.PresMinLimit##Float32","$object.Value.PresMaxLimit##Float32",
null)
      });
    ...
    pwr_slider330.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider330.dd, "$object.LimitH.Limit##Float32",0,100,4,111,351,"$object.Value.PresMinLimit##Float32","$object.Value.PresMaxLimit##Float32",
null)
      });
