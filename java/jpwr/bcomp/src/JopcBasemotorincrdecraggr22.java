...
public class JopcBasemotorincrdecraggr22 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup77;
  public JopcBasemotorincrdecraggr22( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr22( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr22");
    pwr_indsquare4 = new pwr_indsquare(session);
    pwr_indsquare4.setBounds(new Rectangle(151,348,14,14));
    ...
    pwr_indsquare7.setBounds(new Rectangle(151,393,14,14));
    ...
    pwr_smallbuttoncenter28.setBounds(new Rectangle(5,563,45,19));
    ...
    pwr_valuelong29.setBounds(new Rectangle(61,562,334,21));
    ...
    pwr_contactor233.setBounds(new Rectangle(249,338,36,36));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(249,383,36,37));
    ...
    pwr_motor243.setBounds(new Rectangle(174,458,96,72));
    ...
    pwr_indsquare50.setBounds(new Rectangle(151,419,14,15));
    ...
    grp173_51.setBounds(new Rectangle(35,419,38,15));
    ...
    pwr_rodcouplinganim53.setBounds(new Rectangle(169,484,10,20));
    ...
    pwr_contactor254.setBounds(new Rectangle(306,338,36,36));
    ...
    pwr_indsquare56.setBounds(new Rectangle(212,348,14,14));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu242.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu242.dd, new String[] {
        JopLang.transl("ContactorIncr"),null,JopLang.transl("ContactorDecr"),null,JopLang.transl("SafetySwitch"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,    new GeDyn(pwr_pulldownmenu242,1,65,33619967,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu242,1,65,33619967,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.6571F, 275.997F, 360.366F, 280.99F),
    new Polygon( new int[] { 20, 380, 379, 21, 21, 20}, new int[] { 276, 276, 277, 277, 556, 557}, 6), 
    new Polygon( new int[] { 380, 380, 379, 379, 21, 20}, new int[] { 557, 276, 277, 556, 556, 557}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactors"),37, 360);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),37, 406);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Back"),177, 361);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Forw"),113, 361);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
