...
public class JopcBasecontactor1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare2.setBounds(new Rectangle(145,117,16,17));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(17,262,48,21));
    ...
    pwr_contactor224.setBounds(new Rectangle(243,118,111,111));
    ...
    pwr_menubar225.setBounds(new Rectangle(0,0,409,24));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(10,0,69,24));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(327,0,69,24));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(150,0,69,24));
    ...
    pwr_mbup30.setBounds(new Rectangle(354,24,19,20));
