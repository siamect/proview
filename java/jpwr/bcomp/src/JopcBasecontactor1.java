...
public class JopcBasecontactor1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecontactor1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecontactor1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecontactor1");
    pwr_indsquare1 = new pwr_indsquare(session);
    pwr_indsquare1.setBounds(new Rectangle(145,117,16,17));
    ...
    jopButtontoggle17.setBounds(new Rectangle(16,262,48,21));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(150,0,69,24));
    ...
    pwr_pulldownmenu28.setBounds(new Rectangle(69,0,69,24));
    ...
    pwr_contactor19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor19.dd, "$object.Order.ActualValue##Boolean")
      });
    ...
    pwr_contactor223.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor223.dd, "$object.Order.ActualValue##Boolean")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu27.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu27.dd, new String[] {
        "Order Do",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu27,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu27.dd, "open graph /class /inst=$object.Order")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu27.setAnnot1("Signals");
    ...
    pwr_pulldownmenu28.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Help\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Help\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Note\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Trend\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Trend\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Fast\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Fast\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Photo\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Photo\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"DataSheet\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Hist Event...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Block Events...\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"RtNavigator\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Open Object\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"Open Plc\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu28.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",0)
      ,new GeDynCommand(pwr_pulldownmenu28.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      }),
    new GeDyn(pwr_pulldownmenu28,129,65,65532,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 285;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(18F, 95.5731F, 179.619F, 156.593F),
    new Polygon( new int[] { 18, 198, 196, 20, 20, 18}, new int[] { 96, 96, 97, 97, 251, 252}, 6), 
    new Polygon( new int[] { 198, 198, 196, 196, 20, 18}, new int[] { 252, 96, 97, 251, 251, 252}, 6), 
    new Line2D.Float( 179F, 223F, 127F, 223F),
    new Line2D.Float( 89.742F, 223F, 37.742F, 223F),
  };
...
protected class pwr_contactor extends GeComponent {
  ...
  {
    super( session);
    size = new Dimension( 28, 44);
    pages = 2;
  }
  public int original_width = 28;
  public int original_height = 44;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(8F, 2F, 12F, 22F),
    new Polygon( new int[] { 8, 20, 18, 10, 10, 8}, new int[] { 2, 2, 4, 4, 22, 24}, 6), 
    new Polygon( new int[] { 20, 20, 18, 18, 10, 8}, new int[] { 24, 2, 4, 22, 22, 24}, 6), 
    new Arc2D.Float(22F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, 35F, 140F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, 215F, 140F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, -5F, 40F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, 175F, 40F, Arc2D.OPEN),
    new Arc2D.Float(22.2F, 30.2F, 3.6F, 3.6F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
    new Line2D.Float( 6F, 39.7779F, 22F, 32.7779F),
    new Line2D.Float( 14F, 37F, 14F, 24F),
    new Arc2D.Float(2F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 35F, 140F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 215F, 140F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, -5F, 40F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 175F, 40F, Arc2D.OPEN),
    new Arc2D.Float(2.2F, 30.2F, 3.6F, 3.6F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
  };
  int original_width_p2 = 28;
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Arc2D.Float(22.2F, 30.2F, 3.6F, 3.6F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(22F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
    new Line2D.Float( 22.2523F, 32F, 5.31718F, 32F),
    new Line2D.Float( 14F, 32F, 14F, 24F),
    new Arc2D.Float(2F, 30F, 4F, 4F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 35F, 140F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, 215F, 140F, Arc2D.OPEN),
    new Arc2D.Float(2F, 30F, 4F, 4F, -5F, 40F, Arc2D.OPEN),
