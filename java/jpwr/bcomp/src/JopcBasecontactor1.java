...
public class JopcBasecontactor1 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_contactor2	pwr_contactor224;
  ...
  public void geInit() {
    ...
    pwr_indsquare2.setBounds(new Rectangle(146,118,14,15));
    ...
    pwr_smallbuttoncenter18.setBounds(new Rectangle(18,263,46,19));
    pwr_smallbuttoncenter18.setFillColor(103);
    ...
    pwr_contactor224 = new pwr_contactor2(session);
    pwr_contactor224.setBounds(new Rectangle(244,119,109,109));
    pwr_contactor224.setFillColor(32);
    pwr_contactor224.setShadow(1);
    localPanel.add(pwr_contactor224, new Proportion(pwr_contactor224.getBounds(), dsize));
    pwr_menubar225 = new pwr_menubar2(session);
    pwr_menubar225.setBounds(new Rectangle(1,1,407,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu227.setBounds(new Rectangle(328,1,67,22));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(151,1,67,22));
    ...
    pwr_mbup30.setBounds(new Rectangle(355,25,17,18));
    ...
    pwr_contactor20.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor20.dd, "$object.Order.ActualValue##Boolean")
      });
    ...
    pwr_contactor224.dd.setDynType(32769);
    pwr_contactor224.dd.setActionType(0);
    pwr_contactor224.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor224.dd, "$object.Order.ActualValue##Boolean")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Order"),46, 130);
...
protected class pwr_contactor extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,8F,2F,12F,22F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
