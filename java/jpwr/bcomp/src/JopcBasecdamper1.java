...
public class JopcBasecdamper1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_basedamper	pwr_basedamper61;
  pwr_dampercontrol2	pwr_dampercontrol262;
  pwr_mbup	pwr_mbup63;
  pwr_indsquare	pwr_indsquare65;
  public JopcBasecdamper1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecdamper1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecdamper1");
    ...
    pwr_indsquare32.setBounds(new Rectangle(166,186,13,15));
    ...
    jopBar38.setBounds(new Rectangle(359,134,20,238));
    ...
    pwr_valuesmall40.setBounds(new Rectangle(346,392,48,15));
    ...
    pwr_smallbuttoncenter41.setBounds(new Rectangle(37,366,45,19));
    ...
    pwr_indround42.setBounds(new Rectangle(97,345,16,16));
    ...
    pwr_indround43.setBounds(new Rectangle(97,367,16,16));
    ...
    pwr_sliderbackground1_245.setBounds(new Rectangle(423,120,32,267));
    ...
    pwr_slider146.setBounds(new Rectangle(427,302,32,30));
    ...
    pwr_valueinputsmallrd47.setBounds(new Rectangle(413,389,53,22));
    ...
    pwr_indsquare49.setBounds(new Rectangle(167,244,14,15));
    ...
    pwr_pulldownmenu255.setBounds(new Rectangle(161,1,67,22));
    ...
    pwr_smallbuttoncenter56.setBounds(new Rectangle(37,343,45,19));
    ...
    pwr_indround57.setBounds(new Rectangle(97,398,16,16));
    ...
    pwr_basedamper61 = new pwr_basedamper(session);
    pwr_basedamper61.setBounds(new Rectangle(280,535,89,100));
    localPanel.add(pwr_basedamper61, new Proportion(pwr_basedamper61.getBounds(), dsize));
    pwr_dampercontrol262 = new pwr_dampercontrol2(session);
    pwr_dampercontrol262.setBounds(new Rectangle(102,103,62,57));
    pwr_dampercontrol262.setShadow(1);
    localPanel.add(pwr_dampercontrol262, new Proportion(pwr_dampercontrol262.getBounds(), dsize));
    pwr_mbup63 = new pwr_mbup(session);
    pwr_mbup63.setBounds(new Rectangle(488,25,18,18));
    localPanel.add(pwr_mbup63, new Proportion(pwr_mbup63.getBounds(), dsize));
    pwr_indsquare65 = new pwr_indsquare(session);
    pwr_indsquare65.setBounds(new Rectangle(167,268,14,15));
    pwr_indsquare65.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu228.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu228.dd, new String[] {
        JopLang.transl("Order Ao"),JopLang.transl("SwitchOpen Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare32.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare32.dd, "$object.Actuator.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare32.dd, "$object.Actuator.SwitchOpen")
      });
    ...
    pwr_slider146.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider146.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,527.029,685.913)
      });
    ...
    pwr_valueinputsmallrd47.setAnnot1Font(pwr_valueinputsmallrd47.annotFont.deriveFont((float)10));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_basedamper61.dd.setDynType(16384);
    pwr_basedamper61.dd.setActionType(66);
    pwr_basedamper61.dd.setAccess(65532);
    pwr_basedamper61.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basedamper61.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basedamper61.dd, "$object.Damper")
      ,new GeDynCommand(pwr_basedamper61.dd, "open graph/class/inst=$object.Damper")
      });
    pwr_dampercontrol262.dd.setDynType(19504);
    pwr_dampercontrol262.dd.setActionType(0);
    pwr_dampercontrol262.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_dampercontrol262.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_dampercontrol262.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynAnalogColor(pwr_dampercontrol262.dd, "$object.Actuator.PosEnum##Int32",1,4,30)
      ,new GeDynValue(pwr_dampercontrol262.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_dampercontrol262.dd, "$object.Actuator.PosEnum##Int32")
      });
    ...
    pwr_indsquare65.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare65.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch error"),37, 258);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Supervision disabled"),36, 279);
    g.setTransform(save);
  }
