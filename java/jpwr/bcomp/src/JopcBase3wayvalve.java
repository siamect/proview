...
public class JopcBase3wayvalve extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_base3wayvalve2	pwr_base3wayvalve222;
  pwr_mbup	pwr_mbup23;
  public JopcBase3wayvalve( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBase3wayvalve( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBase3wayvalve");
    ...
    pwr_mbopenobject5.setBounds(new Rectangle(194,25,20,20));
    ...
    pwr_mbtrend6.setBounds(new Rectangle(55,25,20,20));
    ...
    pwr_mbfast7.setBounds(new Rectangle(75,25,20,20));
    ...
    pwr_mbphoto8.setBounds(new Rectangle(95,25,20,20));
    ...
    pwr_mbopenplc10.setBounds(new Rectangle(214,25,20,20));
    ...
    pwr_mbcircuitdiagram11.setBounds(new Rectangle(234,25,20,20));
    ...
    pwr_mbrtnavigator12.setBounds(new Rectangle(174,25,20,20));
    ...
    pwr_mbblockevents14.setBounds(new Rectangle(154,25,20,20));
    ...
    pwr_mbnote16.setBounds(new Rectangle(35,25,20,20));
    ...
    pwr_base3wayvalve222 = new pwr_base3wayvalve2(session);
    pwr_base3wayvalve222.setBounds(new Rectangle(82,111,147,194));
    localPanel.add(pwr_base3wayvalve222, new Proportion(pwr_base3wayvalve222.getBounds(), dsize));
    pwr_mbup23 = new pwr_mbup(session);
    pwr_mbup23.setBounds(new Rectangle(380,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_base3wayvalve222.dd.setDynType(1);
    pwr_base3wayvalve222.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.3752F, 23.1001F, 404.397F, 22.4305F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.3752F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.3752F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    g.setTransform(save);
...
protected class pwr_base3wayvalve2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 26, 27, 23, 22}, new int[] { 18, 21, 23,20}, 4),
    new Polygon( new int[] { 22, 23, 19, 18}, new int[] { 20, 23, 23,20}, 4),
    new Polygon( new int[] { 18, 19, 19, 16}, new int[] { 20, 23, 23,22}, 4),
    new Polygon( new int[] { 16, 19, 19, 16}, new int[] { 22, 23, 37,36}, 4),
    new Polygon( new int[] { 16, 19, 15, 14}, new int[] { 36, 37, 42,38}, 4),
    new Polygon( new int[] { 14, 15, 9, 6}, new int[] { 38, 42, 39,34}, 4),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 34, 39, 52,54}, 4),
    new Polygon( new int[] { 6, 9, 16, 14}, new int[] { 54, 52, 56,58}, 4),
    new Polygon( new int[] { 14, 16, 19, 16}, new int[] { 58, 56, 59,60}, 4),
    new Polygon( new int[] { 16, 19, 19, 16}, new int[] { 60, 59, 65,66}, 4),
    new Polygon( new int[] { 16, 19, 19, 18}, new int[] { 66, 65, 65,68}, 4),
    new Polygon( new int[] { 18, 19, 25, 22}, new int[] { 68, 65, 65,68}, 4),
    new Polygon( new int[] { 22, 25, 25, 22}, new int[] { 68, 65, 75,78}, 4),
    new Polygon( new int[] { 22, 25, 39, 42}, new int[] { 78, 75, 75,78}, 4),
    ...
    new Polygon( new int[] { 38, 37, 27, 27}, new int[] { 18, 21, 21,18}, 4),
    new Polygon( new int[] { 27, 27, 27, -45}, new int[] { 18, 21, 21,-110}, 4),
    new Polygon( new int[] { 6, 16, 16, 6, 6}, new int[] {48, 54, 60, 54, 48}, 5),
    new Polygon( new int[] { 6, 7, 15, 16}, new int[] { 48, 50, 55,54}, 4),
    ...
    new Polygon( new int[] { 6, 7, -1220087389, -45}, new int[] { 48, 50, -1220087454,-110}, 4),
    ...
    new Polygon( new int[] { 26, 27, -1220087453, -45}, new int[] { 18, 21, -1220087518,-110}, 4),
