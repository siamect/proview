...
public class JopcBasedirvalve2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter34.setBounds(new Rectangle(144,340,63,21));
    ...
    pwr_smallbuttoncenter35.setBounds(new Rectangle(144,316,63,21));
    ...
    pwr_indround37.setBounds(new Rectangle(219,319,18,18));
    ...
    pwr_indround38.setBounds(new Rectangle(219,341,18,18));
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(144,366,63,21));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(144,316,63,21));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(144,340,63,21));
...
protected class Grp198_ extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 24, -1219706799, -319}, new int[] { 42, 43, -1219706751,-271}, 4),
