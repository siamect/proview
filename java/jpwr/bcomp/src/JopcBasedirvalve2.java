...
public class JopcBasedirvalve2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup50;
  public JopcBasedirvalve2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasedirvalve2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasedirvalve2");
    ...
    pwr_smallbuttoncenter34.setBounds(new Rectangle(145,341,61,19));
    ...
    pwr_smallbuttoncenter35.setBounds(new Rectangle(145,317,61,19));
    ...
    pwr_smallbuttoncenter47.setBounds(new Rectangle(145,367,61,19));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(145,317,61,19));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(145,341,61,19));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter34.setAnnot1("Down");
    ...
    pwr_smallbuttoncenter35.setAnnot1("Up");
    ...
    pwr_smallbuttoncenter48.setAnnot1("Up");
    ...
    pwr_smallbuttoncenter49.setAnnot1("Down");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order Down"),38, 229);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Man"),149, 299);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),38, 249);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order Up"),38, 209);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[8]);
...
protected class Grp198_ extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 24, -1811406627, -319}, new int[] { 42, 43, 85983202,-271}, 4),
