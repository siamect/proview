...
public class JopcBaseactuatora3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBaseactuatora3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora3");
    ...
    pwr_menubar26.setBounds(new Rectangle(1,1,538,22));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(162,1,67,22));
    ...
    pwr_actuator47.setBounds(new Rectangle(107,119,66,42));
    ...
    pwr_smallbuttoncenter48.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround49.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_50 = new Grp175_(session);
    grp175_50.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_50, new Proportion(grp175_50.getBounds(), dsize));
    ...
    pwr_indsquare53.setBounds(new Rectangle(167,262,14,15));
    pwr_indsquare53.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopBar36.setPwrAttribute("$object.Order.ActualValue##Float32");
    jopBar36.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar36.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    ...
    pwr_valuesmall38.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall38.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall38.dd, "$object.Order")
      });
    ...
    pwr_smallbuttoncenter39.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter39.dd, "$object.Mode.OpAuto##Boolean")
      });
    ...
    pwr_indround40.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround40.dd, "$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_indround41.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_indround41.dd, "!$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_sliderbackground1_243.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_243.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_slider144.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider144.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider144.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,537.686,447.913)
      });
    ...
    pwr_valueinputsmallrd45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd45.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd45.dd, "$object.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd45.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    ...
    grp167_46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_46.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_actuator47.dd.setDynType(1);
    pwr_actuator47.dd.setActionType(0);
    pwr_smallbuttoncenter48.dd.setDynType(128);
    pwr_smallbuttoncenter48.dd.setActionType(4);
    ...
    pwr_indround49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround49.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround49.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp175_50.dd.setDynType(129);
    grp175_50.dd.setActionType(0);
    grp175_50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_50.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
    ...
    pwr_indsquare53.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare53.dd, "$object.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.1001F, 537.686F, 22.4305F),
    new Line2D.Float( 252.568F, 329.042F, 18.0338F, 329.042F),
    ...
    new Line2D.Float( 391.02F, 181F, 338.495F, 181F),
    new Line2D.Float( 391.02F, 229F, 338.495F, 229F),
    new Line2D.Float( 391.02F, 276F, 338.495F, 276F),
    new Line2D.Float( 391.02F, 325F, 338.495F, 325F),
  };
