...
public class JopcBasemotorincrdecraggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup80;
  public JopcBasemotorincrdecraggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr8");
    ...
    pwr_overloadrelay5.setBounds(new Rectangle(248,376,38,27));
    ...
    pwr_indsquare8.setBounds(new Rectangle(150,350,16,16));
    ...
    pwr_indsquare11.setBounds(new Rectangle(150,420,16,16));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,590,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,589,336,23));
    ...
    pwr_contactor238.setBounds(new Rectangle(248,340,38,38));
    ...
    pwr_safetyswitch39.setBounds(new Rectangle(248,410,38,39));
    ...
    pwr_motor248.setBounds(new Rectangle(173,485,98,74));
    ...
    pwr_indsquare55.setBounds(new Rectangle(150,446,16,16));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(168,511,12,22));
    ...
    pwr_contactor261.setBounds(new Rectangle(305,340,38,38));
    ...
    pwr_indsquare63.setBounds(new Rectangle(211,350,16,16));
    ...
    pwr_fuse379.setBounds(new Rectangle(259,295,15,37));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, -1219980802, -18}, new int[] { 146, 147, -1219980784,0}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Decr"),177, 364);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),113, 364);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
