...
public class JopcBasemotorincrdecraggr30 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter28.setBounds(new Rectangle(4,518,47,21));
    ...
    pwr_valuelong29.setBounds(new Rectangle(60,517,336,23));
    ...
    pwr_contactor233.setBounds(new Rectangle(248,293,38,38));
    ...
    pwr_safetyswitch34.setBounds(new Rectangle(248,338,38,39));
    ...
    pwr_motor243.setBounds(new Rectangle(173,413,98,74));
    ...
    pwr_indsquare50.setBounds(new Rectangle(150,374,16,16));
    ...
    grp173_51.setBounds(new Rectangle(34,374,40,18));
    ...
    pwr_rodcouplinganim53.setBounds(new Rectangle(168,439,12,22));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140859583, 55}, new int[] { 12, 15, 151091269,72}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140857087, 55}, new int[] { 12, 15, 151494653,72}, 4),
