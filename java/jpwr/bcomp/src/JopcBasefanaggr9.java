...
public class JopcBasefanaggr9 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay3.setBounds(new Rectangle(249,343,36,25));
    ...
    pwr_rod31.setBounds(new Rectangle(139,443,37,8));
    ...
    pwr_contactor237.setBounds(new Rectangle(249,308,36,36));
    ...
    pwr_fananim38.setBounds(new Rectangle(124,401,17,89));
    ...
    pwr_motor248.setBounds(new Rectangle(174,411,96,72));
    ...
    pwr_indsquare57.setBounds(new Rectangle(186,371,14,15));
    ...
    pwr_fuse361.setBounds(new Rectangle(261,265,13,35));
    ...
    grp181_62.setBounds(new Rectangle(31,194,39,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915377, -1}, new int[] { 12, 15, -1219915329,46}, 4),
