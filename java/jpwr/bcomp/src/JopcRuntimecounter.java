...
public class JopcRuntimecounter extends JopFrame implements JopUtilityIfc {
  ...
  pwr_indroundlarge	pwr_indroundlarge57;
  pwr_mbup	pwr_mbup58;
  ...
  public void geInit() {
    ...
    pwr_valuelong1.setBounds(new Rectangle(16,47,414,20));
    ...
    pwr_menubar23.setBounds(new Rectangle(1,1,437,22));
    ...
    pwr_pulldownmenu25.setBounds(new Rectangle(339,1,67,22));
    ...
    pwr_valuesmall20.setBounds(new Rectangle(125,101,99,16));
    ...
    pwr_valuesmall23.setBounds(new Rectangle(125,121,99,16));
    ...
    pwr_valuesmall25.setBounds(new Rectangle(126,143,39,15));
    ...
    pwr_valuesmall28.setBounds(new Rectangle(126,164,39,16));
    ...
    pwr_valuesmall33.setBounds(new Rectangle(126,249,99,16));
    ...
    pwr_valuesmall35.setBounds(new Rectangle(126,269,99,16));
    ...
    pwr_valuesmall37.setBounds(new Rectangle(126,291,39,16));
    ...
    pwr_valuesmall40.setBounds(new Rectangle(126,312,39,15));
    ...
    pwr_valuesmall43.setBounds(new Rectangle(306,249,100,16));
    ...
    pwr_valuesmall44.setBounds(new Rectangle(306,269,100,16));
    ...
    pwr_valuesmall45.setBounds(new Rectangle(306,291,39,16));
    ...
    pwr_valuesmall47.setBounds(new Rectangle(306,312,39,15));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(212,226,38,16));
    ...
    pwr_valuesmall51.setBounds(new Rectangle(126,188,150,16));
    ...
    pwr_valuesmall53.setBounds(new Rectangle(126,357,150,16));
    localPanel.add(pwr_valuesmall53, new Proportion(pwr_valuesmall53.getBounds(), dsize));
    pwr_indroundlarge57 = new pwr_indroundlarge(session);
    pwr_indroundlarge57.setBounds(new Rectangle(348,127,35,35));
    localPanel.add(pwr_indroundlarge57, new Proportion(pwr_indroundlarge57.getBounds(), dsize));
    pwr_mbup58 = new pwr_mbup(session);
    pwr_mbup58.setBounds(new Rectangle(413,25,17,18));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuesmall20.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall20.dd, "$object.TotalTime##DeltaTime","%t")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23.4296F, 437.165F, 22.4305F),
    new Rectangle2D.Float(16.8447F, 73.1614F, 275.926F, 139.95F),
    ...
    new Line2D.Float( 292.331F, 96.3966F, 17.0686F, 96.3966F),
    new Rectangle2D.Float(16.8452F, 221.222F, 415.155F, 155.598F),
    ...
    new Line2D.Float( 431.338F, 244.456F, 17.1822F, 244.456F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Total"),26, 91);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Time"),26, 113);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("RunTime"),26, 133);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Usage"),26, 154);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),177, 155);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Starts"),26, 175);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Trip counter"),26, 239);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Time"),26, 261);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("RunTime"),26, 281);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Usage"),26, 302);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),178, 303);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Starts"),26, 323);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(25, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[8]);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),358, 303);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Current "),128, 239);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Last"),309, 239);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("StartTime"),26, 200);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("ResetTime"),26, 369);
    {
    int fcolor = GeColor.getDrawtype(31, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setColor(GeColor.shiftColor( fcolor, 2, colorInverse));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Running"),338, 96);
    g.setTransform(save);
  }
...
protected class pwr_indroundlarge extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, 9,2,-2,2F,2F,57F,58F, false,293, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[5]);
    GeGradient.paint( g, gradient,2,-2,2F,2F,57F,58F, false,293, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[4]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
