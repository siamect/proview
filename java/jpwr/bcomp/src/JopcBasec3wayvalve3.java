...
public class JopcBasec3wayvalve3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valve3waycontrol2	pwr_valve3waycontrol258;
  pwr_base3wayvalve	pwr_base3wayvalve60;
  pwr_base3wayvalve2	pwr_base3wayvalve261;
  pwr_mbup	pwr_mbup62;
  pwr_indsquare	pwr_indsquare64;
  public JopcBasec3wayvalve3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasec3wayvalve3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasec3wayvalve3");
    ...
    pwr_valve3waycontrol258 = new pwr_valve3waycontrol2(session);
    pwr_valve3waycontrol258.setBounds(new Rectangle(111,100,64,51));
    pwr_valve3waycontrol258.setShadow(1);
    localPanel.add(pwr_valve3waycontrol258, new Proportion(pwr_valve3waycontrol258.getBounds(), dsize));
    pwr_base3wayvalve60 = new pwr_base3wayvalve(session);
    pwr_base3wayvalve60.setBounds(new Rectangle(276,533,98,130));
    localPanel.add(pwr_base3wayvalve60, new Proportion(pwr_base3wayvalve60.getBounds(), dsize));
    pwr_base3wayvalve261 = new pwr_base3wayvalve2(session);
    pwr_base3wayvalve261.setBounds(new Rectangle(430,533,97,129));
    localPanel.add(pwr_base3wayvalve261, new Proportion(pwr_base3wayvalve261.getBounds(), dsize));
    pwr_mbup62 = new pwr_mbup(session);
    pwr_mbup62.setBounds(new Rectangle(488,25,18,18));
    localPanel.add(pwr_mbup62, new Proportion(pwr_mbup62.getBounds(), dsize));
    pwr_indsquare64 = new pwr_indsquare(session);
    pwr_indsquare64.setBounds(new Rectangle(167,261,14,15));
    pwr_indsquare64.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valve3waycontrol258.dd.setDynType(17456);
    pwr_valve3waycontrol258.dd.setActionType(0);
    pwr_valve3waycontrol258.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_valve3waycontrol258.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_valve3waycontrol258.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynValue(pwr_valve3waycontrol258.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_valve3waycontrol258.dd, "$object.Actuator.PosEnum##Int32")
      });
    pwr_base3wayvalve60.dd.setDynType(0);
    pwr_base3wayvalve60.dd.setActionType(66);
    pwr_base3wayvalve60.dd.setAccess(65532);
    pwr_base3wayvalve60.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_base3wayvalve60.dd, "$object.Valve")
      ,new GeDynCommand(pwr_base3wayvalve60.dd, "open graph/class/inst=$object.Valve")
      });
    pwr_base3wayvalve261.dd.setDynType(16384);
    pwr_base3wayvalve261.dd.setActionType(66);
    pwr_base3wayvalve261.dd.setAccess(65532);
    pwr_base3wayvalve261.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_base3wayvalve261.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_base3wayvalve261.dd, "$object.Valve")
      ,new GeDynCommand(pwr_base3wayvalve261.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_mbup62.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbup62.dd, JopLang.transl("Open parent object graph"))
      });
    pwr_indsquare64.dd.setDynType(5);
    pwr_indsquare64.dd.setActionType(0);
    pwr_indsquare64.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare64.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Order"),346, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 272);
...
protected class pwr_base3wayvalve extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 50, 51, 57, 58}, new int[] { 50, 46, 49,54}, 4),
    new Polygon( new int[] { 58, 57, 57, 58}, new int[] { 54, 49, 36,34}, 4),
    new Polygon( new int[] { 58, 57, 50, 50}, new int[] { 34, 36, 32,30}, 4),
    new Polygon( new int[] { 50, 50, 47, 48}, new int[] { 30, 32, 29,28}, 4),
    new Polygon( new int[] { 48, 47, 47, 48}, new int[] { 28, 29, 23,22}, 4),
    new Polygon( new int[] { 48, 47, 47, 46}, new int[] { 22, 23, 23,20}, 4),
    new Polygon( new int[] { 46, 47, 43, 42}, new int[] { 20, 23, 23,20}, 4),
    new Polygon( new int[] { 42, 43, 39, 38}, new int[] { 20, 23, 21,18}, 4),
    new Polygon( new int[] { 38, 39, 29, 27}, new int[] { 18, 21, 21,18}, 4),
    new Polygon( new int[] { 27, 29, 29, 59}, new int[] { 18, 21, 21,-2147483648}, 4),
    ...
    new Polygon( new int[] { 6, 9, 145429883, 59}, new int[] { 48, 50, -1219915370,-2}, 4),
    ...
    new Polygon( new int[] { 26, 29, -1219915316, 59}, new int[] { 18, 21, -1219915378,-2147483648}, 4),
...
protected class pwr_base3wayvalve2 extends GeComponent {
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {34, 30, 28, 34, 34, 38, 34}, 7),
    new Polygon( new int[] { 48, 42, 42, 40, 38, 38, 42, 42, 46, 48, 48}, new int[] {22, 22, 66, 66, 68, 78, 78, 68, 68, 66, 22}, 11),
    new Polygon( new int[] { 48, 49, 45, 42}, new int[] { 22, 23, 23,22}, 4),
    ...
    new Polygon( new int[] { 48, 49, 49, 48}, new int[] { 66, 66, 23,22}, 4),
    new Polygon( new int[] { 48, 49, 59, 59}, new int[] { 22, 23, -2,-2}, 4),
    new Polygon( new int[] { 48, 22, 22, 16, 16, 18, 22, 26, 38, 42, 46, 48}, new int[] {22, 22, 66, 66, 22, 20, 20, 18, 18, 20, 20, 22}, 12),
    new Polygon( new int[] { 48, 45, 22, 22}, new int[] { 22, 20, 20,22}, 4),
    ...
    new Polygon( new int[] { 46, 47, 45, 48}, new int[] { 20, 22, 20,22}, 4),
    new Polygon( new int[] { 48, 45, 1636, 59}, new int[] { 22, 20, -1219915378,-2147483648}, 4),
    new Rectangle2D.Float(22F, 68F, 4F, 10F),
    new Polygon( new int[] { 22, 26, 26, 22, 22, 22}, new int[] { 68, 68, 68, 68, 78, 78}, 6), 
    new Polygon( new int[] { 26, 26, 26, 26, 22, 22}, new int[] { 78, 68, 68, 78, 78, 78}, 6), 
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {54, 50, 52, 44, 44, 48, 54}, 7),
    ...
    new Polygon( new int[] { 40, 39, 57, 58}, new int[] { 43, 38, 47,52}, 4),
    new Polygon( new int[] { 58, 57, 57, 58}, new int[] { 52, 47, 38,36}, 4),
    new Polygon( new int[] { 58, 57, 41, 40}, new int[] { 36, 38, 29,26}, 4),
    ...
    new Polygon( new int[] { 6, 11, 1636, 59}, new int[] { 52, 50, -1219915378,-2147483648}, 4),
    ...
    new Polygon( new int[] { 31, 34, 59, 59}, new int[] { 26, 27, -2,-2}, 4),
...
protected class pwr_valve3waycontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 410, 49}, new int[] { 22, 27, 416098406,27}, 4),
    ...
    new Polygon( new int[] { 42, 42, 410, 49}, new int[] { 22, 27, 416098406,27}, 4),
    ...
    new Polygon( new int[] { 22, 24, 17, 12}, new int[] { 32, 36, 50,52}, 4),
    new Polygon( new int[] { 12, 17, 31, 32}, new int[] { 52, 50, 50,52}, 4),
    new Polygon( new int[] { 32, 31, 24, 22}, new int[] { 52, 50, 36,32}, 4),
    new Polygon( new int[] { 22, 24, 410, 49}, new int[] { 32, 36, 416098406,27}, 4),
