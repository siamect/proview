...
public class JopcBasemotorincrdecraggr33 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay2.setBounds(new Rectangle(248,372,38,27));
    ...
    pwr_indsquare5.setBounds(new Rectangle(150,346,16,16));
    ...
    pwr_smallbuttoncenter8.setBounds(new Rectangle(40,168,48,21));
    ...
    pwr_indround9.setBounds(new Rectangle(100,172,18,18));
    ...
    pwr_indround10.setBounds(new Rectangle(100,194,18,18));
    ...
    pwr_indround25.setBounds(new Rectangle(100,216,18,18));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(4,549,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,548,336,23));
    ...
    pwr_indround31.setBounds(new Rectangle(226,173,18,18));
    ...
    pwr_contactor232.setBounds(new Rectangle(248,336,38,38));
    ...
    pwr_indsquare34.setBounds(new Rectangle(348,117,16,17));
    ...
    pwr_valuesmall44.setBounds(new Rectangle(303,246,71,18));
    ...
    pwr_motorman52.setBounds(new Rectangle(101,95,64,44));
    ...
    pwr_rodcouplinganim53.setBounds(new Rectangle(168,467,12,21));
    ...
    pwr_contactor254.setBounds(new Rectangle(305,336,38,38));
    ...
    pwr_indsquare56.setBounds(new Rectangle(211,346,16,16));
    ...
    pwr_indround57.setBounds(new Rectangle(226,195,18,17));
    ...
    pwr_indsquare58.setBounds(new Rectangle(276,173,16,17));
    ...
    pwr_indsquare59.setBounds(new Rectangle(276,196,16,17));
    ...
    pwr_smallbuttoncenter66.setBounds(new Rectangle(40,193,48,21));
    ...
    pwr_fuse369.setBounds(new Rectangle(259,292,15,37));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(152,193,62,21));
    ...
    pwr_smallbuttoncenter74.setBounds(new Rectangle(152,216,62,21));
    ...
    pwr_smallbuttoncenter75.setBounds(new Rectangle(152,193,62,21));
    ...
    pwr_smallbuttoncenter76.setBounds(new Rectangle(152,169,62,21));
    ...
    pwr_mbup77.setBounds(new Rectangle(344,24,19,20));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140857013, -18}, new int[] { 146, 147, 151053847,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857087, 55}, new int[] { 12, 15, 151053901,53}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140859583, 55}, new int[] { 12, 15, 151686597,53}, 4),
