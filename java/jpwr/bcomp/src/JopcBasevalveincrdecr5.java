...
public class JopcBasevalveincrdecr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup77;
  public JopcBasevalveincrdecr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasevalveincrdecr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasevalveincrdecr5");
    ...
    pwr_indsquare62.setBounds(new Rectangle(290,342,16,17));
    ...
    pwr_smallbuttoncenter63.setBounds(new Rectangle(173,385,62,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu230.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu230.dd, new String[] {
        "Position Ai","OrderIncr Do","OrderDecr Do","SwitchOpen Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbsimulate44.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbsimulate44.dd, "Open simulate graph")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare62.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare62.dd, "$object.Actuator.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare62.dd, "$object.Actuator.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare62.dd, "$object.Actuator.Mode.LimitSwitchIncr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.ManStopHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.OpManStop##Boolean")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(3.01167F, 22.5515F, 531.851F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 3.01167F,44.982F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        3.01167F,22.5515F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    ...
    g.drawString( "Position",454, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "SwitchOpen",199, 199);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "%",410, 165);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Switch error",199, 253);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Decr",188, 375);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Incr",188, 352);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Order incr",38, 199);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Order decr",38, 219);
    {
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 74, -6}, new int[] { 22, 25, -1220087369,-16}, 4),
    ...
    new Polygon( new int[] { 42, 40, 74, -6}, new int[] { 22, 25, -1220087369,-16}, 4),
