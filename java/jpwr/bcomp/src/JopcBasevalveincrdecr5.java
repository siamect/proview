...
public class JopcBasevalveincrdecr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare33.setBounds(new Rectangle(328,186,14,15));
    ...
    pwr_indsquare62.setBounds(new Rectangle(291,343,14,15));
    ...
    pwr_smallbuttoncenter63.setBounds(new Rectangle(174,386,60,19));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 26, -6}, new int[] { 22, 25, 153591478,-33}, 4),
    ...
    new Polygon( new int[] { 42, 40, 26, -6}, new int[] { 22, 25, 153591478,-33}, 4),
