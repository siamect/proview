...
public class JopcBasemotoraggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare4.setBounds(new Rectangle(185,265,16,17));
    ...
    jopSmallbutton7.setBounds(new Rectangle(28,168,48,21));
    ...
    pwr_indround8.setBounds(new Rectangle(89,171,18,18));
    ...
    pwr_indround9.setBounds(new Rectangle(89,193,18,17));
    ...
    jopSmallbutton10.setBounds(new Rectangle(115,191,61,21));
    ...
    pwr_indround25.setBounds(new Rectangle(88,216,18,18));
    ...
    jopSmallbutton27.setBounds(new Rectangle(4,445,47,21));
    ...
    pwr_valuelong28.setBounds(new Rectangle(60,444,336,23));
    ...
    pwr_indround31.setBounds(new Rectangle(187,172,18,17));
    ...
    pwr_contactor232.setBounds(new Rectangle(248,256,38,38));
    ...
    pwr_valuesmall44.setBounds(new Rectangle(282,216,71,18));
    ...
    jopSmallbutton48.setBounds(new Rectangle(115,169,61,21));
    ...
    pwr_indsquare50.setBounds(new Rectangle(185,293,16,17));
    ...
    grp173_51.setBounds(new Rectangle(69,293,38,17));
    ...
    pwr_rodcouplinganim53.setBounds(new Rectangle(167,358,12,21));
    ...
    grp183_54 = new Grp183_(session);
    grp183_54.setBounds(new Rectangle(30,193,43,18));
    localPanel.add(grp183_54, new Proportion(grp183_54.getBounds(), dsize));
    jopSmallbutton55 = new JopSmallbutton(session);
    jopSmallbutton55.setBounds(new Rectangle(28,191,48,21));
    ...
    jopSmallbutton10.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton10.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton10.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton10.dd, "$object.Mode.OpManStop")
      ,new GeDynSetDig(jopSmallbutton10.dd, "$object.Mode.OpManStop##Boolean")
      });
    jopSmallbutton10.setAnnot1(" Stop");
    ...
    pwr_indround31.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indround31.dd, "$object.Mode.Feedback##Boolean",29)
      });
    ...
    pwr_contactor232.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor232.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor232.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor232.dd, "open graph /class/instance=$object.Contactor")
      });
...
null,null,    new GeDyn(pwr_pulldownmenu38,129,65,33619967,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu38,129,65,33619967,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton48.dd.setActionType(6);
    jopSmallbutton48.dd.setAccess(65532);
    jopSmallbutton48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton48.dd, "$object.Mode.ManOrdHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton48.dd, "$object.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton48.dd, "$object.Mode.OpManStart")
      ,new GeDynSetDig(jopSmallbutton48.dd, "$object.MOde.OpManStart##Boolean")
      });
    jopSmallbutton48.setAnnot1(" Start");
    ...
    pwr_motorman52.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman52.dd, "$object.Contactor.Feedback.ActualValue##Boolean",37)
    ...
    pwr_rodcouplinganim53.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim53.dd, "$object.Contactor.IndFeedback##Boolean",1)
      });
    grp183_54.dd.setDynType(129);
    grp183_54.dd.setActionType(0);
    grp183_54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp183_54.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    jopSmallbutton55.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton55.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(jopSmallbutton55.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(jopSmallbutton55.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(jopSmallbutton55.dd, "$object.Mode.OpAuto##Boolean")
      });
    jopSmallbutton55.setAnnot1(" Auto");
...
protected class JopSmallbutton extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 6 * original_height / height * width / original_width, 16F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
...
protected class pwr_fananim__p6 extends GeComponent {
  ...
  {
    super( session);
    size = new Dimension( 64, 79);
  }
  public int original_width = 64;
  public int original_height = 79;
  Shape[] shapes = new Shape[] { 
