...
public class JopcCompmodepid extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcCompmodepid( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcCompmodepid( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcCompmodepid");
    pwr_sliderbackground16 = new pwr_sliderbackground1(session);
    pwr_sliderbackground16.setBounds(new Rectangle(425,40,38,361));
    ...
    pwr_sliderbackground19.setBounds(new Rectangle(181,40,38,361));
    ...
    pwr_slider110.setBounds(new Rectangle(188,58,32,30));
    ...
    pwr_slider111.setBounds(new Rectangle(432,58,32,30));
    ...
    jopBar12.setBounds(new Rectangle(271,68,24,306));
    ...
    jopBar13.setBounds(new Rectangle(312,68,24,306));
    ...
    jopBar14.setBounds(new Rectangle(353,68,24,306));
    ...
    pwr_smallbuttoncenter15.setBounds(new Rectangle(178,16,54,19));
    pwr_smallbuttoncenter15.setColorTone(1);
    ...
    pwr_smallbuttoncenter16.setBounds(new Rectangle(413,16,52,19));
    pwr_smallbuttoncenter16.setColorTone(1);
    ...
    pwr_buttoncommand17.setBounds(new Rectangle(9,410,83,31));
    ...
    pwr_valuereliefup18.setBounds(new Rectangle(27,77,69,21));
    ...
    pwr_indroundlarge19.setBounds(new Rectangle(116,73,26,25));
    ...
    pwr_valuereliefup20.setBounds(new Rectangle(27,44,69,21));
    ...
    pwr_indroundlarge21.setBounds(new Rectangle(116,41,26,25));
    ...
    pwr_valuereliefup22.setBounds(new Rectangle(27,109,69,21));
    ...
    pwr_indroundlarge23.setBounds(new Rectangle(116,106,26,25));
    ...
    pwr_framethin26.setBounds(new Rectangle(5,159,156,86));
    ...
    pwr_valuereliefdown29.setBounds(new Rectangle(27,205,99,24));
    ...
    pwr_valuesmall30.setBounds(new Rectangle(229,377,40,19));
    ...
    pwr_valuesmall31.setBounds(new Rectangle(381,377,40,19));
    ...
    pwr_framethin36.setBounds(new Rectangle(5,259,156,42));
    ...
    pwr_indroundlarge38.setBounds(new Rectangle(116,267,26,25));
    ...
    pwr_indroundlarge39.setBounds(new Rectangle(86,267,26,25));
    ...
    pwr_valueinputreliefup40.setBounds(new Rectangle(229,51,40,17));
    ...
    pwr_valueinputreliefup41.setBounds(new Rectangle(229,357,40,17));
    ...
    pwr_valueinputreliefup42.setBounds(new Rectangle(380,51,40,17));
    ...
    pwr_valueinputreliefup43.setBounds(new Rectangle(380,357,40,17));
    ...
    pwr_valueinputmedium44.setBounds(new Rectangle(174,420,98,22));
    ...
    pwr_valueinputmedium45.setBounds(new Rectangle(274,420,98,22));
    ...
    pwr_valueinputmedium46.setBounds(new Rectangle(375,420,98,22));
    ...
    pwr_slider110.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider110.dd, "$object.SetVal##Float32",0,100,4,57.7185,365.011,"$object.MinSet##Float32","$object.MaxSet##Float32","!$local.SetSliderEnable##Boolean",480,454.468)
      });
    ...
    pwr_slider111.dd.setElements(new GeDynElemIfc[] {
      new GeDynSlider(pwr_slider111.dd, "$object.ForcVal##Float32",0,100,4,57.7185,365.011,"$object.MinOut##Float32","$object.MaxOut##Float32","!$local.OutSliderEnable##Boolean",480,454.468)
      });
    ...
    pwr_smallbuttoncenter15.dd.setDynType(4);
    pwr_smallbuttoncenter15.dd.setActionType(16);
    pwr_smallbuttoncenter15.dd.setAccess(-2147483626);
    pwr_smallbuttoncenter15.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_smallbuttoncenter15.dd, "!$local.SetSliderEnable##Boolean",102)
      ,new GeDynToggleDig(pwr_smallbuttoncenter15.dd, "$local.SetSliderEnable##Boolean")
      });
    pwr_smallbuttoncenter15.setAnnot1("Slider");
    pwr_smallbuttoncenter16.dd.setDynType(4);
    pwr_smallbuttoncenter16.dd.setActionType(16);
    pwr_smallbuttoncenter16.dd.setAccess(-2147483626);
    pwr_smallbuttoncenter16.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_smallbuttoncenter16.dd, "!$local.OutSliderEnable##Boolean",102)
      ,new GeDynToggleDig(pwr_smallbuttoncenter16.dd, "$local.OutSliderEnable##Boolean")
      });
    pwr_smallbuttoncenter16.setAnnot1("Slider");
    ...
    pwr_valueinputreliefup40.setAnnot1Font(pwr_valueinputreliefup40.annotFont.deriveFont((float)11.1412));
    ...
    pwr_valueinputreliefup41.setAnnot1Font(pwr_valueinputreliefup41.annotFont.deriveFont((float)11.1412));
    ...
    pwr_valueinputreliefup42.setAnnot1Font(pwr_valueinputreliefup42.annotFont.deriveFont((float)11.1412));
    ...
    pwr_valueinputreliefup43.setAnnot1Font(pwr_valueinputreliefup43.annotFont.deriveFont((float)11.1412));
    ...
    pwr_valueinputmedium44.setAnnot1Font(pwr_valueinputmedium44.annotFont.deriveFont((float)14.2979));
    ...
    pwr_valueinputmedium45.setAnnot1Font(pwr_valueinputmedium45.annotFont.deriveFont((float)14.2979));
    ...
    pwr_valueinputmedium46.setAnnot1Font(pwr_valueinputmedium46.annotFont.deriveFont((float)14.2979));
...
protected class pwr_buttoncommand extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 9, 8}, new int[] { 35, 31, 46,45}, 4),
    ...
    new Polygon( new int[] { 2, 8, 8, 8}, new int[] { 35, 35, 45,45}, 4),
    new Rectangle2D.Float(2F, 2F, 100.085F, 32.6809F),
    new Polygon( new int[] { 2, 102, 100, 4, 4, 2}, new int[] { 2, 2, 4, 4, 33, 35}, 6), 
    new Polygon( new int[] { 102, 102, 100, 100, 4, 2}, new int[] { 35, 2, 4, 33, 33, 35}, 6), 
  };
...
protected class pwr_smallbuttoncenter extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,1,-1,2F,2F,44.9362F,17.3617F, false,102, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    g.fill( shapes[1]);
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 24 * original_height / height * width / original_width- (float)g.getFont().getStringBounds(annot1, frc).getWidth()/2, 14F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
