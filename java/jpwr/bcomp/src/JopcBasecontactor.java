...
public class JopcBasecontactor extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup37;
  public JopcBasecontactor( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecontactor( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecontactor");
    ...
    pwr_valuelong5.setBounds(new Rectangle(15,40,364,20));
    ...
    pwr_mbopenobject6.setBounds(new Rectangle(193,19,17,17));
    ...
    pwr_mbtrend7.setBounds(new Rectangle(55,19,17,17));
    ...
    pwr_mbfast8.setBounds(new Rectangle(74,19,17,17));
    ...
    pwr_mbphoto9.setBounds(new Rectangle(94,19,17,17));
    ...
    pwr_mbdatasheet10.setBounds(new Rectangle(114,19,17,17));
    ...
    pwr_mbopenplc11.setBounds(new Rectangle(212,19,17,17));
    ...
    pwr_mbcircuitdiagram12.setBounds(new Rectangle(232,19,17,17));
    ...
    pwr_mbrtnavigator13.setBounds(new Rectangle(173,19,17,17));
    ...
    pwr_mbhelpclass14.setBounds(new Rectangle(252,19,17,17));
    ...
    pwr_mbblockevents15.setBounds(new Rectangle(153,19,17,17));
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(16,271,45,18));
    pwr_smallbuttoncenter19.setFillColor(102);
    ...
    pwr_valuesmall26.setBounds(new Rectangle(131,135,47,15));
    ...
    pwr_contactor227.setBounds(new Rectangle(241,112,108,108));
    pwr_contactor227.setFillColor(32);
    ...
    pwr_menubar228.setBounds(new Rectangle(0,-4,404,21));
    ...
    pwr_pulldownmenu229.setBounds(new Rectangle(10,-4,67,21));
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(325,-4,67,21));
    ...
    pwr_pulldownmenu231.setBounds(new Rectangle(149,-4,67,21));
    ...
    pwr_pulldownmenu232.setBounds(new Rectangle(68,-4,67,21));
    ...
    pwr_mbsimulate33.setBounds(new Rectangle(371,19,17,17));
    localPanel.add(pwr_mbsimulate33, new Proportion(pwr_mbsimulate33.getBounds(), dsize));
    grp97_34 = new Grp97_(session);
    grp97_34.setBounds(new Rectangle(31,115,57,16));
    localPanel.add(grp97_34, new Proportion(grp97_34.getBounds(), dsize));
    pwr_indsquare36 = new pwr_indsquare(session);
    pwr_indsquare36.setBounds(new Rectangle(144,254,13,14));
    ...
    pwr_mbup37 = new pwr_mbup(session);
    pwr_mbup37.setBounds(new Rectangle(351,19,17,17));
    localPanel.add(pwr_mbup37, new Proportion(pwr_mbup37.getBounds(), dsize));
    ...
    pwr_mbopenobject6.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenobject6.dd, JopLang.transl("Open Object"))
      });
    ...
    pwr_mbtrend7.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbtrend7.dd, JopLang.transl("Trend"))
      });
    ...
    pwr_mbfast8.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbfast8.dd, JopLang.transl("Fast"))
      });
    ...
    pwr_mbphoto9.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbphoto9.dd, JopLang.transl("Photo"))
      });
    ...
    pwr_mbdatasheet10.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbdatasheet10.dd, JopLang.transl("DataSheet"))
      });
    ...
    pwr_mbopenplc11.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbopenplc11.dd, JopLang.transl("Open Plc"))
      });
    ...
    pwr_mbcircuitdiagram12.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbcircuitdiagram12.dd, JopLang.transl("CircuitDiagram"))
      });
    ...
    pwr_mbrtnavigator13.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbrtnavigator13.dd, JopLang.transl("RtNavigator"))
      });
    ...
    pwr_mbhelpclass14.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelpclass14.dd, JopLang.transl("Help Class"))
      });
    ...
    pwr_mbblockevents15.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbblockevents15.dd, JopLang.transl("Block Events"))
      });
    ...
    pwr_mbhistevent16.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhistevent16.dd, JopLang.transl("Hist Event"))
      });
    ...
    pwr_mbnote17.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbnote17.dd, JopLang.transl("Note"))
      });
    ...
    pwr_mbhelp18.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynTipText(pwr_mbhelp18.dd, JopLang.transl("Help"))
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu231.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu231.dd, "open graph /class /inst=$object.Order")
      }),
    new GeDyn(pwr_pulldownmenu231,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu231.dd, "open graph /class /inst=$object.FeedBack")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp97_34.dd.setDynType(129);
    grp97_34.dd.setActionType(0);
    grp97_34.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp97_34.dd, "$object.DisableFeedback##Boolean",0)
      });
    pwr_indsquare36.dd.setDynType(5);
    pwr_indsquare36.dd.setActionType(0);
    pwr_indsquare36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare36.dd, "$object.SupDisabled##Boolean",29)
      });
    pwr_mbup37.dd.setDynType(129);
    pwr_mbup37.dd.setActionType(8256);
    pwr_mbup37.dd.setAccess(33619967);
    pwr_mbup37.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup37.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup37.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup37.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 303;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),32, 266);
    g.setTransform(save);
  }
