...
public class JopcBasepumpaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(93,408,84,74));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,517,48,21));
    ...
    grp173_55.setBounds(new Rectangle(69,368,40,17));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(168,433,12,21));
    ...
    pwr_overloadrelay65.setBounds(new Rectangle(248,335,38,27));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 54, 56, -1220087447, -39}, new int[] { 10, 12, -1220087397,10}, 4),
    ...
    new Polygon( new int[] { 6, 9, -37, -39}, new int[] { 14, 17, 10,10}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220087429, -21}, new int[] { 12, 15, -1220087367,40}, 4),
