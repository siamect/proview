...
public class JopcBasepumpaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump31.setBounds(new Rectangle(93,408,84,74));
    ...
    jopSmallbutton32.setBounds(new Rectangle(4,517,48,21));
    ...
    pwr_motor247.setBounds(new Rectangle(173,408,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,368,16,16));
    ...
    grp173_57.setBounds(new Rectangle(69,368,38,17));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(168,433,12,21));
    ...
    grp184_62.setBounds(new Rectangle(30,193,43,18));
...
null,    new GeDyn(pwr_pulldownmenu46,1,65,33619964,new GeDynElemIfc[] {
