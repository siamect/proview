...
public class JopcBasecvalve4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_valvecontrol2	pwr_valvecontrol233;
  ...
  JopSmallbutton	jopSmallbutton48;
  pwr_indround	pwr_indround49;
  pwr_indround	pwr_indround50;
  pwr_sliderbackground1_2	pwr_sliderbackground1_252;
  pwr_slider1	pwr_slider153;
  pwr_valueinputsmallrd	pwr_valueinputsmallrd54;
  pwr_indsquare	pwr_indsquare57;
  pwr_indsquare	pwr_indsquare58;
  Grp167_	grp167_59;
  pwr_mbsimulate	pwr_mbsimulate60;
  pwr_actuator	pwr_actuator61;
  pwr_basevalve	pwr_basevalve62;
  ...
  public JopcBasecvalve4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    jopSmallbutton21.setBounds(new Rectangle(17,667,47,21));
    ...
    pwr_valuesmall25.setBounds(new Rectangle(340,391,50,17));
    ...
    pwr_sliderbackground326.setBounds(new Rectangle(337,132,120,243));
    ...
    pwr_pulldownmenu31.setBounds(new Rectangle(267,0,69,24));
    ...
    pwr_pulldownmenu32.setBounds(new Rectangle(69,0,69,24));
    pwr_pulldownmenu32.setShadow(1);
    localPanel.add(pwr_pulldownmenu32, new Proportion(pwr_pulldownmenu32.getBounds(), dsize));
    pwr_valvecontrol233 = new pwr_valvecontrol2(session);
    pwr_valvecontrol233.setBounds(new Rectangle(110,115,66,43));
    pwr_valvecontrol233.setShadow(1);
    localPanel.add(pwr_valvecontrol233, new Proportion(pwr_valvecontrol233.getBounds(), dsize));
    pwr_indsquare37 = new pwr_indsquare(session);
    pwr_indsquare37.setBounds(new Rectangle(165,185,15,17));
    ...
    pwr_indsquare38.setBounds(new Rectangle(166,204,16,17));
    pwr_indsquare38.setFillColor(294);
    pwr_indsquare38.setShadow(1);
    localPanel.add(pwr_indsquare38, new Proportion(pwr_indsquare38.getBounds(), dsize));
    jopBar44 = new JopBar(session);
    jopBar44.setBounds(new Rectangle(355,132,24,242));
    jopBar44.setFillColor(39);
    jopBar44.setBorderColor(0);
    jopBar44.setFillColorBar(167);
    jopBar44.setBorderColorBar(161);
    jopBar44.setDrawFill(1);
    jopBar44.setDrawBorder(1);
    jopBar44.setBarBorderWidth(1);
    jopBar44.setLineWidth(1);
    jopBar44.setMinValue(0F);
    jopBar44.setMaxValue(100F);
    jopBar44.setRotate(0);
    localPanel.add(jopBar44, new Proportion(jopBar44.getBounds(), dsize));
    jopBar45 = new JopBar(session);
    jopBar45.setBounds(new Rectangle(409,132,24,242));
    jopBar45.setFillColor(58);
    jopBar45.setBorderColor(0);
    jopBar45.setFillColorBar(105);
    jopBar45.setBorderColorBar(101);
    jopBar45.setDrawFill(1);
    jopBar45.setDrawBorder(1);
    jopBar45.setBarBorderWidth(1);
    jopBar45.setLineWidth(1);
    jopBar45.setMinValue(0F);
    jopBar45.setMaxValue(100F);
    jopBar45.setRotate(0);
    localPanel.add(jopBar45, new Proportion(jopBar45.getBounds(), dsize));
    jopAxis46 = new JopAxis();
    jopAxis46.setBounds(new Rectangle(327,134,11,238));
    jopAxis46.setBorderColor(0);
    jopAxis46.setTextColor(0);
    jopAxis46.setLineWidth(1);
    jopAxis46.setMinValue(0F);
    jopAxis46.setMaxValue(0F);
    jopAxis46.setLines(51);
    jopAxis46.setLongQuotient(5);
    jopAxis46.setValueQuotient(5);
    jopAxis46.setLineLength(11);
    jopAxis46.setLineWidth(1);
    jopAxis46.setRotate(0);
    jopAxis46.setFont(new Font("Helvetica", Font.PLAIN, 10));
    jopAxis46.setFormat("%3.0f");
    localPanel.add(jopAxis46, new Proportion(jopAxis46.getBounds(), dsize));
    pwr_valuesmall47 = new pwr_valuesmall(session);
    pwr_valuesmall47.setBounds(new Rectangle(397,391,50,17));
    localPanel.add(pwr_valuesmall47, new Proportion(pwr_valuesmall47.getBounds(), dsize));
    jopSmallbutton48 = new JopSmallbutton(session);
    jopSmallbutton48.setBounds(new Rectangle(36,365,48,21));
    jopSmallbutton48.setFillColor(32);
    localPanel.add(jopSmallbutton48, new Proportion(jopSmallbutton48.getBounds(), dsize));
    pwr_indround49 = new pwr_indround(session);
    pwr_indround49.setBounds(new Rectangle(96,344,18,18));
    ...
    pwr_indround50.setBounds(new Rectangle(96,366,18,18));
    pwr_indround50.setShadow(1);
    localPanel.add(pwr_indround50, new Proportion(pwr_indround50.getBounds(), dsize));
    pwr_sliderbackground1_252 = new pwr_sliderbackground1_2(session);
    pwr_sliderbackground1_252.setBounds(new Rectangle(474,119,34,269));
    pwr_sliderbackground1_252.setShadow(1);
    localPanel.add(pwr_sliderbackground1_252, new Proportion(pwr_sliderbackground1_252.getBounds(), dsize));
    pwr_slider153 = new pwr_slider1(session);
    pwr_slider153.setBounds(new Rectangle(478,301,34,32));
    localPanel.add(pwr_slider153, new Proportion(pwr_slider153.getBounds(), dsize));
    pwr_valueinputsmallrd54 = new pwr_valueinputsmallrd(session);
    pwr_valueinputsmallrd54.setBounds(new Rectangle(464,388,56,24));
    pwr_valueinputsmallrd54.setColorBrightness(-2);
    pwr_valueinputsmallrd54.setShadow(1);
    localPanel.add(pwr_valueinputsmallrd54, new Proportion(pwr_valueinputsmallrd54.getBounds(), dsize));
    pwr_indsquare57 = new pwr_indsquare(session);
    pwr_indsquare57.setBounds(new Rectangle(165,237,15,17));
    ...
    pwr_indsquare58.setBounds(new Rectangle(166,256,16,17));
    ...
    grp167_59 = new Grp167_(session);
    grp167_59.setBounds(new Rectangle(472,106,46,18));
    localPanel.add(grp167_59, new Proportion(grp167_59.getBounds(), dsize));
    pwr_mbsimulate60 = new pwr_mbsimulate(session);
    pwr_mbsimulate60.setBounds(new Rectangle(508,24,20,20));
    localPanel.add(pwr_mbsimulate60, new Proportion(pwr_mbsimulate60.getBounds(), dsize));
    pwr_actuator61 = new pwr_actuator(session);
    pwr_actuator61.setBounds(new Rectangle(260,453,132,84));
    pwr_actuator61.setShadow(1);
    localPanel.add(pwr_actuator61, new Proportion(pwr_actuator61.getBounds(), dsize));
    pwr_basevalve62 = new pwr_basevalve(session);
    pwr_basevalve62.setBounds(new Rectangle(285,533,80,122));
    pwr_basevalve62.setShadow(1);
    localPanel.add(pwr_basevalve62, new Proportion(pwr_basevalve62.getBounds(), dsize));
    pwr_pulldownmenu65 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu65.setBounds(new Rectangle(160,0,69,24));
    ...
    jopSmallbutton66.setBounds(new Rectangle(36,342,48,21));
    ...
    pwr_indround67.setBounds(new Rectangle(96,397,18,18));
    pwr_indround67.setFillColor(114);
    pwr_indround67.setShadow(1);
    localPanel.add(pwr_indround67, new Proportion(pwr_indround67.getBounds(), dsize));
    grp175_68 = new Grp175_(session);
    grp175_68.setBounds(new Rectangle(39,396,35,17));
    localPanel.add(grp175_68, new Proportion(grp175_68.getBounds(), dsize));
    pwr_indsquare69 = new pwr_indsquare(session);
    pwr_indsquare69.setBounds(new Rectangle(182,487,16,16));
    pwr_indsquare69.setFillColor(114);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuesmall25.dd.setActionType(2);
    pwr_valuesmall25.dd.setAccess(65532);
    pwr_valuesmall25.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall25.dd, "$object.Actuator.Position.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall25.dd, "$object.Actuator.Position")
      });
    ...
    pwr_pulldownmenu31.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu31.dd, "open graph /class /inst=$object.Actuator.Position")
      }),
    new GeDyn(pwr_pulldownmenu31,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu31.dd, "open graph /class /inst=$object.Actuator.Order")
      }),
    new GeDyn(pwr_pulldownmenu31,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu31.dd, "open graph /class /inst=$object.Actuator.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu31,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu31.dd, "open graph /class /inst=$object.Actuator.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valvecontrol233.dd.setDynType(1034);
    pwr_valvecontrol233.dd.setActionType(0);
    pwr_valvecontrol233.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_valvecontrol233.dd, "$object.Actuator.IndError##Boolean",41)
      ,new GeDynDigColor(pwr_valvecontrol233.dd, "$object.Actuator.IndWarning##Boolean",30)
      ,new GeDynValue(pwr_valvecontrol233.dd, "$object.Mode.IndMode##String8","%s")
      });
    ...
    pwr_indsquare37.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare37.dd, "$object.Actuator.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare37.dd, "$object.Actuator.SwitchOpen")
      });
    ...
    pwr_indsquare38.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare38.dd, "$object.Actuator.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare38.dd, "$object.Actuator.SwitchClosed")
      });
    jopBar44.setPwrAttribute("$object.Actuator.Position.ActualValue##Float32");
    jopBar44.setMinValueAttr("$object.Actuator.Order.PresMinLimit##Float32");
    jopBar44.setMaxValueAttr("$object.Actuator.Order.PresMaxLimit##Float32");
    jopBar45.setPwrAttribute("$object.Actuator.Order.ActualValue##Float32");
    jopBar45.setMinValueAttr("$object.Actuator.Order.PresMinLimit##Float32");
    jopBar45.setMaxValueAttr("$object.Actuator.Order.PresMaxLimit##Float32");
    pwr_valuesmall47.dd.setDynType(1025);
    pwr_valuesmall47.dd.setActionType(2);
    pwr_valuesmall47.dd.setAccess(65532);
    pwr_valuesmall47.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall47.dd, "$object.Actuator.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall47.dd, "$object.Actuator.Order")
      });
    jopSmallbutton48.dd.setDynType(129);
    jopSmallbutton48.dd.setActionType(4);
    jopSmallbutton48.dd.setAccess(65532);
    jopSmallbutton48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton48.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton48.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    jopSmallbutton48.setAnnot1(" Auto");
    pwr_indround49.dd.setDynType(133);
    pwr_indround49.dd.setActionType(0);
    pwr_indround49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround49.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround49.dd, "$object.Actuator.Mode.ManMode##Boolean",29)
      });
    pwr_indround50.dd.setDynType(133);
    pwr_indround50.dd.setActionType(0);
    pwr_indround50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround50.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround50.dd, "!$object.Actuator.Mode.ManMode##Boolean",29)
      });
    pwr_sliderbackground1_252.dd.setDynType(524417);
    pwr_sliderbackground1_252.dd.setActionType(0);
    pwr_sliderbackground1_252.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_252.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_slider153.dd.setDynType(129);
    pwr_slider153.dd.setActionType(2048);
    pwr_slider153.dd.setAccess(65532);
    pwr_slider153.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider153.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider153.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,122.911,361.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",
null)
      });
    pwr_valueinputsmallrd54.dd.setDynType(1153);
    pwr_valueinputsmallrd54.dd.setActionType(4096);
    pwr_valueinputsmallrd54.dd.setAccess(65532);
    pwr_valueinputsmallrd54.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd54.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd54.dd, "$object.Actuator.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd54.dd, 0,0,"$object.Actuator.Mode.OpMinRefMan##Float32","$object.Actuator.Mode.OpMaxRefMan##Float32")
      });
    pwr_indsquare57.dd.setDynType(5);
    pwr_indsquare57.dd.setActionType(0);
    pwr_indsquare57.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare57.dd, "$object.Actuator.DiffPosError##Boolean",29)
      });
    pwr_indsquare58.dd.setDynType(5);
    pwr_indsquare58.dd.setActionType(0);
    pwr_indsquare58.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare58.dd, "$object.Actuator.SwitchError##Boolean",29)
      });
    grp167_59.dd.setDynType(129);
    grp167_59.dd.setActionType(0);
    grp167_59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_59.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_actuator61.dd.setDynType(1);
    pwr_actuator61.dd.setActionType(66);
    pwr_actuator61.dd.setAccess(65532);
    pwr_actuator61.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator61.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator61.dd, "open graph/class/inst=$object.Actuator")
      });
    pwr_basevalve62.dd.setDynType(16385);
    pwr_basevalve62.dd.setActionType(66);
    pwr_basevalve62.dd.setAccess(65532);
    pwr_basevalve62.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve62.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve62.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve62.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_pulldownmenu65.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu65.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu65,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu65.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu65,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu65.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu65.setAnnot1("Components");
    jopSmallbutton66.dd.setDynType(128);
    jopSmallbutton66.dd.setActionType(4);
    jopSmallbutton66.dd.setAccess(65532);
    jopSmallbutton66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton66.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton66.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    jopSmallbutton66.setAnnot1(" Man");
    pwr_indround67.dd.setDynType(133);
    pwr_indround67.dd.setActionType(0);
    pwr_indround67.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround67.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround67.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_68.dd.setDynType(129);
    grp175_68.dd.setActionType(0);
    grp175_68.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_68.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare69.dd.setDynType(13);
    pwr_indsquare69.dd.setActionType(0);
    pwr_indsquare69.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare69.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare69.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Position error",38, 251);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Switch error",38, 271);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
