...
public class JopcBasecvalve4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare35.setBounds(new Rectangle(166,177,13,15));
    ...
    pwr_indsquare36.setBounds(new Rectangle(167,196,14,15));
    ...
    pwr_indsquare55.setBounds(new Rectangle(166,222,13,15));
    ...
    pwr_indsquare56.setBounds(new Rectangle(167,241,14,15));
    ...
    pwr_basevalve60 = new pwr_basevalve(session);
    pwr_basevalve60.setBounds(new Rectangle(286,534,78,120));
    pwr_basevalve60.setShadow(1);
    localPanel.add(pwr_basevalve60, new Proportion(pwr_basevalve60.getBounds(), dsize));
    pwr_pulldownmenu263 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu263.setBounds(new Rectangle(161,1,67,22));
    ...
    pwr_smallbuttoncenter64.setBounds(new Rectangle(37,343,46,19));
    ...
    pwr_indround65.setBounds(new Rectangle(97,398,16,16));
    ...
    grp175_66 = new Grp175_(session);
    grp175_66.setBounds(new Rectangle(40,397,35,15));
    localPanel.add(grp175_66, new Proportion(grp175_66.getBounds(), dsize));
    pwr_indsquare67 = new pwr_indsquare(session);
    pwr_indsquare67.setBounds(new Rectangle(183,488,14,14));
    pwr_indsquare67.setFillColor(114);
    ...
    pwr_valvecontrol270.setBounds(new Rectangle(111,116,64,41));
    ...
    pwr_indsquare73.setBounds(new Rectangle(167,270,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_slider151.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider151.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,533.014,685.913)
      });
    ...
    pwr_basevalve60.dd.setDynType(16385);
    pwr_basevalve60.dd.setActionType(66);
    pwr_basevalve60.dd.setAccess(65532);
    pwr_basevalve60.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basevalve60.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basevalve60.dd, "$object.Valve")
      ,new GeDynCommand(pwr_basevalve60.dd, "open graph/class/inst=$object.Valve")
      });
    ...
    pwr_pulldownmenu263.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu263.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu263,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu263.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu263,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu263.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu263.setAnnot1("Components");
    pwr_smallbuttoncenter64.dd.setDynType(128);
    pwr_smallbuttoncenter64.dd.setActionType(4);
    pwr_smallbuttoncenter64.dd.setAccess(65532);
    pwr_smallbuttoncenter64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter64.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter64.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter64.setAnnot1("Man");
    pwr_indround65.dd.setDynType(133);
    pwr_indround65.dd.setActionType(0);
    pwr_indround65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround65.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround65.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_66.dd.setDynType(129);
    grp175_66.dd.setActionType(0);
    grp175_66.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_66.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare67.dd.setDynType(13);
    pwr_indsquare67.dd.setActionType(0);
    pwr_indsquare67.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare67.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare67.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    ...
    pwr_valvecontrol270.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynValue(pwr_valvecontrol270.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.3792F, 23.1001F, 532.635F, 22.4305F),
    ...
    new Rectangle2D.Float(53.9203F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 54, 114, 112, 56, 56, 54}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 114, 114, 112, 112, 56, 54}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
    new Rectangle2D.Float(149.166F, 144.03F, 60.4167F, 6F),
    new Polygon( new int[] { 149, 210, 207, 151, 151, 149}, new int[] { 144, 144, 146, 146, 148, 150}, 6), 
    new Polygon( new int[] { 210, 210, 207, 207, 151, 149}, new int[] { 150, 144, 146, 148, 148, 150}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.3792F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.3792F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SwitchOpen"),38, 190);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SwitchClosed"),38, 210);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Position error"),38, 235);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch error"),38, 255);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 281);
    g.setTransform(save);
  }
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 113, 32}, new int[] { 22, 26, -1219915280,-2147483648}, 4),
    ...
    new Polygon( new int[] { 42, 40, 113, 32}, new int[] { 22, 26, -1219915280,23}, 4),
