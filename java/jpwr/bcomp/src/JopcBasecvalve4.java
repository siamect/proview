...
public class JopcBasecvalve4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare35.setBounds(new Rectangle(165,176,15,17));
    ...
    pwr_indsquare36.setBounds(new Rectangle(166,195,16,17));
    ...
    pwr_indsquare55.setBounds(new Rectangle(165,221,15,17));
    ...
    pwr_indsquare56.setBounds(new Rectangle(166,240,16,17));
    ...
    pwr_basevalve60.setBounds(new Rectangle(285,533,80,122));
    ...
    pwr_pulldownmenu263.setBounds(new Rectangle(160,0,69,24));
    ...
    pwr_smallbuttoncenter64.setBounds(new Rectangle(36,342,48,21));
    ...
    pwr_indround65.setBounds(new Rectangle(96,397,18,18));
    ...
    pwr_valvecontrol270.setBounds(new Rectangle(110,115,66,43));
    ...
    pwr_indsquare73.setBounds(new Rectangle(166,269,16,17));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 2569, 32}, new int[] { 22, 26, 140885183,23}, 4),
    ...
    new Polygon( new int[] { 42, 40, 2569, 32}, new int[] { 22, 26, 140885183,23}, 4),
