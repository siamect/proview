...
public class JopcBasepumpaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump32.setBounds(new Rectangle(92,384,82,72));
    ...
    pwr_indsquare8.setBounds(new Rectangle(186,316,14,15));
    ...
    pwr_smallbuttoncenter11.setBounds(new Rectangle(29,169,46,19));
    ...
    pwr_indround12.setBounds(new Rectangle(90,172,16,16));
    ...
    pwr_indround13.setBounds(new Rectangle(90,194,16,15));
    ...
    pwr_smallbuttoncenter14.setBounds(new Rectangle(117,192,59,19));
    ...
    pwr_indround29.setBounds(new Rectangle(89,217,16,16));
    ...
    pwr_valuesmall47.setBounds(new Rectangle(283,217,69,16));
    ...
    pwr_smallbuttoncenter51.setBounds(new Rectangle(117,170,59,19));
    ...
    pwr_indsquare53.setBounds(new Rectangle(186,344,14,14));
    ...
    pwr_rodcouplinganim56.setBounds(new Rectangle(168,409,10,19));
    ...
    pwr_pumpanim257.setBounds(new Rectangle(103,96,62,42));
    ...
    grp186_58.setBounds(new Rectangle(31,194,39,16));
...
protected class pwr_pump3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 7709, 28}, new int[] { 40, 36, -1219915386,-2147483648}, 4),
    ...
    new Polygon( new int[] { 54, 56, -1219915347, 28}, new int[] { 10, 12, -1219915386,-10}, 4),
    ...
    new Polygon( new int[] { 6, 11, -1219915347, 28}, new int[] { 14, 17, -1219915386,-2147483648}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915329, 46}, new int[] { 12, 15, -1219915356,19}, 4),
