...
public class JopcBasepumpaggr11 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pump31.setBounds(new Rectangle(91,383,84,74));
    ...
    grp186_58.setBounds(new Rectangle(30,193,43,18));
...
null,null,    new GeDyn(pwr_pulldownmenu43,1,65,65535,new GeDynElemIfc[] {
