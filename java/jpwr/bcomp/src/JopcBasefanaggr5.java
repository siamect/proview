...
public class JopcBasefanaggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod30.setBounds(new Rectangle(138,391,39,10));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(4,463,47,21));
    ...
    pwr_valuelong32.setBounds(new Rectangle(60,462,336,23));
    ...
    pwr_fananim37.setBounds(new Rectangle(123,349,19,91));
    ...
    grp173_56.setBounds(new Rectangle(69,319,40,18));
    ...
    grp180_59.setBounds(new Rectangle(30,193,41,18));
    ...
    pwr_motor262.setBounds(new Rectangle(173,359,98,74));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706466, 13}, new int[] { 12, 15, -1219706448,31}, 4),
