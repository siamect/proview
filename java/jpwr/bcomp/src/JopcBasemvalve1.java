...
public class JopcBasemvalve1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup51;
  public JopcBasemvalve1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemvalve1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter23.setBounds(new Rectangle(17,409,47,21));
    ...
    pwr_valuelong25.setBounds(new Rectangle(74,408,336,23));
    ...
    pwr_indsquare29.setBounds(new Rectangle(166,185,15,17));
    ...
    pwr_indsquare37.setBounds(new Rectangle(166,224,16,17));
    ...
    pwr_indsquare46.setBounds(new Rectangle(166,244,16,17));
    ...
    grp197_48 = new Grp197_(session);
    grp197_48.setBounds(new Rectangle(39,363,37,18));
    localPanel.add(grp197_48, new Proportion(grp197_48.getBounds(), dsize));
    pwr_indsquare50 = new pwr_indsquare(session);
    pwr_indsquare50.setBounds(new Rectangle(166,393,16,17));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare29.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare29.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare29.dd, "$object.SwitchOpen")
      });
    ...
    pwr_valveanim243.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_valveanim243.dd, "$object.SwitchOpen.ActualValue##Boolean",31)
      ,new GeDynValue(pwr_valveanim243.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynAnimation(pwr_valveanim243.dd, "!$object.SwitchOpen.ActualValue##Boolean",2)
      });
    ...
    grp197_48.dd.setDynType(129);
    grp197_48.dd.setActionType(0);
    grp197_48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp197_48.dd, "!$object.Mode.LocalUsed##Boolean",0)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 431;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(17.9999F, 279.14F, 237.944F, 108.807F),
    new Polygon( new int[] { 18, 256, 255, 19, 19, 18}, new int[] { 279, 279, 280, 280, 387, 388}, 6), 
    new Polygon( new int[] { 256, 256, 255, 255, 19, 18}, new int[] { 388, 279, 280, 387, 387, 388}, 6), 
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),40, 406);
    g.setTransform(save);
  }
...
protected class pwr_valveanim2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 10, 152, 55}, new int[] { 22, 27, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 46, 46, 152, 55}, new int[] { 22, 27, -1219706448,-2147483648}, 4),
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 9, 12, 152, 55}, new int[] { 17, 22, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 48, 47, 152, 55}, new int[] { 28, 31, -1219706448,-2147483648}, 4),
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 16, 152, 55}, new int[] { 13, 17, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 48, 48, 152, 55}, new int[] { 33, 34, -1219706448,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p4 = new Shape[] { 
    ...
    new Polygon( new int[] { 19, 20, 152, 55}, new int[] { 11, 17, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 47, 45, 152, 55}, new int[] { 39, 40, -1219706448,-2147483648}, 4),
    new Rectangle2D.Float(50F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p5 = new Shape[] { 
    ...
    new Polygon( new int[] { 25, 26, 152, 55}, new int[] { 10, 14, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 45, 45, 152, 55}, new int[] { 44, 44, -1219706448,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 30, 29, 152, 55}, new int[] { 10, 15, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 41, 39, 152, 55}, new int[] { 49, 48, -1219706448,-2147483648}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 36, 35, 152, 55}, new int[] { 12, 16, -1219706448,-2147483648}, 4),
    ...
    new Polygon( new int[] { 36, 35, 152, 55}, new int[] { 52, 50, -1219706448,-2147483648}, 4),
