...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu226.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu226.dd, new String[] {
        "Order Do","SwitchOpen Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "SwitchOpen",38, 200);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Mode",38, 300);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Order",38, 240);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Man",163, 300);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( "Interlock",38, 260);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 10));
    g.drawString( "Supervision disabled",40, 406);
    g.setTransform(save);
  }
...
protected class pwr_valveanim2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 10, 80, 55}, new int[] { 22, 27, 33,31}, 4),
    ...
    new Polygon( new int[] { 46, 46, 80, 55}, new int[] { 22, 27, 33,31}, 4),
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 9, 12, 80, 55}, new int[] { 17, 22, 33,31}, 4),
    ...
    new Polygon( new int[] { 48, 47, 80, 55}, new int[] { 28, 31, 33,31}, 4),
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 14, 16, 80, 55}, new int[] { 13, 17, 33,31}, 4),
    ...
    new Polygon( new int[] { 48, 48, 80, 55}, new int[] { 33, 34, 33,31}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p4 = new Shape[] { 
    ...
    new Polygon( new int[] { 19, 20, 80, 55}, new int[] { 11, 17, 33,31}, 4),
    ...
    new Polygon( new int[] { 47, 45, 80, 55}, new int[] { 39, 40, 33,31}, 4),
    new Rectangle2D.Float(50F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p5 = new Shape[] { 
    ...
    new Polygon( new int[] { 25, 26, 80, 55}, new int[] { 10, 14, 33,31}, 4),
    ...
    new Polygon( new int[] { 45, 45, 80, 55}, new int[] { 44, 44, 33,31}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p6 = new Shape[] { 
    ...
    new Polygon( new int[] { 30, 29, 80, 55}, new int[] { 10, 15, 33,31}, 4),
    ...
    new Polygon( new int[] { 41, 39, 80, 55}, new int[] { 49, 48, 33,31}, 4),
    new Rectangle2D.Float(50.0001F, 12F, 20F, 16F),
  };
  ...
  Shape[] shapes_p7 = new Shape[] { 
    ...
    new Polygon( new int[] { 36, 35, 80, 55}, new int[] { 12, 16, 33,31}, 4),
    ...
    new Polygon( new int[] { 36, 35, 80, 55}, new int[] { 52, 50, 33,31}, 4),
