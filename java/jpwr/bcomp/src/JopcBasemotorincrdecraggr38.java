...
public class JopcBasemotorincrdecraggr38 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton72.setBounds(new Rectangle(151,169,62,21));
    ...
    jopSmallbutton74.setBounds(new Rectangle(151,216,62,21));
    ...
    jopSmallbutton75.setBounds(new Rectangle(152,193,62,21));
    ...
    jopSmallbutton76.setBounds(new Rectangle(152,169,62,21));
