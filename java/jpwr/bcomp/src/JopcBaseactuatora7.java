...
public class JopcBaseactuatora7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar26.setBounds(new Rectangle(0,0,538,24));
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(17,430,47,21));
    ...
    pwr_valuelong24.setBounds(new Rectangle(74,429,336,23));
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(153,0,69,24));
    ...
    pwr_actuator52.setBounds(new Rectangle(101,117,68,44));
    ...
    pwr_indsquare58.setBounds(new Rectangle(166,259,16,17));
