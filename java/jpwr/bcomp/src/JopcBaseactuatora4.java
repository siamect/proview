...
public class JopcBaseactuatora4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp167_	grp167_57;
  pwr_actuator	pwr_actuator58;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter59;
  pwr_indround	pwr_indround60;
  Grp175_	grp175_61;
  pwr_mbup	pwr_mbup62;
  pwr_indsquare	pwr_indsquare64;
  public JopcBaseactuatora4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatora4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatora4");
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(18,430,45,19));
    ...
    pwr_valuelong24.setBounds(new Rectangle(75,429,334,21));
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(159,1,67,22));
    ...
    pwr_actuator58 = new pwr_actuator(session);
    pwr_actuator58.setBounds(new Rectangle(110,112,66,42));
    pwr_actuator58.setShadow(1);
    localPanel.add(pwr_actuator58, new Proportion(pwr_actuator58.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valueinputreliefup28.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup28.dd, "$object.Order.PresMaxLimit##Float32","%5.1f")
    ...
    pwr_valueinputreliefup29.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valueinputreliefup29.dd, "$object.Order.PresMinLimit##Float32","%5.1f")
    ...
    new GeDyn(pwr_pulldownmenu230,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu230.dd, "open graph /class /inst=$object.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare35.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare35.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare35.dd, "$object.SwitchOpen")
      });
    ...
    pwr_indsquare36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare36.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare36.dd, "$object.SwitchClosed")
      });
    jopBar42.setPwrAttribute("$object.Position.ActualValue##Float32");
    jopBar42.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar42.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    jopBar43.setPwrAttribute("$object.Order.ActualValue##Float32");
    jopBar43.setMinValueAttr("$object.Order.PresMinLimit##Float32");
    jopBar43.setMaxValueAttr("$object.Order.PresMaxLimit##Float32");
    ...
    pwr_valuesmall45.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall45.dd, "$object.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall45.dd, "$object.Order")
      });
    ...
    pwr_smallbuttoncenter46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter46.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter46.dd, "$object.Mode.OpAuto##Boolean")
      });
    ...
    pwr_indround47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround47.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround47.dd, "$object.Mode.ManMode##Boolean",29)
      });
    pwr_indround48.dd.setDynType(133);
    pwr_indround48.dd.setActionType(0);
    pwr_indround48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround48.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround48.dd, "!$object.Mode.ManMode##Boolean",29)
      });
    ...
    pwr_slider151.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider151.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider151.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,527.025,447.913)
      });
    ...
    pwr_valueinputsmallrd52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd52.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd52.dd, "$object.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd52.dd, 0,0,"$object.Mode.OpMinRefMan##Float32","$object.Mode.OpMaxRefMan##Float32")
      });
    ...
    pwr_indsquare55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare55.dd, "$object.DiffPosError##Boolean",29)
      });
    pwr_indsquare56.dd.setDynType(5);
    pwr_indsquare56.dd.setActionType(0);
    pwr_indsquare56.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare56.dd, "$object.SwitchError##Boolean",29)
      });
    ...
    pwr_actuator58.dd.setDynType(1);
    pwr_actuator58.dd.setActionType(0);
    ...
    pwr_smallbuttoncenter59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter59.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter59.dd, "$object.Mode.OpMan##Boolean")
      });
    ...
    pwr_indround60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround60.dd, "$object.Mode.OpNoLocal##Boolean",0)
    ...
    grp175_61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_61.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
    ...
    pwr_indsquare64.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare64.dd, "$object.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 451;
  double rotate;
