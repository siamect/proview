...
public class JopcBaseactuatora4 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_menubar3.setBounds(new Rectangle(0,0,529,24));
    ...
    pwr_pulldownmenu5.setBounds(new Rectangle(445,0,69,24));
    ...
    pwr_valuesmall23.setBounds(new Rectangle(340,391,50,17));
    ...
    pwr_sliderbackground324.setBounds(new Rectangle(337,132,120,243));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(147,0,69,24));
    ...
    pwr_indsquare32.setBounds(new Rectangle(171,109,16,17));
    ...
    pwr_indsquare33.setBounds(new Rectangle(172,128,16,17));
    ...
    jopBar39.setBounds(new Rectangle(355,132,24,242));
    ...
    jopBar40.setBounds(new Rectangle(409,132,24,242));
    ...
    pwr_valuesmall42.setBounds(new Rectangle(397,391,50,17));
    localPanel.add(pwr_valuesmall42, new Proportion(pwr_valuesmall42.getBounds(), dsize));
    pwr_actuator43 = new pwr_actuator(session);
    pwr_actuator43.setBounds(new Rectangle(56,237,132,84));
    pwr_actuator43.setShadow(1);
    localPanel.add(pwr_actuator43, new Proportion(pwr_actuator43.getBounds(), dsize));
    pwr_indround44 = new pwr_indround(session);
    pwr_indround44.setBounds(new Rectangle(105,388,17,18));
    ...
    grp173_45 = new Grp173_(session);
    grp173_45.setBounds(new Rectangle(48,387,35,18));
    localPanel.add(grp173_45, new Proportion(grp173_45.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuesmall23.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall23.dd, "$object.Position.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall23.dd, "$object.Position")
      });
    ...
    pwr_pulldownmenu27.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu27.dd, "open graph /class /inst=$object.Position")
      }),
    new GeDyn(pwr_pulldownmenu27,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu27.dd, "open graph /class /inst=$object.Order")
      }),
    new GeDyn(pwr_pulldownmenu27,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu27.dd, "open graph /class /inst=$object.SwitchOpen")
      }),
    new GeDyn(pwr_pulldownmenu27,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu27.dd, "open graph /class /inst=$object.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare32.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare32.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare32.dd, "$object.SwitchOpen")
      });
    ...
    pwr_indsquare33.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare33.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare33.dd, "$object.SwitchClosed")
      });
    ...
    pwr_actuator43.dd.setDynType(1);
    pwr_actuator43.dd.setActionType(2);
    pwr_actuator43.dd.setAccess(65532);
    pwr_actuator43.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator43.dd, "$object.Actuator")
      });
    pwr_indround44.dd.setDynType(133);
    pwr_indround44.dd.setActionType(0);
    pwr_indround44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround44.dd, "$object.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround44.dd, "$object.Mode.LocalMode##Boolean",29)
      });
    grp173_45.dd.setDynType(129);
    grp173_45.dd.setActionType(0);
    grp173_45.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp173_45.dd, "$object.Mode.OpNoLocal##Boolean",0)
      });
