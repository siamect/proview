...
public class JopcBaseelheater extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_elheater3	pwr_elheater330;
  pwr_mbup	pwr_mbup31;
  public JopcBaseelheater( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseelheater( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseelheater");
    ...
    pwr_indsquare19.setBounds(new Rectangle(159,113,13,15));
    pwr_indsquare19.setFillColor(114);
    ...
    pwr_menubar221.setBounds(new Rectangle(1,1,407,22));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(251,1,67,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(147,1,87,22));
    ...
    pwr_elheater330 = new pwr_elheater3(session);
    pwr_elheater330.setBounds(new Rectangle(213,114,162,42));
    pwr_elheater330.setShadow(1);
    localPanel.add(pwr_elheater330, new Proportion(pwr_elheater330.getBounds(), dsize));
    ...
    pwr_indsquare19.dd.setDynType(21);
    pwr_indsquare19.dd.setActionType(0);
    pwr_indsquare19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare19.dd, "$object.IndError##Boolean")
      ,new GeDynDigLowColor(pwr_indsquare19.dd, "$object.IndWarning##Boolean",29)
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.TempSwitch.Switch")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu226.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$object.DisableTempSwitch##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "open graph /class /inst=$object.TempSwitch")
      }),
    new GeDyn(pwr_pulldownmenu226,129,65,33619964,new GeDynElemIfc[] {
      new GeDynInvisible(pwr_pulldownmenu226.dd, "$object.DisableTempSensor##Boolean",0)
      ,new GeDynCommand(pwr_pulldownmenu226.dd, "open graph /class /inst=$object.TempSensor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu226.setAnnot1("Components");
    ...
    pwr_indsquare29.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare29.dd, "$object.SupDisabled##Boolean",29)
      });
    pwr_elheater330.dd.setDynType(9);
    pwr_elheater330.dd.setActionType(0);
    pwr_elheater330.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_elheater330.dd, "$object.IndError##Boolean",174)
      });
...
protected class pwr_elheater3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 62, 61, -7, -56}, new int[] { 6, 7, -1219915419,-43}, 4),
