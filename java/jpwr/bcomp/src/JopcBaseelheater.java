...
public class JopcBaseelheater extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare19.setBounds(new Rectangle(158,112,15,17));
    ...
    pwr_menubar221.setBounds(new Rectangle(0,0,409,24));
    ...
    pwr_pulldownmenu223.setBounds(new Rectangle(328,0,69,24));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(250,0,69,24));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(146,0,89,24));
    ...
    pwr_elheater330.setBounds(new Rectangle(212,113,164,44));
