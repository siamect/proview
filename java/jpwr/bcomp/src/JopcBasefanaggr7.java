...
public class JopcBasefanaggr7 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_fananim	pwr_fananim35;
  pwr_fananim2	pwr_fananim236;
  ...
  pwr_mbup	pwr_mbup60;
  public JopcBasefanaggr7( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefanaggr7( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefanaggr7");
    ...
    pwr_indround11.setBounds(new Rectangle(89,193,18,18));
    ...
    pwr_smallbuttoncenter12.setBounds(new Rectangle(115,192,61,21));
    ...
    pwr_rod29.setBounds(new Rectangle(138,365,39,10));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,445,48,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,444,336,23));
    ...
    pwr_fananim35 = new pwr_fananim(session);
    pwr_fananim35.setBounds(new Rectangle(123,323,19,91));
    pwr_fananim35.setShadow(1);
    localPanel.add(pwr_fananim35, new Proportion(pwr_fananim35.getBounds(), dsize));
    pwr_fananim236 = new pwr_fananim2(session);
    pwr_fananim236.setBounds(new Rectangle(101,94,64,44));
    pwr_fananim236.setBorderColor(29);
    pwr_fananim236.setTextColor(0);
    pwr_fananim236.setShadow(1);
    pwr_fananim236.setGradient(12);
    localPanel.add(pwr_fananim236, new Proportion(pwr_fananim236.getBounds(), dsize));
    ...
    pwr_valuesmall48.setBounds(new Rectangle(282,216,71,18));
    ...
    pwr_smallbuttoncenter52.setBounds(new Rectangle(115,169,61,21));
    ...
    pwr_indsquare54.setBounds(new Rectangle(185,293,16,17));
    ...
    grp173_55.setBounds(new Rectangle(69,293,40,17));
    localPanel.add(grp173_55, new Proportion(grp173_55.getBounds(), dsize));
    grp181_56 = new Grp181_(session);
    grp181_56.setBounds(new Rectangle(30,193,41,18));
    localPanel.add(grp181_56, new Proportion(grp181_56.getBounds(), dsize));
    pwr_smallbuttoncenter57 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter57.setBounds(new Rectangle(28,192,48,21));
    ...
    pwr_contactor259.setBounds(new Rectangle(248,256,38,38));
    pwr_contactor259.setFillColor(32);
    pwr_contactor259.setShadow(1);
    localPanel.add(pwr_contactor259, new Proportion(pwr_contactor259.getBounds(), dsize));
    pwr_mbup60 = new pwr_mbup(session);
    pwr_mbup60.setBounds(new Rectangle(344,24,19,20));
    localPanel.add(pwr_mbup60, new Proportion(pwr_mbup60.getBounds(), dsize));
    ...
    pwr_fananim35.dd.setDynType(65537);
    pwr_fananim35.dd.setActionType(66);
    pwr_fananim35.dd.setAccess(65532);
    pwr_fananim35.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_fananim35.dd, "$object.Contactor.IndFeedback##Boolean",1)
      ,new GeDynPopupMenu(pwr_fananim35.dd, "$object.Fan")
      ,new GeDynCommand(pwr_fananim35.dd, "open graph/class/inst=$object.Fan")
      });
    pwr_fananim236.dd.setDynType(99381);
    pwr_fananim236.dd.setActionType(0);
    pwr_fananim236.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_fananim236.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_fananim236.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_fananim236.dd, "$object.Contactor.IndFeedback##Boolean",37)
      ,new GeDynValue(pwr_fananim236.dd, "$object.Mode.IndMode##String8","%s")
      ,new GeDynDigShift(pwr_fananim236.dd, "")
      ,new GeDynAnimation(pwr_fananim236.dd, "$object.Contactor.IndFeedback##Boolean",2)
      });
    pwr_fananim236.setAnnot1("L");
...
null,null,    new GeDyn(pwr_pulldownmenu242,129,65,33619967,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp181_56.dd.setDynType(129);
    grp181_56.dd.setActionType(0);
    grp181_56.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp181_56.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_smallbuttoncenter57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter57.dd, "$object.Mode.ManAutoHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter57.dd, "$object.Mode.AutoModDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter57.dd, "$object.Mode.OpAuto")
      ,new GeDynSetDig(pwr_smallbuttoncenter57.dd, "$object.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter57.setAnnot1("Auto");
    ...
    pwr_contactor259.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor259.dd, "$object.Contactor.Feedback.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_contactor259.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor259.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_mbup60.dd.setDynType(129);
    pwr_mbup60.dd.setActionType(8256);
    pwr_mbup60.dd.setAccess(33619967);
    pwr_mbup60.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup60.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup60.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup60.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.6569F, 245.175F, 360.366F, 192.277F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),71, 277);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706513, -33}, new int[] { 12, 13, -1219706495,-15}, 4),
