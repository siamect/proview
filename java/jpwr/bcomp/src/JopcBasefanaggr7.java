...
public class JopcBasefanaggr7 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod28 = new pwr_rod(session);
    pwr_rod28.setBounds(new Rectangle(138,365,39,10));
    pwr_rod28.setShadow(1);
    localPanel.add(pwr_rod28, new Proportion(pwr_rod28.getBounds(), dsize));
    ...
    pwr_rod28.dd.setDynType(1);
    pwr_rod28.dd.setActionType(0);
...
null,null,    new GeDyn(pwr_pulldownmenu42,129,65,33619967,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu44,1,65,65535,new GeDynElemIfc[] {
