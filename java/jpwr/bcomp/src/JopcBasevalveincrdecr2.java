...
public class JopcBasevalveincrdecr2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup64;
  public JopcBasevalveincrdecr2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasevalveincrdecr2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasevalveincrdecr2");
    ...
    pwr_indsquare27.setBounds(new Rectangle(329,205,14,15));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(174,386,60,19));
    ...
    pwr_indsquare50.setBounds(new Rectangle(291,366,14,14));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu224.dd, new String[] {
        JopLang.transl("OrderIncr Do"),JopLang.transl("OrderDecr Do"),JopLang.transl("SwitchClosed Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare27.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare27.dd, "$object.Actuator.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare27.dd, "$object.Actuator.SwitchClosed")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter49.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter49.dd, "$object.Actuator.Mode.ManStopHide##Boolean",0)
      ,new GeDynInvisible(pwr_smallbuttoncenter49.dd, "$object.Actuator.Mode.ManOrdDim##Boolean",1)
      ,new GeDynPopupMenu(pwr_smallbuttoncenter49.dd, "$object.Actuator.Mode.OpManStop")
      ,new GeDynSetDig(pwr_smallbuttoncenter49.dd, "$object.Actuator.Mode.OpManStop##Boolean")
      });
    pwr_smallbuttoncenter49.setAnnot1("Stop");
    pwr_indsquare50.dd.setDynType(141);
    pwr_indsquare50.dd.setActionType(0);
    pwr_indsquare50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare50.dd, "$object.Actuator.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare50.dd, "$object.Actuator.Mode.ErrorDecr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare50.dd, "$object.Actuator.Mode.LimitSwitchDecr##Boolean",29)
      });
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 474, -6}, new int[] { 22, 27, 140859566,38}, 4),
    ...
    new Polygon( new int[] { 42, 40, 474, -6}, new int[] { 22, 27, 140859566,38}, 4),
