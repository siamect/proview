...
public class JopcBasevalveincrdecr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare27.setBounds(new Rectangle(328,204,16,17));
    ...
    pwr_smallbuttoncenter49.setBounds(new Rectangle(173,385,62,21));
    ...
    pwr_indsquare50.setBounds(new Rectangle(290,365,16,16));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu224.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu224.dd, new String[] {
        "OrderIncr Do","OrderDecr Do","SwitchClosed Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "SwitchClosed",199, 219);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 4, 42, -6}, new int[] { 22, 27, -1220087329,38}, 4),
    ...
    new Polygon( new int[] { 42, 40, 42, -6}, new int[] { 22, 27, -1220087329,38}, 4),
