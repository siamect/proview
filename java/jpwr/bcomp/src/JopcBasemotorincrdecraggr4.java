...
public class JopcBasemotorincrdecraggr4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup79;
  public JopcBasemotorincrdecraggr4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr4");
    ...
    pwr_overloadrelay5.setBounds(new Rectangle(248,329,38,27));
    ...
    pwr_indsquare8.setBounds(new Rectangle(150,303,16,17));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,543,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,542,336,23));
    ...
    pwr_contactor238.setBounds(new Rectangle(248,293,38,38));
    ...
    pwr_safetyswitch39.setBounds(new Rectangle(248,363,38,39));
    ...
    pwr_motor248.setBounds(new Rectangle(173,438,98,74));
    ...
    pwr_indsquare55.setBounds(new Rectangle(150,399,16,16));
    ...
    pwr_rodcouplinganim60.setBounds(new Rectangle(168,464,12,22));
    ...
    pwr_contactor261.setBounds(new Rectangle(305,293,38,38));
    ...
    pwr_indsquare63.setBounds(new Rectangle(211,303,16,17));
    ...
    pwr_contactor238.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor238.dd, "$object.ContactorIncr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor238.dd, "$object.ContactorIncr")
      ,new GeDynCommand(pwr_contactor238.dd, "open graph /class/instance=$object.ContactorIncr")
      });
...
null,    new GeDyn(pwr_pulldownmenu245,129,65,65535,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu245,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu245.dd, "open graph /class /inst=$object.SafetySwitch.On")
      }),
...
null,    new GeDyn(pwr_pulldownmenu247,1,65,65535,new GeDynElemIfc[] {
    ...
    new GeDyn(pwr_pulldownmenu247,1,65,33619967,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu247.dd, "open graph /class /inst=$object.SafetySwitch")
      }),
    new GeDyn(pwr_pulldownmenu247,1,65,33619967,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140857013, -18}, new int[] { 146, 147, 152838751,0}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Decr"),170, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),170, 184);
    {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Decr"),177, 317);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),113, 317);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 140857087, 55}, new int[] { 12, 15, 148563829,53}, 4),
