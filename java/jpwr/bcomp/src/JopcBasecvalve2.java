...
public class JopcBasecvalve2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare66.setBounds(new Rectangle(166,268,16,17));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 119, 38}, new int[] { 22, 27, -1219980799,12}, 4),
    ...
    new Polygon( new int[] { 42, 40, 119, 38}, new int[] { 22, 27, -1219980799,12}, 4),
