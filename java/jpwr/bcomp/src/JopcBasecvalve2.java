...
public class JopcBasecvalve2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecvalve2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    pwr_indsquare34.setBounds(new Rectangle(166,188,16,17));
