...
public class JopcBasecvalve1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare49.setBounds(new Rectangle(166,241,16,17));
    ...
    pwr_basevalve53.setBounds(new Rectangle(285,533,80,122));
    ...
    pwr_valvecontrol263.setBounds(new Rectangle(110,115,66,43));
    ...
    pwr_indsquare66.setBounds(new Rectangle(166,266,16,17));
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 6, 2585, 48}, new int[] { 22, 26, 140885186,26}, 4),
    ...
    new Polygon( new int[] { 42, 42, 2585, 48}, new int[] { 22, 26, 140885186,26}, 4),
