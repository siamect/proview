...
public class JopcBasecvalve1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_pulldownmenu	pwr_pulldownmenu58;
  JopSmallbutton	jopSmallbutton59;
  pwr_indround	pwr_indround60;
  Grp175_	grp175_61;
  pwr_indsquare	pwr_indsquare62;
  public JopcBasecvalve1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecvalve1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    jopSmallbutton43.setBounds(new Rectangle(36,365,48,21));
    ...
    pwr_valueinputsmallrd49.setColorBrightness(-2);
    ...
    pwr_indsquare51.setBounds(new Rectangle(166,256,16,17));
    ...
    grp167_52.setBounds(new Rectangle(420,106,46,18));
    ...
    pwr_pulldownmenu58 = new pwr_pulldownmenu(session);
    pwr_pulldownmenu58.setBounds(new Rectangle(160,0,69,24));
    pwr_pulldownmenu58.setShadow(1);
    localPanel.add(pwr_pulldownmenu58, new Proportion(pwr_pulldownmenu58.getBounds(), dsize));
    jopSmallbutton59 = new JopSmallbutton(session);
    jopSmallbutton59.setBounds(new Rectangle(36,342,48,21));
    ...
    grp175_61.setBounds(new Rectangle(39,396,35,17));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton43.dd.setActionType(4);
    jopSmallbutton43.dd.setAccess(65532);
    jopSmallbutton43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton43.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton43.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    jopSmallbutton43.setAnnot1(" Auto");
    ...
    pwr_sliderbackground1_247.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_247.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
...
null)
    ...
    grp167_52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_52.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    ...
    pwr_pulldownmenu58.dd.setDynType(1);
    pwr_pulldownmenu58.dd.setActionType(524288);
    pwr_pulldownmenu58.dd.setAccess(65535);
    pwr_pulldownmenu58.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu58.dd, new String[] {
        ...
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu58,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu58.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu58,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu58.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu58.setAnnot1("Components");
    jopSmallbutton59.dd.setDynType(128);
    jopSmallbutton59.dd.setActionType(4);
    jopSmallbutton59.dd.setAccess(65532);
    jopSmallbutton59.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(jopSmallbutton59.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(jopSmallbutton59.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    jopSmallbutton59.setAnnot1(" Man");
...
protected class pwr_valvecontrol2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 42, 42, 42, 42}, new int[] { 22, 26, 39,42}, 4),
    new Polygon( new int[] { 42, 42, 29, 22}, new int[] { 42, 39, 32,32}, 4),
    new Polygon( new int[] { 22, 29, 42, 42}, new int[] { 32, 32, 26,22}, 4),
