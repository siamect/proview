...
public class JopcBasedirvalve extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(17,410,48,21));
    ...
    pwr_smallbuttoncenter26.setBounds(new Rectangle(34,340,48,21));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(34,317,48,21));
...
protected class Grp198_ extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 24, -1219706854, -374}, new int[] { 42, 43, -1219706773,-293}, 4),
