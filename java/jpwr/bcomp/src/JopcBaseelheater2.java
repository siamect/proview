...
public class JopcBaseelheater2 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_elheater3	pwr_elheater322;
  pwr_mbup	pwr_mbup23;
  public JopcBaseelheater2( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseelheater2( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseelheater2");
    ...
    pwr_smallbuttoncenter15.setBorderColor(102);
    ...
    pwr_elheater322 = new pwr_elheater3(session);
    pwr_elheater322.setBounds(new Rectangle(199,113,164,44));
    pwr_elheater322.setShadow(1);
    localPanel.add(pwr_elheater322, new Proportion(pwr_elheater322.getBounds(), dsize));
    ...
    pwr_pulldownmenu219.dd.setDynType(0);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_elheater322.dd.setDynType(1);
    pwr_elheater322.dd.setActionType(0);
...
protected class pwr_elheater3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 62, 61, -31, -56}, new int[] { 6, 7, -1219980955,-43}, 4),
