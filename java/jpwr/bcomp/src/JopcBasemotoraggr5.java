...
public class JopcBasemotoraggr5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_motor2	pwr_motor260;
  pwr_mbup	pwr_mbup61;
  public JopcBasemotoraggr5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr5");
    pwr_overloadrelay3 = new pwr_overloadrelay(session);
    pwr_overloadrelay3.setBounds(new Rectangle(249,292,36,25));
    pwr_overloadrelay3.setFillColor(32);
    ...
    pwr_indsquare7.setBounds(new Rectangle(186,266,14,15));
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(117,192,59,19));
    ...
    pwr_indround28.setBounds(new Rectangle(89,217,16,16));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,464,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,463,334,21));
    ...
    pwr_contactor235.setBounds(new Rectangle(249,257,36,36));
    ...
    pwr_valuesmall46.setBounds(new Rectangle(283,217,69,16));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(117,170,59,19));
    ...
    pwr_indsquare52.setBounds(new Rectangle(186,320,14,14));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(169,385,10,19));
    ...
    pwr_motor260 = new pwr_motor2(session);
    pwr_motor260.setBounds(new Rectangle(174,360,96,72));
    localPanel.add(pwr_motor260, new Proportion(pwr_motor260.getBounds(), dsize));
    pwr_mbup61 = new pwr_mbup(session);
    pwr_mbup61.setBounds(new Rectangle(345,25,17,18));
    localPanel.add(pwr_mbup61, new Proportion(pwr_mbup61.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_motorman56.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman56.dd, "$object.Contactor.Feedback.ActualValue##Boolean",37)
    ...
    pwr_motor260.dd.setDynType(0);
    pwr_motor260.dd.setActionType(66);
    pwr_motor260.dd.setAccess(65532);
    pwr_motor260.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_motor260.dd, "$object.Motor")
      ,new GeDynCommand(pwr_motor260.dd, "open graph/class/instance=$object.motor")
      });
    pwr_mbup61.dd.setDynType(129);
    pwr_mbup61.dd.setActionType(8256);
    pwr_mbup61.dd.setAccess(33619967);
    pwr_mbup61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup61.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup61.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup61.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Rectangle2D.Float(19.6571F, 245.176F, 360.366F, 210.785F),
    ...
    new Polygon( new int[] { 226, 264, 268, 268, 268, 264}, new int[] {362, 362, 358, 316, 358, 362}, 6),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Contactor"),72, 278);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Overload relay"),72, 310);
    g.setTransform(save);
  }
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915354, 21}, new int[] { 12, 15, -1219915323,52}, 4),
