...
public class JopcBasemotoraggr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_overloadrelay3.setBounds(new Rectangle(248,291,38,27));
    ...
    pwr_smallbuttoncenter13.setBounds(new Rectangle(116,191,61,21));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(4,463,47,21));
    ...
    grp166_44.setBounds(new Rectangle(30,216,37,18));
    ...
    pwr_smallbuttoncenter50.setBounds(new Rectangle(116,169,61,21));
    ...
    pwr_indsquare52.setBounds(new Rectangle(185,319,16,16));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706458, 21}, new int[] { 12, 15, -1219706427,52}, 4),
