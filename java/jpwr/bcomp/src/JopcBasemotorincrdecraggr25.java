...
public class JopcBasemotorincrdecraggr25 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    jopSmallbutton72.setBounds(new Rectangle(150,169,62,21));
    ...
    jopSmallbutton74.setBounds(new Rectangle(150,216,62,21));
    ...
    jopSmallbutton76.setBounds(new Rectangle(151,169,62,21));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Down",176, 355);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Up",112, 355);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
