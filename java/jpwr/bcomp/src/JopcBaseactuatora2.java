...
public class JopcBaseactuatora2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(162,0,69,24));
    ...
    pwr_actuator51.setBounds(new Rectangle(106,118,68,44));
