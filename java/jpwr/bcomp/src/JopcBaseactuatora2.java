...
public class JopcBaseactuatora2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(163,1,67,22));
    ...
    pwr_actuator51 = new pwr_actuator(session);
    pwr_actuator51.setBounds(new Rectangle(107,119,66,42));
    pwr_actuator51.setShadow(1);
    localPanel.add(pwr_actuator51, new Proportion(pwr_actuator51.getBounds(), dsize));
    ...
    pwr_mbup55.setBounds(new Rectangle(489,25,18,18));
    localPanel.add(pwr_mbup55, new Proportion(pwr_mbup55.getBounds(), dsize));
    pwr_indsquare57 = new pwr_indsquare(session);
    pwr_indsquare57.setBounds(new Rectangle(167,269,14,15));
    pwr_indsquare57.setFillColor(295);
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare32.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare32.dd, "$object.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare32.dd, "$object.SwitchClosed")
      });
    ...
    pwr_smallbuttoncenter41.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(pwr_smallbuttoncenter41.dd, "$object.Mode.OpAuto##Boolean")
      });
    ...
    pwr_slider146.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider146.dd, "$object.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Order.PresMinLimit##Float32","$object.Order.PresMaxLimit##Float32",null,527.025,448.913)
      });
    ...
    pwr_indsquare49.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare49.dd, "$object.SwitchError##Boolean",29)
      });
    grp167_50.dd.setDynType(129);
    grp167_50.dd.setActionType(0);
    grp167_50.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_50.dd, "$object.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_actuator51.dd.setDynType(1);
    pwr_actuator51.dd.setActionType(0);
    ...
    pwr_indsquare57.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare57.dd, "$object.SupDisabled##Boolean",29)
      });
