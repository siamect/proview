...
public class JopcBasecdampersim extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter1.setBounds(new Rectangle(212,273,37,20));
    ...
    pwr_indsquare2.setBounds(new Rectangle(179,275,15,16));
    ...
    pwr_smallbuttoncenter5.setBounds(new Rectangle(212,152,37,20));
    ...
    pwr_indsquare6.setBounds(new Rectangle(179,154,15,16));
    ...
    pwr_valueinputmediumrd8.setBounds(new Rectangle(299,147,69,29));
    ...
    pwr_sliderbackground29.setBounds(new Rectangle(25,191,380,43));
    ...
    pwr_slider210.setBounds(new Rectangle(78,197,23,15));
    ...
    pwr_menubar212.setBounds(new Rectangle(9,0,417,23));
    ...
    pwr_pulldownmenu213.setBounds(new Rectangle(20,0,68,23));
    ...
    pwr_pulldownmenu214.setBounds(new Rectangle(343,0,68,23));
    ...
    pwr_mbopenobject15.setBounds(new Rectangle(36,24,19,19));
    ...
    pwr_mbopenplc16.setBounds(new Rectangle(56,24,19,19));
    ...
    pwr_mbrtnavigator17.setBounds(new Rectangle(17,24,19,19));
    ...
    pwr_mbhelpclass18.setBounds(new Rectangle(76,24,19,19));
    ...
    pwr_pulldownmenu219.setBounds(new Rectangle(78,0,68,23));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(212,99,37,20));
    ...
    pwr_indsquare22.setBounds(new Rectangle(179,101,15,16));
    ...
    pwr_smallbuttoncenter24.setBounds(new Rectangle(212,124,37,20));
    ...
    pwr_indsquare25.setBounds(new Rectangle(179,126,15,16));
    ...
    pwr_smallbuttoncenter27.setBounds(new Rectangle(326,99,37,20));
    ...
    pwr_indsquare29.setBounds(new Rectangle(298,101,15,16));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(326,124,37,20));
    ...
    pwr_indsquare32.setBounds(new Rectangle(298,126,15,16));
    ...
    pwr_slider210.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSlider(pwr_slider210.dd, "$object.ManPositionValue##Float32",0,100,1,35.6604,372.453,null,null,
null)
      });
