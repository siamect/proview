...
public class JopcBasemdamper1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare27.setBounds(new Rectangle(165,185,15,17));
    ...
    pwr_indsquare35.setBounds(new Rectangle(166,224,16,17));
    ...
    pwr_indsquare42.setBounds(new Rectangle(166,244,16,17));
    ...
    pwr_mdamper48.setBounds(new Rectangle(313,176,147,147));
...
protected class pwr_mdamper extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 2, 5, -1219706428, 51}, new int[] { 28, 29, -1219706458,21}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
