...
public class JopcBasefiltersim extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasefiltersim( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefiltersim( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefiltersim");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_smallbuttoncenter5.dd.setElements(new GeDynElemIfc[] {
      new GeDynToggleDig(pwr_smallbuttoncenter5.dd, "$object.CloggedSwitch.ActualValue##Boolean")
      ,new GeDynTipText(pwr_smallbuttoncenter5.dd, "Toggle CloggedSwitch value")
      });
    pwr_indsquare6.dd.setDynType(5);
    pwr_indsquare6.dd.setActionType(0);
    pwr_indsquare6.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare6.dd, "$object.CloggedSwitch.ActualValue##Boolean",38)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Simulate BaseFilter",19, 47);
    {
    ...
    g.drawString( "CloggedSwitch value",40, 82);
    g.setTransform(save);
  }
