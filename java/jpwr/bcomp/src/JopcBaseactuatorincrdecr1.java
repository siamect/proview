...
public class JopcBaseactuatorincrdecr1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp243_	grp243_54;
  pwr_mbup	pwr_mbup55;
  public JopcBaseactuatorincrdecr1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseactuatorincrdecr1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseactuatorincrdecr1");
    ...
    pwr_menubar25.setBounds(new Rectangle(0,0,422,24));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(337,0,69,24));
    ...
    pwr_smallbuttoncenter21.setBounds(new Rectangle(17,433,48,21));
    ...
    pwr_valuelong23.setBounds(new Rectangle(74,432,336,23));
    ...
    pwr_actuator31.setBounds(new Rectangle(168,115,68,44));
    ...
    pwr_indsquare43.setBounds(new Rectangle(290,342,16,17));
    pwr_indsquare43.setFillColor(294);
    ...
    pwr_smallbuttoncenter44.setBounds(new Rectangle(173,385,62,21));
    ...
    pwr_mbup55.setBounds(new Rectangle(381,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    new GeDyn(pwr_pulldownmenu224,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu224.dd, "open graph /class /inst=$object.SwitchOpen")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare27.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare27.dd, "$object.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare27.dd, "$object.SwitchOpen")
      });
    ...
    pwr_indsquare43.dd.setDynType(141);
    pwr_indsquare43.dd.setActionType(0);
    pwr_indsquare43.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indsquare43.dd, "$object.Mode.OpNoLimitSwitch##Boolean",0)
      ,new GeDynDigColor(pwr_indsquare43.dd, "$object.Mode.ErrorIncr##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare43.dd, "$object.Mode.LimitSwitchIncr##Boolean",29)
      });
    ...
    pwr_smallbuttoncenter44.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter44.dd, "$object.Mode.ManStopHide##Boolean",0)
...
class LocalPanel extends JPanel {
  ...
  public int original_width = 422;
  public int original_height = 455;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(17F, 304.139F, 382.76F, 121.555F),
    ...
    new Rectangle2D.Float(2.0001F, 22.5515F, 418.425F, 22.4305F),
    new Line2D.Float( 397.233F, 329.042F, 17.6617F, 329.042F),
    new Rectangle2D.Float(17F, 98.9982F, 382.76F, 197.211F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.0001F,44.982F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.0001F,22.5515F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[3]);
