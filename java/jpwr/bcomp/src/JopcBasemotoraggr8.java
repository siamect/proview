...
public class JopcBasemotoraggr8 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(248,380,38,39));
    ...
    pwr_motor247.setBounds(new Rectangle(173,456,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,416,16,17));
    ...
    pwr_fuse360.setBounds(new Rectangle(259,267,15,37));
    ...
    grp183_63.setBounds(new Rectangle(30,193,41,18));
    ...
    pwr_smallbuttoncenter64.setBounds(new Rectangle(28,191,48,21));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219980861, 50}, new int[] { 12, 15, -1219980883,28}, 4),
