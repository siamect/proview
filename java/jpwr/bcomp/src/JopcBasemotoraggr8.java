...
public class JopcBasemotoraggr8 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_fuse3	pwr_fuse359;
  pwr_motorman	pwr_motorman60;
  pwr_rodcouplinganim	pwr_rodcouplinganim61;
  Grp183_	grp183_62;
  JopSmallbutton	jopSmallbutton63;
  public JopcBasemotoraggr8( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr8( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr8");
    pwr_overloadrelay2 = new pwr_overloadrelay(session);
    pwr_overloadrelay2.setBounds(new Rectangle(248,346,38,27));
    ...
    pwr_indsquare6.setBounds(new Rectangle(185,320,16,17));
    ...
    pwr_indsquare9.setBounds(new Rectangle(185,390,16,17));
    ...
    jopSmallbutton11.setBounds(new Rectangle(28,168,48,21));
    ...
    jopSmallbutton14.setBounds(new Rectangle(115,191,61,21));
    ...
    pwr_indround29.setBounds(new Rectangle(87,216,18,18));
    ...
    jopSmallbutton31.setBounds(new Rectangle(4,563,47,21));
    ...
    pwr_valuelong32.setBounds(new Rectangle(60,562,336,23));
    ...
    pwr_contactor236.setBounds(new Rectangle(248,311,38,38));
    ...
    pwr_safetyswitch37.setBounds(new Rectangle(248,378,39,41));
    ...
    pwr_motor246.setBounds(new Rectangle(173,456,98,74));
    ...
    pwr_indsquare55.setBounds(new Rectangle(185,416,16,17));
    ...
    grp173_56.setBounds(new Rectangle(69,416,38,18));
    localPanel.add(grp173_56, new Proportion(grp173_56.getBounds(), dsize));
    pwr_indsquare57 = new pwr_indsquare(session);
    pwr_indsquare57.setBounds(new Rectangle(185,352,16,17));
    pwr_indsquare57.setShadow(1);
    localPanel.add(pwr_indsquare57, new Proportion(pwr_indsquare57.getBounds(), dsize));
    pwr_fuse359 = new pwr_fuse3(session);
    pwr_fuse359.setBounds(new Rectangle(259,267,15,37));
    pwr_fuse359.setRotate(-90);
    pwr_fuse359.setShadow(1);
    localPanel.add(pwr_fuse359, new Proportion(pwr_fuse359.getBounds(), dsize));
    pwr_motorman60 = new pwr_motorman(session);
    pwr_motorman60.setBounds(new Rectangle(101,95,64,44));
    pwr_motorman60.setShadow(1);
    localPanel.add(pwr_motorman60, new Proportion(pwr_motorman60.getBounds(), dsize));
    pwr_rodcouplinganim61 = new pwr_rodcouplinganim(session);
    pwr_rodcouplinganim61.setBounds(new Rectangle(168,481,12,22));
    pwr_rodcouplinganim61.setShadow(1);
    localPanel.add(pwr_rodcouplinganim61, new Proportion(pwr_rodcouplinganim61.getBounds(), dsize));
    ...
    jopSmallbutton14.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynSetDig(jopSmallbutton14.dd, "$object.Mode.OpManStop##Boolean")
      });
    jopSmallbutton14.setAnnot1(" Stop");
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse359.dd.setDynType(1);
    pwr_fuse359.dd.setActionType(0);
    pwr_motorman60.dd.setDynType(1077);
    pwr_motorman60.dd.setActionType(0);
    pwr_motorman60.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_motorman60.dd, "$object.IndError##Boolean")
      ,new GeDynDigWarning(pwr_motorman60.dd, "$object.IndWarning##Boolean")
      ,new GeDynDigLowColor(pwr_motorman60.dd, "$object.Contactor.Feedback.ActualValue##Boolean",37)
      ,new GeDynValue(pwr_motorman60.dd, "$object.Mode.IndMode##String8","%s")
      });
    pwr_rodcouplinganim61.dd.setDynType(65537);
    pwr_rodcouplinganim61.dd.setActionType(0);
    pwr_rodcouplinganim61.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim61.dd, "$object.Contactor.IndFeedback##Boolean",1)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Contactor",72, 332);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Safety switch",72, 403);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Overload relay",72, 364);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_fananim__p6 extends GeComponent {
  // Dimension size;
  public pwr_fananim__p6( JopSession session)
  {
    super( session);
    size = new Dimension( 64, 78);
  }
  public int original_width = 64;
  public int original_height = 78;
  Shape[] shapes = new Shape[] { 
...
protected class pwr_fananim2__p7 extends GeComponent {
  // Dimension size;
  public pwr_fananim2__p7( JopSession session)
  {
    super( session);
    size = new Dimension( 64, 44);
    annot1Font = new Font("Helvetica", Font.BOLD, 14);
