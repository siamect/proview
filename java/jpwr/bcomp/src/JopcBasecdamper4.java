...
public class JopcBasecdamper4 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_sliderbackground1_2	pwr_sliderbackground1_250;
  pwr_slider1	pwr_slider151;
  pwr_valueinputsmallrd	pwr_valueinputsmallrd52;
  pwr_indsquare	pwr_indsquare55;
  pwr_indsquare	pwr_indsquare56;
  Grp167_	grp167_57;
  pwr_mbsimulate	pwr_mbsimulate58;
  pwr_actuator	pwr_actuator59;
  ...
  pwr_basedamper	pwr_basedamper68;
  pwr_dampercontrol2	pwr_dampercontrol269;
  pwr_mbup	pwr_mbup70;
  pwr_indsquare	pwr_indsquare72;
  public JopcBasecdamper4( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecdamper4( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecdamper4");
    pwr_valuelong5 = new pwr_valuelong(session);
    pwr_valuelong5.setBounds(new Rectangle(18,47,383,20));
    ...
    pwr_menubar26.setBounds(new Rectangle(2,1,527,22));
    ...
    pwr_pulldownmenu27.setBounds(new Rectangle(13,1,67,22));
    ...
    pwr_pulldownmenu28.setBounds(new Rectangle(448,1,67,22));
    ...
    pwr_mbopenobject9.setBounds(new Rectangle(197,25,18,18));
    ...
    pwr_mbtrend10.setBounds(new Rectangle(58,25,18,18));
    ...
    pwr_mbfast11.setBounds(new Rectangle(78,25,18,18));
    ...
    pwr_mbphoto12.setBounds(new Rectangle(97,25,18,18));
    ...
    pwr_mbdatasheet13.setBounds(new Rectangle(117,25,18,18));
    ...
    pwr_mbopenplc14.setBounds(new Rectangle(216,25,18,18));
    ...
    pwr_mbcircuitdiagram15.setBounds(new Rectangle(236,25,18,18));
    ...
    pwr_mbrtnavigator16.setBounds(new Rectangle(177,25,18,18));
    ...
    pwr_mbhelpclass17.setBounds(new Rectangle(256,25,18,18));
    ...
    pwr_mbblockevents18.setBounds(new Rectangle(157,25,18,18));
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(19,668,45,19));
    ...
    pwr_valuelong23.setBounds(new Rectangle(18,71,383,20));
    ...
    pwr_valuelong24.setBounds(new Rectangle(76,667,334,21));
    ...
    pwr_valuesmall26.setBounds(new Rectangle(342,392,48,15));
    ...
    pwr_sliderbackground327.setBounds(new Rectangle(339,133,118,241));
    ...
    pwr_valueinputreliefup28.setBounds(new Rectangle(276,132,49,16));
    ...
    pwr_valueinputreliefup29.setBounds(new Rectangle(276,359,49,16));
    ...
    pwr_pulldownmenu230.setBounds(new Rectangle(270,1,67,22));
    ...
    pwr_pulldownmenu231.setBounds(new Rectangle(72,1,67,22));
    ...
    pwr_indsquare35.setBounds(new Rectangle(168,178,13,15));
    pwr_indsquare35.setFillColor(294);
    ...
    pwr_indsquare36.setBounds(new Rectangle(168,197,14,15));
    pwr_indsquare36.setFillColor(294);
    pwr_indsquare36.setShadow(1);
    localPanel.add(pwr_indsquare36, new Proportion(pwr_indsquare36.getBounds(), dsize));
    jopBar42 = new JopBar(session);
    jopBar42.setBounds(new Rectangle(359,134,20,238));
    jopBar42.setFillColor(39);
    jopBar42.setBorderColor(0);
    jopBar42.setFillColorBar(167);
    jopBar42.setBorderColorBar(161);
    jopBar42.setDrawFill(1);
    jopBar42.setDrawBorder(1);
    jopBar42.setBarBorderWidth(1);
    jopBar42.setLineWidth(1);
    jopBar42.setMinValue(0F);
    jopBar42.setMaxValue(100F);
    jopBar42.setRotate(0);
    localPanel.add(jopBar42, new Proportion(jopBar42.getBounds(), dsize));
    jopBar43 = new JopBar(session);
    jopBar43.setBounds(new Rectangle(413,134,20,238));
    jopBar43.setFillColor(58);
    jopBar43.setBorderColor(0);
    jopBar43.setFillColorBar(105);
    jopBar43.setBorderColorBar(101);
    jopBar43.setDrawFill(1);
    jopBar43.setDrawBorder(1);
    jopBar43.setBarBorderWidth(1);
    jopBar43.setLineWidth(1);
    jopBar43.setMinValue(0F);
    jopBar43.setMaxValue(100F);
    jopBar43.setRotate(0);
    localPanel.add(jopBar43, new Proportion(jopBar43.getBounds(), dsize));
    jopAxis44 = new JopAxis();
    jopAxis44.setBounds(new Rectangle(328,134,11,238));
    jopAxis44.setBorderColor(0);
    jopAxis44.setTextColor(0);
    jopAxis44.setLineWidth(1);
    jopAxis44.setMinValue(0F);
    jopAxis44.setMaxValue(0F);
    ...
    jopAxis44.setFormat("%3.0f");
    localPanel.add(jopAxis44, new Proportion(jopAxis44.getBounds(), dsize));
    pwr_valuesmall45 = new pwr_valuesmall(session);
    pwr_valuesmall45.setBounds(new Rectangle(399,392,48,15));
    ...
    pwr_smallbuttoncenter46.setBounds(new Rectangle(38,366,46,19));
    ...
    pwr_indround47.setBounds(new Rectangle(98,345,16,16));
    ...
    pwr_indround48.setBounds(new Rectangle(98,367,16,16));
    pwr_indround48.setShadow(1);
    localPanel.add(pwr_indround48, new Proportion(pwr_indround48.getBounds(), dsize));
    pwr_sliderbackground1_250 = new pwr_sliderbackground1_2(session);
    pwr_sliderbackground1_250.setBounds(new Rectangle(476,120,32,267));
    pwr_sliderbackground1_250.setShadow(1);
    localPanel.add(pwr_sliderbackground1_250, new Proportion(pwr_sliderbackground1_250.getBounds(), dsize));
    pwr_slider151 = new pwr_slider1(session);
    pwr_slider151.setBounds(new Rectangle(480,302,32,30));
    localPanel.add(pwr_slider151, new Proportion(pwr_slider151.getBounds(), dsize));
    pwr_valueinputsmallrd52 = new pwr_valueinputsmallrd(session);
    pwr_valueinputsmallrd52.setBounds(new Rectangle(466,389,54,22));
    pwr_valueinputsmallrd52.setShadow(1);
    localPanel.add(pwr_valueinputsmallrd52, new Proportion(pwr_valueinputsmallrd52.getBounds(), dsize));
    pwr_indsquare55 = new pwr_indsquare(session);
    pwr_indsquare55.setBounds(new Rectangle(168,222,13,15));
    pwr_indsquare55.setFillColor(176);
    ...
    pwr_indsquare56.setBounds(new Rectangle(168,241,14,15));
    ...
    grp167_57 = new Grp167_(session);
    grp167_57.setBounds(new Rectangle(474,107,42,16));
    localPanel.add(grp167_57, new Proportion(grp167_57.getBounds(), dsize));
    pwr_mbsimulate58 = new pwr_mbsimulate(session);
    pwr_mbsimulate58.setBounds(new Rectangle(510,25,18,18));
    localPanel.add(pwr_mbsimulate58, new Proportion(pwr_mbsimulate58.getBounds(), dsize));
    pwr_actuator59 = new pwr_actuator(session);
    pwr_actuator59.setBounds(new Rectangle(262,454,130,82));
    pwr_actuator59.setShadow(1);
    localPanel.add(pwr_actuator59, new Proportion(pwr_actuator59.getBounds(), dsize));
    pwr_pulldownmenu262 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu262.setBounds(new Rectangle(163,1,67,22));
    ...
    pwr_smallbuttoncenter63.setBounds(new Rectangle(38,343,46,19));
    ...
    pwr_indround64.setBounds(new Rectangle(98,398,16,16));
    pwr_indround64.setFillColor(114);
    pwr_indround64.setShadow(1);
    localPanel.add(pwr_indround64, new Proportion(pwr_indround64.getBounds(), dsize));
    grp175_65 = new Grp175_(session);
    grp175_65.setBounds(new Rectangle(41,397,35,15));
    localPanel.add(grp175_65, new Proportion(grp175_65.getBounds(), dsize));
    pwr_indsquare66 = new pwr_indsquare(session);
    pwr_indsquare66.setBounds(new Rectangle(185,488,14,14));
    pwr_indsquare66.setFillColor(114);
    pwr_indsquare66.setShadow(1);
    localPanel.add(pwr_indsquare66, new Proportion(pwr_indsquare66.getBounds(), dsize));
    pwr_basedamper68 = new pwr_basedamper(session);
    pwr_basedamper68.setBounds(new Rectangle(282,535,89,100));
    localPanel.add(pwr_basedamper68, new Proportion(pwr_basedamper68.getBounds(), dsize));
    pwr_dampercontrol269 = new pwr_dampercontrol2(session);
    pwr_dampercontrol269.setBounds(new Rectangle(101,103,62,57));
    pwr_dampercontrol269.setShadow(1);
    localPanel.add(pwr_dampercontrol269, new Proportion(pwr_dampercontrol269.getBounds(), dsize));
    pwr_mbup70 = new pwr_mbup(session);
    pwr_mbup70.setBounds(new Rectangle(490,25,18,18));
    localPanel.add(pwr_mbup70, new Proportion(pwr_mbup70.getBounds(), dsize));
    pwr_indsquare72 = new pwr_indsquare(session);
    pwr_indsquare72.setBounds(new Rectangle(168,268,14,15));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu230.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu230.dd, new String[] {
        JopLang.transl("Position Ai"),JopLang.transl("Order Ao"),JopLang.transl("SwitchOpen Di"),JopLang.transl("SwitchClosed Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
    ...
    new GeDyn(pwr_pulldownmenu230,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu230.dd, "open graph /class /inst=$object.Actuator.SwitchClosed")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare35.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare35.dd, "$object.Actuator.SwitchOpen.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare35.dd, "$object.Actuator.SwitchOpen")
      });
    ...
    pwr_indsquare36.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare36.dd, "$object.Actuator.SwitchClosed.ActualValue##Boolean",29)
      ,new GeDynPopupMenu(pwr_indsquare36.dd, "$object.Actuator.SwitchClosed")
      });
    jopBar42.setPwrAttribute("$object.Actuator.Position.ActualValue##Float32");
    jopBar42.setMinValueAttr("$object.Actuator.Order.PresMinLimit##Float32");
    jopBar42.setMaxValueAttr("$object.Actuator.Order.PresMaxLimit##Float32");
    jopBar43.setPwrAttribute("$object.Actuator.Order.ActualValue##Float32");
    jopBar43.setMinValueAttr("$object.Actuator.Order.PresMinLimit##Float32");
    jopBar43.setMaxValueAttr("$object.Actuator.Order.PresMaxLimit##Float32");
    pwr_valuesmall45.dd.setDynType(1025);
    pwr_valuesmall45.dd.setActionType(2);
    pwr_valuesmall45.dd.setAccess(65532);
    pwr_valuesmall45.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall45.dd, "$object.Actuator.Order.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall45.dd, "$object.Actuator.Order")
      });
    pwr_smallbuttoncenter46.dd.setDynType(129);
    pwr_smallbuttoncenter46.dd.setActionType(4);
    pwr_smallbuttoncenter46.dd.setAccess(65532);
    pwr_smallbuttoncenter46.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter46.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter46.dd, "$object.Actuator.Mode.OpAuto##Boolean")
      });
    pwr_smallbuttoncenter46.setAnnot1("Auto");
    pwr_indround47.dd.setDynType(133);
    pwr_indround47.dd.setActionType(0);
    pwr_indround47.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround47.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround47.dd, "$object.Actuator.Mode.ManMode##Boolean",29)
      });
    pwr_indround48.dd.setDynType(133);
    pwr_indround48.dd.setActionType(0);
    pwr_indround48.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround48.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround48.dd, "!$object.Actuator.Mode.ManMode##Boolean",29)
      });
    pwr_sliderbackground1_250.dd.setDynType(524417);
    pwr_sliderbackground1_250.dd.setActionType(0);
    pwr_sliderbackground1_250.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_sliderbackground1_250.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_slider151.dd.setDynType(129);
    pwr_slider151.dd.setActionType(2048);
    pwr_slider151.dd.setAccess(65532);
    pwr_slider151.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_slider151.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSlider(pwr_slider151.dd, "$object.Actuator.Mode.OpRefMan##Float32",0,100,4,124.911,363.449,"$object.Actuator.Order.PresMinLimit##Float32","$object.Actuator.Order.PresMaxLimit##Float32",null,527.39,685.913)
      });
    pwr_valueinputsmallrd52.dd.setDynType(1153);
    pwr_valueinputsmallrd52.dd.setActionType(4096);
    pwr_valueinputsmallrd52.dd.setAccess(65532);
    pwr_valueinputsmallrd52.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_valueinputsmallrd52.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynValue(pwr_valueinputsmallrd52.dd, "$object.Actuator.Mode.OpRefMan##Float32","%5.1f")
      ,new GeDynValueInput(pwr_valueinputsmallrd52.dd, 0,0,"$object.Actuator.Mode.OpMinRefMan##Float32","$object.Actuator.Mode.OpMaxRefMan##Float32")
      });
    pwr_valueinputsmallrd52.setAnnot1Font(pwr_valueinputsmallrd52.annotFont.deriveFont((float)10));
    pwr_indsquare55.dd.setDynType(5);
    pwr_indsquare55.dd.setActionType(0);
    pwr_indsquare55.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare55.dd, "$object.Actuator.DiffPosError##Boolean",29)
      });
    pwr_indsquare56.dd.setDynType(5);
    pwr_indsquare56.dd.setActionType(0);
    pwr_indsquare56.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare56.dd, "$object.Actuator.SwitchError##Boolean",29)
      });
    grp167_57.dd.setDynType(129);
    grp167_57.dd.setActionType(0);
    grp167_57.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp167_57.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      });
    pwr_mbsimulate58.dd.setDynType(129);
    pwr_mbsimulate58.dd.setActionType(8256);
    pwr_mbsimulate58.dd.setAccess(65532);
    pwr_mbsimulate58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbsimulate58.dd, "$cmd(check method/method=\"Simulate\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbsimulate58.dd, "call method/method=\"Simulate\"/object=$object")
      ,new GeDynTipText(pwr_mbsimulate58.dd, JopLang.transl("Open simulate graph"))
      });
    pwr_actuator59.dd.setDynType(1);
    pwr_actuator59.dd.setActionType(66);
    pwr_actuator59.dd.setAccess(65532);
    pwr_actuator59.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_actuator59.dd, "$object.Actuator")
      ,new GeDynCommand(pwr_actuator59.dd, "open graph/class/inst=$object.Actuator")
      });
    ...
    pwr_pulldownmenu262.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu262.dd, new String[] {
        JopLang.transl("Actuator"),JopLang.transl("Damper"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu262,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu262.dd, "open graph /class /inst=$object.Actuator")
      }),
    new GeDyn(pwr_pulldownmenu262,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu262.dd, "open graph /class /inst=$object.Valve")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu262.setAnnot1("Components");
    pwr_smallbuttoncenter63.dd.setDynType(128);
    pwr_smallbuttoncenter63.dd.setActionType(4);
    pwr_smallbuttoncenter63.dd.setAccess(65532);
    pwr_smallbuttoncenter63.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.OpAutoOnly##Boolean",0)
      ,new GeDynSetDig(pwr_smallbuttoncenter63.dd, "$object.Actuator.Mode.OpMan##Boolean")
      });
    pwr_smallbuttoncenter63.setAnnot1("Man");
    pwr_indround64.dd.setDynType(133);
    pwr_indround64.dd.setActionType(0);
    pwr_indround64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_indround64.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      ,new GeDynDigLowColor(pwr_indround64.dd, "$object.Actuator.Mode.LocalMode##Boolean",29)
      });
    grp175_65.dd.setDynType(129);
    grp175_65.dd.setActionType(0);
    grp175_65.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp175_65.dd, "$object.Actuator.Mode.OpNoLocal##Boolean",0)
      });
    pwr_indsquare66.dd.setDynType(13);
    pwr_indsquare66.dd.setActionType(0);
    pwr_indsquare66.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_indsquare66.dd, "$object.Actuator.IndError##Boolean",176)
      ,new GeDynDigLowColor(pwr_indsquare66.dd, "$object.Actuator.IndWarning##Boolean",29)
      });
    pwr_basedamper68.dd.setDynType(16384);
    pwr_basedamper68.dd.setActionType(66);
    pwr_basedamper68.dd.setAccess(65532);
    pwr_basedamper68.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnalogShift(pwr_basedamper68.dd, "$object.Actuator.PosEnum##Int32")
      ,new GeDynPopupMenu(pwr_basedamper68.dd, "$object.Damper")
      ,new GeDynCommand(pwr_basedamper68.dd, "open graph/class/inst=$object.Damper")
      });
    pwr_dampercontrol269.dd.setDynType(19504);
    pwr_dampercontrol269.dd.setActionType(0);
    pwr_dampercontrol269.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_dampercontrol269.dd, "$object.Actuator.IndError##Boolean")
      ,new GeDynDigWarning(pwr_dampercontrol269.dd, "$object.Actuator.IndWarning##Boolean")
      ,new GeDynAnalogColor(pwr_dampercontrol269.dd, "$object.Actuator.PosEnum##Int32",1,4,30)
      ,new GeDynValue(pwr_dampercontrol269.dd, "$object.Actuator.Mode.IndMode##String8","%s")
      ,new GeDynAnalogShift(pwr_dampercontrol269.dd, "$object.Actuator.PosEnum##Int32")
      });
    pwr_mbup70.dd.setDynType(129);
    pwr_mbup70.dd.setActionType(8256);
    pwr_mbup70.dd.setAccess(33619967);
    pwr_mbup70.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup70.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup70.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup70.dd, JopLang.transl("Open parent object graph"))
      });
    pwr_indsquare72.dd.setDynType(5);
    pwr_indsquare72.dd.setActionType(0);
    pwr_indsquare72.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare72.dd, "$object.Actuator.SupDisabled##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Line2D.Float( 253.569F, 329.042F, 19.0339F, 329.042F),
    new Rectangle2D.Float(18.625F, 304.139F, 237.944F, 121.555F),
    new Polygon( new int[] { 19, 257, 256, 19, 19, 19}, new int[] { 304, 304, 305, 305, 425, 426}, 6), 
    new Polygon( new int[] { 257, 257, 256, 256, 19, 19}, new int[] { 426, 304, 305, 425, 425, 426}, 6), 
    new Rectangle2D.Float(260.625F, 98.9998F, 266.625F, 327.444F),
    new Polygon( new int[] { 261, 527, 526, 262, 262, 261}, new int[] { 99, 99, 100, 100, 425, 426}, 6), 
    new Polygon( new int[] { 527, 527, 526, 526, 262, 261}, new int[] { 426, 99, 100, 425, 425, 426}, 6), 
    new Rectangle2D.Float(18.625F, 98.9982F, 237.944F, 197.211F),
    new Polygon( new int[] { 19, 257, 256, 20, 20, 19}, new int[] { 99, 99, 100, 100, 295, 296}, 6), 
    new Polygon( new int[] { 257, 257, 256, 256, 20, 19}, new int[] { 296, 99, 100, 295, 295, 296}, 6), 
    new Line2D.Float( 455.656F, 181F, 339.496F, 181F),
    new Line2D.Float( 455.656F, 229F, 339.496F, 229F),
    new Line2D.Float( 455.656F, 276F, 339.496F, 276F),
    new Line2D.Float( 455.656F, 325F, 339.496F, 325F),
    new Rectangle2D.Float(44.625F, 143F, 143F, 7F),
    new Polygon( new int[] { 45, 188, 186, 46, 46, 45}, new int[] { 143, 143, 145, 145, 148, 150}, 6), 
    new Polygon( new int[] { 188, 188, 186, 186, 46, 45}, new int[] { 150, 143, 145, 148, 148, 150}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Position"),346, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order"),407, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SwitchOpen"),39, 191);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("SwitchClosed"),39, 211);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("%"),301, 165);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Mode"),39, 324);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Position error"),39, 235);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch error"),39, 255);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Actuator"),99, 500);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Damper"),99, 601);
    {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),38, 279);
    g.setTransform(save);
  }
...
protected class pwr_dampercontrol2 extends GeComponent {
  // Dimension size;
  public pwr_dampercontrol2( JopSession session)
  {
    super( session);
    size = new Dimension( 47, 44);
  ...
  Shape[] shapes = new Shape[] { 
    new Arc2D.Float(4F, 2F, 16.0609F, 16.0609F, 35F, 140F, Arc2D.PIE),
    new Arc2D.Float(4F, 2F, 16.0609F, 16.0609F, 215F, 140F, Arc2D.PIE),
    new Arc2D.Float(4F, 2F, 16.0609F, 16.0609F, -5F, 40F, Arc2D.PIE),
    new Arc2D.Float(4F, 2F, 16.0609F, 16.0609F, 175F, 40F, Arc2D.PIE),
    new Arc2D.Float(5.60609F, 3.60609F, 12.8487F, 12.8487F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(4F, 2F, 16.0609F, 16.0609F, 0F, 360F, Arc2D.PIE),
    new Rectangle2D.Float(25.4697F, 12.0491F, 20F, 16F),
    new Line2D.Float( 12F, 22F, 12F, 18F),
    new Rectangle2D.Float(2F, 22F, 20F, 20F),
    new Polygon( new int[] { 2, 22, 20, 4, 4, 2}, new int[] { 22, 22, 24, 24, 40, 42}, 6), 
    new Polygon( new int[] { 22, 22, 20, 20, 4, 2}, new int[] { 42, 22, 24, 40, 40, 42}, 6), 
    new Line2D.Float( 18F, 26F, 6F, 38F),
    new Polygon( new int[] { 10, 12, 14, 12, 10}, new int[] {32, 30, 32, 34, 32}, 5),
  };
  int original_width_p2 = 47;
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 22, 20, 20, 4, 2}, new int[] { 42, 22, 24, 40, 40, 42}, 6), 
    new Polygon( new int[] { 10, 12, 14, 12, 10}, new int[] {32, 30, 32, 34, 32}, 5),
    new Line2D.Float( 12F, 40F, 12F, 24F),
  };
  int original_width_p3 = 47;
  ...
  Shape[] shapes_p3 = new Shape[] { 
    ...
    new Polygon( new int[] { 22, 22, 20, 20, 4, 2}, new int[] { 42, 22, 24, 40, 40, 42}, 6), 
    new Polygon( new int[] { 10, 12, 14, 12, 10}, new int[] {32, 30, 32, 34, 32}, 5),
    new Line2D.Float( 20F, 32F, 4F, 32F),
  };
  public void paintComponent(Graphics g1) {
    switch ( page) {
      case 2 :
    ...
    GeGradient.paint( g, 9,2,-2,4F,2F,16.0609F,16.0609F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[5]);
    GeGradient.paint( g, gradient,2,-2,4F,2F,16.0609F,16.0609F, false,74, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[4]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
    ...
    g.transform( AffineTransform.getScaleInstance( original_width/width *
      		height/original_height, 1));
    if ( annot1 != null)
      g.drawString( annot1, 27 * original_height / height * width / original_width, 27F);
    g.setTransform( save_tmp);
    }
    if ( rounds == 2)
      g.setClip(null);
  ...
  public void paintComponent_p2(Graphics g1) {
    ...
    ((Arc2D)shapes_p2[0]).setArcType(Arc2D.PIE);
    ...
    ((Arc2D)shapes_p2[5]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p2[5]);
  ...
  public void paintComponent_p3(Graphics g1) {
    ...
    ((Arc2D)shapes_p3[0]).setArcType(Arc2D.PIE);
    ...
    ((Arc2D)shapes_p3[5]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[5]);
...
protected class pwr_basedamper extends GeComponent {
  // Dimension size;
  public pwr_basedamper( JopSession session)
  {
    super( session);
    size = new Dimension( 52, 58);
    pages = 3;
  }
  public int original_width = 52;
  public int original_height = 58;
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(16F, 8.00006F, 20F, 2F),
    new Polygon( new int[] { 16, 36, 36, 16, 16, 16}, new int[] { 8, 8, 8, 8, 10, 10}, 6), 
    new Polygon( new int[] { 36, 36, 36, 36, 16, 16}, new int[] { 10, 8, 8, 10, 10, 10}, 6), 
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 0F, 120F, Arc2D.PIE),
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 200F, 40F, Arc2D.PIE),
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(3.35434F, 9.35436F, 45.111F, 45.111F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, 35F, 140F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, 215F, 140F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, -5F, 40F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, 175F, 40F, Arc2D.PIE),
    new Arc2D.Float(12.9471F, 10.795F, 22.5246F, 41.9904F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(11.6957F, 9.5436F, 25.0274F, 44.4931F, 200F, 90F, Arc2D.PIE),
    new Arc2D.Float(13.0955F, 10.225F, 27.8082F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Rectangle2D.Float(29.3111F, 2.16812F, 12.8564F, 5.03704F),
    new Rectangle2D.Float(10.0265F, 2.16812F, 19.2846F, 5.03704F),
    new Rectangle2D.Float(13.2406F, 2.16812F, 6.4282F, 5.03704F),
    new Rectangle2D.Float(10.0001F, 2F, 32.141F, 5.56726F),
    new Rectangle2D.Float(26.3903F, 10.0823F, 1.44067F, 44.1105F),
    new Polygon( new int[] { 26, 28, 27, 27, 27, 26}, new int[] { 10, 10, 11, 11, 54, 54}, 6), 
    new Polygon( new int[] { 28, 28, 27, 27, 27, 26}, new int[] { 54, 10, 11, 54, 54, 54}, 6), 
    new Line2D.Float( 26.2302F, 53.5515F, 26.2302F, 10.0781F),
    new Line2D.Float( 27.9911F, 53.5515F, 27.9911F, 10.0781F),
  };
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(3.35434F, 9.35436F, 45.111F, 45.111F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, 35F, 140F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, 215F, 140F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, -5F, 40F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, 175F, 40F, Arc2D.PIE),
    new Arc2D.Float(5.84502F, 11.5954F, 36.9328F, 40.3895F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(3.7932F, 9.5436F, 41.0364F, 44.4931F, 200F, 90F, Arc2D.PIE),
    new Arc2D.Float(5.0779F, 9.57936F, 43.1374F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Rectangle2D.Float(29.3111F, 2.16812F, 12.8564F, 5.03704F),
    new Rectangle2D.Float(10.0265F, 2.16812F, 19.2846F, 5.03704F),
    new Rectangle2D.Float(13.2406F, 2.16812F, 6.4282F, 5.03704F),
    new Rectangle2D.Float(10.0001F, 2F, 32.141F, 5.56726F),
    new Rectangle2D.Float(25.5294F, 10.0976F, 1.44067F, 43.6618F),
    new Polygon( new int[] { 26, 27, 26, 26, 26, 26}, new int[] { 10, 10, 11, 11, 53, 54}, 6), 
    new Polygon( new int[] { 27, 27, 26, 26, 26, 26}, new int[] { 54, 10, 11, 53, 53, 54}, 6), 
    new Line2D.Float( 25.3693F, 53.3363F, 25.3693F, 9.8629F),
    new Line2D.Float( 27.1302F, 53.3363F, 27.1302F, 9.8629F),
  };
  int original_width_p3 = 52;
  int original_height_p3 = 58;
  Shape[] shapes_p3 = new Shape[] { 
    new Rectangle2D.Float(16F, 8.00006F, 20F, 2F),
    new Polygon( new int[] { 16, 36, 36, 16, 16, 16}, new int[] { 8, 8, 8, 8, 10, 10}, 6), 
    new Polygon( new int[] { 36, 36, 36, 36, 16, 16}, new int[] { 10, 8, 8, 10, 10, 10}, 6), 
    ...
    new Arc2D.Float(2F, 8.00006F, 48F, 48F, 0F, 360F, Arc2D.OPEN),
    new Arc2D.Float(3.35434F, 9.35436F, 45.111F, 45.111F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, 35F, 140F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, 215F, 140F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, -5F, 40F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, 175F, 40F, Arc2D.PIE),
    new Arc2D.Float(21.3605F, 9.93325F, 7.01374F, 43.7138F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Arc2D.Float(20.9708F, 9.5436F, 7.79305F, 44.4931F, 200F, 90F, Arc2D.PIE),
    new Arc2D.Float(22.7655F, 10.225F, 8.65894F, 44.4931F, 0F, 360F, Arc2D.PIE),
    new Rectangle2D.Float(29.3111F, 2.16812F, 12.8564F, 5.03704F),
    new Rectangle2D.Float(10.0265F, 2.16812F, 19.2846F, 5.03704F),
    new Rectangle2D.Float(13.2406F, 2.16812F, 6.4282F, 5.03704F),
    new Rectangle2D.Float(10.0001F, 2F, 32.141F, 5.56726F),
    new Rectangle2D.Float(25.9599F, 9.86715F, 1.44067F, 43.8963F),
    new Polygon( new int[] { 26, 27, 27, 26, 26, 26}, new int[] { 10, 10, 10, 10, 53, 54}, 6), 
    new Polygon( new int[] { 27, 27, 27, 27, 26, 26}, new int[] { 54, 10, 10, 53, 53, 54}, 6), 
    new Line2D.Float( 26.015F, 53.5515F, 26.015F, 10.0781F),
    new Line2D.Float( 27.5606F, 53.3363F, 27.5606F, 9.8629F),
  };
  public void paintComponent(Graphics g1) {
    switch ( page) {
      case 2 :
    ...
    GeGradient.paint( g, gradient,2,-2,16F,8.00006F,20F,2F, false,38, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    GeGradient.paint( g, 9,2,-2,11.6957F,9.5436F,25.0274F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[13]);
    GeGradient.paint( g, gradient,2,-2,11.6957F,9.5436F,25.0274F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[12]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
    ...
    ((Arc2D)shapes[13]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[13]);
    ...
    GeGradient.paint( g, gradient,2,-2,26.3903F,10.0823F,1.44067F,44.1105F, false,33, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[20]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p2(Graphics g1) {
    ...
    ((Arc2D)shapes_p2[9]).setArcType(Arc2D.PIE);
    ...
    GeGradient.paint( g, 9,2,-2,3.7932F,9.5436F,41.0364F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p2[13]);
    GeGradient.paint( g, gradient,2,-2,3.7932F,9.5436F,41.0364F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p2[12]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
    ...
    ((Arc2D)shapes_p2[13]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p2[13]);
    ...
    g.setColor(GeColor.getColor(39, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes_p2[14]);
    ((Arc2D)shapes_p2[14]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p2[14]);
    ...
    GeGradient.paint( g, gradient,2,-2,25.5294F,10.0976F,1.44067F,43.6618F, false,33, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p2[20]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
  ...
  public void paintComponent_p3(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[6]);
    ((Arc2D)shapes_p3[7]).setArcType(Arc2D.PIE);
    g.setColor(GeColor.getColor(39, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes_p3[7]);
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[7]);
    ((Arc2D)shapes_p3[8]).setArcType(Arc2D.PIE);
    ((Arc2D)shapes_p3[9]).setArcType(Arc2D.PIE);
    ...
    GeGradient.paint( g, 9,2,-2,20.9708F,9.5436F,7.79305F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p3[13]);
    GeGradient.paint( g, gradient,2,-2,20.9708F,9.5436F,7.79305F,44.4931F, false,31, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p3[12]);
    }
    } else {
    if ( gradient == GeGradient.eGradient_No) {
    ...
    ((Arc2D)shapes_p3[13]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[13]);
    ...
    g.setColor(GeColor.getColor(39, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed));
    g.fill( shapes_p3[14]);
    ((Arc2D)shapes_p3[14]).setArcType(Arc2D.OPEN);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes_p3[14]);
    ...
    GeGradient.paint( g, gradient,2,-2,25.9599F,9.86715F,1.44067F,43.8963F, false,33, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes_p3[20]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
...
protected class Grp167_ extends GeComponent {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Manual"),2, 13);
    }
    if ( rounds == 2)
      g.setClip(null);
    g.setTransform(save);
