...
public class JopcBasefanaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod32.setBounds(new Rectangle(139,441,37,8));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(5,518,45,19));
    ...
    pwr_valuelong34.setBounds(new Rectangle(61,517,334,21));
    ...
    pwr_fananim38.setBounds(new Rectangle(124,399,17,89));
    ...
    pwr_motor248.setBounds(new Rectangle(174,409,96,72));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(117,170,59,19));
    ...
    pwr_indsquare57.setBounds(new Rectangle(186,369,14,14));
    ...
    grp180_61.setBounds(new Rectangle(31,194,39,16));
    ...
    pwr_contactor265.setBounds(new Rectangle(249,301,36,36));
    ...
    pwr_overloadrelay66.setBounds(new Rectangle(249,336,36,25));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915359, 16}, new int[] { 12, 15, -1219915336,39}, 4),
