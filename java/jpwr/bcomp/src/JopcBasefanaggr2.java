...
public class JopcBasefanaggr2 extends JopFrame implements JopUtilityIfc {
  ...
  pwr_contactor2	pwr_contactor265;
  pwr_overloadrelay	pwr_overloadrelay66;
  pwr_mbup	pwr_mbup67;
  ...
  public void geInit() {
    ...
    pwr_rod32.setBounds(new Rectangle(138,440,39,10));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,517,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,516,336,23));
    ...
    pwr_fananim38.setBounds(new Rectangle(123,398,19,91));
    ...
    pwr_fananim239.setFillColor(74);
    ...
    pwr_motor248.setBounds(new Rectangle(173,408,98,74));
    ...
    pwr_smallbuttoncenter55.setBounds(new Rectangle(116,169,61,21));
    ...
    pwr_indsquare57.setBounds(new Rectangle(185,368,16,16));
    ...
    grp173_58.setBounds(new Rectangle(69,368,40,17));
    ...
    grp180_61 = new Grp180_(session);
    grp180_61.setBounds(new Rectangle(30,193,41,18));
    localPanel.add(grp180_61, new Proportion(grp180_61.getBounds(), dsize));
    ...
    pwr_manswitch364.setBounds(new Rectangle(248,252,38,38));
    ...
    pwr_contactor265 = new pwr_contactor2(session);
    pwr_contactor265.setBounds(new Rectangle(248,300,38,38));
    pwr_contactor265.setFillColor(32);
    pwr_contactor265.setShadow(1);
    localPanel.add(pwr_contactor265, new Proportion(pwr_contactor265.getBounds(), dsize));
    pwr_overloadrelay66 = new pwr_overloadrelay(session);
    pwr_overloadrelay66.setBounds(new Rectangle(248,335,38,27));
    pwr_overloadrelay66.setFillColor(32);
    pwr_overloadrelay66.setShadow(1);
    localPanel.add(pwr_overloadrelay66, new Proportion(pwr_overloadrelay66.getBounds(), dsize));
...
null,    new GeDyn(pwr_pulldownmenu247,1,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp180_61.dd.setDynType(129);
    grp180_61.dd.setActionType(0);
    grp180_61.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp180_61.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_contactor265.dd.setDynType(32769);
    pwr_contactor265.dd.setActionType(66);
    pwr_contactor265.dd.setAccess(65535);
    pwr_contactor265.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor265.dd, "$object.Contactor.Feedback.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_contactor265.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor265.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_overloadrelay66.dd.setDynType(1);
    pwr_overloadrelay66.dd.setActionType(66);
    pwr_overloadrelay66.dd.setAccess(33619967);
    pwr_overloadrelay66.dd.setElements(new GeDynElemIfc[] {
      new GeDynPopupMenu(pwr_overloadrelay66.dd, "$object.OverloadRelay")
      ,new GeDynCommand(pwr_overloadrelay66.dd, "open graph /class/instance=$object.OverloadRelay")
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23F, 405.416F, 22.4305F),
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Overload relay",72, 353);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[15]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 18, 16}, new int[] { 12, 15, 39,39}, 4),
