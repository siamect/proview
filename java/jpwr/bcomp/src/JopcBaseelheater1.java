...
public class JopcBaseelheater1 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare19.setBounds(new Rectangle(167,107,14,15));
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(11,1,67,22));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(329,1,67,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(251,1,67,22));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(149,1,87,22));
    ...
    pwr_elheater332.setBounds(new Rectangle(234,116,162,42));
...
protected class pwr_elheater3 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 62, 61, -56, -2147483648}, new int[] { 6, 7, -43,-43}, 4),
