...
public class JopcBaseelheater1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_elheater3	pwr_elheater332;
  pwr_mbup	pwr_mbup33;
  public JopcBaseelheater1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBaseelheater1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBaseelheater1");
    ...
    pwr_indsquare19.setBounds(new Rectangle(166,106,16,17));
    pwr_indsquare19.setFillColor(38);
    ...
    pwr_pulldownmenu224.setBounds(new Rectangle(10,0,69,24));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(328,0,69,24));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(250,0,69,24));
    ...
    pwr_pulldownmenu228.setBounds(new Rectangle(148,0,89,24));
    ...
    pwr_elheater332 = new pwr_elheater3(session);
    pwr_elheater332.setBounds(new Rectangle(233,115,164,44));
    pwr_elheater332.setShadow(1);
    localPanel.add(pwr_elheater332, new Proportion(pwr_elheater332.getBounds(), dsize));
    ...
    pwr_indsquare19.dd.setDynType(48);
    pwr_indsquare19.dd.setActionType(2);
    pwr_indsquare19.dd.setAccess(65535);
    pwr_indsquare19.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigError(pwr_indsquare19.dd, "$object.TempSensor.IndError##Boolean")
      ,new GeDynDigWarning(pwr_indsquare19.dd, "$object.TempSensor.IndWarning##Boolean")
      ,new GeDynPopupMenu(pwr_indsquare19.dd, "$object.TempSensor")
      });
    ...
    pwr_valuesmall22.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall22.dd, "$object.TempSensor.Value.ActualValue##Float32","%5.1f")
      ,new GeDynPopupMenu(pwr_valuesmall22.dd, "$object.TempSensor")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu226.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu226.dd, "open graph /class /inst=$object.TempSensor.Value")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu228.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu228.dd, "open graph /class /inst=$object.TempSensor")
      }),
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
      })
      });
    pwr_pulldownmenu228.setAnnot1("Components");
    ...
    pwr_indsquare31.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare31.dd, "$object.SupDisabled##Boolean",29)
      });
    pwr_elheater332.dd.setDynType(1);
    pwr_elheater332.dd.setActionType(0);
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.37536F, 23.1001F, 404.413F, 22.4305F),
    new Rectangle2D.Float(19.9999F, 98F, 206.192F, 71.3333F),
    new Polygon( new int[] { 20, 226, 225, 21, 21, 20}, new int[] { 98, 98, 99, 99, 169, 169}, 6), 
    new Polygon( new int[] { 226, 226, 225, 225, 21, 20}, new int[] { 169, 98, 99, 169, 169, 169}, 6), 
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.37536F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.37536F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class pwr_elheater3 extends GeComponent {
  // Dimension size;
  public pwr_elheater3( JopSession session)
  {
    super( session);
    size = new Dimension( 84, 24);
  }
  public int original_width = 84;
  public int original_height = 24;
  Shape[] shapes = new Shape[] { 
    new Polygon( new int[] { 62, 44, 20, 10, 4, 2, 2, 4, 10, 22, 44, 62, 62, 42, 24, 10, 6, 6, 6, 10, 22, 42, 62, 62}, new int[] {6, 6, 4, 4, 6, 10, 14, 18, 20, 20, 18, 18, 14, 14, 16, 16, 14, 12, 10, 8, 8, 10, 10, 6}, 24),
    new Polygon( new int[] { 62, 61, 44, 44}, new int[] { 6, 7, 7,6}, 4),
    new Polygon( new int[] { 44, 44, 20, 20}, new int[] { 6, 7, 5,4}, 4),
    new Polygon( new int[] { 20, 20, 10, 10}, new int[] { 4, 5, 5,4}, 4),
    new Polygon( new int[] { 10, 10, 5, 4}, new int[] { 4, 5, 7,6}, 4),
    new Polygon( new int[] { 4, 5, 3, 2}, new int[] { 6, 7, 10,10}, 4),
    new Polygon( new int[] { 2, 3, 3, 2}, new int[] { 10, 10, 14,14}, 4),
    new Polygon( new int[] { 2, 3, 5, 4}, new int[] { 14, 14, 17,18}, 4),
    new Polygon( new int[] { 4, 5, 10, 10}, new int[] { 18, 17, 19,20}, 4),
    new Polygon( new int[] { 10, 10, 22, 22}, new int[] { 20, 19, 19,20}, 4),
    new Polygon( new int[] { 22, 22, 44, 44}, new int[] { 20, 19, 17,18}, 4),
    new Polygon( new int[] { 44, 44, 61, 62}, new int[] { 18, 17, 17,18}, 4),
    new Polygon( new int[] { 62, 61, 61, 62}, new int[] { 18, 17, 15,14}, 4),
    new Polygon( new int[] { 62, 61, 42, 42}, new int[] { 14, 15, 15,14}, 4),
    new Polygon( new int[] { 42, 42, 24, 24}, new int[] { 14, 15, 17,16}, 4),
    new Polygon( new int[] { 24, 24, 10, 10}, new int[] { 16, 17, 17,16}, 4),
    new Polygon( new int[] { 10, 10, 5, 6}, new int[] { 16, 17, 15,14}, 4),
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 14, 15, 12,12}, 4),
    new Polygon( new int[] { 6, 5, 5, 6}, new int[] { 12, 12, 9,10}, 4),
    new Polygon( new int[] { 6, 5, 10, 10}, new int[] { 10, 9, 7,8}, 4),
    new Polygon( new int[] { 10, 10, 22, 22}, new int[] { 8, 7, 7,8}, 4),
    ...
    new Polygon( new int[] { 62, 61, -31, -56}, new int[] { 6, 7, -1219706523,-43}, 4),
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
    int fcolor = GeColor.getDrawtype(54, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    if ( gradient == GeGradient.eGradient_No) {
    g.setColor(GeColor.getColor( fcolor));
    g.fill( shapes[0]);
    } else {
    GeGradient.paint( g, gradient,2,-2,2F,4F,60F,16F, false,54, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
    ...
    {
    int fcolor = GeColor.getDrawtype(48, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, fillColor, dimmed);
    g.setStroke( new BasicStroke(1F));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
