...
public class JopcBasemotorincrdecraggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare10.setBounds(new Rectangle(150,348,16,17));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,518,47,21));
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,517,336,23));
    ...
    pwr_contactor237.setBounds(new Rectangle(248,293,38,38));
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(248,338,38,39));
    ...
    pwr_motor247.setBounds(new Rectangle(173,413,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(150,374,16,16));
    ...
    grp173_55.setBounds(new Rectangle(34,374,40,18));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(168,439,12,22));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 140857013, -18}, new int[] { 146, 147, 151033039,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 140857087, 55}, new int[] { 12, 15, 151033093,53}, 4),
