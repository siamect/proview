...
public class JopcBasemotorincrdecraggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup76;
  public JopcBasemotorincrdecraggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr6");
    ...
    pwr_indsquare10.setBounds(new Rectangle(151,349,14,15));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(5,519,45,19));
    ...
    pwr_valuelong33.setBounds(new Rectangle(61,518,334,21));
    ...
    pwr_contactor237.setBounds(new Rectangle(249,294,36,36));
    ...
    pwr_safetyswitch38.setBounds(new Rectangle(249,339,36,37));
    ...
    pwr_motor247.setBounds(new Rectangle(174,414,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(151,375,14,14));
    ...
    grp173_55.setBounds(new Rectangle(35,375,38,16));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(169,440,10,20));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 151635773, -18}, new int[] { 146, 147, 144033775,0}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 151635847, 55}, new int[] { 12, 15, 144033829,53}, 4),
