...
public class JopcBasemotoraggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare9.setBounds(new Rectangle(186,313,14,15));
    ...
    pwr_smallbuttoncenter31.setBounds(new Rectangle(5,486,45,19));
    ...
    pwr_valuelong32.setBounds(new Rectangle(61,485,334,21));
    ...
    pwr_contactor236.setBounds(new Rectangle(249,257,36,36));
    ...
    pwr_safetyswitch37.setBounds(new Rectangle(249,303,36,37));
    ...
    pwr_motor246.setBounds(new Rectangle(174,379,96,72));
    ...
    pwr_indsquare55.setBounds(new Rectangle(186,339,14,14));
    ...
    grp173_56.setBounds(new Rectangle(70,339,38,15));
    ...
    pwr_rodcouplinganim58.setBounds(new Rectangle(169,404,10,19));
    ...
    grp182_59.setBounds(new Rectangle(31,194,39,16));
    ...
    pwr_smallbuttoncenter60.setBounds(new Rectangle(29,192,46,19));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915325, 50}, new int[] { 12, 15, -1219915331,44}, 4),
