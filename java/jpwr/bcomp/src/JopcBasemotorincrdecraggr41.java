...
public class JopcBasemotorincrdecraggr41 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasemotorincrdecraggr41( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr41( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr41");
    ...
    jopSmallbutton70.setBounds(new Rectangle(149,169,62,21));
    ...
    jopSmallbutton71.setBounds(new Rectangle(149,193,62,21));
    ...
    jopSmallbutton72.setBounds(new Rectangle(149,216,62,21));
    ...
    jopSmallbutton73.setBounds(new Rectangle(150,193,62,21));
    ...
    jopSmallbutton74.setBounds(new Rectangle(150,169,62,21));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    jopSmallbutton70.setAnnot1(" Open");
    ...
    jopSmallbutton73.setAnnot1(" Close");
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Close",161, 207);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Open ",161, 184);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
