...
public class JopcBasesupswitch extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup31;
  public JopcBasesupswitch( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasesupswitch( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasesupswitch");
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(18,231,46,19));
    ...
    pwr_valuelong21.setBounds(new Rectangle(75,231,334,21));
    ...
    pwr_indsquare30.setBounds(new Rectangle(155,208,14,15));
    ...
    pwr_mbup31.setBounds(new Rectangle(362,25,18,18));
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 253;
  double rotate;
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),22, 219);
    g.setTransform(save);
  }
