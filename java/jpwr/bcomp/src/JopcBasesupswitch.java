...
public class JopcBasesupswitch extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter19.setBounds(new Rectangle(17,230,48,21));
    ...
    pwr_valuelong21.setBounds(new Rectangle(74,230,336,23));
    ...
    pwr_valuesmall23.setBounds(new Rectangle(213,114,35,18));
    pwr_valuesmall23.setFillColor(31);
    pwr_valuesmall23.setBorderColor(31);
    localPanel.add(pwr_valuesmall23, new Proportion(pwr_valuesmall23.getBounds(), dsize));
    pwr_switch24 = new pwr_switch(session);
    pwr_switch24.setBounds(new Rectangle(84,116,34,34));
    pwr_switch24.setShadow(1);
    localPanel.add(pwr_switch24, new Proportion(pwr_switch24.getBounds(), dsize));
    pwr_pulldownmenu225 = new pwr_pulldownmenu2(session);
    pwr_pulldownmenu225.setBounds(new Rectangle(150,0,69,24));
    ...
    pwr_indsquare31.setBounds(new Rectangle(154,207,16,17));
    ...
    pwr_mbup32.setBounds(new Rectangle(361,24,20,20));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_valuesmall23.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuesmall23.dd, "$object.Temp.Unit##String16","%s")
      });
    pwr_switch24.dd.setDynType(9);
    pwr_switch24.dd.setActionType(0);
    pwr_switch24.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigColor(pwr_switch24.dd, "!$object.Switch.ActualValue##Boolean",176)
      });
    ...
    pwr_pulldownmenu225.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu225.dd, new String[] {
        "Switch Di",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
            new GeDyn(pwr_pulldownmenu225,1,65,65535,new GeDynElemIfc[] {
      new GeDynCommand(pwr_pulldownmenu225.dd, "open graph /class /inst=$object.Switch")
      }),
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_indsquare28.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigLowColor(pwr_indsquare28.dd, "$object.Switch.ActualValue##Boolean",29)
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Supervision disabled",22, 219);
    g.setTransform(save);
  }
...
protected class pwr_switch extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 12, 12, 89, -23}, new int[] { 22, 18, 152781623,-8}, 4),
  };
  public void paintComponent(Graphics g1) {
    animationCount = 1;
    if ( !visible)
