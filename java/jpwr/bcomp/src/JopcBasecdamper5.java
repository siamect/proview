...
public class JopcBasecdamper5 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasecdamper5( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecdamper5( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecdamper5");
    ...
    pwr_indsquare34.setBounds(new Rectangle(166,186,13,15));
    ...
    jopBar40.setBounds(new Rectangle(357,134,20,238));
    ...
    jopBar41.setBounds(new Rectangle(411,134,20,238));
    ...
    pwr_indsquare53.setBounds(new Rectangle(166,222,13,15));
    ...
    pwr_indsquare54.setBounds(new Rectangle(167,241,14,15));
    ...
    pwr_pulldownmenu260.setBounds(new Rectangle(161,1,84,22));
    ...
    pwr_indsquare64.setBounds(new Rectangle(183,488,14,14));
    ...
    pwr_basedamper66.setBounds(new Rectangle(280,535,89,100));
    ...
    pwr_dampercontrol267.setBounds(new Rectangle(102,103,62,57));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu230.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu230.dd, new String[] {
        JopLang.transl("Position Ai"),JopLang.transl("Order Ao"),JopLang.transl("SwitchOpen Di"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Position"),344, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Order"),405, 119);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Position error"),37, 235);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Switch error"),37, 255);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
