...
public class JopcBaseactuatorincrdecr5 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter22.setBounds(new Rectangle(18,433,46,19));
    ...
    pwr_valuelong24.setBounds(new Rectangle(75,432,334,21));
    ...
    pwr_actuator44.setBounds(new Rectangle(164,117,66,42));
    ...
    pwr_indsquare56.setBounds(new Rectangle(291,343,14,15));
    ...
    pwr_smallbuttoncenter57.setBounds(new Rectangle(174,386,60,19));
    ...
    pwr_indsquare70.setBounds(new Rectangle(329,265,14,15));
