...
public class JopcBasec3wayvalve6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasec3wayvalve6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasec3wayvalve6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasec3wayvalve6");
    ...
    pwr_valve3waycontrol267.setBounds(new Rectangle(112,100,64,51));
    ...
    pwr_base3wayvalve69.setBounds(new Rectangle(277,533,98,130));
    ...
    pwr_base3wayvalve270.setBounds(new Rectangle(430,533,97,129));
    ...
    pwr_indsquare73.setBounds(new Rectangle(167,271,14,15));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( JopLang.transl("Supervision disabled"),37, 282);
...
protected class pwr_base3wayvalve extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 6, 9, 140892274, 42}, new int[] { 48, 50, 144126417,-2147483648}, 4),
...
protected class pwr_base3wayvalve2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 16, 17, 9, 6}, new int[] { 60, 58, 53,54}, 4),
    new Polygon( new int[] { 6, 9, 9, 6}, new int[] { 54, 53, 50,48}, 4),
    new Polygon( new int[] { 6, 9, 140892274, 42}, new int[] { 48, 50, 144126417,-6}, 4),
    new Polygon( new int[] { 6, 14, 16, 16, 14, 6, 6}, new int[] {34, 38, 36, 42, 42, 38, 34}, 7),
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {34, 30, 28, 34, 34, 38, 34}, 7),
    new Polygon( new int[] { 48, 42, 42, 40, 38, 38, 42, 42, 46, 48, 48}, new int[] {22, 22, 66, 66, 68, 78, 78, 68, 68, 66, 22}, 11),
    new Polygon( new int[] { 48, 22, 22, 16, 16, 18, 22, 26, 38, 42, 46, 48}, new int[] {22, 22, 66, 66, 22, 20, 20, 18, 18, 20, 20, 22}, 12),
  ...
  Shape[] shapes_p2 = new Shape[] { 
    ...
    new Polygon( new int[] { 48, 43, 1107, 42}, new int[] { 22, 20, -1219915382,-6}, 4),
    new Rectangle2D.Float(22F, 68F, 4F, 10F),
    new Polygon( new int[] { 22, 26, 26, 22, 22, 22}, new int[] { 68, 68, 68, 68, 78, 78}, 6), 
    new Polygon( new int[] { 26, 26, 26, 26, 22, 22}, new int[] { 78, 68, 68, 78, 78, 78}, 6), 
    new Polygon( new int[] { 58, 50, 48, 48, 50, 58, 58}, new int[] {54, 50, 52, 44, 44, 48, 54}, 7),
    ...
    new Polygon( new int[] { 6, 11, 1107, 42}, new int[] { 52, 50, -1219915382,-2147483648}, 4),
