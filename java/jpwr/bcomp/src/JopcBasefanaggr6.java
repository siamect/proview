...
public class JopcBasefanaggr6 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_contactor2	pwr_contactor262;
  pwr_safetyswitch	pwr_safetyswitch63;
  pwr_mbup	pwr_mbup64;
  public JopcBasefanaggr6( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefanaggr6( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefanaggr6");
    ...
    pwr_rod31.setBounds(new Rectangle(138,410,39,10));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,485,47,21));
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,484,336,23));
    ...
    pwr_fananim37.setBounds(new Rectangle(123,368,19,91));
    ...
    pwr_motor247.setBounds(new Rectangle(173,378,98,74));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(115,169,61,21));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,338,16,16));
    ...
    grp173_57.setBounds(new Rectangle(69,338,40,17));
    localPanel.add(grp173_57, new Proportion(grp173_57.getBounds(), dsize));
    grp180_58 = new Grp180_(session);
    grp180_58.setBounds(new Rectangle(30,193,41,18));
    localPanel.add(grp180_58, new Proportion(grp180_58.getBounds(), dsize));
    ...
    pwr_contactor262 = new pwr_contactor2(session);
    pwr_contactor262.setBounds(new Rectangle(248,256,38,38));
    pwr_contactor262.setFillColor(32);
    pwr_contactor262.setShadow(1);
    localPanel.add(pwr_contactor262, new Proportion(pwr_contactor262.getBounds(), dsize));
    pwr_safetyswitch63 = new pwr_safetyswitch(session);
    pwr_safetyswitch63.setBounds(new Rectangle(248,302,38,39));
    pwr_safetyswitch63.setFillColor(32);
    pwr_safetyswitch63.setShadow(1);
    localPanel.add(pwr_safetyswitch63, new Proportion(pwr_safetyswitch63.getBounds(), dsize));
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp180_58.dd.setDynType(129);
    grp180_58.dd.setActionType(0);
    grp180_58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp180_58.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_contactor262.dd.setDynType(32769);
    pwr_contactor262.dd.setActionType(66);
    pwr_contactor262.dd.setAccess(65535);
    pwr_contactor262.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor262.dd, "$object.Contactor.Feedback.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_contactor262.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor262.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_safetyswitch63.dd.setDynType(32769);
    pwr_safetyswitch63.dd.setActionType(66);
    pwr_safetyswitch63.dd.setAccess(65535);
    pwr_safetyswitch63.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch63.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch63.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch63.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.drawString( "Contactor",71, 278);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( "Safety switch",71, 326);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1220087405, 2}, new int[] { 12, 15, -1220087353,54}, 4),
