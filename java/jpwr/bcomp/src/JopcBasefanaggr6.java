...
public class JopcBasefanaggr6 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod31.setBounds(new Rectangle(139,411,37,8));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(5,486,45,19));
    ...
    pwr_valuelong33.setBounds(new Rectangle(61,485,334,21));
    ...
    pwr_fananim37.setBounds(new Rectangle(124,369,17,89));
    ...
    pwr_motor247.setBounds(new Rectangle(174,379,96,72));
    ...
    pwr_smallbuttoncenter54.setBounds(new Rectangle(116,170,59,19));
    ...
    pwr_indsquare56.setBounds(new Rectangle(186,339,14,14));
    ...
    pwr_contactor262.setBounds(new Rectangle(249,257,36,36));
    ...
    pwr_safetyswitch63.setBounds(new Rectangle(249,303,36,37));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915373, 2}, new int[] { 12, 15, -1219915321,54}, 4),
