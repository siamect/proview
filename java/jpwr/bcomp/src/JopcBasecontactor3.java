...
public class JopcBasecontactor3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbopenobject	pwr_mbopenobject3;
  pwr_mbtrend	pwr_mbtrend4;
  pwr_mbfast	pwr_mbfast5;
  pwr_mbphoto	pwr_mbphoto6;
  pwr_mbdatasheet	pwr_mbdatasheet7;
  pwr_mbopenplc	pwr_mbopenplc8;
  pwr_mbcircuitdiagram	pwr_mbcircuitdiagram9;
  pwr_mbrtnavigator	pwr_mbrtnavigator10;
  pwr_mbhelpclass	pwr_mbhelpclass11;
  pwr_mbblockevents	pwr_mbblockevents12;
  pwr_mbhistevent	pwr_mbhistevent13;
  pwr_mbnote	pwr_mbnote14;
  pwr_mbhelp	pwr_mbhelp15;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter16;
  pwr_valuelong	pwr_valuelong17;
  pwr_contactor__p2	pwr_contactor__p218;
  pwr_valuelong	pwr_valuelong21;
  pwr_contactor2	pwr_contactor222;
  ...
  pwr_mbup	pwr_mbup27;
  public JopcBasecontactor3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasecontactor3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasecontactor3");
    pwr_valuelong2 = new pwr_valuelong(session);
    pwr_valuelong2.setBounds(new Rectangle(17,47,367,20));
    pwr_valuelong2.setFillColor(31);
    pwr_valuelong2.setBorderColor(32);
    localPanel.add(pwr_valuelong2, new Proportion(pwr_valuelong2.getBounds(), dsize));
    pwr_mbopenobject3 = new pwr_mbopenobject(session);
    pwr_mbopenobject3.setBounds(new Rectangle(195,25,18,18));
    pwr_mbopenobject3.setShadow(1);
    localPanel.add(pwr_mbopenobject3, new Proportion(pwr_mbopenobject3.getBounds(), dsize));
    pwr_mbtrend4 = new pwr_mbtrend(session);
    pwr_mbtrend4.setBounds(new Rectangle(56,25,18,18));
    pwr_mbtrend4.setShadow(1);
    localPanel.add(pwr_mbtrend4, new Proportion(pwr_mbtrend4.getBounds(), dsize));
    pwr_mbfast5 = new pwr_mbfast(session);
    pwr_mbfast5.setBounds(new Rectangle(76,25,18,18));
    pwr_mbfast5.setShadow(1);
    localPanel.add(pwr_mbfast5, new Proportion(pwr_mbfast5.getBounds(), dsize));
    pwr_mbphoto6 = new pwr_mbphoto(session);
    pwr_mbphoto6.setBounds(new Rectangle(96,25,18,18));
    pwr_mbphoto6.setShadow(1);
    localPanel.add(pwr_mbphoto6, new Proportion(pwr_mbphoto6.getBounds(), dsize));
    pwr_mbdatasheet7 = new pwr_mbdatasheet(session);
    pwr_mbdatasheet7.setBounds(new Rectangle(116,25,18,18));
    pwr_mbdatasheet7.setShadow(1);
    localPanel.add(pwr_mbdatasheet7, new Proportion(pwr_mbdatasheet7.getBounds(), dsize));
    pwr_mbopenplc8 = new pwr_mbopenplc(session);
    pwr_mbopenplc8.setBounds(new Rectangle(215,25,18,18));
    pwr_mbopenplc8.setShadow(1);
    localPanel.add(pwr_mbopenplc8, new Proportion(pwr_mbopenplc8.getBounds(), dsize));
    pwr_mbcircuitdiagram9 = new pwr_mbcircuitdiagram(session);
    pwr_mbcircuitdiagram9.setBounds(new Rectangle(235,25,18,18));
    pwr_mbcircuitdiagram9.setShadow(1);
    localPanel.add(pwr_mbcircuitdiagram9, new Proportion(pwr_mbcircuitdiagram9.getBounds(), dsize));
    pwr_mbrtnavigator10 = new pwr_mbrtnavigator(session);
    pwr_mbrtnavigator10.setBounds(new Rectangle(175,25,18,18));
    pwr_mbrtnavigator10.setShadow(1);
    localPanel.add(pwr_mbrtnavigator10, new Proportion(pwr_mbrtnavigator10.getBounds(), dsize));
    pwr_mbhelpclass11 = new pwr_mbhelpclass(session);
    pwr_mbhelpclass11.setBounds(new Rectangle(255,25,18,18));
    pwr_mbhelpclass11.setShadow(1);
    localPanel.add(pwr_mbhelpclass11, new Proportion(pwr_mbhelpclass11.getBounds(), dsize));
    pwr_mbblockevents12 = new pwr_mbblockevents(session);
    pwr_mbblockevents12.setBounds(new Rectangle(155,25,18,18));
    pwr_mbblockevents12.setShadow(1);
    localPanel.add(pwr_mbblockevents12, new Proportion(pwr_mbblockevents12.getBounds(), dsize));
    pwr_mbhistevent13 = new pwr_mbhistevent(session);
    pwr_mbhistevent13.setBounds(new Rectangle(136,25,18,18));
    localPanel.add(pwr_mbhistevent13, new Proportion(pwr_mbhistevent13.getBounds(), dsize));
    pwr_mbnote14 = new pwr_mbnote(session);
    pwr_mbnote14.setBounds(new Rectangle(36,25,17,18));
    localPanel.add(pwr_mbnote14, new Proportion(pwr_mbnote14.getBounds(), dsize));
    pwr_mbhelp15 = new pwr_mbhelp(session);
    pwr_mbhelp15.setBounds(new Rectangle(17,25,18,18));
    localPanel.add(pwr_mbhelp15, new Proportion(pwr_mbhelp15.getBounds(), dsize));
    pwr_smallbuttoncenter16 = new pwr_smallbuttoncenter(session);
    pwr_smallbuttoncenter16.setBounds(new Rectangle(18,263,46,19));
    pwr_smallbuttoncenter16.setFillColor(102);
    pwr_smallbuttoncenter16.setBorderColor(37);
    ...
    pwr_valuelong17.setBounds(new Rectangle(17,71,367,20));
    pwr_valuelong17.setFillColor(31);
    pwr_valuelong17.setBorderColor(32);
    localPanel.add(pwr_valuelong17, new Proportion(pwr_valuelong17.getBounds(), dsize));
    pwr_contactor__p218 = new pwr_contactor__p2(session);
    pwr_contactor__p218.setBounds(new Rectangle(87,150,39,63));
    localPanel.add(pwr_contactor__p218, new Proportion(pwr_contactor__p218.getBounds(), dsize));
    pwr_valuelong21 = new pwr_valuelong(session);
    pwr_valuelong21.setBounds(new Rectangle(75,263,334,21));
    pwr_valuelong21.setFillColor(31);
    pwr_valuelong21.setBorderColor(31);
    localPanel.add(pwr_valuelong21, new Proportion(pwr_valuelong21.getBounds(), dsize));
    pwr_contactor222 = new pwr_contactor2(session);
    pwr_contactor222.setBounds(new Rectangle(244,119,109,109));
    pwr_contactor222.setFillColor(32);
    pwr_contactor222.setShadow(1);
    localPanel.add(pwr_contactor222, new Proportion(pwr_contactor222.getBounds(), dsize));
    ...
    pwr_pulldownmenu225.setBounds(new Rectangle(328,1,67,22));
    ...
    pwr_pulldownmenu226.setBounds(new Rectangle(70,1,67,22));
    pwr_pulldownmenu226.setShadow(1);
    localPanel.add(pwr_pulldownmenu226, new Proportion(pwr_pulldownmenu226.getBounds(), dsize));
    pwr_mbup27 = new pwr_mbup(session);
    pwr_mbup27.setBounds(new Rectangle(355,25,17,18));
    localPanel.add(pwr_mbup27, new Proportion(pwr_mbup27.getBounds(), dsize));
    ...
    pwr_mbopenobject3.dd.setDynType(129);
    pwr_mbopenobject3.dd.setActionType(8256);
    pwr_mbopenobject3.dd.setAccess(65532);
    pwr_mbopenobject3.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenobject3.dd, "$cmd(check method/method=\"Open Object\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenobject3.dd, "call method/method=\"Open Object\"/object=$object")
      ,new GeDynTipText(pwr_mbopenobject3.dd, JopLang.transl("Open Object"))
      });
    pwr_mbtrend4.dd.setDynType(129);
    pwr_mbtrend4.dd.setActionType(8256);
    pwr_mbtrend4.dd.setAccess(65532);
    pwr_mbtrend4.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbtrend4.dd, "$cmd(check method/method=\"Trend\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbtrend4.dd, "call method/method=\"Trend\"/object=$object")
      ,new GeDynTipText(pwr_mbtrend4.dd, JopLang.transl("Trend"))
      });
    pwr_mbfast5.dd.setDynType(129);
    pwr_mbfast5.dd.setActionType(8256);
    pwr_mbfast5.dd.setAccess(65532);
    pwr_mbfast5.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbfast5.dd, "$cmd(check method/method=\"Fast\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbfast5.dd, "call method/method=\"Fast\"/object=$object")
      ,new GeDynTipText(pwr_mbfast5.dd, JopLang.transl("Fast"))
      });
    pwr_mbphoto6.dd.setDynType(129);
    pwr_mbphoto6.dd.setActionType(8256);
    pwr_mbphoto6.dd.setAccess(65532);
    pwr_mbphoto6.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbphoto6.dd, "$cmd(check method/method=\"Photo\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbphoto6.dd, "call method/method=\"Photo\"/object=$object")
      ,new GeDynTipText(pwr_mbphoto6.dd, JopLang.transl("Photo"))
      });
    pwr_mbdatasheet7.dd.setDynType(129);
    pwr_mbdatasheet7.dd.setActionType(8256);
    pwr_mbdatasheet7.dd.setAccess(65532);
    pwr_mbdatasheet7.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbdatasheet7.dd, "$cmd(check method/method=\"DataSheet\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbdatasheet7.dd, "call method/method=\"DataSheet\"/object=$object")
      ,new GeDynTipText(pwr_mbdatasheet7.dd, JopLang.transl("DataSheet"))
      });
    pwr_mbopenplc8.dd.setDynType(129);
    pwr_mbopenplc8.dd.setActionType(8256);
    pwr_mbopenplc8.dd.setAccess(65532);
    pwr_mbopenplc8.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbopenplc8.dd, "$cmd(check method/method=\"Open Plc\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbopenplc8.dd, "call method/method=\"Open Plc\"/object=$object")
      ,new GeDynTipText(pwr_mbopenplc8.dd, JopLang.transl("Open Plc"))
      });
    pwr_mbcircuitdiagram9.dd.setDynType(129);
    pwr_mbcircuitdiagram9.dd.setActionType(8256);
    pwr_mbcircuitdiagram9.dd.setAccess(65535);
    pwr_mbcircuitdiagram9.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbcircuitdiagram9.dd, "$cmd(check method/method=\"CircuitDiagram\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbcircuitdiagram9.dd, "call method/method=\"CircuitDiagram\"/object=$object")
      ,new GeDynTipText(pwr_mbcircuitdiagram9.dd, JopLang.transl("CircuitDiagram"))
      });
    pwr_mbrtnavigator10.dd.setDynType(129);
    pwr_mbrtnavigator10.dd.setActionType(8256);
    pwr_mbrtnavigator10.dd.setAccess(65532);
    pwr_mbrtnavigator10.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbrtnavigator10.dd, "$cmd(check method/method=\"RtNavigator\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbrtnavigator10.dd, "call method/method=\"RtNavigator\"/object=$object")
      ,new GeDynTipText(pwr_mbrtnavigator10.dd, JopLang.transl("RtNavigator"))
      });
    pwr_mbhelpclass11.dd.setDynType(129);
    pwr_mbhelpclass11.dd.setActionType(8256);
    pwr_mbhelpclass11.dd.setAccess(65532);
    pwr_mbhelpclass11.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelpclass11.dd, "$cmd(check method/method=\"Help Class\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelpclass11.dd, "call method/method=\"Help Class\"/object=$object")
      ,new GeDynTipText(pwr_mbhelpclass11.dd, JopLang.transl("Help Class"))
      });
    pwr_mbblockevents12.dd.setDynType(129);
    pwr_mbblockevents12.dd.setActionType(8256);
    pwr_mbblockevents12.dd.setAccess(65532);
    pwr_mbblockevents12.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbblockevents12.dd, "$cmd(check method/method=\"Block Events...\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbblockevents12.dd, "call method/method=\"Block Events...\"/object=$object")
      ,new GeDynTipText(pwr_mbblockevents12.dd, JopLang.transl("Block Events"))
      });
    pwr_mbhistevent13.dd.setDynType(129);
    pwr_mbhistevent13.dd.setActionType(8256);
    pwr_mbhistevent13.dd.setAccess(65532);
    pwr_mbhistevent13.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhistevent13.dd, "$cmd(check method/method=\"Hist Event...\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbhistevent13.dd, "call method/method=\"Hist Event...\"/object=$object")
      ,new GeDynTipText(pwr_mbhistevent13.dd, JopLang.transl("Hist Event"))
      });
    pwr_mbnote14.dd.setDynType(129);
    pwr_mbnote14.dd.setActionType(8256);
    pwr_mbnote14.dd.setAccess(65532);
    pwr_mbnote14.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbnote14.dd, "$cmd(check method/method=\"Note\"/object=$object)",0)
      ,new GeDynCommand(pwr_mbnote14.dd, "call method/method=\"Note\"/object=$object")
      ,new GeDynTipText(pwr_mbnote14.dd, JopLang.transl("Note"))
      });
    pwr_mbhelp15.dd.setDynType(128);
    pwr_mbhelp15.dd.setActionType(8256);
    pwr_mbhelp15.dd.setAccess(65532);
    pwr_mbhelp15.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbhelp15.dd, "$cmd(check method/method=\"Help\"/object=$object)",1)
      ,new GeDynCommand(pwr_mbhelp15.dd, "call method/method=\"Help\"/object=$object")
      ,new GeDynTipText(pwr_mbhelp15.dd, JopLang.transl("Help"))
      });
    pwr_smallbuttoncenter16.dd.setDynType(128);
    pwr_smallbuttoncenter16.dd.setActionType(64);
    pwr_smallbuttoncenter16.dd.setAccess(65532);
    pwr_smallbuttoncenter16.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_smallbuttoncenter16.dd, "$object.Note##String80",0)
      ,new GeDynCommand(pwr_smallbuttoncenter16.dd, "call method/method=\"Note\"/object=$object")
      });
    pwr_smallbuttoncenter16.setAnnot1("Note !");
    pwr_valuelong17.dd.setDynType(1025);
    pwr_valuelong17.dd.setActionType(0);
    pwr_valuelong17.dd.setElements(new GeDynElemIfc[] {
      new GeDynValue(pwr_valuelong17.dd, "$object.Specification##String40","%s")
      });
    pwr_contactor__p218.dd.setDynType(5);
    pwr_contactor__p218.dd.setActionType(0);
    pwr_contactor__p218.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor__p218.dd, "")
      });
    ...
    pwr_contactor222.dd.setDynType(32769);
    pwr_contactor222.dd.setActionType(0);
    pwr_contactor222.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor222.dd, "")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_mbup27.dd.setDynType(129);
    pwr_mbup27.dd.setActionType(8256);
    pwr_mbup27.dd.setAccess(33619967);
    pwr_mbup27.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup27.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup27.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup27.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2.37519F, 23.1001F, 405.04F, 22.4305F),
    ...
    new Line2D.Float( 178F, 197F, 126F, 197F),
    new Line2D.Float( 88.742F, 197F, 36.742F, 197F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2.37519F,45.5306F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2.37519F,23.1001F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
...
protected class pwr_contactor__p2 extends GeComponent {
  // Dimension size;
  public pwr_contactor__p2( JopSession session)
  {
    super( session);
  ...
  public void paintComponent(Graphics g1) {
    ...
    GeGradient.paint( g, gradient,2,-2,8F,2F,12F,22F, false,294, colorTone, colorShift, colorIntensity, colorInverse, fillColor, dimmed);
    g.fill( shapes[0]);
    }
    if ( shadow != 0) {
    g.setColor(GeColor.shiftColor( fcolor, -2, colorInverse));
