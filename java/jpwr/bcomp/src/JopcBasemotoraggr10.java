...
public class JopcBasemotoraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_indsquare5.setBounds(new Rectangle(185,317,16,17));
    ...
    pwr_indsquare8.setBounds(new Rectangle(185,364,16,16));
    ...
    jopSmallbutton30.setBounds(new Rectangle(4,526,47,21));
    ...
    pwr_valuelong31.setBounds(new Rectangle(60,525,336,23));
    ...
    pwr_contactor235.setBounds(new Rectangle(248,308,38,38));
    ...
    pwr_safetyswitch36.setBounds(new Rectangle(248,352,39,41));
    ...
    pwr_motor245.setBounds(new Rectangle(173,430,98,74));
    ...
    pwr_indsquare54.setBounds(new Rectangle(185,390,16,17));
