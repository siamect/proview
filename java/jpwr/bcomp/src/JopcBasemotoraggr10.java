...
public class JopcBasemotoraggr10 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  BorderLayout borderLayout1 = new BorderLayout();
  public LocalPanel localPanel = new LocalPanel();
  boolean scrollbar = false;
  Dimension size;
  pwr_safetyswitch	pwr_safetyswitch1;
  ...
  Grp173_	grp173_56;
  pwr_fuse3	pwr_fuse357;
  pwr_motorman	pwr_motorman58;
  pwr_rodcouplinganim	pwr_rodcouplinganim59;
  Grp184_	grp184_60;
  pwr_smallbuttoncenter	pwr_smallbuttoncenter61;
  pwr_contactor2	pwr_contactor263;
  pwr_mbup	pwr_mbup64;
  public JopcBasemotoraggr10( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotoraggr10( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotoraggr10");
    pwr_safetyswitch1 = new pwr_safetyswitch(session);
    pwr_safetyswitch1.setBounds(new Rectangle(248,354,38,39));
    pwr_safetyswitch1.setFillColor(32);
    pwr_safetyswitch1.setShadow(1);
    localPanel.add(pwr_safetyswitch1, new Proportion(pwr_safetyswitch1.getBounds(), dsize));
    pwr_indsquare8 = new pwr_indsquare(session);
    pwr_indsquare8.setBounds(new Rectangle(185,317,16,17));
    ...
    pwr_indsquare11.setBounds(new Rectangle(185,364,16,16));
    ...
    pwr_smallbuttoncenter16.setBounds(new Rectangle(116,191,61,21));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(4,526,47,21));
    ...
    pwr_valuelong34.setBounds(new Rectangle(60,525,336,23));
    ...
    pwr_motor246.setBounds(new Rectangle(173,430,98,74));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(116,169,61,21));
    ...
    pwr_indsquare55.setBounds(new Rectangle(185,390,16,17));
    ...
    grp173_56.setBounds(new Rectangle(69,390,40,18));
    localPanel.add(grp173_56, new Proportion(grp173_56.getBounds(), dsize));
    pwr_fuse357 = new pwr_fuse3(session);
    pwr_fuse357.setBounds(new Rectangle(260,266,15,37));
    pwr_fuse357.setRotate(-90);
    pwr_fuse357.setShadow(1);
    localPanel.add(pwr_fuse357, new Proportion(pwr_fuse357.getBounds(), dsize));
    pwr_motorman58 = new pwr_motorman(session);
    pwr_motorman58.setBounds(new Rectangle(101,95,64,44));
    pwr_motorman58.setShadow(1);
    pwr_motorman58.setGradient(12);
    ...
    pwr_rodcouplinganim59.setBounds(new Rectangle(169,455,12,22));
    ...
    grp184_60.setBounds(new Rectangle(30,193,41,18));
    ...
    pwr_contactor263 = new pwr_contactor2(session);
    pwr_contactor263.setBounds(new Rectangle(248,308,38,38));
    pwr_contactor263.setFillColor(32);
    pwr_contactor263.setShadow(1);
    localPanel.add(pwr_contactor263, new Proportion(pwr_contactor263.getBounds(), dsize));
    pwr_mbup64 = new pwr_mbup(session);
    pwr_mbup64.setBounds(new Rectangle(344,24,19,20));
    localPanel.add(pwr_mbup64, new Proportion(pwr_mbup64.getBounds(), dsize));
    pwr_safetyswitch1.dd.setDynType(32769);
    pwr_safetyswitch1.dd.setActionType(66);
    pwr_safetyswitch1.dd.setAccess(65535);
    pwr_safetyswitch1.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_safetyswitch1.dd, "!$object.SafetySwitch.On.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_safetyswitch1.dd, "$object.SafetySwitch")
      ,new GeDynCommand(pwr_safetyswitch1.dd, "open graph/class/instance=$object.SafetySwitch")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu245.dd.setElements(new GeDynElemIfc[] {
      new GeDynPulldownMenu(pwr_pulldownmenu245.dd, new String[] {
        JopLang.transl("Contactor"),null,JopLang.transl("SafetySwitch"),JopLang.transl("Motor"),null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null},
        new GeDyn[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_fuse357.dd.setDynType(1);
    pwr_fuse357.dd.setActionType(0);
    ...
    pwr_motorman58.dd.setElements(new GeDynElemIfc[] {
      ...
      ,new GeDynDigLowColor(pwr_motorman58.dd, "$object.Contactor.Feedback.ActualValue##Boolean",37)
    ...
    pwr_rodcouplinganim59.dd.setElements(new GeDynElemIfc[] {
      new GeDynAnimation(pwr_rodcouplinganim59.dd, "$object.Contactor.IndFeedback##Boolean",1)
      });
    ...
    pwr_contactor263.dd.setDynType(32769);
    pwr_contactor263.dd.setActionType(66);
    pwr_contactor263.dd.setAccess(65535);
    pwr_contactor263.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor263.dd, "$object.Contactor.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor263.dd, "$object.Contactor")
      ,new GeDynCommand(pwr_contactor263.dd, "open graph /class/instance=$object.Contactor")
      });
    pwr_mbup64.dd.setDynType(129);
    pwr_mbup64.dd.setActionType(8256);
    pwr_mbup64.dd.setAccess(33619967);
    pwr_mbup64.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(pwr_mbup64.dd, "$cmd(check isattribute/object=$object)",0)
      ,new GeDynCommand(pwr_mbup64.dd, "open graph/class/parent/instance=$object")
      ,new GeDynTipText(pwr_mbup64.dd, JopLang.transl("Open parent object graph"))
      });
...
class LocalPanel extends JPanel {
  ...
  public int original_height = 548;
  double rotate;
  ...
  Shape[] shapes = new Shape[] { 
    new Rectangle2D.Float(2F, 23F, 404.858F, 22.4305F),
    new Rectangle2D.Float(19.6571F, 245.175F, 360.366F, 277.42F),
    new Polygon( new int[] { 20, 380, 379, 20, 20, 20}, new int[] { 245, 245, 246, 246, 522, 523}, 6), 
    new Polygon( new int[] { 380, 380, 379, 379, 20, 20}, new int[] { 523, 245, 246, 522, 522, 523}, 6), 
    new Polygon( new int[] { 228, 264, 268, 268, 268, 264}, new int[] {432, 432, 428, 392, 428, 432}, 6),
    new Line2D.Float( 268F, 254F, 268F, 310F),
    ...
    new Line2D.Float( 268F, 358F, 268F, 344F),
  };
  ...
  public void paintComponent(Graphics g1) {
    ...
    {
      GradientPaint gp = new GradientPaint( 2F,45.4305F,        GeColor.getColor(31,colorTone,colorShift,colorIntensity,0, colorInverse, fillColor, dimmed),
        2F,23F,GeColor.getColor(31,colorTone,colorShift,colorIntensity,-1, colorInverse, fillColor, dimmed),true);
      g.setPaint(gp);
    }
    g.fill( shapes[0]);
    {
    ...
    g.drawString( JopLang.transl("Contactor"),72, 330);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Safety switch"),72, 378);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Mode"),35, 162);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Ready"),262, 110);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Interlock"),262, 131);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Run"),236, 229);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.PLAIN, 12));
    g.drawString( JopLang.transl("Starts"),236, 209);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Start"),128, 184);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, borderColor, dimmed));
    g.draw( shapes[13]);
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 46, 46}, new int[] { 12, 15, 52,52}, 4),
    ...
    new Polygon( new int[] { 92, 92, 81, 80}, new int[] { 62, 61, 61,62}, 4),
    new Polygon( new int[] { 80, 81, 81, 80}, new int[] { 62, 61, 15,12}, 4),
    new Polygon( new int[] { 80, 81, 148170510, 46}, new int[] { 12, 15, 144032852,52}, 4),
