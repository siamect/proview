...
public class JopcBasemotoraggr10 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_safetyswitch1.setBounds(new Rectangle(249,355,36,37));
    ...
    pwr_indsquare8.setBounds(new Rectangle(186,318,14,15));
    ...
    pwr_indsquare11.setBounds(new Rectangle(186,365,14,14));
    ...
    pwr_smallbuttoncenter16.setBounds(new Rectangle(117,192,59,19));
    ...
    pwr_smallbuttoncenter33.setBounds(new Rectangle(5,527,45,19));
    ...
    pwr_valuelong34.setBounds(new Rectangle(61,526,334,21));
    ...
    pwr_motor246.setBounds(new Rectangle(174,431,96,72));
    ...
    pwr_smallbuttoncenter53.setBounds(new Rectangle(117,170,59,19));
    ...
    pwr_indsquare55.setBounds(new Rectangle(186,391,14,15));
    ...
    pwr_motorman58.setBounds(new Rectangle(102,96,62,42));
    ...
    pwr_rodcouplinganim59.setBounds(new Rectangle(170,456,10,20));
    ...
    pwr_contactor263.setBounds(new Rectangle(249,309,36,36));
    ...
    pwr_mbup64.setBounds(new Rectangle(345,25,17,18));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915329, 46}, new int[] { 12, 15, -1219915323,52}, 4),
