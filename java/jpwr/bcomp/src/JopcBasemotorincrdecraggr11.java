...
public class JopcBasemotorincrdecraggr11 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_mbup	pwr_mbup74;
  public JopcBasemotorincrdecraggr11( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr11( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr11");
    ...
    pwr_indsquare7.setBounds(new Rectangle(151,349,14,15));
    ...
    pwr_smallbuttoncenter30.setBounds(new Rectangle(5,521,45,19));
    ...
    pwr_valuelong31.setBounds(new Rectangle(61,520,334,21));
    ...
    pwr_contactor235.setBounds(new Rectangle(249,339,36,36));
    ...
    pwr_motor244.setBounds(new Rectangle(174,416,96,72));
    ...
    pwr_indsquare51.setBounds(new Rectangle(151,377,14,14));
    ...
    grp173_52.setBounds(new Rectangle(35,377,38,16));
    ...
    pwr_rodcouplinganim54.setBounds(new Rectangle(169,442,10,19));
    ...
    pwr_contactor255.setBounds(new Rectangle(306,339,36,36));
    ...
    pwr_indsquare57.setBounds(new Rectangle(212,349,14,15));
    ...
    pwr_fuse373.setBounds(new Rectangle(260,294,13,35));
...
class LocalPanel extends JPanel {
  ...
  public void paintComponent(Graphics g1) {
    ...
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Decr"),177, 362);
    g.setColor(GeColor.getColor(0, colorTone,
	 colorShift, colorIntensity, colorBrightness, colorInverse, textColor, dimmed));
    g.setFont(new Font("Helvetica", Font.BOLD, 12));
    g.drawString( JopLang.transl("Incr"),113, 362);
    g.setStroke( new BasicStroke(1F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 55, 55}, new int[] { 12, 15, 54,53}, 4),
