...
public class JopcBasemotorincrdecraggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(5,512,45,19));
    ...
    pwr_valuelong33.setBounds(new Rectangle(61,511,334,21));
    ...
    pwr_manswitch337.setBounds(new Rectangle(249,285,36,36));
    ...
    pwr_contactor238.setBounds(new Rectangle(249,333,36,36));
    ...
    pwr_motor247.setBounds(new Rectangle(174,407,96,72));
    ...
    pwr_indsquare54.setBounds(new Rectangle(151,368,14,14));
    ...
    grp173_55.setBounds(new Rectangle(35,368,38,16));
    ...
    pwr_rodcouplinganim57.setBounds(new Rectangle(169,433,10,19));
    ...
    pwr_contactor258.setBounds(new Rectangle(306,333,36,36));
    ...
    pwr_indsquare60.setBounds(new Rectangle(212,343,14,14));
...
null,null,    new GeDyn(pwr_pulldownmenu244,129,65,33619964,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu246,1,65,33619967,new GeDynElemIfc[] {
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, -1219915314, -26}, new int[] { 146, 147, -1219915301,-13}, 4),
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, 152409671, 47}, new int[] { 12, 15, 144033816,40}, 4),
