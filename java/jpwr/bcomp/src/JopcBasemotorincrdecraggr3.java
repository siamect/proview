...
public class JopcBasemotorincrdecraggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  public JopcBasemotorincrdecraggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasemotorincrdecraggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasemotorincrdecraggr3");
    ...
    pwr_manswitch336.setBounds(new Rectangle(248,284,38,38));
    ...
    pwr_contactor237.setBounds(new Rectangle(248,332,38,38));
    ...
    pwr_motor246.setBounds(new Rectangle(173,406,98,74));
    ...
    pwr_indsquare53.setBounds(new Rectangle(150,367,16,16));
    ...
    grp173_54.setBounds(new Rectangle(34,367,39,18));
    ...
    pwr_rodcouplinganim56.setBounds(new Rectangle(168,432,12,21));
    ...
    pwr_contactor237.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_contactor237.dd, "$object.ContactorIncr.IndFeedback##Boolean")
      ,new GeDynPopupMenu(pwr_contactor237.dd, "$object.ContactorIncr")
      ,new GeDynCommand(pwr_contactor237.dd, "open graph /class/instance=$object.ContactorIncr")
      });
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu43.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu43.dd, "open graph /class /inst=$object.CircuitBreaker.NotTripped")
      }),
    new GeDyn(pwr_pulldownmenu43,1,65,65535,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu43,129,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    pwr_pulldownmenu45.dd.setElements(new GeDynElemIfc[] {
      ...
      new GeDynCommand(pwr_pulldownmenu45.dd, "open graph /class /inst=$object.CircuitBreaker")
      }),
    new GeDyn(pwr_pulldownmenu45,1,65,65535,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu45,1,65,33619967,new GeDynElemIfc[] {
