...
public class JopcBasefanaggr3 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_rod31.setBounds(new Rectangle(138,405,39,10));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(4,484,47,21));
    ...
    pwr_valuelong33.setBounds(new Rectangle(60,483,336,23));
    ...
    pwr_fananim37.setBounds(new Rectangle(123,363,19,91));
    ...
    pwr_motor247.setBounds(new Rectangle(173,373,98,74));
    ...
    pwr_indsquare56.setBounds(new Rectangle(185,333,16,16));
    ...
    pwr_contactor262.setBounds(new Rectangle(248,300,38,38));
    ...
    pwr_manswitch363.setBounds(new Rectangle(248,252,38,38));
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219706468, 11}, new int[] { 12, 15, -1219706448,31}, 4),
