...
public class JopcBasefanaggr3 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  pwr_manswitch3	pwr_manswitch363;
  pwr_mbup	pwr_mbup64;
  public JopcBasefanaggr3( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public JopcBasefanaggr3( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
  ...
  public void geInit() {
    ...
    if ( engine.isInstance())
      ...
      this.setTitle("JopcBasefanaggr3");
    ...
    pwr_rod31.setBounds(new Rectangle(139,406,37,8));
    ...
    pwr_smallbuttoncenter32.setBounds(new Rectangle(5,485,45,19));
    ...
    pwr_valuelong33.setBounds(new Rectangle(61,484,334,21));
    ...
    pwr_fananim37.setBounds(new Rectangle(124,364,17,89));
    ...
    pwr_motor247.setBounds(new Rectangle(174,374,96,72));
    ...
    pwr_indsquare56.setBounds(new Rectangle(186,334,14,14));
    ...
    grp173_57.setBounds(new Rectangle(70,334,38,15));
    localPanel.add(grp173_57, new Proportion(grp173_57.getBounds(), dsize));
    grp181_58 = new Grp181_(session);
    grp181_58.setBounds(new Rectangle(31,194,39,16));
    localPanel.add(grp181_58, new Proportion(grp181_58.getBounds(), dsize));
    ...
    pwr_contactor262.setBounds(new Rectangle(249,301,36,36));
    ...
    pwr_manswitch363 = new pwr_manswitch3(session);
    pwr_manswitch363.setBounds(new Rectangle(249,253,36,36));
    pwr_manswitch363.setFillColor(32);
    pwr_manswitch363.setShadow(1);
    localPanel.add(pwr_manswitch363, new Proportion(pwr_manswitch363.getBounds(), dsize));
...
null,null,    new GeDyn(pwr_pulldownmenu244,129,65,33619967,new GeDynElemIfc[] {
...
null,null,    new GeDyn(pwr_pulldownmenu246,1,65,33619964,new GeDynElemIfc[] {
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
    ...
    grp181_58.dd.setDynType(129);
    grp181_58.dd.setActionType(0);
    grp181_58.dd.setElements(new GeDynElemIfc[] {
      new GeDynInvisible(grp181_58.dd, "$object.Mode.ExternOrdHide##Boolean",0)
      });
    ...
    pwr_manswitch363.dd.setDynType(32769);
    pwr_manswitch363.dd.setActionType(66);
    pwr_manswitch363.dd.setAccess(65535);
    pwr_manswitch363.dd.setElements(new GeDynElemIfc[] {
      new GeDynDigShift(pwr_manswitch363.dd, "$object.CircuitBreaker.NotTripped.ActualValue##Boolean")
      ,new GeDynPopupMenu(pwr_manswitch363.dd, "$object.CircuitBreaker")
      ,new GeDynCommand(pwr_manswitch363.dd, "open graph/class/instance=$object.CircuitBreaker")
      });
...
protected class pwr_motor2 extends GeComponent {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 80, 81, -1219915364, 11}, new int[] { 12, 15, -1219915344,31}, 4),
