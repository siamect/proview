...
public class JopcBasemotorincrdecraggr18 extends JopFrame implements JopUtilityIfc {
  ...
  public void geInit() {
    ...
    pwr_smallbuttoncenter71.setBounds(new Rectangle(140,169,80,21));
    ...
    pwr_smallbuttoncenter72.setBounds(new Rectangle(140,193,80,21));
    ...
    pwr_smallbuttoncenter73.setBounds(new Rectangle(140,216,80,21));
...
class LocalPanel extends JPanel {
  ...
  Shape[] shapes = new Shape[] { 
    ...
    new Polygon( new int[] { 20, 21, 150780885, -18}, new int[] { 146, 147, 147391311,0}, 4),
